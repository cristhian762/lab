    ...
    async _getPicks(filter, _disposables, token, runOptions) {
        ...
        for (let i = 0; i < filteredCommandPicks.length; i++) {
            ...
            if (i === 0 && this.commandsHistory.peek(commandPick.commandId)) {
                commandPicks.push({ type: 'separator', label: ( localizeWithPath(
        ...
        return {
            ...
            additionalPicks: (async () => {
                ...
                if (addSuggestedSeparator && commandPicks[0]?.type !== 'separator') {
                    commandPicks.unshift({ type: 'separator', label: ( localizeWithPath(
                        'vs/platform/quickinput/browser/commandsQuickAccess',
                        'suggested',
                        "similar commands"
                    )) });
            ...
            accept: async () => {
                ...
                try {
                    ...
                    if (!isCancellationError(error)) {
                        this.dialogService.error(( localizeWithPath(
                            'vs/platform/quickinput/browser/commandsQuickAccess',
                            'canNotRun',
