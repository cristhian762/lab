...
import { IRemoteAuthorityResolverService, RemoteAuthorityResolverError, getRemoteAuthorityPrefix, RemoteAuthorityResolverErrorCode } from 'vscode/vscode/vs/platform/remote/common/remoteAuthorityResolver';
...
import { ExtensionPointContribution, ActivationTimes, toExtension } from 'vscode/vscode/vs/workbench/services/extensions/common/extensions';
...
let AbstractExtensionService = AbstractExtensionService_1 = class AbstractExtensionService extends Disposable {
    ...
    async _doStopExtensionHostsWithVeto(reason) {
            ...
            veto(value, reason) {
                ...
                if (typeof value === 'boolean') {
                    ...
                    value.then(value => {
                        ...
                        vetoReasons.add(( localizeWithPath(
                            'vs/workbench/services/extensions/common/abstractExtensionService',
        ...
        if (!veto) {
            ...
            await this._dialogService.warn(( localizeWithPath(
                'vs/workbench/services/extensions/common/abstractExtensionService',
    ...
    async _onRemoteExtensionHostCrashed(extensionHost, reconnectionToken) {
        try {
            ...
            if (this._remoteCrashTracker.shouldAutomaticallyRestart()) {
                ...
                this._notificationService.status(( localizeWithPath(
                    'vs/workbench/services/extensions/common/abstractExtensionService',
                ...
                this._notificationService.prompt(Severity.Error, ( localizeWithPath(
                    'vs/workbench/services/extensions/common/abstractExtensionService',
