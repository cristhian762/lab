...
import { cursorStyleToString, TextEditorCursorStyle } from 'vscode/vscode/vs/editor/common/config/editorOptions';
...
import { EditorState } from 'vscode/vscode/vs/editor/contrib/editorState/browser/editorState';
...
class MainThreadTextEditorProperties {
    ...
    static _readOptionsFromCodeEditor(previousProperties, model, codeEditor) {
        ...
        if (codeEditor) {
            ...
            const lineNumbersOpts = options.get(68 );
