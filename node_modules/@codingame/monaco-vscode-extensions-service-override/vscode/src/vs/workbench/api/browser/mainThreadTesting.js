...
import { ITestItem, ITestMessage, TestsDiffOp, IFileCoverage, CoverageDetails } from 'vscode/vscode/vs/workbench/contrib/testing/common/testTypes';
...
let MainThreadTesting = class MainThreadTesting extends Disposable {
    ...
    $signalCoverageAvailable(runId, taskId, available) {
        this.withLiveRun(runId, run => {
            ...
            const fn = available ? ((token) => TestCoverage.load(taskId, {
