class Qa {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(t) {
      setTimeout(() => {
        throw t.stack ? kt.isErrorNoTelemetry(t) ? new kt(t.message + `
...
function ni(e) {
  if (e instanceof Error) {
    ...
    return {
      ...
      message: n,
      stack: r,
      noTelemetry: kt.isErrorNoTelemetry(e)
    };
  }
  return e;
}
const nr = "Canceled";
function Ya(e) {
  return e instanceof Ka ? !0 : e instanceof Error && e.name === nr && e.message === nr;
}
...
const yt = class yt {
  ...
  filter(t) {
    return new yt((n) => this.iterate((r) => t(r) ? n(r) : !0));
  }
  map(t) {
    return new yt((n) => this.iterate((r) => n(t(r))));
  }
  some(t) {
    let n = !1;
  ...
  findLastMaxBy(t) {
    let n, r = !0;
    return this.iterate((i) => ((r || ir.isGreaterThan(t(i, n))) && (r = !1, n = i), !0)), n;
  }
};
yt.empty = new yt((t) => {
});
...
(function(e) {
  ...
  e.reduce = v;
  function* p(b, w, S = b.length) {
    for (w < 0 && (w += b.length), S < 0 ? S += b.length : S > b.length && (S = b.length); w < S; w++)
      yield b[w];
  }
  e.slice = p;
  function x(b, w = Number.POSITIVE_INFINITY) {
    const S = [];
    if (w === 0)
      return [S, b];
...
const Dn = class Dn {
  ...
  add(t) {
    ...
    return this._isDisposed ? Dn.DISABLE_DISPOSED_WARNING || console.warn(new Error(
...
const wt = class wt {
  constructor(t) {
    this.element = t, this.next = wt.Undefined, this.prev = wt.Undefined;
  }
};
wt.Undefined = new wt(void 0);
let K = wt;
class co {
  constructor() {
  ...
  _remove(t) {
    if (t.prev !== K.Undefined && t.next !== K.Undefined) {
      ...
      t.prev === K.Undefined && t.next === K.Undefined ? (this._first = K.Undefined, this._last = K.Undefined) : t.next === K.Undefined ? (this._last = this._last.prev, this._last.next = K.Undefined) : t.prev === K.Undefined && (this._first = this._first.next, this._first.prev = K.Undefined);
    this._size -= 1;
  }
  *[Symbol.iterator]() {
    let t = this._first;
...
const fo = globalThis.performance && typeof globalThis.performance.now == "function";
class jn {
  static create(t) {
    return new jn(t);
  }
  constructor(t) {
    this._now = fo && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(k) {
    return (L, T = null, F) => {
      ...
      return O = k((M) => {
        if (!V)
          return O ? O.dispose() : V = !0, L.call(T, M);
      }, null, F), V && O.dispose(), O;
    };
  }
  e.once = n;
  function r(k, L, T) {
    return u((F, V = null, O) => k((M) => F.call(V, L(M)), null, O), T);
  }
  e.map = r;
  function i(k, L, T) {
    return u((F, V = null, O) => k((M) => {
      L(M), F.call(V, M);
    }, null, O), T);
  }
  e.forEach = i;
  function s(k, L, T) {
    return u((F, V = null, O) => k((M) => L(M) && F.call(V, M), null, O), T);
  }
  e.filter = s;
  function a(k) {
    return k;
  ...
  function o(...k) {
    return (L, T = null, F) => {
      const V = uo(...k.map((O) => O((M) => L.call(T, M))));
      return f(V, F);
    };
  }
  e.any = o;
  ...
  function u(k, L) {
    ...
    return L == null || L.add(V), V.event;
  }
  function f(k, L) {
    return L instanceof Array ? L.push(k) : L && L.add(k), k;
  }
  function h(k, L, T = 100, F = !1, V = !1, O, M) {
    let C, P, D, B = 0, U;
    const G = {
      leakWarningThreshold: O,
      onWillAddFirstListener() {
        C = k((le) => {
          B++, P = L(P, le), F && !D && (de.fire(P), P = void 0), U = () => {
            const me = P;
            P = void 0, D = void 0, (!F || B > 1) && de.fire(me), B = 0;
          }, typeof T == "number" ? (clearTimeout(D), D = setTimeout(U, T)) : D === void 0 && (D = 0, queueMicrotask(U));
        });
      },
    ...
    return M == null || M.add(de), de.event;
  }
  e.debounce = h;
  function d(k, L = 0, T) {
    return e.debounce(k, (F, V) => F ? (F.push(V), F) : [V], L, void 0, !0, void 0, T);
  }
  e.accumulate = d;
  function g(k, L = (F, V) => F === V, T) {
    let F = !0, V;
    return s(k, (O) => {
      const M = F || !L(O, V);
      return F = !1, V = O, M;
  ...
  e.split = m;
  function v(k, L = !1, T = [], F) {
    let V = T.slice(), O = k((P) => {
      V ? V.push(P) : C.fire(P);
    });
    F && F.add(O);
    const M = () => {
      V == null || V.forEach((P) => C.fire(P)), V = null;
    }, C = new Ce({
      onWillAddFirstListener() {
        O || (O = k((P) => C.fire(P)), F && F.add(O));
      },
  ...
  class y {
    ...
    forEach(L) {
      return this.steps.push((T) => (L(T), T)), this;
    }
    filter(L) {
      return this.steps.push((T) => L(T) ? T : x), this;
    }
    reduce(L, T) {
      let F = T;
      return this.steps.push((V) => (F = L(F, V), F)), this;
    }
    latch(L = (T, F) => T === F) {
      let T = !0, F;
      return this.steps.push((V) => {
        const O = T || !L(V, F);
        return T = !1, F = V, O ? V : x;
      }), this;
    }
    evaluate(L) {
  ...
  function b(k, L, T = (F) => F) {
    const F = (...C) => M.fire(T(...C)), V = () => k.on(L, F), O = () => k.removeListener(L, F), M = new Ce(
      { onWillAddFirstListener: V, onDidRemoveLastListener: O }
    );
    return M.event;
  }
  e.fromNodeEventEmitter = b;
  function w(k, L, T = (F) => F) {
    const F = (...C) => M.fire(T(...C)), V = () => k.addEventListener(L, F), O = () => k.removeEventListener(L, F), M = new Ce(
      { onWillAddFirstListener: V, onDidRemoveLastListener: O }
    );
    return M.event;
  }
  ...
  class _ {
    constructor(L, T) {
      ...
      this.emitter = new Ce(F), T && T.add(this.emitter);
    }
    beginUpdate(L) {
      this._counter++;
    }
  ...
  function E(k, L) {
    return new _(k, L).emitter.event;
  }
  e.fromObservable = E;
  function I(k) {
    return (L, T, F) => {
      ...
      const M = {
        ...
        endUpdate() {
          V--, V === 0 && (k.reportChanges(), O && (O = !1, L.call(T)));
        },
      ...
      k.addObserver(M), k.reportChanges();
      const C = {
        dispose() {
          k.removeObserver(M);
        }
      };
      return F instanceof $t ? F.add(C) : Array.isArray(F) && F.push(C), C;
    };
  }
  e.fromObservableLight = I;
})(sr || (sr = {}));
const Nt = class Nt {
  constructor(t) {
...
class Ce {
  constructor(t) {
    var n, r, i, s;
    this._size = 0, this._options = t, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new go(((r = this._options) == null ? void 0 : r.leakWarningThreshold) ?? ho) : void 0, this._perfMon = (i = this._options) != null && i._profName ? new ar(this._options._profName) : void 0, this._deliveryQueue = (s = this._options) == null ? void 0 : s.deliveryQueue;
  }
  dispose() {
    var t, n, r, i;
  ...
  get event() {
    return this._event ?? (this._event = (t, n, r) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold * 3)
        return console.warn(`[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far`), Rt.None;
      if (this._disposed)
        return Rt.None;
      n && (t = t.bind(n));
      const i = new $n(t);
      let s;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (i.stack = Ur.create(), s = this._leakageMon.check(i.stack, this._size + 1)), this._listeners ? this._listeners instanceof $n ? (this._deliveryQueue ?? (this._deliveryQueue = new vo()), this._listeners = [this._listeners, i]) : this._listeners.push(i) : ((l = (o = this._options) == null ? void 0 : o.onWillAddFirstListener) == null || l.call(o, this), this._listeners = i, (f = (u = this._options) == null ? void 0 : u.onDidAddFirstListener) == null || f.call(u, this)), this._size++;
      const a = xn(() => {
        s == null || s(), this._removeListener(i);
      });
      return r instanceof $t ? r.add(a) : Array.isArray(r) && r.push(a), a;
    }), this._event;
  }
  _removeListener(t) {
    var s, a, o, l;
    ...
    if (this._size * po <= n.length) {
      let u = 0;
      for (let f = 0; f < n.length; f++)
        n[f] ? n[u++] = n[f] : i && (this._deliveryQueue.end--, u < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = u;
    }
  }
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const r = ((i = this._options) == null ? void 0 : i.onListenerError) || xa;
    if (!r) {
      t.value(n);
      return;
    }
...
let wo = typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function No(e, t) {
  let n;
...
let Lo, So = {};
function Y(e, t, n, ...r) {
  const i = typeof t == "object" ? t.key : t, s = (So[e] ?? {})[i] ?? n;
  return No(s, r);
}
function Ao(e) {
  return Lo;
...
const bt = "en";
let lr = !1, ur = !1, tn, hn = bt, ii = bt, _e;
const st = globalThis;
let ge;
typeof st.vscode < "u" && typeof st.vscode.process < "u" ? ge = st.vscode.process : typeof process < "u" && (ge = process);
var ba;
const _o = typeof ((ba = ge == null ? void 0 : ge.versions) == null ? void 0 : ba.electron) == "string", Co = _o && (ge == null ? void 0 : ge.type) === "renderer";
if (typeof ge == "object") {
  lr = ge.platform === "win32", ur = ge.platform === "darwin", ge.platform, ge.env.CI || ge.env.BUILD_ARTIFACTSTAGINGDIRECTORY, tn = bt, hn = bt;
  const e = ge.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e), n = t.availableLanguages["*"];
      tn = t.locale, ii = t.osLocale, hn = n || bt;
    } catch {
    }
} else
  typeof navigator == "object" && !Co ? (_e = navigator.userAgent, lr = _e.indexOf("Windows") >= 0, ur = _e.indexOf("Macintosh") >= 0, (_e.indexOf("Macintosh") >= 0 || _e.indexOf("iPad") >= 0 || _e.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, _e.indexOf("Linux") >= 0, (_e == null ? void 0 : _e.indexOf("Mobi")) >= 0, Ao(
    Y(
      "vs/base/common/platform",
      { key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] },
      "_"
    )
  ), tn = bt, hn = tn, ii = navigator.language) : console.error("Unable to resolve platform.");
var si;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(si || (si = {}));
const Wt = lr, ko = ur, je = _e, ze = hn;
var ai;
(function(e) {
  function t() {
    return ze;
...
const Eo = typeof st.postMessage == "function" && !st.importScripts;
(() => {
  if (Eo) {
    const e = [];
    ...
    return (n) => {
      ...
      e.push({
        id: r,
        callback: n
      }), st.postMessage({ vscodeScheduleAsyncWork: r }, "*");
    };
  }
...
const Ro = !!(je && je.indexOf("Chrome") >= 0);
je && je.indexOf("Firefox") >= 0;
!Ro && je && je.indexOf("Safari") >= 0;
je && je.indexOf("Edg/") >= 0;
je && je.indexOf("Android") >= 0;
const wa = Object.freeze(function(e, t) {
...
(function(e) {
  ...
  e.isCancellationToken = t, e.None = Object.freeze({
    ...
    onCancellationRequested: sr.None
  }), e.Cancelled = Object.freeze({
    isCancellationRequested: !0,
    onCancellationRequested: wa
  });
})(yn || (yn = {}));
class dn {
  constructor() {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? wa : (this._emitter || (this._emitter = new Ce()), this._emitter.event);
  }
  dispose() {
...
class Mo {
  ...
  cancel() {
    this._token ? this._token instanceof dn && this._token.cancel() : this._token = yn.Cancelled;
  }
  dispose(t = !1) {
    var n;
    t && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof dn && this._token.dispose() : this._token = yn.None;
  }
}
class To {
  constructor(t) {
...
const De = class De {
  static getInstance(t) {
    return De.cache.get(Array.from(t));
  }
  static getLocales() {
...
De.ambiguousCharacterData = new li(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}')), De.cache = new To((t) => {
  ...
  const s = De.ambiguousCharacterData.value;
  let a = t.filter((f) => !f.startsWith("_") && f in s);
  ...
  return new De(u);
}), De._locales = new li(() => Object.keys(De.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let Ht = De;
const Lt = class Lt {
  static getRawData() {
...
class Go {
  ...
  sendMessage(t, n) {
    ...
    return new Promise((i, s) => {
      this._pendingReplies[r] = {
        resolve: i,
        reject: s
      }, this._send(new $o(this._workerId, r, t, n));
    });
  }
  listen(t, n) {
    let r = null;
    const i = new Ce({
      onWillAddFirstListener: () => {
        r = String(++this._lastSentReq), this._pendingEmitters.set(r, i), this._send(new Wo(this._workerId, r, t, n));
      },
      onDidRemoveLastListener: () => {
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then((i) => {
      this._send(new ui(this._workerId, n, i, void 0));
    }, (i) => {
      i.detail instanceof Error && (i.detail = ni(i.detail)), this._send(new ui(this._workerId, n, void 0, ni(i)));
    });
  }
  _handleSubscribeEventMessage(t) {
    const n = t.req, r = this._handler.handleEvent(t.eventName, t.arg)((i) => {
      this._send(new Ho(this._workerId, n, i));
    });
...
function La(e) {
  return e[0] === "o" && e[1] === "n" && Na(e.charCodeAt(2));
}
function Sa(e) {
  return /^onDynamic/.test(e) && Na(e.charCodeAt(9));
}
function Jo(e, t, n) {
  const r = (a) => function() {
...
class Xo {
  constructor(t, n) {
    this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Go({
      sendMessage: (r, i) => {
        t(r, i);
      },
  ...
  initialize(t, n, r, i) {
    ...
    const o = Jo(i, (l, u) => this._protocol.sendMessage(l, u), (l, u) => this._protocol.listen(l, u));
...
function Zo(e, t, n) {
  return new et(new fi(e), new fi(t)).ComputeDiff(n).changes;
}
class ht {
  static Assert(t, n) {
    if (!t)
...
class hi {
  ...
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new Ze(
...
class et {
  constructor(t, n, r = null) {
    ...
    const [i, s, a] = et._getElements(t), [o, l, u] = et._getElements(n);
  ...
  ElementsAreStrictEqual(t, n) {
    if (!this.ElementsAreEqual(t, n))
      return !1;
    const r = et._getStrictElement(this._originalSequence, t), i = et._getStrictElement(this._modifiedSequence, n);
    return r === i;
  }
  ...
  ComputeDiffRecursive(t, n, r, i, s) {
    ...
    if (t > n || r > i) {
      let h;
      return r <= i ? (ht.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), h = [
        new Ze(t, 0, r, i - r + 1)
      ]) : t <= n ? (ht.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), h = [
        new Ze(t, n - t + 1, r, 0)
      ]) : (ht.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), ht.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), h = []), h;
    }
    const a = [0], o = [0], l = this.ComputeRecursionPoint(t, n, r, i, a, o, s), u = a[0], f = o[0];
    if (l !== null)
      return l;
    if (!s[0]) {
      const h = this.ComputeDiffRecursive(t, u, r, f, s);
      let d = [];
      return s[0] ? d = [
        new Ze(
          u + 1,
      ...
      ] : d = this.ComputeDiffRecursive(u + 1, n, f + 1, i, s), this.ConcatenateChanges(h, d);
    }
    return [
      new Ze(
        t,
  ...
  WALKTRACE(t, n, r, i, s, a, o, l, u, f, h, d, g, m, v, p, x, y) {
    let b = null, w = null, S = new hi(), N = n, A = r, _ = g[0] - p[0] - i, E = -1073741824, I = this.m_forwardHistory.length - 1;
    do {
      const k = _ + t;
      k === N || k < A && u[k - 1] < u[k + 1] ? (h = u[k + 1], m = h - _ - i, h < E && S.MarkNextChange(), E = h, S.AddModifiedElement(h + 1, m), _ = k + 1 - t) : (h = u[k - 1] + 1, m = h - _ - i, h < E && S.MarkNextChange(), E = h - 1, S.AddOriginalElement(h, m + 1), _ = k - 1 - t), I >= 0 && (u = this.m_forwardHistory[I], t = u[0], N = 1, A = u.length - 1);
    } while (--I >= -1);
    if (b = S.getReverseChanges(), y[0]) {
      let k = g[0] + 1, L = p[0] + 1;
      if (b !== null && b.length > 0) {
        const T = b[b.length - 1];
        k = Math.max(k, T.getOriginalEnd()), L = Math.max(L, T.getModifiedEnd());
      }
      w = [
        new Ze(
          k,
      ...
      S = new hi(), N = a, A = o, _ = g[0] - p[0] - l, E = 1073741824, I = x ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const k = _ + s;
        k === N || k < A && f[k - 1] >= f[k + 1] ? (h = f[k + 1] - 1, m = h - _ - l, h > E && S.MarkNextChange(), E = h + 1, S.AddOriginalElement(h + 1, m + 1), _ = k + 1 - s) : (h = f[k - 1], m = h - _ - l, h > E && S.MarkNextChange(), E = h, S.AddModifiedElement(h + 1, m + 1), _ = k - 1 - s), I >= 0 && (f = this.m_reverseHistory[I], s = f[0], N = 1, A = f.length - 1);
      } while (--I >= -1);
      w = S.getChanges();
    }
  ...
  ComputeRecursionPoint(t, n, r, i, s, a, o) {
    ...
    const m = n - t + (i - r), v = m + 1, p = new Int32Array(v), x = new Int32Array(v), y = i - r, b = n - t, w = t - r, S = n - i, A = (b - y) % 2 === 0;
    p[y] = t, x[b] = n, o[0] = !1;
    for (let _ = 1; _ <= m / 2 + 1; _++) {
      let E = 0, I = 0;
      f = this.ClipDiagonalBound(y - _, _, y, v), h = this.ClipDiagonalBound(y + _, _, y, v);
      for (let L = f; L <= h; L += 2) {
        L === f || L < h && p[L - 1] < p[L + 1] ? l = p[L + 1] : l = p[L - 1] + 1, u = l - (L - y) - w;
        const T = l;
        for (; l < n && u < i && this.ElementsAreEqual(l + 1, u + 1); )
          l++, u++;
        if (p[L] = l, l + u > E + I && (E = l, I = u), !A && Math.abs(L - b) <= _ - 1 && l >= x[L])
          return s[0] = l, a[0] = u, T <= x[L] && _ <= 1448 ? this.WALKTRACE(y, f, h, w, b, d, g, S, p, x, l, n, s, u, i, a, A, o) : null;
      }
      const k = (E - t + (I - r) - _) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(E, k))
        return o[0] = !0, s[0] = E, a[0] = I, k > 0 && _ <= 1448 ? this.WALKTRACE(y, f, h, w, b, d, g, S, p, x, l, n, s, u, i, a, A, o) : (t++, r++, [
          new Ze(
            t,
            n - t + 1,
            r,
      ...
      d = this.ClipDiagonalBound(b - _, _, b, v), g = this.ClipDiagonalBound(b + _, _, b, v);
      for (let L = d; L <= g; L += 2) {
        L === d || L < g && x[L - 1] >= x[L + 1] ? l = x[L + 1] - 1 : l = x[L - 1], u = l - (L - b) - S;
        const T = l;
        for (; l > t && u > r && this.ElementsAreEqual(l, u); )
          l--, u--;
        if (x[L] = l, A && Math.abs(L - y) <= _ && l <= p[L])
          return s[0] = l, a[0] = u, T >= p[L] && _ <= 1448 ? this.WALKTRACE(y, f, h, w, b, d, g, S, p, x, l, n, s, u, i, a, A, o) : null;
      }
      if (_ <= 1447) {
        let L = new Int32Array(h - f + 2);
        L[0] = y - f + 1, dt.Copy2(p, f, L, 1, h - f + 1), this.m_forwardHistory.push(L), L = new Int32Array(g - d + 2), L[0] = b - d + 1, dt.Copy2(x, d, L, 1, g - d + 1), this.m_reverseHistory.push(L);
      }
    }
    return this.WALKTRACE(y, f, h, w, b, d, g, S, p, x, l, n, s, u, i, a, A, o);
  }
  PrettifyChanges(t) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      for (let h = 1; ; h++) {
        const d = r.originalStart - h, g = r.modifiedStart - h;
        if (d < i || g < s || a && !this.OriginalElementsAreEqual(d, d + r.originalLength) || o && !this.ModifiedElementsAreEqual(g, g + r.modifiedLength))
          break;
        const v = (d === i && g === s ? 5 : 0) + this._boundaryScore(d, r.originalLength, g, r.modifiedLength);
        v > u && (u = v, l = h);
      }
    ...
    if (this._hasStrings)
      for (let n = 1, r = t.length; n < r; n++) {
        const i = t[n - 1], s = t[n], a = s.originalStart - i.originalStart - i.originalLength, o = i.originalStart, l = s.originalStart + s.originalLength, u = l - o, f = i.modifiedStart, h = s.modifiedStart + s.modifiedLength, d = h - f;
        if (a < 5 && u < 20 && d < 20) {
          const g = this._findBetterContiguousSequence(o, u, f, d, a);
          if (g) {
            const [m, v] = g;
            (m !== i.originalStart + i.originalLength || v !== i.modifiedStart + i.modifiedLength) && (i.originalLength = m - i.originalStart, i.modifiedLength = v - i.modifiedStart, s.originalStart = m + a, s.modifiedStart = v + a, s.originalLength = l - s.originalStart, s.modifiedLength = h - s.modifiedStart);
          }
        }
      }
    return t;
  ...
  ConcatenateChanges(t, n) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
      ...
      return dt.Copy(t, 0, i, 0, t.length - 1), i[t.length - 1] = r[0], dt.Copy(n, 1, i, t.length, n.length - 1), i;
    } else {
      const i = new Array(t.length + n.length);
      return dt.Copy(t, 0, i, 0, t.length), dt.Copy(n, 0, i, t.length, n.length), i;
    }
  }
  ChangesOverlap(t, n, r) {
    if (ht.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), ht.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      const i = t.originalStart;
      let s = t.originalLength;
      const a = t.modifiedStart;
      let o = t.modifiedLength;
      return t.originalStart + t.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (o = n.modifiedStart + n.modifiedLength - t.modifiedStart), r[0] = new Ze(i, s, a, o), !0;
    } else
      return r[0] = null, !1;
  }
...
if (typeof Wn < "u" && typeof Wn.process < "u") {
  ...
  typeof process < "u" ? at = {
    ...
    get platform() {
      return Wt ? "win32" : ko ? "darwin" : "linux";
    },
    get arch() {
    },
    get env() {
...
const wn = at.cwd, Yo = at.env, Ko = at.platform;
at.arch;
const el = 65, tl = 97, nl = 90, rl = 122, tt = 46, ue = 47, pe = 92, Ge = 58, il = 63;
...
function sl(e, t) {
  if (e === null || typeof e != "object")
    throw new Aa(t, "Object", e);
}
function ne(e, t) {
  if (typeof e != "string")
    throw new Aa(t, "string", e);
}
const Ae = Ko === "win32";
function W(e) {
  return e === ue || e === pe;
        ...
        if (o === 2) {
          if (i.length < 2 || s !== 2 || i.charCodeAt(i.length - 1) !== tt || i.charCodeAt(i.length - 2) !== tt) {
            if (i.length > 2) {
              ...
              f === -1 ? (i = "", s = 0) : (i = i.slice(0, f), s = i.length - 1 - i.lastIndexOf(n)), a = u, o = 0;
              continue;
            } else if (i.length !== 0) {
              i = "", s = 0, a = u, o = 0;
              continue;
...
const oe = {
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= -1; i--) {
      let s;
      if (i >= 0) {
        if (s = e[i], ne(s, "path"), s.length === 0)
          continue;
      } else
        t.length === 0 ? s = wn() : (s = Yo[`=${t}`] || wn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === pe) && (s = `${t}\\`));
      const a = s.length;
      let o = 0, l = "", u = !1;
      ...
      if (a === 1)
        ...
        Je(f) && s.charCodeAt(1) === Ge && (l = s.slice(0, 2), o = 2, a > 2 && W(s.charCodeAt(2)) && (u = !0, o = 3));
      if (l.length > 0)
        if (t.length > 0) {
  ...
  normalize(e) {
    ...
    if (W(s))
      ...
      Je(s) && e.charCodeAt(1) === Ge && (r = e.slice(0, 2), n = 2, t > 2 && W(e.charCodeAt(2)) && (i = !0, n = 3));
    let a = n < t ? Nn(e.slice(n), !i, "\\", W) : "";
  ...
  isAbsolute(e) {
    ...
    return W(n) || t > 2 && Je(n) && e.charCodeAt(1) === Ge && W(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let s = 0; s < e.length; ++s) {
      const a = e[s];
      ne(a, "path"), a.length > 0 && (t === void 0 ? t = n = a : t += `\\${a}`);
    }
    if (t === void 0)
      return ".";
    let r = !0, i = 0;
  ...
  relative(e, t) {
    ...
    if (d !== f) {
      ...
      if (u > f) {
        if (t.charCodeAt(o + d) === pe)
          return r.slice(o + d + 1);
        if (d === 2)
          return r.slice(o + d);
      }
      a > f && (e.charCodeAt(i + d) === pe ? h = d : d === 2 && (h = 3)), h === -1 && (h = 0);
    }
    let g = "";
    for (d = i + h + 1; d <= s; ++d)
      (d === s || e.charCodeAt(d) === pe) && (g += g.length === 0 ? ".." : "\\..");
    return o += h, g.length > 0 ? `${g}${r.slice(o, l)}` : (r.charCodeAt(o) === pe && ++o, r.slice(o, l));
  },
  toNamespacedPath(e) {
    ...
    } else if (Je(t.charCodeAt(0)) && t.charCodeAt(1) === Ge && t.charCodeAt(2) === pe)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    if (W(i)) {
      ...
      Je(i) && e.charCodeAt(1) === Ge && (n = t > 2 && W(e.charCodeAt(2)) ? 3 : 2, r = n);
    let s = -1, a = !0;
    for (let o = t - 1; o >= r; --o)
      if (W(e.charCodeAt(o))) {
        if (!a) {
  ...
  basename(e, t) {
    ...
    let n = 0, r = -1, i = !0, s;
    if (e.length >= 2 && Je(e.charCodeAt(0)) && e.charCodeAt(1) === Ge && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === Ge && Je(e.charCodeAt(0)) && (t = r = 2);
  ...
  parse(e) {
    ...
    if (W(i)) {
      if (r = 1, W(e.charCodeAt(1))) {
        let h = 2, d = h;
        for (; h < n && !W(e.charCodeAt(h)); )
          h++;
        if (h < n && h !== d) {
          for (d = h; h < n && W(e.charCodeAt(h)); )
            h++;
          if (h < n && h !== d) {
            for (d = h; h < n && !W(e.charCodeAt(h)); )
              h++;
    ...
    } else if (Je(i) && e.charCodeAt(1) === Ge) {
      if (n <= 2)
    ...
    let s = -1, a = r, o = -1, l = !0, u = e.length - 1, f = 0;
    for (; u >= r; --u) {
      ...
      o === -1 && (l = !1, o = u + 1), i === tt ? s === -1 ? s = u : f !== 1 && (f = 1) : s !== -1 && (f = -1);
    }
    return o !== -1 && (s === -1 || f === 0 || f === 1 && s === o - 1 && s === a + 1 ? t.base = t.name = e.slice(a, o) : (t.name = e.slice(a, s), t.base = e.slice(a, o), t.ext = e.slice(s, o))), a > 0 && a !== r ? t.dir = e.slice(0, a - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1 && !n; r--) {
      const i = r >= 0 ? e[r] : al();
      ne(i, "path"), i.length !== 0 && (t = `${i}/${t}`, n = i.charCodeAt(0) === ue);
    }
    return t = Nn(t, !n, "/", fr), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (ne(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ue, n = e.charCodeAt(e.length - 1) === ue;
    return e = Nn(e, !t, "/", fr), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  join(...e) {
    ...
    for (let n = 0; n < e.length; ++n) {
      const r = e[n];
      ne(r, "path"), r.length > 0 && (t === void 0 ? t = r : t += `/${r}`);
    }
    return t === void 0 ? "." : ce.normalize(t);
  },
  relative(e, t) {
    if (ne(e, "from"), ne(t, "to"), e === t || (e = ce.resolve(e), t = ce.resolve(t), e === t))
      return "";
    ...
    if (u === o)
      if (a > o) {
        if (t.charCodeAt(s + u) === ue)
          return t.slice(s + u + 1);
        if (u === 0)
          return t.slice(s + u);
      } else
        i > o && (e.charCodeAt(n + u) === ue ? l = u : u === 0 && (l = 0));
    let f = "";
    for (u = n + l + 1; u <= r; ++u)
      (u === r || e.charCodeAt(u) === ue) && (f += f.length === 0 ? ".." : "/..");
  ...
  parse(e) {
    ...
    for (; l >= r; --l) {
      ...
      a === -1 && (o = !1, a = l + 1), f === tt ? i === -1 ? i = l : u !== 1 && (u = 1) : i !== -1 && (u = -1);
    }
    if (a !== -1) {
      const f = s === 0 && n ? 1 : s;
      i === -1 || u === 0 || u === 1 && i === a - 1 && i === s + 1 ? t.base = t.name = e.slice(f, a) : (t.name = e.slice(f, i), t.base = e.slice(f, a), t.ext = e.slice(i, a));
    }
...
Ae ? oe.normalize : ce.normalize;
Ae ? oe.isAbsolute : ce.isAbsolute;
Ae ? oe.join : ce.join;
Ae ? oe.resolve : ce.resolve;
Ae ? oe.relative : ce.relative;
Ae ? oe.dirname : ce.dirname;
Ae ? oe.basename : ce.basename;
Ae ? oe.extname : ce.extname;
Ae ? oe.parse : ce.parse;
Ae ? oe.sep : ce.sep;
Ae ? oe.delimiter : ce.delimiter;
const ol = /^\w[\w\d+.-]*$/, ll = /^\//, ul = /^\/\//;
function cl(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !ol.test(e.scheme))
    throw new Error("[UriError]: Scheme contains illegal characters.");
  if (e.path) {
    if (e.authority) {
      if (!ll.test(e.path))
        throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
    } else if (ul.test(e.path))
...
let $r = class gn {
  static isUri(t) {
    return t instanceof gn ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  constructor(t, n, r, i, s, a = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || Z, this.authority = t.authority || Z, this.path = t.path || Z, this.query = t.query || Z, this.fragment = t.fragment || Z) : (this.scheme = fl(t, a), this.authority = n || Z, this.path = hl(this.scheme, r || Z), this.query = i || Z, this.fragment = s || Z, cl(this, a));
  }
  get fsPath() {
    return hr(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = Z), r === void 0 ? r = this.authority : r === null && (r = Z), i === void 0 ? i = this.path : i === null && (i = Z), s === void 0 ? s = this.query : s === null && (s = Z), a === void 0 ? a = this.fragment : a === null && (a = Z), n === this.scheme && r === this.authority && i === this.path && s === this.query && a === this.fragment ? this : new gt(n, r, i, s, a);
  }
  static parse(t, n = !1) {
    const r = dl.exec(t);
    return r ? new gt(
  ...
  static joinPath(t, ...n) {
    ...
    let r;
    return Wt && t.scheme === "file" ? r = gn.file(oe.join(hr(t, !0), ...n)).path : r = ce.join(t.path, ...n), t.with({ path: r });
  }
  toString(t = !1) {
    return dr(this, t);
  }
  ...
  static revive(t) {
    if (t) {
      ...
      {
        const n = new gt(t);
        return n._formatted = t.external ?? null, n._fsPath = t._sep === Ca ? t.fsPath ?? null : null, n;
      }
    } else
      return t;
  }
};
const Ca = Wt ? 1 : void 0;
class gt extends $r {
  constructor() {
    super(...arguments), this._formatted = null, this._fsPath = null;
  }
  get fsPath() {
    return this._fsPath || (this._fsPath = hr(this, !1)), this._fsPath;
  }
  toString(t = !1) {
    return t ? dr(this, !0) : (this._formatted || (this._formatted = dr(this, !1)), this._formatted);
  }
  toJSON() {
    const t = {
      $mid: 1
    };
    return this._fsPath && (t.fsPath = this._fsPath, t._sep = Ca), this._formatted && (t.external = this._formatted), this.path && (t.path = this.path), this.scheme && (t.scheme = this.scheme), this.authority && (t.authority = this.authority), this.query && (t.query = this.query), this.fragment && (t.fragment = this.fragment), t;
  }
}
const ka = {
  58: "%3A",
...
function gl(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const r = e.charCodeAt(n);
    r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += ka[r]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function hr(e, t) {
  let n;
  return e.authority && e.path.length > 1 && e.scheme === "file" ? n = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? n = e.path.substr(1) : n = e.path[1].toLowerCase() + e.path.substr(2) : n = e.path, Wt && (n = n.replace(/\//g, "\\")), n;
}
function dr(e, t) {
  const n = t ? gl : di;
  ...
  if (i && (r += i, r += ":"), (s || i === "file") && (r += ke, r += ke), s) {
    ...
    if (u !== -1) {
      ...
      s = s.substr(u + 1), u = f.lastIndexOf(":"), u === -1 ? r += n(f, !1, !1) : (r += n(f.substr(0, u), !1, !1), r += ":", r += n(f.substr(u + 1), !1, !0)), r += "@";
    }
  ...
  return o && (r += "?", r += n(o, !1, !1)), l && (r += "#", r += t ? l : di(l, !1, !1)), r;
}
function Ea(e) {
  try {
...
function nn(e) {
  return e.match(gi) ? e.replace(gi, (t) => Ea(t)) : e;
}
let Te = class rt {
  constructor(t, n) {
  ...
  static intersectRanges(t, n) {
    ...
    return r < o ? (r = o, i = l) : r === o && (i = Math.max(i, l)), s > u ? (s = u, a = f) : s === u && (a = Math.min(a, f)), r > s || r === s && i > a ? null : new ie(
      r,
      i,
      s,
      a
...
class vl {
  ...
  onEvents(t) {
    ...
    const n = t.changes;
    for (const r of n)
      this._acceptDeleteRange(r.range), this._acceptInsertText(new Te(r.range.startLineNumber, r.range.startColumn), r.text);
...
function Wr(e, t, n, r, i) {
  if (t = Ma(t), i || (i = bn.first(Ta)), n.length > i.maxLen) {
    let u = e - i.maxLen / 2;
    return u < 0 ? u = 0 : r += u, n = n.substring(u, e + i.maxLen / 2), Wr(e, t, n, r, i);
  }
...
class Hr {
  constructor(t) {
    const n = mi(t);
    this._defaultValue = n, this._asciiMap = Hr._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
...
class Ln {
  ...
  static computeLinks(t, n = Ll()) {
    ...
    for (let s = 1, a = t.getLineCount(); s <= a; s++) {
      ...
      let u = 0, f = 0, h = 0, d = 1, g = !1, m = !1, v = !1, p = !1;
      for (; u < l; ) {
        let x = !1;
        const y = o.charCodeAt(u);
        if (d === 13) {
          let b;
          switch (y) {
            case 40:
            ...
            case 34:
            case 96:
              h === y ? b = 1 : h === 39 || h === 34 || h === 96 ? b = 0 : b = 1;
              break;
            case 42:
              b = h === 42 ? 1 : 0;
              break;
          ...
          b === 1 && (i.push(Ln._createLink(r, o, s, f, u)), x = !0);
        } else if (d === 12) {
          let b;
          y === 91 ? (m = !0, b = 0) : b = r.get(y), b === 1 ? x = !0 : d = 13;
        } else
          d = n.nextState(d, y), d === 0 && (x = !0);
        x && (d = 1, g = !1, m = !1, p = !1, f = u + 1, h = y), u++;
      }
      d === 13 && i.push(Ln._createLink(r, o, s, f, l));
    }
    return i;
  }
}
...
const mn = new zr(), mr = new zr(), pr = new zr(), _l = new Array(230), Cl = /* @__PURE__ */ Object.create(null), kl = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const i of t) {
    const [s, a, o, l, u, f, h, d, g] = i;
    if (r[a] || (r[a] = !0, Cl[o] = a, kl[o.toLowerCase()] = a), !n[l]) {
      if (n[l] = !0, !u)
        throw new Error(`String representation missing for key code ${l} around scan code ${o}`);
      mn.define(l, u), mr.define(l, d || u), pr.define(l, g || d || u);
    }
    f && (_l[f] = l);
  }
})();
...
(function(e) {
  function t(o) {
    return mn.keyCodeToStr(o);
  }
  e.toString = t;
  function n(o) {
    return mn.strToKeyCode(o);
  }
  e.fromString = n;
  function r(o) {
  ...
  function i(o) {
    return pr.keyCodeToStr(o);
  }
  e.toUserSettingsGeneral = i;
  function s(o) {
    return mr.strToKeyCode(o) || pr.strToKeyCode(o);
  }
...
const q = {
  ...
  runCoverage: c("run-all-coverage", 60460),
...
Y("vs/editor/common/languages", "Array", "array"), Y("vs/editor/common/languages", "Boolean", "boolean"), Y("vs/editor/common/languages", "Class", "class"), Y("vs/editor/common/languages", "Constant", "constant"), Y("vs/editor/common/languages", "Constructor", "constructor"), Y("vs/editor/common/languages", "Enum", "enumeration"), Y("vs/editor/common/languages", "EnumMember", "enumeration member"), Y("vs/editor/common/languages", "Event", "event"), Y("vs/editor/common/languages", "Field", "field"), Y("vs/editor/common/languages", "File", "file"), Y("vs/editor/common/languages", "Function", "function"), Y("vs/editor/common/languages", "Interface", "interface"), Y("vs/editor/common/languages", "Key", "key"), Y("vs/editor/common/languages", "Method", "method"), Y("vs/editor/common/languages", "Module", "module"), Y("vs/editor/common/languages", "Namespace", "namespace"), Y("vs/editor/common/languages", "Null", "null"), Y("vs/editor/common/languages", "Number", "number"), Y("vs/editor/common/languages", "Object", "object"), Y("vs/editor/common/languages", "Operator", "operator"), Y("vs/editor/common/languages", "Package", "package"), Y("vs/editor/common/languages", "Property", "property"), Y("vs/editor/common/languages", "String", "string"), Y("vs/editor/common/languages", "Struct", "struct"), Y("vs/editor/common/languages", "TypeParameter", "type parameter"), Y("vs/editor/common/languages", "Variable", "variable");
var Ni;
(function(e) {
  const t = /* @__PURE__ */ new Map();
...
}, xe.Comment = new xe("comment"), xe.Imports = new xe("imports"), xe.Region = new xe("region"), xe);
var Li;
(function(e) {
  function t(n) {
...
function Dl(e, t, n, r, i) {
  return Fl(e, t, n, r, i) && Il(e, t, n, r, i);
}
class Vl {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
        if (s === 0) {
          jo(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = i, this._prevMatchLength = s, !this._wordSeparators || Dl(this._wordSeparators, t, n, i, s))
        return r;
    } while (r);
    return null;
  }
}
function Ol(e, t = "Unreachable") {
  throw new Error(t);
}
function Sn(e) {
  if (!e()) {
    debugger;
    e(), xa(new Ue("Assertion Failed"));
  }
}
function Pa(e, t) {
  let n = 0;
...
class jl {
  static computeUnicodeHighlights(t, n, r) {
    const i = r ? r.startLineNumber : 1, s = r ? r.endLineNumber : t.getLineCount(), a = new bs(n), o = a.getCandidateCodePoints();
    let l;
    o === "allNonBasicAscii" ? l = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : l = new RegExp(`${ql(Array.from(o))}`, "g");
    const u = new Vl(null, l), f = [];
    let h = !1, d, g = 0, m = 0, v = 0;
    e:
      for (let p = i, x = s; p <= x; p++) {
        const y = t.getLineContent(p), b = y.length;
        u.reset(0);
        do
          if (d = u.next(y), d) {
            let w = d.index, S = d.index + d[0].length;
            if (w > 0) {
              const E = y.charCodeAt(w - 1);
              cr(E) && w--;
            }
            if (S + 1 < b) {
              const E = y.charCodeAt(S - 1);
              cr(E) && S++;
            }
            const N = y.substring(w, S);
            let A = Wr(w + 1, Ra, y, 0);
            A && A.endColumn <= w + 1 && (A = null);
            const _ = a.shouldHighlightNonBasicASCII(N, A ? A.word : null);
            if (_ !== 0) {
              if (_ === 3 ? g++ : _ === 2 ? m++ : _ === 1 ? v++ : Ol(), f.length >= 1e3) {
                h = !0;
                break e;
              }
              f.push(new ee(p, w + 1, p, S + 1));
            }
          }
        while (d);
      }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (r.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 2:
        return { kind: 1 };
      case 3: {
        const s = t.codePointAt(0), a = r.ambiguousCharacters.getPrimaryConfusable(s), o = Ht.getLocales().filter((l) => !Ht.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, l])).isAmbiguous(s));
...
function ql(e, t) {
  return `[${Po(e.map((r) => String.fromCodePoint(r)).join(""))}]`;
}
class bs {
  constructor(t) {
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const a of n) {
        const o = a.codePointAt(0), l = Bo(a);
        i = i || l, !l && !this.ambiguousCharacters.isAmbiguous(o) && !Vt.isInvisibleCharacter(o) && (s = !0);
      }
    return !i && s ? 0 : this.options.invisibleCharacters && !xs(t) && Vt.isInvisibleCharacter(r) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(r) ? 3 : 0;
  }
}
function xs(e) {
  return e === " " || e === `
...
class Gr {
  ...
  flip() {
    return new Gr(this.lineRangeMapping.flip(), this.changes.map((t) => t.flip()));
  }
}
class z {
  static addRange(t, n) {
...
class H {
  ...
  static fromRangeInclusive(t) {
    return new H(t.startLineNumber, t.endLineNumber + 1);
  }
  static subtract(t, n) {
    ...
    ] : n.startLineNumber <= t.startLineNumber && t.endLineNumberExclusive <= n.endLineNumberExclusive ? [] : n.endLineNumberExclusive < t.endLineNumberExclusive ? [new H(
      Math.max(n.endLineNumberExclusive, t.startLineNumber),
      t.endLineNumberExclusive
    )] : [new H(t.startLineNumber, Math.min(n.startLineNumber, t.endLineNumberExclusive))] : [t];
  }
  static joinMany(t) {
    if (t.length === 0)
      return [];
  ...
  deltaLength(t) {
    return new H(this.startLineNumber, this.endLineNumberExclusive + t);
  }
  get length() {
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new ee(
...
class Ve {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = rr(this._normalizedRanges, (i) => i.endLineNumberExclusive >= t.startLineNumber), r = Ut(this._normalizedRanges, (i) => i.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
  ...
  contains(t) {
    const n = Et(this._normalizedRanges, (r) => r.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = Et(this._normalizedRanges, (r) => r.startLineNumber < t.endLineNumberExclusive);
  ...
  getUnion(t) {
    ...
    for (; r < this._normalizedRanges.length || i < t._normalizedRanges.length; ) {
      ...
      s === null ? s = a : s.endLineNumberExclusive >= a.startLineNumber ? s = new H(
        s.startLineNumber,
  ...
  subtractFrom(t) {
    const n = rr(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), r = Ut(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === r)
      return new Ve([t]);
    const i = [];
    ...
    return s < t.endLineNumberExclusive && i.push(new H(s, t.endLineNumberExclusive)), new Ve(i);
  }
  toString() {
...
class Re {
  static inverse(t, n, r) {
    ...
    let s = 1, a = 1;
    for (const l of t) {
      const u = new Re(new H(s, l.original.startLineNumber), new H(a, l.modified.startLineNumber));
      u.modified.isEmpty || i.push(u), s = l.original.endLineNumberExclusive, a = l.modified.endLineNumberExclusive;
    }
    const o = new Re(new H(s, n + 1), new H(a, r + 1));
  ...
  static clip(t, n, r) {
    ...
    for (const s of t) {
      ...
      a && !a.isEmpty && o && !o.isEmpty && i.push(new Re(a, o));
    }
    return i;
  }
  constructor(t, n) {
...
class lt extends Re {
  ...
  flip() {
    var t;
    return new lt(this.modified, this.original, (t = this.innerChanges) == null ? void 0 : t.map((n) => n.flip()));
  }
}
class zt {
  constructor(t, n) {
  ...
  flip() {
    return new zt(this.modifiedRange, this.originalRange);
  }
}
const Bl = 3;
class Ul {
  computeDiff(t, n, r) {
    ...
    for (const u of s.changes) {
      let f;
      u.originalEndLineNumber === 0 ? f = new H(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1) : f = new H(u.originalStartLineNumber, u.originalEndLineNumber + 1);
      let h;
      u.modifiedEndLineNumber === 0 ? h = new H(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1) : h = new H(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1);
      let d = new lt(f, h, (l = u.charChanges) == null ? void 0 : l.map((g) => new zt(new ee(
      ...
      o && (o.modified.endLineNumberExclusive === d.modified.startLineNumber || o.original.endLineNumberExclusive === d.original.startLineNumber) && (d = new lt(
        o.original.join(d.original),
        o.modified.join(d.modified),
        o.innerChanges && d.innerChanges ? o.innerChanges.concat(d.innerChanges) : void 0
      ), a.pop()), a.push(d), o = d;
    }
    return Sn(() => Pa(a, (u, f) => f.original.startLineNumber - u.original.endLineNumberExclusive === f.modified.startLineNumber - u.modified.endLineNumberExclusive && u.original.endLineNumberExclusive < f.original.startLineNumber && u.modified.endLineNumberExclusive < f.modified.startLineNumber)), new pn(a, [], s.quitEarly);
  }
}
function Fa(e, t, n, r) {
  return new et(e, t, n).ComputeDiff(r);
}
let ys = class {
  constructor(t) {
    const n = [], r = [];
    for (let i = 0, s = t.length; i < s; i++)
      n[i] = Nr(t[i], 1), r[i] = Lr(t[i], 1);
...
class At {
  ...
  static createFromDiffChange(t, n, r) {
    const i = n.getStartLineNumber(t.originalStart), s = n.getStartColumn(t.originalStart), a = n.getEndLineNumber(t.originalStart + t.originalLength - 1), o = n.getEndColumn(t.originalStart + t.originalLength - 1), l = r.getStartLineNumber(t.modifiedStart), u = r.getStartColumn(t.modifiedStart), f = r.getEndLineNumber(t.modifiedStart + t.modifiedLength - 1), h = r.getEndColumn(t.modifiedStart + t.modifiedLength - 1);
    return new At(
      i,
      s,
      a,
...
class Ot {
  ...
  static createFromDiffResult(t, n, r, i, s, a, o) {
    let l, u, f, h, d;
    if (n.originalLength === 0 ? (l = r.getStartLineNumber(n.originalStart) - 1, u = 0) : (l = r.getStartLineNumber(n.originalStart), u = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (f = i.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (f = i.getStartLineNumber(n.modifiedStart), h = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
      ...
      if (g.getElements().length > 0 && m.getElements().length > 0) {
        let v = Fa(g, m, s, !0).changes;
        o && (v = Wl(v)), d = [];
        for (let p = 0, x = v.length; p < x; p++)
          d.push(At.createFromDiffChange(v[p], g, m));
      }
    }
    return new Ot(
      l,
...
class Ia {
  constructor(t, n, r) {
    this.shouldComputeCharChanges = r.shouldComputeCharChanges, this.shouldPostProcessCharChanges = r.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = r.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = r.shouldMakePrettyDiff, this.originalLines = t, this.modifiedLines = n, this.original = new ys(t), this.modified = new ys(n), this.continueLineDiff = ws(r.maxComputationTime), this.continueCharDiff = ws(r.maxComputationTime === 0 ? 0 : Math.min(r.maxComputationTime, 5e3));
  }
  computeDiff() {
    ...
    const t = Fa(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, r = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const o = [];
      for (let l = 0, u = n.length; l < u; l++)
        o.push(Ot.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[l], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: r,
        changes: o
      };
    ...
    for (let o = -1, l = n.length; o < l; o++) {
      const u = o + 1 < l ? n[o + 1] : null, f = u ? u.originalStart : this.originalLines.length, h = u ? u.modifiedStart : this.modifiedLines.length;
      for (; s < f && a < h; ) {
        const d = this.originalLines[s], g = this.modifiedLines[a];
        if (d !== g) {
          {
            let m = Nr(d, 1), v = Nr(g, 1);
            for (; m > 1 && v > 1; ) {
              const p = d.charCodeAt(m - 2), x = g.charCodeAt(v - 2);
              if (p !== x)
                break;
              m--, v--;
            }
          ...
          {
            let m = Lr(d, 1), v = Lr(g, 1);
            const p = d.length + 1, x = g.length + 1;
            for (; m < p && v < x; ) {
              const y = d.charCodeAt(m - 1), b = d.charCodeAt(v - 1);
              if (y !== b)
                break;
              m++, v++;
            }
            (m < p || v < x) && this._pushTrimWhitespaceCharChange(i, s + 1, m, p, a + 1, v, x);
          }
        }
        s++, a++;
      }
      u && (i.push(Ot.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += u.originalLength, a += u.modifiedLength);
    }
    return {
      quitEarly: r,
      changes: i
  ...
  _pushTrimWhitespaceCharChange(t, n, r, i, s, a, o) {
    if (this._mergeTrimWhitespaceCharChange(t, n, r, i, s, a, o))
      return;
    let l;
    this.shouldComputeCharChanges && (l = [new At(
      n,
      r,
      n,
      i,
  ...
  _mergeTrimWhitespaceCharChange(t, n, r, i, s, a, o) {
    ...
    if (l === 0)
      return !1;
    const u = t[l - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new At(
      n,
      r,
      n,
      i,
      ...
      s,
      o
    )), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === s ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = s, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new At(
      n,
      r,
      n,
      i,
...
class $e {
  static trivial(t, n) {
    return new $e([new te(z.ofLength(t.length), z.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new $e([new te(z.ofLength(t.length), z.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class te {
  static invert(t, n) {
    const r = [];
    return io(t, (i, s) => {
      r.push(te.fromOffsetPairs(i ? i.getEndExclusives() : Be.zero, s ? s.getStarts() : new Be(
        n,
  ...
  static fromOffsetPairs(t, n) {
    return new te(new z(t.offset1, n.offset1), new z(t.offset2, n.offset2));
  }
  constructor(t, n) {
...
Bt.chrKeys = /* @__PURE__ */ new Map();
let An = Bt;
class zl {
  compute(t, n, r = Gt.instance, i) {
    if (t.length === 0 || n.length === 0)
      return $e.trivial(t, n);
    const s = new zn(t.length, n.length), a = new zn(t.length, n.length), o = new zn(t.length, n.length);
    for (let m = 0; m < t.length; m++)
      for (let v = 0; v < n.length; v++) {
        if (!r.isValid())
          return $e.trivialTimedOut(t, n);
        const p = m === 0 ? 0 : s.get(m - 1, v), x = v === 0 ? 0 : s.get(m, v - 1);
        let y;
        t.getElement(m) === n.getElement(v) ? (m === 0 || v === 0 ? y = 0 : y = s.get(m - 1, v - 1), m > 0 && v > 0 && a.get(m - 1, v - 1) === 3 && (y += o.get(m - 1, v - 1)), y += i ? i(m, v) : 1) : y = -1;
        const b = Math.max(p, x, y);
        if (b === y) {
          const w = m > 0 && v > 0 ? o.get(m - 1, v - 1) : 0;
          o.set(m, v, w + 1), a.set(m, v, 3);
        } else
          b === p ? (o.set(m, v, 0), a.set(m, v, 1)) : b === x && (o.set(m, v, 0), a.set(m, v, 2));
        s.set(m, v, b);
      }
    const l = [];
    let u = t.length, f = n.length;
    function h(m, v) {
      (m + 1 !== u || v + 1 !== f) && l.push(new te(new z(m + 1, u), new z(v + 1, f))), u = m, f = v;
    }
    let d = t.length - 1, g = n.length - 1;
    for (; d >= 0 && g >= 0; )
      a.get(d, g) === 3 ? (h(d, g), d--, g--) : a.get(d, g) === 1 ? d-- : g--;
    return h(-1, -1), l.reverse(), new $e(l, !1);
  }
}
class Da {
  compute(t, n, r = Gt.instance) {
    if (t.length === 0 || n.length === 0)
      return $e.trivial(t, n);
    const i = t, s = n;
    function a(v, p) {
      for (; v < i.length && p < s.length && i.getElement(v) === s.getElement(p); )
        v++, p++;
      return v;
    }
    let o = 0;
    ...
    l.set(0, a(0, 0));
    const u = new Jl();
    u.set(0, l.get(0) === 0 ? null : new Ns(null, 0, 0, l.get(0)));
    let f = 0;
    e:
      for (; ; ) {
        if (o++, !r.isValid())
          return $e.trivialTimedOut(i, s);
        const v = -Math.min(o, s.length + o % 2), p = Math.min(o, i.length + o % 2);
        for (f = v; f <= p; f += 2) {
          const x = f === p ? -1 : l.get(f + 1), y = f === v ? -1 : l.get(f - 1) + 1, b = Math.min(Math.max(x, y), i.length), w = b - f;
          if (b > i.length || w > s.length)
            continue;
          const S = a(b, w);
          l.set(f, S);
          const N = b === x ? u.get(f + 1) : u.get(f - 1);
          if (u.set(f, S !== b ? new Ns(N, b, w, S - b) : N), l.get(f) === i.length && l.get(f) - f === s.length)
            break e;
        }
      }
    let h = u.get(f);
    ...
    for (; ; ) {
      const v = h ? h.x + h.length : 0, p = h ? h.y + h.length : 0;
      if ((v !== g || p !== m) && d.push(new te(new z(v, g), new z(p, m))), !h)
        break;
      g = h.x, m = h.y, h = h.prev;
    }
    return d.reverse(), new $e(d, !1);
  }
}
class Ns {
  constructor(t, n, r, i) {
...
class _n {
  ...
  getBoundaryScore(t) {
    const n = Ss(t > 0 ? this.elements[t - 1] : -1), r = Ss(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && r === 8)
      return 0;
    if (n === 8)
      return 150;
    let i = 0;
    return n !== r && (i += 10, n === 0 && r === 1 && (i += 1)), i += Ls(n), i += Ls(r), i;
  }
  translateOffset(t) {
    if (this.lineRange.isEmpty)
      return new Te(this.lineRange.start + 1, 1);
  ...
  translateRange(t) {
    return ee.fromPositions(this.translateOffset(t.start), this.translateOffset(t.endExclusive));
  }
  findWordContaining(t) {
    if (t < 0 || t >= this.elements.length || !Gn(this.elements[t]))
      return;
    let n = t;
    for (; n > 0 && Gn(this.elements[n - 1]); )
      n--;
    let r = t;
    for (; r < this.elements.length && Gn(this.elements[r]); )
      r++;
    return new z(n, r);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = Et(this.firstCharOffsetByLine, (i) => i <= t.start) ?? 0, r = to(this.firstCharOffsetByLine, (i) => t.endExclusive <= i) ?? this.elements.length;
    return new z(n, r);
  }
}
function Gn(e) {
...
function Ql(e, t, n, r, i, s) {
  let { moves: a, excludedChanges: o } = Yl(e, t, n, s);
  if (!s.isValid())
    return [];
  const l = e.filter((f) => !o.has(f)), u = Kl(l, r, i, t, n, s);
  return ao(a, u), a = eu(a), a = a.filter((f) => {
    const h = f.original.toOffsetRange().slice(t).map((g) => g.trim());
    return h.join(`
`).length >= 15 && Zl(h, (g) => g.length >= 2) >= 2;
  }), a = tu(e, a), a;
}
function Zl(e, t) {
  let n = 0;
...
function Yl(e, t, n, r) {
  const i = [], s = e.filter((l) => l.modified.isEmpty && l.original.length >= 3).map((l) => new An(l.original, t, l)), a = new Set(e.filter((l) => l.original.isEmpty && l.modified.length >= 3).map((l) => new An(l.modified, n, l))), o = /* @__PURE__ */ new Set();
  for (const l of s) {
    let u = -1, f;
    for (const h of a) {
    ...
    if (u > 0.9 && f && (a.delete(f), i.push(new Re(l.range, f.range)), o.add(l.source), o.add(f.source)), !r.isValid())
...
function Kl(e, t, n, r, i, s) {
  ...
  for (const d of e) {
    ...
    for (let m = d.modified.startLineNumber; m < d.modified.endLineNumberExclusive - 2; m++) {
      const v = `${n[m - 1]}:${n[m + 1 - 1]}:${n[m + 2 - 1]}`, p = new H(m, m + 3), x = [];
      o.forEach(v, ({ range: y }) => {
        for (const w of g)
          if (w.originalLineRange.endLineNumberExclusive + 1 === y.endLineNumberExclusive && w.modifiedLineRange.endLineNumberExclusive + 1 === p.endLineNumberExclusive) {
            w.originalLineRange = new H(
              w.originalLineRange.startLineNumber,
              y.endLineNumberExclusive
            ), w.modifiedLineRange = new H(
  ...
  l.sort(oo(cn((d) => d.modifiedLineRange.length, fn)));
  const u = new Ve(), f = new Ve();
  for (const d of l) {
    const g = d.modifiedLineRange.startLineNumber - d.originalLineRange.startLineNumber, m = u.subtractFrom(d.modifiedLineRange), v = f.subtractFrom(d.originalLineRange).getWithDelta(g), p = m.getIntersection(v);
    for (const x of p.ranges) {
      if (x.length < 3)
        continue;
      const y = x, b = x.delta(-g);
      a.push(new Re(b, y)), u.addRange(y), f.addRange(b);
    }
  }
  a.sort(cn((d) => d.original.startLineNumber, fn));
  const h = new vn(e);
  for (let d = 0; d < a.length; d++) {
    const g = a[d], m = h.findLastMonotonous((N) => N.original.startLineNumber <= g.original.startLineNumber), v = Et(e, (N) => N.modified.startLineNumber <= g.modified.startLineNumber), p = Math.max(g.original.startLineNumber - m.original.startLineNumber, g.modified.startLineNumber - v.modified.startLineNumber), x = h.findLastMonotonous((N) => N.original.startLineNumber < g.original.endLineNumberExclusive), y = Et(e, (N) => N.modified.startLineNumber < g.modified.endLineNumberExclusive), b = Math.max(x.original.endLineNumberExclusive - g.original.endLineNumberExclusive, y.modified.endLineNumberExclusive - g.modified.endLineNumberExclusive);
    let w;
    for (w = 0; w < p; w++) {
      const N = g.original.startLineNumber - w - 1, A = g.modified.startLineNumber - w - 1;
      if (N > r.length || A > i.length || u.contains(A) || f.contains(N) || !As(r[N - 1], i[A - 1], s))
        break;
    }
    w > 0 && (f.addRange(new H(g.original.startLineNumber - w, g.original.startLineNumber)), u.addRange(new H(g.modified.startLineNumber - w, g.modified.startLineNumber)));
    let S;
    for (S = 0; S < b; S++) {
      const N = g.original.endLineNumberExclusive + S, A = g.modified.endLineNumberExclusive + S;
      if (N > r.length || A > i.length || u.contains(A) || f.contains(N) || !As(r[N - 1], i[A - 1], s))
        break;
    }
    S > 0 && (f.addRange(new H(
      g.original.endLineNumberExclusive,
      g.original.endLineNumberExclusive + S
    )), u.addRange(new H(
      g.modified.endLineNumberExclusive,
      g.modified.endLineNumberExclusive + S
    ))), (w > 0 || S > 0) && (a[d] = new Re(new H(
      g.original.startLineNumber - w,
      g.original.endLineNumberExclusive + S
    ), new H(
      g.modified.startLineNumber - w,
      g.modified.endLineNumberExclusive + S
    )));
  }
  return a;
...
function As(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const i = new Da().compute(new _n([e], new z(0, 1), !1), new _n([t], new z(0, 1), !1), n);
  let s = 0;
  const a = te.invert(i.diffs, e.length);
  for (const f of a)
...
function tu(e, t) {
  const n = new vn(e);
  return t = t.filter((r) => {
    const i = n.findLastMonotonous((o) => o.original.startLineNumber < r.original.endLineNumberExclusive) || new Re(new H(1, 1), new H(1, 1)), s = Et(e, (o) => o.modified.startLineNumber < r.modified.endLineNumberExclusive);
    return i !== s;
  }), t;
}
function _s(e, t, n) {
  let r = n;
  return r = Cs(e, t, r), r = Cs(e, t, r), r = nu(e, t, r), r;
}
function Cs(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let s = 1; s < n.length; s++) {
    ...
    if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
      ...
      for (u = 1; u <= l && !(e.getElement(o.seq1Range.start - u) !== e.getElement(o.seq1Range.endExclusive - u) || t.getElement(o.seq2Range.start - u) !== t.getElement(o.seq2Range.endExclusive - u)); u++)
        ;
      if (u--, u === l) {
        r[r.length - 1] = new te(new z(a.seq1Range.start, o.seq1Range.endExclusive - l), new z(a.seq2Range.start, o.seq2Range.endExclusive - l));
        continue;
      }
      o = o.delta(-u);
    }
  ...
  for (let s = 0; s < r.length - 1; s++) {
    ...
    if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
      ...
      for (u = 0; u < l && !(!e.isStronglyEqual(o.seq1Range.start + u, o.seq1Range.endExclusive + u) || !t.isStronglyEqual(o.seq2Range.start + u, o.seq2Range.endExclusive + u)); u++)
        ;
      if (u === l) {
        r[s + 1] = new te(new z(o.seq1Range.start + l, a.seq1Range.endExclusive), new z(o.seq2Range.start + l, a.seq2Range.endExclusive));
        continue;
      }
      u > 0 && (o = o.delta(u));
    }
...
function nu(e, t, n) {
  ...
  for (let r = 0; r < n.length; r++) {
    const i = r > 0 ? n[r - 1] : void 0, s = n[r], a = r + 1 < n.length ? n[r + 1] : void 0, o = new z(
    ...
    s.seq1Range.isEmpty ? n[r] = ks(s, e, t, o, l) : s.seq2Range.isEmpty && (n[r] = ks(s.swap(), t, e, l, o).swap());
  }
  return n;
}
function ks(e, t, n, r, i) {
  ...
  let l = 0, u = -1;
  for (let f = -a; f <= o; f++) {
    const h = e.seq2Range.start + f, d = e.seq2Range.endExclusive + f, g = e.seq1Range.start + f, m = t.getBoundaryScore(g) + n.getBoundaryScore(h) + n.getBoundaryScore(d);
    m > u && (u = m, l = f);
  }
  return e.delta(l);
}
...
function iu(e, t, n) {
  ...
  function a(l, u) {
    if (l.offset1 < s.offset1 || l.offset2 < s.offset2)
      return;
    const f = e.findWordContaining(l.offset1), h = t.findWordContaining(l.offset2);
    if (!f || !h)
      return;
    let d = new te(f, h);
    const g = d.intersect(u);
    let m = g.seq1Range.length, v = g.seq2Range.length;
    for (; r.length > 0; ) {
      const p = r[0];
      if (!(p.seq1Range.intersects(f) || p.seq2Range.intersects(h)))
        break;
      const y = e.findWordContaining(p.seq1Range.start), b = t.findWordContaining(p.seq2Range.start), w = new te(y, b), S = w.intersect(p);
      if (m += S.seq1Range.length, v += S.seq2Range.length, d = d.join(w), d.seq1Range.endExclusive >= p.seq1Range.endExclusive)
        r.shift();
      else
        break;
    }
    m + v < (d.seq1Range.length + d.seq2Range.length) * 2 / 3 && i.push(d), s = d.getEndExclusives();
  }
  for (; r.length > 0; ) {
    const l = r.shift();
...
function au(e, t, n) {
  ...
  do {
    ...
    for (let l = 1; l < r.length; l++) {
      let h = function(g, m) {
        const v = new z(f.seq1Range.endExclusive, u.seq1Range.start);
        return e.getText(v).replace(/\s/g, "").length <= 4 && (g.seq1Range.length + g.seq2Range.length > 5 || m.seq1Range.length + m.seq2Range.length > 5);
      };
      var a = h;
      const u = r[l], f = o[o.length - 1];
      h(f, u) ? (s = !0, o[o.length - 1] = o[o.length - 1].join(u)) : o.push(u);
    }
    r = o;
  } while (i++ < 10 && s);
  return r;
...
function ou(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < r.length; u++) {
      let d = function(m, v) {
        const p = new z(h.seq1Range.endExclusive, f.seq1Range.start);
        if (e.countLinesIn(p) > 5 || p.length > 500)
          return !1;
        const y = e.getText(p).trim();
        if (y.length > 20 || y.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const b = e.countLinesIn(m.seq1Range), w = m.seq1Range.length, S = t.countLinesIn(m.seq2Range), N = m.seq2Range.length, A = e.countLinesIn(v.seq1Range), _ = v.seq1Range.length, E = t.countLinesIn(v.seq2Range), I = v.seq2Range.length, k = 2 * 40 + 50;
        function L(T) {
          return Math.min(T, k);
        }
        return Math.pow(Math.pow(L(b * 40 + w), 1.5) + Math.pow(L(S * 40 + N), 1.5), 1.5) + Math.pow(Math.pow(L(A * 40 + _), 1.5) + Math.pow(L(E * 40 + I), 1.5), 1.5) > (k ** 1.5) ** 1.5 * 1.3;
      };
      var o = d;
      const f = r[u], h = l[l.length - 1];
      d(h, f) ? (s = !0, l[l.length - 1] = l[l.length - 1].join(f)) : l.push(f);
    }
    r = l;
  } while (i++ < 10 && s);
  const a = [];
  return so(r, (l, u, f) => {
    let h = u;
    function d(y) {
      return y.length > 0 && y.trim().length <= 3 && u.seq1Range.length + u.seq2Range.length > 100;
    }
    const g = e.extendToFullLines(u.seq1Range), m = e.getText(new z(g.start, u.seq1Range.start));
    d(m) && (h = h.deltaStart(-m.length));
    const v = e.getText(new z(u.seq1Range.endExclusive, g.endExclusive));
    d(v) && (h = h.deltaEnd(v.length));
    const p = te.fromOffsetPairs(l ? l.getEndExclusives() : Be.zero, f ? f.getStarts() : Be.max), x = h.intersect(p);
...
class lu {
  constructor() {
    this.dynamicProgrammingDiffing = new zl(), this.myersDiffingAlgorithm = new Da();
  }
  computeDiff(t, n, r) {
    if (t.length <= 1 && no(t, n, (S, N) => S === N))
      return new pn([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new pn([
        new lt(new H(1, t.length + 1), new H(1, n.length + 1), [
          new zt(new ee(1, 1, t.length, t[0].length + 1), new ee(1, 1, n.length, n[0].length + 1))
        ])
      ], [], !1);
    const i = r.maxComputationTimeMs === 0 ? Gt.instance : new Hl(r.maxComputationTimeMs), s = !r.ignoreTrimWhitespace, a = /* @__PURE__ */ new Map();
    function o(S) {
      let N = a.get(S);
      return N === void 0 && (N = a.size, a.set(S, N)), N;
    }
    const l = t.map((S) => o(S.trim())), u = n.map((S) => o(S.trim())), f = new Es(l, t), h = new Es(u, n), d = f.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(f, h, i, (S, N) => t[S] === n[N] ? n[N].length === 0 ? 0.1 : 1 + Math.log(1 + n[N].length) : 0.99) : this.myersDiffingAlgorithm.compute(f, h);
    let g = d.diffs, m = d.hitTimeout;
    g = _s(f, h, g), g = au(f, h, g);
    const v = [], p = (S) => {
      if (s)
        for (let N = 0; N < S; N++) {
          const A = x + N, _ = y + N;
          if (t[A] !== n[_]) {
            const E = this.refineDiff(t, n, new te(new z(A, A + 1), new z(_, _ + 1)), i, s);
    ...
    let x = 0, y = 0;
    for (const S of g) {
      Sn(() => S.seq1Range.start - x === S.seq2Range.start - y);
      const N = S.seq1Range.start - x;
      p(N), x = S.seq1Range.endExclusive, y = S.seq2Range.endExclusive;
      const A = this.refineDiff(t, n, S, i, s);
      A.hitTimeout && (m = !0);
      for (const _ of A.mappings)
        v.push(_);
    }
    p(t.length - x);
    const b = Ms(v, t, n);
    let w = [];
    return r.computeMoves && (w = this.computeMoves(b, t, n, l, u, i, s)), Sn(() => {
      function S(A, _) {
        if (A.lineNumber < 1 || A.lineNumber > _.length)
          return !1;
        const E = _[A.lineNumber - 1];
        return !(A.column < 1 || A.column > E.length + 1);
      }
      function N(A, _) {
      ...
      for (const A of b) {
        if (!A.innerChanges)
          return !1;
        for (const _ of A.innerChanges)
          if (!(S(_.modifiedRange.getStartPosition(), n) && S(_.modifiedRange.getEndPosition(), n) && S(_.originalRange.getStartPosition(), t) && S(_.originalRange.getEndPosition(), t)))
            return !1;
        if (!N(A.modified, n) || !N(A.original, t))
          return !1;
      }
      return !0;
    }), new pn(b, w, m);
  ...
  computeMoves(t, n, r, i, s, a, o) {
    return Ql(t, n, r, i, s, a).map((f) => {
      const h = this.refineDiff(n, r, new te(f.original.toOffsetRange(), f.modified.toOffsetRange()), a, o), d = Ms(h.mappings, n, r, !0);
      return new Gr(f, d);
    });
  }
  refineDiff(t, n, r, i, s) {
    const a = new _n(t, r.seq1Range, s), o = new _n(n, r.seq2Range, s), l = a.length + o.length < 500 ? this.dynamicProgrammingDiffing.compute(a, o, i) : this.myersDiffingAlgorithm.compute(a, o, i);
    let u = l.diffs;
    return u = _s(a, o, u), u = iu(a, o, u), u = ru(a, o, u), u = ou(a, o, u), {
      mappings: u.map((h) => new zt(a.translateRange(h.seq1Range), o.translateRange(h.seq2Range))),
...
function Ms(e, t, n, r = !1) {
  const i = [];
  for (const s of ro(e.map((a) => uu(a, t, n)), (a, o) => a.original.overlapOrTouch(o.original) || a.modified.overlapOrTouch(o.modified))) {
  ...
  return Sn(() => !r && i.length > 0 && i[0].original.startLineNumber !== i[0].modified.startLineNumber ? !1 : Pa(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), i;
}
function uu(e, t, n) {
  let r = 0, i = 0;
...
class Se {
  ...
  static fromRGBA(t) {
    ...
    const f = (o + a) / 2, h = a - o;
    if (h > 0) {
      switch (u = Math.min(f <= 0.5 ? h / (2 * f) : h / (2 - 2 * f), 1), a) {
        case n:
          l = (r - i) / h + (r < i ? 6 : 0);
          break;
        case r:
  ...
  static toRGBA(t) {
    ...
    if (r === 0)
      ...
      const u = i < 0.5 ? i * (1 + r) : i + r - i * r, f = 2 * i - u;
      a = Se._hue2rgb(f, u, n + 1 / 3), o = Se._hue2rgb(f, u, n), l = Se._hue2rgb(f, u, n - 1 / 3);
    }
    return new se(Math.round(a * 255), Math.round(o * 255), Math.round(l * 255), s);
  }
}
class xt {
  constructor(t, n, r, i) {
  ...
  static fromRGBA(t) {
    ...
    let u;
    return o === 0 ? u = 0 : s === n ? u = ((r - i) / o % 6 + 6) % 6 : s === r ? u = (i - n) / o + 2 : u = (n - r) / o + 4, new xt(Math.round(u * 60), l, s, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: r, v: i, a: s } = t, a = i * r, o = a * (1 - Math.abs(n / 60 % 2 - 1)), l = i - a;
    let [u, f, h] = [0, 0, 0];
    return n < 60 ? (u = a, f = o) : n < 120 ? (u = o, f = a) : n < 180 ? (f = a, h = o) : n < 240 ? (f = o, h = a) : n < 300 ? (u = o, h = a) : n <= 360 && (u = a, h = o), u = Math.round((u + l) * 255), f = Math.round((f + l) * 255), h = Math.round((h + l) * 255), new se(u, f, h, s);
  }
}
var J;
let Cn = (J = class {
  ...
  get hsva() {
    return this._hsva ? this._hsva : xt.fromRGBA(this.rgba);
  }
  constructor(t) {
    if (t)
      if (t instanceof se)
        ...
        this._hsva = t, this.rgba = xt.toRGBA(t);
      else
  ...
  equals(t) {
    return !!t && se.equals(this.rgba, t.rgba) && Se.equals(this.hsla, t.hsla) && xt.equals(this.hsva, t.hsva);
  }
  ...
  opposite() {
    return new J(new se(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(t) {
  ...
  flatten(...t) {
    const n = t.reduceRight((r, i) => J._flatten(i, r));
...
}, J.white = new J(new se(255, 255, 255, 1)), J.black = new J(new se(0, 0, 0, 1)), J.red = new J(new se(255, 0, 0, 1)), J.blue = new J(new se(0, 0, 255, 1)), J.green = new J(new se(0, 255, 0, 1)), J.cyan = new J(new se(0, 255, 255, 1)), J.lightgrey = new J(new se(211, 211, 211, 1)), J.transparent = new J(new se(0, 0, 0, 0)), J);
(function(e) {
  (function(t) {
    (function(n) {
      function r(g) {
      ...
      function h(g) {
        ...
        if (m === 0 || g.charCodeAt(0) !== 35)
          return null;
        if (m === 7) {
          const v = 16 * d(g.charCodeAt(1)) + d(g.charCodeAt(2)), p = 16 * d(g.charCodeAt(3)) + d(g.charCodeAt(4)), x = 16 * d(g.charCodeAt(5)) + d(g.charCodeAt(6));
          return new e(new se(v, p, x, 1));
        }
        if (m === 9) {
          const v = 16 * d(g.charCodeAt(1)) + d(g.charCodeAt(2)), p = 16 * d(g.charCodeAt(3)) + d(g.charCodeAt(4)), x = 16 * d(g.charCodeAt(5)) + d(g.charCodeAt(6)), y = 16 * d(g.charCodeAt(7)) + d(g.charCodeAt(8));
          return new e(new se(v, p, x, y / 255));
        }
        if (m === 4) {
          const v = d(g.charCodeAt(1)), p = d(g.charCodeAt(2)), x = d(g.charCodeAt(3));
          return new e(new se(16 * v + v, 16 * p + p, 16 * x + x));
        }
        if (m === 5) {
          const v = d(g.charCodeAt(1)), p = d(g.charCodeAt(2)), x = d(g.charCodeAt(3)), y = d(g.charCodeAt(4));
          return new e(new se(16 * v + v, 16 * p + p, 16 * x + x, (16 * y + y) / 255));
        }
        return null;
      }
      n.parseHex = h;
...
function cu(e, t) {
  ...
  if (n)
    return {
      range: e,
      color: Jr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    };
}
function Ts(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const i = t[0].values(), s = Va(i);
  return {
    range: e,
    color: Jr(s[0], s[1], s[2], n ? s[3] : 1)
  };
}
function Ps(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const i = t[0].values(), s = Va(i), a = new Cn(new Se(
    s[0],
    s[1] / 100,
    s[2] / 100,
    n ? s[3] : 1
  ...
  return {
    range: e,
    color: Jr(a.rgba.r, a.rgba.g, a.rgba.b, a.rgba.a)
  };
}
function Ft(e, t) {
...
function fu(e) {
  const t = [], r = Ft(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (r.length > 0)
    for (const i of r) {
...
function hu(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : fu(e);
}
class du extends vl {
  get uri() {
    return this._uri;
  ...
  findMatches(t) {
    ...
    for (let r = 0; r < this._lines.length; r++) {
      const i = this._lines[r], s = this.offsetAt(new Te(r + 1, 1)), a = i.matchAll(t);
      for (const o of a)
  ...
  getWordAtPosition(t, n) {
    const r = Wr(t.column, Ma(n), this._lines[t.lineNumber - 1], 0);
    return r ? new ee(
      t.lineNumber,
      r.startColumn,
      t.lineNumber,
...
const Ke = class Ke {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new du($r.parse(t.url), t.lines, t.EOL, t.versionId);
  }
  ...
  async computeUnicodeHighlights(t, n, r) {
    ...
    return i ? jl.computeUnicodeHighlights(i, n, r) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  async computeDiff(t, n, r, i) {
    const s = this._getModel(t), a = this._getModel(n);
    return !s || !a ? null : Ke.computeDiff(s, a, r, i);
  }
  static computeDiff(t, n, r, i) {
    const s = i === "advanced" ? Jn.getDefault() : Jn.getLegacy(), a = t.getLinesContent(), o = n.getLinesContent(), l = s.computeDiff(a, o, r), u = l.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function f(h) {
      return h.map(
        (d) => {
          var g;
          return [d.original.startLineNumber, d.original.endLineNumberExclusive, d.modified.startLineNumber, d.modified.endLineNumberExclusive, (g = d.innerChanges) == null ? void 0 : g.map((m) => [
  ...
  async computeMoreMinimalEdits(t, n, r) {
    ...
    n = n.slice(0).sort((l, u) => {
      if (l.range && u.range)
        return ee.compareRangesUsingStarts(l.range, u.range);
      const f = l.range ? 0 : 1, h = u.range ? 0 : 1;
      return f - h;
    });
    let o = 0;
    for (let l = 1; l < n.length; l++)
      ee.getEndPosition(n[o].range).equals(ee.getStartPosition(n[l].range)) ? (n[o].range = ee.fromPositions(ee.getStartPosition(n[o].range), ee.getEndPosition(n[l].range)), n[o].text += n[l].text) : (o++, n[o] = n[l]);
    n.length = o + 1;
    for (let { range: l, text: u, eol: f } of n) {
      if (typeof f == "number" && (a = f), ee.isEmpty(l) && !u)
        continue;
      const h = i.getValueInRange(l);
      if (u = u.replace(/\r\n|\n|\r/g, i.eol), h === u)
        continue;
      if (Math.max(u.length, h.length) > Ke._diffLimit) {
        s.push({ range: l, text: u });
        continue;
      }
      const d = Zo(h, u, r), g = i.offsetAt(ee.lift(l).getStartPosition());
      for (const m of d) {
        const v = i.positionAt(g + m.originalStart), p = i.positionAt(g + m.originalStart + m.originalLength), x = {
  ...
  computeHumanReadableDiff(t, n, r) {
    ...
    const s = [];
    let a;
    n = n.slice(0).sort((u, f) => {
      if (u.range && f.range)
        return ee.compareRangesUsingStarts(u.range, f.range);
      const h = u.range ? 0 : 1, d = f.range ? 0 : 1;
      return h - d;
    });
    for (let { range: u, text: f, eol: h } of n) {
      let x = function(b, w) {
        return new Te(
          b.lineNumber + w.lineNumber - 1,
          w.lineNumber === 1 ? b.column + w.column - 1 : w.column
        );
      }, y = function(b, w) {
        const S = [];
        for (let N = w.startLineNumber; N <= w.endLineNumber; N++) {
          const A = b[N - 1];
          N === w.startLineNumber && N === w.endLineNumber ? S.push(A.substring(w.startColumn - 1, w.endColumn - 1)) : N === w.startLineNumber ? S.push(A.substring(w.startColumn - 1)) : N === w.endLineNumber ? S.push(A.substring(0, w.endColumn - 1)) : S.push(A);
        }
        return S;
      };
      var o = x, l = y;
      if (typeof h == "number" && (a = h), ee.isEmpty(u) && !f)
        continue;
      const d = i.getValueInRange(u);
      if (f = f.replace(/\r\n|\n|\r/g, i.eol), d === f)
        continue;
      if (Math.max(f.length, d.length) > Ke._diffLimit) {
        s.push({ range: u, text: f });
        continue;
      }
      const g = d.split(/\r\n|\n|\r/), m = f.split(/\r\n|\n|\r/), v = Jn.getDefault().computeDiff(g, m, r), p = ee.lift(u).getStartPosition();
      for (const b of v.changes)
        if (b.innerChanges)
          for (const w of b.innerChanges)
            s.push({
              range: ee.fromPositions(x(p, w.originalRange.getStartPosition()), x(p, w.originalRange.getEndPosition())),
              text: y(m, w.modifiedRange).join(i.eol)
            });
        else
          throw new Ue("The experimental diff algorithm always produces inner changes");
    }
    return typeof a == "number" && s.push({ eol: a, text: "", range: { startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0 } }), s;
  }
  ...
  async textualSuggest(t, n, r, i) {
    const s = new jn(), a = new RegExp(r, i), o = /* @__PURE__ */ new Set();
    e:
      for (const l of t) {
        const u = this._getModel(l);
        if (u) {
          for (const f of u.words(a))
            if (!(f === n || !isNaN(Number(f))) && (o.add(f), o.size > Ke._suggestionsLimit))
              break e;
        }
      }
  ...
  async navigateValueSet(t, n, r, i, s) {
    ...
    return gr.INSTANCE.navigateValueSet(n, l, u, f, r);
  }
  loadForeignModule(t, n, r) {
    const a = {
      host: yo(r, (o, l) => this._host.fhr(o, l)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(a, n), Promise.resolve(or(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"));
  }
  fmr(t, n) {
...
Ke._diffLimit = 1e5, Ke._suggestionsLimit = 1e4;
let Ar = Ke;
typeof importScripts == "function" && (globalThis.monaco = Pl());
let _r = !1;
function Oa(e) {
  if (_r)
    return;
...
function Xr(e, t) {
  t === void 0 && (t = !1);
  var n = e.length, r = 0, i = "", s = 0, a = 16, o = 0, l = 0, u = 0, f = 0, h = 0;
  function d(b, w) {
    for (var S = 0, N = 0; S < b || !w; ) {
  ...
  function m() {
    ...
    if (e.charCodeAt(r) === 48)
      ...
      for (r++; r < e.length && pt(e.charCodeAt(r)); )
        r++;
    if (r < e.length && e.charCodeAt(r) === 46)
      if (r++, r < e.length && pt(e.charCodeAt(r)))
        for (r++; r < e.length && pt(e.charCodeAt(r)); )
          r++;
      else
        return h = 3, e.substring(b, r);
    var w = r;
    if (r < e.length && (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101))
      if (r++, (r < e.length && e.charCodeAt(r) === 43 || e.charCodeAt(r) === 45) && r++, r < e.length && pt(e.charCodeAt(r))) {
        for (r++; r < e.length && pt(e.charCodeAt(r)); )
          r++;
        w = r;
      } else
...
`;
          ...
          case 117:
            var A = d(4, !0);
            A >= 0 ? b += String.fromCharCode(A) : h = 4;
            break;
          default:
            h = 5;
        }
    ...
    switch (b) {
      ...
      case 47:
        ...
        if (e.charCodeAt(r + 1) === 47) {
          for (r += 2; r < n && !It(e.charCodeAt(r)); )
            r++;
          return i = e.substring(w, r), a = 12;
        }
        if (e.charCodeAt(r + 1) === 42) {
          r += 2;
          for (var S = n - 1, N = !1; r < S; ) {
            var A = e.charCodeAt(r);
            if (A === 42 && e.charCodeAt(r + 1) === 47) {
              r += 2, N = !0;
              break;
            }
            r++, It(A) && (A === 13 && e.charCodeAt(r) === 10 && r++, o++, u = r);
          }
          return N || (r++, h = 1), i = e.substring(w, r), a = 13;
        }
        return i += String.fromCharCode(b), r++, a = 16;
      case 45:
        if (i += String.fromCharCode(b), r++, r === n || !pt(e.charCodeAt(r)))
          return a = 16;
      case 48:
      case 49:
      case 50:
...
function gu(e, t, n) {
  var r, i, s, a, o;
  if (t) {
    for (a = t.offset, o = a + t.length, s = a; s > 0 && !Fs(e, s - 1); )
      s--;
    for (var l = o; l < e.length && !Fs(e, l); )
      l++;
    i = e.substring(s, l), r = mu(i, n);
  } else
    i = e, r = 0, s = 0, a = 0, o = e.length;
  var u = pu(n, e), f = !1, h = 0, d;
  n.insertSpaces ? d = Qn(" ", n.tabSize || 4) : d = "	";
  var g = Xr(i, !1), m = !1;
  function v() {
    return u + Qn(d, r + h);
  }
  ...
  var x = [];
  function y(L, T, F) {
    !m && (!t || T < o && F > a) && e.substring(T, F) !== L && x.push({ offset: T, length: F - T, content: L });
  }
  var b = p();
  if (b !== 17) {
    var w = g.getTokenOffset() + s, S = Qn(d, r);
    y(S, s, w);
  }
  for (; b !== 17; ) {
    for (var N = g.getTokenOffset() + g.getTokenLength() + s, A = p(), _ = "", E = !1; !f && (A === 12 || A === 13); ) {
      var I = g.getTokenOffset() + s;
      y(" ", N, I), N = g.getTokenOffset() + g.getTokenLength() + s, E = A === 12, _ = E ? v() : "", A = p();
    }
    if (A === 2)
      b !== 1 && (h--, _ = v());
    else if (A === 4)
...
function vu(e, t, n) {
  t === void 0 && (t = []), n === void 0 && (n = kn.DEFAULT);
  var r = null, i = [], s = [];
  function a(l) {
...
function xu(e, t, n) {
  ...
  function s(E) {
    return E ? function(I) {
      return E(I, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter());
    } : function() {
      return !0;
    };
  }
  var a = i(t.onObjectBegin), o = s(t.onObjectProperty), l = i(t.onObjectEnd), u = i(t.onArrayBegin), f = i(t.onArrayEnd), h = s(t.onLiteralValue), d = s(t.onSeparator), g = i(t.onComment), m = s(t.onError), v = n && n.disallowComments, p = n && n.allowTrailingComma;
  function x() {
    for (; ; ) {
      var E = r.scan();
  ...
  function y(E, I, k) {
    if (I === void 0 && (I = []), k === void 0 && (k = []), m(E), I.length + k.length > 0)
  ...
  function b(E) {
    ...
    return E ? h(I) : o(I), x(), !0;
  }
  function w() {
    switch (r.getToken()) {
      case 11:
        var E = r.getTokenValue(), I = Number(E);
        isNaN(I) && (y(
          2
          /* InvalidNumberFormat */
        ), I = 0), h(I);
  ...
  function S() {
    return r.getToken() !== 10 ? (y(3, [], [
      2,
      5
      /* CommaToken */
    ]), !1) : (b(!1), r.getToken() === 6 ? (d(":"), x(), _() || y(4, [], [
      2,
      5
      /* CommaToken */
    ])) : y(5, [], [
  ...
  function N() {
    a(), x();
    for (var E = !1; r.getToken() !== 2 && r.getToken() !== 17; ) {
      if (r.getToken() === 5) {
        if (E || y(4, [], []), d(","), x(), r.getToken() === 2 && p)
          break;
      } else
        E && y(6, [], []);
      S() || y(4, [], [
  ...
  function A() {
    u(), x();
    for (var E = !1; r.getToken() !== 4 && r.getToken() !== 17; ) {
      if (r.getToken() === 5) {
        if (E || y(4, [], []), d(","), x(), r.getToken() === 4 && p)
          break;
      } else
        E && y(6, [], []);
      _() || y(4, [], [
  ...
  return x(), r.getToken() === 17 ? n.allowEmptyContent ? !0 : (y(4, [], []), !1) : _() ? (r.getToken() !== 17 && y(9, [], []), !0) : (y(4, [], []), !1);
}
var _t = Xr, yu = vu, wu = qa, Nu = ja, Lu = Cr;
function Su(e, t, n) {
  return gu(e, t, n);
}
function jt(e, t) {
...
(function(e) {
  function t(r, i) {
    return r === Number.MAX_VALUE && (r = Rn.MAX_VALUE), i === Number.MAX_VALUE && (i = Rn.MAX_VALUE), { line: r, character: i };
  }
  e.create = t;
  function n(r) {
    var i = r;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && Q.is(i.range) && (R.string(i.uri) || R.undefined(i.uri));
  }
  e.is = n;
})(Xt || (Xt = {}));
var Ds;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && Q.is(i.targetRange) && R.string(i.targetUri) && (Q.is(i.targetSelectionRange) || R.undefined(i.targetSelectionRange)) && (Q.is(i.originSelectionRange) || R.undefined(i.originSelectionRange));
  }
  e.is = n;
})(Ds || (Ds = {}));
var kr;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return Q.is(i.range) && kr.is(i.color);
  }
  e.is = n;
})(Vs || (Vs = {}));
var Os;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && Xt.is(i.location) && R.string(i.message);
  }
  e.is = n;
})(Er || (Er = {}));
var Le;
...
(function(e) {
  ...
  function n(r) {
    var i, s = r;
    return R.defined(s) && Q.is(s.range) && R.string(s.message) && (R.number(s.severity) || R.undefined(s.severity)) && (R.integer(s.code) || R.string(s.code) || R.undefined(s.code)) && (R.undefined(s.codeDescription) || R.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (R.string(s.source) || R.undefined(s.source)) && (R.undefined(s.relatedInformation) || R.typedArray(s.relatedInformation, Er.is));
  }
  e.is = n;
})(We || (We = {}));
var Qt;
...
(function(e) {
  ...
  function i(s) {
    var a = s;
    return R.objectLiteral(a) && R.string(a.newText) && Q.is(a.range);
  }
  e.is = i;
})(Me || (Me = {}));
var Ct;
...
(function(e) {
  ...
  function i(s) {
    var a = s;
    return Me.is(a) && (Ct.is(a.annotationId) || he.is(a.annotationId));
  }
  e.is = i;
})(Ye || (Ye = {}));
var Mn;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && Tn.is(i.textDocument) && Array.isArray(i.edits);
  }
  e.is = n;
})(Mn || (Mn = {}));
var Zt;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return i && i.kind === "create" && R.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || R.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || R.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || he.is(i.annotationId));
  }
  e.is = n;
})(Zt || (Zt = {}));
var Yt;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return i && i.kind === "rename" && R.string(i.oldUri) && R.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || R.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || R.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || he.is(i.annotationId));
  }
  e.is = n;
})(Yt || (Yt = {}));
var Kt;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return i && i.kind === "delete" && R.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || R.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || R.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || he.is(i.annotationId));
  }
  e.is = n;
})(Kt || (Kt = {}));
var Rr;
(function(e) {
  function t(n) {
    ...
    return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every(function(i) {
      return R.string(i.kind) ? Zt.is(i) || Yt.is(i) || Kt.is(i) : Mn.is(i);
    }));
  }
  e.is = t;
})(Rr || (Rr = {}));
var rn = (
  ...
  function() {
    ...
    return e.prototype.insert = function(t, n, r) {
      var i, s;
      if (r === void 0 ? i = Me.insert(t, n) : he.is(r) ? (s = r, i = Ye.insert(t, n, r)) : (this.assertChangeAnnotations(this.changeAnnotations), s = this.changeAnnotations.manage(r), i = Ye.insert(t, n, s)), this.edits.push(i), s !== void 0)
        return s;
    }, e.prototype.replace = function(t, n, r) {
      var i, s;
      if (r === void 0 ? i = Me.replace(t, n) : he.is(r) ? (s = r, i = Ye.replace(t, n, r)) : (this.assertChangeAnnotations(this.changeAnnotations), s = this.changeAnnotations.manage(r), i = Ye.replace(t, n, s)), this.edits.push(i), s !== void 0)
        return s;
    }, e.prototype.delete = function(t, n) {
      var r, i;
      if (n === void 0 ? r = Me.del(t) : he.is(n) ? (i = n, r = Ye.del(t, n)) : (this.assertChangeAnnotations(this.changeAnnotations), i = this.changeAnnotations.manage(n), r = Ye.del(t, i)), this.edits.push(r), i !== void 0)
        return i;
  ...
  function() {
    ...
    return e.prototype.all = function() {
      ...
      var r;
      if (he.is(t) ? r = t : (r = this.nextId(), n = t), this._annotations[r] !== void 0)
...
(function() {
  function e(t) {
    var n = this;
    this._textEditChanges = /* @__PURE__ */ Object.create(null), t !== void 0 ? (this._workspaceEdit = t, t.documentChanges ? (this._changeAnnotations = new Us(t.changeAnnotations), t.changeAnnotations = this._changeAnnotations.all(), t.documentChanges.forEach(function(r) {
      if (Mn.is(r)) {
        var i = new rn(r.edits, n._changeAnnotations);
        n._textEditChanges[r.textDocument.uri] = i;
      }
    })) : t.changes && Object.keys(t.changes).forEach(function(r) {
      var i = new rn(t.changes[r]);
  ...
  return Object.defineProperty(e.prototype, "edit", {
    ...
    if (Tn.is(t)) {
      ...
      if (!r) {
        ...
        this._workspaceEdit.documentChanges.push(s), r = new rn(i, this._changeAnnotations), this._textEditChanges[n.uri] = r;
      }
      return r;
    } else {
      ...
      if (!r) {
        var i = [];
        this._workspaceEdit.changes[t] = i, r = new rn(i), this._textEditChanges[t] = r;
      }
      return r;
    }
  }, e.prototype.initDocumentChanges = function() {
    this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new Us(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
    ...
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
      throw new Error("Workspace edit is not configured for document changes.");
    var i;
    Ct.is(n) || he.is(n) ? i = n : r = n;
    var s, a;
    if (i === void 0 ? s = Zt.create(t, r) : (a = he.is(i) ? i : this._changeAnnotations.manage(i), s = Zt.create(t, r, a)), this._workspaceEdit.documentChanges.push(s), a !== void 0)
      return a;
  }, e.prototype.renameFile = function(t, n, r, i) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
      throw new Error("Workspace edit is not configured for document changes.");
    var s;
    Ct.is(r) || he.is(r) ? s = r : i = r;
    var a, o;
    if (s === void 0 ? a = Yt.create(t, n, i) : (o = he.is(s) ? s : this._changeAnnotations.manage(s), a = Yt.create(t, n, i, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0)
      return o;
    ...
    Ct.is(n) || he.is(n) ? i = n : r = n;
    var s, a;
    if (i === void 0 ? s = Kt.create(t, r) : (a = he.is(i) ? i : this._changeAnnotations.manage(i), s = Kt.create(t, r, a)), this._workspaceEdit.documentChanges.push(s), a !== void 0)
      return a;
  }, e;
})();
var $s;
...
(function(e) {
  function t(n) {
    var r = n;
    return R.objectLiteral(n) && He.is(r.kind) && R.string(r.value);
  }
  e.is = t;
})(Mr || (Mr = {}));
var Ne;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return i && R.string(i.newText) && Q.is(i.insert) && Q.is(i.replace);
  }
  e.is = n;
})(Gs || (Gs = {}));
var Js;
...
(function(e) {
  function t(n) {
    var r = n;
    return !!r && R.objectLiteral(r) && (Mr.is(r.contents) || Pn.is(r.contents) || R.typedArray(r.contents, Pn.is)) && (n.range === void 0 || Q.is(n.range));
  }
  e.is = t;
})(Qs || (Qs = {}));
var Zs;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return i && R.string(i.name) && R.number(i.kind) && Q.is(i.range) && Q.is(i.selectionRange) && (i.detail === void 0 || R.string(i.detail)) && (i.deprecated === void 0 || R.boolean(i.deprecated)) && (i.children === void 0 || Array.isArray(i.children)) && (i.tags === void 0 || Array.isArray(i.tags));
  }
  e.is = n;
})(ra || (ra = {}));
var ia;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && R.typedArray(i.diagnostics, We.is) && (i.only === void 0 || R.typedArray(i.only, R.string));
  }
  e.is = n;
})(sa || (sa = {}));
var aa;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return i && R.string(i.title) && (i.diagnostics === void 0 || R.typedArray(i.diagnostics, We.is)) && (i.kind === void 0 || R.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || Qt.is(i.command)) && (i.isPreferred === void 0 || R.boolean(i.isPreferred)) && (i.edit === void 0 || Rr.is(i.edit));
  }
  e.is = n;
})(aa || (aa = {}));
var oa;
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && Q.is(i.range) && (R.undefined(i.command) || Qt.is(i.command));
  }
  e.is = n;
})(oa || (oa = {}));
var la;
...
(function(e) {
  ...
  function n(r) {
    var i = r;
    return R.defined(i) && Q.is(i.range) && (R.undefined(i.target) || R.string(i.target));
  }
  e.is = n;
})(ua || (ua = {}));
var Fn;
...
(function(e) {
  ...
  e.is = n;
  function r(s, a) {
    for (var o = s.getText(), l = i(a, function(m, v) {
      var p = m.range.start.line - v.range.start.line;
      return p === 0 ? m.range.start.character - v.range.start.character : p;
...
(function(e) {
  ...
  e.number = a;
  function o(g, m, v) {
    return t.call(g) === "[object Number]" && m <= g && g <= v;
  }
  e.numberRange = o;
  function l(g) {
...
(function(e) {
  ...
  e.update = n;
  function r(i, s) {
    let a = i.getText(), o = Ir(s.map(ku), (f, h) => {
...
(function(e) {
  e.LATEST = {
    textDocument: {
      completion: {
        completionItem: {
          documentationFormat: [He.Markdown, He.PlainText],
...
var Vu = (
  ...
  function() {
    ...
    return e.prototype.add = function(t) {
      ...
      return (this.focusOffset === -1 || Ua(t, this.focusOffset)) && t !== this.exclude;
    ...
    return e.prototype.hasProblems = function() {
      ...
      if (!this.enumValueMatch && !t.enumValueMatch && this.enumValues && t.enumValues) {
        ...
        for (var n = 0, r = this.problems; n < r.length; n++) {
          var i = r[n];
          i.code === X.EnumValueMismatch && (i.message = j("enumWarning", "Value is not accepted. Valid values: {0}.", this.enumValues.map(function(s) {
...
var $a = (
  ...
  function() {
    ...
    return e.prototype.getNodeFromOffset = function(t, n) {
      ...
      if (r === void 0 && (r = Le.Warning), this.root && n) {
        var i = new be();
        return fe(this.root, n, i, Vr.instance), i.problems.map(function(s) {
          var a, o = Q.create(t.positionAt(s.location.offset), t.positionAt(s.location.offset + s.location.length));
          return We.create(o, s.message, (a = s.severity) !== null && a !== void 0 ? a : r, s.code);
        });
      }
    }, e.prototype.getMatchingSchemas = function(t, n, r) {
      n === void 0 && (n = -1);
      var i = new Vu(n, r);
      return this.root && t && fe(this.root, t, new be(), i), i.schemas;
    }, e;
  }()
);
function fe(e, t, n, r) {
  ...
  function s() {
    ...
    var m = ve(t.not);
    if (m) {
      var v = new be(), p = r.newSub();
      fe(i, m, v, p), v.hasProblems() || n.problems.push({
        location: { offset: i.offset, length: i.length },
        message: j("notSchemaWarning", "Matches a schema that is not allowed.")
      });
      for (var x = 0, y = p.schemas; x < y.length; x++) {
        var b = y[x];
        b.inverted = !b.inverted, r.add(b);
      }
    }
    var w = function(T, F) {
      for (var V = [], O = void 0, M = 0, C = T; M < C.length; M++) {
        var P = C[M], D = ve(P), B = new be(), U = r.newSub();
        if (fe(i, D, B, U), B.hasProblems() || V.push(D), !O)
          O = { schema: D, validationResult: B, matchingSchemas: U };
        else if (!F && !B.hasProblems() && !O.validationResult.hasProblems())
          O.matchingSchemas.merge(U), O.validationResult.propertiesMatches += B.propertiesMatches, O.validationResult.propertiesValueMatches += B.propertiesValueMatches;
        else {
          var G = B.compare(O.validationResult);
          G > 0 ? O = { schema: D, validationResult: B, matchingSchemas: U } : G === 0 && (O.matchingSchemas.merge(U), O.validationResult.mergeEnumValues(B));
        }
      }
      return V.length > 1 && F && n.problems.push({
        location: { offset: i.offset, length: 1 },
        message: j("oneOfWarning", "Matches multiple schemas when only one must validate.")
      }), O && (n.merge(O.validationResult), n.propertiesMatches += O.validationResult.propertiesMatches, n.propertiesValueMatches += O.validationResult.propertiesValueMatches, r.merge(O.matchingSchemas)), V.length;
    };
    Array.isArray(t.anyOf) && w(t.anyOf, !1), Array.isArray(t.oneOf) && w(t.oneOf, !0);
    var S = function(T) {
      var F = new be(), V = r.newSub();
      fe(i, ve(T), F, V), n.merge(F), n.propertiesMatches += F.propertiesMatches, n.propertiesValueMatches += F.propertiesValueMatches, r.merge(V);
    }, N = function(T, F, V) {
      var O = ve(T), M = new be(), C = r.newSub();
      fe(i, O, M, C), r.merge(C), M.hasProblems() ? V && S(V) : F && S(F);
    }, A = ve(t.if);
    if (A && N(A, ve(t.then), ve(t.else)), Array.isArray(t.enum)) {
      for (var _ = ot(i), E = !1, I = 0, k = t.enum; I < k.length; I++) {
        var L = k[I];
        if (jt(_, L)) {
          E = !0;
          break;
      ...
      n.enumValues = t.enum, n.enumValueMatch = E, E || n.problems.push({
        ...
        message: t.errorMessage || j("enumWarning", "Value is not accepted. Valid values: {0}.", t.enum.map(function(T) {
    ...
    if (qe(t.const)) {
      var _ = ot(i);
      jt(_, t.const) ? n.enumValueMatch = !0 : (n.problems.push({
        location: { offset: i.offset, length: i.length },
        code: X.EnumValueMismatch,
  ...
  function a(f, h, d, g) {
    var m = f.value;
    function v(I) {
      var k, L = /^(-?\d+)(?:\.(\d+))?(?:e([-+]\d+))?$/.exec(I.toString());
      return L && {
    ...
    if (ye(h.multipleOf)) {
      ...
      if (Number.isInteger(h.multipleOf))
        ...
        var x = v(h.multipleOf), y = v(m);
        if (x && y) {
          var b = Math.pow(10, Math.abs(y.multiplier - x.multiplier));
          y.multiplier < x.multiplier ? y.value *= b : x.value *= b, p = y.value % x.value;
        }
      }
      p !== 0 && d.problems.push({
        location: { offset: f.offset, length: f.length },
        message: j("multipleOfWarning", "Value is not divisible by {0}.", h.multipleOf)
      });
    }
    function w(I, k) {
      if (ye(k))
    ...
    var N = w(h.minimum, h.exclusiveMinimum);
    ye(N) && m <= N && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("exclusiveMinimumWarning", "Value is below the exclusive minimum of {0}.", N)
    });
    var A = w(h.maximum, h.exclusiveMaximum);
    ye(A) && m >= A && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("exclusiveMaximumWarning", "Value is above the exclusive maximum of {0}.", A)
    });
    var _ = S(h.minimum, h.exclusiveMinimum);
    ye(_) && m < _ && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("minimumWarning", "Value is below the minimum of {0}.", _)
    });
    var E = S(h.maximum, h.exclusiveMaximum);
    ye(E) && m > E && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("maximumWarning", "Value is above the maximum of {0}.", E)
    });
  }
  function o(f, h, d, g) {
    if (ye(h.minLength) && f.value.length < h.minLength && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("minLengthWarning", "String is shorter than the minimum length of {0}.", h.minLength)
    }), ye(h.maxLength) && f.value.length > h.maxLength && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("maxLengthWarning", "String is longer than the maximum length of {0}.", h.maxLength)
    }), Au(h.pattern)) {
      var m = En(h.pattern);
      m != null && m.test(f.value) || d.problems.push({
        location: { offset: f.offset, length: f.length },
        message: h.patternErrorMessage || h.errorMessage || j("patternWarning", 'String does not match the pattern of "{0}".', h.pattern)
      });
    }
    if (h.format)
      switch (h.format) {
        ...
        case "uri-reference":
          {
            var v = void 0;
            if (!f.value)
              v = j("uriEmpty", "URI expected.");
            else {
              var p = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(f.value);
              p ? !p[2] && h.format === "uri" && (v = j("uriSchemeMissing", "URI with a scheme is expected.")) : v = j("uriMissing", "URI is expected.");
            }
            v && d.problems.push({
              location: { offset: f.offset, length: f.length },
              message: h.patternErrorMessage || h.errorMessage || j("uriFormatWarning", "String is not a URI: {0}", v)
            });
          }
          break;
        case "color-hex":
        ...
        case "ipv6":
          var x = Mu[h.format];
          (!f.value || !x.pattern.exec(f.value)) && d.problems.push({
            location: { offset: f.offset, length: f.length },
            message: h.patternErrorMessage || h.errorMessage || x.errorMessage
          });
      }
  }
  function l(f, h, d, g) {
    if (Array.isArray(h.items)) {
      for (var m = h.items, v = 0; v < m.length; v++) {
        var p = m[v], x = ve(p), y = new be(), b = f.items[v];
        b ? (fe(b, x, y, g), d.mergePropertyMatch(y)) : f.items.length >= m.length && d.propertiesValueMatches++;
      }
      if (f.items.length > m.length)
        if (typeof h.additionalItems == "object")
          for (var w = m.length; w < f.items.length; w++) {
            var y = new be();
            fe(f.items[w], h.additionalItems, y, g), d.mergePropertyMatch(y);
          }
        else
      ...
      var S = ve(h.items);
      if (S)
        for (var N = 0, A = f.items; N < A.length; N++) {
          var b = A[N], y = new be();
          fe(b, S, y, g), d.mergePropertyMatch(y);
        }
    }
    var _ = ve(h.contains);
    if (_) {
      var E = f.items.some(function(L) {
        var T = new be();
        return fe(L, _, T, Vr.instance), !T.hasProblems();
      });
      E || d.problems.push({
        location: { offset: f.offset, length: f.length },
        message: h.errorMessage || j("requiredItemMissingWarning", "Array does not contain required item.")
      });
    }
    if (ye(h.minItems) && f.items.length < h.minItems && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("minItemsWarning", "Array has too few items. Expected {0} or more.", h.minItems)
    }), ye(h.maxItems) && f.items.length > h.maxItems && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("maxItemsWarning", "Array has too many items. Expected {0} or fewer.", h.maxItems)
    }), h.uniqueItems === !0) {
      var I = ot(f), k = I.some(function(L, T) {
        return T !== I.lastIndexOf(L);
      });
      k && d.problems.push({
        location: { offset: f.offset, length: f.length },
  ...
  function u(f, h, d, g) {
    for (var m = /* @__PURE__ */ Object.create(null), v = [], p = 0, x = f.properties; p < x.length; p++) {
      var y = x[p], b = y.keyNode.value;
      m[b] = y.valueNode, v.push(b);
    }
    if (Array.isArray(h.required))
      for (var w = 0, S = h.required; w < S.length; w++) {
        var N = S[w];
        if (!m[N]) {
          var A = f.parent && f.parent.type === "property" && f.parent.keyNode, _ = A ? { offset: A.offset, length: A.length } : { offset: f.offset, length: 1 };
          d.problems.push({
            location: _,
            message: j("MissingRequiredPropWarning", 'Missing property "{0}".', N)
          });
        }
      }
    var E = function(ti) {
      for (var Un = v.indexOf(ti); Un >= 0; )
        v.splice(Un, 1), Un = v.indexOf(ti);
    };
    if (h.properties)
      for (var I = 0, k = Object.keys(h.properties); I < k.length; I++) {
        var N = k[I];
        E(N);
        var L = h.properties[N], T = m[N];
        if (T)
          if (Oe(L))
            if (L)
              ...
              d.problems.push({
                ...
                message: h.errorMessage || j("DisallowedExtraPropWarning", "Property {0} is not allowed.", N)
              });
            }
          else {
            var F = new be();
            fe(T, L, F, g), d.mergePropertyMatch(F);
          }
      }
    if (h.patternProperties)
      for (var V = 0, O = Object.keys(h.patternProperties); V < O.length; V++)
        for (var M = O[V], C = En(M), P = 0, D = v.slice(0); P < D.length; P++) {
          var N = D[P];
          if (C != null && C.test(N)) {
            E(N);
            var T = m[N];
            if (T) {
              var L = h.patternProperties[M];
              if (Oe(L))
                if (L)
                  d.propertiesMatches++, d.propertiesValueMatches++;
                else {
    ...
    if (typeof h.additionalProperties == "object")
      for (var B = 0, U = v; B < U.length; B++) {
        ...
        if (T) {
          var F = new be();
          fe(T, h.additionalProperties, F, g), d.mergePropertyMatch(F);
        }
      }
    else if (h.additionalProperties === !1 && v.length > 0)
      for (var G = 0, de = v; G < de.length; G++) {
        var N = de[G], T = m[N];
        if (T) {
          var y = T.parent;
          d.problems.push({
    ...
    if (ye(h.maxProperties) && f.properties.length > h.maxProperties && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("MaxPropWarning", "Object has more properties than limit of {0}.", h.maxProperties)
    }), ye(h.minProperties) && f.properties.length < h.minProperties && d.problems.push({
      location: { offset: f.offset, length: f.length },
      message: j("MinPropWarning", "Object has fewer properties than the required number of {0}", h.minProperties)
    }), h.dependencies)
      for (var le = 0, me = Object.keys(h.dependencies); le < me.length; le++) {
        var b = me[le], ft = m[b];
        if (ft) {
          var Pe = h.dependencies[b];
          if (Array.isArray(Pe))
            for (var qn = 0, Zr = Pe; qn < Zr.length; qn++) {
              var Yr = Zr[qn];
              m[Yr] ? d.propertiesValueMatches++ : d.problems.push({
                location: { offset: f.offset, length: f.length },
                message: j("RequiredDependentPropWarning", "Object is missing property {0} required by property {1}.", Yr, b)
              });
            }
          else {
            var L = ve(Pe);
            if (L) {
              var F = new be();
              fe(f, L, F, g), d.mergePropertyMatch(F);
            }
          }
        }
      }
    var Kr = ve(h.propertyNames);
    if (Kr)
      for (var Bn = 0, ei = f.properties; Bn < ei.length; Bn++) {
        var Xa = ei[Bn], b = Xa.keyNode;
        b && fe(b, Kr, d, Vr.instance);
      }
  }
}
function ju(e, t) {
  var n = [], r = -1, i = e.getText(), s = _t(i, !1), a = t && t.collectComments ? [] : void 0;
  function o() {
    for (; ; ) {
      var N = s.scan();
      switch (f(), N) {
  ...
  function l(N, A, _, E, I) {
    if (I === void 0 && (I = Le.Error), n.length === 0 || _ !== r) {
      var k = Q.create(e.positionAt(_), e.positionAt(E));
      n.push(We.create(k, N, I, A, e.languageId)), r = _;
    }
  }
  function u(N, A, _, E, I) {
    _ === void 0 && (_ = void 0), E === void 0 && (E = []), I === void 0 && (I = []);
    ...
    if (l(N, A, k, L), _ && h(_, !1), E.length + I.length > 0)
  ...
  function f() {
    switch (s.getTokenError()) {
      case 4:
        return u(j("InvalidUnicode", "Invalid unicode sequence in string."), X.InvalidUnicode), !0;
      case 5:
        return u(j("InvalidEscapeCharacter", "Invalid escape character in string."), X.InvalidEscapeCharacter), !0;
      case 3:
        return u(j("UnexpectedEndOfNumber", "Unexpected end of number."), X.UnexpectedEndOfNumber), !0;
      case 1:
        return u(j("UnexpectedEndOfComment", "Unexpected end of comment."), X.UnexpectedEndOfComment), !0;
      case 2:
        return u(j("UnexpectedEndOfString", "Unexpected end of string."), X.UnexpectedEndOfString), !0;
      case 6:
        return u(j("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."), X.InvalidCharacter), !0;
    }
    return !1;
  }
  function h(N, A) {
    return N.length = s.getTokenOffset() + s.getTokenLength() - N.offset, A && o(), N;
  }
  function d(N) {
    if (s.getToken() === 3) {
      var A = new Pu(N, s.getTokenOffset());
      o();
      for (var _ = !1; s.getToken() !== 4 && s.getToken() !== 17; ) {
        if (s.getToken() === 5) {
          _ || u(j("ValueExpected", "Value expected"), X.ValueExpected);
          var E = s.getTokenOffset();
          if (o(), s.getToken() === 4) {
            _ && l(j("TrailingComma", "Trailing comma"), X.TrailingComma, E, E + 1);
            continue;
          }
        } else
          _ && u(j("ExpectedComma", "Expected comma"), X.CommaExpected);
        var I = b(A);
        I ? A.items.push(I) : u(j("PropertyExpected", "Value expected"), X.ValueExpected, void 0, [], [
          4,
          5
          /* CommaToken */
        ]), _ = !0;
      }
      return s.getToken() !== 4 ? u(j("ExpectedCloseBracket", "Expected comma or closing bracket"), X.CommaOrCloseBacketExpected, A) : h(A, !0);
    }
  }
  var g = new Zn(void 0, 0, 0);
  function m(N, A) {
    var _ = new Iu(N, s.getTokenOffset(), g), E = p(_);
    if (!E)
      if (s.getToken() === 16) {
        u(j("DoubleQuotesExpected", "Property keys must be doublequoted"), X.Undefined);
        var I = new Zn(_, s.getTokenOffset(), s.getTokenLength());
        I.value = s.getTokenValue(), E = I, o();
      } else
        return;
    _.keyNode = E;
    var k = A[E.value];
    if (k ? (l(j("DuplicateKeyWarning", "Duplicate object key"), X.DuplicateKey, _.keyNode.offset, _.keyNode.offset + _.keyNode.length, Le.Warning), typeof k == "object" && l(j("DuplicateKeyWarning", "Duplicate object key"), X.DuplicateKey, k.keyNode.offset, k.keyNode.offset + k.keyNode.length, Le.Warning), A[E.value] = !0) : A[E.value] = _, s.getToken() === 6)
      _.colonOffset = s.getTokenOffset(), o();
    else if (u(j("ColonExpected", "Colon expected"), X.ColonExpected), s.getToken() === 10 && e.positionAt(E.offset + E.length).line < e.positionAt(s.getTokenOffset()).line)
      return _.length = E.length, _;
    var L = b(_);
    return L ? (_.valueNode = L, _.length = L.offset + L.length - _.offset, _) : u(j("ValueExpected", "Value expected"), X.ValueExpected, _, [], [
      2,
      5
      /* CommaToken */
    ]);
  ...
  function v(N) {
    if (s.getToken() === 1) {
      var A = new Du(N, s.getTokenOffset()), _ = /* @__PURE__ */ Object.create(null);
      o();
      for (var E = !1; s.getToken() !== 2 && s.getToken() !== 17; ) {
        if (s.getToken() === 5) {
          E || u(j("PropertyExpected", "Property expected"), X.PropertyExpected);
          var I = s.getTokenOffset();
          if (o(), s.getToken() === 2) {
            E && l(j("TrailingComma", "Trailing comma"), X.TrailingComma, I, I + 1);
            continue;
          }
        } else
          E && u(j("ExpectedComma", "Expected comma"), X.CommaExpected);
        var k = m(A, _);
        k ? A.properties.push(k) : u(j("PropertyExpected", "Property expected"), X.PropertyExpected, void 0, [], [
          2,
          5
          /* CommaToken */
        ]), E = !0;
      }
      return s.getToken() !== 2 ? u(j("ExpectedCloseBrace", "Expected comma or closing brace"), X.CommaOrCloseBraceExpected, A) : h(A, !0);
    }
  }
  function p(N) {
    if (s.getToken() === 10) {
      var A = new Zn(N, s.getTokenOffset());
      return A.value = s.getTokenValue(), h(A, !0);
    }
  }
  function x(N) {
    if (s.getToken() === 11) {
      var A = new Fu(N, s.getTokenOffset());
      if (s.getTokenError() === 0) {
        var _ = s.getTokenValue();
        try {
          var E = JSON.parse(_);
          if (!ye(E))
            return u(j("InvalidNumberFormat", "Invalid number format."), X.Undefined, A);
          A.value = E;
        } catch {
          return u(j("InvalidNumberFormat", "Invalid number format."), X.Undefined, A);
        }
  ...
  function y(N) {
    switch (s.getToken()) {
      case 7:
        return h(new Tu(N, s.getTokenOffset()), !0);
      case 8:
        return h(new da(N, !0, s.getTokenOffset()), !0);
      case 9:
        return h(new da(N, !1, s.getTokenOffset()), !0);
      default:
        return;
    }
  }
  function b(N) {
    return d(N) || v(N) || p(N) || x(N) || y(N);
  }
  var w = void 0, S = o();
  return S !== 17 && (w = b(w), w ? s.getToken() !== 17 && u(j("End of file expected", "End of file expected."), X.Undefined) : u(j("Invalid symbol", "Expected a JSON object, array or literal."), X.Undefined)), new $a(w, n, a);
}
function jr(e, t, n) {
  if (e !== null && typeof e == "object") {
    var r = t + "	";
    if (Array.isArray(e)) {
      ...
      for (var i = `[
`, s = 0; s < e.length; s++)
        i += r + jr(e[s], r, n), s < e.length - 1 && (i += ","), i += `
`;
      return i += t + "]", i;
    } else {
      var a = Object.keys(e);
...
`, s = 0; s < a.length; s++) {
        var o = a[s];
        i += r + JSON.stringify(o) + ": " + jr(e[o], r, n), s < a.length - 1 && (i += ","), i += `
`;
      }
      return i += t + "}", i;
    }
  ...
  function() {
    ...
    return e.prototype.doResolve = function(t) {
      ...
      if (l && (l.type === "string" || l.type === "number" || l.type === "boolean" || l.type === "null"))
        h = Q.create(t.positionAt(l.offset), t.positionAt(l.offset + l.length));
      else {
        var d = o - f.length;
        d > 0 && a[d - 1] === '"' && d--, h = Q.create(t.positionAt(d), n);
      }
      var g = {}, m = {
        add: function(v) {
          var p = v.label, x = g[p];
          if (x)
            x.documentation || (x.documentation = v.documentation), x.detail || (x.detail = v.detail);
          else {
            if (p = p.replace(/[\n]/g, "↵"), p.length > 60) {
              var y = p.substr(0, 57).trim() + "...";
              g[y] || (p = y);
            }
            h && v.insertText !== void 0 && (v.textEdit = Me.replace(h, v.insertText)), v.label = p, g[p] = v, s.items.push(v);
          }
        },
      ...
      return this.schemaService.getSchemaForResource(t.uri, r).then(function(v) {
        var p = [], x = !0, y = "", b = void 0;
        if (l && l.type === "string") {
          var w = l.parent;
          w && w.type === "property" && w.keyNode === l && (x = !w.valueNode, b = w, y = a.substr(l.offset + 1, l.length - 2), w && (l = w.parent));
        }
        if (l && l.type === "object") {
          if (l.offset === o)
            return s;
          ...
          S.forEach(function(E) {
            (!b || b !== E) && (g[E.keyNode.value] = Tr.create("__"));
          });
          var N = "";
          x && (N = i.evaluateSeparatorAfter(t, t.offsetAt(h.end))), v ? i.getPropertyCompletions(v, r, l, x, N, m) : i.getSchemaLessPropertyCompletions(r, l, y, m);
          var A = Or(l);
          i.contributions.forEach(function(E) {
            var I = E.collectPropertyCompletions(t.uri, A, f, x, N === "", m);
            I && p.push(I);
          }), !v && f.length > 0 && a.charAt(o - f.length - 1) !== '"' && (m.add({
            kind: Ne.Property,
            label: i.getLabelForValue(f),
            insertText: i.getInsertTextForProperty(f, void 0, !1, N),
            insertTextFormat: ae.Snippet,
            documentation: ""
          }), m.setAsIncomplete());
        }
        var _ = {};
        return v ? i.getValueCompletions(v, r, l, o, t, m, _) : i.getSchemaLessValueCompletions(r, l, o, t, m), i.contributions.length > 0 && i.getContributedValueCompletions(r, l, o, t, m, p), i.promiseConstructor.all(p).then(function() {
          if (m.getNumberOfProposals() === 0) {
            var E = o;
            l && (l.type === "string" || l.type === "number" || l.type === "boolean" || l.type === "null") && (E = l.offset + l.length);
            var I = i.evaluateSeparatorAfter(t, E);
            i.addFillerValueCompletions(_, I, m);
          }
          return s;
        });
      });
      ...
      l.forEach(function(u) {
        if (u.node === r && !u.inverted) {
          ...
          f && Object.keys(f).forEach(function(v) {
            var p = f[v];
            if (typeof p == "object" && !p.deprecationMessage && !p.doNotSuggest) {
              var x = {
                kind: Ne.Property,
                label: v,
                insertText: o.getInsertTextForProperty(v, p, i, s),
                insertTextFormat: ae.Snippet,
                filterText: o.getFilterTextForValue(v),
                documentation: o.fromMarkup(p.markdownDescription) || p.description || ""
              };
              p.suggestSortText !== void 0 && (x.sortText = p.suggestSortText), x.insertText && Jt(x.insertText, "$1".concat(s)) && (x.command = {
                title: "Suggest",
          ...
          if (typeof h == "object" && !h.deprecationMessage && !h.doNotSuggest) {
            var d = function(v, p) {
              ...
              var x = {
                ...
                insertTextFormat: ae.Snippet,
                filterText: o.getFilterTextForValue(v),
                documentation: p || o.fromMarkup(h.markdownDescription) || h.description || ""
              };
              h.suggestSortText !== void 0 && (x.sortText = h.suggestSortText), x.insertText && Jt(x.insertText, "$1".concat(s)) && (x.command = {
                title: "Suggest",
                command: "editor.action.triggerSuggest"
              }), a.add(x);
            };
            if (h.enum)
              for (var g = 0; g < h.enum.length; g++) {
                var m = void 0;
                h.markdownEnumDescriptions && g < h.markdownEnumDescriptions.length ? m = o.fromMarkup(h.markdownEnumDescriptions[g]) : h.enumDescriptions && g < h.enumDescriptions.length && (m = h.enumDescriptions[g]), d(h.enum[g], m);
              }
            h.const && d(h.const);
          }
        }
      ...
      var l = this.evaluateSeparatorAfter(i, o), u = function(g) {
        g.parent && !Ua(g.parent, r, !0) && s.add({
      ...
      if (n.type === "property" && r > (n.colonOffset || 0)) {
        ...
        if (f && (r > f.offset + f.length || f.type === "object" || f.type === "array"))
          return;
        var h = n.keyNode.value;
        t.visit(function(g) {
          return g.type === "property" && g.keyNode.value === h && g.valueNode && u(g.valueNode), !0;
        }), h === "$schema" && n.parent && !n.parent.parent && this.addDollarSchemaCompletions(l, s);
      }
      if (n.type === "array")
      ...
      if (r && (r.type === "string" || r.type === "number" || r.type === "boolean" || r.type === "null") && (l = r.offset + r.length, f = r, r = r.parent), !r) {
      ...
      if (r && (u !== void 0 || r.type === "array")) {
        for (var d = this.evaluateSeparatorAfter(s, l), g = n.getMatchingSchemas(t.schema, r.offset, f), m = 0, v = g; m < v.length; m++) {
          var p = v[m];
          if (p.node === r && !p.inverted && p.schema) {
            if (r.type === "array" && p.schema.items)
              if (Array.isArray(p.schema.items)) {
                var x = this.findItemAtOffset(r, s, i);
                x < p.schema.items.length && this.addSchemaValueCompletions(p.schema.items[x], d, a, o);
              } else
                this.addSchemaValueCompletions(p.schema.items, d, a, o);
            if (u !== void 0) {
              var y = !1;
              if (p.schema.properties) {
                var b = p.schema.properties[u];
                b && (y = !0, this.addSchemaValueCompletions(b, d, a, o));
              }
              if (p.schema.patternProperties && !y)
                for (var w = 0, S = Object.keys(p.schema.patternProperties); w < S.length; w++) {
                  var N = S[w], A = En(N);
                  if (A != null && A.test(u)) {
                    y = !0;
                    var b = p.schema.patternProperties[N];
                    this.addSchemaValueCompletions(b, d, a, o);
                  }
                }
              if (p.schema.additionalProperties && !y) {
                var b = p.schema.additionalProperties;
                this.addSchemaValueCompletions(b, d, a, o);
              }
            }
          }
      ...
      if (qe(t.default)) {
        ...
        r.add({
          ...
          insertTextFormat: ae.Snippet,
          detail: Yn("json.suggest.default", "Default value")
        }), a = !0;
      }
      Array.isArray(t.examples) && t.examples.forEach(function(f) {
        ...
        var h = t.type, d = f.body, g = f.label, m, v;
        if (qe(d)) {
          t.type;
          for (var p = i; p > 0; p--)
            d = [d];
          m = s.getInsertTextForSnippetValue(d, n), v = s.getFilterTextForSnippetValue(d), g = g || s.getLabelForSnippetValue(d);
        } else if (typeof f.bodyText == "string") {
          for (var x = "", y = "", b = "", p = i; p > 0; p--)
            x = x + b + `[
`, y = y + `
` + b + "]", b += "	", h = "array";
          m = x + b + f.bodyText.split(`
`).join(`
` + b) + y + n, g = g || m, v = m.replace(/[\n]/g, "");
        } else
          return;
        r.add({
          kind: s.getSuggestionKind(h),
      ...
      if (!(Array.isArray(t.enum) || qe(t.const))) {
        var r = t.type;
      ...
      t.object && r.add({
        ...
        insertTextFormat: ae.Snippet,
        detail: Yn("defaults.object", "New object"),
        documentation: ""
      }), t.array && r.add({
        kind: this.getSuggestionKind("array"),
        label: "[]",
        insertText: this.getInsertTextForGuessedValue([], n),
        insertTextFormat: ae.Snippet,
        detail: Yn("defaults.array", "New array"),
        documentation: ""
      });
      ...
      if (n) {
        if (Array.isArray(n.defaultSnippets)) {
          if (n.defaultSnippets.length === 1) {
            ...
            qe(u) && (o = this.getInsertTextForSnippetValue(u, ""));
          }
          l += n.defaultSnippets.length;
        }
        if (n.enum && (!o && n.enum.length === 1 && (o = this.getInsertTextForGuessedValue(n.enum[0], "")), l += n.enum.length), qe(n.default) && (o || (o = this.getInsertTextForGuessedValue(n.default, "")), l++), Array.isArray(n.examples) && n.examples.length && (o || (o = this.getInsertTextForGuessedValue(n.examples[0], "")), l += n.examples.length), l === 0) {
          var f = Array.isArray(n.type) ? n.type[0] : n.type;
...
\r\v":{[,]}`.indexOf(i.charAt(r)) === -1; )
      ...
      for (var i = _t(n.getText(), !0), s = t.items, a = s.length - 1; a >= 0; a--) {
        var o = s[a];
      ...
      if (!qe(this.supportsMarkdown)) {
        ...
        this.supportsMarkdown = t && t.completionItem && Array.isArray(t.completionItem.documentationFormat) && t.completionItem.documentationFormat.indexOf(He.Markdown) !== -1;
      }
      return this.supportsMarkdown;
    }, e.prototype.doesSupportsCommitCharacters = function() {
      if (!qe(this.supportsCommitCharacters)) {
        var t = this.clientCapabilities.textDocument && this.clientCapabilities.textDocument.completion;
  ...
  function() {
    ...
    return e.prototype.doHover = function(t, n, r) {
      ...
      for (var l = Q.create(t.positionAt(a.offset), t.positionAt(a.offset + a.length)), u = function(m) {
        var v = {
          contents: m,
          range: l
        };
        return v;
      }, f = Or(s), h = this.contributions.length - 1; h >= 0; h--) {
      ...
      return this.schemaService.getSchemaForResource(t.uri, r).then(function(m) {
        if (m && s) {
          var v = r.getMatchingSchemas(m.schema, s.offset), p = void 0, x = void 0, y = void 0, b = void 0;
          v.every(function(S) {
            if (S.node === s && !S.inverted && S.schema && (p = p || S.schema.title, x = x || S.schema.markdownDescription || Kn(S.schema.description), S.schema.enum)) {
              var N = S.schema.enum.indexOf(ot(s));
              S.schema.markdownEnumDescriptions ? y = S.schema.markdownEnumDescriptions[N] : S.schema.enumDescriptions && (y = Kn(S.schema.enumDescriptions[N])), y && (b = S.schema.enum[N], typeof b != "string" && (b = JSON.stringify(b)));
            }
            return !0;
          });
          var w = "";
          return p && (w = Kn(p)), x && (w.length > 0 && (w += `

`), w += x), y && (w.length > 0 && (w += `

`), w += "`".concat(Uu(b), "`: ").concat(y)), u([w]);
        }
        return null;
      });
    }, e;
...
var $u = en(), Wu = (
  ...
  function() {
    ...
    return e.prototype.configure = function(t) {
      t && (this.validationEnabled = t.validate !== !1, this.commentSeverity = t.allowComments ? void 0 : Le.Error);
      ...
      var a = [], o = {}, l = function(d) {
        ...
        var g = r != null && r.trailingCommas ? sn(r.trailingCommas) : Le.Error, m = r != null && r.comments ? sn(r.comments) : s.commentSeverity, v = r != null && r.schemaValidation ? sn(r.schemaValidation) : Le.Warning, p = r != null && r.schemaRequest ? sn(r.schemaRequest) : Le.Warning;
        if (d) {
          if (d.errors.length && n.root && p) {
            var x = n.root, y = x.type === "object" ? x.properties[0] : void 0;
            if (y && y.keyNode.value === "$schema") {
              var b = y.valueNode || y, w = Q.create(t.positionAt(b.offset), t.positionAt(b.offset + b.length));
              l(We.create(w, d.errors[0], p, X.SchemaResolveError));
            } else {
              var w = Q.create(t.positionAt(x.offset), t.positionAt(x.offset + 1));
              l(We.create(w, d.errors[0], p, X.SchemaResolveError));
            }
          } else if (v) {
            var S = n.validate(t, d.schema, v);
            S && S.forEach(l);
          }
          Wa(d.schema) && (m = void 0), Ha(d.schema) && (g = void 0);
        }
        for (var N = 0, A = n.syntaxErrors; N < A.length; N++) {
          var _ = A[N];
          if (_.code === X.TrailingComma) {
            if (typeof g != "number")
              continue;
            _.severity = g;
          }
        ...
        if (typeof m == "number") {
          var E = $u("InvalidCommentToken", "Comments are not permitted in JSON.");
          n.comments.forEach(function(I) {
            l(We.create(I, E, m, X.CommentNotPermitted));
          });
        }
        return a;
      };
      if (i) {
        var f = i.id || "schemaservice://untitled/" + Hu++, h = this.jsonSchemaService.registerExternalSchema(f, [], i);
...
function Ha(e) {
  if (e && typeof e == "object") {
    if (Oe(e.allowTrailingCommas))
      return e.allowTrailingCommas;
    var t = e;
    if (Oe(t.allowsTrailingCommas))
...
var ma = 48, zu = 57, Gu = 65, an = 97, Ju = 102;
function re(e) {
  return e < ma ? 0 : e <= zu ? e - ma : (e < an && (e += an - Gu), e >= an && e <= Ju ? e - an + 10 : 0);
}
function Xu(e) {
  if (e[0] === "#")
    switch (e.length) {
      case 4:
        return {
          red: re(e.charCodeAt(1)) * 17 / 255,
          green: re(e.charCodeAt(2)) * 17 / 255,
          blue: re(e.charCodeAt(3)) * 17 / 255,
          alpha: 1
        };
      case 5:
        return {
          ...
          green: re(e.charCodeAt(2)) * 17 / 255,
          blue: re(e.charCodeAt(3)) * 17 / 255,
          alpha: re(e.charCodeAt(4)) * 17 / 255
        };
      case 7:
        return {
          red: (re(e.charCodeAt(1)) * 16 + re(e.charCodeAt(2))) / 255,
          green: (re(e.charCodeAt(3)) * 16 + re(e.charCodeAt(4))) / 255,
          blue: (re(e.charCodeAt(5)) * 16 + re(e.charCodeAt(6))) / 255,
          alpha: 1
        };
      case 9:
        return {
          ...
          green: (re(e.charCodeAt(3)) * 16 + re(e.charCodeAt(4))) / 255,
          blue: (re(e.charCodeAt(5)) * 16 + re(e.charCodeAt(6))) / 255,
          alpha: (re(e.charCodeAt(7)) * 16 + re(e.charCodeAt(8))) / 255
        };
    }
}
var Qu = (
  ...
  function() {
    ...
    return e.prototype.findDocumentSymbols = function(t, n, r) {
      ...
      if ((o === "vscode://defaultsettings/keybindings.json" || Jt(o.toLowerCase(), "/user/keybindings.json")) && s.type === "array") {
          ...
          if (h.type === "object")
            for (var d = 0, g = h.properties; d < g.length; d++) {
              ...
              if (m.keyNode.value === "key" && m.valueNode) {
                var v = Xt.create(t.uri, Xe(t, h));
                if (l.push({ name: ot(m.valueNode), kind: Ie.Function, location: v }), a--, a <= 0)
      ...
      ], x = 0, y = !1, b = [], w = function(N, A) {
        N.type === "array" ? N.items.forEach(function(_) {
          _ && p.push({ node: _, containerName: A });
        }) : N.type === "object" && N.properties.forEach(function(_) {
          var E = _.valueNode;
          if (E)
            if (a > 0) {
              a--;
              var I = Xt.create(t.uri, Xe(t, _)), k = A ? A + "." + _.keyNode.value : _.keyNode.value;
              b.push({ name: i.getKeyLabel(_), kind: i.getSymbolKind(E.type), location: I, containerName: A }), p.push({ node: E, containerName: k });
            } else
              y = !0;
        });
      }; x < p.length; ) {
        var S = p[x++];
        w(S.node, S.containerName);
      }
      return y && r && r.onResultLimitExceeded && r.onResultLimitExceeded(o), b;
        ...
        for (var l = [], u = 0, f = s.items; u < f.length; u++) {
          ...
          if (h.type === "object")
            for (var d = 0, g = h.properties; d < g.length; d++) {
              var m = g[d];
              if (m.keyNode.value === "key" && m.valueNode) {
                var v = Xe(t, h), p = Xe(t, m.keyNode);
                if (l.push({ name: ot(m.valueNode), kind: Ie.Function, range: v, selectionRange: p }), a--, a <= 0)
                  return r && r.onResultLimitExceeded && r.onResultLimitExceeded(o), l;
              }
            }
        }
      ...
      for (var x = [], y = [
        { node: s, result: x }
      ], b = 0, w = !1, S = function(A, _) {
        A.type === "array" ? A.items.forEach(function(E, I) {
          if (E)
            if (a > 0) {
              a--;
              var k = Xe(t, E), L = k, T = String(I), F = { name: T, kind: i.getSymbolKind(E.type), range: k, selectionRange: L, children: [] };
              _.push(F), y.push({ result: F.children, node: E });
            } else
              w = !0;
        }) : A.type === "object" && A.properties.forEach(function(E) {
          var I = E.valueNode;
          if (I)
            if (a > 0) {
              a--;
              var k = Xe(t, E), L = Xe(t, E.keyNode), T = [], F = { name: i.getKeyLabel(E), kind: i.getSymbolKind(I.type), range: k, selectionRange: L, children: T, detail: i.getDetail(I) };
              _.push(F), y.push({ result: T, node: I });
            } else
              w = !0;
        });
      }; b < y.length; ) {
      ...
      return w && r && r.onResultLimitExceeded && r.onResultLimitExceeded(o), x;
      ...
      return this.schemaService.getSchemaForResource(t.uri, n).then(function(i) {
        var s = [];
        if (i)
          for (var a = r && typeof r.resultLimit == "number" ? r.resultLimit : Number.MAX_VALUE, o = n.getMatchingSchemas(i.schema), l = {}, u = 0, f = o; u < f.length; u++) {
            var h = f[u];
      ...
      var f;
      return r.alpha === 1 ? f = "#".concat(u(a)).concat(u(o)).concat(u(l)) : f = "#".concat(u(a)).concat(u(o)).concat(u(l)).concat(u(Math.round(r.alpha * 255))), s.push({ label: f, textEdit: Me.replace(i, JSON.stringify(f)) }), s;
    }, e;
  }()
);
function Xe(e, t) {
...
for (pa in qr.schemas) {
  on = qr.schemas[pa];
  for (vt in on.properties)
    ln = on.properties[vt], typeof ln == "boolean" && (ln = on.properties[vt] = {}), er = Zu[vt], er ? ln.description = er : console.log("".concat(vt, ": localize('schema.json.").concat(vt, `', "")`));
}
var on, ln, er, vt, pa, za;
za = (() => {
  var e = { 470: (r) => {
    function i(o) {
      if (typeof o != "string")
    ...
    function s(o, l) {
      for (var u, f = "", h = 0, d = -1, g = 0, m = 0; m <= o.length; ++m) {
        if (m < o.length)
          u = o.charCodeAt(m);
        else {
          if (u === 47)
            ...
            if (d !== m - 1 && g === 2) {
              if (f.length < 2 || h !== 2 || f.charCodeAt(f.length - 1) !== 46 || f.charCodeAt(f.length - 2) !== 46) {
                if (f.length > 2) {
                  var v = f.lastIndexOf("/");
                  if (v !== f.length - 1) {
                    v === -1 ? (f = "", h = 0) : h = (f = f.slice(0, v)).length - 1 - f.lastIndexOf("/"), d = m, g = 0;
                    continue;
                  }
              ...
              f.length > 0 ? f += "/" + o.slice(d + 1, m) : f = o.slice(d + 1, m), h = m - d - 1;
          d = m, g = 0;
        } else
          u === 46 && g !== -1 ? ++g : g = -1;
      }
    ...
    var a = { resolve: function() {
      ...
      for (var f = o.length, h = f - u, d = 1; d < l.length && l.charCodeAt(d) === 47; ++d)
        ;
      for (var g = l.length - d, m = h < g ? h : g, v = -1, p = 0; p <= m; ++p) {
        if (p === m) {
          if (g > m) {
            if (l.charCodeAt(d + p) === 47)
              return l.slice(d + p + 1);
            if (p === 0)
              return l.slice(d + p);
          } else
            h > m && (o.charCodeAt(u + p) === 47 ? v = p : p === 0 && (v = 0));
          break;
        }
        var x = o.charCodeAt(u + p);
        if (x !== l.charCodeAt(d + p))
          break;
        x === 47 && (v = p);
      }
      var y = "";
      for (p = u + v + 1; p <= f; ++p)
        p !== f && o.charCodeAt(p) !== 47 || (y.length === 0 ? y += ".." : y += "/..");
      return y.length > 0 ? y + l.slice(d + v) : (d += v, l.charCodeAt(d) === 47 && ++d, l.slice(d));
      ...
      if (l !== void 0 && l.length > 0 && l.length <= o.length) {
        ...
        for (u = o.length - 1; u >= 0; --u) {
          ...
          if (v === 47) {
            ...
            m === -1 && (d = !1, m = u + 1), g >= 0 && (v === l.charCodeAt(g) ? --g == -1 && (h = u) : (g = -1, h = m));
        }
        return f === h ? h = m : h === -1 && (h = o.length), o.slice(f, h);
      }
      for (u = o.length - 1; u >= 0; --u)
      ...
      for (var l = -1, u = 0, f = -1, h = !0, d = 0, g = o.length - 1; g >= 0; --g) {
        ...
        if (m !== 47)
          f === -1 && (h = !1, f = g + 1), m === 46 ? l === -1 ? l = g : d !== 1 && (d = 1) : l !== -1 && (d = -1);
        else if (!h) {
          u = g + 1;
          break;
        }
      ...
      h ? (l.root = "/", u = 1) : u = 0;
      for (var d = -1, g = 0, m = -1, v = !0, p = o.length - 1, x = 0; p >= u; --p)
        if ((f = o.charCodeAt(p)) !== 47)
          m === -1 && (v = !1, m = p + 1), f === 46 ? d === -1 ? d = p : x !== 1 && (x = 1) : d !== -1 && (x = -1);
        else if (!v) {
          g = p + 1;
          break;
        }
      return d === -1 || m === -1 || x === 0 || x === 1 && d === m - 1 && d === g + 1 ? m !== -1 && (l.base = l.name = g === 0 && h ? o.slice(1, m) : o.slice(g, m)) : (g === 0 && h ? (l.name = o.slice(1, d), l.base = o.slice(1, m)) : (l.name = o.slice(g, d), l.base = o.slice(g, m)), l.ext = o.slice(d, m)), g > 0 ? l.dir = o.slice(0, g - 1) : h && (l.dir = "/"), l;
    }, sep: "/", delimiter: ":", win32: null, posix: null };
    a.posix = a, r.exports = a;
  }, 447: (r, i, s) => {
    var a;
    if (s.r(i), s.d(i, { URI: () => y, Utils: () => T }), typeof process == "object")
      a = process.platform === "win32";
    else if (typeof navigator == "object") {
      var o = navigator.userAgent;
      a = o.indexOf("Windows") >= 0;
    }
    var l, u, f = (l = function(M, C) {
      return (l = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(P, D) {
        P.__proto__ = D;
      } || function(P, D) {
        for (var B in D)
      ...
      l(M, C), M.prototype = C === null ? Object.create(C) : (P.prototype = C.prototype, new P());
    }), h = /^\w[\w\d+.-]*$/, d = /^\//, g = /^\/\//;
    function m(M, C) {
      if (!M.scheme && C)
      ...
      if (M.scheme && !h.test(M.scheme))
        throw new Error("[UriError]: Scheme contains illegal characters.");
      if (M.path) {
        if (M.authority) {
          if (!d.test(M.path))
            throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
        } else if (g.test(M.path))
          throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
      }
    }
    var v = "", p = "/", x = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, y = function() {
      function M(C, P, D, B, U, G) {
        G === void 0 && (G = !1), typeof C == "object" ? (this.scheme = C.scheme || v, this.authority = C.authority || v, this.path = C.path || v, this.query = C.query || v, this.fragment = C.fragment || v) : (this.scheme = /* @__PURE__ */ function(de, le) {
          return de || le ? de : "file";
        }(C, G), this.authority = P || v, this.path = function(de, le) {
          switch (de) {
            case "https":
            case "http":
            case "file":
              le ? le[0] !== p && (le = p + le) : le = p;
          }
          return le;
        }(this.scheme, D || v), this.query = B || v, this.fragment = U || v, m(this, G));
      }
      return M.isUri = function(C) {
        ...
        return _(this, !1);
      }, enumerable: !1, configurable: !0 }), M.prototype.with = function(C) {
        if (!C)
          return this;
        var P = C.scheme, D = C.authority, B = C.path, U = C.query, G = C.fragment;
        return P === void 0 ? P = this.scheme : P === null && (P = v), D === void 0 ? D = this.authority : D === null && (D = v), B === void 0 ? B = this.path : B === null && (B = v), U === void 0 ? U = this.query : U === null && (U = v), G === void 0 ? G = this.fragment : G === null && (G = v), P === this.scheme && D === this.authority && B === this.path && U === this.query && G === this.fragment ? this : new w(P, D, B, U, G);
      }, M.parse = function(C, P) {
        P === void 0 && (P = !1);
        var D = x.exec(C);
        return D ? new w(D[2] || v, L(D[4] || v), L(D[5] || v), L(D[7] || v), L(D[9] || v), P) : new w(v, v, v, v, v);
      }, M.file = function(C) {
        var P = v;
        if (a && (C = C.replace(/\\/g, p)), C[0] === p && C[1] === p) {
          var D = C.indexOf(p, 2);
          D === -1 ? (P = C.substring(2), C = p) : (P = C.substring(2, D), C = C.substring(D) || p);
        }
        return new w("file", P, C, v, v);
      }, M.from = function(C) {
        var P = new w(C.scheme, C.authority, C.path, C.query, C.fragment);
        return m(P, !0), P;
      }, M.prototype.toString = function(C) {
        return C === void 0 && (C = !1), E(this, C);
        ...
        if (C) {
          if (C instanceof M)
            return C;
          var P = new w(C);
          return P._formatted = C.external, P._fsPath = C._sep === b ? C.fsPath : null, P;
        }
        return C;
      }, M;
    }(), b = a ? 1 : void 0, w = function(M) {
      function C() {
        var P = M !== null && M.apply(this, arguments) || this;
        return P._formatted = null, P._fsPath = null, P;
      }
      return f(C, M), Object.defineProperty(C.prototype, "fsPath", { get: function() {
        return this._fsPath || (this._fsPath = _(this, !1)), this._fsPath;
      }, enumerable: !1, configurable: !0 }), C.prototype.toString = function(P) {
        return P === void 0 && (P = !1), P ? E(this, !0) : (this._formatted || (this._formatted = E(this, !1)), this._formatted);
      }, C.prototype.toJSON = function() {
        var P = { $mid: 1 };
        return this._fsPath && (P.fsPath = this._fsPath, P._sep = b), this._formatted && (P.external = this._formatted), this.path && (P.path = this.path), this.scheme && (P.scheme = this.scheme), this.authority && (P.authority = this.authority), this.query && (P.query = this.query), this.fragment && (P.fragment = this.fragment), P;
      }, C;
    }(y), S = ((u = {})[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28", u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u);
    function N(M, C) {
      for (var P = void 0, D = -1, B = 0; B < M.length; B++) {
        var U = M.charCodeAt(B);
        if (U >= 97 && U <= 122 || U >= 65 && U <= 90 || U >= 48 && U <= 57 || U === 45 || U === 46 || U === 95 || U === 126 || C && U === 47)
          D !== -1 && (P += encodeURIComponent(M.substring(D, B)), D = -1), P !== void 0 && (P += M.charAt(B));
        else {
          P === void 0 && (P = M.substr(0, B));
          var G = S[U];
          G !== void 0 ? (D !== -1 && (P += encodeURIComponent(M.substring(D, B)), D = -1), P += G) : D === -1 && (D = B);
        }
      }
      return D !== -1 && (P += encodeURIComponent(M.substring(D))), P !== void 0 ? P : M;
    }
    function A(M) {
      for (var C = void 0, P = 0; P < M.length; P++) {
        var D = M.charCodeAt(P);
        D === 35 || D === 63 ? (C === void 0 && (C = M.substr(0, P)), C += S[D]) : C !== void 0 && (C += M[P]);
      }
      return C !== void 0 ? C : M;
    }
    function _(M, C) {
      var P;
      return P = M.authority && M.path.length > 1 && M.scheme === "file" ? "//".concat(M.authority).concat(M.path) : M.path.charCodeAt(0) === 47 && (M.path.charCodeAt(1) >= 65 && M.path.charCodeAt(1) <= 90 || M.path.charCodeAt(1) >= 97 && M.path.charCodeAt(1) <= 122) && M.path.charCodeAt(2) === 58 ? C ? M.path.substr(1) : M.path[1].toLowerCase() + M.path.substr(2) : M.path, a && (P = P.replace(/\//g, "\\")), P;
    }
    function E(M, C) {
      var P = C ? A : N, D = "", B = M.scheme, U = M.authority, G = M.path, de = M.query, le = M.fragment;
      if (B && (D += B, D += ":"), (U || B === "file") && (D += p, D += p), U) {
        var me = U.indexOf("@");
        if (me !== -1) {
          var ft = U.substr(0, me);
          U = U.substr(me + 1), (me = ft.indexOf(":")) === -1 ? D += P(ft, !1) : (D += P(ft.substr(0, me), !1), D += ":", D += P(ft.substr(me + 1), !1)), D += "@";
        }
        (me = (U = U.toLowerCase()).indexOf(":")) === -1 ? D += P(U, !1) : (D += P(U.substr(0, me), !1), D += U.substr(me));
      }
      if (G) {
        if (G.length >= 3 && G.charCodeAt(0) === 47 && G.charCodeAt(2) === 58)
          (Pe = G.charCodeAt(1)) >= 65 && Pe <= 90 && (G = "/".concat(String.fromCharCode(Pe + 32), ":").concat(G.substr(3)));
        else if (G.length >= 2 && G.charCodeAt(1) === 58) {
          var Pe;
          (Pe = G.charCodeAt(0)) >= 65 && Pe <= 90 && (G = "".concat(String.fromCharCode(Pe + 32), ":").concat(G.substr(2)));
        }
        D += P(G, !0);
      }
      return de && (D += "?", D += P(de, !1)), le && (D += "#", D += C ? le : N(le, !1)), D;
    }
    function I(M) {
      try {
        return decodeURIComponent(M);
      } catch {
        return M.length > 3 ? M.substr(0, 3) + I(M.substr(3)) : M;
      }
    }
    var k = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function L(M) {
      return M.match(k) ? M.replace(k, function(C) {
        return I(C);
      }) : M;
    }
    var T, F = s(470), V = function(M, C, P) {
      if (P || arguments.length === 2)
        for (var D, B = 0, U = C.length; B < U; B++)
          !D && B in C || (D || (D = Array.prototype.slice.call(C, 0, B)), D[B] = C[B]);
      return M.concat(D || Array.prototype.slice.call(C));
    }, O = F.posix || F;
    (function(M) {
      M.joinPath = function(C) {
        for (var P = [], D = 1; D < arguments.length; D++)
          P[D - 1] = arguments[D];
        return C.with({ path: O.join.apply(O, V([C.path], P, !1)) });
      }, M.resolvePath = function(C) {
        for (var P = [], D = 1; D < arguments.length; D++)
          P[D - 1] = arguments[D];
        var B = C.path || "/";
        return C.with({ path: O.resolve.apply(O, V([B], P, !1)) });
      }, M.dirname = function(C) {
        var P = O.dirname(C.path);
        return P.length === 1 && P.charCodeAt(0) === 46 ? C : C.with({ path: P });
      }, M.basename = function(C) {
        return O.basename(C.path);
      }, M.extname = function(C) {
        return O.extname(C.path);
      };
    })(T || (T = {}));
  } }, t = {};
  function n(r) {
...
var { URI: Mt, Utils: wc } = za;
function Yu(e, t) {
  if (typeof e != "string")
    throw new TypeError("Expected a string");
  for (var n = String(e), r = "", i = t ? !!t.extended : !1, s = t ? !!t.globstar : !1, a = !1, o = t && typeof t.flags == "string" ? t.flags : "", l, u = 0, f = n.length; u < f; u++)
    switch (l = n[u], l) {
      case "/":
      case "$":
      case "^":
      ...
      case ",":
        ...
        break;
      case "*":
        for (var h = n[u - 1], d = 1; n[u + 1] === "*"; )
          d++, u++;
        var g = n[u + 1];
        if (!s)
          r += ".*";
        else {
          var m = d > 1 && (h === "/" || h === void 0 || h === "{" || h === ",") && (g === "/" || g === void 0 || g === "," || g === "}");
          m ? (g === "/" ? u++ : h === "/" && r.endsWith("\\/") && (r = r.substr(0, r.length - 2)), r += "((?:[^/]*(?:/|$))*)") : r += "([^/]*)";
        }
        break;
      default:
        r += l;
...
var Fe = en(), Ku = "!", ec = "/", tc = (
    ...
    function e(t, n) {
      ...
      try {
        for (var r = 0, i = t; r < i.length; r++) {
          var s = i[r], a = s[0] !== Ku;
          a || (s = s.substring(1)), s.length > 0 && (s[0] === ec && (s = s.substring(1)), this.globWrappers.push({
            regexp: Yu("**/" + s, { extended: !0, globstar: !0 }),
            include: a
          }));
        }
        this.uris = n;
  ...
  function() {
    function e(t, n, r) {
      this.service = t, this.uri = n, this.dependencies = /* @__PURE__ */ new Set(), this.anchors = void 0, r && (this.unresolvedSchema = this.service.promise.resolve(new Dt(r)));
    }
  ...
  function() {
    ...
    return e.prototype.getRegisteredSchemaIds = function(t) {
      ...
      var n = Qe(t), r = this.schemasById[n];
      return r ? r.getResolvedSchema() : this.promise.resolve(void 0);
    }, e.prototype.loadSchema = function(t) {
      if (!this.requestService) {
        var n = Fe("json.schema.norequestservice", "Unable to load schema from '{0}'. No schema request service available", un(t));
        return this.promise.resolve(new Dt({}, [n]));
      }
      return this.requestService(t).then(function(r) {
        if (!r) {
          var i = Fe("json.schema.nocontent", "Unable to load schema from '{0}': No content.", un(t));
          return new Dt({}, [i]);
        }
        var s = {}, a = [];
        s = yu(r, a);
        var o = a.length ? [Fe("json.schema.invalidFormat", "Unable to parse content from '{0}': Parse error at offset {1}.", un(t), a[0].offset)] : [];
        return new Dt(s, o);
      }, function(r) {
        var i = r.toString(), s = r.toString().split("Error: ");
        return s.length > 1 && (i = s[1]), Jt(i, ".") && (i = i.substr(0, i.length - 1)), new Dt({}, [Fe("json.schema.nocontent", "Unable to load schema from '{0}': {1}.", un(t), i)]);
      });
      ...
      if (s.$schema) {
        ...
        if (a === "http://json-schema.org/draft-03/schema")
          return this.promise.resolve(new va({}, [Fe("json.schema.draft03.notsupported", "Draft-03 schemas are not supported.")]));
      ...
      var o = this.contextService, l = function(v, p) {
        p = decodeURIComponent(p);
        var x = v;
        return p[0] === "/" && (p = p.substring(1)), p.split("/").some(function(y) {
          return y = y.replace(/~1/g, "/").replace(/~0/g, "~"), x = x[y], !x;
        }), x;
      }, u = function(v, p, x) {
        return p.anchors || (p.anchors = m(v)), p.anchors.get(x);
      }, f = function(v, p) {
        for (var x in p)
          p.hasOwnProperty(x) && !v.hasOwnProperty(x) && x !== "id" && x !== "$id" && (v[x] = p[x]);
      }, h = function(v, p, x, y) {
        var b;
        y === void 0 || y.length === 0 ? b = p : y.charAt(0) === "/" ? b = l(p, y) : b = u(p, x, y), b ? f(v, b) : i.push(Fe("json.schema.invalidid", "$ref '{0}' in '{1}' can not be resolved.", y, x.uri));
      }, d = function(v, p, x, y) {
        o && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(p) && (p = o.resolveRelativePath(p, y.uri)), p = Qe(p);
        var b = r.getOrAddSchemaHandle(p);
        return b.getUnresolvedSchema().then(function(w) {
          if (y.dependencies.add(p), w.errors.length) {
            var S = x ? p + "#" + x : p;
            i.push(Fe("json.schema.problemloadingref", "Problems loading reference '{0}': {1}", S, w.errors[0]));
          }
          return h(v, w.schema, b, x), g(v, w.schema, b);
        });
      }, g = function(v, p, x) {
        var y = [];
        return r.traverseNodes(v, function(b) {
          for (var w = /* @__PURE__ */ new Set(); b.$ref; ) {
            var S = b.$ref, N = S.split("#", 2);
            if (delete b.$ref, N[0].length > 0) {
              y.push(d(b, N[0], N[1], x));
              return;
            } else if (!w.has(S)) {
              var A = N[1];
              h(b, p, x, A), w.add(S);
        ...
        return r.traverseNodes(v, function(x) {
          var y = x.$id || x.id;
          if (typeof y == "string" && y.charAt(0) === "#") {
            var b = y.substring(1);
            p.has(b) ? i.push(Fe("json.schema.duplicateid", "Duplicate id declaration: '{0}'", y)) : p.set(b, x);
          }
        }), p;
      };
      return g(s, s, n).then(function(v) {
        return new va(s, i);
      });
      ...
      for (var n = /* @__PURE__ */ Object.create(null), r = [], i = sc(t), s = 0, a = this.filePatternAssociations; s < a.length; s++) {
        var o = a[s];
      ...
      if (r) {
        var i = r.id || "schemaservice://untitled/matchingSchemas/" + ic++, s = this.addSchemaHandle(i, r);
...
function sc(e) {
  try {
    return Mt.parse(e).with({ fragment: null, query: null }).toString(!0);
  } catch {
    return e;
  }
}
...
function ac(e, t) {
  var n = [], r = [], i = [], s = -1, a = _t(e.getText(), !1), o = a.scan();
  function l(I) {
  ...
  for (; o !== 17; ) {
    switch (o) {
      ...
      case 13: {
        ...
        a.getTokenError() === 1 && u + 1 < e.lineCount ? a.setPosition(e.offsetAt(Ee.create(u + 1, 0))) : u < g && (l({ startLine: u, endLine: g, kind: qt.Comment }), s = u);
        break;
      }
      case 12: {
        var m = e.getText().substr(a.getTokenOffset(), a.getTokenLength()), v = m.match(/^\/\/\s*#(region\b)|(endregion\b)/);
        if (v) {
          var d = e.positionAt(a.getTokenOffset()).line;
          if (v[1]) {
            var f = { startLine: d, endLine: d, kind: qt.Region };
            i.push(f);
          } else {
            for (var p = i.length - 1; p >= 0 && i[p].kind !== qt.Region; )
              p--;
            if (p >= 0) {
              var f = i[p];
              i.length = p, d > f.startLine && s !== f.startLine && (f.endLine = d, l(f), s = f.startLine);
            }
          }
        }
        break;
  ...
  for (var y = [], b = 0, w = r; b < w.length; b++) {
    var S = w[b];
    S < 30 && (y[S] = (y[S] || 0) + 1);
  }
  for (var N = 0, A = 0, p = 0; p < y.length; p++) {
    var _ = y[p];
    if (_) {
      if (_ + N > x) {
        A = p;
  ...
  for (var E = [], p = 0; p < n.length; p++) {
    var S = r[p];
    typeof S == "number" && (S < A || S === A && N++ < x) && E.push(n[p]);
  }
  return E;
}
function oc(e, t, n) {
  function r(o) {
    for (var l = e.offsetAt(o), u = n.getNodeFromOffset(l, !0), f = []; u; ) {
      switch (u.type) {
        case "string":
        case "object":
        case "array":
    ...
    for (var m = void 0, v = f.length - 1; v >= 0; v--)
      m = Fn.create(f[v], m);
    return m || (m = Fn.create(Q.create(o, o))), m;
  }
  function i(o, l) {
    return Q.create(e.positionAt(o), e.positionAt(l));
  }
  var s = _t(e.getText(), !0);
  function a(o, l) {
    s.setPosition(o);
    var u = s.scan();
...
function Br(e, t) {
  ...
  if (t && t.type === "object") {
    ...
    return r ? Br(e, r.valueNode) : null;
...
function fc(e) {
  return e === "#" ? [] : e[0] !== "#" || e[1] !== "/" ? null : e.substring(2).split(/\//).map(hc);
}
function hc(e) {
  return e.replace(/~1/g, "/").replace(/~0/g, "~");
}
function dc(e) {
  var t = e.promiseConstructor || Promise, n = new rc(e.schemaRequestService, e.workspaceContext, t);
  n.setSchemaContributions(qr);
  var r = new qu(n, e.contributions, t, e.clientCapabilities), i = new Bu(n, e.contributions, t), s = new Qu(n), a = new Wu(n, t);
  return {
...
` };
      return Su(o.getText(), f, g).map(function(m) {
        return Me.replace(Q.create(o.positionAt(m.offset), o.positionAt(m.offset + m.length)), m.content);
      });
    }
  };
}
var Ga;
typeof fetch < "u" && (Ga = function(e) {
  return fetch(e).then((t) => t.text());
});
var gc = class {
  constructor(e, t) {
    this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = dc({
      workspaceContext: {
      ...
      schemaRequestService: t.enableSchemaRequest ? Ga : void 0,
...
function pc(e) {
  return e.charCodeAt(0) === mc;
}
function vc(e, t) {
  if (pc(t)) {
    const n = Mt.parse(e), r = t.split("/");
    return n.with({ path: Ja(r) }).toString();
  }
  return bc(e, t);
}
function Ja(e) {
...
function bc(e, ...t) {
  const n = Mt.parse(e), r = n.path.split("/");
  for (let i of t)
    r.push(...i.split("/"));
  return n.with({ path: Ja(r) }).toString();
}
