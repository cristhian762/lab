...
const Un = "Canceled";
function Ds(e) {
  return e instanceof Is ? !0 : e instanceof Error && e.name === Un && e.message === Un;
}
...
class Fe extends Error {
  constructor(t) {
    super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, Fe.prototype);
  }
}
function zs(e, t) {
  const n = this;
...
function Nt(e, t, n = 0, i = e.length) {
  let r = n, a = i;
  for (; r < a; ) {
...
const kn = class kn {
  ...
  findLastMonotonous(t) {
    ...
    const n = Nt(this._array, t, this._findLastMonotonousLastIdx);
    return this._findLastMonotonousLastIdx = n + 1, n === -1 ? void 0 : this._array[n];
  }
};
kn.assertInvariants = !1;
let en = kn;
function Us(e, t, n = (i, r) => i === r) {
  if (e === t)
    return !0;
...
const ft = class ft {
  ...
  filter(t) {
    return new ft((n) => this.iterate((i) => t(i) ? n(i) : !0));
  }
  map(t) {
    return new ft((n) => this.iterate((i) => n(t(i))));
  }
  some(t) {
    let n = !1;
  ...
  findLastMaxBy(t) {
    let n, i = !0;
    return this.iterate((r) => ((i || Fn.isGreaterThan(t(r, n))) && (i = !1, n = r), !0)), n;
  }
};
ft.empty = new ft((t) => {
});
...
(function(e) {
  ...
  e.reduce = p;
  function* _(y, S, E = y.length) {
    for (S < 0 && (S += y.length), E < 0 ? E += y.length : E > y.length && (E = y.length); S < E; S++)
      yield y[S];
  }
  e.slice = _;
  function x(y, S = Number.POSITIVE_INFINITY) {
    const E = [];
    if (S === 0)
      return [E, y];
    const F = y[Symbol.iterator]();
    for (let v = 0; v < S; v++) {
      const b = F.next();
      if (b.done)
        return [E, e.empty()];
...
const Si = class Si {
  constructor() {
    this._store = new Dt(), this._store;
  }
  dispose() {
    this._store.dispose();
  }
...
class js {
  ...
  _remove(t) {
    if (t.prev !== ne.Undefined && t.next !== ne.Undefined) {
      ...
      t.prev === ne.Undefined && t.next === ne.Undefined ? (this._first = ne.Undefined, this._last = ne.Undefined) : t.next === ne.Undefined ? (this._last = this._last.prev, this._last.next = ne.Undefined) : t.prev === ne.Undefined && (this._first = this._first.next, this._first.prev = ne.Undefined);
    this._size -= 1;
  }
  *[Symbol.iterator]() {
    let t = this._first;
...
const Gs = globalThis.performance && typeof globalThis.performance.now == "function";
class Cn {
  static create(t) {
    return new Cn(t);
  }
  constructor(t) {
    this._now = Gs && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
(function(e) {
  ...
  function n(L) {
    return (k, N = null, D) => {
      ...
      return P = L((C) => {
        if (!H)
          return P ? P.dispose() : H = !0, k.call(N, C);
      }, null, D), H && P.dispose(), P;
    };
  }
  e.once = n;
  function i(L, k, N) {
    return u((D, H = null, P) => L((C) => D.call(H, k(C)), null, P), N);
  }
  e.map = i;
  function r(L, k, N) {
    return u((D, H = null, P) => L((C) => {
      k(C), D.call(H, C);
    }, null, P), N);
  }
  e.forEach = r;
  function a(L, k, N) {
    return u((D, H = null, P) => L((C) => k(C) && D.call(H, C), null, P), N);
  }
  e.filter = a;
  function s(L) {
    return L;
  ...
  function o(...L) {
    return (k, N = null, D) => {
      const H = Vs(...L.map((P) => P((C) => k.call(N, C))));
      return c(H, D);
    };
  }
  e.any = o;
  ...
  function u(L, k) {
    ...
    return k == null || k.add(H), H.event;
  }
  function c(L, k) {
    return k instanceof Array ? k.push(L) : k && k.add(L), L;
  }
  function d(L, k, N = 100, D = !1, H = !1, P, C) {
    let A, M, W, I = 0, z;
    const B = {
      leakWarningThreshold: P,
      onWillAddFirstListener() {
        A = L((Y) => {
          I++, M = k(M, Y), D && !W && ($.fire(M), M = void 0), z = () => {
            const J = M;
            M = void 0, W = void 0, (!D || I > 1) && $.fire(J), I = 0;
          }, typeof N == "number" ? (clearTimeout(W), W = setTimeout(z, N)) : W === void 0 && (W = 0, queueMicrotask(z));
        });
      },
    ...
    return C == null || C.add($), $.event;
  }
  e.debounce = d;
  function m(L, k = 0, N) {
    return e.debounce(L, (D, H) => D ? (D.push(H), D) : [H], k, void 0, !0, void 0, N);
  }
  e.accumulate = m;
  function f(L, k = (D, H) => D === H, N) {
    let D = !0, H;
    return a(L, (P) => {
      const C = D || !k(P, H);
      return D = !1, H = P, C;
  ...
  e.split = g;
  function p(L, k = !1, N = [], D) {
    let H = N.slice(), P = L((M) => {
      H ? H.push(M) : A.fire(M);
    });
    D && D.add(P);
    const C = () => {
      H == null || H.forEach((M) => A.fire(M)), H = null;
    }, A = new Ce({
      onWillAddFirstListener() {
        P || (P = L((M) => A.fire(M)), D && D.add(P));
      },
  ...
  class w {
    ...
    forEach(k) {
      return this.steps.push((N) => (k(N), N)), this;
    }
    filter(k) {
      return this.steps.push((N) => k(N) ? N : x), this;
    }
    reduce(k, N) {
      let D = N;
      return this.steps.push((H) => (D = k(D, H), D)), this;
    }
    latch(k = (N, D) => N === D) {
      let N = !0, D;
      return this.steps.push((H) => {
        const P = N || !k(H, D);
        return N = !1, D = H, P ? H : x;
      }), this;
    }
    evaluate(k) {
  ...
  function y(L, k, N = (D) => D) {
    const D = (...A) => C.fire(N(...A)), H = () => L.on(k, D), P = () => L.removeListener(k, D), C = new Ce(
      { onWillAddFirstListener: H, onDidRemoveLastListener: P }
    );
    return C.event;
  }
  e.fromNodeEventEmitter = y;
  function S(L, k, N = (D) => D) {
    const D = (...A) => C.fire(N(...A)), H = () => L.addEventListener(k, D), P = () => L.removeEventListener(k, D), C = new Ce(
      { onWillAddFirstListener: H, onDidRemoveLastListener: P }
    );
    return C.event;
  }
  ...
  class b {
    constructor(k, N) {
      ...
      this.emitter = new Ce(D), N && N.add(this.emitter);
    }
    beginUpdate(k) {
      this._counter++;
    }
  ...
  function T(L, k) {
    return new b(L, k).emitter.event;
  }
  e.fromObservable = T;
  function q(L) {
    return (k, N, D) => {
      ...
      const C = {
        ...
        endUpdate() {
          H--, H === 0 && (L.reportChanges(), P && (P = !1, k.call(N)));
        },
      ...
      L.addObserver(C), L.reportChanges();
      const A = {
        dispose() {
          L.removeObserver(C);
        }
      };
      return D instanceof Dt ? D.add(A) : Array.isArray(D) && D.push(A), A;
    };
  }
...
const pt = class pt {
  constructor(t) {
    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${pt._idPool++}`, pt.all.add(this);
  }
  start(t) {
    this._stopWatch = new Cn(), this.listenerCount = t;
  }
  stop() {
    if (this._stopWatch) {
...
pt.all = /* @__PURE__ */ new Set(), pt._idPool = 0;
let Bn = pt, $s = -1;
class Xs {
...
class Ce {
  constructor(t) {
    var n, i, r, a;
    this._size = 0, this._options = t, this._leakageMon = (n = this._options) != null && n.leakWarningThreshold ? new Xs(((i = this._options) == null ? void 0 : i.leakWarningThreshold) ?? $s) : void 0, this._perfMon = (r = this._options) != null && r._profName ? new Bn(this._options._profName) : void 0, this._deliveryQueue = (a = this._options) == null ? void 0 : a.deliveryQueue;
  }
  dispose() {
    var t, n, i, r;
  ...
  get event() {
    return this._event ?? (this._event = (t, n, i) => {
      ...
      if (this._leakageMon && this._size > this._leakageMon.threshold * 3)
        return console.warn(`[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far`), xt.None;
      if (this._disposed)
        return xt.None;
      n && (t = t.bind(n));
      const r = new En(t);
      let a;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (r.stack = vi.create(), a = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof En ? (this._deliveryQueue ?? (this._deliveryQueue = new Ys()), this._listeners = [this._listeners, r]) : this._listeners.push(r) : ((l = (o = this._options) == null ? void 0 : o.onWillAddFirstListener) == null || l.call(o, this), this._listeners = r, (c = (u = this._options) == null ? void 0 : u.onDidAddFirstListener) == null || c.call(u, this)), this._size++;
      const s = nn(() => {
        a == null || a(), this._removeListener(r);
      });
      return i instanceof Dt ? i.add(s) : Array.isArray(i) && i.push(s), s;
    }), this._event;
  }
  _removeListener(t) {
    var a, s, o, l;
    if ((s = (a = this._options) == null ? void 0 : a.onWillRemoveListener) == null || s.call(a, this), !this._listeners)
      return;
    if (this._size === 1) {
    ...
    if (this._size * Qs <= n.length) {
      let u = 0;
      for (let c = 0; c < n.length; c++)
        n[c] ? n[u++] = n[c] : r && (this._deliveryQueue.end--, u < this._deliveryQueue.i && this._deliveryQueue.i--);
      n.length = u;
    }
  }
  _deliver(t, n) {
    ...
    if (!t)
      return;
    const i = ((r = this._options) == null ? void 0 : r.onListenerError) || is;
    if (!i) {
      t.value(n);
      return;
    }
  ...
  fire(t) {
    var n, i, r, a;
    if ((n = this._deliveryQueue) != null && n.current && (this._deliverQueue(this._deliveryQueue), (i = this._perfMon) == null || i.stop()), (r = this._perfMon) == null || r.start(this._size), this._listeners)
      if (this._listeners instanceof En)
...
let to = typeof document < "u" && document.location && document.location.hash.indexOf("pseudo=true") >= 0;
function no(e, t) {
  let n;
  ...
  }), to && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
}
let io, ro = {};
function te(e, t, n, ...i) {
  const r = typeof t == "object" ? t.key : t, a = (ro[e] ?? {})[r] ?? n;
  return no(a, i);
}
function ao(e) {
  return io;
...
const dt = "en";
let On = !1, Vn = !1, Ot, Jt = dt, Ni = dt, Se;
const rt = globalThis;
let pe;
typeof rt.vscode < "u" && typeof rt.vscode.process < "u" ? pe = rt.vscode.process : typeof process < "u" && (pe = process);
var ns;
const so = typeof ((ns = pe == null ? void 0 : pe.versions) == null ? void 0 : ns.electron) == "string", oo = so && (pe == null ? void 0 : pe.type) === "renderer";
if (typeof pe == "object") {
  On = pe.platform === "win32", Vn = pe.platform === "darwin", pe.platform, pe.env.CI || pe.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Ot = dt, Jt = dt;
  const e = pe.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      const t = JSON.parse(e), n = t.availableLanguages["*"];
      Ot = t.locale, Ni = t.osLocale, Jt = n || dt;
    } catch {
    }
} else
  typeof navigator == "object" && !oo ? (Se = navigator.userAgent, On = Se.indexOf("Windows") >= 0, Vn = Se.indexOf("Macintosh") >= 0, (Se.indexOf("Macintosh") >= 0 || Se.indexOf("iPad") >= 0 || Se.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Se.indexOf("Linux") >= 0, (Se == null ? void 0 : Se.indexOf("Mobi")) >= 0, ao(
    te(
      "vs/base/common/platform",
      { key: "ensureLoaderPluginIsLoaded", comment: ["{Locked}"] },
      "_"
    )
  ), Ot = dt, Jt = Ot, Ni = navigator.language) : console.error("Unable to resolve platform.");
var Di;
(function(e) {
  e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows";
})(Di || (Di = {}));
const It = On, lo = Vn, Ue = Se, qe = Jt;
var Ii;
(function(e) {
  function t() {
    return qe;
...
const uo = typeof rt.postMessage == "function" && !rt.importScripts;
(() => {
  if (uo) {
    const e = [];
    rt.addEventListener("message", (n) => {
    ...
    return (n) => {
      ...
      e.push({
        id: i,
        callback: n
      }), rt.postMessage({ vscodeScheduleAsyncWork: i }, "*");
    };
  }
...
const co = !!(Ue && Ue.indexOf("Chrome") >= 0);
Ue && Ue.indexOf("Firefox") >= 0;
!co && Ue && Ue.indexOf("Safari") >= 0;
Ue && Ue.indexOf("Edg/") >= 0;
Ue && Ue.indexOf("Android") >= 0;
const as = Object.freeze(function(e, t) {
...
(function(e) {
  function t(n) {
    return n === e.None || n === e.Cancelled || n instanceof Qt ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function";
  }
...
class Qt {
  ...
  get onCancellationRequested() {
    return this._isCancelled ? as : (this._emitter || (this._emitter = new Ce()), this._emitter.event);
  }
  dispose() {
...
class ho {
  ...
  cancel() {
    this._token ? this._token instanceof Qt && this._token.cancel() : this._token = rn.Cancelled;
  }
  dispose(t = !1) {
    var n;
    t && this.cancel(), (n = this._parentListener) == null || n.dispose(), this._token ? this._token instanceof Qt && this._token.dispose() : this._token = rn.None;
  }
}
class mo {
  constructor(t) {
...
ze.ambiguousCharacterData = new Hi(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}')), ze.cache = new mo((t) => {
  ...
  const a = ze.ambiguousCharacterData.value;
  let s = t.filter((c) => !c.startsWith("_") && c in a);
  ...
  const l = n(a._common), u = i(l, o);
  return new ze(u);
}), ze._locales = new Hi(() => Object.keys(ze.ambiguousCharacterData.value).filter((t) => !t.startsWith("_")));
let zt = ze;
const gt = class gt {
  static getRawData() {
...
class Co {
  ...
  sendMessage(t, n) {
    ...
    return new Promise((r, a) => {
      this._pendingReplies[i] = {
        resolve: r,
        reject: a
      }, this._send(new ko(this._workerId, i, t, n));
    });
  }
  listen(t, n) {
    let i = null;
    const r = new Ce({
      onWillAddFirstListener: () => {
        i = String(++this._lastSentReq), this._pendingEmitters.set(i, r), this._send(new Ao(this._workerId, i, t, n));
      },
      onDidRemoveLastListener: () => {
        this._pendingEmitters.delete(i), this._send(new Lo(this._workerId, i)), i = null;
      }
    });
    return r.event;
  }
  ...
  _handleRequestMessage(t) {
    ...
    this._handler.handleMessage(t.method, t.args).then((r) => {
      this._send(new Ui(this._workerId, n, r, void 0));
    }, (r) => {
      r.detail instanceof Error && (r.detail = Ri(r.detail)), this._send(new Ui(this._workerId, n, void 0, Ri(r)));
    });
  }
...
class Ro {
  constructor(t, n) {
    this._requestHandlerFactory = n, this._requestHandler = null, this._protocol = new Co({
      sendMessage: (i, r) => {
        t(i, r);
      },
  ...
  initialize(t, n, i, r) {
    ...
    const o = Eo(r, (l, u) => this._protocol.sendMessage(l, u), (l, u) => this._protocol.listen(l, u));
    return this._requestHandlerFactory ? (this._requestHandler = this._requestHandlerFactory(o), Promise.resolve(qn(this._requestHandler))) : (n && (typeof n.baseUrl < "u" && delete n.baseUrl, typeof n.paths < "u" && typeof n.paths.vs < "u" && delete n.paths.vs, typeof n.trustedTypesPolicy < "u" && delete n.trustedTypesPolicy, n.catchError = !0, globalThis.require.config(n)), new Promise((l, u) => {
      ...
      c([i], (d) => {
        if (this._requestHandler = d.create(o), !this._requestHandler) {
...
function No(e, t, n) {
  return new Je(new Fi(e), new Fi(t)).ComputeDiff(n).changes;
}
class ot {
  static Assert(t, n) {
    if (!t)
...
class Pi {
  ...
  MarkNextChange() {
    (this.m_originalCount > 0 || this.m_modifiedCount > 0) && this.m_changes.push(new Ge(
...
class Je {
  constructor(t, n, i = null) {
    ...
    const [r, a, s] = Je._getElements(t), [o, l, u] = Je._getElements(n);
    this._hasStrings = s && u, this._originalStringElements = r, this._originalElementsOrHash = a, this._modifiedStringElements = o, this._modifiedElementsOrHash = l, this.m_forwardHistory = [], this.m_reverseHistory = [];
  }
  ...
  _ComputeDiff(t, n, i, r, a) {
    const s = [!1];
    let o = this.ComputeDiffRecursive(t, n, i, r, s);
  ...
  ComputeDiffRecursive(t, n, i, r, a) {
    ...
    const s = [0], o = [0], l = this.ComputeRecursionPoint(t, n, i, r, s, o, a), u = s[0], c = o[0];
    if (l !== null)
      return l;
    if (!a[0]) {
  ...
  WALKTRACE(t, n, i, r, a, s, o, l, u, c, d, m, f, g, p, _, x, w) {
    let y = null, S = null, E = new Pi(), F = n, v = i, b = f[0] - _[0] - r, T = -1073741824, q = this.m_forwardHistory.length - 1;
    do {
      const L = b + t;
      L === F || L < v && u[L - 1] < u[L + 1] ? (d = u[L + 1], g = d - b - r, d < T && E.MarkNextChange(), T = d, E.AddModifiedElement(d + 1, g), b = L + 1 - t) : (d = u[L - 1] + 1, g = d - b - r, d < T && E.MarkNextChange(), T = d - 1, E.AddOriginalElement(d, g + 1), b = L - 1 - t), q >= 0 && (u = this.m_forwardHistory[q], t = u[0], F = 1, v = u.length - 1);
    } while (--q >= -1);
    if (y = E.getReverseChanges(), w[0]) {
      let L = f[0] + 1, k = _[0] + 1;
      if (y !== null && y.length > 0) {
        const N = y[y.length - 1];
        L = Math.max(L, N.getOriginalEnd()), k = Math.max(k, N.getModifiedEnd());
      }
      S = [
        new Ge(
          L,
      ...
      E = new Pi(), F = s, v = o, b = f[0] - _[0] - l, T = 1073741824, q = x ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
      do {
        const L = b + a;
        L === F || L < v && c[L - 1] >= c[L + 1] ? (d = c[L + 1] - 1, g = d - b - l, d > T && E.MarkNextChange(), T = d + 1, E.AddOriginalElement(d + 1, g + 1), b = L + 1 - a) : (d = c[L - 1], g = d - b - l, d > T && E.MarkNextChange(), T = d, E.AddModifiedElement(d + 1, g + 1), b = L - 1 - a), q >= 0 && (c = this.m_reverseHistory[q], a = c[0], F = 1, v = c.length - 1);
      } while (--q >= -1);
      S = E.getChanges();
    }
    return this.ConcatenateChanges(y, S);
  }
  ComputeRecursionPoint(t, n, i, r, a, s, o) {
    let l = 0, u = 0, c = 0, d = 0, m = 0, f = 0;
    t--, i--, a[0] = 0, s[0] = 0, this.m_forwardHistory = [], this.m_reverseHistory = [];
    const g = n - t + (r - i), p = g + 1, _ = new Int32Array(p), x = new Int32Array(p), w = r - i, y = n - t, S = t - i, E = n - r, v = (y - w) % 2 === 0;
    _[w] = t, x[y] = n, o[0] = !1;
    for (let b = 1; b <= g / 2 + 1; b++) {
      let T = 0, q = 0;
      c = this.ClipDiagonalBound(w - b, b, w, p), d = this.ClipDiagonalBound(w + b, b, w, p);
      for (let k = c; k <= d; k += 2) {
        k === c || k < d && _[k - 1] < _[k + 1] ? l = _[k + 1] : l = _[k - 1] + 1, u = l - (k - w) - S;
        const N = l;
        for (; l < n && u < r && this.ElementsAreEqual(l + 1, u + 1); )
          l++, u++;
        if (_[k] = l, l + u > T + q && (T = l, q = u), !v && Math.abs(k - y) <= b - 1 && l >= x[k])
          return a[0] = l, s[0] = u, N <= x[k] && b <= 1448 ? this.WALKTRACE(w, c, d, S, y, m, f, E, _, x, l, n, a, u, r, s, v, o) : null;
      }
      const L = (T - t + (q - i) - b) / 2;
      if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(T, L))
        return o[0] = !0, a[0] = T, s[0] = q, L > 0 && b <= 1448 ? this.WALKTRACE(w, c, d, S, y, m, f, E, _, x, l, n, a, u, r, s, v, o) : (t++, i++, [
          new Ge(
            t,
            n - t + 1,
            i,
      ...
      m = this.ClipDiagonalBound(y - b, b, y, p), f = this.ClipDiagonalBound(y + b, b, y, p);
      for (let k = m; k <= f; k += 2) {
        k === m || k < f && x[k - 1] >= x[k + 1] ? l = x[k + 1] - 1 : l = x[k - 1], u = l - (k - y) - E;
        const N = l;
        for (; l > t && u > i && this.ElementsAreEqual(l, u); )
          l--, u--;
        if (x[k] = l, v && Math.abs(k - w) <= b && l <= _[k])
          return a[0] = l, s[0] = u, N >= _[k] && b <= 1448 ? this.WALKTRACE(w, c, d, S, y, m, f, E, _, x, l, n, a, u, r, s, v, o) : null;
      }
      if (b <= 1447) {
        let k = new Int32Array(d - c + 2);
        k[0] = w - c + 1, lt.Copy2(_, c, k, 1, d - c + 1), this.m_forwardHistory.push(k), k = new Int32Array(f - m + 2), k[0] = y - m + 1, lt.Copy2(x, m, k, 1, f - m + 1), this.m_reverseHistory.push(k);
      }
    }
    return this.WALKTRACE(w, c, d, S, y, m, f, E, _, x, l, n, a, u, r, s, v, o);
  }
  PrettifyChanges(t) {
    for (let n = 0; n < t.length; n++) {
      const i = t[n], r = n < t.length - 1 ? t[n + 1].originalStart : this._originalElementsOrHash.length, a = n < t.length - 1 ? t[n + 1].modifiedStart : this._modifiedElementsOrHash.length, s = i.originalLength > 0, o = i.modifiedLength > 0;
      for (; i.originalStart + i.originalLength < r && i.modifiedStart + i.modifiedLength < a && (!s || this.OriginalElementsAreEqual(i.originalStart, i.originalStart + i.originalLength)) && (!o || this.ModifiedElementsAreEqual(i.modifiedStart, i.modifiedStart + i.modifiedLength)); ) {
    ...
    for (let n = t.length - 1; n >= 0; n--) {
      ...
      const s = i.originalLength > 0, o = i.modifiedLength > 0;
      ...
      for (let d = 1; ; d++) {
        ...
        if (m < r || f < a || s && !this.OriginalElementsAreEqual(m, m + i.originalLength) || o && !this.ModifiedElementsAreEqual(f, f + i.modifiedLength))
          break;
    ...
    if (this._hasStrings)
      for (let n = 1, i = t.length; n < i; n++) {
        const r = t[n - 1], a = t[n], s = a.originalStart - r.originalStart - r.originalLength, o = r.originalStart, l = a.originalStart + a.originalLength, u = l - o, c = r.modifiedStart, d = a.modifiedStart + a.modifiedLength, m = d - c;
        if (s < 5 && u < 20 && m < 20) {
          const f = this._findBetterContiguousSequence(o, u, c, m, s);
          if (f) {
            const [g, p] = f;
            (g !== r.originalStart + r.originalLength || p !== r.modifiedStart + r.modifiedLength) && (r.originalLength = g - r.originalStart, r.modifiedLength = p - r.modifiedStart, a.originalStart = g + s, a.modifiedStart = p + s, a.originalLength = l - a.originalStart, a.modifiedLength = d - a.modifiedStart);
          }
        }
      }
    return t;
  ...
  ChangesOverlap(t, n, i) {
    if (ot.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), ot.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
      ...
      return t.originalStart + t.originalLength >= n.originalStart && (a = n.originalStart + n.originalLength - t.originalStart), t.modifiedStart + t.modifiedLength >= n.modifiedStart && (o = n.modifiedStart + n.modifiedLength - t.modifiedStart), i[0] = new Ge(r, a, s, o), !0;
    } else
      return i[0] = null, !1;
  }
...
if (typeof Rn < "u" && typeof Rn.process < "u") {
  ...
  typeof process < "u" ? at = {
    ...
    get platform() {
      return It ? "win32" : lo ? "darwin" : "linux";
    },
    get arch() {
    },
    get env() {
...
const an = at.cwd, Do = at.env, Io = at.platform;
at.arch;
const zo = 65, Ho = 97, Uo = 90, Wo = 122, Ye = 46, ce = 47, ge = 92, Oe = 58, Fo = 63;
...
function Po(e, t) {
  if (e === null || typeof e != "object")
    throw new us(t, "Object", e);
}
function ae(e, t) {
  if (typeof e != "string")
    throw new us(t, "string", e);
}
const ke = Io === "win32";
function j(e) {
  return e === ce || e === ge;
...
function Ve(e) {
  return e >= zo && e <= Uo || e >= Ho && e <= Wo;
}
function sn(e, t, n, i) {
  let r = "", a = 0, s = -1, o = 0, l = 0;
  for (let u = 0; u <= e.length; ++u) {
    ...
    if (i(l)) {
      if (!(s === u - 1 || o === 1))
        if (o === 2) {
          if (r.length < 2 || a !== 2 || r.charCodeAt(r.length - 1) !== Ye || r.charCodeAt(r.length - 2) !== Ye) {
            if (r.length > 2) {
              const c = r.lastIndexOf(n);
              c === -1 ? (r = "", a = 0) : (r = r.slice(0, c), a = r.length - 1 - r.lastIndexOf(n)), s = u, o = 0;
              continue;
            } else if (r.length !== 0) {
              r = "", a = 0, s = u, o = 0;
              continue;
...
const ue = {
  resolve(...e) {
    ...
    for (let r = e.length - 1; r >= -1; r--) {
      let a;
      if (r >= 0) {
        if (a = e[r], ae(a, "path"), a.length === 0)
          continue;
      } else
        t.length === 0 ? a = an() : (a = Do[`=${t}`] || an(), (a === void 0 || a.slice(0, 2).toLowerCase() !== t.toLowerCase() && a.charCodeAt(2) === ge) && (a = `${t}\\`));
      const s = a.length;
      let o = 0, l = "", u = !1;
        ...
        if (u = !0, j(a.charCodeAt(1))) {
          ...
          if (d < s && d !== m) {
            ...
            if (d < s && d !== m) {
              for (m = d; d < s && !j(a.charCodeAt(d)); )
                d++;
              (d === s || d !== m) && (l = `\\\\${f}\\${a.slice(m, d)}`, o = d);
            }
          }
        } else
          o = 1;
      else
        Ve(c) && a.charCodeAt(1) === Oe && (l = a.slice(0, 2), o = 2, s > 2 && j(a.charCodeAt(2)) && (u = !0, o = 3));
      if (l.length > 0)
        if (t.length > 0) {
      ...
      if (i) {
        if (t.length > 0)
          break;
      } else if (n = `${a.slice(o)}\\${n}`, i = u, u && t.length > 0)
        break;
    }
    return n = sn(n, !i, "\\", j), i ? `${t}\\${n}` : `${t}${n}` || ".";
  },
  normalize(e) {
    ae(e, "path");
    const t = e.length;
    ...
    if (j(a))
      if (r = !0, j(e.charCodeAt(1))) {
        let o = 2, l = o;
        for (; o < t && !j(e.charCodeAt(o)); )
          o++;
        if (o < t && o !== l) {
          const u = e.slice(l, o);
          for (l = o; o < t && j(e.charCodeAt(o)); )
            o++;
          if (o < t && o !== l) {
            for (l = o; o < t && !j(e.charCodeAt(o)); )
              o++;
            if (o === t)
              return `\\\\${u}\\${e.slice(l)}\\`;
            o !== l && (i = `\\\\${u}\\${e.slice(l, o)}`, n = o);
          }
        }
      } else
        n = 1;
    else
      Ve(a) && e.charCodeAt(1) === Oe && (i = e.slice(0, 2), n = 2, t > 2 && j(e.charCodeAt(2)) && (r = !0, n = 3));
    let s = n < t ? sn(e.slice(n), !r, "\\", j) : "";
  ...
  isAbsolute(e) {
    ...
    return j(n) || t > 2 && Ve(n) && e.charCodeAt(1) === Oe && j(e.charCodeAt(2));
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let a = 0; a < e.length; ++a) {
      const s = e[a];
      ae(s, "path"), s.length > 0 && (t === void 0 ? t = n = s : t += `\\${s}`);
    }
    if (t === void 0)
      return ".";
    let i = !0, r = 0;
  ...
  relative(e, t) {
    if (ae(e, "from"), ae(t, "to"), e === t)
      return "";
    const n = ue.resolve(e), i = ue.resolve(t);
    ...
    if (m !== c) {
      ...
      if (u > c) {
        if (t.charCodeAt(o + m) === ge)
          return i.slice(o + m + 1);
        if (m === 2)
          return i.slice(o + m);
      }
      s > c && (e.charCodeAt(r + m) === ge ? d = m : m === 2 && (d = 3)), d === -1 && (d = 0);
    }
    let f = "";
    for (m = r + d + 1; m <= a; ++m)
      (m === a || e.charCodeAt(m) === ge) && (f += f.length === 0 ? ".." : "\\..");
    return o += d, f.length > 0 ? `${f}${i.slice(o, l)}` : (i.charCodeAt(o) === ge && ++o, i.slice(o, l));
  },
  toNamespacedPath(e) {
    ...
    } else if (Ve(t.charCodeAt(0)) && t.charCodeAt(1) === Oe && t.charCodeAt(2) === ge)
      return `\\\\?\\${t}`;
    return e;
  },
  dirname(e) {
    ...
    if (j(r)) {
      ...
      Ve(r) && e.charCodeAt(1) === Oe && (n = t > 2 && j(e.charCodeAt(2)) ? 3 : 2, i = n);
    let a = -1, s = !0;
    for (let o = t - 1; o >= i; --o)
      if (j(e.charCodeAt(o))) {
        if (!s) {
  ...
  basename(e, t) {
    t !== void 0 && ae(t, "ext"), ae(e, "path");
    let n = 0, i = -1, r = !0, a;
    if (e.length >= 2 && Ve(e.charCodeAt(0)) && e.charCodeAt(1) === Oe && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
      if (t === e)
        return "";
      ...
      for (a = e.length - 1; a >= n; --a) {
        ...
        if (j(l)) {
          ...
          o === -1 && (r = !1, o = a + 1), s >= 0 && (l === t.charCodeAt(s) ? --s === -1 && (i = a) : (s = -1, i = o));
      }
      return n === i ? i = o : i === -1 && (i = e.length), e.slice(n, i);
    }
    for (a = e.length - 1; a >= n; --a)
      if (j(e.charCodeAt(a))) {
        if (!r) {
  ...
  extname(e) {
    ...
    e.length >= 2 && e.charCodeAt(1) === Oe && Ve(e.charCodeAt(0)) && (t = i = 2);
    for (let o = e.length - 1; o >= t; --o) {
      ...
      r === -1 && (a = !1, r = o + 1), l === Ye ? n === -1 ? n = o : s !== 1 && (s = 1) : n !== -1 && (s = -1);
    }
  ...
  parse(e) {
    ...
    } else if (Ve(r) && e.charCodeAt(1) === Oe) {
      if (n <= 2)
    ...
    let a = -1, s = i, o = -1, l = !0, u = e.length - 1, c = 0;
    for (; u >= i; --u) {
      ...
      o === -1 && (l = !1, o = u + 1), r === Ye ? a === -1 ? a = u : c !== 1 && (c = 1) : a !== -1 && (c = -1);
    }
    return o !== -1 && (a === -1 || c === 0 || c === 1 && a === o - 1 && a === s + 1 ? t.base = t.name = e.slice(s, o) : (t.name = e.slice(s, a), t.base = e.slice(s, o), t.ext = e.slice(a, o))), s > 0 && s !== i ? t.dir = e.slice(0, s - 1) : t.dir = t.root, t;
  },
  sep: "\\",
  delimiter: ";",
  win32: null,
  ...
  resolve(...e) {
    ...
    for (let i = e.length - 1; i >= -1 && !n; i--) {
      const r = i >= 0 ? e[i] : Bo();
      ae(r, "path"), r.length !== 0 && (t = `${r}/${t}`, n = r.charCodeAt(0) === ce);
    }
    return t = sn(t, !n, "/", Gn), n ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (ae(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ce, n = e.charCodeAt(e.length - 1) === ce;
    return e = sn(e, !t, "/", Gn), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
    return ae(e, "path"), e.length > 0 && e.charCodeAt(0) === ce;
  },
  join(...e) {
    if (e.length === 0)
      return ".";
    ...
    for (let n = 0; n < e.length; ++n) {
      const i = e[n];
      ae(i, "path"), i.length > 0 && (t === void 0 ? t = i : t += `/${i}`);
    }
    return t === void 0 ? "." : de.normalize(t);
  },
  relative(e, t) {
    if (ae(e, "from"), ae(t, "to"), e === t || (e = de.resolve(e), t = de.resolve(t), e === t))
      return "";
    const n = 1, i = e.length, r = i - n, a = 1, s = t.length - a, o = r < s ? r : s;
    let l = -1, u = 0;
    for (; u < o; u++) {
    ...
    if (u === o)
      if (s > o) {
        if (t.charCodeAt(a + u) === ce)
          return t.slice(a + u + 1);
        if (u === 0)
          return t.slice(a + u);
      } else
        r > o && (e.charCodeAt(n + u) === ce ? l = u : u === 0 && (l = 0));
    let c = "";
    for (u = n + l + 1; u <= i; ++u)
      (u === i || e.charCodeAt(u) === ce) && (c += c.length === 0 ? ".." : "/..");
  ...
  dirname(e) {
    if (ae(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === ce;
    let n = -1, i = !0;
    for (let r = e.length - 1; r >= 1; --r)
      if (e.charCodeAt(r) === ce) {
        if (!i) {
          n = r;
          break;
        }
  ...
  extname(e) {
    ...
    for (let s = e.length - 1; s >= 0; --s) {
      ...
      i === -1 && (r = !1, i = s + 1), o === Ye ? t === -1 ? t = s : a !== 1 && (a = 1) : t !== -1 && (a = -1);
    }
  ...
  parse(e) {
    ...
    if (e.length === 0)
      return t;
    const n = e.charCodeAt(0) === ce;
    let i;
    n ? (t.root = "/", i = 1) : i = 0;
    let r = -1, a = 0, s = -1, o = !0, l = e.length - 1, u = 0;
    for (; l >= i; --l) {
      ...
      s === -1 && (o = !1, s = l + 1), c === Ye ? r === -1 ? r = l : u !== 1 && (u = 1) : r !== -1 && (u = -1);
    }
    if (s !== -1) {
      const c = a === 0 && n ? 1 : a;
      r === -1 || u === 0 || u === 1 && r === s - 1 && r === a + 1 ? t.base = t.name = e.slice(c, s) : (t.name = e.slice(c, r), t.base = e.slice(c, s), t.ext = e.slice(r, s));
    }
...
de.win32 = ue.win32 = ue;
de.posix = ue.posix = de;
ke ? ue.normalize : de.normalize;
ke ? ue.isAbsolute : de.isAbsolute;
ke ? ue.join : de.join;
ke ? ue.resolve : de.resolve;
ke ? ue.relative : de.relative;
ke ? ue.dirname : de.dirname;
ke ? ue.basename : de.basename;
ke ? ue.extname : de.extname;
ke ? ue.parse : de.parse;
ke ? ue.sep : de.sep;
ke ? ue.delimiter : de.delimiter;
const qo = /^\w[\w\d+.-]*$/, Oo = /^\//, Vo = /^\/\//;
function jo(e, t) {
  if (!e.scheme && t)
    throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);
  if (e.scheme && !qo.test(e.scheme))
...
let wi = class Yt {
  ...
  constructor(t, n, i, r, a, s = !1) {
    typeof t == "object" ? (this.scheme = t.scheme || ee, this.authority = t.authority || ee, this.path = t.path || ee, this.query = t.query || ee, this.fragment = t.fragment || ee) : (this.scheme = Go(t, s), this.authority = n || ee, this.path = $o(this.scheme, i || ee), this.query = r || ee, this.fragment = a || ee, jo(this, s));
  }
  get fsPath() {
    return $n(this, !1);
  }
  with(t) {
    ...
    return n === void 0 ? n = this.scheme : n === null && (n = ee), i === void 0 ? i = this.authority : i === null && (i = ee), r === void 0 ? r = this.path : r === null && (r = ee), a === void 0 ? a = this.query : a === null && (a = ee), s === void 0 ? s = this.fragment : s === null && (s = ee), n === this.scheme && i === this.authority && r === this.path && a === this.query && s === this.fragment ? this : new ut(n, i, r, a, s);
  }
  static parse(t, n = !1) {
    const i = Xo.exec(t);
    return i ? new ut(
      ...
      Vt(i[9] || ee),
      n
    ) : new ut(ee, ee, ee, ee, ee);
  }
  static file(t) {
    let n = ee;
    if (It && (t = t.replace(/\\/g, Ee)), t[0] === Ee && t[1] === Ee) {
      const i = t.indexOf(Ee, 2);
      i === -1 ? (n = t.substring(2), t = Ee) : (n = t.substring(2, i), t = t.substring(i) || Ee);
    }
    return new ut("file", n, t, ee, ee);
  }
  static from(t, n) {
    return new ut(
      t.scheme,
  ...
  static joinPath(t, ...n) {
    ...
    let i;
    return It && t.scheme === "file" ? i = Yt.file(ue.join($n(t, !0), ...n)).path : i = de.join(t.path, ...n), t.with({ path: i });
  }
  toString(t = !1) {
    return Xn(this, t);
  }
...
function Bi(e, t, n) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    if (s >= 97 && s <= 122 || s >= 65 && s <= 90 || s >= 48 && s <= 57 || s === 45 || s === 46 || s === 95 || s === 126 || t && s === 47 || n && s === 91 || n && s === 93 || n && s === 58)
      ...
      const o = ds[s];
      o !== void 0 ? (r !== -1 && (i += encodeURIComponent(e.substring(r, a)), r = -1), i += o) : r === -1 && (r = a);
    }
  }
...
function Jo(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const i = e.charCodeAt(n);
    i === 35 || i === 63 ? (t === void 0 && (t = e.substr(0, n)), t += ds[i]) : t !== void 0 && (t += e[n]);
  }
  return t !== void 0 ? t : e;
}
function $n(e, t) {
...
function Xn(e, t) {
  const n = t ? Jo : Bi;
  let i = "", { scheme: r, authority: a, path: s, query: o, fragment: l } = e;
  if (r && (i += r, i += ":"), (a || r === "file") && (i += Ee, i += Ee), a) {
    let u = a.indexOf("@");
    if (u !== -1) {
  ...
  return o && (i += "?", i += n(o, !1, !1)), l && (i += "#", i += t ? l : Bi(l, !1, !1)), i;
}
function ms(e) {
  try {
...
function Vt(e) {
  return e.match(qi) ? e.replace(qi, (t) => ms(t)) : e;
}
let Ne = class tt {
  constructor(t, n) {
  ...
  static intersectRanges(t, n) {
    ...
    return i < o ? (i = o, r = l) : i === o && (r = Math.max(r, l)), a > u ? (a = u, s = c) : a === u && (s = Math.min(s, c)), i > a || i === a && r > s ? null : new se(
      i,
      r,
      a,
      s
...
function _i(e, t, n, i, r) {
  if (t = ps(t), r || (r = tn.first(gs)), n.length > r.maxLen) {
    let u = e - r.maxLen / 2;
    return u < 0 ? u = 0 : i += u, n = n.substring(u, e + r.maxLen / 2), _i(e, t, n, i, r);
  }
...
class yi {
  constructor(t) {
    const n = Oi(t);
    this._defaultValue = n, this._asciiMap = yi._createAsciiMap(n), this._map = /* @__PURE__ */ new Map();
  }
...
function al() {
  if (Tt === null) {
    ...
    const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…`;
    for (let n = 0; n < e.length; n++)
      Tt.set(e.charCodeAt(n), 1);
    const t = ".,;:";
    for (let n = 0; n < t.length; n++)
      Tt.set(t.charCodeAt(n), 2);
  }
  return Tt;
}
class on {
  static _createLink(t, n, i, r, a) {
    ...
    if (r > 0) {
      const o = n.charCodeAt(r - 1), l = n.charCodeAt(s);
      (o === 40 && l === 41 || o === 91 && l === 93 || o === 123 && l === 125) && s--;
    }
    return {
      range: {
        startLineNumber: i,
  ...
  static computeLinks(t, n = rl()) {
    ...
    for (let a = 1, s = t.getLineCount(); a <= s; a++) {
      const o = t.getLineContent(a), l = o.length;
      let u = 0, c = 0, d = 0, m = 1, f = !1, g = !1, p = !1, _ = !1;
      for (; u < l; ) {
        let x = !1;
        ...
        if (m === 13) {
          ...
          switch (w) {
            ...
            case 34:
            case 96:
              d === w ? y = 1 : d === 39 || d === 34 || d === 96 ? y = 0 : y = 1;
              break;
            case 42:
              y = d === 42 ? 1 : 0;
              break;
          ...
          y === 1 && (r.push(on._createLink(i, o, a, c, u)), x = !0);
        } else if (m === 12) {
          let y;
          w === 91 ? (g = !0, y = 0) : y = i.get(w), y === 1 ? x = !0 : m = 13;
        } else
          m = n.nextState(m, w), m === 0 && (x = !0);
        x && (m = 1, f = !1, g = !1, _ = !1, c = u + 1, d = w), u++;
      }
      m === 13 && r.push(on._createLink(i, o, a, c, l));
    }
    return r;
  }
}
...
const Zt = new xi(), Qn = new xi(), Yn = new xi(), ol = new Array(230), ll = /* @__PURE__ */ Object.create(null), ul = /* @__PURE__ */ Object.create(null);
(function() {
  const e = "", t = [
  ...
  for (const r of t) {
    const [a, s, o, l, u, c, d, m, f] = r;
    if (i[s] || (i[s] = !0, ll[o] = s, ul[o.toLowerCase()] = s), !n[l]) {
      if (n[l] = !0, !u)
        throw new Error(`String representation missing for key code ${l} around scan code ${o}`);
      Zt.define(l, u), Qn.define(l, m || u), Yn.define(l, f || m || u);
    }
    c && (ol[c] = l);
  }
})();
...
(function(e) {
  function t(o) {
    return Zt.keyCodeToStr(o);
  }
  e.toString = t;
  function n(o) {
    return Zt.strToKeyCode(o);
  }
  e.fromString = n;
  function i(o) {
    return Qn.keyCodeToStr(o);
  }
  e.toUserSettingsUS = i;
  function r(o) {
    return Yn.keyCodeToStr(o);
  }
  e.toUserSettingsGeneral = r;
  function a(o) {
    return Qn.strToKeyCode(o) || Yn.strToKeyCode(o);
  }
...
const O = {
  ...
  runCoverage: h("run-all-coverage", 60460),
...
class hl {
  constructor() {
    this._tokenizationSupports = /* @__PURE__ */ new Map(), this._factories = /* @__PURE__ */ new Map(), this._onDidChange = new Ce(), this.onDidChange = this._onDidChange.event, this._colorMap = null;
  }
  handleChange(t) {
  ...
  register(t, n) {
    return this._tokenizationSupports.set(t, n), this.handleChange([t]), nn(() => {
  ...
  registerFactory(t, n) {
    ...
    const i = new dl(this, t, n);
    return this._factories.set(t, i), nn(() => {
...
te("vs/editor/common/languages", "Array", "array"), te("vs/editor/common/languages", "Boolean", "boolean"), te("vs/editor/common/languages", "Class", "class"), te("vs/editor/common/languages", "Constant", "constant"), te("vs/editor/common/languages", "Constructor", "constructor"), te("vs/editor/common/languages", "Enum", "enumeration"), te("vs/editor/common/languages", "EnumMember", "enumeration member"), te("vs/editor/common/languages", "Event", "event"), te("vs/editor/common/languages", "Field", "field"), te("vs/editor/common/languages", "File", "file"), te("vs/editor/common/languages", "Function", "function"), te("vs/editor/common/languages", "Interface", "interface"), te("vs/editor/common/languages", "Key", "key"), te("vs/editor/common/languages", "Method", "method"), te("vs/editor/common/languages", "Module", "module"), te("vs/editor/common/languages", "Namespace", "namespace"), te("vs/editor/common/languages", "Null", "null"), te("vs/editor/common/languages", "Number", "number"), te("vs/editor/common/languages", "Object", "object"), te("vs/editor/common/languages", "Operator", "operator"), te("vs/editor/common/languages", "Package", "package"), te("vs/editor/common/languages", "Property", "property"), te("vs/editor/common/languages", "String", "string"), te("vs/editor/common/languages", "Struct", "struct"), te("vs/editor/common/languages", "TypeParameter", "type parameter"), te("vs/editor/common/languages", "Variable", "variable");
var Qi;
(function(e) {
  const t = /* @__PURE__ */ new Map();
...
}, ve.Comment = new ve("comment"), ve.Imports = new ve("imports"), ve.Region = new ve("region"), ve);
var Yi;
(function(e) {
  function t(n) {
...
bt.CtrlCmd = 2048, bt.Shift = 1024, bt.Alt = 512, bt.WinCtrl = 256;
let ni = bt;
function fl() {
  return {
    editor: void 0,
    languages: void 0,
    CancellationTokenSource: ho,
    Emitter: Ce,
    KeyCode: Zn,
    KeyMod: ni,
    Position: Ne,
...
function bl(e, t, n, i, r) {
  return pl(e, t, n, i, r) && gl(e, t, n, i, r);
}
class vl {
  constructor(t, n) {
  ...
  next(t) {
    ...
    do {
      ...
      if (r === this._prevMatchStartIndex && a === this._prevMatchLength) {
        if (a === 0) {
          _o(t, n, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
          continue;
        }
        return null;
      }
      if (this._prevMatchStartIndex = r, this._prevMatchLength = a, !this._wordSeparators || bl(this._wordSeparators, t, n, r, a))
        return i;
    } while (i);
    return null;
  }
}
function wl(e, t = "Unreachable") {
  throw new Error(t);
}
function ln(e) {
  if (!e()) {
    debugger;
    e(), is(new Fe("Assertion Failed"));
  }
}
function bs(e, t) {
  let n = 0;
...
class _l {
  static computeUnicodeHighlights(t, n, i) {
    const r = i ? i.startLineNumber : 1, a = i ? i.endLineNumber : t.getLineCount(), s = new Gr(n), o = s.getCandidateCodePoints();
    let l;
    o === "allNonBasicAscii" ? l = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : l = new RegExp(`${yl(Array.from(o))}`, "g");
    const u = new vl(null, l), c = [];
    let d = !1, m, f = 0, g = 0, p = 0;
    e:
      for (let _ = r, x = a; _ <= x; _++) {
        const w = t.getLineContent(_), y = w.length;
        u.reset(0);
        do
          if (m = u.next(w), m) {
            let S = m.index, E = m.index + m[0].length;
            if (S > 0) {
              const T = w.charCodeAt(S - 1);
              jn(T) && S--;
            }
            if (E + 1 < y) {
              const T = w.charCodeAt(E - 1);
              jn(T) && E++;
            }
            const F = w.substring(S, E);
            let v = _i(S + 1, fs, w, 0);
            v && v.endColumn <= S + 1 && (v = null);
            const b = s.shouldHighlightNonBasicASCII(F, v ? v.word : null);
            if (b !== 0) {
              if (b === 3 ? f++ : b === 2 ? g++ : b === 1 ? p++ : wl(), c.length >= 1e3) {
                d = !0;
                break e;
              }
              c.push(new ie(_, S + 1, _, E + 1));
            }
          }
        while (m);
      }
  ...
  static computeUnicodeHighlightReason(t, n) {
    ...
    switch (i.shouldHighlightNonBasicASCII(t, null)) {
      ...
      case 2:
        return { kind: 1 };
      case 3: {
        const a = t.codePointAt(0), s = i.ambiguousCharacters.getPrimaryConfusable(a), o = zt.getLocales().filter((l) => !zt.getInstance(/* @__PURE__ */ new Set([...n.allowedLocales, l])).isAmbiguous(a));
...
function yl(e, t) {
  return `[${fo(e.map((i) => String.fromCodePoint(i)).join(""))}]`;
}
class Gr {
  constructor(t) {
  ...
  getCandidateCodePoints() {
    ...
    if (this.options.invisibleCharacters)
      for (const n of Lt.codePoints)
        $r(String.fromCodePoint(n)) || t.add(n);
  ...
  shouldHighlightNonBasicASCII(t, n) {
    ...
    if (n)
      for (const s of n) {
        const o = s.codePointAt(0), l = xo(s);
        r = r || l, !l && !this.ambiguousCharacters.isAmbiguous(o) && !Lt.isInvisibleCharacter(o) && (a = !0);
      }
    return !r && a ? 0 : this.options.invisibleCharacters && !$r(t) && Lt.isInvisibleCharacter(i) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(i) ? 3 : 0;
  }
}
function $r(e) {
  return e === " " || e === `
...
class Ti {
  ...
  flip() {
    return new Ti(this.lineRangeMapping.flip(), this.changes.map((t) => t.flip()));
  }
}
class X {
  static addRange(t, n) {
  ...
  constructor(t, n) {
    if (this.start = t, this.endExclusive = n, t > n)
      throw new Fe(`Invalid range: ${this.toString()}`);
  }
  get isEmpty() {
  ...
  clip(t) {
    if (this.isEmpty)
      throw new Fe(`Invalid clipping range: ${this.toString()}`);
...
class G {
  ...
  static subtract(t, n) {
    return n ? t.startLineNumber < n.startLineNumber && n.endLineNumberExclusive < t.endLineNumberExclusive ? [
      new G(t.startLineNumber, n.startLineNumber),
      new G(n.endLineNumberExclusive, t.endLineNumberExclusive)
    ] : n.startLineNumber <= t.startLineNumber && t.endLineNumberExclusive <= n.endLineNumberExclusive ? [] : n.endLineNumberExclusive < t.endLineNumberExclusive ? [new G(
      Math.max(n.endLineNumberExclusive, t.startLineNumber),
      t.endLineNumberExclusive
    )] : [new G(t.startLineNumber, Math.min(n.startLineNumber, t.endLineNumberExclusive))] : [t];
  }
  static joinMany(t) {
    if (t.length === 0)
      return [];
  ...
  constructor(t, n) {
    if (t > n)
      throw new Fe(`startLineNumber ${t} cannot be after endLineNumberExclusive ${n}`);
  ...
  toInclusiveRange() {
    return this.isEmpty ? null : new ie(
  ...
  toExclusiveRange() {
    return new ie(this.startLineNumber, 1, this.endLineNumberExclusive, 1);
  }
  mapToLineArray(t) {
    const n = [];
...
class He {
  ...
  addRange(t) {
    if (t.length === 0)
      return;
    const n = Wn(this._normalizedRanges, (r) => r.endLineNumberExclusive >= t.startLineNumber), i = Nt(this._normalizedRanges, (r) => r.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
  ...
  contains(t) {
    const n = yt(this._normalizedRanges, (i) => i.startLineNumber <= t);
    return !!n && n.endLineNumberExclusive > t;
  }
  intersects(t) {
    const n = yt(this._normalizedRanges, (i) => i.startLineNumber < t.endLineNumberExclusive);
  ...
  getUnion(t) {
    ...
    for (; i < this._normalizedRanges.length || r < t._normalizedRanges.length; ) {
      ...
      if (i < this._normalizedRanges.length && r < t._normalizedRanges.length) {
        const o = this._normalizedRanges[i], l = t._normalizedRanges[r];
        o.startLineNumber < l.startLineNumber ? (s = o, i++) : (s = l, r++);
      } else
        i < this._normalizedRanges.length ? (s = this._normalizedRanges[i], i++) : (s = t._normalizedRanges[r], r++);
      a === null ? a = s : a.endLineNumberExclusive >= s.startLineNumber ? a = new G(
        a.startLineNumber,
  ...
  subtractFrom(t) {
    const n = Wn(this._normalizedRanges, (s) => s.endLineNumberExclusive >= t.startLineNumber), i = Nt(this._normalizedRanges, (s) => s.startLineNumber <= t.endLineNumberExclusive) + 1;
    if (n === i)
      return new He([t]);
    const r = [];
    ...
    for (let s = n; s < i; s++) {
      ...
      o.startLineNumber > a && r.push(new G(a, o.startLineNumber)), a = o.endLineNumberExclusive;
    }
    return a < t.endLineNumberExclusive && r.push(new G(a, t.endLineNumberExclusive)), new He(r);
  }
  toString() {
  ...
  getIntersection(t) {
    ...
    let i = 0, r = 0;
    for (; i < this._normalizedRanges.length && r < t._normalizedRanges.length; ) {
      const a = this._normalizedRanges[i], s = t._normalizedRanges[r], o = a.intersect(s);
      o && !o.isEmpty && n.push(o), a.endLineNumberExclusive < s.endLineNumberExclusive ? i++ : r++;
    }
    return new He(n);
  }
  getWithDelta(t) {
...
class Re {
  static inverse(t, n, i) {
    ...
    let a = 1, s = 1;
    for (const l of t) {
      const u = new Re(new G(a, l.original.startLineNumber), new G(s, l.modified.startLineNumber));
      u.modified.isEmpty || r.push(u), a = l.original.endLineNumberExclusive, s = l.modified.endLineNumberExclusive;
    }
    const o = new Re(new G(a, n + 1), new G(s, i + 1));
    return o.modified.isEmpty || r.push(o), r;
  }
  static clip(t, n, i) {
    const r = [];
    for (const a of t) {
      const s = a.original.intersect(n), o = a.modified.intersect(i);
      s && !s.isEmpty && o && !o.isEmpty && r.push(new Re(s, o));
    }
    return r;
  }
  constructor(t, n) {
  ...
  join(t) {
    return new Re(this.original.join(t.original), this.modified.join(t.modified));
  }
...
class st extends Re {
  ...
  flip() {
    var t;
    return new st(this.modified, this.original, (t = this.innerChanges) == null ? void 0 : t.map((n) => n.flip()));
  }
}
class Ht {
  constructor(t, n) {
  ...
  flip() {
    return new Ht(this.modifiedRange, this.originalRange);
  }
}
const xl = 3;
class Tl {
  computeDiff(t, n, i) {
    ...
    for (const u of a.changes) {
      let c;
      u.originalEndLineNumber === 0 ? c = new G(u.originalStartLineNumber + 1, u.originalStartLineNumber + 1) : c = new G(u.originalStartLineNumber, u.originalEndLineNumber + 1);
      let d;
      u.modifiedEndLineNumber === 0 ? d = new G(u.modifiedStartLineNumber + 1, u.modifiedStartLineNumber + 1) : d = new G(u.modifiedStartLineNumber, u.modifiedEndLineNumber + 1);
      let m = new st(c, d, (l = u.charChanges) == null ? void 0 : l.map((f) => new Ht(new ie(
      ...
      o && (o.modified.endLineNumberExclusive === m.modified.startLineNumber || o.original.endLineNumberExclusive === m.original.startLineNumber) && (m = new st(
    ...
    return ln(() => bs(s, (u, c) => c.original.startLineNumber - u.original.endLineNumberExclusive === c.modified.startLineNumber - u.modified.endLineNumberExclusive && u.original.endLineNumberExclusive < c.original.startLineNumber && u.modified.endLineNumberExclusive < c.modified.startLineNumber)), new Kt(s, [], a.quitEarly);
  }
}
function vs(e, t, n, i) {
...
let Xr = class {
  ...
  createCharSequence(t, n, i) {
    ...
    let o = 0;
    for (let l = n; l <= i; l++) {
      const u = this.lines[l], c = t ? this._startColumns[l] : 1, d = t ? this._endColumns[l] : u.length + 1;
      for (let m = c; m < d; m++)
        r[o] = u.charCodeAt(m - 1), a[o] = l + 1, s[o] = m, o++;
      !t && l < i && (r[o] = 10, a[o] = l + 1, s[o] = u.length + 1, o++);
    }
    return new kl(r, a, s);
  }
};
...
class vt {
  constructor(t, n, i, r, a, s, o, l) {
    this.originalStartLineNumber = t, this.originalStartColumn = n, this.originalEndLineNumber = i, this.originalEndColumn = r, this.modifiedStartLineNumber = a, this.modifiedStartColumn = s, this.modifiedEndLineNumber = o, this.modifiedEndColumn = l;
  }
...
function Al(e) {
  ...
  for (let i = 1, r = e.length; i < r; i++) {
    const a = e[i], s = a.originalStart - (n.originalStart + n.originalLength), o = a.modifiedStart - (n.modifiedStart + n.modifiedLength);
    Math.min(s, o) < xl ? (n.originalLength = a.originalStart + a.originalLength - n.originalStart, n.modifiedLength = a.modifiedStart + a.modifiedLength - n.modifiedStart) : (t.push(a), n = a);
  }
  return t;
}
class Ct {
  ...
  static createFromDiffResult(t, n, i, r, a, s, o) {
    let l, u, c, d, m;
    if (n.originalLength === 0 ? (l = i.getStartLineNumber(n.originalStart) - 1, u = 0) : (l = i.getStartLineNumber(n.originalStart), u = i.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (c = r.getStartLineNumber(n.modifiedStart) - 1, d = 0) : (c = r.getStartLineNumber(n.modifiedStart), d = r.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), s && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && a()) {
      ...
      if (f.getElements().length > 0 && g.getElements().length > 0) {
        let p = vs(f, g, a, !0).changes;
        o && (p = Al(p)), m = [];
        for (let _ = 0, x = p.length; _ < x; _++)
          m.push(vt.createFromDiffChange(p[_], f, g));
      }
    }
    return new Ct(
      l,
...
class ws {
  ...
  computeDiff() {
    ...
    const t = vs(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), n = t.changes, i = t.quitEarly;
    if (this.shouldIgnoreTrimWhitespace) {
      const o = [];
      for (let l = 0, u = n.length; l < u; l++)
        o.push(Ct.createFromDiffResult(this.shouldIgnoreTrimWhitespace, n[l], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
      return {
        quitEarly: i,
        changes: o
      };
    ...
    for (let o = -1, l = n.length; o < l; o++) {
      const u = o + 1 < l ? n[o + 1] : null, c = u ? u.originalStart : this.originalLines.length, d = u ? u.modifiedStart : this.modifiedLines.length;
      for (; a < c && s < d; ) {
        const m = this.originalLines[a], f = this.modifiedLines[s];
        if (m !== f) {
          {
            let g = ii(m, 1), p = ii(f, 1);
            for (; g > 1 && p > 1; ) {
              const _ = m.charCodeAt(g - 2), x = f.charCodeAt(p - 2);
              if (_ !== x)
                break;
              g--, p--;
            }
          ...
          {
            let g = ri(m, 1), p = ri(f, 1);
            const _ = m.length + 1, x = f.length + 1;
            for (; g < _ && p < x; ) {
              const w = m.charCodeAt(g - 1), y = m.charCodeAt(p - 1);
              if (w !== y)
                break;
              g++, p++;
            }
            (g < _ || p < x) && this._pushTrimWhitespaceCharChange(r, a + 1, g, _, s + 1, p, x);
          }
        }
        a++, s++;
      }
      u && (r.push(Ct.createFromDiffResult(this.shouldIgnoreTrimWhitespace, u, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), a += u.originalLength, s += u.modifiedLength);
    }
    return {
      quitEarly: i,
      changes: r
  ...
  _pushTrimWhitespaceCharChange(t, n, i, r, a, s, o) {
    if (this._mergeTrimWhitespaceCharChange(t, n, i, r, a, s, o))
      return;
    let l;
    this.shouldComputeCharChanges && (l = [new vt(
      n,
      i,
      n,
      r,
  ...
  _mergeTrimWhitespaceCharChange(t, n, i, r, a, s, o) {
    const l = t.length;
    if (l === 0)
      return !1;
    const u = t[l - 1];
    return u.originalEndLineNumber === 0 || u.modifiedEndLineNumber === 0 ? !1 : u.originalEndLineNumber === n && u.modifiedEndLineNumber === a ? (this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new vt(
      n,
      i,
      n,
      r,
      ...
      a,
      o
    )), !0) : u.originalEndLineNumber + 1 === n && u.modifiedEndLineNumber + 1 === a ? (u.originalEndLineNumber = n, u.modifiedEndLineNumber = a, this.shouldComputeCharChanges && u.charChanges && u.charChanges.push(new vt(
      n,
      i,
      n,
      r,
...
class Pe {
  static trivial(t, n) {
    return new Pe([new re(X.ofLength(t.length), X.ofLength(n.length))], !1);
  }
  static trivialTimedOut(t, n) {
    return new Pe([new re(X.ofLength(t.length), X.ofLength(n.length))], !0);
  }
  constructor(t, n) {
...
class re {
  static invert(t, n) {
    const i = [];
    return Fs(t, (r, a) => {
      i.push(re.fromOffsetPairs(r ? r.getEndExclusives() : We.zero, a ? a.getStarts() : new We(
        n,
  ...
  static fromOffsetPairs(t, n) {
    return new re(new X(t.offset1, n.offset1), new X(t.offset2, n.offset2));
  }
  constructor(t, n) {
...
const nt = class nt {
  ...
  delta(t) {
    return t === 0 ? this : new nt(this.offset1 + t, this.offset2 + t);
  }
  equals(t) {
...
class Sl {
  constructor(t) {
    if (this.timeout = t, this.startTime = Date.now(), this.valid = !0, t <= 0)
      throw new Fe("timeout must be positive");
  }
  isValid() {
...
let un = Mt;
class Ll {
  compute(t, n, i = Ut.instance, r) {
    if (t.length === 0 || n.length === 0)
      return Pe.trivial(t, n);
    const a = new Nn(t.length, n.length), s = new Nn(t.length, n.length), o = new Nn(t.length, n.length);
    for (let g = 0; g < t.length; g++)
      for (let p = 0; p < n.length; p++) {
        if (!i.isValid())
          return Pe.trivialTimedOut(t, n);
        const _ = g === 0 ? 0 : a.get(g - 1, p), x = p === 0 ? 0 : a.get(g, p - 1);
        let w;
        t.getElement(g) === n.getElement(p) ? (g === 0 || p === 0 ? w = 0 : w = a.get(g - 1, p - 1), g > 0 && p > 0 && s.get(g - 1, p - 1) === 3 && (w += o.get(g - 1, p - 1)), w += r ? r(g, p) : 1) : w = -1;
        const y = Math.max(_, x, w);
        if (y === w) {
          const S = g > 0 && p > 0 ? o.get(g - 1, p - 1) : 0;
          o.set(g, p, S + 1), s.set(g, p, 3);
        } else
          y === _ ? (o.set(g, p, 0), s.set(g, p, 1)) : y === x && (o.set(g, p, 0), s.set(g, p, 2));
        a.set(g, p, y);
      }
    const l = [];
    let u = t.length, c = n.length;
    function d(g, p) {
      (g + 1 !== u || p + 1 !== c) && l.push(new re(new X(g + 1, u), new X(p + 1, c))), u = g, c = p;
    }
    let m = t.length - 1, f = n.length - 1;
    for (; m >= 0 && f >= 0; )
      s.get(m, f) === 3 ? (d(m, f), m--, f--) : s.get(m, f) === 1 ? m-- : f--;
    return d(-1, -1), l.reverse(), new Pe(l, !1);
  }
}
class _s {
  compute(t, n, i = Ut.instance) {
    if (t.length === 0 || n.length === 0)
      return Pe.trivial(t, n);
    const r = t, a = n;
    function s(p, _) {
      for (; p < r.length && _ < a.length && r.getElement(p) === a.getElement(_); )
        p++, _++;
      return p;
    }
    let o = 0;
    ...
    l.set(0, s(0, 0));
    const u = new El();
    u.set(0, l.get(0) === 0 ? null : new Qr(null, 0, 0, l.get(0)));
    let c = 0;
    e:
      for (; ; ) {
        if (o++, !i.isValid())
          return Pe.trivialTimedOut(r, a);
        const p = -Math.min(o, a.length + o % 2), _ = Math.min(o, r.length + o % 2);
        for (c = p; c <= _; c += 2) {
          const x = c === _ ? -1 : l.get(c + 1), w = c === p ? -1 : l.get(c - 1) + 1, y = Math.min(Math.max(x, w), r.length), S = y - c;
          if (y > r.length || S > a.length)
            continue;
          const E = s(y, S);
          l.set(c, E);
          const F = y === x ? u.get(c + 1) : u.get(c - 1);
          if (u.set(c, E !== y ? new Qr(F, y, S, E - y) : F), l.get(c) === r.length && l.get(c) - c === a.length)
            break e;
        }
      }
    let d = u.get(c);
    ...
    for (; ; ) {
      ...
      if ((p !== f || _ !== g) && m.push(new re(new X(p, f), new X(_, g))), !d)
        break;
...
class cn {
  ...
  getBoundaryScore(t) {
    const n = Zr(t > 0 ? this.elements[t - 1] : -1), i = Zr(t < this.elements.length ? this.elements[t] : -1);
    if (n === 7 && i === 8)
      return 0;
    if (n === 8)
      return 150;
    let r = 0;
    return n !== i && (r += 10, n === 0 && i === 1 && (r += 1)), r += Yr(n), r += Yr(i), r;
  }
  translateOffset(t) {
    if (this.lineRange.isEmpty)
      return new Ne(this.lineRange.start + 1, 1);
    const n = Nt(this.firstCharOffsetByLine, (i) => i <= t);
    return new Ne(
  ...
  translateRange(t) {
    return ie.fromPositions(this.translateOffset(t.start), this.translateOffset(t.endExclusive));
  }
  findWordContaining(t) {
    ...
    for (; n > 0 && Dn(this.elements[n - 1]); )
      n--;
    let i = t;
    for (; i < this.elements.length && Dn(this.elements[i]); )
      i++;
    return new X(n, i);
  }
  countLinesIn(t) {
  ...
  extendToFullLines(t) {
    const n = yt(this.firstCharOffsetByLine, (r) => r <= t.start) ?? 0, i = Hs(this.firstCharOffsetByLine, (r) => t.endExclusive <= r) ?? this.elements.length;
    return new X(n, i);
  }
}
function Dn(e) {
...
function Zr(e) {
  return e === 10 ? 8 : e === 13 ? 7 : ai(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
}
function Ml(e, t, n, i, r, a) {
  let { moves: s, excludedChanges: o } = Dl(e, t, n, a);
  if (!a.isValid())
    return [];
  const l = e.filter((c) => !o.has(c)), u = Il(l, i, r, t, n, a);
  return Bs(s, u), s = zl(s), s = s.filter((c) => {
    const d = c.original.toOffsetRange().slice(t).map((f) => f.trim());
    return d.join(`
`).length >= 15 && Nl(d, (f) => f.length >= 2) >= 2;
  }), s = Hl(e, s), s;
}
function Nl(e, t) {
  let n = 0;
...
function Dl(e, t, n, i) {
  const r = [], a = e.filter((l) => l.modified.isEmpty && l.original.length >= 3).map((l) => new un(l.original, t, l)), s = new Set(e.filter((l) => l.original.isEmpty && l.modified.length >= 3).map((l) => new un(l.modified, n, l))), o = /* @__PURE__ */ new Set();
  for (const l of a) {
    let u = -1, c;
    for (const d of s) {
    ...
    if (u > 0.9 && c && (s.delete(c), r.push(new Re(l.range, c.range)), o.add(l.source), o.add(c.source)), !i.isValid())
      return { moves: r, excludedChanges: o };
  }
  return { moves: r, excludedChanges: o };
}
function Il(e, t, n, i, r, a) {
  const s = [], o = new Os();
  for (const m of e)
    for (let f = m.original.startLineNumber; f < m.original.endLineNumberExclusive - 2; f++) {
      const g = `${t[f - 1]}:${t[f + 1 - 1]}:${t[f + 2 - 1]}`;
      o.add(g, { range: new G(f, f + 3) });
    }
  const l = [];
  ...
  for (const m of e) {
    ...
    for (let g = m.modified.startLineNumber; g < m.modified.endLineNumberExclusive - 2; g++) {
      const p = `${n[g - 1]}:${n[g + 1 - 1]}:${n[g + 2 - 1]}`, _ = new G(g, g + 3), x = [];
      o.forEach(p, ({ range: w }) => {
        for (const S of f)
          if (S.originalLineRange.endLineNumberExclusive + 1 === w.endLineNumberExclusive && S.modifiedLineRange.endLineNumberExclusive + 1 === _.endLineNumberExclusive) {
            S.originalLineRange = new G(
              S.originalLineRange.startLineNumber,
              w.endLineNumberExclusive
            ), S.modifiedLineRange = new G(
  ...
  l.sort(qs($t((m) => m.modifiedLineRange.length, Xt)));
  const u = new He(), c = new He();
  for (const m of l) {
    const f = m.modifiedLineRange.startLineNumber - m.originalLineRange.startLineNumber, g = u.subtractFrom(m.modifiedLineRange), p = c.subtractFrom(m.originalLineRange).getWithDelta(f), _ = g.getIntersection(p);
    for (const x of _.ranges) {
      if (x.length < 3)
        continue;
      const w = x, y = x.delta(-f);
      s.push(new Re(y, w)), u.addRange(w), c.addRange(y);
    }
  }
  s.sort($t((m) => m.original.startLineNumber, Xt));
  const d = new en(e);
  for (let m = 0; m < s.length; m++) {
    const f = s[m], g = d.findLastMonotonous((F) => F.original.startLineNumber <= f.original.startLineNumber), p = yt(e, (F) => F.modified.startLineNumber <= f.modified.startLineNumber), _ = Math.max(f.original.startLineNumber - g.original.startLineNumber, f.modified.startLineNumber - p.modified.startLineNumber), x = d.findLastMonotonous((F) => F.original.startLineNumber < f.original.endLineNumberExclusive), w = yt(e, (F) => F.modified.startLineNumber < f.modified.endLineNumberExclusive), y = Math.max(x.original.endLineNumberExclusive - f.original.endLineNumberExclusive, w.modified.endLineNumberExclusive - f.modified.endLineNumberExclusive);
    let S;
    for (S = 0; S < _; S++) {
      const F = f.original.startLineNumber - S - 1, v = f.modified.startLineNumber - S - 1;
      if (F > i.length || v > r.length || u.contains(v) || c.contains(F) || !Kr(i[F - 1], r[v - 1], a))
        break;
    }
    S > 0 && (c.addRange(new G(f.original.startLineNumber - S, f.original.startLineNumber)), u.addRange(new G(f.modified.startLineNumber - S, f.modified.startLineNumber)));
    let E;
    for (E = 0; E < y; E++) {
      const F = f.original.endLineNumberExclusive + E, v = f.modified.endLineNumberExclusive + E;
      if (F > i.length || v > r.length || u.contains(v) || c.contains(F) || !Kr(i[F - 1], r[v - 1], a))
        break;
    }
    E > 0 && (c.addRange(new G(
      f.original.endLineNumberExclusive,
      f.original.endLineNumberExclusive + E
    )), u.addRange(new G(
      f.modified.endLineNumberExclusive,
      f.modified.endLineNumberExclusive + E
    ))), (S > 0 || E > 0) && (s[m] = new Re(new G(
      f.original.startLineNumber - S,
      f.original.endLineNumberExclusive + E
    ), new G(
      f.modified.startLineNumber - S,
      f.modified.endLineNumberExclusive + E
    )));
  }
  return s;
...
function Kr(e, t, n) {
  ...
  if (e.length > 300 && t.length > 300)
    return !1;
  const r = new _s().compute(new cn([e], new X(0, 1), !1), new cn([t], new X(0, 1), !1), n);
  let a = 0;
...
function Hl(e, t) {
  const n = new en(e);
  return t = t.filter((i) => {
    const r = n.findLastMonotonous((o) => o.original.startLineNumber < i.original.endLineNumberExclusive) || new Re(new G(1, 1), new G(1, 1)), a = yt(e, (o) => o.modified.startLineNumber < i.modified.endLineNumberExclusive);
    return r !== a;
  }), t;
}
function ea(e, t, n) {
  let i = n;
  return i = ta(e, t, i), i = ta(e, t, i), i = Ul(e, t, i), i;
}
function ta(e, t, n) {
  if (n.length === 0)
    return n;
  ...
  for (let a = 1; a < n.length; a++) {
    ...
    if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
      const l = o.seq1Range.start - s.seq1Range.endExclusive;
      let u;
      for (u = 1; u <= l && !(e.getElement(o.seq1Range.start - u) !== e.getElement(o.seq1Range.endExclusive - u) || t.getElement(o.seq2Range.start - u) !== t.getElement(o.seq2Range.endExclusive - u)); u++)
        ;
      if (u--, u === l) {
        i[i.length - 1] = new re(new X(s.seq1Range.start, o.seq1Range.endExclusive - l), new X(s.seq2Range.start, o.seq2Range.endExclusive - l));
        continue;
      }
      o = o.delta(-u);
    }
  ...
  for (let a = 0; a < i.length - 1; a++) {
    ...
    let o = i[a];
    if (o.seq1Range.isEmpty || o.seq2Range.isEmpty) {
      const l = s.seq1Range.start - o.seq1Range.endExclusive;
      let u;
      for (u = 0; u < l && !(!e.isStronglyEqual(o.seq1Range.start + u, o.seq1Range.endExclusive + u) || !t.isStronglyEqual(o.seq2Range.start + u, o.seq2Range.endExclusive + u)); u++)
        ;
      if (u === l) {
        i[a + 1] = new re(new X(o.seq1Range.start + l, s.seq1Range.endExclusive), new X(o.seq2Range.start + l, s.seq2Range.endExclusive));
        continue;
      }
      u > 0 && (o = o.delta(u));
    }
...
function Ul(e, t, n) {
  ...
  for (let i = 0; i < n.length; i++) {
    const r = i > 0 ? n[i - 1] : void 0, a = n[i], s = i + 1 < n.length ? n[i + 1] : void 0, o = new X(
    ...
    a.seq1Range.isEmpty ? n[i] = na(a, e, t, o, l) : a.seq2Range.isEmpty && (n[i] = na(a.swap(), t, e, l, o).swap());
  }
  return n;
}
function na(e, t, n, i, r) {
  ...
  s--;
  let o = 0;
  for (; e.seq1Range.start + o < i.endExclusive && e.seq2Range.endExclusive + o < r.endExclusive && n.isStronglyEqual(e.seq2Range.start + o, e.seq2Range.endExclusive + o) && o < 100; )
    o++;
  if (s === 0 && o === 0)
    return e;
  let l = 0, u = -1;
...
function Fl(e, t, n) {
  const i = re.invert(n, e.length), r = [];
  let a = new We(0, 0);
  function s(l, u) {
    if (l.offset1 < a.offset1 || l.offset2 < a.offset2)
      return;
    const c = e.findWordContaining(l.offset1), d = t.findWordContaining(l.offset2);
    if (!c || !d)
      return;
    let m = new re(c, d);
    ...
    for (; i.length > 0; ) {
      const _ = i[0];
      if (!(_.seq1Range.intersects(c) || _.seq2Range.intersects(d)))
        break;
      const w = e.findWordContaining(_.seq1Range.start), y = t.findWordContaining(_.seq2Range.start), S = new re(w, y), E = S.intersect(_);
      if (g += E.seq1Range.length, p += E.seq2Range.length, m = m.join(S), m.seq1Range.endExclusive >= _.seq1Range.endExclusive)
        i.shift();
      else
        break;
    }
    g + p < (m.seq1Range.length + m.seq2Range.length) * 2 / 3 && r.push(m), a = m.getEndExclusives();
  }
  for (; i.length > 0; ) {
    const l = i.shift();
...
function Bl(e, t, n) {
  ...
  do {
    ...
    for (let l = 1; l < i.length; l++) {
      let d = function(f, g) {
        const p = new X(c.seq1Range.endExclusive, u.seq1Range.start);
        return e.getText(p).replace(/\s/g, "").length <= 4 && (f.seq1Range.length + f.seq2Range.length > 5 || g.seq1Range.length + g.seq2Range.length > 5);
      };
      var s = d;
      const u = i[l], c = o[o.length - 1];
      d(c, u) ? (a = !0, o[o.length - 1] = o[o.length - 1].join(u)) : o.push(u);
    }
    i = o;
  } while (r++ < 10 && a);
  return i;
...
function ql(e, t, n) {
  ...
  do {
    ...
    for (let u = 1; u < i.length; u++) {
      let m = function(g, p) {
        const _ = new X(d.seq1Range.endExclusive, c.seq1Range.start);
        if (e.countLinesIn(_) > 5 || _.length > 500)
          return !1;
        const w = e.getText(_).trim();
        if (w.length > 20 || w.split(/\r\n|\r|\n/).length > 1)
          return !1;
        const y = e.countLinesIn(g.seq1Range), S = g.seq1Range.length, E = t.countLinesIn(g.seq2Range), F = g.seq2Range.length, v = e.countLinesIn(p.seq1Range), b = p.seq1Range.length, T = t.countLinesIn(p.seq2Range), q = p.seq2Range.length, L = 2 * 40 + 50;
        function k(N) {
          return Math.min(N, L);
        }
        return Math.pow(Math.pow(k(y * 40 + S), 1.5) + Math.pow(k(E * 40 + F), 1.5), 1.5) + Math.pow(Math.pow(k(v * 40 + b), 1.5) + Math.pow(k(T * 40 + q), 1.5), 1.5) > (L ** 1.5) ** 1.5 * 1.3;
      };
      var o = m;
      const c = i[u], d = l[l.length - 1];
      m(d, c) ? (a = !0, l[l.length - 1] = l[l.length - 1].join(c)) : l.push(c);
    }
    i = l;
  } while (r++ < 10 && a);
  const s = [];
  return Ps(i, (l, u, c) => {
    ...
    const f = e.extendToFullLines(u.seq1Range), g = e.getText(new X(f.start, u.seq1Range.start));
    m(g) && (d = d.deltaStart(-g.length));
    const p = e.getText(new X(u.seq1Range.endExclusive, f.endExclusive));
    m(p) && (d = d.deltaEnd(p.length));
    const _ = re.fromOffsetPairs(l ? l.getEndExclusives() : We.zero, c ? c.getStarts() : We.max), x = d.intersect(_);
    s.length > 0 && x.getStarts().equals(s[s.length - 1].getEndExclusives()) ? s[s.length - 1] = s[s.length - 1].join(x) : s.push(x);
  }), s;
}
class ia {
  constructor(t, n) {
  ...
  getBoundaryScore(t) {
    const n = t === 0 ? 0 : ra(this.lines[t - 1]), i = t === this.lines.length ? 0 : ra(this.lines[t]);
    return 1e3 - (n + i);
  }
  getText(t) {
...
class Ol {
  constructor() {
    this.dynamicProgrammingDiffing = new Ll(), this.myersDiffingAlgorithm = new _s();
  }
  computeDiff(t, n, i) {
    if (t.length <= 1 && Us(t, n, (E, F) => E === F))
      return new Kt([], [], !1);
    if (t.length === 1 && t[0].length === 0 || n.length === 1 && n[0].length === 0)
      return new Kt([
        new st(new G(1, t.length + 1), new G(1, n.length + 1), [
          new Ht(new ie(1, 1, t.length, t[0].length + 1), new ie(1, 1, n.length, n[0].length + 1))
        ])
      ], [], !1);
    const r = i.maxComputationTimeMs === 0 ? Ut.instance : new Sl(i.maxComputationTimeMs), a = !i.ignoreTrimWhitespace, s = /* @__PURE__ */ new Map();
    function o(E) {
      let F = s.get(E);
      return F === void 0 && (F = s.size, s.set(E, F)), F;
    }
    const l = t.map((E) => o(E.trim())), u = n.map((E) => o(E.trim())), c = new ia(l, t), d = new ia(u, n), m = c.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(c, d, r, (E, F) => t[E] === n[F] ? n[F].length === 0 ? 0.1 : 1 + Math.log(1 + n[F].length) : 0.99) : this.myersDiffingAlgorithm.compute(c, d);
    let f = m.diffs, g = m.hitTimeout;
    f = ea(c, d, f), f = Bl(c, d, f);
    const p = [], _ = (E) => {
      if (a)
        for (let F = 0; F < E; F++) {
          const v = x + F, b = w + F;
          if (t[v] !== n[b]) {
            const T = this.refineDiff(t, n, new re(new X(v, v + 1), new X(b, b + 1)), r, a);
    ...
    let x = 0, w = 0;
    for (const E of f) {
      ln(() => E.seq1Range.start - x === E.seq2Range.start - w);
      const F = E.seq1Range.start - x;
      _(F), x = E.seq1Range.endExclusive, w = E.seq2Range.endExclusive;
      const v = this.refineDiff(t, n, E, r, a);
      v.hitTimeout && (g = !0);
      for (const b of v.mappings)
        p.push(b);
    }
    _(t.length - x);
    const y = aa(p, t, n);
    let S = [];
    return i.computeMoves && (S = this.computeMoves(y, t, n, l, u, r, a)), ln(() => {
      function E(v, b) {
        if (v.lineNumber < 1 || v.lineNumber > b.length)
          return !1;
        const T = b[v.lineNumber - 1];
        return !(v.column < 1 || v.column > T.length + 1);
      }
      function F(v, b) {
        return !(v.startLineNumber < 1 || v.startLineNumber > b.length + 1 || v.endLineNumberExclusive < 1 || v.endLineNumberExclusive > b.length + 1);
      }
      for (const v of y) {
        if (!v.innerChanges)
          return !1;
        for (const b of v.innerChanges)
          if (!(E(b.modifiedRange.getStartPosition(), n) && E(b.modifiedRange.getEndPosition(), n) && E(b.originalRange.getStartPosition(), t) && E(b.originalRange.getEndPosition(), t)))
            return !1;
  ...
  computeMoves(t, n, i, r, a, s, o) {
    return Ml(t, n, i, r, a, s).map((c) => {
      const d = this.refineDiff(n, i, new re(c.original.toOffsetRange(), c.modified.toOffsetRange()), s, o), m = aa(d.mappings, n, i, !0);
      return new Ti(c, m);
    });
  }
  refineDiff(t, n, i, r, a) {
    const s = new cn(t, i.seq1Range, a), o = new cn(n, i.seq2Range, a), l = s.length + o.length < 500 ? this.dynamicProgrammingDiffing.compute(s, o, r) : this.myersDiffingAlgorithm.compute(s, o, r);
    let u = l.diffs;
    return u = ea(s, o, u), u = Fl(s, o, u), u = Wl(s, o, u), u = ql(s, o, u), {
      mappings: u.map((d) => new Ht(s.translateRange(d.seq1Range), o.translateRange(d.seq2Range))),
...
function aa(e, t, n, i = !1) {
  const r = [];
  for (const a of Ws(e.map((s) => Vl(s, t, n)), (s, o) => s.original.overlapOrTouch(o.original) || s.modified.overlapOrTouch(o.modified))) {
    const s = a[0], o = a[a.length - 1];
    r.push(new st(
      s.original.join(o.original),
      s.modified.join(o.modified),
      a.map((l) => l.innerChanges[0])
    ));
  }
  return ln(() => !i && r.length > 0 && r[0].original.startLineNumber !== r[0].modified.startLineNumber ? !1 : bs(r, (a, s) => s.original.startLineNumber - a.original.endLineNumberExclusive === s.modified.startLineNumber - a.modified.endLineNumberExclusive && a.original.endLineNumberExclusive < s.original.startLineNumber && a.modified.endLineNumberExclusive < s.modified.startLineNumber)), r;
}
function Vl(e, t, n) {
  let i = 0, r = 0;
...
class Te {
  ...
  static fromRGBA(t) {
    const n = t.r / 255, i = t.g / 255, r = t.b / 255, a = t.a, s = Math.max(n, i, r), o = Math.min(n, i, r);
    let l = 0, u = 0;
    const c = (o + s) / 2, d = s - o;
    if (d > 0) {
  ...
  static toRGBA(t) {
    ...
    if (i === 0)
      ...
      s = Te._hue2rgb(c, u, n + 1 / 3), o = Te._hue2rgb(c, u, n), l = Te._hue2rgb(c, u, n - 1 / 3);
    }
    return new oe(Math.round(s * 255), Math.round(o * 255), Math.round(l * 255), a);
  }
}
class mt {
  constructor(t, n, i, r) {
  ...
  static fromRGBA(t) {
    const n = t.r / 255, i = t.g / 255, r = t.b / 255, a = Math.max(n, i, r), s = Math.min(n, i, r), o = a - s, l = a === 0 ? 0 : o / a;
    let u;
    return o === 0 ? u = 0 : a === n ? u = ((i - r) / o % 6 + 6) % 6 : a === i ? u = (r - n) / o + 2 : u = (n - i) / o + 4, new mt(Math.round(u * 60), l, a, t.a);
  }
  static toRGBA(t) {
    const { h: n, s: i, v: r, a } = t, s = r * i, o = s * (1 - Math.abs(n / 60 % 2 - 1)), l = r - s;
    let [u, c, d] = [0, 0, 0];
    return n < 60 ? (u = s, c = o) : n < 120 ? (u = o, c = s) : n < 180 ? (c = s, d = o) : n < 240 ? (c = o, d = s) : n < 300 ? (u = o, d = s) : n <= 360 && (u = s, d = o), u = Math.round((u + l) * 255), c = Math.round((c + l) * 255), d = Math.round((d + l) * 255), new oe(u, c, d, a);
  }
}
var Q;
let hn = (Q = class {
  ...
  equals(t) {
    return !!t && oe.equals(this.rgba, t.rgba) && Te.equals(this.hsla, t.hsla) && mt.equals(this.hsva, t.hsva);
  }
  ...
  opposite() {
    return new Q(new oe(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
  }
  blend(t) {
    const n = t.rgba, i = this.rgba.a, r = n.a, a = i + r * (1 - i);
    if (a < 1e-6)
      return Q.transparent;
    const s = this.rgba.r * i / a + n.r * r * (1 - i) / a, o = this.rgba.g * i / a + n.g * r * (1 - i) / a, l = this.rgba.b * i / a + n.b * r * (1 - i) / a;
    return new Q(new oe(s, o, l, a));
  }
  makeOpaque(t) {
    ...
    const { r: n, g: i, b: r, a } = this.rgba;
    return new Q(new oe(
      t.rgba.r - a * (t.rgba.r - n),
      t.rgba.g - a * (t.rgba.g - i),
      t.rgba.b - a * (t.rgba.b - r),
      1
    ));
  }
  flatten(...t) {
...
}, Q.white = new Q(new oe(255, 255, 255, 1)), Q.black = new Q(new oe(0, 0, 0, 1)), Q.red = new Q(new oe(255, 0, 0, 1)), Q.blue = new Q(new oe(0, 0, 255, 1)), Q.green = new Q(new oe(0, 255, 0, 1)), Q.cyan = new Q(new oe(0, 255, 255, 1)), Q.lightgrey = new Q(new oe(211, 211, 211, 1)), Q.transparent = new Q(new oe(0, 0, 0, 0)), Q);
(function(e) {
  (function(t) {
    (function(n) {
      function i(f) {
      ...
      function l(f) {
        return `#${o(f.rgba.r)}${o(f.rgba.g)}${o(f.rgba.b)}`;
      }
      n.formatHex = l;
      function u(f, g = !1) {
        return g && f.rgba.a === 1 ? e.Format.CSS.formatHex(f) : `#${o(f.rgba.r)}${o(f.rgba.g)}${o(f.rgba.b)}${o(Math.round(f.rgba.a * 255))}`;
      }
      n.formatHexA = u;
      function c(f) {
      ...
      function d(f) {
        ...
        if (g === 0 || f.charCodeAt(0) !== 35)
          return null;
        if (g === 7) {
          const p = 16 * m(f.charCodeAt(1)) + m(f.charCodeAt(2)), _ = 16 * m(f.charCodeAt(3)) + m(f.charCodeAt(4)), x = 16 * m(f.charCodeAt(5)) + m(f.charCodeAt(6));
          return new e(new oe(p, _, x, 1));
        }
        if (g === 9) {
          const p = 16 * m(f.charCodeAt(1)) + m(f.charCodeAt(2)), _ = 16 * m(f.charCodeAt(3)) + m(f.charCodeAt(4)), x = 16 * m(f.charCodeAt(5)) + m(f.charCodeAt(6)), w = 16 * m(f.charCodeAt(7)) + m(f.charCodeAt(8));
          return new e(new oe(p, _, x, w / 255));
        }
        if (g === 4) {
          const p = m(f.charCodeAt(1)), _ = m(f.charCodeAt(2)), x = m(f.charCodeAt(3));
          return new e(new oe(16 * p + p, 16 * _ + _, 16 * x + x));
        }
        if (g === 5) {
          const p = m(f.charCodeAt(1)), _ = m(f.charCodeAt(2)), x = m(f.charCodeAt(3)), w = m(f.charCodeAt(4));
          return new e(new oe(16 * p + p, 16 * _ + _, 16 * x + x, (16 * w + w) / 255));
        }
        return null;
      }
      n.parseHex = d;
...
function sa(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), a = ys(r);
  return {
    range: e,
    color: ki(a[0], a[1], a[2], n ? a[3] : 1)
  };
}
function oa(e, t, n) {
  if (!e || t.length !== 1)
    return;
  const r = t[0].values(), a = ys(r), s = new hn(new Te(
    a[0],
    a[1] / 100,
    a[2] / 100,
    n ? a[3] : 1
  ...
  return {
    range: e,
    color: ki(s.rgba.r, s.rgba.g, s.rgba.b, s.rgba.a)
  };
}
function At(e, t) {
...
function Gl(e) {
  const t = [], i = At(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);
  if (i.length > 0)
    for (const r of i) {
      const a = r.filter((u) => u !== void 0), s = a[1], o = a[2];
      if (!o)
        continue;
      let l;
      if (s === "rgb") {
...
function $l(e) {
  return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : Gl(e);
}
class Xl extends Zo {
  get uri() {
    return this._uri;
  ...
  findMatches(t) {
    ...
    for (let i = 0; i < this._lines.length; i++) {
      const r = this._lines[i], a = this.offsetAt(new Ne(i + 1, 1)), s = r.matchAll(t);
      for (const o of s)
        (o.index || o.index === 0) && (o.index = o.index + a), n.push(o);
    }
    return n;
  }
  getLinesContent() {
  ...
  getWordAtPosition(t, n) {
    const i = _i(t.column, ps(n), this._lines[t.lineNumber - 1], 0);
    return i ? new ie(
      t.lineNumber,
      i.startColumn,
      t.lineNumber,
  ...
  words(t) {
    ...
    return {
      *[Symbol.iterator]() {
        for (; ; )
          if (s < o.length) {
            const l = a.substring(o[s].start, o[s].end);
            s += 1, yield l;
          } else if (r < n.length)
            a = n[r], o = i(a, t), s = 0, r += 1;
          else
            break;
      }
    };
...
const Xe = class Xe {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new Xl(wi.parse(t.url), t.lines, t.EOL, t.versionId);
  }
  ...
  async computeUnicodeHighlights(t, n, i) {
    ...
    return r ? _l.computeUnicodeHighlights(r, n, i) : { ranges: [], hasMore: !1, ambiguousCharacterCount: 0, invisibleCharacterCount: 0, nonBasicAsciiCharacterCount: 0 };
  }
  async computeDiff(t, n, i, r) {
    const a = this._getModel(t), s = this._getModel(n);
    return !a || !s ? null : Xe.computeDiff(a, s, i, r);
  }
  static computeDiff(t, n, i, r) {
    const a = r === "advanced" ? In.getDefault() : In.getLegacy(), s = t.getLinesContent(), o = n.getLinesContent(), l = a.computeDiff(s, o, i), u = l.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
    function c(d) {
      return d.map(
        (m) => {
          var f;
          return [m.original.startLineNumber, m.original.endLineNumberExclusive, m.modified.startLineNumber, m.modified.endLineNumberExclusive, (f = m.innerChanges) == null ? void 0 : f.map((g) => [
  ...
  static _modelsAreIdentical(t, n) {
    ...
    if (i !== r)
      return !1;
    for (let a = 1; a <= i; a++) {
      const s = t.getLineContent(a), o = n.getLineContent(a);
      if (s !== o)
        return !1;
    }
    return !0;
  ...
  async computeDirtyDiff(t, n, i) {
    ...
    if (!r || !a)
      return null;
    const s = r.getLinesContent(), o = a.getLinesContent();
    return new ws(s, o, {
  ...
  async computeMoreMinimalEdits(t, n, i) {
    ...
    n = n.slice(0).sort((l, u) => {
      if (l.range && u.range)
        return ie.compareRangesUsingStarts(l.range, u.range);
      const c = l.range ? 0 : 1, d = u.range ? 0 : 1;
      return c - d;
    });
    let o = 0;
    for (let l = 1; l < n.length; l++)
      ie.getEndPosition(n[o].range).equals(ie.getStartPosition(n[l].range)) ? (n[o].range = ie.fromPositions(ie.getStartPosition(n[o].range), ie.getEndPosition(n[l].range)), n[o].text += n[l].text) : (o++, n[o] = n[l]);
    n.length = o + 1;
    for (let { range: l, text: u, eol: c } of n) {
      if (typeof c == "number" && (s = c), ie.isEmpty(l) && !u)
        continue;
      const d = r.getValueInRange(l);
      if (u = u.replace(/\r\n|\n|\r/g, r.eol), d === u)
        continue;
      if (Math.max(u.length, d.length) > Xe._diffLimit) {
        a.push({ range: l, text: u });
        continue;
      }
      const m = No(d, u, i), f = r.offsetAt(ie.lift(l).getStartPosition());
      for (const g of m) {
        const p = r.positionAt(f + g.originalStart), _ = r.positionAt(f + g.originalStart + g.originalLength), x = {
        ...
        r.getValueInRange(x.range) !== x.text && a.push(x);
      }
    }
  ...
  computeHumanReadableDiff(t, n, i) {
    ...
    n = n.slice(0).sort((u, c) => {
      if (u.range && c.range)
        return ie.compareRangesUsingStarts(u.range, c.range);
      const d = u.range ? 0 : 1, m = c.range ? 0 : 1;
      return d - m;
    });
    for (let { range: u, text: c, eol: d } of n) {
      let x = function(y, S) {
        return new Ne(
          y.lineNumber + S.lineNumber - 1,
          S.lineNumber === 1 ? y.column + S.column - 1 : S.column
        );
      }, w = function(y, S) {
        const E = [];
        for (let F = S.startLineNumber; F <= S.endLineNumber; F++) {
          const v = y[F - 1];
          F === S.startLineNumber && F === S.endLineNumber ? E.push(v.substring(S.startColumn - 1, S.endColumn - 1)) : F === S.startLineNumber ? E.push(v.substring(S.startColumn - 1)) : F === S.endLineNumber ? E.push(v.substring(0, S.endColumn - 1)) : E.push(v);
        }
        return E;
      };
      var o = x, l = w;
      if (typeof d == "number" && (s = d), ie.isEmpty(u) && !c)
        continue;
      const m = r.getValueInRange(u);
      if (c = c.replace(/\r\n|\n|\r/g, r.eol), m === c)
        continue;
      if (Math.max(c.length, m.length) > Xe._diffLimit) {
        a.push({ range: u, text: c });
        continue;
      }
      const f = m.split(/\r\n|\n|\r/), g = c.split(/\r\n|\n|\r/), p = In.getDefault().computeDiff(f, g, i), _ = ie.lift(u).getStartPosition();
      for (const y of p.changes)
        if (y.innerChanges)
          for (const S of y.innerChanges)
            a.push({
              range: ie.fromPositions(x(_, S.originalRange.getStartPosition()), x(_, S.originalRange.getEndPosition())),
              text: w(g, S.modifiedRange).join(r.eol)
            });
        else
          throw new Fe("The experimental diff algorithm always produces inner changes");
    }
    return typeof s == "number" && a.push({ eol: s, text: "", range: { startLineNumber: 0, startColumn: 0, endLineNumber: 0, endColumn: 0 } }), a;
  }
  ...
  async textualSuggest(t, n, i, r) {
    const a = new Cn(), s = new RegExp(i, r), o = /* @__PURE__ */ new Set();
    e:
      for (const l of t) {
        const u = this._getModel(l);
        if (u) {
          for (const c of u.words(s))
            if (!(c === n || !isNaN(Number(c))) && (o.add(c), o.size > Xe._suggestionsLimit))
              break e;
        }
      }
  ...
  async computeWordRanges(t, n, i, r) {
    ...
    const s = new RegExp(i, r), o = /* @__PURE__ */ Object.create(null);
    for (let l = n.startLineNumber; l < n.endLineNumber; l++) {
      const u = a.getLineWords(l, s);
      for (const c of u) {
        if (!isNaN(Number(c.word)))
          continue;
        let d = o[c.word];
        d || (d = [], o[c.word] = d), d.push({
          startLineNumber: l,
  ...
  async navigateValueSet(t, n, i, r, a) {
    ...
    const l = s.getValueInRange(n), u = s.getWordAtPosition({ lineNumber: n.startLineNumber, column: n.startColumn }, o);
    if (!u)
      return null;
    const c = s.getValueInRange(u);
    return Jn.INSTANCE.navigateValueSet(n, l, u, c, i);
  }
  loadForeignModule(t, n, i) {
    const s = {
      host: eo(i, (o, l) => this._host.fhr(o, l)),
      getMirrorModels: () => this._getModels()
    };
    return this._foreignModuleFactory ? (this._foreignModule = this._foreignModuleFactory(s, n), Promise.resolve(qn(this._foreignModule))) : Promise.reject(new Error("Unexpected usage"));
  }
  fmr(t, n) {
...
Xe._diffLimit = 1e5, Xe._suggestionsLimit = 1e4;
let si = Xe;
typeof importScripts == "function" && (globalThis.monaco = fl());
let oi = !1;
function xs(e) {
  if (oi)
    return;
...
(function(e) {
  function t(i, r, a, s) {
    if (R.uinteger(i) && R.uinteger(r) && R.uinteger(a) && R.uinteger(s))
      return { start: he.create(i, r), end: he.create(a, s) };
    if (he.is(i) && he.is(r))
  ...
  function n(i) {
    var r = i;
    return R.objectLiteral(r) && he.is(r.start) && he.is(r.end);
  }
  e.is = n;
})(Z || (Z = {}));
var mn;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.defined(r) && Z.is(r.range) && (R.string(r.uri) || R.undefined(r.uri));
  }
  e.is = n;
})(mn || (mn = {}));
var ua;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.defined(r) && Z.is(r.targetRange) && R.string(r.targetUri) && (Z.is(r.targetSelectionRange) || R.undefined(r.targetSelectionRange)) && (Z.is(r.originSelectionRange) || R.undefined(r.originSelectionRange));
  }
  e.is = n;
})(ua || (ua = {}));
var li;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.numberRange(r.red, 0, 1) && R.numberRange(r.green, 0, 1) && R.numberRange(r.blue, 0, 1) && R.numberRange(r.alpha, 0, 1);
  }
  e.is = n;
})(li || (li = {}));
var ca;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return Z.is(r.range) && li.is(r.color);
  }
  e.is = n;
})(ca || (ca = {}));
var ha;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.string(r.label) && (R.undefined(r.textEdit) || le.is(r)) && (R.undefined(r.additionalTextEdits) || R.typedArray(r.additionalTextEdits, le.is));
  }
  e.is = n;
})(ha || (ha = {}));
var fn;
...
(function(e) {
  function t(i, r, a, s, o) {
    ...
    return R.defined(a) && (l.startCharacter = a), R.defined(s) && (l.endCharacter = s), R.defined(o) && (l.kind = o), l;
  }
  e.create = t;
  function n(i) {
    var r = i;
    return R.uinteger(r.startLine) && R.uinteger(r.startLine) && (R.undefined(r.startCharacter) || R.uinteger(r.startCharacter)) && (R.undefined(r.endCharacter) || R.uinteger(r.endCharacter)) && (R.undefined(r.kind) || R.string(r.kind));
  }
  e.is = n;
})(da || (da = {}));
var ui;
...
(function(e) {
  function t(n) {
    var i = n;
    return i != null && R.string(i.href);
  }
  e.is = t;
})(pa || (pa = {}));
var pn;
(function(e) {
  function t(i, r, a, s, o, l) {
    var u = { range: i, message: r };
    return R.defined(a) && (u.severity = a), R.defined(s) && (u.code = s), R.defined(o) && (u.source = o), R.defined(l) && (u.relatedInformation = l), u;
  }
  e.create = t;
  function n(i) {
    var r, a = i;
    return R.defined(a) && Z.is(a.range) && R.string(a.message) && (R.number(a.severity) || R.undefined(a.severity)) && (R.integer(a.code) || R.string(a.code) || R.undefined(a.code)) && (R.undefined(a.codeDescription) || R.string((r = a.codeDescription) === null || r === void 0 ? void 0 : r.href)) && (R.string(a.source) || R.undefined(a.source)) && (R.undefined(a.relatedInformation) || R.typedArray(a.relatedInformation, ui.is));
  }
  e.is = n;
})(pn || (pn = {}));
var Wt;
(function(e) {
  function t(i, r) {
    for (var a = [], s = 2; s < arguments.length; s++)
      a[s - 2] = arguments[s];
    var o = { title: i, command: r };
    return R.defined(a) && a.length > 0 && (o.arguments = a), o;
  }
  e.create = t;
  function n(i) {
    var r = i;
...
(function(e) {
  ...
  function r(a) {
    var s = a;
    return R.objectLiteral(s) && R.string(s.newText) && Z.is(s.range);
  }
  e.is = r;
})(le || (le = {}));
var wt;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r !== void 0 && R.objectLiteral(r) && R.string(r.label) && (R.boolean(r.needsConfirmation) || r.needsConfirmation === void 0) && (R.string(r.description) || r.description === void 0);
  }
  e.is = n;
})(wt || (wt = {}));
var me;
...
(function(e) {
  ...
  function r(a) {
    var s = a;
    return le.is(s) && (wt.is(s.annotationId) || me.is(s.annotationId));
  }
  e.is = r;
})($e || ($e = {}));
var gn;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.defined(r) && bn.is(r.textDocument) && Array.isArray(r.edits);
  }
  e.is = n;
})(gn || (gn = {}));
var Ft;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r && r.kind === "create" && R.string(r.uri) && (r.options === void 0 || (r.options.overwrite === void 0 || R.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || R.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || me.is(r.annotationId));
  }
  e.is = n;
})(Ft || (Ft = {}));
var Pt;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r && r.kind === "rename" && R.string(r.oldUri) && R.string(r.newUri) && (r.options === void 0 || (r.options.overwrite === void 0 || R.boolean(r.options.overwrite)) && (r.options.ignoreIfExists === void 0 || R.boolean(r.options.ignoreIfExists))) && (r.annotationId === void 0 || me.is(r.annotationId));
  }
  e.is = n;
})(Pt || (Pt = {}));
var Bt;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r && r.kind === "delete" && R.string(r.uri) && (r.options === void 0 || (r.options.recursive === void 0 || R.boolean(r.options.recursive)) && (r.options.ignoreIfNotExists === void 0 || R.boolean(r.options.ignoreIfNotExists))) && (r.annotationId === void 0 || me.is(r.annotationId));
  }
  e.is = n;
})(Bt || (Bt = {}));
var ci;
(function(e) {
  function t(n) {
    ...
    return i && (i.changes !== void 0 || i.documentChanges !== void 0) && (i.documentChanges === void 0 || i.documentChanges.every(function(r) {
      return R.string(r.kind) ? Ft.is(r) || Pt.is(r) || Bt.is(r) : gn.is(r);
    }));
  }
  e.is = t;
})(ci || (ci = {}));
var jt = (
  ...
  function() {
    ...
    return e.prototype.insert = function(t, n, i) {
      var r, a;
      if (i === void 0 ? r = le.insert(t, n) : me.is(i) ? (a = i, r = $e.insert(t, n, i)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(i), r = $e.insert(t, n, a)), this.edits.push(r), a !== void 0)
        return a;
    }, e.prototype.replace = function(t, n, i) {
      var r, a;
      if (i === void 0 ? r = le.replace(t, n) : me.is(i) ? (a = i, r = $e.replace(t, n, i)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(i), r = $e.replace(t, n, a)), this.edits.push(r), a !== void 0)
        return a;
    }, e.prototype.delete = function(t, n) {
      var i, r;
      if (n === void 0 ? i = le.del(t) : me.is(n) ? (r = n, i = $e.del(t, n)) : (this.assertChangeAnnotations(this.changeAnnotations), r = this.changeAnnotations.manage(n), i = $e.del(t, r)), this.edits.push(i), r !== void 0)
        return r;
  ...
  function() {
    ...
    return e.prototype.all = function() {
      ...
      var i;
      if (me.is(t) ? i = t : (i = this.nextId(), n = t), this._annotations[i] !== void 0)
...
(function() {
  function e(t) {
    var n = this;
    this._textEditChanges = /* @__PURE__ */ Object.create(null), t !== void 0 ? (this._workspaceEdit = t, t.documentChanges ? (this._changeAnnotations = new ga(t.changeAnnotations), t.changeAnnotations = this._changeAnnotations.all(), t.documentChanges.forEach(function(i) {
      if (gn.is(i)) {
        var r = new jt(i.edits, n._changeAnnotations);
        n._textEditChanges[i.textDocument.uri] = r;
      }
    })) : t.changes && Object.keys(t.changes).forEach(function(i) {
      var r = new jt(t.changes[i]);
  ...
  return Object.defineProperty(e.prototype, "edit", {
    ...
    if (bn.is(t)) {
      ...
      if (!i) {
        ...
        this._workspaceEdit.documentChanges.push(a), i = new jt(r, this._changeAnnotations), this._textEditChanges[n.uri] = i;
      }
      return i;
    } else {
      ...
      if (!i) {
        var r = [];
        this._workspaceEdit.changes[t] = r, i = new jt(r), this._textEditChanges[t] = i;
      }
      return i;
    }
  }, e.prototype.initDocumentChanges = function() {
    this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new ga(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
    ...
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
      throw new Error("Workspace edit is not configured for document changes.");
    var r;
    wt.is(n) || me.is(n) ? r = n : i = n;
    var a, s;
    if (r === void 0 ? a = Ft.create(t, i) : (s = me.is(r) ? r : this._changeAnnotations.manage(r), a = Ft.create(t, i, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0)
      return s;
  }, e.prototype.renameFile = function(t, n, i, r) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
      throw new Error("Workspace edit is not configured for document changes.");
    var a;
    wt.is(i) || me.is(i) ? a = i : r = i;
    var s, o;
    if (a === void 0 ? s = Pt.create(t, n, r) : (o = me.is(a) ? a : this._changeAnnotations.manage(a), s = Pt.create(t, n, r, o)), this._workspaceEdit.documentChanges.push(s), o !== void 0)
      return o;
    ...
    wt.is(n) || me.is(n) ? r = n : i = n;
    var a, s;
    if (r === void 0 ? a = Bt.create(t, i) : (s = me.is(r) ? r : this._changeAnnotations.manage(r), a = Bt.create(t, i, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0)
      return s;
  }, e;
})();
var ba;
...
(function(e) {
  function t(n) {
    var i = n;
    return R.objectLiteral(n) && Me.is(i.kind) && R.string(i.value);
  }
  e.is = t;
})(hi || (hi = {}));
var be;
...
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r && R.string(r.newText) && Z.is(r.insert) && Z.is(r.replace);
  }
  e.is = n;
})(ya || (ya = {}));
var xa;
...
(function(e) {
  function t(n) {
    var i = n;
    return !!i && R.objectLiteral(i) && (hi.is(i.contents) || vn.is(i.contents) || R.typedArray(i.contents, vn.is)) && (n.range === void 0 || Z.is(n.range));
  }
  e.is = t;
})(Aa || (Aa = {}));
var Sa;
...
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r && R.string(r.name) && R.number(r.kind) && Z.is(r.range) && Z.is(r.selectionRange) && (r.detail === void 0 || R.string(r.detail)) && (r.deprecated === void 0 || R.boolean(r.deprecated)) && (r.children === void 0 || Array.isArray(r.children)) && (r.tags === void 0 || Array.isArray(r.tags));
  }
  e.is = n;
})(Ma || (Ma = {}));
var Na;
...
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.defined(r) && R.typedArray(r.diagnostics, pn.is) && (r.only === void 0 || R.typedArray(r.only, R.string));
  }
  e.is = n;
})(Da || (Da = {}));
var Ia;
(function(e) {
  function t(i, r, a) {
    var s = { title: i }, o = !0;
    return typeof r == "string" ? (o = !1, s.kind = r) : Wt.is(r) ? s.command = r : s.edit = r, o && a !== void 0 && (s.kind = a), s;
  }
  e.create = t;
  function n(i) {
    var r = i;
    return r && R.string(r.title) && (r.diagnostics === void 0 || R.typedArray(r.diagnostics, pn.is)) && (r.kind === void 0 || R.string(r.kind)) && (r.edit !== void 0 || r.command !== void 0) && (r.command === void 0 || Wt.is(r.command)) && (r.isPreferred === void 0 || R.boolean(r.isPreferred)) && (r.edit === void 0 || ci.is(r.edit));
  }
  e.is = n;
})(Ia || (Ia = {}));
var za;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.defined(r) && Z.is(r.range) && (R.undefined(r.command) || Wt.is(r.command));
  }
  e.is = n;
})(za || (za = {}));
var Ha;
...
(function(e) {
  ...
  function n(i) {
    var r = i;
    return R.defined(r) && Z.is(r.range) && (R.undefined(r.target) || R.string(r.target));
  }
  e.is = n;
})(Ua || (Ua = {}));
var _n;
(function(e) {
  ...
  function n(i) {
    var r = i;
    return r !== void 0 && Z.is(r.range) && (r.parent === void 0 || e.is(r.parent));
  }
  e.is = n;
})(_n || (_n = {}));
var Wa;
(function(e) {
  ...
  e.is = n;
  function i(a, s) {
    for (var o = a.getText(), l = r(s, function(g, p) {
      var _ = g.range.start.line - p.range.start.line;
      return _ === 0 ? g.range.start.character - p.range.start.character : _;
    }), u = o.length, c = l.length - 1; c >= 0; c--) {
      var d = l[c], m = a.offsetAt(d.range.start), f = a.offsetAt(d.range.end);
      if (f <= u)
        o = o.substring(0, m) + d.newText + o.substring(f, o.length);
      else
  ...
  function r(a, s) {
    if (a.length <= 1)
      return a;
    var o = a.length / 2 | 0, l = a.slice(0, o), u = a.slice(o);
    r(l, s), r(u, s);
    for (var c = 0, d = 0, m = 0; c < l.length && d < u.length; ) {
      var f = s(l[c], u[d]);
      f <= 0 ? a[m++] = l[c++] : a[m++] = u[d++];
    }
    for (; c < l.length; )
...
` && r++;
      ...
      if (r === 0)
        return he.create(0, t);
      for (; i < r; ) {
        var a = Math.floor((i + r) / 2);
        n[a] > t ? r = a : i = a + 1;
      }
      var s = i - 1;
      return he.create(s, t - n[s]);
...
var Fa = class mi {
  ...
  update(t, n) {
    for (let i of t)
      if (mi.isIncremental(i)) {
        const r = Ts(i.range), a = this.offsetAt(r.start), s = this.offsetAt(r.end);
        ...
        if (d !== 0)
          for (let m = o + 1 + c.length, f = u.length; m < f; m++)
            u[m] = u[m] + d;
      } else if (mi.isFull(i))
...
(function(e) {
  ...
  e.update = n;
  function i(r, a) {
    let s = r.getText(), o = pi(a.map(Zl), (c, d) => {
    ...
    for (const c of o) {
      ...
      if (d < l)
        throw new Error("Overlapping edit");
      d > l && u.push(s.substring(l, d)), c.newText.length && u.push(c.newText), l = r.offsetAt(c.range.end);
    }
...
(function(e) {
  e.LATEST = {
    textDocument: {
      ...
      hover: {
        contentFormat: [Me.Markdown, Me.PlainText]
      }
    }
  };
})(Ba || (Ba = {}));
  ...
  function() {
    ...
    return e.prototype.eos = function() {
      ...
      var t = this.advanceWhileChar(function(n) {
        return n === su || n === ou || n === iu || n === au || n === ru;
      });
      return t > 0;
...
), qa = 33, ht = 45, Gt = 60, Ie = 62, zn = 47, eu = 61, tu = 34, nu = 39, iu = 10, ru = 13, au = 12, su = 32, ou = 9, lu = {
...
function xe(e, t, n, i) {
  ...
  var r = new Kl(e, t), a = n, s = 0, o = U.Unknown, l, u, c, d, m;
  function f() {
  ...
  function p(w, y, S) {
    return o = y, s = w, l = S, y;
  }
  function _() {
    var w = r.pos(), y = a, S = x();
    return S !== U.EOS && w === r.pos() && !(i && (S === U.StartTagClose || S === U.EndTagClose)) ? (console.log("Scanner.scan has not advanced at offset " + w + ", state before: " + y + " after: " + a), r.advance(1), p(w, U.Unknown)) : S;
  }
  function x() {
    var w = r.pos();
    if (r.eos())
    ...
    switch (a) {
      case V.WithinComment:
        return r.advanceIfChars([ht, ht, Ie]) ? (a = V.WithinContent, p(w, U.EndCommentTag)) : (r.advanceUntilChars([ht, ht, Ie]), p(w, U.Comment));
      case V.WithinDoctype:
        return r.advanceIfChar(Ie) ? (a = V.WithinContent, p(w, U.EndDoctypeTag)) : (r.advanceUntilChar(Ie), p(w, U.Doctype));
      case V.WithinContent:
        if (r.advanceIfChar(Gt)) {
          if (!r.eos() && r.peekChar() === qa) {
            if (r.advanceIfChars([qa, ht, ht]))
              return a = V.WithinComment, p(w, U.StartCommentTag);
            if (r.advanceIfRegExp(/^!doctype/i))
              return a = V.WithinDoctype, p(w, U.StartDoctypeTag);
          }
          return r.advanceIfChar(zn) ? (a = V.AfterOpeningEndTag, p(w, U.EndTagOpen)) : (a = V.AfterOpeningStartTag, p(w, U.StartTagOpen));
        }
        return r.advanceUntilChar(Gt), p(w, U.Content);
      case V.AfterOpeningEndTag:
        var S = f();
        return S.length > 0 ? (a = V.WithinEndTag, p(w, U.EndTag)) : r.skipWhitespace() ? p(w, U.Whitespace, je("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (a = V.WithinEndTag, r.advanceUntilChar(Ie), w < r.pos() ? p(w, U.Unknown, je("error.endTagNameExpected", "End tag name expected.")) : x());
      case V.WithinEndTag:
        if (r.skipWhitespace())
          return p(w, U.Whitespace);
        if (r.advanceIfChar(Ie))
          return a = V.WithinContent, p(w, U.EndTagClose);
        if (i && r.peekChar() === Gt)
          return a = V.WithinContent, p(w, U.EndTagClose, je("error.closingBracketMissing", "Closing bracket missing."));
        y = je("error.closingBracketExpected", "Closing bracket expected.");
        break;
      case V.AfterOpeningStartTag:
        return c = f(), m = void 0, d = void 0, c.length > 0 ? (u = !1, a = V.WithinTag, p(w, U.StartTag)) : r.skipWhitespace() ? p(w, U.Whitespace, je("error.unexpectedWhitespace", "Tag name must directly follow the open bracket.")) : (a = V.WithinTag, r.advanceUntilChar(Ie), w < r.pos() ? p(w, U.Unknown, je("error.startTagNameExpected", "Start tag name expected.")) : x());
      case V.WithinTag:
        return r.skipWhitespace() ? (u = !0, p(w, U.Whitespace)) : u && (d = g(), d.length > 0) ? (a = V.AfterAttributeName, u = !1, p(w, U.AttributeName)) : r.advanceIfChars([zn, Ie]) ? (a = V.WithinContent, p(w, U.StartTagSelfClose)) : r.advanceIfChar(Ie) ? (c === "script" ? m && lu[m] ? a = V.WithinContent : a = V.WithinScriptContent : c === "style" ? a = V.WithinStyleContent : a = V.WithinContent, p(w, U.StartTagClose)) : i && r.peekChar() === Gt ? (a = V.WithinContent, p(w, U.StartTagClose, je("error.closingBracketMissing", "Closing bracket missing."))) : (r.advance(1), p(w, U.Unknown, je("error.unexpectedCharacterInTag", "Unexpected character in tag.")));
      case V.AfterAttributeName:
        return r.skipWhitespace() ? (u = !0, p(w, U.Whitespace)) : r.advanceIfChar(eu) ? (a = V.BeforeAttributeValue, p(w, U.DelimiterAssign)) : (a = V.WithinTag, x());
      case V.BeforeAttributeValue:
        if (r.skipWhitespace())
          return p(w, U.Whitespace);
        var E = r.advanceIfRegExp(/^[^\s"'`=<>]+/);
        if (E.length > 0)
          return r.peekChar() === Ie && r.peekChar(-1) === zn && (r.goBack(1), E = E.substr(0, E.length - 1)), d === "type" && (m = E), a = V.WithinTag, u = !1, p(w, U.AttributeValue);
        var F = r.peekChar();
        return F === nu || F === tu ? (r.advance(1), r.advanceUntilChar(F) && r.advance(1), d === "type" && (m = r.getSource().substring(w + 1, r.pos() - 1)), a = V.WithinTag, u = !1, p(w, U.AttributeValue)) : (a = V.WithinTag, u = !1, x());
      case V.WithinScriptContent:
        for (var v = 1; !r.eos(); ) {
          var b = r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
          if (b.length === 0)
            return r.goToEnd(), p(w, U.Script);
          if (b === "<!--")
            v === 1 && (v = 2);
          else if (b === "-->")
            v = 1;
        ...
        return a = V.WithinContent, w < r.pos() ? p(w, U.Script) : x();
      case V.WithinStyleContent:
        return r.advanceUntilRegExp(/<\/style/i), a = V.WithinContent, w < r.pos() ? p(w, U.Styles) : x();
    }
    return r.advance(1), a = V.WithinContent, p(w, U.Unknown, y);
  }
  return {
    scan: _,
...
var cu = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"];
function yn(e) {
  return !!e && uu(cu, e.toLowerCase(), function(t, n) {
...
var Va = (
  ...
  function() {
    ...
    return Object.defineProperty(e.prototype, "attributeNames", {
      ...
      var n = Oa(this.children, function(a) {
        return t <= a.start;
      }) - 1;
      if (n >= 0) {
      ...
      var n = Oa(this.children, function(r) {
        return t <= r.start;
      }) - 1;
      if (n >= 0) {
        var i = this.children[n];
...
function ks(e) {
  for (var t = xe(e, void 0, void 0, !0), n = new Va(0, e.length, [], void 0), i = n, r = -1, a = void 0, s = null, o = t.scan(); o !== U.EOS; ) {
    switch (o) {
      case U.StartTagOpen:
        var l = new Va(t.getTokenOffset(), e.length, [], i);
      ...
      case U.StartTagClose:
        i.parent && (i.end = t.getTokenEnd(), t.getTokenLength() ? (i.startTagEnd = t.getTokenEnd(), i.tag && yn(i.tag) && (i.closed = !0, i = i.parent)) : i = i.parent);
        break;
...
var du = 97, mu = 122, fu = 65, pu = 90, gu = 48, bu = 57;
function St(e, t) {
  var n = e.charCodeAt(t);
  return du <= n && n <= mu || fu <= n && n <= pu || gu <= n && n <= bu;
}
function xn(e) {
  return typeof e < "u";
}
    ...
    return e.prototype.isApplicable = function() {
      ...
      var a = function(o) {
        o.forEach(function(l) {
          l.name.toLowerCase() === n && (l.values && l.values.forEach(function(u) {
            r.push(u);
          }), l.valueSet && i._valueSetMap[l.valueSet] && i._valueSetMap[l.valueSet].forEach(function(u) {
            r.push(u);
          }));
        });
...
var Ga = function(e, t, n, i) {
  ...
  function() {
    ...
    return e.prototype.onHtmlAttributeValue = function(t) {
      Tu(t.tag, t.attribute) && this.atributeCompletions.push(t);
    }, e.prototype.computeCompletions = function(t, n) {
      return Ga(this, void 0, void 0, function() {
        var i, r, a, s, o, l, u, c, d, m;
        return $a(this, function(f) {
          switch (f.label) {
            case 0:
              i = { items: [], isIncomplete: !1 }, r = 0, a = this.atributeCompletions, f.label = 1;
            case 1:
              return r < a.length ? (s = a[r], o = yu(t.getText(s.range)), xu(o) ? o === "." || o === ".." ? (i.isIncomplete = !0, [3, 4]) : [3, 2] : [3, 4]) : [3, 5];
            case 2:
              return l = ku(s.value, o, s.range), [4, this.providePathSuggestions(s.value, l, t, n)];
            case 3:
        ...
        return $a(this, function(g) {
          switch (g.label) {
            case 0:
              ...
              g.label = 1;
            case 1:
              return g.trys.push([1, 3, , 4]), o = [], [4, this.readDirectory(s)];
            case 2:
              for (l = g.sent(), u = 0, c = l; u < c.length; u++)
                d = c[u], m = d[0], f = d[1], m.charCodeAt(0) !== _u && o.push(Au(m, f === gi.Directory, n));
              return [2, o];
            case 3:
              return g.sent(), [3, 4];
            case 4:
...
function yu(e) {
  return Ke(e, "'") || Ke(e, '"') ? e.slice(1, -1) : e;
}
function xu(e) {
  return !(Ke(e, "http") || Ke(e, "https") || Ke(e, "//"));
}
function Tu(e, t) {
  if (t === "src" || t === "href")
    return !0;
...
function ku(e, t, n) {
  ...
  if (r === -1)
    ...
    var a = t.slice(r + 1), s = Rt(n.end, -1 - a.length), o = a.indexOf(" "), l = void 0;
    o !== -1 ? l = Rt(s, o) : l = Rt(n.end, -1), i = Z.create(s, l);
  }
  return i;
}
function Au(e, t, n) {
...
function Rt(e, t) {
  return he.create(e.line, e.character + t);
}
function Su(e, t, n) {
  var i = Rt(e.start, t), r = Rt(e.end, n);
  return Z.create(i, r);
}
var Lu = {
  // HTML 4
  ...
  function() {
    ...
    return e.prototype.setCompletionParticipants = function(t) {
        ...
        return Eu(this, function(c) {
          switch (c.label) {
            case 0:
              ...
              s = new wu(this.lsOptions.fileSystemProvider.readDirectory), o = this.completionParticipants, this.completionParticipants = [s].concat(o), l = this.doComplete(t, n, i, a), c.label = 1;
            case 1:
      ...
      var a = {
        isIncomplete: !1,
        items: []
      }, s = this.completionParticipants, o = this.dataManager.getDataProviders().filter(function(I) {
        return I.isApplicable(t.languageId) && (!r || r[I.getId()] !== !1);
      }), l = this.doesSupportMarkdown(), u = t.getText(), c = t.offsetAt(n), d = i.findNodeBefore(c);
      if (!d)
        return a;
      var m = xe(u, d.start), f = "", g;
      function p(I, z) {
        return z === void 0 && (z = c), I > c && (I = c), { start: t.positionAt(I), end: t.positionAt(z) };
      }
      function _(I, z) {
        var B = p(I, z);
        return o.forEach(function($) {
          $.provideTags().forEach(function(Y) {
            a.items.push({
              label: Y.name,
              kind: be.Property,
              documentation: it(Y, void 0, l),
              textEdit: le.replace(B, Y.name),
...
\r`.indexOf(B) >= 0)
      ...
      function w(I, z, B) {
        B === void 0 && (B = c);
        var $ = p(I, B), Y = Xa(u, B, V.WithinEndTag, U.EndTagClose) ? "" : ">", J = d;
        for (z && (J = J.parent); J; ) {
          var K = J.tag;
          if (K && (!J.closed || J.endTagStart && J.endTagStart > c)) {
            var fe = {
              label: "/" + K,
              kind: be.Property,
              filterText: "/" + K,
              textEdit: le.replace($, "/" + K + Y),
              insertTextFormat: Le.PlainText
            }, De = x(J.start), Be = x(I - 1);
            if (De !== null && Be !== null && De !== Be) {
              var we = De + "</" + K + Y;
              fe.textEdit = le.replace(p(I - 1 - Be.length), we), fe.filterText = Be + "</" + K;
            }
            return a.items.push(fe), a;
          }
          J = J.parent;
        }
        return z || o.forEach(function(et) {
          et.provideTags().forEach(function(Ae) {
            a.items.push({
              label: "/" + Ae.name,
              kind: be.Property,
              documentation: it(Ae, void 0, l),
              filterText: "/" + Ae.name + Y,
              textEdit: le.replace($, "/" + Ae.name + Y),
              insertTextFormat: Le.PlainText
            });
          });
        }), a;
      ...
      function y(I, z) {
        if (r && r.hideAutoCompleteProposals)
          return a;
        if (!yn(z)) {
          var B = t.positionAt(I);
          a.items.push({
            label: "</" + z + ">",
            kind: be.Property,
            filterText: "</" + z + ">",
            textEdit: le.insert(B, "$0</" + z + ">"),
      ...
      function F(I, z) {
        ...
        for (var $ = c; $ < z && u[$] !== "<"; )
          $++;
        var Y = u.substring(I, z), J = p(I, $), K = "";
        if (!Xa(u, z, V.AfterAttributeName, U.DelimiterAssign)) {
          var fe = (B = r == null ? void 0 : r.attributeDefaultValue) !== null && B !== void 0 ? B : "doublequotes";
          fe === "empty" ? K = "=$1" : fe === "singlequotes" ? K = "='$1'" : K = '="$1"';
        }
        var De = E();
        return De[Y] = !1, o.forEach(function(Be) {
          Be.provideAttributes(f).forEach(function(we) {
            if (!De[we.name]) {
              De[we.name] = !0;
              var et = we.name, Ae;
              we.valueSet !== "v" && K.length && (et = et + K, (we.valueSet || we.name === "style") && (Ae = {
                title: "Suggest",
                command: "editor.action.triggerSuggest"
              })), a.items.push({
                label: we.name,
                kind: we.valueSet === "handler" ? be.Function : be.Value,
                documentation: it(we, void 0, l),
                textEdit: le.replace(J, et),
                insertTextFormat: Le.Snippet,
                command: Ae
              });
            }
      ...
      function v(I, z) {
        ...
        $[B] = "".concat(B, '$1="$2"');
        function Y(J) {
          J.attributeNames.forEach(function(K) {
            Ke(K, B) && !$[K] && !z[K] && ($[K] = K + '="$1"');
          }), J.children.forEach(function(K) {
            return Y(K);
          });
        }
        i && i.roots.forEach(function(J) {
          return Y(J);
        }), Object.keys($).forEach(function(J) {
          return a.items.push({
            label: J,
            kind: be.Value,
            textEdit: le.replace(I, $[J]),
            insertTextFormat: Le.Snippet
          });
        });
      }
      function b(I, z) {
        ...
        if (c > I && c <= z && Nu(u[I])) {
          var J = I + 1, K = z;
          z > I && u[z - 1] === u[I] && K--;
          var fe = Du(u, c, J), De = Iu(u, c, K);
          B = p(fe, De), Y = c >= J && c <= K ? u.substring(J, c) : "", $ = !1;
        } else
          B = p(I, z), Y = u.substring(I, c), $ = !0;
        if (s.length > 0)
          for (var Be = f.toLowerCase(), we = g.toLowerCase(), et = p(I, z), Ae = 0, Li = s; Ae < Li.length; Ae++) {
            var Ci = Li[Ae];
            Ci.onHtmlAttributeValue && Ci.onHtmlAttributeValue({ document: t, position: n, tag: Be, attribute: we, value: Y, range: et });
          }
        return o.forEach(function(Rs) {
          Rs.provideValues(f, g).forEach(function(qt) {
            var Ei = $ ? '"' + qt.name + '"' : qt.name;
            a.items.push({
              label: qt.name,
              filterText: Ei,
              kind: be.Unit,
              documentation: it(qt, void 0, l),
              textEdit: le.replace(B, Ei),
              insertTextFormat: Le.PlainText
            });
          });
        }), L(), a;
      ...
      function T(I) {
        return c === m.getTokenEnd() && (N = m.scan(), N === I && m.getTokenOffset() === c) ? m.getTokenEnd() : c;
      }
      function q() {
        for (var I = 0, z = s; I < z.length; I++) {
          var B = z[I];
      ...
      function L() {
        for (var I = c - 1, z = n.character; I >= 0 && St(u, I); )
          I--, z--;
        if (I >= 0 && u[I] === "&") {
          var B = Z.create(he.create(n.line, z - 1), n);
          for (var $ in Et)
            if (hu($, ";")) {
              var Y = "&" + $;
              a.items.push({
                label: Y,
                kind: be.Keyword,
                documentation: Ru("entity.propose", "Character entity representing '".concat(Et[$], "'")),
                textEdit: le.replace(B, Y),
                insertTextFormat: Le.PlainText
              });
            }
        }
      ...
      function k(I, z) {
        ...
        a.items.push({
          ...
          textEdit: le.replace(B, "!DOCTYPE html>"),
          insertTextFormat: Le.PlainText
        });
      }
      for (var N = m.scan(); N !== U.EOS && m.getTokenOffset() <= c; ) {
        switch (N) {
          case U.StartTagOpen:
            if (m.getTokenEnd() === c) {
              var D = T(U.StartTag);
              return n.line === 0 && k(c, D), S(c, D);
            }
            break;
          case U.StartTag:
            if (m.getTokenOffset() <= c && c <= m.getTokenEnd())
              return _(m.getTokenOffset(), m.getTokenEnd());
            f = m.getTokenText();
            break;
          case U.AttributeName:
            if (m.getTokenOffset() <= c && c <= m.getTokenEnd())
          ...
          case U.Whitespace:
            if (c <= m.getTokenEnd())
              switch (m.getScannerState()) {
                case V.AfterOpeningStartTag:
                  var H = m.getTokenOffset(), P = T(U.StartTag);
                  return S(H, P);
                case V.WithinTag:
                case V.AfterAttributeName:
          ...
          case U.EndTagOpen:
            if (c <= m.getTokenEnd()) {
              var C = m.getTokenOffset() + 1, A = T(U.EndTag);
              return w(C, !1, A);
            }
            break;
          case U.EndTag:
      ...
      if (s <= 0)
        return null;
      var o = (a = r == null ? void 0 : r.attributeDefaultValue) !== null && a !== void 0 ? a : "doublequotes";
      if (o === "empty")
        return null;
      var l = t.getText().charAt(s - 1);
      if (l !== "=")
        return null;
      var u = o === "doublequotes" ? '"$1"' : "'$1'", c = i.findNodeBefore(s);
      if (c && c.attributes && c.start < s && (!c.endTagStart || c.endTagStart > s))
        for (var d = xe(t.getText(), c.start), m = d.scan(); m !== U.EOS && d.getTokenEnd() <= s; ) {
          if (m === U.AttributeName && d.getTokenEnd() === s - 1)
            return m = d.scan(), m !== U.DelimiterAssign || (m = d.scan(), m === U.Unknown || m === U.AttributeValue) ? null : u;
          m = d.scan();
        }
      return null;
      ...
      if (a === ">") {
        ...
        if (s && s.tag && !yn(s.tag) && s.start < r && (!s.endTagStart || s.endTagStart > r))
          for (var o = xe(t.getText(), s.start), l = o.scan(); l !== U.EOS && o.getTokenEnd() <= r; ) {
            if (l === U.StartTagClose && o.getTokenEnd() === r)
        ...
        if (s && s.tag)
          for (var o = xe(t.getText(), s.start), l = o.scan(); l !== U.EOS && o.getTokenEnd() <= r; ) {
            if (l === U.EndTagOpen && o.getTokenEnd() === r)
              return "".concat(s.tag, ">");
            l = o.scan();
          }
      }
      ...
      var t, n, i;
      if (!xn(this.supportsMarkdown)) {
        if (!xn(this.lsOptions.clientCapabilities))
        ...
        this.supportsMarkdown = Array.isArray(r) && r.indexOf(Me.Markdown) !== -1;
      }
...
function Xa(e, t, n, i) {
  for (var r = xe(e, t, n), a = r.scan(); a === U.Whitespace; )
    a = r.scan();
  return a === i;
}
function Du(e, t, n) {
...
var zu = Ai(), Hu = (
  ...
  function() {
    ...
    return e.prototype.doHover = function(t, n, i, r) {
      var a = this.convertContents.bind(this), s = this.doesSupportMarkdown(), o = t.offsetAt(n), l = i.findNodeAt(o), u = t.getText();
      if (!l || !l.tag)
        return null;
      var c = this.dataManager.getDataProviders().filter(function(k) {
        return k.isApplicable(t.languageId);
      });
      function d(k, N, D) {
        for (var H = function(W) {
          var I = null;
          if (W.provideTags().forEach(function(z) {
            if (z.name.toLowerCase() === k.toLowerCase()) {
              var B = it(z, r, s);
              B || (B = {
                kind: s ? "markdown" : "plaintext",
                value: ""
              }), I = { contents: B, range: N };
            }
          }), I)
            return I.contents = a(I.contents), { value: I };
        }, P = 0, C = c; P < C.length; P++) {
          var A = C[P], M = H(A);
          if (typeof M == "object")
            return M.value;
        }
      ...
      function m(k, N, D) {
        for (var H = function(W) {
          var I = null;
          if (W.provideAttributes(k).forEach(function(z) {
            if (N === z.name && z.description) {
              var B = it(z, r, s);
              B ? I = { contents: B, range: D } : I = null;
            }
          }), I)
            return I.contents = a(I.contents), { value: I };
        }, P = 0, C = c; P < C.length; P++) {
      ...
      function f(k, N, D, H) {
        for (var P = function(I) {
          var z = null;
          if (I.provideValues(k, N).forEach(function(B) {
            if (D === B.name && B.description) {
              var $ = it(B, r, s);
              $ ? z = { contents: $, range: H } : z = null;
            }
          }), z)
      ...
      function g(k, N) {
        ...
        for (var H in Et) {
          var P = null, C = "&" + H;
          if (D === C) {
            var A = Et[H].charCodeAt(0).toString(16).toUpperCase(), M = "U+";
            if (A.length < 4)
              for (var W = 4 - A.length, I = 0; I < W; )
                M += "0", I += 1;
            M += A;
            var z = zu("entity.propose", "Character entity representing '".concat(Et[H], "', unicode equivalent '").concat(M, "'"));
            z ? P = { contents: z, range: N } : P = null;
          }
          if (P)
            return P.contents = a(P.contents), P;
        }
        return null;
      }
      function p(k, N) {
        for (var D = xe(t.getText(), N), H = D.scan(); H !== U.EOS && (D.getTokenEnd() < o || D.getTokenEnd() === o && H !== k); )
          H = D.scan();
        return H === k && o <= D.getTokenEnd() ? { start: t.positionAt(D.getTokenOffset()), end: t.positionAt(D.getTokenEnd()) } : null;
      }
      function _() {
        for (var k = o - 1, N = n.character; k >= 0 && St(u, k); )
          k--, N--;
        for (var D = k + 1, H = N; St(u, D); )
          D++, H++;
        if (k >= 0 && u[k] === "&") {
          var P = null;
          return u[D] === ";" ? P = Z.create(he.create(n.line, N), he.create(n.line, H + 1)) : P = Z.create(he.create(n.line, N), he.create(n.line, H)), P;
        }
        return null;
      }
      function x(k) {
        for (var N = o - 1, D = "&"; N >= 0 && St(k, N); )
          N--;
        for (N = N + 1; St(k, N); )
          D += k[N], N += 1;
        return D += ";", D;
      ...
      if (l.endTagStart && o >= l.endTagStart) {
        var w = p(U.EndTag, l.endTagStart);
        return w ? d(l.tag, w) : null;
      }
      var y = p(U.StartTag, l.start);
      if (y)
        return d(l.tag, y);
      var S = p(U.AttributeName, l.start);
      if (S) {
        var E = l.tag, F = t.getText(S);
        return m(E, F, S);
      }
      var v = _();
      if (v)
        return g(u, v);
      function b(k, N) {
        for (var D = xe(t.getText(), k), H = D.scan(), P = void 0; H !== U.EOS && D.getTokenEnd() <= N; )
          H = D.scan(), H === U.AttributeName && (P = D.getTokenText());
        return P;
      }
      var T = p(U.AttributeValue, l.start);
      if (T) {
        var E = l.tag, q = Uu(t.getText(T)), L = b(l.start, t.offsetAt(T.start));
        if (L)
          return f(E, L, q, T);
      }
      return null;
...
(function() {
  var e = [
    ...
    function(r) {
      function a(l) {
        this.__parent = l, this.__character_count = 0, this.__indent_count = -1, this.__alignment_count = 0, this.__wrap_point_index = 0, this.__wrap_point_character_count = 0, this.__wrap_point_indent_count = -1, this.__wrap_point_alignment_count = 0, this.__items = [];
      }
      a.prototype.clone_empty = function() {
        ...
        for (var u = this.__items.length - 1; u >= 0; u--)
          if (this.__items[u].match(l))
            return !0;
        return !1;
      }, a.prototype.set_indent = function(l, u) {
        this.is_empty() && (this.__indent_count = l || 0, this.__alignment_count = u || 0, this.__character_count = this.__parent.get_indent_size(this.__indent_count, this.__alignment_count));
        ...
        if (this._should_wrap()) {
          ...
          return l.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count), l.__items = this.__items.slice(this.__wrap_point_index), this.__items = this.__items.slice(0, this.__wrap_point_index), l.__character_count += this.__character_count - this.__wrap_point_character_count, this.__character_count = this.__wrap_point_character_count, l.__items[0] === " " && (l.__items.splice(0, 1), l.__character_count -= 1), !0;
        }
        return !1;
        ...
        var u = l.lastIndexOf(`
`);
        u !== -1 ? this.__character_count = l.length - u : this.__character_count += l.length;
      }, a.prototype.pop = function() {
        var l = null;
        return this.is_empty() || (l = this.__items.pop(), this.__character_count -= l.length), l;
        ...
        var l = "";
        return this.is_empty() ? this.__parent.indent_empty_lines && (l = this.__parent.get_indent_string(this.__indent_count)) : (l = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count), l += this.__items.join("")), l;
      };
      function s(l, u) {
        this.__cache = [""], this.__indent_size = l.indent_size, this.__indent_string = l.indent_char, l.indent_with_tabs || (this.__indent_string = new Array(l.indent_size + 1).join(l.indent_char)), u = u || "", l.indent_level > 0 && (u = new Array(l.indent_level + 1).join(this.__indent_string)), this.__base_string = u, this.__base_string_length = u.length;
      }
      s.prototype.get_indent_size = function(l, u) {
        var c = this.__base_string_length;
        return u = u || 0, l < 0 && (c = 0), c += l * this.__indent_size, c += u, c;
      }, s.prototype.get_indent_string = function(l, u) {
        var c = this.__base_string;
        return u = u || 0, l < 0 && (l = 0, c = ""), u += l * this.__indent_size, this.__ensure_cache(u), c += this.__cache[u], c;
      }, s.prototype.__ensure_cache = function(l) {
        for (; l >= this.__cache.length; )
          this.__add_column();
      }, s.prototype.__add_column = function() {
        var l = this.__cache.length, u = 0, c = "";
        this.__indent_size && l >= this.__indent_size && (u = Math.floor(l / this.__indent_size), l -= u * this.__indent_size, c = new Array(u + 1).join(this.__indent_string)), l && (c += new Array(l + 1).join(" ")), this.__cache.push(c);
      };
      function o(l, u) {
        this.__indent_cache = new s(l, u), this.raw = !1, this._end_with_newline = l.end_with_newline, this.indent_size = l.indent_size, this.wrap_line_length = l.wrap_line_length, this.indent_empty_lines = l.indent_empty_lines, this.__lines = [], this.previous_line = null, this.current_line = null, this.next_line = new a(this), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1, this.__add_outputline();
      }
      ...
      }, o.prototype.add_new_line = function(l) {
        return this.is_empty() || !l && this.just_added_newline() ? !1 : (this.raw || this.__add_outputline(), !0);
      }, o.prototype.get_code = function(l) {
        this.trim(!0);
...
` && (c = c.replace(/[\n]/g, l)), c;
      ...
      }, o.prototype.set_indent = function(l, u) {
        return l = l || 0, u = u || 0, this.next_line.set_indent(l, u), this.__lines.length > 1 ? (this.current_line.set_indent(l, u), !0) : (this.current_line.set_indent(), !1);
      }, o.prototype.add_raw_token = function(l) {
        for (var u = 0; u < l.newlines; u++)
          this.__add_outputline();
        this.current_line.set_indent(-1), this.current_line.push(l.whitespace_before), this.current_line.push(l.text), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = !1;
      }, o.prototype.add_token = function(l) {
        this.__add_space_before_token(), this.current_line.push(l), this.space_before_token = !1, this.non_breaking_space = !1, this.previous_token_wrapped = this.current_line._allow_wrap();
      }, o.prototype.__add_space_before_token = function() {
        this.space_before_token && !this.just_added_newline() && (this.non_breaking_space || this.set_wrap_point(), this.current_line.push(" "));
      }, o.prototype.remove_indent = function(l) {
        for (var u = this.__lines.length; l < u; )
          this.__lines[l]._remove_indent(), l++;
        this.current_line._remove_wrap_indent();
      }, o.prototype.trim = function(l) {
        for (l = l === void 0 ? !1 : l, this.current_line.trim(); l && this.__lines.length > 1 && this.current_line.is_empty(); )
      ...
      }, o.prototype.ensure_empty_line_above = function(l, u) {
        for (var c = this.__lines.length - 2; c >= 0; ) {
          var d = this.__lines[c];
          if (d.is_empty())
            break;
          if (d.item(0).indexOf(l) !== 0 && d.item(-1) !== u) {
    ...
    function(r) {
      ...
      a.prototype._get_array = function(l, u) {
        ...
        var c = this.raw_options[l], d = c === void 0 ? !!u : !!c;
        return d;
...
`).replace(/\\t/, "	")), d;
        ...
        var c = this.raw_options[l];
        u = parseInt(u, 10), isNaN(u) && (u = 0);
        var d = parseInt(c, 10);
        return isNaN(d) && (d = u), d;
      }, a.prototype._get_selection = function(l, u, c) {
        var d = this._get_selection_list(l, u, c);
        if (d.length !== 1)
          throw new Error(
            "Invalid Option Value: The option '" + l + `' can only be one of the following values:
` + u + `
You passed in: '` + this.raw_options[l] + "'"
          );
        return d[0];
      }, a.prototype._get_selection_list = function(l, u, c) {
        if (!u || u.length === 0)
          throw new Error("Selection list cannot be empty.");
        if (c = c || [u[0]], !this._is_valid_selection(c, u))
          throw new Error("Invalid Default Value!");
        var d = this._get_array(l, c);
        if (!this._is_valid_selection(d, u))
          throw new Error(
            "Invalid Option Value: The option '" + l + `' can contain only the following values:
` + u + `
You passed in: '` + this.raw_options[l] + "'"
          );
        return d;
      }, a.prototype._is_valid_selection = function(l, u) {
        return l.length && u.length && !l.some(function(c) {
      ...
      r.exports.Options = a, r.exports.normalizeOpts = o, r.exports.mergeOpts = s;
    },
    ,
    /* 8 */
    /***/
    function(r) {
      ...
      s.prototype.restart = function() {
        ...
        var l = null;
        return o = o || 0, o += this.__position, o >= 0 && o < this.__input_length && (l = this.__input.charAt(o)), l;
      }, s.prototype.__match = function(o, l) {
        o.lastIndex = l;
        var u = o.exec(this.__input);
        return u && !(a && o.sticky) && u.index !== l && (u = null), u;
      }, s.prototype.test = function(o, l) {
        return l = l || 0, l += this.__position, l >= 0 && l < this.__input_length ? !!this.__match(o, l) : !1;
      }, s.prototype.testChar = function(o, l) {
        var u = this.peek(l);
        return o.lastIndex = 0, u !== null && o.test(u);
      }, s.prototype.match = function(o) {
        var l = this.__match(o, this.__position);
        return l ? this.__position += l[0].length : l = null, l;
      }, s.prototype.read = function(o, l, u) {
        var c = "", d;
        return o && (d = this.match(o), d && (c += d[0])), l && (d || !o) && (c += this.readUntil(l, u)), c;
      }, s.prototype.readUntil = function(o, l) {
        var u = "", c = this.__position;
        o.lastIndex = this.__position;
        var d = o.exec(this.__input);
        return d ? (c = d.index, l && (c += d[0].length)) : c = this.__input_length, u = this.__input.substring(this.__position, c), this.__position = c, u;
      }, s.prototype.readUntilAfter = function(o) {
        return this.readUntil(o, !0);
      }, s.prototype.get_regexp = function(o, l) {
        var u = null, c = "g";
        return l && a && (c = "y"), typeof o == "string" && o !== "" ? u = new RegExp(o, c) : o && (u = new RegExp(o.source, c)), u;
      }, s.prototype.get_literal_regexp = function(o) {
        return RegExp(o.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"));
      }, s.prototype.peekUntilAfter = function(o) {
        var l = this.__position, u = this.readUntilAfter(o);
        return this.__position = l, u;
      }, s.prototype.lookBack = function(o) {
        var l = this.__position - 1;
        return l >= o.length && this.__input.substring(l - o.length, l).toLowerCase() === o;
    ...
    function(r) {
      ...
      a.prototype.get_directives = function(s) {
        ...
        for (var l = this.__directive_pattern.exec(s); l; )
          o[l[1]] = l[2], l = this.__directive_pattern.exec(s);
        return o;
    ...
    /***/
    function(r, a, s) {
      var o = s(16).Beautifier, l = s(17).Options;
      function u(c, d) {
        var m = new o(c, d);
        return m.beautify();
      }
    ...
    /***/
    function(r, a, s) {
      var o = s(17).Options, l = s(2).Output, u = s(8).InputScanner, c = s(13).Directives, d = new c(/\/\*/, /\*\//), m = /\r\n|[\r\n]/, f = /\r\n|[\r\n]/g, g = /\s/, p = /(?:\s|\n)+/g, _ = /\/\*(?:[\s\S]*?)((?:\*\/)|$)/g, x = /\/\/(?:[^\n\r\u2028\u2029]*)/g;
      function w(y, S) {
        this._source_text = y || "", this._options = new o(S), this._ch = null, this._input = null, this.NESTED_AT_RULE = {
          "@page": !0,
          "@font-face": !0,
          "@keyframes": !0,
      ...
      w.prototype.eatString = function(y) {
        var S = "";
...
`)
        ...
        return S;
      }, w.prototype.eatWhitespace = function(y) {
        for (var S = g.test(this._input.peek()), E = 0; g.test(this._input.peek()); )
...
` && (E === 0 || E < this._options.max_preserve_newlines) && (E++, this._output.add_new_line(!0));
        ...
        for (var y = 0, S = 1, E = this._input.peek(S); E; ) {
          if (E === "{")
            return !0;
          if (E === "(")
            y += 1;
        ...
        S === "auto" && (S = `
`, y && m.test(y || "") && (S = y.match(m)[0])), y = y.replace(f, `
`);
        var E = y.match(/^[\t ]*/)[0];
        this._output = new l(this._options, E), this._input = new u(y), this._indentLevel = 0, this._nestedLevel = 0, this._ch = null;
        for (var F = 0, v = !1, b = !1, T = !1, q = !1, L = !1, k = this._ch, N, D, H; N = this._input.read(p), D = N !== "", H = k, this._ch = this._input.next(), this._ch === "\\" && this._input.hasNext() && (this._ch += this._input.next()), k = this._ch, this._ch; )
          if (this._ch === "/" && this._input.peek() === "*") {
            this._output.add_new_line(), this._input.back();
            var P = this._input.read(_), C = d.get_directives(P);
            C && C.ignore === "start" && (P += d.readIgnored(this._input)), this.print_string(P), this.eatWhitespace(!0), this._output.add_new_line();
            ...
            if (this.preserveSingleSpace(D), this._input.peek() === "{")
              ...
              A.match(/[ :]$/) && (A = this.eatString(": ").replace(/\s$/, ""), this.print_string(A), this._output.space_before_token = !0), A = A.replace(/\s$/, ""), A === "extend" ? q = !0 : A === "import" && (L = !0), A in this.NESTED_AT_RULE ? (this._nestedLevel += 1, A in this.CONDITIONAL_GROUP_RULE && (T = !0)) : !v && F === 0 && A.indexOf(":") !== -1 && (b = !0, this.indent());
            }
          else
            this._ch === "#" && this._input.peek() === "{" ? (this.preserveSingleSpace(D), this.print_string(this._ch + this.eatString("}"))) : this._ch === "{" ? (b && (b = !1, this.outdent()), T ? (T = !1, v = this._indentLevel >= this._nestedLevel) : v = this._indentLevel >= this._nestedLevel - 1, this._options.newline_between_rules && v && this._output.previous_line && this._output.previous_line.item(-1) !== "{" && this._output.ensure_empty_line_above("/", ","), this._output.space_before_token = !0, this._options.brace_style === "expand" ? (this._output.add_new_line(), this.print_string(this._ch), this.indent(), this._output.set_indent(this._indentLevel)) : (this.indent(), this.print_string(this._ch)), this.eatWhitespace(!0), this._output.add_new_line()) : this._ch === "}" ? (this.outdent(), this._output.add_new_line(), H === "{" && this._output.trim(!0), L = !1, q = !1, b && (this.outdent(), b = !1), this.print_string(this._ch), v = !1, this._nestedLevel && this._nestedLevel--, this.eatWhitespace(!0), this._output.add_new_line(), this._options.newline_between_rules && !this._output.just_added_blankline() && this._input.peek() !== "}" && this._output.add_new_line(!0)) : this._ch === ":" ? (v || T) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !q && F === 0 ? (this.print_string(":"), b || (b = !0, this._output.space_before_token = !0, this.eatWhitespace(!0), this.indent())) : (this._input.lookBack(" ") && (this._output.space_before_token = !0), this._input.peek() === ":" ? (this._ch = this._input.next(), this.print_string("::")) : this.print_string(":")) : this._ch === '"' || this._ch === "'" ? (this.preserveSingleSpace(D), this.print_string(this._ch + this.eatString(this._ch)), this.eatWhitespace(!0)) : this._ch === ";" ? F === 0 ? (b && (this.outdent(), b = !1), q = !1, L = !1, this.print_string(this._ch), this.eatWhitespace(!0), this._input.peek() !== "/" && this._output.add_new_line()) : (this.print_string(this._ch), this.eatWhitespace(!0), this._output.space_before_token = !0) : this._ch === "(" ? this._input.lookBack("url") ? (this.print_string(this._ch), this.eatWhitespace(), F++, this.indent(), this._ch = this._input.next(), this._ch === ")" || this._ch === '"' || this._ch === "'" ? this._input.back() : this._ch && (this.print_string(this._ch + this.eatString(")")), F && (F--, this.outdent()))) : (this.preserveSingleSpace(D), this.print_string(this._ch), this.eatWhitespace(), F++, this.indent()) : this._ch === ")" ? (F && (F--, this.outdent()), this.print_string(this._ch)) : this._ch === "," ? (this.print_string(this._ch), this.eatWhitespace(!0), this._options.selector_separator_newline && !b && F === 0 && !L && !q ? this._output.add_new_line() : this._output.space_before_token = !0) : (this._ch === ">" || this._ch === "+" || this._ch === "~") && !b && F === 0 ? this._options.space_around_combinator ? (this._output.space_before_token = !0, this.print_string(this._ch), this._output.space_before_token = !0) : (this.print_string(this._ch), this.eatWhitespace(), this._ch && g.test(this._ch) && (this._ch = "")) : this._ch === "]" ? this.print_string(this._ch) : this._ch === "[" ? (this.preserveSingleSpace(D), this.print_string(this._ch)) : this._ch === "=" ? (this.eatWhitespace(), this.print_string("="), g.test(this._ch) && (this._ch = "")) : this._ch === "!" && !this._input.lookBack("\\") ? (this.print_string(" "), this.print_string(this._ch)) : (this.preserveSingleSpace(D), this.print_string(this._ch));
        var M = this._output.get_code(S);
        return M;
    ...
    function(r, a, s) {
      var o = s(6).Options;
      function l(u) {
        o.call(this, u, "css"), this.selector_separator_newline = this._get_boolean("selector_separator_newline", !0), this.newline_between_rules = this._get_boolean("newline_between_rules", !0);
      ...
      l.prototype = new o(), r.exports.Options = l;
    }
    /******/
  ], t = {};
  function n(r) {
...
` && (c = c.replace(/[\n]/g, l)), c;
    ...
    function(r) {
      function a(s, o, l, u) {
        this.type = s, this.text = o, this.comments_before = null, this.newlines = l || 0, this.whitespace_before = u || "", this.parent = null, this.next = null, this.previous = null, this.opened = null, this.closed = null, this.directives = null;
      }
      r.exports.Token = a;
    },
    ,
...
You passed in: '` + this.raw_options[l] + "'"
    ...
    /***/
    function(r, a, s) {
      var o = s(8).InputScanner, l = s(3).Token, u = s(10).TokenStream, c = s(11).WhitespacePattern, d = {
        START: "TK_START",
        RAW: "TK_RAW",
        EOF: "TK_EOF"
      }, m = function(f, g) {
        this._input = new o(f), this._options = g || {}, this.__tokens = null, this._patterns = {}, this._patterns.whitespace = new c(this._input);
      };
      m.prototype.tokenize = function() {
        this._input.restart(), this.__tokens = new u(), this._reset();
        for (var f, g = new l(d.START, ""), p = null, _ = [], x = new u(); g.type !== d.EOF; ) {
          for (f = this._get_next_token(g, p); this._is_comment(f); )
            x.add(f), f = this._get_next_token(g, p);
          x.isEmpty() || (f.comments_before = x, x = new u()), f.parent = p, this._is_opening(f) ? (_.push(p), p = f) : p && this._is_closing(f, p) && (f.opened = p, p.closed = f, p = _.pop(), f.parent = p), f.previous = g, g.next = f, this.__tokens.add(f), g = f;
        }
    ...
    function(r, a, s) {
      var o = s(12).Pattern;
      function l(u, c) {
        o.call(this, u, c), c ? this._line_regexp = this._input.get_regexp(c._line_regexp) : this.__set_whitespace_patterns("", ""), this.newline_count = 0, this.whitespace_before_token = "";
      }
      l.prototype = new o(), l.prototype.__set_whitespace_patterns = function(u, c) {
    ...
    function(r, a, s) {
      ...
      function u(c, d) {
        o.call(this, c, d), this.__template_pattern = null, this._disabled = Object.assign({}, l), this._excluded = Object.assign({}, l), d && (this.__template_pattern = this._input.get_regexp(d.__template_pattern), this._excluded = Object.assign(this._excluded, d._excluded), this._disabled = Object.assign(this._disabled, d._disabled));
        var m = new o(c);
        this.__patterns = {
      ...
      u.prototype = new o(), u.prototype._create = function() {
    ...
    /***/
    function(r, a, s) {
      var o = s(19).Beautifier, l = s(20).Options;
      function u(c, d, m, f) {
        var g = new o(c, d, m, f);
        return g.beautify();
      }
    ...
    /***/
    function(r, a, s) {
      var o = s(20).Options, l = s(2).Output, u = s(21).Tokenizer, c = s(21).TOKEN, d = /\r\n|[\r\n]/, m = /\r\n|[\r\n]/g, f = function(v, b) {
        this.indent_level = 0, this.alignment_size = 0, this.max_preserve_newlines = v.max_preserve_newlines, this.preserve_newlines = v.preserve_newlines, this._output = new l(v, b);
      };
      f.prototype.current_line_has_match = function(v) {
        return this._output.current_line.has_match(v);
      }, f.prototype.set_space_before_token = function(v, b) {
        this._output.space_before_token = v, this._output.non_breaking_space = b;
      }, f.prototype.set_wrap_point = function() {
        this._output.set_indent(this.indent_level, this.alignment_size), this._output.set_wrap_point();
      }, f.prototype.add_raw_token = function(v) {
        this._output.add_raw_token(v);
      }, f.prototype.print_preserved_newlines = function(v) {
        var b = 0;
        v.type !== c.TEXT && v.previous.type !== c.TEXT && (b = v.newlines ? 1 : 0), this.preserve_newlines && (b = v.newlines < this.max_preserve_newlines + 1 ? v.newlines : this.max_preserve_newlines + 1);
        for (var T = 0; T < b; T++)
          this.print_newline(T > 0);
        return b !== 0;
      }, f.prototype.traverse_whitespace = function(v) {
        return v.whitespace_before || v.newlines ? (this.print_preserved_newlines(v) || (this._output.space_before_token = !0), !0) : !1;
      }, f.prototype.previous_token_wrapped = function() {
        return this._output.previous_token_wrapped;
      }, f.prototype.print_newline = function(v) {
        this._output.add_new_line(v);
      }, f.prototype.print_token = function(v) {
        v.text && (this._output.set_indent(this.indent_level, this.alignment_size), this._output.add_token(v.text));
      }, f.prototype.indent = function() {
        this.indent_level++;
      }, f.prototype.get_full_indent = function(v) {
        return v = this.indent_level + (v || 0), v < 1 ? "" : this._output.get_indent_string(v);
      };
      var g = function(v) {
        for (var b = null, T = v.next; T.type !== c.EOF && v.closed !== T; ) {
        ...
        var T = null, q = null;
        return b.closed ? (v === "script" ? T = "text/javascript" : v === "style" && (T = "text/css"), T = g(b) || T, T.search("text/css") > -1 ? q = "css" : T.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/) > -1 ? q = "javascript" : T.search(/(text|application|dojo)\/(x-)?(html)/) > -1 ? q = "html" : T.search(/test\/null/) > -1 && (q = "null"), q) : null;
      };
      function _(v, b) {
        return b.indexOf(v) !== -1;
      }
      function x(v, b, T) {
        this.parent = v || null, this.tag = b ? b.tag_name : "", this.indent_level = T || 0, this.parser_token = b || null;
      }
      function w(v) {
        this._printer = v, this._current_frame = null;
      }
      w.prototype.get_parser_token = function() {
        return this._current_frame ? this._current_frame.parser_token : null;
      }, w.prototype.record_tag = function(v) {
        var b = new x(this._current_frame, v, this._printer.indent_level);
        this._current_frame = b;
      }, w.prototype._try_pop_frame = function(v) {
        var b = null;
        return v && (b = v.parser_token, this._printer.indent_level = v.indent_level, this._current_frame = v.parent), b;
      }, w.prototype._get_frame = function(v, b) {
        for (var T = this._current_frame; T && v.indexOf(T.tag) === -1; ) {
        ...
        return T;
      }, w.prototype.try_pop = function(v, b) {
        var T = this._get_frame([v], b);
        return this._try_pop_frame(T);
      }, w.prototype.indent_to_tag = function(v) {
        var b = this._get_frame(v);
        b && (this._printer.indent_level = b.indent_level);
      };
      function y(v, b, T, q) {
        this._source_text = v || "", b = b || {}, this._js_beautify = T, this._css_beautify = q, this._tag_stack = null;
        var L = new o(b, "html");
      ...
      y.prototype.beautify = function() {
        if (this._options.disabled)
          return this._source_text;
        var v = this._source_text, b = this._options.eol;
        this._options.eol === "auto" && (b = `
`, v && d.test(v) && (b = v.match(d)[0])), v = v.replace(m, `
`);
        var T = v.match(/^[\t ]*/)[0], q = {
          text: "",
          type: ""
        }, L = new S(), k = new f(this._options, T), N = new u(v, this._options).tokenize();
        this._tag_stack = new w(k);
        for (var D = null, H = N.next(); H.type !== c.EOF; )
          H.type === c.TAG_OPEN || H.type === c.COMMENT ? (D = this._handle_tag_open(k, H, L, q), L = D) : H.type === c.ATTRIBUTE || H.type === c.EQUALS || H.type === c.VALUE || H.type === c.TEXT && !L.tag_complete ? D = this._handle_inside_tag(k, H, L, N) : H.type === c.TAG_CLOSE ? D = this._handle_tag_close(k, H, L) : H.type === c.TEXT ? D = this._handle_text(k, H, L) : k.add_raw_token(H), q = D, H = N.next();
        var P = k._output.get_code(b);
        return P;
      }, y.prototype._handle_tag_close = function(v, b, T) {
        var q = {
          text: b.text,
          type: b.type
        };
        return v.alignment_size = 0, T.tag_complete = !0, v.set_space_before_token(b.newlines || b.whitespace_before !== "", !0), T.is_unformatted ? v.add_raw_token(b) : (T.tag_start_char === "<" && (v.set_space_before_token(b.text[0] === "/", !0), this._is_wrap_attributes_force_expand_multiline && T.has_wrapped_attrs && v.print_newline(!1)), v.print_token(b)), T.indent_content && !(T.is_unformatted || T.is_content_unformatted) && (v.indent(), T.indent_content = !1), !T.is_inline_element && !(T.is_unformatted || T.is_content_unformatted) && v.set_wrap_point(), q;
      }, y.prototype._handle_inside_tag = function(v, b, T, q) {
        var L = T.has_wrapped_attrs, k = {
          text: b.text,
          type: b.type
        };
        if (v.set_space_before_token(b.newlines || b.whitespace_before !== "", !0), T.is_unformatted)
          v.add_raw_token(b);
        else if (T.tag_start_char === "{" && b.type === c.TEXT)
          v.print_preserved_newlines(b) ? (b.newlines = 0, v.add_raw_token(b)) : v.print_token(b);
        else {
          if (b.type === c.ATTRIBUTE ? (v.set_space_before_token(!0), T.attr_count += 1) : (b.type === c.EQUALS || b.type === c.VALUE && b.previous.type === c.EQUALS) && v.set_space_before_token(!1), b.type === c.ATTRIBUTE && T.tag_start_char === "<" && ((this._is_wrap_attributes_preserve || this._is_wrap_attributes_preserve_aligned) && (v.traverse_whitespace(b), L = L || b.newlines !== 0), this._is_wrap_attributes_force)) {
            var N = T.attr_count > 1;
            if (this._is_wrap_attributes_force_expand_multiline && T.attr_count === 1) {
              var D = !0, H = 0, P;
              do {
                if (P = q.peek(H), P.type === c.ATTRIBUTE) {
                  D = !1;
                  break;
                }
                H += 1;
              } while (H < 4 && P.type !== c.EOF && P.type !== c.TAG_CLOSE);
              N = !D;
            }
            N && (v.print_newline(!1), L = !0);
          }
          v.print_token(b), L = L || v.previous_token_wrapped(), T.has_wrapped_attrs = L;
        }
        return k;
      }, y.prototype._handle_text = function(v, b, T) {
        var q = {
          text: b.text,
          type: "TK_CONTENT"
        };
        return T.custom_beautifier_name ? this._print_custom_beatifier_text(v, b, T) : T.is_unformatted || T.is_content_unformatted ? v.add_raw_token(b) : (v.traverse_whitespace(b), v.print_token(b)), q;
      }, y.prototype._print_custom_beatifier_text = function(v, b, T) {
        var q = this;
        if (b.text !== "") {
          var L = b.text, k, N = 1, D = "", H = "";
          T.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function" ? k = this._js_beautify : T.custom_beautifier_name === "css" && typeof this._css_beautify == "function" ? k = this._css_beautify : T.custom_beautifier_name === "html" && (k = function(I, z) {
            var B = new y(I, z, q._js_beautify, q._css_beautify);
            return B.beautify();
          }), this._options.indent_scripts === "keep" ? N = 0 : this._options.indent_scripts === "separate" && (N = -v.indent_level);
          var P = v.get_full_indent(N);
          if (L = L.replace(/\n[ \t]*$/, ""), T.custom_beautifier_name !== "html" && L[0] === "<" && L.match(/^(<!--|<!\[CDATA\[)/)) {
            var C = /^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(L);
            if (!C) {
              v.add_raw_token(b);
              return;
            ...
            D = P + C[1] + `
`, L = C[4], C[5] && (H = P + C[5]), L = L.replace(/\n[ \t]*$/, ""), (C[2] || C[3].indexOf(`
`) !== -1) && (C = C[3].match(/[ \t]+$/), C && (b.whitespace_before = C[0]));
          }
          if (L)
            if (k) {
              var A = function() {
...
` + P);
          ...
          D && (L ? L = D + L + `
` + H : L = D + H), v.print_newline(!1), L && (b.text = L, b.whitespace_before = "", b.newlines = 0, v.add_raw_token(b), v.print_newline(!0));
        }
      }, y.prototype._handle_tag_open = function(v, b, T, q) {
        var L = this._get_tag_open_token(b);
        return (T.is_unformatted || T.is_content_unformatted) && !T.is_empty_element && b.type === c.TAG_OPEN && b.text.indexOf("</") === 0 ? (v.add_raw_token(b), L.start_tag_token = this._tag_stack.try_pop(L.tag_name)) : (v.traverse_whitespace(b), this._set_tag_position(v, b, L, T, q), L.is_inline_element || v.set_wrap_point(), v.print_token(b)), (this._is_wrap_attributes_force_aligned || this._is_wrap_attributes_aligned_multiple || this._is_wrap_attributes_preserve_aligned) && (L.alignment_size = b.text.length + 1), !L.tag_complete && !L.is_unformatted && (v.alignment_size = L.alignment_size), L;
      };
      var S = function(v, b) {
      ...
      y.prototype._get_tag_open_token = function(v) {
        var b = new S(this._tag_stack.get_parser_token(), v);
        return b.alignment_size = this._options.wrap_attributes_indent_size, b.is_end_tag = b.is_end_tag || _(b.tag_check, this._options.void_elements), b.is_empty_element = b.tag_complete || b.is_start_tag && b.is_end_tag, b.is_unformatted = !b.tag_complete && _(b.tag_check, this._options.unformatted), b.is_content_unformatted = !b.is_empty_element && _(b.tag_check, this._options.content_unformatted), b.is_inline_element = _(b.tag_name, this._options.inline) || b.tag_start_char === "{", b;
      }, y.prototype._set_tag_position = function(v, b, T, q, L) {
        if (T.is_empty_element || (T.is_end_tag ? T.start_tag_token = this._tag_stack.try_pop(T.tag_name) : (this._do_optional_end_element(T) && (T.is_inline_element || v.print_newline(!1)), this._tag_stack.record_tag(T), (T.tag_name === "script" || T.tag_name === "style") && !(T.is_unformatted || T.is_content_unformatted) && (T.custom_beautifier_name = p(T.tag_check, b)))), _(T.tag_check, this._options.extra_liners) && (v.print_newline(!1), v._output.just_added_blankline() || v.print_newline(!0)), T.is_empty_element) {
          if (T.tag_start_char === "{" && T.tag_check === "else") {
            this._tag_stack.indent_to_tag(["if", "unless", "each"]), T.indent_content = !0;
            var k = v.current_line_has_match(/{{#if/);
            k || v.print_newline(!1);
          }
          T.tag_name === "!--" && L.type === c.TAG_CLOSE && q.is_end_tag && T.text.indexOf(`
`) === -1 || (T.is_inline_element || T.is_unformatted || v.print_newline(!1), this._calcluate_parent_multiline(v, T));
        } else if (T.is_end_tag) {
          var N = !1;
          N = T.start_tag_token && T.start_tag_token.multiline_content, N = N || !T.is_inline_element && !(q.is_inline_element || q.is_unformatted) && !(L.type === c.TAG_CLOSE && T.start_tag_token === q) && L.type !== "TK_CONTENT", (T.is_content_unformatted || T.is_unformatted) && (N = !1), N && v.print_newline(!1);
        } else
          T.indent_content = !T.custom_beautifier_name, T.tag_start_char === "<" && (T.tag_name === "html" ? T.indent_content = this._options.indent_inner_html : T.tag_name === "head" ? T.indent_content = this._options.indent_head_inner_html : T.tag_name === "body" && (T.indent_content = this._options.indent_body_inner_html)), !(T.is_inline_element || T.is_unformatted) && (L.type !== "TK_CONTENT" || T.is_content_unformatted) && v.print_newline(!1), this._calcluate_parent_multiline(v, T);
      }, y.prototype._calcluate_parent_multiline = function(v, b) {
        b.parent && v._output.just_added_newline() && !((b.is_inline_element || b.is_unformatted) && b.parent.is_inline_element) && (b.parent.multiline_content = !0);
      };
      var E = ["address", "article", "aside", "blockquote", "details", "div", "dl", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hr", "main", "nav", "ol", "p", "pre", "section", "table", "ul"], F = ["a", "audio", "del", "ins", "map", "noscript", "video"];
      y.prototype._do_optional_end_element = function(v) {
        var b = null;
        if (!(v.is_empty_element || !v.is_start_tag || !v.parent)) {
          if (v.tag_name === "body")
            b = b || this._tag_stack.try_pop("head");
          else if (v.tag_name === "li")
            b = b || this._tag_stack.try_pop("li", ["ol", "ul"]);
          else if (v.tag_name === "dd" || v.tag_name === "dt")
            b = b || this._tag_stack.try_pop("dt", ["dl"]), b = b || this._tag_stack.try_pop("dd", ["dl"]);
          else if (v.parent.tag_name === "p" && E.indexOf(v.tag_name) !== -1) {
            var T = v.parent.parent;
            (!T || F.indexOf(T.tag_name) === -1) && (b = b || this._tag_stack.try_pop("p"));
          } else
            v.tag_name === "rp" || v.tag_name === "rt" ? (b = b || this._tag_stack.try_pop("rt", ["ruby", "rtc"]), b = b || this._tag_stack.try_pop("rp", ["ruby", "rtc"])) : v.tag_name === "optgroup" ? b = b || this._tag_stack.try_pop("optgroup", ["select"]) : v.tag_name === "option" ? b = b || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]) : v.tag_name === "colgroup" ? b = b || this._tag_stack.try_pop("caption", ["table"]) : v.tag_name === "thead" ? (b = b || this._tag_stack.try_pop("caption", ["table"]), b = b || this._tag_stack.try_pop("colgroup", ["table"])) : v.tag_name === "tbody" || v.tag_name === "tfoot" ? (b = b || this._tag_stack.try_pop("caption", ["table"]), b = b || this._tag_stack.try_pop("colgroup", ["table"]), b = b || this._tag_stack.try_pop("thead", ["table"]), b = b || this._tag_stack.try_pop("tbody", ["table"])) : v.tag_name === "tr" ? (b = b || this._tag_stack.try_pop("caption", ["table"]), b = b || this._tag_stack.try_pop("colgroup", ["table"]), b = b || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"])) : (v.tag_name === "th" || v.tag_name === "td") && (b = b || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"]), b = b || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"]));
          return v.parent = this._tag_stack.get_parser_token(), b;
        }
    ...
    /***/
    function(r, a, s) {
      var o = s(9).Tokenizer, l = s(9).TOKEN, u = s(13).Directives, c = s(14).TemplatablePattern, d = s(12).Pattern, m = {
        ...
        RAW: l.RAW,
        EOF: l.EOF
      }, f = new u(/<\!--/, /-->/), g = function(p, _) {
        o.call(this, p, _), this._current_tag_name = "";
        var x = new c(this._input).read_options(this._options), w = new d(this._input);
        if (this.__patterns = {
          word: x.until(/[\n\r\t <]/),
          ...
          this.__patterns.unformatted_content_delimiter = w.matching(y).until_after(y);
        }
      };
      g.prototype = new o(), g.prototype._is_comment = function(p) {
        return !1;
      }, g.prototype._is_opening = function(p) {
        return p.type === m.TAG_OPEN;
      }, g.prototype._is_closing = function(p, _) {
        return p.type === m.TAG_CLOSE && _ && ((p.text === ">" || p.text === "/>") && _.text[0] === "<" || p.text === "}}" && _.text[0] === "{" && _.text[1] === "{");
      }, g.prototype._reset = function() {
        this._current_tag_name = "";
      }, g.prototype._get_next_token = function(p, _) {
        var x = null;
        this._readWhitespace();
        var w = this._input.peek();
        return w === null ? this._create_token(m.EOF, "") : (x = x || this._read_open_handlebars(w, _), x = x || this._read_attribute(w, p, _), x = x || this._read_close(w, _), x = x || this._read_raw_content(w, p, _), x = x || this._read_content_word(w), x = x || this._read_comment_or_cdata(w), x = x || this._read_processing(w), x = x || this._read_open(w, _), x = x || this._create_token(m.UNKNOWN, this._input.next()), x);
      }, g.prototype._read_comment_or_cdata = function(p) {
        var _ = null, x = null, w = null;
        if (p === "<") {
          var y = this._input.peek(1);
          y === "!" && (x = this.__patterns.comment.read(), x ? (w = f.get_directives(x), w && w.ignore === "start" && (x += f.readIgnored(this._input))) : x = this.__patterns.cdata.read()), x && (_ = this._create_token(m.COMMENT, x), _.directives = w);
        }
        return _;
        ...
        if (p === "<") {
          var y = this._input.peek(1);
          (y === "!" || y === "?") && (x = this.__patterns.conditional_comment.read(), x = x || this.__patterns.processing.read()), x && (_ = this._create_token(m.COMMENT, x), _.directives = w);
        }
        return _;
      }, g.prototype._read_open = function(p, _) {
        var x = null, w = null;
        return _ || p === "<" && (x = this._input.next(), this._input.peek() === "/" && (x += this._input.next()), x += this.__patterns.element_name.read(), w = this._create_token(m.TAG_OPEN, x)), w;
      }, g.prototype._read_open_handlebars = function(p, _) {
        var x = null, w = null;
        return _ || this._options.indent_handlebars && p === "{" && this._input.peek(1) === "{" && (this._input.peek(2) === "!" ? (x = this.__patterns.handlebars_comment.read(), x = x || this.__patterns.handlebars.read(), w = this._create_token(m.COMMENT, x)) : (x = this.__patterns.handlebars_open.read(), w = this._create_token(m.TAG_OPEN, x))), w;
      }, g.prototype._read_close = function(p, _) {
        var x = null, w = null;
        return _ && (_.text[0] === "<" && (p === ">" || p === "/" && this._input.peek(1) === ">") ? (x = this._input.next(), p === "/" && (x += this._input.next()), w = this._create_token(m.TAG_CLOSE, x)) : _.text[0] === "{" && p === "}" && this._input.peek(1) === "}" && (this._input.next(), this._input.next(), w = this._create_token(m.TAG_CLOSE, "}}"))), w;
      }, g.prototype._read_attribute = function(p, _, x) {
        var w = null, y = "";
        if (x && x.text[0] === "<")
          if (p === "=")
            ...
            p === '"' ? S += this.__patterns.double_quote.read() : S += this.__patterns.single_quote.read(), w = this._create_token(m.VALUE, S);
          } else
            y = this.__patterns.attribute.read(), y && (_.type === m.EQUALS ? w = this._create_token(m.VALUE, y) : w = this._create_token(m.ATTRIBUTE, y));
        return w;
      ...
      }, g.prototype._read_raw_content = function(p, _, x) {
        var w = "";
        if (x && x.text[0] === "{")
          w = this.__patterns.handlebars_raw_close.read();
        else if (_.type === m.TAG_CLOSE && _.opened.text[0] === "<" && _.text[0] !== "/") {
          var y = _.opened.text.substr(1).toLowerCase();
          if (y === "script" || y === "style") {
            var S = this._read_comment_or_cdata(p);
            if (S)
              return S.type = m.TEXT, S;
            w = this._input.readUntil(new RegExp("</" + y + "[\\n\\r\\t ]*?>", "ig"));
          } else
            this._is_content_unformatted(y) && (w = this._input.readUntil(new RegExp("</" + y + "[\\n\\r\\t ]*?>", "ig")));
        }
        return w ? this._create_token(m.TEXT, w) : null;
      }, g.prototype._read_content_word = function(p) {
        var _ = "";
        if (this._options.unformatted_content_delimiter && p === this._options.unformatted_content_delimiter[0] && (_ = this.__patterns.unformatted_content_delimiter.read()), _ || (_ = this.__patterns.word.read()), _)
          return this._create_token(m.TEXT, _);
...
function Bu(e, t, n) {
  ...
  if (t) {
    for (var o = e.offsetAt(t.start), l = o; l > 0 && Qa(i, l - 1); )
      l--;
    l === 0 || Ja(i, l - 1) ? o = l : l < o && (o = l + 1);
    for (var u = e.offsetAt(t.end), c = u; c < i.length && Qa(i, c); )
      c++;
    (c === i.length || Ja(i, c)) && (u = c), t = Z.create(e.positionAt(o), e.positionAt(u));
    var d = i.substring(0, o);
    if (new RegExp(/.*[<][^>]*$/).test(d))
      return i = i.substring(o, u), [{
        range: t,
        newText: i
      }];
    if (r = u === i.length, i = i.substring(o, u), o !== 0) {
      var m = e.offsetAt(he.create(t.start.line, 0));
      a = Vu(e.getText(), m, n);
    }
  } else
    t = Z.create(he.create(0, 0), e.positionAt(i.length));
  var f = {
    indent_size: s,
    indent_char: n.insertSpaces ? " " : "	",
    indent_empty_lines: ye(n, "indentEmptyLines", !1),
    wrap_line_length: ye(n, "wrapLineLength", 120),
    unformatted: Hn(n, "unformatted", void 0),
    content_unformatted: Hn(n, "contentUnformatted", void 0),
    ...
    extra_liners: Hn(n, "extraLiners", void 0),
...
`,
  ...
  if (a > 0) {
    var p = n.insertSpaces ? ja(" ", s * a) : ja("	", a);
    g = g.split(`
`).join(`
...
Cs = (() => {
  var e = { 470: (i) => {
    ...
    function a(o, l) {
      for (var u, c = "", d = 0, m = -1, f = 0, g = 0; g <= o.length; ++g) {
        if (g < o.length)
          u = o.charCodeAt(g);
        else {
          if (u === 47)
        ...
        if (u === 47) {
          if (!(m === g - 1 || f === 1))
            if (m !== g - 1 && f === 2) {
              ...
              l && (c.length > 0 ? c += "/.." : c = "..", d = 2);
            } else
              c.length > 0 ? c += "/" + o.slice(m + 1, g) : c = o.slice(m + 1, g), d = g - m - 1;
          m = g, f = 0;
        } else
          u === 46 && f !== -1 ? ++f : f = -1;
      }
    ...
    var s = { resolve: function() {
      for (var o, l = "", u = !1, c = arguments.length - 1; c >= -1 && !u; c--) {
        var d;
        c >= 0 ? d = arguments[c] : (o === void 0 && (o = process.cwd()), d = o), r(d), d.length !== 0 && (l = d + "/" + l, u = d.charCodeAt(0) === 47);
      }
      return l = a(l, !u), u ? l.length > 0 ? "/" + l : "/" : l.length > 0 ? l : ".";
    }, normalize: function(o) {
      if (r(o), o.length === 0)
        return ".";
      var l = o.charCodeAt(0) === 47, u = o.charCodeAt(o.length - 1) === 47;
      return (o = a(o, !l)).length !== 0 || l || (o = "."), o.length > 0 && u && (o += "/"), l ? "/" + o : o;
      ...
      for (var o, l = 0; l < arguments.length; ++l) {
        var u = arguments[l];
        r(u), u.length > 0 && (o === void 0 ? o = u : o += "/" + u);
      }
      return o === void 0 ? "." : s.normalize(o);
    }, relative: function(o, l) {
      if (r(o), r(l), o === l || (o = s.resolve(o)) === (l = s.resolve(l)))
        return "";
      for (var u = 1; u < o.length && o.charCodeAt(u) === 47; ++u)
        ;
      for (var c = o.length, d = c - u, m = 1; m < l.length && l.charCodeAt(m) === 47; ++m)
        ;
      for (var f = l.length - m, g = d < f ? d : f, p = -1, _ = 0; _ <= g; ++_) {
        if (_ === g) {
          if (f > g) {
            if (l.charCodeAt(m + _) === 47)
              return l.slice(m + _ + 1);
            if (_ === 0)
              return l.slice(m + _);
          } else
            d > g && (o.charCodeAt(u + _) === 47 ? p = _ : _ === 0 && (p = 0));
          break;
        }
        var x = o.charCodeAt(u + _);
        if (x !== l.charCodeAt(m + _))
          break;
        x === 47 && (p = _);
      }
      var w = "";
      for (_ = u + p + 1; _ <= c; ++_)
        _ !== c && o.charCodeAt(_) !== 47 || (w.length === 0 ? w += ".." : w += "/..");
      return w.length > 0 ? w + l.slice(m + p) : (m += p, l.charCodeAt(m) === 47 && ++m, l.slice(m));
    }, _makeLong: function(o) {
      return o;
    }, dirname: function(o) {
      if (r(o), o.length === 0)
        return ".";
      for (var l = o.charCodeAt(0), u = l === 47, c = -1, d = !0, m = o.length - 1; m >= 1; --m)
        if ((l = o.charCodeAt(m)) === 47) {
          if (!d) {
            c = m;
            break;
          }
      ...
      if (l !== void 0 && l.length > 0 && l.length <= o.length) {
        ...
        for (u = o.length - 1; u >= 0; --u) {
          ...
          if (p === 47) {
            ...
            g === -1 && (m = !1, g = u + 1), f >= 0 && (p === l.charCodeAt(f) ? --f == -1 && (d = u) : (f = -1, d = g));
        }
        return c === d ? d = g : d === -1 && (d = o.length), o.slice(c, d);
      }
      for (u = o.length - 1; u >= 0; --u)
      ...
      r(o);
      for (var l = -1, u = 0, c = -1, d = !0, m = 0, f = o.length - 1; f >= 0; --f) {
        var g = o.charCodeAt(f);
        if (g !== 47)
          c === -1 && (d = !1, c = f + 1), g === 46 ? l === -1 ? l = f : m !== 1 && (m = 1) : l !== -1 && (m = -1);
        else if (!d) {
          u = f + 1;
          break;
        }
      }
      return l === -1 || c === -1 || m === 0 || m === 1 && l === c - 1 && l === u + 1 ? "" : o.slice(l, c);
    }, format: function(o) {
      ...
      if (o.length === 0)
        return l;
      var u, c = o.charCodeAt(0), d = c === 47;
      d ? (l.root = "/", u = 1) : u = 0;
      for (var m = -1, f = 0, g = -1, p = !0, _ = o.length - 1, x = 0; _ >= u; --_)
        if ((c = o.charCodeAt(_)) !== 47)
          g === -1 && (p = !1, g = _ + 1), c === 46 ? m === -1 ? m = _ : x !== 1 && (x = 1) : m !== -1 && (x = -1);
        else if (!p) {
          f = _ + 1;
          break;
        }
      return m === -1 || g === -1 || x === 0 || x === 1 && m === g - 1 && m === f + 1 ? g !== -1 && (l.base = l.name = f === 0 && d ? o.slice(1, g) : o.slice(f, g)) : (f === 0 && d ? (l.name = o.slice(1, m), l.base = o.slice(1, g)) : (l.name = o.slice(f, m), l.base = o.slice(f, g)), l.ext = o.slice(m, g)), f > 0 ? l.dir = o.slice(0, f - 1) : d && (l.dir = "/"), l;
    }, sep: "/", delimiter: ":", win32: null, posix: null };
    s.posix = s, i.exports = s;
  }, 447: (i, r, a) => {
    var s;
    if (a.r(r), a.d(r, { URI: () => w, Utils: () => N }), typeof process == "object")
      s = process.platform === "win32";
    else if (typeof navigator == "object") {
      var o = navigator.userAgent;
      s = o.indexOf("Windows") >= 0;
    }
    var l, u, c = (l = function(C, A) {
      return (l = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(M, W) {
        M.__proto__ = W;
      } || function(M, W) {
        for (var I in W)
          Object.prototype.hasOwnProperty.call(W, I) && (M[I] = W[I]);
      })(C, A);
    }, function(C, A) {
      ...
      l(C, A), C.prototype = A === null ? Object.create(A) : (M.prototype = A.prototype, new M());
    }), d = /^\w[\w\d+.-]*$/, m = /^\//, f = /^\/\//;
    function g(C, A) {
      if (!C.scheme && A)
      ...
      if (C.path) {
        if (C.authority) {
          if (!m.test(C.path))
            throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character');
        } else if (f.test(C.path))
          throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")');
      }
    }
    var p = "", _ = "/", x = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, w = function() {
      function C(A, M, W, I, z, B) {
        B === void 0 && (B = !1), typeof A == "object" ? (this.scheme = A.scheme || p, this.authority = A.authority || p, this.path = A.path || p, this.query = A.query || p, this.fragment = A.fragment || p) : (this.scheme = /* @__PURE__ */ function($, Y) {
          return $ || Y ? $ : "file";
        }(A, B), this.authority = M || p, this.path = function($, Y) {
          switch ($) {
            case "https":
            case "http":
            case "file":
          ...
          return Y;
        }(this.scheme, W || p), this.query = I || p, this.fragment = z || p, g(this, B));
      }
      return C.isUri = function(A) {
        ...
        if (!A)
          return this;
        var M = A.scheme, W = A.authority, I = A.path, z = A.query, B = A.fragment;
        return M === void 0 ? M = this.scheme : M === null && (M = p), W === void 0 ? W = this.authority : W === null && (W = p), I === void 0 ? I = this.path : I === null && (I = p), z === void 0 ? z = this.query : z === null && (z = p), B === void 0 ? B = this.fragment : B === null && (B = p), M === this.scheme && W === this.authority && I === this.path && z === this.query && B === this.fragment ? this : new S(M, W, I, z, B);
      }, C.parse = function(A, M) {
        M === void 0 && (M = !1);
        var W = x.exec(A);
        return W ? new S(W[2] || p, k(W[4] || p), k(W[5] || p), k(W[7] || p), k(W[9] || p), M) : new S(p, p, p, p, p);
      }, C.file = function(A) {
        var M = p;
        if (s && (A = A.replace(/\\/g, _)), A[0] === _ && A[1] === _) {
          var W = A.indexOf(_, 2);
          W === -1 ? (M = A.substring(2), A = _) : (M = A.substring(2, W), A = A.substring(W) || _);
        }
        return new S("file", M, A, p, p);
      }, C.from = function(A) {
        var M = new S(A.scheme, A.authority, A.path, A.query, A.fragment);
        return g(M, !0), M;
      }, C.prototype.toString = function(A) {
        return A === void 0 && (A = !1), T(this, A);
        ...
        if (A) {
          if (A instanceof C)
            return A;
          var M = new S(A);
          return M._formatted = A.external, M._fsPath = A._sep === y ? A.fsPath : null, M;
        }
        return A;
      }, C;
    }(), y = s ? 1 : void 0, S = function(C) {
      function A() {
      ...
      return c(A, C), Object.defineProperty(A.prototype, "fsPath", { get: function() {
        ...
        return M === void 0 && (M = !1), M ? T(this, !0) : (this._formatted || (this._formatted = T(this, !1)), this._formatted);
      }, A.prototype.toJSON = function() {
        var M = { $mid: 1 };
        return this._fsPath && (M.fsPath = this._fsPath, M._sep = y), this._formatted && (M.external = this._formatted), this.path && (M.path = this.path), this.scheme && (M.scheme = this.scheme), this.authority && (M.authority = this.authority), this.query && (M.query = this.query), this.fragment && (M.fragment = this.fragment), M;
      }, A;
    }(w), E = ((u = {})[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28", u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u);
    function F(C, A) {
      for (var M = void 0, W = -1, I = 0; I < C.length; I++) {
        var z = C.charCodeAt(I);
        if (z >= 97 && z <= 122 || z >= 65 && z <= 90 || z >= 48 && z <= 57 || z === 45 || z === 46 || z === 95 || z === 126 || A && z === 47)
          W !== -1 && (M += encodeURIComponent(C.substring(W, I)), W = -1), M !== void 0 && (M += C.charAt(I));
        else {
          M === void 0 && (M = C.substr(0, I));
          var B = E[z];
          B !== void 0 ? (W !== -1 && (M += encodeURIComponent(C.substring(W, I)), W = -1), M += B) : W === -1 && (W = I);
        }
      }
      return W !== -1 && (M += encodeURIComponent(C.substring(W))), M !== void 0 ? M : C;
    }
    function v(C) {
      for (var A = void 0, M = 0; M < C.length; M++) {
        var W = C.charCodeAt(M);
        W === 35 || W === 63 ? (A === void 0 && (A = C.substr(0, M)), A += E[W]) : A !== void 0 && (A += C[M]);
      }
      return A !== void 0 ? A : C;
    }
    function b(C, A) {
    ...
    function T(C, A) {
      var M = A ? v : F, W = "", I = C.scheme, z = C.authority, B = C.path, $ = C.query, Y = C.fragment;
      if (I && (W += I, W += ":"), (z || I === "file") && (W += _, W += _), z) {
        var J = z.indexOf("@");
        if (J !== -1) {
          var K = z.substr(0, J);
          z = z.substr(J + 1), (J = K.indexOf(":")) === -1 ? W += M(K, !1) : (W += M(K.substr(0, J), !1), W += ":", W += M(K.substr(J + 1), !1)), W += "@";
        }
        (J = (z = z.toLowerCase()).indexOf(":")) === -1 ? W += M(z, !1) : (W += M(z.substr(0, J), !1), W += z.substr(J));
      }
      if (B) {
        if (B.length >= 3 && B.charCodeAt(0) === 47 && B.charCodeAt(2) === 58)
          (fe = B.charCodeAt(1)) >= 65 && fe <= 90 && (B = "/".concat(String.fromCharCode(fe + 32), ":").concat(B.substr(3)));
        else if (B.length >= 2 && B.charCodeAt(1) === 58) {
          var fe;
          (fe = B.charCodeAt(0)) >= 65 && fe <= 90 && (B = "".concat(String.fromCharCode(fe + 32), ":").concat(B.substr(2)));
        }
        W += M(B, !0);
      }
      return $ && (W += "?", W += M($, !1)), Y && (W += "#", W += A ? Y : F(Y, !1)), W;
    }
    function q(C) {
      try {
        return decodeURIComponent(C);
      } catch {
        return C.length > 3 ? C.substr(0, 3) + q(C.substr(3)) : C;
      }
    }
    var L = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function k(C) {
      return C.match(L) ? C.replace(L, function(A) {
        return q(A);
      }) : C;
    }
    var N, D = a(470), H = function(C, A, M) {
      if (M || arguments.length === 2)
        for (var W, I = 0, z = A.length; I < z; I++)
          !W && I in A || (W || (W = Array.prototype.slice.call(A, 0, I)), W[I] = A[I]);
      return C.concat(W || Array.prototype.slice.call(A));
    }, P = D.posix || D;
    (function(C) {
      C.joinPath = function(A) {
        for (var M = [], W = 1; W < arguments.length; W++)
          M[W - 1] = arguments[W];
        return A.with({ path: P.join.apply(P, H([A.path], M, !1)) });
      }, C.resolvePath = function(A) {
        for (var M = [], W = 1; W < arguments.length; W++)
          M[W - 1] = arguments[W];
        var I = A.path || "/";
        return A.with({ path: P.resolve.apply(P, H([I], M, !1)) });
      }, C.dirname = function(A) {
        var M = P.dirname(A.path);
        return M.length === 1 && M.charCodeAt(0) === 46 ? A : A.with({ path: M });
      }, C.basename = function(A) {
        return P.basename(A.path);
      }, C.extname = function(A) {
        return P.extname(A.path);
      };
    })(N || (N = {}));
  } }, t = {};
  function n(i) {
...
function Xu(e, t, n, i, r, a) {
  var s = bi(n);
  if (Gu(s, e.languageId)) {
    s.length < n.length && (i++, r--);
    var o = $u(e.uri, s, t, a);
    if (!(!o || !Ju(o)))
      return {
        range: Z.create(e.positionAt(i), e.positionAt(r)),
        target: o
      };
  }
}
...
function Qu(e, t) {
  for (var n = [], i = xe(e.getText(), 0), r = i.scan(), a = void 0, s = !1, o = void 0, l = {}; r !== U.EOS; ) {
    switch (r) {
      case U.StartTag:
        if (!o) {
      ...
      case U.AttributeValue:
        if (a === "src" || a === "href") {
          ...
          if (!s) {
            var d = Xu(e, t, c, i.getTokenOffset(), i.getTokenEnd(), o);
            d && n.push(d);
          }
          s && typeof o > "u" && (o = bi(c), o && t && (o = t.resolveReference(o, e.uri))), s = !1, a = void 0;
        } else if (a === "id") {
          var m = bi(i.getTokenText());
          l[m] = i.getTokenOffset();
        }
        break;
    }
    r = i.scan();
  ...
  for (var f = 0, g = n; f < g.length; f++) {
    var d = g[f], p = e.uri + "#";
    if (d.target && Ke(d.target, p)) {
      var _ = d.target.substr(p.length), x = l[_];
      if (x !== void 0) {
        var w = e.positionAt(x);
...
function Yu(e, t, n) {
  ...
  if (!r.tag)
    return [];
  var a = [], s = Ka(U.StartTag, e, r.start), o = typeof r.endTagStart == "number" && Ka(U.EndTag, e, r.endTagStart);
  return (s && Za(s, t) || o && Za(o, t)) && (s && a.push({ kind: wn.Read, range: s }), o && a.push({ kind: wn.Read, range: o })), a;
}
function Ya(e, t) {
  return e.line < t.line || e.line === t.line && e.character <= t.character;
}
function Za(e, t) {
  return Ya(e.start, t) && Ya(t, e.end);
}
function Ka(e, t, n) {
  for (var i = xe(t.getText(), n), r = i.scan(); r !== U.EOS && r !== e; )
    r = i.scan();
  return r !== U.EOS ? { start: t.positionAt(i.getTokenOffset()), end: t.positionAt(i.getTokenEnd()) } : null;
}
function Zu(e, t) {
  var n = [];
...
function Es(e, t, n, i) {
  var r = Ku(t), a = mn.create(e.uri, Z.create(e.positionAt(t.start), e.positionAt(t.end))), s = {
    name: r,
    location: a,
    containerName: n,
    kind: di.Field
  };
  i.push(s), t.children.forEach(function(o) {
    Es(e, o, r, i);
  });
}
function Ku(e) {
...
function es(e, t, n) {
  ...
  r.endTagStart + 2 <= i && i <= r.endTagStart + 2 + a) ? [
    Z.create(e.positionAt(r.start + 1), e.positionAt(r.start + 1 + a)),
    Z.create(e.positionAt(r.endTagStart + 2), e.positionAt(r.endTagStart + 2 + a))
  ] : null;
}
function ic(e, t) {
  e = e.sort(function(g, p) {
    var _ = g.startLine - p.startLine;
    return _ === 0 && (_ = g.endLine - p.endLine), _;
  });
  for (var n = void 0, i = [], r = [], a = [], s = function(g, p) {
    ...
    if (!n)
      n = l, s(o, 0);
    else if (l.startLine > n.startLine) {
      if (l.endLine <= n.endLine)
        i.push(n), n = l, s(o, i.length);
      else if (l.startLine > n.endLine) {
        do
          n = i.pop();
        while (n && l.startLine > n.endLine);
        n && i.push(n), n = l, s(o, i.length);
      }
    }
  }
  for (var u = 0, c = 0, o = 0; o < a.length; o++) {
    var d = a[o];
    if (d) {
      if (d + u > t) {
        c = o;
  ...
  for (var m = [], o = 0; o < e.length; o++) {
    var f = r[o];
    typeof f == "number" && (f < c || f === c && u++ < t) && m.push(e[o]);
  }
  return m;
}
function rc(e, t) {
  var n = xe(e.getText()), i = n.scan(), r = [], a = [], s = null, o = -1;
  function l(w) {
    r.push(w), o = w.startLine;
  }
  for (; i !== U.EOS; ) {
    switch (i) {
      case U.StartTag: {
      ...
      case U.StartTagSelfClose: {
        ...
        if (d >= 0) {
          ...
          g > c && o !== c && l({ startLine: c, endLine: g });
        }
        break;
      }
      case U.Comment: {
        var c = e.positionAt(n.getTokenOffset()).line, p = n.getTokenText(), _ = p.match(/^\s*#(region\b)|(endregion\b)/);
        if (_)
          if (_[1])
            ...
            if (d >= 0) {
              ...
              a.length = d;
              var g = c;
              c = m.startLine, g > c && o !== c && l({ startLine: c, endLine: g, kind: fn.Region });
            }
          }
        else {
          var g = e.positionAt(n.getTokenOffset() + n.getTokenLength()).line;
          c < g && l({ startLine: c, endLine: g, kind: fn.Comment });
        }
        break;
      }
    }
  ...
  var x = t && t.rangeLimit || Number.MAX_VALUE;
  return r.length > x ? ic(r, x) : r;
}
function ac(e, t) {
  function n(i) {
    for (var r = sc(e, i), a = void 0, s = void 0, o = r.length - 1; o >= 0; o--) {
      var l = r[o];
      (!a || l[0] !== a[0] || l[1] !== a[1]) && (s = _n.create(Z.create(e.positionAt(r[o][0]), e.positionAt(r[o][1])), s)), a = l;
    }
    return s || (s = _n.create(Z.create(i, i))), s;
  }
  return t.map(n);
}
function sc(e, t) {
  var n = ks(e.getText()), i = e.offsetAt(t), r = n.findNodeAt(i), a = oc(r);
  if (r.startTagEnd && !r.endTagStart) {
    if (r.startTagEnd !== r.end)
      return [[r.start, r.end]];
    var s = Z.create(e.positionAt(r.startTagEnd - 2), e.positionAt(r.startTagEnd)), o = e.getText(s);
    o === "/>" ? a.unshift([r.start + 1, r.startTagEnd - 2]) : a.unshift([r.start + 1, r.startTagEnd - 1]);
    var l = ts(e, r, i);
...
function ts(e, t, n) {
  for (var i = Z.create(e.positionAt(t.start), e.positionAt(t.end)), r = e.getText(i), a = n - t.start, s = xe(r), o = s.scan(), l = t.start, u = [], c = !1, d = -1; o !== U.EOS; ) {
    switch (o) {
      case U.AttributeName: {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`
  ...
  function() {
    ...
    return e.prototype.setDataProviders = function(t, n) {
      var i;
      this.dataProviders = [], t && this.dataProviders.push(new As("html5", lc)), (i = this.dataProviders).push.apply(i, n);
...
function hc(e) {
  e === void 0 && (e = cc);
  var t = new uc(e), n = new Hu(e, t), i = new Mu(e, t);
  return {
    ...
    format: Bu,
    findDocumentHighlights: Yu,
    findDocumentLinks: Qu,
    findDocumentSymbols: Zu,
    getFoldingRanges: rc,
    getSelectionRanges: ac,
    doQuoteComplete: i.doQuoteComplete.bind(i),
    doTagComplete: i.doTagComplete.bind(i),
    doRename: ec,
    findMatchingTagPosition: nc,
    findOnTypeRenameRanges: es,
    findLinkedEditingRanges: es
  };
}
function dc(e, t) {
  return new As(e, t);
  ...
  constructor(e, t) {
    ...
    if (n != null && n.dataProviders)
      for (const a in n.dataProviders)
        r.push(dc(a, n.dataProviders[a]));
    this._languageService = hc({
