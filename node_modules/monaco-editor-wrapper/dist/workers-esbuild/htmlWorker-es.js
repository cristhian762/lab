var ci=class{constructor(){this.listeners=[],this.unexpectedErrorHandler=function(t){setTimeout(()=>{throw t.stack?Rt.isErrorNoTelemetry(t)?new Rt(t.message+`

`+t.stack):new Error(t.message+`

`+t.stack):t},0)}}addListener(t){return this.listeners.push(t),()=>{this._removeListener(t)}}emit(t){this.listeners.forEach(n=>{n(t)})}_removeListener(t){this.listeners.splice(this.listeners.indexOf(t),1)}setUnexpectedErrorHandler(t){this.unexpectedErrorHandler=t}getUnexpectedErrorHandler(){return this.unexpectedErrorHandler}onUnexpectedError(t){this.unexpectedErrorHandler(t),this.emit(t)}onUnexpectedExternalError(t){this.unexpectedErrorHandler(t)}},Yo=new ci;function ln(e){Zo(e)||Yo.onUnexpectedError(e)}function fi(e){if(e instanceof Error){let{name:t,message:n}=e,i=e.stacktrace||e.stack;return{$isError:!0,name:t,message:n,stack:i,noTelemetry:Rt.isErrorNoTelemetry(e)}}return e}var hi="Canceled";function Zo(e){return e instanceof di?!0:e instanceof Error&&e.name===hi&&e.message===hi}var di=class extends Error{constructor(){super(hi),this.name=this.message}};var Rt=class e extends Error{constructor(t){super(t),this.name="CodeExpectedError"}static fromError(t){if(t instanceof e)return t;let n=new e;return n.message=t.message,n.stack=t.stack,n}static isErrorNoTelemetry(t){return t.name==="CodeExpectedError"}},pe=class e extends Error{constructor(t){super(t||"An unexpected bug occurred."),Object.setPrototypeOf(this,e.prototype)}};function mi(e,t){let n=this,i=!1,r;return function(){if(i)return r;if(i=!0,t)try{r=e.apply(n,arguments)}finally{t()}else r=e.apply(n,arguments);return r}}function Ie(e,t){let n=it(e,t);return n===-1?void 0:e[n]}function it(e,t,n=0,i=e.length){let r=n,s=i;for(;r<s;){let a=Math.floor((r+s)/2);t(e[a])?r=a+1:s=a}return r-1}function Ar(e,t){let n=Nt(e,t);return n===e.length?void 0:e[n]}function Nt(e,t,n=0,i=e.length){let r=n,s=i;for(;r<s;){let a=Math.floor((r+s)/2);t(e[a])?s=a:r=a+1}return r}var Dt=class e{static{this.assertInvariants=!1}constructor(t){this._array=t,this._findLastMonotonousLastIdx=0}findLastMonotonous(t){if(e.assertInvariants){if(this._prevFindLastPredicate){for(let i of this._array)if(this._prevFindLastPredicate(i)&&!t(i))throw new Error("MonotonousArray: current predicate must be weaker than (or equal to) the previous predicate.")}this._prevFindLastPredicate=t}let n=it(this._array,t,this._findLastMonotonousLastIdx);return this._findLastMonotonousLastIdx=n+1,n===-1?void 0:this._array[n]}};function Sr(e,t,n=(i,r)=>i===r){if(e===t)return!0;if(!e||!t||e.length!==t.length)return!1;for(let i=0,r=e.length;i<r;i++)if(!n(e[i],t[i]))return!1;return!0}function*Lr(e,t){let n,i;for(let r of e)i!==void 0&&t(i,r)?n.push(r):(n&&(yield n),n=[r]),i=r;n&&(yield n)}function Cr(e,t){for(let n=0;n<=e.length;n++)t(n===0?void 0:e[n-1],n===e.length?void 0:e[n])}function Er(e,t){for(let n=0;n<e.length;n++)t(n===0?void 0:e[n-1],e[n],n+1===e.length?void 0:e[n+1])}function Mr(e,t){for(let n of t)e.push(n)}var pi;(function(e){function t(s){return s<0}e.isLessThan=t;function n(s){return s<=0}e.isLessThanOrEqual=n;function i(s){return s>0}e.isGreaterThan=i;function r(s){return s===0}e.isNeitherLessOrGreaterThan=r,e.greaterThan=1,e.lessThan=-1,e.neitherLessOrGreaterThan=0})(pi||(pi={}));function rt(e,t){return(n,i)=>t(e(n),e(i))}var st=(e,t)=>e-t;function Rr(e){return(t,n)=>-e(t,n)}var kr=class e{static{this.empty=new e(t=>{})}constructor(t){this.iterate=t}forEach(t){this.iterate(n=>(t(n),!0))}toArray(){let t=[];return this.iterate(n=>(t.push(n),!0)),t}filter(t){return new e(n=>this.iterate(i=>t(i)?n(i):!0))}map(t){return new e(n=>this.iterate(i=>n(t(i))))}some(t){let n=!1;return this.iterate(i=>(n=t(i),!n)),n}findFirst(t){let n;return this.iterate(i=>t(i)?(n=i,!1):!0),n}findLast(t){let n;return this.iterate(i=>(t(i)&&(n=i),!0)),n}findLastMaxBy(t){let n,i=!0;return this.iterate(r=>((i||pi.isGreaterThan(t(r,n)))&&(i=!1,n=r),!0)),n}};function Dr(e,t){let n=Object.create(null);for(let i of e){let r=t(i),s=n[r];s||(s=n[r]=[]),s.push(i)}return n}var Nr,Ir,zr;var gi=class{constructor(t,n){this.uri=t,this.value=n}};function Ko(e){return Array.isArray(e)}var un=class e{static{this.defaultToKey=t=>t.toString()}constructor(t,n){if(this[Nr]="ResourceMap",t instanceof e)this.map=new Map(t.map),this.toKey=n??e.defaultToKey;else if(Ko(t)){this.map=new Map,this.toKey=n??e.defaultToKey;for(let[i,r]of t)this.set(i,r)}else this.map=new Map,this.toKey=t??e.defaultToKey}set(t,n){return this.map.set(this.toKey(t),new gi(t,n)),this}get(t){return this.map.get(this.toKey(t))?.value}has(t){return this.map.has(this.toKey(t))}get size(){return this.map.size}clear(){this.map.clear()}delete(t){return this.map.delete(this.toKey(t))}forEach(t,n){typeof n<"u"&&(t=t.bind(n));for(let[i,r]of this.map)t(r.value,r.uri,this)}*values(){for(let t of this.map.values())yield t.value}*keys(){for(let t of this.map.values())yield t.uri}*entries(){for(let t of this.map.values())yield[t.uri,t.value]}*[(Nr=Symbol.toStringTag,Symbol.iterator)](){for(let[,t]of this.map)yield[t.uri,t.value]}},Ur=class{constructor(t,n){this[Ir]="ResourceSet",!t||typeof t=="function"?this._map=new un(t):(this._map=new un(n),t.forEach(this.add,this))}get size(){return this._map.size}add(t){return this._map.set(t,t),this}clear(){this._map.clear()}delete(t){return this._map.delete(t)}forEach(t,n){this._map.forEach((i,r)=>t.call(n,r,r,this))}has(t){return this._map.has(t)}entries(){return this._map.entries()}keys(){return this._map.keys()}values(){return this._map.keys()}[(Ir=Symbol.toStringTag,Symbol.iterator)](){return this.keys()}},Fr=class{constructor(){this[zr]="LinkedMap",this._map=new Map,this._head=void 0,this._tail=void 0,this._size=0,this._state=0}clear(){this._map.clear(),this._head=void 0,this._tail=void 0,this._size=0,this._state++}isEmpty(){return!this._head&&!this._tail}get size(){return this._size}get first(){return this._head?.value}get last(){return this._tail?.value}has(t){return this._map.has(t)}get(t,n=0){let i=this._map.get(t);if(i)return n!==0&&this.touch(i,n),i.value}set(t,n,i=0){let r=this._map.get(t);if(r)r.value=n,i!==0&&this.touch(r,i);else{switch(r={key:t,value:n,next:void 0,previous:void 0},i){case 0:this.addItemLast(r);break;case 1:this.addItemFirst(r);break;case 2:this.addItemLast(r);break;default:this.addItemLast(r);break}this._map.set(t,r),this._size++}return this}delete(t){return!!this.remove(t)}remove(t){let n=this._map.get(t);if(n)return this._map.delete(t),this.removeItem(n),this._size--,n.value}shift(){if(!this._head&&!this._tail)return;if(!this._head||!this._tail)throw new Error("Invalid list");let t=this._head;return this._map.delete(t.key),this.removeItem(t),this._size--,t.value}forEach(t,n){let i=this._state,r=this._head;for(;r;){if(n?t.bind(n)(r.value,r.key,this):t(r.value,r.key,this),this._state!==i)throw new Error("LinkedMap got modified during iteration.");r=r.next}}keys(){let t=this,n=this._state,i=this._head,r={[Symbol.iterator](){return r},next(){if(t._state!==n)throw new Error("LinkedMap got modified during iteration.");if(i){let s={value:i.key,done:!1};return i=i.next,s}else return{value:void 0,done:!0}}};return r}values(){let t=this,n=this._state,i=this._head,r={[Symbol.iterator](){return r},next(){if(t._state!==n)throw new Error("LinkedMap got modified during iteration.");if(i){let s={value:i.value,done:!1};return i=i.next,s}else return{value:void 0,done:!0}}};return r}entries(){let t=this,n=this._state,i=this._head,r={[Symbol.iterator](){return r},next(){if(t._state!==n)throw new Error("LinkedMap got modified during iteration.");if(i){let s={value:[i.key,i.value],done:!1};return i=i.next,s}else return{value:void 0,done:!0}}};return r}[(zr=Symbol.toStringTag,Symbol.iterator)](){return this.entries()}trimOld(t){if(t>=this.size)return;if(t===0){this.clear();return}let n=this._head,i=this.size;for(;n&&i>t;)this._map.delete(n.key),n=n.next,i--;this._head=n,this._size=i,n&&(n.previous=void 0),this._state++}addItemFirst(t){if(!this._head&&!this._tail)this._tail=t;else if(this._head)t.next=this._head,this._head.previous=t;else throw new Error("Invalid list");this._head=t,this._state++}addItemLast(t){if(!this._head&&!this._tail)this._head=t;else if(this._tail)t.previous=this._tail,this._tail.next=t;else throw new Error("Invalid list");this._tail=t,this._state++}removeItem(t){if(t===this._head&&t===this._tail)this._head=void 0,this._tail=void 0;else if(t===this._head){if(!t.next)throw new Error("Invalid list");t.next.previous=void 0,this._head=t.next}else if(t===this._tail){if(!t.previous)throw new Error("Invalid list");t.previous.next=void 0,this._tail=t.previous}else{let n=t.next,i=t.previous;if(!n||!i)throw new Error("Invalid list");n.previous=i,i.next=n}t.next=void 0,t.previous=void 0,this._state++}touch(t,n){if(!this._head||!this._tail)throw new Error("Invalid list");if(!(n!==1&&n!==2)){if(n===1){if(t===this._head)return;let i=t.next,r=t.previous;t===this._tail?(r.next=void 0,this._tail=r):(i.previous=r,r.next=i),t.previous=void 0,t.next=this._head,this._head.previous=t,this._head=t,this._state++}else if(n===2){if(t===this._tail)return;let i=t.next,r=t.previous;t===this._head?(i.previous=void 0,this._head=i):(i.previous=r,r.next=i),t.next=void 0,t.previous=this._tail,this._tail.next=t,this._tail=t,this._state++}}}toJSON(){let t=[];return this.forEach((n,i)=>{t.push([i,n])}),t}fromJSON(t){this.clear();for(let[n,i]of t)this.set(n,i)}};var ft=class{constructor(){this.map=new Map}add(t,n){let i=this.map.get(t);i||(i=new Set,this.map.set(t,i)),i.add(n)}delete(t,n){let i=this.map.get(t);i&&(i.delete(n),i.size===0&&this.map.delete(t))}forEach(t,n){let i=this.map.get(t);i&&i.forEach(n)}get(t){let n=this.map.get(t);return n||new Set}};var mt;(function(e){function t(y){return y&&typeof y=="object"&&typeof y[Symbol.iterator]=="function"}e.is=t;let n=Object.freeze([]);function i(){return n}e.empty=i;function*r(y){yield y}e.single=r;function s(y){return t(y)?y:r(y)}e.wrap=s;function a(y){return y||n}e.from=a;function*l(y){for(let C=y.length-1;C>=0;C--)yield y[C]}e.reverse=l;function o(y){return!y||y[Symbol.iterator]().next().done===!0}e.isEmpty=o;function u(y){return y[Symbol.iterator]().next().value}e.first=u;function c(y,C){for(let E of y)if(C(E))return!0;return!1}e.some=c;function h(y,C){for(let E of y)if(C(E))return E}e.find=h;function*f(y,C){for(let E of y)C(E)&&(yield E)}e.filter=f;function*m(y,C){let E=0;for(let B of y)yield C(B,E++)}e.map=m;function*b(...y){for(let C of y)yield*C}e.concat=b;function p(y,C,E){let B=E;for(let v of y)B=C(B,v);return B}e.reduce=p;function*w(y,C,E=y.length){for(C<0&&(C+=y.length),E<0?E+=y.length:E>y.length&&(E=y.length);C<E;C++)yield y[C]}e.slice=w;function x(y,C=Number.POSITIVE_INFINITY){let E=[];if(C===0)return[E,y];let B=y[Symbol.iterator]();for(let v=0;v<C;v++){let g=B.next();if(g.done)return[E,e.empty()];E.push(g.value)}return[E,{[Symbol.iterator](){return B}}]}e.consume=x;async function _(y){let C=[];for await(let E of y)C.push(E);return Promise.resolve(C)}e.asyncToArray=_})(mt||(mt={}));var It=null,Hr=class e{constructor(){this.livingDisposables=new Map}static{this.idx=0}getDisposableData(t){let n=this.livingDisposables.get(t);return n||(n={parent:null,source:null,isSingleton:!1,value:t,idx:e.idx++},this.livingDisposables.set(t,n)),n}trackDisposable(t){let n=this.getDisposableData(t);n.source||(n.source=new Error().stack)}setParent(t,n){let i=this.getDisposableData(t);i.parent=n}markAsDisposed(t){this.livingDisposables.delete(t)}markAsSingleton(t){this.getDisposableData(t).isSingleton=!0}getRootParent(t,n){let i=n.get(t);if(i)return i;let r=t.parent?this.getRootParent(this.getDisposableData(t.parent),n):t;return n.set(t,r),r}getTrackedDisposables(){let t=new Map;return[...this.livingDisposables.entries()].filter(([,i])=>i.source!==null&&!this.getRootParent(i,t).isSingleton).flatMap(([i])=>i)}computeLeakingDisposables(t=10,n){let i;if(n)i=n;else{let o=new Map,u=[...this.livingDisposables.values()].filter(h=>h.source!==null&&!this.getRootParent(h,o).isSingleton);if(u.length===0)return;let c=new Set(u.map(h=>h.value));if(i=u.filter(h=>!(h.parent&&c.has(h.parent))),i.length===0)throw new Error("There are cyclic diposable chains!")}if(!i)return;function r(o){function u(h,f){for(;h.length>0&&f.some(m=>typeof m=="string"?m===h[0]:h[0].match(m));)h.shift()}let c=o.source.split(`
`).map(h=>h.trim().replace("at ","")).filter(h=>h!=="");return u(c,["Error",/^trackDisposable \(.*\)$/,/^DisposableTracker.trackDisposable \(.*\)$/]),c.reverse()}let s=new ft;for(let o of i){let u=r(o);for(let c=0;c<=u.length;c++)s.add(u.slice(0,c).join(`
`),o)}i.sort(rt(o=>o.idx,st));let a="",l=0;for(let o of i.slice(0,t)){l++;let u=r(o),c=[];for(let h=0;h<u.length;h++){let f=u[h];f=`(shared with ${s.get(u.slice(0,h+1).join(`
`)).size}/${i.length} leaks) at ${f}`;let b=s.get(u.slice(0,h).join(`
`)),p=Dr([...b].map(w=>r(w)[h]),w=>w);delete p[u[h]];for(let[w,x]of Object.entries(p))c.unshift(`    - stacktraces of ${x.length} other leaks continue with ${w}`);c.unshift(f)}a+=`
...
`),{leaks:i,details:a}}};function vi(e){return It?.trackDisposable(e),e}function _i(e){It?.markAsDisposed(e)}function bi(e,t){It?.setParent(e,t)}function el(e,t){if(It)for(let n of e)It.setParent(n,t)}function Wr(e){if(mt.is(e)){let t=[];for(let n of e)if(n)try{n.dispose()}catch(i){t.push(i)}if(t.length===1)throw t[0];if(t.length>1)throw new AggregateError(t,"Encountered errors while disposing of store");return Array.isArray(e)?[]:e}else if(e)return e.dispose(),e}function Br(...e){let t=gt(()=>Wr(e));return el(e,t),t}function gt(e){let t=vi({dispose:mi(()=>{_i(t),e()})});return t}var pt=class e{static{this.DISABLE_DISPOSED_WARNING=!1}constructor(){this._toDispose=new Set,this._isDisposed=!1,vi(this)}dispose(){this._isDisposed||(_i(this),this._isDisposed=!0,this.clear())}get isDisposed(){return this._isDisposed}clear(){if(this._toDispose.size!==0)try{Wr(this._toDispose)}finally{this._toDispose.clear()}}add(t){if(!t)return t;if(t===this)throw new Error("Cannot register a disposable on itself!");return bi(t,this),this._isDisposed?e.DISABLE_DISPOSED_WARNING||console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack):this._toDispose.add(t),t}delete(t){if(t){if(t===this)throw new Error("Cannot dispose a disposable on itself!");this._toDispose.delete(t),t.dispose()}}deleteAndLeak(t){t&&this._toDispose.has(t)&&(this._toDispose.delete(t),bi(t,null))}},ze=class{static{this.None=Object.freeze({dispose(){}})}constructor(){this._store=new pt,vi(this),bi(this._store,this)}dispose(){_i(this),this._store.dispose()}_register(t){if(t===this)throw new Error("Cannot register a disposable on itself!");return this._store.add(t)}};var ne=class e{static{this.Undefined=new e(void 0)}constructor(t){this.element=t,this.next=e.Undefined,this.prev=e.Undefined}},zt=class{constructor(){this._first=ne.Undefined,this._last=ne.Undefined,this._size=0}get size(){return this._size}isEmpty(){return this._first===ne.Undefined}clear(){let t=this._first;for(;t!==ne.Undefined;){let n=t.next;t.prev=ne.Undefined,t.next=ne.Undefined,t=n}this._first=ne.Undefined,this._last=ne.Undefined,this._size=0}unshift(t){return this._insert(t,!1)}push(t){return this._insert(t,!0)}_insert(t,n){let i=new ne(t);if(this._first===ne.Undefined)this._first=i,this._last=i;else if(n){let s=this._last;this._last=i,i.prev=s,s.next=i}else{let s=this._first;this._first=i,i.next=s,s.prev=i}this._size+=1;let r=!1;return()=>{r||(r=!0,this._remove(i))}}shift(){if(this._first!==ne.Undefined){let t=this._first.element;return this._remove(this._first),t}}pop(){if(this._last!==ne.Undefined){let t=this._last.element;return this._remove(this._last),t}}_remove(t){if(t.prev!==ne.Undefined&&t.next!==ne.Undefined){let n=t.prev;n.next=t.next,t.next.prev=n}else t.prev===ne.Undefined&&t.next===ne.Undefined?(this._first=ne.Undefined,this._last=ne.Undefined):t.next===ne.Undefined?(this._last=this._last.prev,this._last.next=ne.Undefined):t.prev===ne.Undefined&&(this._first=this._first.next,this._first.prev=ne.Undefined);this._size-=1}*[Symbol.iterator](){let t=this._first;for(;t!==ne.Undefined;)yield t.element,t=t.next}};var tl=globalThis.performance&&typeof globalThis.performance.now=="function",bt=class e{static create(t){return new e(t)}constructor(t){this._now=tl&&t===!1?Date.now:globalThis.performance.now.bind(globalThis.performance),this._startTime=this._now(),this._stopTime=-1}stop(){this._stopTime=this._now()}reset(){this._startTime=this._now(),this._stopTime=-1}elapsed(){return this._stopTime!==-1?this._stopTime-this._startTime:this._now()-this._startTime}};var cn;(function(e){e.None=()=>ze.None;function t(S,A){return h(S,()=>{},0,void 0,!0,void 0,A)}e.defer=t;function n(S){return(A,N=null,D)=>{let U=!1,W;return W=S(L=>{if(!U)return W?W.dispose():U=!0,A.call(N,L)},null,D),U&&W.dispose(),W}}e.once=n;function i(S,A,N){return u((D,U=null,W)=>S(L=>D.call(U,A(L)),null,W),N)}e.map=i;function r(S,A,N){return u((D,U=null,W)=>S(L=>{A(L),D.call(U,L)},null,W),N)}e.forEach=r;function s(S,A,N){return u((D,U=null,W)=>S(L=>A(L)&&D.call(U,L),null,W),N)}e.filter=s;function a(S){return S}e.signal=a;function l(...S){return(A,N=null,D)=>{let U=Br(...S.map(W=>W(L=>A.call(N,L))));return c(U,D)}}e.any=l;function o(S,A,N,D){let U=N;return i(S,W=>(U=A(U,W),U),D)}e.reduce=o;function u(S,A){let N,D={onWillAddFirstListener(){N=S(U.fire,U)},onDidRemoveLastListener(){N?.dispose()}},U=new de(D);return A?.add(U),U.event}function c(S,A){return A instanceof Array?A.push(S):A&&A.add(S),S}function h(S,A,N=100,D=!1,U=!1,W,L){let k,R,H,I=0,z,P={leakWarningThreshold:W,onWillAddFirstListener(){k=S(X=>{I++,R=A(R,X),D&&!H&&(G.fire(R),R=void 0),z=()=>{let Q=R;R=void 0,H=void 0,(!D||I>1)&&G.fire(Q),I=0},typeof N=="number"?(clearTimeout(H),H=setTimeout(z,N)):H===void 0&&(H=0,queueMicrotask(z))})},onWillRemoveListener(){U&&I>0&&z?.()},onDidRemoveLastListener(){z=void 0,k.dispose()}},G=new de(P);return L?.add(G),G.event}e.debounce=h;function f(S,A=0,N){return e.debounce(S,(D,U)=>D?(D.push(U),D):[U],A,void 0,!0,void 0,N)}e.accumulate=f;function m(S,A=(D,U)=>D===U,N){let D=!0,U;return s(S,W=>{let L=D||!A(W,U);return D=!1,U=W,L},N)}e.latch=m;function b(S,A,N){return[e.filter(S,A,N),e.filter(S,D=>!A(D),N)]}e.split=b;function p(S,A=!1,N=[],D){let U=N.slice(),W=S(R=>{U?U.push(R):k.fire(R)});D&&D.add(W);let L=()=>{U?.forEach(R=>k.fire(R)),U=null},k=new de({onWillAddFirstListener(){W||(W=S(R=>k.fire(R)),D&&D.add(W))},onDidAddFirstListener(){U&&(A?setTimeout(L):L())},onDidRemoveLastListener(){W&&W.dispose(),W=null}});return D&&D.add(k),k.event}e.buffer=p;function w(S,A){return(D,U,W)=>{let L=A(new _);return S(function(k){let R=L.evaluate(k);R!==x&&D.call(U,R)},void 0,W)}}e.chain=w;let x=Symbol("HaltChainable");class _{constructor(){this.steps=[]}map(A){return this.steps.push(A),this}forEach(A){return this.steps.push(N=>(A(N),N)),this}filter(A){return this.steps.push(N=>A(N)?N:x),this}reduce(A,N){let D=N;return this.steps.push(U=>(D=A(D,U),D)),this}latch(A=(N,D)=>N===D){let N=!0,D;return this.steps.push(U=>{let W=N||!A(U,D);return N=!1,D=U,W?U:x}),this}evaluate(A){for(let N of this.steps)if(A=N(A),A===x)break;return A}}function y(S,A,N=D=>D){let D=(...k)=>L.fire(N(...k)),U=()=>S.on(A,D),W=()=>S.removeListener(A,D),L=new de({onWillAddFirstListener:U,onDidRemoveLastListener:W});return L.event}e.fromNodeEventEmitter=y;function C(S,A,N=D=>D){let D=(...k)=>L.fire(N(...k)),U=()=>S.addEventListener(A,D),W=()=>S.removeEventListener(A,D),L=new de({onWillAddFirstListener:U,onDidRemoveLastListener:W});return L.event}e.fromDOMEventEmitter=C;function E(S){return new Promise(A=>n(S)(A))}e.toPromise=E;function B(S){let A=new de;return S.then(N=>{A.fire(N)},()=>{A.fire(void 0)}).finally(()=>{A.dispose()}),A.event}e.fromPromise=B;function v(S,A,N){return A(N),S(D=>A(D))}e.runAndSubscribe=v;class g{constructor(A,N){this._observable=A,this._counter=0,this._hasChanged=!1;let D={onWillAddFirstListener:()=>{A.addObserver(this)},onDidRemoveLastListener:()=>{A.removeObserver(this)}};this.emitter=new de(D),N&&N.add(this.emitter)}beginUpdate(A){this._counter++}handlePossibleChange(A){}handleChange(A,N){this._hasChanged=!0}endUpdate(A){this._counter--,this._counter===0&&(this._observable.reportChanges(),this._hasChanged&&(this._hasChanged=!1,this.emitter.fire(this._observable.get())))}}function T(S,A){return new g(S,A).emitter.event}e.fromObservable=T;function q(S){return(A,N,D)=>{let U=0,W=!1,L={beginUpdate(){U++},endUpdate(){U--,U===0&&(S.reportChanges(),W&&(W=!1,A.call(N)))},handlePossibleChange(){},handleChange(){W=!0}};S.addObserver(L),S.reportChanges();let k={dispose(){S.removeObserver(L)}};return D instanceof pt?D.add(k):Array.isArray(D)&&D.push(k),k}}e.fromObservableLight=q})(cn||(cn={}));var wi=class e{static{this.all=new Set}static{this._idPool=0}constructor(t){this.listenerCount=0,this.invocationCount=0,this.elapsedOverall=0,this.durations=[],this.name=`${t}_${e._idPool++}`,e.all.add(this)}start(t){this._stopWatch=new bt,this.listenerCount=t}stop(){if(this._stopWatch){let t=this._stopWatch.elapsed();this.durations.push(t),this.elapsedOverall+=t,this.invocationCount+=1,this._stopWatch=void 0}}},Pr=-1;var yi=class{constructor(t,n=Math.random().toString(18).slice(2,5)){this.threshold=t,this.name=n,this._warnCountdown=0}dispose(){this._stacks?.clear()}check(t,n){let i=this.threshold;if(i<=0||n<i)return;this._stacks||(this._stacks=new Map);let r=this._stacks.get(t.value)||0;if(this._stacks.set(t.value,r+1),this._warnCountdown-=1,this._warnCountdown<=0){this._warnCountdown=i*.5;let s,a=0;for(let[l,o]of this._stacks)(!s||a<o)&&(s=l,a=o);console.warn(`[${this.name}] potential listener LEAK detected, having ${n} listeners already. MOST frequent listener (${a}):`),console.warn(s)}return()=>{let s=this._stacks.get(t.value)||0;this._stacks.set(t.value,s-1)}}},xi=class e{static create(){return new e(new Error().stack??"")}constructor(t){this.value=t}print(){console.warn(this.value.split(`
`).slice(2).join(`
`))}},nl=0,Ut=class{constructor(t){this.value=t,this.id=nl++}},il=2;var de=class{constructor(t){this._size=0,this._options=t,this._leakageMon=Pr>0||this._options?.leakWarningThreshold?new yi(this._options?.leakWarningThreshold??Pr):void 0,this._perfMon=this._options?._profName?new wi(this._options._profName):void 0,this._deliveryQueue=this._options?.deliveryQueue}dispose(){this._disposed||(this._disposed=!0,this._deliveryQueue?.current===this&&this._deliveryQueue.reset(),this._listeners&&(this._listeners=void 0,this._size=0),this._options?.onDidRemoveLastListener?.(),this._leakageMon?.dispose())}get event(){return this._event??=(t,n,i)=>{if(this._leakageMon&&this._size>this._leakageMon.threshold*3)return console.warn(`[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far`),ze.None;if(this._disposed)return ze.None;n&&(t=t.bind(n));let r=new Ut(t),s;this._leakageMon&&this._size>=Math.ceil(this._leakageMon.threshold*.2)&&(r.stack=xi.create(),s=this._leakageMon.check(r.stack,this._size+1)),this._listeners?this._listeners instanceof Ut?(this._deliveryQueue??=new Ti,this._listeners=[this._listeners,r]):this._listeners.push(r):(this._options?.onWillAddFirstListener?.(this),this._listeners=r,this._options?.onDidAddFirstListener?.(this)),this._size++;let a=gt(()=>{s?.(),this._removeListener(r)});return i instanceof pt?i.add(a):Array.isArray(i)&&i.push(a),a},this._event}_removeListener(t){if(this._options?.onWillRemoveListener?.(this),!this._listeners)return;if(this._size===1){this._listeners=void 0,this._options?.onDidRemoveLastListener?.(this),this._size=0;return}let n=this._listeners,i=n.indexOf(t);if(i===-1)throw console.log("disposed?",this._disposed),console.log("size?",this._size),console.log("arr?",JSON.stringify(this._listeners)),new Error("Attempted to dispose unknown listener");this._size--,n[i]=void 0;let r=this._deliveryQueue.current===this;if(this._size*il<=n.length){let s=0;for(let a=0;a<n.length;a++)n[a]?n[s++]=n[a]:r&&(this._deliveryQueue.end--,s<this._deliveryQueue.i&&this._deliveryQueue.i--);n.length=s}}_deliver(t,n){if(!t)return;let i=this._options?.onListenerError||ln;if(!i){t.value(n);return}try{t.value(n)}catch(r){i(r)}}_deliverQueue(t){let n=t.current._listeners;for(;t.i<t.end;)this._deliver(n[t.i++],t.value);t.reset()}fire(t){if(this._deliveryQueue?.current&&(this._deliverQueue(this._deliveryQueue),this._perfMon?.stop()),this._perfMon?.start(this._size),this._listeners)if(this._listeners instanceof Ut)this._deliver(this._listeners,t);else{let n=this._deliveryQueue;n.enqueue(this,t,this._listeners.length),this._deliverQueue(n)}this._perfMon?.stop()}hasListeners(){return this._size>0}};var Ti=class{constructor(){this.i=-1,this.end=0}enqueue(t,n,i){this.i=0,this.end=i,this.current=t,this.value=n}reset(){this.i=this.end,this.current=void 0,this.value=void 0}};function qr(e){return typeof e=="string"}function rl(e){let t=[];for(;Object.prototype!==e;)t=t.concat(Object.getOwnPropertyNames(e)),e=Object.getPrototypeOf(e);return t}function Ft(e){let t=[];for(let n of rl(e))typeof e[n]=="function"&&t.push(n);return t}function Or(e,t){let n=r=>function(){let s=Array.prototype.slice.call(arguments,0);return t(r,s)},i={};for(let r of e)i[r]=n(r);return i}var sl=typeof document<"u"&&document.location&&document.location.hash.indexOf("pseudo=true")>=0;function al(e,t){let n;return t.length===0?n=e:n=e.replace(/\{(\d+)\}/g,(i,r)=>{let s=r[0],a=t[s],l=i;return typeof a=="string"?l=a:(typeof a=="number"||typeof a=="boolean"||a===void 0||a===null)&&(l=String(a)),l}),sl&&(n="\uFF3B"+n.replace(/[aouei]/g,"$&$&")+"\uFF3D"),n}var ol=!1,ll,ul={};function ee(e,t,n,...i){ol=!0;let r=typeof t=="object"?t.key:t,s=(ul[e]??{})[r]??n;return al(s,i)}function Vr(e){return ll}var vt="en",fn=!1,mn=!1,ki=!1,cl=!1,Jr=!1,hl=!1,dl=!1,fl=!1,hn,dn=vt,jr=vt,Ue,Fe=globalThis,Te;typeof Fe.vscode<"u"&&typeof Fe.vscode.process<"u"?Te=Fe.vscode.process:typeof process<"u"&&(Te=process);var ml=typeof Te?.versions?.electron=="string",pl=ml&&Te?.type==="renderer";if(typeof Te=="object"){fn=Te.platform==="win32",mn=Te.platform==="darwin",ki=Te.platform==="linux",dl=!!Te.env.CI||!!Te.env.BUILD_ARTIFACTSTAGINGDIRECTORY,hn=vt,dn=vt;let e=Te.env.VSCODE_NLS_CONFIG;if(e)try{let t=JSON.parse(e),n=t.availableLanguages["*"];hn=t.locale,jr=t.osLocale,dn=n||vt}catch{}cl=!0}else typeof navigator=="object"&&!pl?(Ue=navigator.userAgent,fn=Ue.indexOf("Windows")>=0,mn=Ue.indexOf("Macintosh")>=0,hl=(Ue.indexOf("Macintosh")>=0||Ue.indexOf("iPad")>=0||Ue.indexOf("iPhone")>=0)&&!!navigator.maxTouchPoints&&navigator.maxTouchPoints>0,ki=Ue.indexOf("Linux")>=0,fl=Ue?.indexOf("Mobi")>=0,Jr=!0,hn=Vr(ee("vs/base/common/platform",{key:"ensureLoaderPluginIsLoaded",comment:["{Locked}"]},"_"))||vt,dn=hn,jr=navigator.language):console.error("Unable to resolve platform.");var Gr;(function(e){e[e.Web=0]="Web",e[e.Mac=1]="Mac",e[e.Linux=2]="Linux",e[e.Windows=3]="Windows"})(Gr||(Gr={}));var Ai=0;mn?Ai=1:fn?Ai=3:ki&&(Ai=2);var at=fn,Xr=mn;var gl=Jr&&typeof Fe.importScripts=="function",hh=gl?Fe.origin:void 0;var Ee=Ue,Be=dn,$r;(function(e){function t(){return Be}e.value=t;function n(){return Be.length===2?Be==="en":Be.length>=3?Be[0]==="e"&&Be[1]==="n"&&Be[2]==="-":!1}e.isDefaultVariant=n;function i(){return Be==="en"}e.isDefault=i})($r||($r={}));var bl=typeof Fe.postMessage=="function"&&!Fe.importScripts,dh=(()=>{if(bl){let e=[];Fe.addEventListener("message",n=>{if(n.data&&n.data.vscodeScheduleAsyncWork)for(let i=0,r=e.length;i<r;i++){let s=e[i];if(s.id===n.data.vscodeScheduleAsyncWork){e.splice(i,1),s.callback();return}}});let t=0;return n=>{let i=++t;e.push({id:i,callback:n}),Fe.postMessage({vscodeScheduleAsyncWork:i},"*")}}return e=>setTimeout(e)})(),Qr;(function(e){e[e.Windows=1]="Windows",e[e.Macintosh=2]="Macintosh",e[e.Linux=3]="Linux"})(Qr||(Qr={}));var vl=!!(Ee&&Ee.indexOf("Chrome")>=0),fh=!!(Ee&&Ee.indexOf("Firefox")>=0),mh=!!(!vl&&Ee&&Ee.indexOf("Safari")>=0),ph=!!(Ee&&Ee.indexOf("Edg/")>=0),gh=!!(Ee&&Ee.indexOf("Android")>=0);var Yr=Object.freeze(function(e,t){let n=setTimeout(e.bind(t),0);return{dispose(){clearTimeout(n)}}}),pn;(function(e){function t(n){return n===e.None||n===e.Cancelled||n instanceof _t?!0:!n||typeof n!="object"?!1:typeof n.isCancellationRequested=="boolean"&&typeof n.onCancellationRequested=="function"}e.isCancellationToken=t,e.None=Object.freeze({isCancellationRequested:!1,onCancellationRequested:cn.None}),e.Cancelled=Object.freeze({isCancellationRequested:!0,onCancellationRequested:Yr})})(pn||(pn={}));var _t=class{constructor(){this._isCancelled=!1,this._emitter=null}cancel(){this._isCancelled||(this._isCancelled=!0,this._emitter&&(this._emitter.fire(void 0),this.dispose()))}get isCancellationRequested(){return this._isCancelled}get onCancellationRequested(){return this._isCancelled?Yr:(this._emitter||(this._emitter=new de),this._emitter.event)}dispose(){this._emitter&&(this._emitter.dispose(),this._emitter=null)}},Ht=class{constructor(t){this._token=void 0,this._parentListener=void 0,this._parentListener=t&&t.onCancellationRequested(this.cancel,this)}get token(){return this._token||(this._token=new _t),this._token}cancel(){this._token?this._token instanceof _t&&this._token.cancel():this._token=pn.Cancelled}dispose(t=!1){t&&this.cancel(),this._parentListener?.dispose(),this._token?this._token instanceof _t&&this._token.dispose():this._token=pn.None}};var gn=class{constructor(t){this.fn=t,this.lastCache=void 0,this.lastArgKey=void 0}get(t){let n=JSON.stringify(t);return this.lastArgKey!==n&&(this.lastArgKey=n,this.lastCache=this.fn(t)),this.lastCache}};var Wt=class{constructor(t){this.executor=t,this._didRun=!1}get hasValue(){return this._didRun}get value(){if(!this._didRun)try{this._value=this.executor()}catch(t){this._error=t}finally{this._didRun=!0}if(this._error)throw this._error;return this._value}get rawValue(){return this._value}};function Kr(e){return e.replace(/[\\\{\}\*\+\?\|\^\$\.\[\]\(\)]/g,"\\$&")}function es(e){return e.split(/\r\n|\r|\n/)}function ts(e){for(let t=0,n=e.length;t<n;t++){let i=e.charCodeAt(t);if(i!==32&&i!==9)return t}return-1}function ns(e,t=e.length-1){for(let n=t;n>=0;n--){let i=e.charCodeAt(n);if(i!==32&&i!==9)return n}return-1}function Si(e){return e>=65&&e<=90}function xt(e){return 55296<=e&&e<=56319}function bn(e){return 56320<=e&&e<=57343}function Li(e,t){return(e-55296<<10)+(t-56320)+65536}function is(e,t,n){let i=e.charCodeAt(n);if(xt(i)&&n+1<t){let r=e.charCodeAt(n+1);if(bn(r))return Li(i,r)}return i}var _l=/^[\t\n\r\x20-\x7E]*$/;function rs(e){return _l.test(e)}var Zr=class e{static{this._INSTANCE=null}static getInstance(){return e._INSTANCE||(e._INSTANCE=new e),e._INSTANCE}constructor(){this._data=wl()}getGraphemeBreakType(t){if(t<32)return t===10?3:t===13?2:4;if(t<127)return 0;let n=this._data,i=n.length/3,r=1;for(;r<=i;)if(t<n[3*r])r=2*r;else if(t>n[3*r+1])r=2*r+1;else return n[3*r+2];return 0}};function wl(){return JSON.parse("[0,0,0,51229,51255,12,44061,44087,12,127462,127487,6,7083,7085,5,47645,47671,12,54813,54839,12,128678,128678,14,3270,3270,5,9919,9923,14,45853,45879,12,49437,49463,12,53021,53047,12,71216,71218,7,128398,128399,14,129360,129374,14,2519,2519,5,4448,4519,9,9742,9742,14,12336,12336,14,44957,44983,12,46749,46775,12,48541,48567,12,50333,50359,12,52125,52151,12,53917,53943,12,69888,69890,5,73018,73018,5,127990,127990,14,128558,128559,14,128759,128760,14,129653,129655,14,2027,2035,5,2891,2892,7,3761,3761,5,6683,6683,5,8293,8293,4,9825,9826,14,9999,9999,14,43452,43453,5,44509,44535,12,45405,45431,12,46301,46327,12,47197,47223,12,48093,48119,12,48989,49015,12,49885,49911,12,50781,50807,12,51677,51703,12,52573,52599,12,53469,53495,12,54365,54391,12,65279,65279,4,70471,70472,7,72145,72147,7,119173,119179,5,127799,127818,14,128240,128244,14,128512,128512,14,128652,128652,14,128721,128722,14,129292,129292,14,129445,129450,14,129734,129743,14,1476,1477,5,2366,2368,7,2750,2752,7,3076,3076,5,3415,3415,5,4141,4144,5,6109,6109,5,6964,6964,5,7394,7400,5,9197,9198,14,9770,9770,14,9877,9877,14,9968,9969,14,10084,10084,14,43052,43052,5,43713,43713,5,44285,44311,12,44733,44759,12,45181,45207,12,45629,45655,12,46077,46103,12,46525,46551,12,46973,46999,12,47421,47447,12,47869,47895,12,48317,48343,12,48765,48791,12,49213,49239,12,49661,49687,12,50109,50135,12,50557,50583,12,51005,51031,12,51453,51479,12,51901,51927,12,52349,52375,12,52797,52823,12,53245,53271,12,53693,53719,12,54141,54167,12,54589,54615,12,55037,55063,12,69506,69509,5,70191,70193,5,70841,70841,7,71463,71467,5,72330,72342,5,94031,94031,5,123628,123631,5,127763,127765,14,127941,127941,14,128043,128062,14,128302,128317,14,128465,128467,14,128539,128539,14,128640,128640,14,128662,128662,14,128703,128703,14,128745,128745,14,129004,129007,14,129329,129330,14,129402,129402,14,129483,129483,14,129686,129704,14,130048,131069,14,173,173,4,1757,1757,1,2200,2207,5,2434,2435,7,2631,2632,5,2817,2817,5,3008,3008,5,3201,3201,5,3387,3388,5,3542,3542,5,3902,3903,7,4190,4192,5,6002,6003,5,6439,6440,5,6765,6770,7,7019,7027,5,7154,7155,7,8205,8205,13,8505,8505,14,9654,9654,14,9757,9757,14,9792,9792,14,9852,9853,14,9890,9894,14,9937,9937,14,9981,9981,14,10035,10036,14,11035,11036,14,42654,42655,5,43346,43347,7,43587,43587,5,44006,44007,7,44173,44199,12,44397,44423,12,44621,44647,12,44845,44871,12,45069,45095,12,45293,45319,12,45517,45543,12,45741,45767,12,45965,45991,12,46189,46215,12,46413,46439,12,46637,46663,12,46861,46887,12,47085,47111,12,47309,47335,12,47533,47559,12,47757,47783,12,47981,48007,12,48205,48231,12,48429,48455,12,48653,48679,12,48877,48903,12,49101,49127,12,49325,49351,12,49549,49575,12,49773,49799,12,49997,50023,12,50221,50247,12,50445,50471,12,50669,50695,12,50893,50919,12,51117,51143,12,51341,51367,12,51565,51591,12,51789,51815,12,52013,52039,12,52237,52263,12,52461,52487,12,52685,52711,12,52909,52935,12,53133,53159,12,53357,53383,12,53581,53607,12,53805,53831,12,54029,54055,12,54253,54279,12,54477,54503,12,54701,54727,12,54925,54951,12,55149,55175,12,68101,68102,5,69762,69762,7,70067,70069,7,70371,70378,5,70720,70721,7,71087,71087,5,71341,71341,5,71995,71996,5,72249,72249,7,72850,72871,5,73109,73109,5,118576,118598,5,121505,121519,5,127245,127247,14,127568,127569,14,127777,127777,14,127872,127891,14,127956,127967,14,128015,128016,14,128110,128172,14,128259,128259,14,128367,128368,14,128424,128424,14,128488,128488,14,128530,128532,14,128550,128551,14,128566,128566,14,128647,128647,14,128656,128656,14,128667,128673,14,128691,128693,14,128715,128715,14,128728,128732,14,128752,128752,14,128765,128767,14,129096,129103,14,129311,129311,14,129344,129349,14,129394,129394,14,129413,129425,14,129466,129471,14,129511,129535,14,129664,129666,14,129719,129722,14,129760,129767,14,917536,917631,5,13,13,2,1160,1161,5,1564,1564,4,1807,1807,1,2085,2087,5,2307,2307,7,2382,2383,7,2497,2500,5,2563,2563,7,2677,2677,5,2763,2764,7,2879,2879,5,2914,2915,5,3021,3021,5,3142,3144,5,3263,3263,5,3285,3286,5,3398,3400,7,3530,3530,5,3633,3633,5,3864,3865,5,3974,3975,5,4155,4156,7,4229,4230,5,5909,5909,7,6078,6085,7,6277,6278,5,6451,6456,7,6744,6750,5,6846,6846,5,6972,6972,5,7074,7077,5,7146,7148,7,7222,7223,5,7416,7417,5,8234,8238,4,8417,8417,5,9000,9000,14,9203,9203,14,9730,9731,14,9748,9749,14,9762,9763,14,9776,9783,14,9800,9811,14,9831,9831,14,9872,9873,14,9882,9882,14,9900,9903,14,9929,9933,14,9941,9960,14,9974,9974,14,9989,9989,14,10006,10006,14,10062,10062,14,10160,10160,14,11647,11647,5,12953,12953,14,43019,43019,5,43232,43249,5,43443,43443,5,43567,43568,7,43696,43696,5,43765,43765,7,44013,44013,5,44117,44143,12,44229,44255,12,44341,44367,12,44453,44479,12,44565,44591,12,44677,44703,12,44789,44815,12,44901,44927,12,45013,45039,12,45125,45151,12,45237,45263,12,45349,45375,12,45461,45487,12,45573,45599,12,45685,45711,12,45797,45823,12,45909,45935,12,46021,46047,12,46133,46159,12,46245,46271,12,46357,46383,12,46469,46495,12,46581,46607,12,46693,46719,12,46805,46831,12,46917,46943,12,47029,47055,12,47141,47167,12,47253,47279,12,47365,47391,12,47477,47503,12,47589,47615,12,47701,47727,12,47813,47839,12,47925,47951,12,48037,48063,12,48149,48175,12,48261,48287,12,48373,48399,12,48485,48511,12,48597,48623,12,48709,48735,12,48821,48847,12,48933,48959,12,49045,49071,12,49157,49183,12,49269,49295,12,49381,49407,12,49493,49519,12,49605,49631,12,49717,49743,12,49829,49855,12,49941,49967,12,50053,50079,12,50165,50191,12,50277,50303,12,50389,50415,12,50501,50527,12,50613,50639,12,50725,50751,12,50837,50863,12,50949,50975,12,51061,51087,12,51173,51199,12,51285,51311,12,51397,51423,12,51509,51535,12,51621,51647,12,51733,51759,12,51845,51871,12,51957,51983,12,52069,52095,12,52181,52207,12,52293,52319,12,52405,52431,12,52517,52543,12,52629,52655,12,52741,52767,12,52853,52879,12,52965,52991,12,53077,53103,12,53189,53215,12,53301,53327,12,53413,53439,12,53525,53551,12,53637,53663,12,53749,53775,12,53861,53887,12,53973,53999,12,54085,54111,12,54197,54223,12,54309,54335,12,54421,54447,12,54533,54559,12,54645,54671,12,54757,54783,12,54869,54895,12,54981,55007,12,55093,55119,12,55243,55291,10,66045,66045,5,68325,68326,5,69688,69702,5,69817,69818,5,69957,69958,7,70089,70092,5,70198,70199,5,70462,70462,5,70502,70508,5,70750,70750,5,70846,70846,7,71100,71101,5,71230,71230,7,71351,71351,5,71737,71738,5,72000,72000,7,72160,72160,5,72273,72278,5,72752,72758,5,72882,72883,5,73031,73031,5,73461,73462,7,94192,94193,7,119149,119149,7,121403,121452,5,122915,122916,5,126980,126980,14,127358,127359,14,127535,127535,14,127759,127759,14,127771,127771,14,127792,127793,14,127825,127867,14,127897,127899,14,127945,127945,14,127985,127986,14,128000,128007,14,128021,128021,14,128066,128100,14,128184,128235,14,128249,128252,14,128266,128276,14,128335,128335,14,128379,128390,14,128407,128419,14,128444,128444,14,128481,128481,14,128499,128499,14,128526,128526,14,128536,128536,14,128543,128543,14,128556,128556,14,128564,128564,14,128577,128580,14,128643,128645,14,128649,128649,14,128654,128654,14,128660,128660,14,128664,128664,14,128675,128675,14,128686,128689,14,128695,128696,14,128705,128709,14,128717,128719,14,128725,128725,14,128736,128741,14,128747,128748,14,128755,128755,14,128762,128762,14,128981,128991,14,129009,129023,14,129160,129167,14,129296,129304,14,129320,129327,14,129340,129342,14,129356,129356,14,129388,129392,14,129399,129400,14,129404,129407,14,129432,129442,14,129454,129455,14,129473,129474,14,129485,129487,14,129648,129651,14,129659,129660,14,129671,129679,14,129709,129711,14,129728,129730,14,129751,129753,14,129776,129782,14,917505,917505,4,917760,917999,5,10,10,3,127,159,4,768,879,5,1471,1471,5,1536,1541,1,1648,1648,5,1767,1768,5,1840,1866,5,2070,2073,5,2137,2139,5,2274,2274,1,2363,2363,7,2377,2380,7,2402,2403,5,2494,2494,5,2507,2508,7,2558,2558,5,2622,2624,7,2641,2641,5,2691,2691,7,2759,2760,5,2786,2787,5,2876,2876,5,2881,2884,5,2901,2902,5,3006,3006,5,3014,3016,7,3072,3072,5,3134,3136,5,3157,3158,5,3260,3260,5,3266,3266,5,3274,3275,7,3328,3329,5,3391,3392,7,3405,3405,5,3457,3457,5,3536,3537,7,3551,3551,5,3636,3642,5,3764,3772,5,3895,3895,5,3967,3967,7,3993,4028,5,4146,4151,5,4182,4183,7,4226,4226,5,4253,4253,5,4957,4959,5,5940,5940,7,6070,6070,7,6087,6088,7,6158,6158,4,6432,6434,5,6448,6449,7,6679,6680,5,6742,6742,5,6754,6754,5,6783,6783,5,6912,6915,5,6966,6970,5,6978,6978,5,7042,7042,7,7080,7081,5,7143,7143,7,7150,7150,7,7212,7219,5,7380,7392,5,7412,7412,5,8203,8203,4,8232,8232,4,8265,8265,14,8400,8412,5,8421,8432,5,8617,8618,14,9167,9167,14,9200,9200,14,9410,9410,14,9723,9726,14,9733,9733,14,9745,9745,14,9752,9752,14,9760,9760,14,9766,9766,14,9774,9774,14,9786,9786,14,9794,9794,14,9823,9823,14,9828,9828,14,9833,9850,14,9855,9855,14,9875,9875,14,9880,9880,14,9885,9887,14,9896,9897,14,9906,9916,14,9926,9927,14,9935,9935,14,9939,9939,14,9962,9962,14,9972,9972,14,9978,9978,14,9986,9986,14,9997,9997,14,10002,10002,14,10017,10017,14,10055,10055,14,10071,10071,14,10133,10135,14,10548,10549,14,11093,11093,14,12330,12333,5,12441,12442,5,42608,42610,5,43010,43010,5,43045,43046,5,43188,43203,7,43302,43309,5,43392,43394,5,43446,43449,5,43493,43493,5,43571,43572,7,43597,43597,7,43703,43704,5,43756,43757,5,44003,44004,7,44009,44010,7,44033,44059,12,44089,44115,12,44145,44171,12,44201,44227,12,44257,44283,12,44313,44339,12,44369,44395,12,44425,44451,12,44481,44507,12,44537,44563,12,44593,44619,12,44649,44675,12,44705,44731,12,44761,44787,12,44817,44843,12,44873,44899,12,44929,44955,12,44985,45011,12,45041,45067,12,45097,45123,12,45153,45179,12,45209,45235,12,45265,45291,12,45321,45347,12,45377,45403,12,45433,45459,12,45489,45515,12,45545,45571,12,45601,45627,12,45657,45683,12,45713,45739,12,45769,45795,12,45825,45851,12,45881,45907,12,45937,45963,12,45993,46019,12,46049,46075,12,46105,46131,12,46161,46187,12,46217,46243,12,46273,46299,12,46329,46355,12,46385,46411,12,46441,46467,12,46497,46523,12,46553,46579,12,46609,46635,12,46665,46691,12,46721,46747,12,46777,46803,12,46833,46859,12,46889,46915,12,46945,46971,12,47001,47027,12,47057,47083,12,47113,47139,12,47169,47195,12,47225,47251,12,47281,47307,12,47337,47363,12,47393,47419,12,47449,47475,12,47505,47531,12,47561,47587,12,47617,47643,12,47673,47699,12,47729,47755,12,47785,47811,12,47841,47867,12,47897,47923,12,47953,47979,12,48009,48035,12,48065,48091,12,48121,48147,12,48177,48203,12,48233,48259,12,48289,48315,12,48345,48371,12,48401,48427,12,48457,48483,12,48513,48539,12,48569,48595,12,48625,48651,12,48681,48707,12,48737,48763,12,48793,48819,12,48849,48875,12,48905,48931,12,48961,48987,12,49017,49043,12,49073,49099,12,49129,49155,12,49185,49211,12,49241,49267,12,49297,49323,12,49353,49379,12,49409,49435,12,49465,49491,12,49521,49547,12,49577,49603,12,49633,49659,12,49689,49715,12,49745,49771,12,49801,49827,12,49857,49883,12,49913,49939,12,49969,49995,12,50025,50051,12,50081,50107,12,50137,50163,12,50193,50219,12,50249,50275,12,50305,50331,12,50361,50387,12,50417,50443,12,50473,50499,12,50529,50555,12,50585,50611,12,50641,50667,12,50697,50723,12,50753,50779,12,50809,50835,12,50865,50891,12,50921,50947,12,50977,51003,12,51033,51059,12,51089,51115,12,51145,51171,12,51201,51227,12,51257,51283,12,51313,51339,12,51369,51395,12,51425,51451,12,51481,51507,12,51537,51563,12,51593,51619,12,51649,51675,12,51705,51731,12,51761,51787,12,51817,51843,12,51873,51899,12,51929,51955,12,51985,52011,12,52041,52067,12,52097,52123,12,52153,52179,12,52209,52235,12,52265,52291,12,52321,52347,12,52377,52403,12,52433,52459,12,52489,52515,12,52545,52571,12,52601,52627,12,52657,52683,12,52713,52739,12,52769,52795,12,52825,52851,12,52881,52907,12,52937,52963,12,52993,53019,12,53049,53075,12,53105,53131,12,53161,53187,12,53217,53243,12,53273,53299,12,53329,53355,12,53385,53411,12,53441,53467,12,53497,53523,12,53553,53579,12,53609,53635,12,53665,53691,12,53721,53747,12,53777,53803,12,53833,53859,12,53889,53915,12,53945,53971,12,54001,54027,12,54057,54083,12,54113,54139,12,54169,54195,12,54225,54251,12,54281,54307,12,54337,54363,12,54393,54419,12,54449,54475,12,54505,54531,12,54561,54587,12,54617,54643,12,54673,54699,12,54729,54755,12,54785,54811,12,54841,54867,12,54897,54923,12,54953,54979,12,55009,55035,12,55065,55091,12,55121,55147,12,55177,55203,12,65024,65039,5,65520,65528,4,66422,66426,5,68152,68154,5,69291,69292,5,69633,69633,5,69747,69748,5,69811,69814,5,69826,69826,5,69932,69932,7,70016,70017,5,70079,70080,7,70095,70095,5,70196,70196,5,70367,70367,5,70402,70403,7,70464,70464,5,70487,70487,5,70709,70711,7,70725,70725,7,70833,70834,7,70843,70844,7,70849,70849,7,71090,71093,5,71103,71104,5,71227,71228,7,71339,71339,5,71344,71349,5,71458,71461,5,71727,71735,5,71985,71989,7,71998,71998,5,72002,72002,7,72154,72155,5,72193,72202,5,72251,72254,5,72281,72283,5,72344,72345,5,72766,72766,7,72874,72880,5,72885,72886,5,73023,73029,5,73104,73105,5,73111,73111,5,92912,92916,5,94095,94098,5,113824,113827,4,119142,119142,7,119155,119162,4,119362,119364,5,121476,121476,5,122888,122904,5,123184,123190,5,125252,125258,5,127183,127183,14,127340,127343,14,127377,127386,14,127491,127503,14,127548,127551,14,127744,127756,14,127761,127761,14,127769,127769,14,127773,127774,14,127780,127788,14,127796,127797,14,127820,127823,14,127869,127869,14,127894,127895,14,127902,127903,14,127943,127943,14,127947,127950,14,127972,127972,14,127988,127988,14,127992,127994,14,128009,128011,14,128019,128019,14,128023,128041,14,128064,128064,14,128102,128107,14,128174,128181,14,128238,128238,14,128246,128247,14,128254,128254,14,128264,128264,14,128278,128299,14,128329,128330,14,128348,128359,14,128371,128377,14,128392,128393,14,128401,128404,14,128421,128421,14,128433,128434,14,128450,128452,14,128476,128478,14,128483,128483,14,128495,128495,14,128506,128506,14,128519,128520,14,128528,128528,14,128534,128534,14,128538,128538,14,128540,128542,14,128544,128549,14,128552,128555,14,128557,128557,14,128560,128563,14,128565,128565,14,128567,128576,14,128581,128591,14,128641,128642,14,128646,128646,14,128648,128648,14,128650,128651,14,128653,128653,14,128655,128655,14,128657,128659,14,128661,128661,14,128663,128663,14,128665,128666,14,128674,128674,14,128676,128677,14,128679,128685,14,128690,128690,14,128694,128694,14,128697,128702,14,128704,128704,14,128710,128714,14,128716,128716,14,128720,128720,14,128723,128724,14,128726,128727,14,128733,128735,14,128742,128744,14,128746,128746,14,128749,128751,14,128753,128754,14,128756,128758,14,128761,128761,14,128763,128764,14,128884,128895,14,128992,129003,14,129008,129008,14,129036,129039,14,129114,129119,14,129198,129279,14,129293,129295,14,129305,129310,14,129312,129319,14,129328,129328,14,129331,129338,14,129343,129343,14,129351,129355,14,129357,129359,14,129375,129387,14,129393,129393,14,129395,129398,14,129401,129401,14,129403,129403,14,129408,129412,14,129426,129431,14,129443,129444,14,129451,129453,14,129456,129465,14,129472,129472,14,129475,129482,14,129484,129484,14,129488,129510,14,129536,129647,14,129652,129652,14,129656,129658,14,129661,129663,14,129667,129670,14,129680,129685,14,129705,129708,14,129712,129718,14,129723,129727,14,129731,129733,14,129744,129750,14,129754,129759,14,129768,129775,14,129783,129791,14,917504,917504,4,917506,917535,4,917632,917759,4,918000,921599,4,0,9,4,11,12,4,14,31,4,169,169,14,174,174,14,1155,1159,5,1425,1469,5,1473,1474,5,1479,1479,5,1552,1562,5,1611,1631,5,1750,1756,5,1759,1764,5,1770,1773,5,1809,1809,5,1958,1968,5,2045,2045,5,2075,2083,5,2089,2093,5,2192,2193,1,2250,2273,5,2275,2306,5,2362,2362,5,2364,2364,5,2369,2376,5,2381,2381,5,2385,2391,5,2433,2433,5,2492,2492,5,2495,2496,7,2503,2504,7,2509,2509,5,2530,2531,5,2561,2562,5,2620,2620,5,2625,2626,5,2635,2637,5,2672,2673,5,2689,2690,5,2748,2748,5,2753,2757,5,2761,2761,7,2765,2765,5,2810,2815,5,2818,2819,7,2878,2878,5,2880,2880,7,2887,2888,7,2893,2893,5,2903,2903,5,2946,2946,5,3007,3007,7,3009,3010,7,3018,3020,7,3031,3031,5,3073,3075,7,3132,3132,5,3137,3140,7,3146,3149,5,3170,3171,5,3202,3203,7,3262,3262,7,3264,3265,7,3267,3268,7,3271,3272,7,3276,3277,5,3298,3299,5,3330,3331,7,3390,3390,5,3393,3396,5,3402,3404,7,3406,3406,1,3426,3427,5,3458,3459,7,3535,3535,5,3538,3540,5,3544,3550,7,3570,3571,7,3635,3635,7,3655,3662,5,3763,3763,7,3784,3789,5,3893,3893,5,3897,3897,5,3953,3966,5,3968,3972,5,3981,3991,5,4038,4038,5,4145,4145,7,4153,4154,5,4157,4158,5,4184,4185,5,4209,4212,5,4228,4228,7,4237,4237,5,4352,4447,8,4520,4607,10,5906,5908,5,5938,5939,5,5970,5971,5,6068,6069,5,6071,6077,5,6086,6086,5,6089,6099,5,6155,6157,5,6159,6159,5,6313,6313,5,6435,6438,7,6441,6443,7,6450,6450,5,6457,6459,5,6681,6682,7,6741,6741,7,6743,6743,7,6752,6752,5,6757,6764,5,6771,6780,5,6832,6845,5,6847,6862,5,6916,6916,7,6965,6965,5,6971,6971,7,6973,6977,7,6979,6980,7,7040,7041,5,7073,7073,7,7078,7079,7,7082,7082,7,7142,7142,5,7144,7145,5,7149,7149,5,7151,7153,5,7204,7211,7,7220,7221,7,7376,7378,5,7393,7393,7,7405,7405,5,7415,7415,7,7616,7679,5,8204,8204,5,8206,8207,4,8233,8233,4,8252,8252,14,8288,8292,4,8294,8303,4,8413,8416,5,8418,8420,5,8482,8482,14,8596,8601,14,8986,8987,14,9096,9096,14,9193,9196,14,9199,9199,14,9201,9202,14,9208,9210,14,9642,9643,14,9664,9664,14,9728,9729,14,9732,9732,14,9735,9741,14,9743,9744,14,9746,9746,14,9750,9751,14,9753,9756,14,9758,9759,14,9761,9761,14,9764,9765,14,9767,9769,14,9771,9773,14,9775,9775,14,9784,9785,14,9787,9791,14,9793,9793,14,9795,9799,14,9812,9822,14,9824,9824,14,9827,9827,14,9829,9830,14,9832,9832,14,9851,9851,14,9854,9854,14,9856,9861,14,9874,9874,14,9876,9876,14,9878,9879,14,9881,9881,14,9883,9884,14,9888,9889,14,9895,9895,14,9898,9899,14,9904,9905,14,9917,9918,14,9924,9925,14,9928,9928,14,9934,9934,14,9936,9936,14,9938,9938,14,9940,9940,14,9961,9961,14,9963,9967,14,9970,9971,14,9973,9973,14,9975,9977,14,9979,9980,14,9982,9985,14,9987,9988,14,9992,9996,14,9998,9998,14,10000,10001,14,10004,10004,14,10013,10013,14,10024,10024,14,10052,10052,14,10060,10060,14,10067,10069,14,10083,10083,14,10085,10087,14,10145,10145,14,10175,10175,14,11013,11015,14,11088,11088,14,11503,11505,5,11744,11775,5,12334,12335,5,12349,12349,14,12951,12951,14,42607,42607,5,42612,42621,5,42736,42737,5,43014,43014,5,43043,43044,7,43047,43047,7,43136,43137,7,43204,43205,5,43263,43263,5,43335,43345,5,43360,43388,8,43395,43395,7,43444,43445,7,43450,43451,7,43454,43456,7,43561,43566,5,43569,43570,5,43573,43574,5,43596,43596,5,43644,43644,5,43698,43700,5,43710,43711,5,43755,43755,7,43758,43759,7,43766,43766,5,44005,44005,5,44008,44008,5,44012,44012,7,44032,44032,11,44060,44060,11,44088,44088,11,44116,44116,11,44144,44144,11,44172,44172,11,44200,44200,11,44228,44228,11,44256,44256,11,44284,44284,11,44312,44312,11,44340,44340,11,44368,44368,11,44396,44396,11,44424,44424,11,44452,44452,11,44480,44480,11,44508,44508,11,44536,44536,11,44564,44564,11,44592,44592,11,44620,44620,11,44648,44648,11,44676,44676,11,44704,44704,11,44732,44732,11,44760,44760,11,44788,44788,11,44816,44816,11,44844,44844,11,44872,44872,11,44900,44900,11,44928,44928,11,44956,44956,11,44984,44984,11,45012,45012,11,45040,45040,11,45068,45068,11,45096,45096,11,45124,45124,11,45152,45152,11,45180,45180,11,45208,45208,11,45236,45236,11,45264,45264,11,45292,45292,11,45320,45320,11,45348,45348,11,45376,45376,11,45404,45404,11,45432,45432,11,45460,45460,11,45488,45488,11,45516,45516,11,45544,45544,11,45572,45572,11,45600,45600,11,45628,45628,11,45656,45656,11,45684,45684,11,45712,45712,11,45740,45740,11,45768,45768,11,45796,45796,11,45824,45824,11,45852,45852,11,45880,45880,11,45908,45908,11,45936,45936,11,45964,45964,11,45992,45992,11,46020,46020,11,46048,46048,11,46076,46076,11,46104,46104,11,46132,46132,11,46160,46160,11,46188,46188,11,46216,46216,11,46244,46244,11,46272,46272,11,46300,46300,11,46328,46328,11,46356,46356,11,46384,46384,11,46412,46412,11,46440,46440,11,46468,46468,11,46496,46496,11,46524,46524,11,46552,46552,11,46580,46580,11,46608,46608,11,46636,46636,11,46664,46664,11,46692,46692,11,46720,46720,11,46748,46748,11,46776,46776,11,46804,46804,11,46832,46832,11,46860,46860,11,46888,46888,11,46916,46916,11,46944,46944,11,46972,46972,11,47000,47000,11,47028,47028,11,47056,47056,11,47084,47084,11,47112,47112,11,47140,47140,11,47168,47168,11,47196,47196,11,47224,47224,11,47252,47252,11,47280,47280,11,47308,47308,11,47336,47336,11,47364,47364,11,47392,47392,11,47420,47420,11,47448,47448,11,47476,47476,11,47504,47504,11,47532,47532,11,47560,47560,11,47588,47588,11,47616,47616,11,47644,47644,11,47672,47672,11,47700,47700,11,47728,47728,11,47756,47756,11,47784,47784,11,47812,47812,11,47840,47840,11,47868,47868,11,47896,47896,11,47924,47924,11,47952,47952,11,47980,47980,11,48008,48008,11,48036,48036,11,48064,48064,11,48092,48092,11,48120,48120,11,48148,48148,11,48176,48176,11,48204,48204,11,48232,48232,11,48260,48260,11,48288,48288,11,48316,48316,11,48344,48344,11,48372,48372,11,48400,48400,11,48428,48428,11,48456,48456,11,48484,48484,11,48512,48512,11,48540,48540,11,48568,48568,11,48596,48596,11,48624,48624,11,48652,48652,11,48680,48680,11,48708,48708,11,48736,48736,11,48764,48764,11,48792,48792,11,48820,48820,11,48848,48848,11,48876,48876,11,48904,48904,11,48932,48932,11,48960,48960,11,48988,48988,11,49016,49016,11,49044,49044,11,49072,49072,11,49100,49100,11,49128,49128,11,49156,49156,11,49184,49184,11,49212,49212,11,49240,49240,11,49268,49268,11,49296,49296,11,49324,49324,11,49352,49352,11,49380,49380,11,49408,49408,11,49436,49436,11,49464,49464,11,49492,49492,11,49520,49520,11,49548,49548,11,49576,49576,11,49604,49604,11,49632,49632,11,49660,49660,11,49688,49688,11,49716,49716,11,49744,49744,11,49772,49772,11,49800,49800,11,49828,49828,11,49856,49856,11,49884,49884,11,49912,49912,11,49940,49940,11,49968,49968,11,49996,49996,11,50024,50024,11,50052,50052,11,50080,50080,11,50108,50108,11,50136,50136,11,50164,50164,11,50192,50192,11,50220,50220,11,50248,50248,11,50276,50276,11,50304,50304,11,50332,50332,11,50360,50360,11,50388,50388,11,50416,50416,11,50444,50444,11,50472,50472,11,50500,50500,11,50528,50528,11,50556,50556,11,50584,50584,11,50612,50612,11,50640,50640,11,50668,50668,11,50696,50696,11,50724,50724,11,50752,50752,11,50780,50780,11,50808,50808,11,50836,50836,11,50864,50864,11,50892,50892,11,50920,50920,11,50948,50948,11,50976,50976,11,51004,51004,11,51032,51032,11,51060,51060,11,51088,51088,11,51116,51116,11,51144,51144,11,51172,51172,11,51200,51200,11,51228,51228,11,51256,51256,11,51284,51284,11,51312,51312,11,51340,51340,11,51368,51368,11,51396,51396,11,51424,51424,11,51452,51452,11,51480,51480,11,51508,51508,11,51536,51536,11,51564,51564,11,51592,51592,11,51620,51620,11,51648,51648,11,51676,51676,11,51704,51704,11,51732,51732,11,51760,51760,11,51788,51788,11,51816,51816,11,51844,51844,11,51872,51872,11,51900,51900,11,51928,51928,11,51956,51956,11,51984,51984,11,52012,52012,11,52040,52040,11,52068,52068,11,52096,52096,11,52124,52124,11,52152,52152,11,52180,52180,11,52208,52208,11,52236,52236,11,52264,52264,11,52292,52292,11,52320,52320,11,52348,52348,11,52376,52376,11,52404,52404,11,52432,52432,11,52460,52460,11,52488,52488,11,52516,52516,11,52544,52544,11,52572,52572,11,52600,52600,11,52628,52628,11,52656,52656,11,52684,52684,11,52712,52712,11,52740,52740,11,52768,52768,11,52796,52796,11,52824,52824,11,52852,52852,11,52880,52880,11,52908,52908,11,52936,52936,11,52964,52964,11,52992,52992,11,53020,53020,11,53048,53048,11,53076,53076,11,53104,53104,11,53132,53132,11,53160,53160,11,53188,53188,11,53216,53216,11,53244,53244,11,53272,53272,11,53300,53300,11,53328,53328,11,53356,53356,11,53384,53384,11,53412,53412,11,53440,53440,11,53468,53468,11,53496,53496,11,53524,53524,11,53552,53552,11,53580,53580,11,53608,53608,11,53636,53636,11,53664,53664,11,53692,53692,11,53720,53720,11,53748,53748,11,53776,53776,11,53804,53804,11,53832,53832,11,53860,53860,11,53888,53888,11,53916,53916,11,53944,53944,11,53972,53972,11,54000,54000,11,54028,54028,11,54056,54056,11,54084,54084,11,54112,54112,11,54140,54140,11,54168,54168,11,54196,54196,11,54224,54224,11,54252,54252,11,54280,54280,11,54308,54308,11,54336,54336,11,54364,54364,11,54392,54392,11,54420,54420,11,54448,54448,11,54476,54476,11,54504,54504,11,54532,54532,11,54560,54560,11,54588,54588,11,54616,54616,11,54644,54644,11,54672,54672,11,54700,54700,11,54728,54728,11,54756,54756,11,54784,54784,11,54812,54812,11,54840,54840,11,54868,54868,11,54896,54896,11,54924,54924,11,54952,54952,11,54980,54980,11,55008,55008,11,55036,55036,11,55064,55064,11,55092,55092,11,55120,55120,11,55148,55148,11,55176,55176,11,55216,55238,9,64286,64286,5,65056,65071,5,65438,65439,5,65529,65531,4,66272,66272,5,68097,68099,5,68108,68111,5,68159,68159,5,68900,68903,5,69446,69456,5,69632,69632,7,69634,69634,7,69744,69744,5,69759,69761,5,69808,69810,7,69815,69816,7,69821,69821,1,69837,69837,1,69927,69931,5,69933,69940,5,70003,70003,5,70018,70018,7,70070,70078,5,70082,70083,1,70094,70094,7,70188,70190,7,70194,70195,7,70197,70197,7,70206,70206,5,70368,70370,7,70400,70401,5,70459,70460,5,70463,70463,7,70465,70468,7,70475,70477,7,70498,70499,7,70512,70516,5,70712,70719,5,70722,70724,5,70726,70726,5,70832,70832,5,70835,70840,5,70842,70842,5,70845,70845,5,70847,70848,5,70850,70851,5,71088,71089,7,71096,71099,7,71102,71102,7,71132,71133,5,71219,71226,5,71229,71229,5,71231,71232,5,71340,71340,7,71342,71343,7,71350,71350,7,71453,71455,5,71462,71462,7,71724,71726,7,71736,71736,7,71984,71984,5,71991,71992,7,71997,71997,7,71999,71999,1,72001,72001,1,72003,72003,5,72148,72151,5,72156,72159,7,72164,72164,7,72243,72248,5,72250,72250,1,72263,72263,5,72279,72280,7,72324,72329,1,72343,72343,7,72751,72751,7,72760,72765,5,72767,72767,5,72873,72873,7,72881,72881,7,72884,72884,7,73009,73014,5,73020,73021,5,73030,73030,1,73098,73102,7,73107,73108,7,73110,73110,7,73459,73460,5,78896,78904,4,92976,92982,5,94033,94087,7,94180,94180,5,113821,113822,5,118528,118573,5,119141,119141,5,119143,119145,5,119150,119154,5,119163,119170,5,119210,119213,5,121344,121398,5,121461,121461,5,121499,121503,5,122880,122886,5,122907,122913,5,122918,122922,5,123566,123566,5,125136,125142,5,126976,126979,14,126981,127182,14,127184,127231,14,127279,127279,14,127344,127345,14,127374,127374,14,127405,127461,14,127489,127490,14,127514,127514,14,127538,127546,14,127561,127567,14,127570,127743,14,127757,127758,14,127760,127760,14,127762,127762,14,127766,127768,14,127770,127770,14,127772,127772,14,127775,127776,14,127778,127779,14,127789,127791,14,127794,127795,14,127798,127798,14,127819,127819,14,127824,127824,14,127868,127868,14,127870,127871,14,127892,127893,14,127896,127896,14,127900,127901,14,127904,127940,14,127942,127942,14,127944,127944,14,127946,127946,14,127951,127955,14,127968,127971,14,127973,127984,14,127987,127987,14,127989,127989,14,127991,127991,14,127995,127999,5,128008,128008,14,128012,128014,14,128017,128018,14,128020,128020,14,128022,128022,14,128042,128042,14,128063,128063,14,128065,128065,14,128101,128101,14,128108,128109,14,128173,128173,14,128182,128183,14,128236,128237,14,128239,128239,14,128245,128245,14,128248,128248,14,128253,128253,14,128255,128258,14,128260,128263,14,128265,128265,14,128277,128277,14,128300,128301,14,128326,128328,14,128331,128334,14,128336,128347,14,128360,128366,14,128369,128370,14,128378,128378,14,128391,128391,14,128394,128397,14,128400,128400,14,128405,128406,14,128420,128420,14,128422,128423,14,128425,128432,14,128435,128443,14,128445,128449,14,128453,128464,14,128468,128475,14,128479,128480,14,128482,128482,14,128484,128487,14,128489,128494,14,128496,128498,14,128500,128505,14,128507,128511,14,128513,128518,14,128521,128525,14,128527,128527,14,128529,128529,14,128533,128533,14,128535,128535,14,128537,128537,14]")}var wt=class e{static{this.ambiguousCharacterData=new Wt(()=>JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,8218,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,8242,96,1370,96,1523,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71922,67,71913,67,65315,67,8557,67,8450,67,8493,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71919,87,71910,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,66293,90,71909,90,65338,90,8484,90,8488,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65297,49,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"cs":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"es":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"fr":[65374,126,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"it":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ja":[8211,45,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65292,44,65307,59],"ko":[8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"pt-BR":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"ru":[65374,126,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65288,40,65289,41,65292,44,65307,59,65311,63],"zh-hans":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41],"zh-hant":[8211,45,65374,126,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65283,35,65307,59]}'))}static{this.cache=new gn(t=>{function n(c){let h=new Map;for(let f=0;f<c.length;f+=2)h.set(c[f],c[f+1]);return h}function i(c,h){let f=new Map(c);for(let[m,b]of h)f.set(m,b);return f}function r(c,h){if(!c)return h;let f=new Map;for(let[m,b]of c)h.has(m)&&f.set(m,b);return f}let s=this.ambiguousCharacterData.value,a=t.filter(c=>!c.startsWith("_")&&c in s);a.length===0&&(a=["_default"]);let l;for(let c of a){let h=n(s[c]);l=r(l,h)}let o=n(s._common),u=i(o,l);return new e(u)})}static getInstance(t){return e.cache.get(Array.from(t))}static{this._locales=new Wt(()=>Object.keys(e.ambiguousCharacterData.value).filter(t=>!t.startsWith("_")))}static getLocales(){return e._locales.value}constructor(t){this.confusableDictionary=t}isAmbiguous(t){return this.confusableDictionary.has(t)}getPrimaryConfusable(t){return this.confusableDictionary.get(t)}getConfusableCodePoints(){return new Set(this.confusableDictionary.keys())}},yt=class e{static getRawData(){return JSON.parse("[9,10,11,12,13,32,127,160,173,847,1564,4447,4448,6068,6069,6155,6156,6157,6158,7355,7356,8192,8193,8194,8195,8196,8197,8198,8199,8200,8201,8202,8203,8204,8205,8206,8207,8234,8235,8236,8237,8238,8239,8287,8288,8289,8290,8291,8292,8293,8294,8295,8296,8297,8298,8299,8300,8301,8302,8303,10240,12288,12644,65024,65025,65026,65027,65028,65029,65030,65031,65032,65033,65034,65035,65036,65037,65038,65039,65279,65440,65520,65521,65522,65523,65524,65525,65526,65527,65528,65532,78844,119155,119156,119157,119158,119159,119160,119161,119162,917504,917505,917506,917507,917508,917509,917510,917511,917512,917513,917514,917515,917516,917517,917518,917519,917520,917521,917522,917523,917524,917525,917526,917527,917528,917529,917530,917531,917532,917533,917534,917535,917536,917537,917538,917539,917540,917541,917542,917543,917544,917545,917546,917547,917548,917549,917550,917551,917552,917553,917554,917555,917556,917557,917558,917559,917560,917561,917562,917563,917564,917565,917566,917567,917568,917569,917570,917571,917572,917573,917574,917575,917576,917577,917578,917579,917580,917581,917582,917583,917584,917585,917586,917587,917588,917589,917590,917591,917592,917593,917594,917595,917596,917597,917598,917599,917600,917601,917602,917603,917604,917605,917606,917607,917608,917609,917610,917611,917612,917613,917614,917615,917616,917617,917618,917619,917620,917621,917622,917623,917624,917625,917626,917627,917628,917629,917630,917631,917760,917761,917762,917763,917764,917765,917766,917767,917768,917769,917770,917771,917772,917773,917774,917775,917776,917777,917778,917779,917780,917781,917782,917783,917784,917785,917786,917787,917788,917789,917790,917791,917792,917793,917794,917795,917796,917797,917798,917799,917800,917801,917802,917803,917804,917805,917806,917807,917808,917809,917810,917811,917812,917813,917814,917815,917816,917817,917818,917819,917820,917821,917822,917823,917824,917825,917826,917827,917828,917829,917830,917831,917832,917833,917834,917835,917836,917837,917838,917839,917840,917841,917842,917843,917844,917845,917846,917847,917848,917849,917850,917851,917852,917853,917854,917855,917856,917857,917858,917859,917860,917861,917862,917863,917864,917865,917866,917867,917868,917869,917870,917871,917872,917873,917874,917875,917876,917877,917878,917879,917880,917881,917882,917883,917884,917885,917886,917887,917888,917889,917890,917891,917892,917893,917894,917895,917896,917897,917898,917899,917900,917901,917902,917903,917904,917905,917906,917907,917908,917909,917910,917911,917912,917913,917914,917915,917916,917917,917918,917919,917920,917921,917922,917923,917924,917925,917926,917927,917928,917929,917930,917931,917932,917933,917934,917935,917936,917937,917938,917939,917940,917941,917942,917943,917944,917945,917946,917947,917948,917949,917950,917951,917952,917953,917954,917955,917956,917957,917958,917959,917960,917961,917962,917963,917964,917965,917966,917967,917968,917969,917970,917971,917972,917973,917974,917975,917976,917977,917978,917979,917980,917981,917982,917983,917984,917985,917986,917987,917988,917989,917990,917991,917992,917993,917994,917995,917996,917997,917998,917999]")}static{this._data=void 0}static getData(){return this._data||(this._data=new Set(e.getRawData())),this._data}static isInvisibleCharacter(t){return e.getData().has(t)}static get codePoints(){return e.getData()}};var yl="$initialize";var Ci=class{constructor(t,n,i,r){this.vsWorker=t,this.req=n,this.method=i,this.args=r,this.type=0}},vn=class{constructor(t,n,i,r){this.vsWorker=t,this.seq=n,this.res=i,this.err=r,this.type=1}},Ei=class{constructor(t,n,i,r){this.vsWorker=t,this.req=n,this.eventName=i,this.arg=r,this.type=2}},Mi=class{constructor(t,n,i){this.vsWorker=t,this.req=n,this.event=i,this.type=3}},Ri=class{constructor(t,n){this.vsWorker=t,this.req=n,this.type=4}},Di=class{constructor(t){this._workerId=-1,this._handler=t,this._lastSentReq=0,this._pendingReplies=Object.create(null),this._pendingEmitters=new Map,this._pendingEvents=new Map}setWorkerId(t){this._workerId=t}sendMessage(t,n){let i=String(++this._lastSentReq);return new Promise((r,s)=>{this._pendingReplies[i]={resolve:r,reject:s},this._send(new Ci(this._workerId,i,t,n))})}listen(t,n){let i=null,r=new de({onWillAddFirstListener:()=>{i=String(++this._lastSentReq),this._pendingEmitters.set(i,r),this._send(new Ei(this._workerId,i,t,n))},onDidRemoveLastListener:()=>{this._pendingEmitters.delete(i),this._send(new Ri(this._workerId,i)),i=null}});return r.event}handleMessage(t){!t||!t.vsWorker||this._workerId!==-1&&t.vsWorker!==this._workerId||this._handleMessage(t)}_handleMessage(t){switch(t.type){case 1:return this._handleReplyMessage(t);case 0:return this._handleRequestMessage(t);case 2:return this._handleSubscribeEventMessage(t);case 3:return this._handleEventMessage(t);case 4:return this._handleUnsubscribeEventMessage(t)}}_handleReplyMessage(t){if(!this._pendingReplies[t.seq]){console.warn("Got reply to unknown seq");return}let n=this._pendingReplies[t.seq];if(delete this._pendingReplies[t.seq],t.err){let i=t.err;t.err.$isError&&(i=new Error,i.name=t.err.name,i.message=t.err.message,i.stack=t.err.stack),n.reject(i);return}n.resolve(t.res)}_handleRequestMessage(t){let n=t.req;this._handler.handleMessage(t.method,t.args).then(r=>{this._send(new vn(this._workerId,n,r,void 0))},r=>{r.detail instanceof Error&&(r.detail=fi(r.detail)),this._send(new vn(this._workerId,n,void 0,fi(r)))})}_handleSubscribeEventMessage(t){let n=t.req,i=this._handler.handleEvent(t.eventName,t.arg)(r=>{this._send(new Mi(this._workerId,n,r))});this._pendingEvents.set(n,i)}_handleEventMessage(t){if(!this._pendingEmitters.has(t.req)){console.warn("Got event for unknown req");return}this._pendingEmitters.get(t.req).fire(t.event)}_handleUnsubscribeEventMessage(t){if(!this._pendingEvents.has(t.req)){console.warn("Got unsubscribe for unknown req");return}this._pendingEvents.get(t.req).dispose(),this._pendingEvents.delete(t.req)}_send(t){let n=[];if(t.type===0)for(let i=0;i<t.args.length;i++)t.args[i]instanceof ArrayBuffer&&n.push(t.args[i]);else t.type===1&&t.res instanceof ArrayBuffer&&n.push(t.res);this._handler.sendMessage(t,n)}};function ss(e){return e[0]==="o"&&e[1]==="n"&&Si(e.charCodeAt(2))}function as(e){return/^onDynamic/.test(e)&&Si(e.charCodeAt(9))}function xl(e,t,n){let i=a=>function(){let l=Array.prototype.slice.call(arguments,0);return t(a,l)},r=a=>function(l){return n(a,l)},s={};for(let a of e){if(as(a)){s[a]=r(a);continue}if(ss(a)){s[a]=n(a,void 0);continue}s[a]=i(a)}return s}var _n=class{constructor(t,n){this._requestHandlerFactory=n,this._requestHandler=null,this._protocol=new Di({sendMessage:(i,r)=>{t(i,r)},handleMessage:(i,r)=>this._handleMessage(i,r),handleEvent:(i,r)=>this._handleEvent(i,r)})}onmessage(t){this._protocol.handleMessage(t)}_handleMessage(t,n){if(t===yl)return this.initialize(n[0],n[1],n[2],n[3]);if(!this._requestHandler||typeof this._requestHandler[t]!="function")return Promise.reject(new Error("Missing requestHandler or method: "+t));try{return Promise.resolve(this._requestHandler[t].apply(this._requestHandler,n))}catch(i){return Promise.reject(i)}}_handleEvent(t,n){if(!this._requestHandler)throw new Error("Missing requestHandler");if(as(t)){let i=this._requestHandler[t].call(this._requestHandler,n);if(typeof i!="function")throw new Error(`Missing dynamic event ${t} on request handler.`);return i}if(ss(t)){let i=this._requestHandler[t];if(typeof i!="function")throw new Error(`Missing event ${t} on request handler.`);return i}throw new Error(`Malformed event name ${t}`)}initialize(t,n,i,r){this._protocol.setWorkerId(t);let l=xl(r,(o,u)=>this._protocol.sendMessage(o,u),(o,u)=>this._protocol.listen(o,u));return this._requestHandlerFactory?(this._requestHandler=this._requestHandlerFactory(l),Promise.resolve(Ft(this._requestHandler))):(n&&(typeof n.baseUrl<"u"&&delete n.baseUrl,typeof n.paths<"u"&&typeof n.paths.vs<"u"&&delete n.paths.vs,typeof n.trustedTypesPolicy<"u"&&delete n.trustedTypesPolicy,n.catchError=!0,globalThis.require.config(n)),new Promise((o,u)=>{let c=globalThis.require;c([i],h=>{if(this._requestHandler=h.create(l),!this._requestHandler){u(new Error("No RequestHandler!"));return}o(Ft(this._requestHandler))},u)}))}};var Ae=class{constructor(t,n,i,r){this.originalStart=t,this.originalLength=n,this.modifiedStart=i,this.modifiedLength=r}getOriginalEnd(){return this.originalStart+this.originalLength}getModifiedEnd(){return this.modifiedStart+this.modifiedLength}};function os(e,t){return(t<<5)-t+e|0}function cs(e,t){t=os(149417,t);for(let n=0,i=e.length;n<i;n++)t=os(e.charCodeAt(n),t);return t}function Ni(e,t,n=32){let i=n-t,r=~((1<<i)-1);return(e<<t|(r&e)>>>i)>>>0}function ls(e,t=0,n=e.byteLength,i=0){for(let r=0;r<n;r++)e[t+r]=i}function Tl(e,t,n="0"){for(;e.length<t;)e=n+e;return e}function Bt(e,t=32){return e instanceof ArrayBuffer?Array.from(new Uint8Array(e)).map(n=>n.toString(16).padStart(2,"0")).join(""):Tl((e>>>0).toString(16),t/4)}var us=class e{static{this._bigBlock32=new DataView(new ArrayBuffer(320))}constructor(){this._h0=1732584193,this._h1=4023233417,this._h2=2562383102,this._h3=271733878,this._h4=3285377520,this._buff=new Uint8Array(67),this._buffDV=new DataView(this._buff.buffer),this._buffLen=0,this._totalLen=0,this._leftoverHighSurrogate=0,this._finished=!1}update(t){let n=t.length;if(n===0)return;let i=this._buff,r=this._buffLen,s=this._leftoverHighSurrogate,a,l;for(s!==0?(a=s,l=-1,s=0):(a=t.charCodeAt(0),l=0);;){let o=a;if(xt(a))if(l+1<n){let u=t.charCodeAt(l+1);bn(u)?(l++,o=Li(a,u)):o=65533}else{s=a;break}else bn(a)&&(o=65533);if(r=this._push(i,r,o),l++,l<n)a=t.charCodeAt(l);else break}this._buffLen=r,this._leftoverHighSurrogate=s}_push(t,n,i){return i<128?t[n++]=i:i<2048?(t[n++]=192|(i&1984)>>>6,t[n++]=128|(i&63)>>>0):i<65536?(t[n++]=224|(i&61440)>>>12,t[n++]=128|(i&4032)>>>6,t[n++]=128|(i&63)>>>0):(t[n++]=240|(i&1835008)>>>18,t[n++]=128|(i&258048)>>>12,t[n++]=128|(i&4032)>>>6,t[n++]=128|(i&63)>>>0),n>=64&&(this._step(),n-=64,this._totalLen+=64,t[0]=t[64],t[1]=t[65],t[2]=t[66]),n}digest(){return this._finished||(this._finished=!0,this._leftoverHighSurrogate&&(this._leftoverHighSurrogate=0,this._buffLen=this._push(this._buff,this._buffLen,65533)),this._totalLen+=this._buffLen,this._wrapUp()),Bt(this._h0)+Bt(this._h1)+Bt(this._h2)+Bt(this._h3)+Bt(this._h4)}_wrapUp(){this._buff[this._buffLen++]=128,ls(this._buff,this._buffLen),this._buffLen>56&&(this._step(),ls(this._buff));let t=8*this._totalLen;this._buffDV.setUint32(56,Math.floor(t/4294967296),!1),this._buffDV.setUint32(60,t%4294967296,!1),this._step()}_step(){let t=e._bigBlock32,n=this._buffDV;for(let h=0;h<64;h+=4)t.setUint32(h,n.getUint32(h,!1),!1);for(let h=64;h<320;h+=4)t.setUint32(h,Ni(t.getUint32(h-12,!1)^t.getUint32(h-32,!1)^t.getUint32(h-56,!1)^t.getUint32(h-64,!1),1),!1);let i=this._h0,r=this._h1,s=this._h2,a=this._h3,l=this._h4,o,u,c;for(let h=0;h<80;h++)h<20?(o=r&s|~r&a,u=1518500249):h<40?(o=r^s^a,u=1859775393):h<60?(o=r&s|r&a|s&a,u=2400959708):(o=r^s^a,u=3395469782),c=Ni(i,5)+o+l+u+t.getUint32(h*4,!1)&4294967295,l=a,a=s,s=Ni(r,30),r=i,i=c;this._h0=this._h0+i&4294967295,this._h1=this._h1+r&4294967295,this._h2=this._h2+s&4294967295,this._h3=this._h3+a&4294967295,this._h4=this._h4+l&4294967295}};var wn=class{constructor(t){this.source=t}getElements(){let t=this.source,n=new Int32Array(t.length);for(let i=0,r=t.length;i<r;i++)n[i]=t.charCodeAt(i);return n}};function hs(e,t,n){return new Pt(new wn(e),new wn(t)).ComputeDiff(n).changes}var Pe=class{static Assert(t,n){if(!t)throw new Error(n)}},qe=class{static Copy(t,n,i,r,s){for(let a=0;a<s;a++)i[r+a]=t[n+a]}static Copy2(t,n,i,r,s){for(let a=0;a<s;a++)i[r+a]=t[n+a]}},yn=class{constructor(){this.m_changes=[],this.m_originalStart=1073741824,this.m_modifiedStart=1073741824,this.m_originalCount=0,this.m_modifiedCount=0}MarkNextChange(){(this.m_originalCount>0||this.m_modifiedCount>0)&&this.m_changes.push(new Ae(this.m_originalStart,this.m_originalCount,this.m_modifiedStart,this.m_modifiedCount)),this.m_originalCount=0,this.m_modifiedCount=0,this.m_originalStart=1073741824,this.m_modifiedStart=1073741824}AddOriginalElement(t,n){this.m_originalStart=Math.min(this.m_originalStart,t),this.m_modifiedStart=Math.min(this.m_modifiedStart,n),this.m_originalCount++}AddModifiedElement(t,n){this.m_originalStart=Math.min(this.m_originalStart,t),this.m_modifiedStart=Math.min(this.m_modifiedStart,n),this.m_modifiedCount++}getChanges(){return(this.m_originalCount>0||this.m_modifiedCount>0)&&this.MarkNextChange(),this.m_changes}getReverseChanges(){return(this.m_originalCount>0||this.m_modifiedCount>0)&&this.MarkNextChange(),this.m_changes.reverse(),this.m_changes}},Pt=class e{constructor(t,n,i=null){this.ContinueProcessingPredicate=i,this._originalSequence=t,this._modifiedSequence=n;let[r,s,a]=e._getElements(t),[l,o,u]=e._getElements(n);this._hasStrings=a&&u,this._originalStringElements=r,this._originalElementsOrHash=s,this._modifiedStringElements=l,this._modifiedElementsOrHash=o,this.m_forwardHistory=[],this.m_reverseHistory=[]}static _isStringArray(t){return t.length>0&&typeof t[0]=="string"}static _getElements(t){let n=t.getElements();if(e._isStringArray(n)){let i=new Int32Array(n.length);for(let r=0,s=n.length;r<s;r++)i[r]=cs(n[r],0);return[n,i,!0]}return n instanceof Int32Array?[[],n,!1]:[[],new Int32Array(n),!1]}ElementsAreEqual(t,n){return this._originalElementsOrHash[t]!==this._modifiedElementsOrHash[n]?!1:this._hasStrings?this._originalStringElements[t]===this._modifiedStringElements[n]:!0}ElementsAreStrictEqual(t,n){if(!this.ElementsAreEqual(t,n))return!1;let i=e._getStrictElement(this._originalSequence,t),r=e._getStrictElement(this._modifiedSequence,n);return i===r}static _getStrictElement(t,n){return typeof t.getStrictElement=="function"?t.getStrictElement(n):null}OriginalElementsAreEqual(t,n){return this._originalElementsOrHash[t]!==this._originalElementsOrHash[n]?!1:this._hasStrings?this._originalStringElements[t]===this._originalStringElements[n]:!0}ModifiedElementsAreEqual(t,n){return this._modifiedElementsOrHash[t]!==this._modifiedElementsOrHash[n]?!1:this._hasStrings?this._modifiedStringElements[t]===this._modifiedStringElements[n]:!0}ComputeDiff(t){return this._ComputeDiff(0,this._originalElementsOrHash.length-1,0,this._modifiedElementsOrHash.length-1,t)}_ComputeDiff(t,n,i,r,s){let a=[!1],l=this.ComputeDiffRecursive(t,n,i,r,a);return s&&(l=this.PrettifyChanges(l)),{quitEarly:a[0],changes:l}}ComputeDiffRecursive(t,n,i,r,s){for(s[0]=!1;t<=n&&i<=r&&this.ElementsAreEqual(t,i);)t++,i++;for(;n>=t&&r>=i&&this.ElementsAreEqual(n,r);)n--,r--;if(t>n||i>r){let h;return i<=r?(Pe.Assert(t===n+1,"originalStart should only be one more than originalEnd"),h=[new Ae(t,0,i,r-i+1)]):t<=n?(Pe.Assert(i===r+1,"modifiedStart should only be one more than modifiedEnd"),h=[new Ae(t,n-t+1,i,0)]):(Pe.Assert(t===n+1,"originalStart should only be one more than originalEnd"),Pe.Assert(i===r+1,"modifiedStart should only be one more than modifiedEnd"),h=[]),h}let a=[0],l=[0],o=this.ComputeRecursionPoint(t,n,i,r,a,l,s),u=a[0],c=l[0];if(o!==null)return o;if(!s[0]){let h=this.ComputeDiffRecursive(t,u,i,c,s),f=[];return s[0]?f=[new Ae(u+1,n-(u+1)+1,c+1,r-(c+1)+1)]:f=this.ComputeDiffRecursive(u+1,n,c+1,r,s),this.ConcatenateChanges(h,f)}return[new Ae(t,n-t+1,i,r-i+1)]}WALKTRACE(t,n,i,r,s,a,l,o,u,c,h,f,m,b,p,w,x,_){let y=null,C=null,E=new yn,B=n,v=i,g=m[0]-w[0]-r,T=-1073741824,q=this.m_forwardHistory.length-1;do{let S=g+t;S===B||S<v&&u[S-1]<u[S+1]?(h=u[S+1],b=h-g-r,h<T&&E.MarkNextChange(),T=h,E.AddModifiedElement(h+1,b),g=S+1-t):(h=u[S-1]+1,b=h-g-r,h<T&&E.MarkNextChange(),T=h-1,E.AddOriginalElement(h,b+1),g=S-1-t),q>=0&&(u=this.m_forwardHistory[q],t=u[0],B=1,v=u.length-1)}while(--q>=-1);if(y=E.getReverseChanges(),_[0]){let S=m[0]+1,A=w[0]+1;if(y!==null&&y.length>0){let N=y[y.length-1];S=Math.max(S,N.getOriginalEnd()),A=Math.max(A,N.getModifiedEnd())}C=[new Ae(S,f-S+1,A,p-A+1)]}else{E=new yn,B=a,v=l,g=m[0]-w[0]-o,T=1073741824,q=x?this.m_reverseHistory.length-1:this.m_reverseHistory.length-2;do{let S=g+s;S===B||S<v&&c[S-1]>=c[S+1]?(h=c[S+1]-1,b=h-g-o,h>T&&E.MarkNextChange(),T=h+1,E.AddOriginalElement(h+1,b+1),g=S+1-s):(h=c[S-1],b=h-g-o,h>T&&E.MarkNextChange(),T=h,E.AddModifiedElement(h+1,b+1),g=S-1-s),q>=0&&(c=this.m_reverseHistory[q],s=c[0],B=1,v=c.length-1)}while(--q>=-1);C=E.getChanges()}return this.ConcatenateChanges(y,C)}ComputeRecursionPoint(t,n,i,r,s,a,l){let o=0,u=0,c=0,h=0,f=0,m=0;t--,i--,s[0]=0,a[0]=0,this.m_forwardHistory=[],this.m_reverseHistory=[];let b=n-t+(r-i),p=b+1,w=new Int32Array(p),x=new Int32Array(p),_=r-i,y=n-t,C=t-i,E=n-r,v=(y-_)%2===0;w[_]=t,x[y]=n,l[0]=!1;for(let g=1;g<=b/2+1;g++){let T=0,q=0;c=this.ClipDiagonalBound(_-g,g,_,p),h=this.ClipDiagonalBound(_+g,g,_,p);for(let A=c;A<=h;A+=2){A===c||A<h&&w[A-1]<w[A+1]?o=w[A+1]:o=w[A-1]+1,u=o-(A-_)-C;let N=o;for(;o<n&&u<r&&this.ElementsAreEqual(o+1,u+1);)o++,u++;if(w[A]=o,o+u>T+q&&(T=o,q=u),!v&&Math.abs(A-y)<=g-1&&o>=x[A])return s[0]=o,a[0]=u,N<=x[A]&&g<=1448?this.WALKTRACE(_,c,h,C,y,f,m,E,w,x,o,n,s,u,r,a,v,l):null}let S=(T-t+(q-i)-g)/2;if(this.ContinueProcessingPredicate!==null&&!this.ContinueProcessingPredicate(T,S))return l[0]=!0,s[0]=T,a[0]=q,S>0&&g<=1448?this.WALKTRACE(_,c,h,C,y,f,m,E,w,x,o,n,s,u,r,a,v,l):(t++,i++,[new Ae(t,n-t+1,i,r-i+1)]);f=this.ClipDiagonalBound(y-g,g,y,p),m=this.ClipDiagonalBound(y+g,g,y,p);for(let A=f;A<=m;A+=2){A===f||A<m&&x[A-1]>=x[A+1]?o=x[A+1]-1:o=x[A-1],u=o-(A-y)-E;let N=o;for(;o>t&&u>i&&this.ElementsAreEqual(o,u);)o--,u--;if(x[A]=o,v&&Math.abs(A-_)<=g&&o<=w[A])return s[0]=o,a[0]=u,N>=w[A]&&g<=1448?this.WALKTRACE(_,c,h,C,y,f,m,E,w,x,o,n,s,u,r,a,v,l):null}if(g<=1447){let A=new Int32Array(h-c+2);A[0]=_-c+1,qe.Copy2(w,c,A,1,h-c+1),this.m_forwardHistory.push(A),A=new Int32Array(m-f+2),A[0]=y-f+1,qe.Copy2(x,f,A,1,m-f+1),this.m_reverseHistory.push(A)}}return this.WALKTRACE(_,c,h,C,y,f,m,E,w,x,o,n,s,u,r,a,v,l)}PrettifyChanges(t){for(let n=0;n<t.length;n++){let i=t[n],r=n<t.length-1?t[n+1].originalStart:this._originalElementsOrHash.length,s=n<t.length-1?t[n+1].modifiedStart:this._modifiedElementsOrHash.length,a=i.originalLength>0,l=i.modifiedLength>0;for(;i.originalStart+i.originalLength<r&&i.modifiedStart+i.modifiedLength<s&&(!a||this.OriginalElementsAreEqual(i.originalStart,i.originalStart+i.originalLength))&&(!l||this.ModifiedElementsAreEqual(i.modifiedStart,i.modifiedStart+i.modifiedLength));){let u=this.ElementsAreStrictEqual(i.originalStart,i.modifiedStart);if(this.ElementsAreStrictEqual(i.originalStart+i.originalLength,i.modifiedStart+i.modifiedLength)&&!u)break;i.originalStart++,i.modifiedStart++}let o=[null];if(n<t.length-1&&this.ChangesOverlap(t[n],t[n+1],o)){t[n]=o[0],t.splice(n+1,1),n--;continue}}for(let n=t.length-1;n>=0;n--){let i=t[n],r=0,s=0;if(n>0){let h=t[n-1];r=h.originalStart+h.originalLength,s=h.modifiedStart+h.modifiedLength}let a=i.originalLength>0,l=i.modifiedLength>0,o=0,u=this._boundaryScore(i.originalStart,i.originalLength,i.modifiedStart,i.modifiedLength);for(let h=1;;h++){let f=i.originalStart-h,m=i.modifiedStart-h;if(f<r||m<s||a&&!this.OriginalElementsAreEqual(f,f+i.originalLength)||l&&!this.ModifiedElementsAreEqual(m,m+i.modifiedLength))break;let p=(f===r&&m===s?5:0)+this._boundaryScore(f,i.originalLength,m,i.modifiedLength);p>u&&(u=p,o=h)}i.originalStart-=o,i.modifiedStart-=o;let c=[null];if(n>0&&this.ChangesOverlap(t[n-1],t[n],c)){t[n-1]=c[0],t.splice(n,1),n++;continue}}if(this._hasStrings)for(let n=1,i=t.length;n<i;n++){let r=t[n-1],s=t[n],a=s.originalStart-r.originalStart-r.originalLength,l=r.originalStart,o=s.originalStart+s.originalLength,u=o-l,c=r.modifiedStart,h=s.modifiedStart+s.modifiedLength,f=h-c;if(a<5&&u<20&&f<20){let m=this._findBetterContiguousSequence(l,u,c,f,a);if(m){let[b,p]=m;(b!==r.originalStart+r.originalLength||p!==r.modifiedStart+r.modifiedLength)&&(r.originalLength=b-r.originalStart,r.modifiedLength=p-r.modifiedStart,s.originalStart=b+a,s.modifiedStart=p+a,s.originalLength=o-s.originalStart,s.modifiedLength=h-s.modifiedStart)}}}return t}_findBetterContiguousSequence(t,n,i,r,s){if(n<s||r<s)return null;let a=t+n-s+1,l=i+r-s+1,o=0,u=0,c=0;for(let h=t;h<a;h++)for(let f=i;f<l;f++){let m=this._contiguousSequenceScore(h,f,s);m>0&&m>o&&(o=m,u=h,c=f)}return o>0?[u,c]:null}_contiguousSequenceScore(t,n,i){let r=0;for(let s=0;s<i;s++){if(!this.ElementsAreEqual(t+s,n+s))return 0;r+=this._originalStringElements[t+s].length}return r}_OriginalIsBoundary(t){return t<=0||t>=this._originalElementsOrHash.length-1?!0:this._hasStrings&&/^\s*$/.test(this._originalStringElements[t])}_OriginalRegionIsBoundary(t,n){if(this._OriginalIsBoundary(t)||this._OriginalIsBoundary(t-1))return!0;if(n>0){let i=t+n;if(this._OriginalIsBoundary(i-1)||this._OriginalIsBoundary(i))return!0}return!1}_ModifiedIsBoundary(t){return t<=0||t>=this._modifiedElementsOrHash.length-1?!0:this._hasStrings&&/^\s*$/.test(this._modifiedStringElements[t])}_ModifiedRegionIsBoundary(t,n){if(this._ModifiedIsBoundary(t)||this._ModifiedIsBoundary(t-1))return!0;if(n>0){let i=t+n;if(this._ModifiedIsBoundary(i-1)||this._ModifiedIsBoundary(i))return!0}return!1}_boundaryScore(t,n,i,r){let s=this._OriginalRegionIsBoundary(t,n)?1:0,a=this._ModifiedRegionIsBoundary(i,r)?1:0;return s+a}ConcatenateChanges(t,n){let i=[];if(t.length===0||n.length===0)return n.length>0?n:t;if(this.ChangesOverlap(t[t.length-1],n[0],i)){let r=new Array(t.length+n.length-1);return qe.Copy(t,0,r,0,t.length-1),r[t.length-1]=i[0],qe.Copy(n,1,r,t.length,n.length-1),r}else{let r=new Array(t.length+n.length);return qe.Copy(t,0,r,0,t.length),qe.Copy(n,0,r,t.length,n.length),r}}ChangesOverlap(t,n,i){if(Pe.Assert(t.originalStart<=n.originalStart,"Left change is not less than or equal to right change"),Pe.Assert(t.modifiedStart<=n.modifiedStart,"Left change is not less than or equal to right change"),t.originalStart+t.originalLength>=n.originalStart||t.modifiedStart+t.modifiedLength>=n.modifiedStart){let r=t.originalStart,s=t.originalLength,a=t.modifiedStart,l=t.modifiedLength;return t.originalStart+t.originalLength>=n.originalStart&&(s=n.originalStart+n.originalLength-t.originalStart),t.modifiedStart+t.modifiedLength>=n.modifiedStart&&(l=n.modifiedStart+n.modifiedLength-t.modifiedStart),i[0]=new Ae(r,s,a,l),!0}else return i[0]=null,!1}ClipDiagonalBound(t,n,i,r){if(t>=0&&t<r)return t;let s=i,a=r-i-1,l=n%2===0;if(t<0){let o=s%2===0;return l===o?0:1}else{let o=a%2===0;return l===o?r-1:r-2}}};var ot,Ii=globalThis.vscode;if(typeof Ii<"u"&&typeof Ii.process<"u"){let e=Ii.process;ot={get platform(){return e.platform},get arch(){return e.arch},get env(){return e.env},cwd(){return e.cwd()}}}else typeof process<"u"?ot={get platform(){return process.platform},get arch(){return process.arch},get env(){return process.env},cwd(){return process.env.VSCODE_CWD||process.cwd()}}:ot={get platform(){return at?"win32":Xr?"darwin":"linux"},get arch(){},get env(){return{}},cwd(){return"/"}};var qt=ot.cwd,ds=ot.env,fs=ot.platform,Ph=ot.arch;var Al=65,kl=97,Sl=90,Ll=122,je=46,ce=47,ge=92,Oe=58,Cl=63,xn=class extends Error{constructor(t,n,i){let r;typeof n=="string"&&n.indexOf("not ")===0?(r="must not be",n=n.replace(/^not /,"")):r="must be";let s=t.indexOf(".")!==-1?"property":"argument",a=`The "${t}" ${s} ${r} of type ${n}`;a+=`. Received type ${typeof i}`,super(a),this.code="ERR_INVALID_ARG_TYPE"}};function El(e,t){if(e===null||typeof e!="object")throw new xn(t,"Object",e)}function re(e,t){if(typeof e!="string")throw new xn(t,"string",e)}var ye=fs==="win32";function j(e){return e===ce||e===ge}function zi(e){return e===ce}function Ve(e){return e>=Al&&e<=Sl||e>=kl&&e<=Ll}function Tn(e,t,n,i){let r="",s=0,a=-1,l=0,o=0;for(let u=0;u<=e.length;++u){if(u<e.length)o=e.charCodeAt(u);else{if(i(o))break;o=ce}if(i(o)){if(!(a===u-1||l===1))if(l===2){if(r.length<2||s!==2||r.charCodeAt(r.length-1)!==je||r.charCodeAt(r.length-2)!==je){if(r.length>2){let c=r.lastIndexOf(n);c===-1?(r="",s=0):(r=r.slice(0,c),s=r.length-1-r.lastIndexOf(n)),a=u,l=0;continue}else if(r.length!==0){r="",s=0,a=u,l=0;continue}}t&&(r+=r.length>0?`${n}..`:"..",s=2)}else r.length>0?r+=`${n}${e.slice(a+1,u)}`:r=e.slice(a+1,u),s=u-a-1;a=u,l=0}else o===je&&l!==-1?++l:l=-1}return r}function ms(e,t){El(t,"pathObject");let n=t.dir||t.root,i=t.base||`${t.name||""}${t.ext||""}`;return n?n===t.root?`${n}${i}`:`${n}${e}${i}`:i}var ae={resolve(...e){let t="",n="",i=!1;for(let r=e.length-1;r>=-1;r--){let s;if(r>=0){if(s=e[r],re(s,"path"),s.length===0)continue}else t.length===0?s=qt():(s=ds[`=${t}`]||qt(),(s===void 0||s.slice(0,2).toLowerCase()!==t.toLowerCase()&&s.charCodeAt(2)===ge)&&(s=`${t}\\`));let a=s.length,l=0,o="",u=!1,c=s.charCodeAt(0);if(a===1)j(c)&&(l=1,u=!0);else if(j(c))if(u=!0,j(s.charCodeAt(1))){let h=2,f=h;for(;h<a&&!j(s.charCodeAt(h));)h++;if(h<a&&h!==f){let m=s.slice(f,h);for(f=h;h<a&&j(s.charCodeAt(h));)h++;if(h<a&&h!==f){for(f=h;h<a&&!j(s.charCodeAt(h));)h++;(h===a||h!==f)&&(o=`\\\\${m}\\${s.slice(f,h)}`,l=h)}}}else l=1;else Ve(c)&&s.charCodeAt(1)===Oe&&(o=s.slice(0,2),l=2,a>2&&j(s.charCodeAt(2))&&(u=!0,l=3));if(o.length>0)if(t.length>0){if(o.toLowerCase()!==t.toLowerCase())continue}else t=o;if(i){if(t.length>0)break}else if(n=`${s.slice(l)}\\${n}`,i=u,u&&t.length>0)break}return n=Tn(n,!i,"\\",j),i?`${t}\\${n}`:`${t}${n}`||"."},normalize(e){re(e,"path");let t=e.length;if(t===0)return".";let n=0,i,r=!1,s=e.charCodeAt(0);if(t===1)return zi(s)?"\\":e;if(j(s))if(r=!0,j(e.charCodeAt(1))){let l=2,o=l;for(;l<t&&!j(e.charCodeAt(l));)l++;if(l<t&&l!==o){let u=e.slice(o,l);for(o=l;l<t&&j(e.charCodeAt(l));)l++;if(l<t&&l!==o){for(o=l;l<t&&!j(e.charCodeAt(l));)l++;if(l===t)return`\\\\${u}\\${e.slice(o)}\\`;l!==o&&(i=`\\\\${u}\\${e.slice(o,l)}`,n=l)}}}else n=1;else Ve(s)&&e.charCodeAt(1)===Oe&&(i=e.slice(0,2),n=2,t>2&&j(e.charCodeAt(2))&&(r=!0,n=3));let a=n<t?Tn(e.slice(n),!r,"\\",j):"";return a.length===0&&!r&&(a="."),a.length>0&&j(e.charCodeAt(t-1))&&(a+="\\"),i===void 0?r?`\\${a}`:a:r?`${i}\\${a}`:`${i}${a}`},isAbsolute(e){re(e,"path");let t=e.length;if(t===0)return!1;let n=e.charCodeAt(0);return j(n)||t>2&&Ve(n)&&e.charCodeAt(1)===Oe&&j(e.charCodeAt(2))},join(...e){if(e.length===0)return".";let t,n;for(let s=0;s<e.length;++s){let a=e[s];re(a,"path"),a.length>0&&(t===void 0?t=n=a:t+=`\\${a}`)}if(t===void 0)return".";let i=!0,r=0;if(typeof n=="string"&&j(n.charCodeAt(0))){++r;let s=n.length;s>1&&j(n.charCodeAt(1))&&(++r,s>2&&(j(n.charCodeAt(2))?++r:i=!1))}if(i){for(;r<t.length&&j(t.charCodeAt(r));)r++;r>=2&&(t=`\\${t.slice(r)}`)}return ae.normalize(t)},relative(e,t){if(re(e,"from"),re(t,"to"),e===t)return"";let n=ae.resolve(e),i=ae.resolve(t);if(n===i||(e=n.toLowerCase(),t=i.toLowerCase(),e===t))return"";let r=0;for(;r<e.length&&e.charCodeAt(r)===ge;)r++;let s=e.length;for(;s-1>r&&e.charCodeAt(s-1)===ge;)s--;let a=s-r,l=0;for(;l<t.length&&t.charCodeAt(l)===ge;)l++;let o=t.length;for(;o-1>l&&t.charCodeAt(o-1)===ge;)o--;let u=o-l,c=a<u?a:u,h=-1,f=0;for(;f<c;f++){let b=e.charCodeAt(r+f);if(b!==t.charCodeAt(l+f))break;b===ge&&(h=f)}if(f!==c){if(h===-1)return i}else{if(u>c){if(t.charCodeAt(l+f)===ge)return i.slice(l+f+1);if(f===2)return i.slice(l+f)}a>c&&(e.charCodeAt(r+f)===ge?h=f:f===2&&(h=3)),h===-1&&(h=0)}let m="";for(f=r+h+1;f<=s;++f)(f===s||e.charCodeAt(f)===ge)&&(m+=m.length===0?"..":"\\..");return l+=h,m.length>0?`${m}${i.slice(l,o)}`:(i.charCodeAt(l)===ge&&++l,i.slice(l,o))},toNamespacedPath(e){if(typeof e!="string"||e.length===0)return e;let t=ae.resolve(e);if(t.length<=2)return e;if(t.charCodeAt(0)===ge){if(t.charCodeAt(1)===ge){let n=t.charCodeAt(2);if(n!==Cl&&n!==je)return`\\\\?\\UNC\\${t.slice(2)}`}}else if(Ve(t.charCodeAt(0))&&t.charCodeAt(1)===Oe&&t.charCodeAt(2)===ge)return`\\\\?\\${t}`;return e},dirname(e){re(e,"path");let t=e.length;if(t===0)return".";let n=-1,i=0,r=e.charCodeAt(0);if(t===1)return j(r)?e:".";if(j(r)){if(n=i=1,j(e.charCodeAt(1))){let l=2,o=l;for(;l<t&&!j(e.charCodeAt(l));)l++;if(l<t&&l!==o){for(o=l;l<t&&j(e.charCodeAt(l));)l++;if(l<t&&l!==o){for(o=l;l<t&&!j(e.charCodeAt(l));)l++;if(l===t)return e;l!==o&&(n=i=l+1)}}}}else Ve(r)&&e.charCodeAt(1)===Oe&&(n=t>2&&j(e.charCodeAt(2))?3:2,i=n);let s=-1,a=!0;for(let l=t-1;l>=i;--l)if(j(e.charCodeAt(l))){if(!a){s=l;break}}else a=!1;if(s===-1){if(n===-1)return".";s=n}return e.slice(0,s)},basename(e,t){t!==void 0&&re(t,"ext"),re(e,"path");let n=0,i=-1,r=!0,s;if(e.length>=2&&Ve(e.charCodeAt(0))&&e.charCodeAt(1)===Oe&&(n=2),t!==void 0&&t.length>0&&t.length<=e.length){if(t===e)return"";let a=t.length-1,l=-1;for(s=e.length-1;s>=n;--s){let o=e.charCodeAt(s);if(j(o)){if(!r){n=s+1;break}}else l===-1&&(r=!1,l=s+1),a>=0&&(o===t.charCodeAt(a)?--a===-1&&(i=s):(a=-1,i=l))}return n===i?i=l:i===-1&&(i=e.length),e.slice(n,i)}for(s=e.length-1;s>=n;--s)if(j(e.charCodeAt(s))){if(!r){n=s+1;break}}else i===-1&&(r=!1,i=s+1);return i===-1?"":e.slice(n,i)},extname(e){re(e,"path");let t=0,n=-1,i=0,r=-1,s=!0,a=0;e.length>=2&&e.charCodeAt(1)===Oe&&Ve(e.charCodeAt(0))&&(t=i=2);for(let l=e.length-1;l>=t;--l){let o=e.charCodeAt(l);if(j(o)){if(!s){i=l+1;break}continue}r===-1&&(s=!1,r=l+1),o===je?n===-1?n=l:a!==1&&(a=1):n!==-1&&(a=-1)}return n===-1||r===-1||a===0||a===1&&n===r-1&&n===i+1?"":e.slice(n,r)},format:ms.bind(null,"\\"),parse(e){re(e,"path");let t={root:"",dir:"",base:"",ext:"",name:""};if(e.length===0)return t;let n=e.length,i=0,r=e.charCodeAt(0);if(n===1)return j(r)?(t.root=t.dir=e,t):(t.base=t.name=e,t);if(j(r)){if(i=1,j(e.charCodeAt(1))){let h=2,f=h;for(;h<n&&!j(e.charCodeAt(h));)h++;if(h<n&&h!==f){for(f=h;h<n&&j(e.charCodeAt(h));)h++;if(h<n&&h!==f){for(f=h;h<n&&!j(e.charCodeAt(h));)h++;h===n?i=h:h!==f&&(i=h+1)}}}}else if(Ve(r)&&e.charCodeAt(1)===Oe){if(n<=2)return t.root=t.dir=e,t;if(i=2,j(e.charCodeAt(2))){if(n===3)return t.root=t.dir=e,t;i=3}}i>0&&(t.root=e.slice(0,i));let s=-1,a=i,l=-1,o=!0,u=e.length-1,c=0;for(;u>=i;--u){if(r=e.charCodeAt(u),j(r)){if(!o){a=u+1;break}continue}l===-1&&(o=!1,l=u+1),r===je?s===-1?s=u:c!==1&&(c=1):s!==-1&&(c=-1)}return l!==-1&&(s===-1||c===0||c===1&&s===l-1&&s===a+1?t.base=t.name=e.slice(a,l):(t.name=e.slice(a,s),t.base=e.slice(a,l),t.ext=e.slice(s,l))),a>0&&a!==i?t.dir=e.slice(0,a-1):t.dir=t.root,t},sep:"\\",delimiter:";",win32:null,posix:null},Ml=(()=>{if(ye){let e=/\\/g;return()=>{let t=qt().replace(e,"/");return t.slice(t.indexOf("/"))}}return()=>qt()})(),ue={resolve(...e){let t="",n=!1;for(let i=e.length-1;i>=-1&&!n;i--){let r=i>=0?e[i]:Ml();re(r,"path"),r.length!==0&&(t=`${r}/${t}`,n=r.charCodeAt(0)===ce)}return t=Tn(t,!n,"/",zi),n?`/${t}`:t.length>0?t:"."},normalize(e){if(re(e,"path"),e.length===0)return".";let t=e.charCodeAt(0)===ce,n=e.charCodeAt(e.length-1)===ce;return e=Tn(e,!t,"/",zi),e.length===0?t?"/":n?"./":".":(n&&(e+="/"),t?`/${e}`:e)},isAbsolute(e){return re(e,"path"),e.length>0&&e.charCodeAt(0)===ce},join(...e){if(e.length===0)return".";let t;for(let n=0;n<e.length;++n){let i=e[n];re(i,"path"),i.length>0&&(t===void 0?t=i:t+=`/${i}`)}return t===void 0?".":ue.normalize(t)},relative(e,t){if(re(e,"from"),re(t,"to"),e===t||(e=ue.resolve(e),t=ue.resolve(t),e===t))return"";let n=1,i=e.length,r=i-n,s=1,a=t.length-s,l=r<a?r:a,o=-1,u=0;for(;u<l;u++){let h=e.charCodeAt(n+u);if(h!==t.charCodeAt(s+u))break;h===ce&&(o=u)}if(u===l)if(a>l){if(t.charCodeAt(s+u)===ce)return t.slice(s+u+1);if(u===0)return t.slice(s+u)}else r>l&&(e.charCodeAt(n+u)===ce?o=u:u===0&&(o=0));let c="";for(u=n+o+1;u<=i;++u)(u===i||e.charCodeAt(u)===ce)&&(c+=c.length===0?"..":"/..");return`${c}${t.slice(s+o)}`},toNamespacedPath(e){return e},dirname(e){if(re(e,"path"),e.length===0)return".";let t=e.charCodeAt(0)===ce,n=-1,i=!0;for(let r=e.length-1;r>=1;--r)if(e.charCodeAt(r)===ce){if(!i){n=r;break}}else i=!1;return n===-1?t?"/":".":t&&n===1?"//":e.slice(0,n)},basename(e,t){t!==void 0&&re(t,"ext"),re(e,"path");let n=0,i=-1,r=!0,s;if(t!==void 0&&t.length>0&&t.length<=e.length){if(t===e)return"";let a=t.length-1,l=-1;for(s=e.length-1;s>=0;--s){let o=e.charCodeAt(s);if(o===ce){if(!r){n=s+1;break}}else l===-1&&(r=!1,l=s+1),a>=0&&(o===t.charCodeAt(a)?--a===-1&&(i=s):(a=-1,i=l))}return n===i?i=l:i===-1&&(i=e.length),e.slice(n,i)}for(s=e.length-1;s>=0;--s)if(e.charCodeAt(s)===ce){if(!r){n=s+1;break}}else i===-1&&(r=!1,i=s+1);return i===-1?"":e.slice(n,i)},extname(e){re(e,"path");let t=-1,n=0,i=-1,r=!0,s=0;for(let a=e.length-1;a>=0;--a){let l=e.charCodeAt(a);if(l===ce){if(!r){n=a+1;break}continue}i===-1&&(r=!1,i=a+1),l===je?t===-1?t=a:s!==1&&(s=1):t!==-1&&(s=-1)}return t===-1||i===-1||s===0||s===1&&t===i-1&&t===n+1?"":e.slice(t,i)},format:ms.bind(null,"/"),parse(e){re(e,"path");let t={root:"",dir:"",base:"",ext:"",name:""};if(e.length===0)return t;let n=e.charCodeAt(0)===ce,i;n?(t.root="/",i=1):i=0;let r=-1,s=0,a=-1,l=!0,o=e.length-1,u=0;for(;o>=i;--o){let c=e.charCodeAt(o);if(c===ce){if(!l){s=o+1;break}continue}a===-1&&(l=!1,a=o+1),c===je?r===-1?r=o:u!==1&&(u=1):r!==-1&&(u=-1)}if(a!==-1){let c=s===0&&n?1:s;r===-1||u===0||u===1&&r===a-1&&r===s+1?t.base=t.name=e.slice(c,a):(t.name=e.slice(c,r),t.base=e.slice(c,a),t.ext=e.slice(r,a))}return s>0?t.dir=e.slice(0,s-1):n&&(t.dir="/"),t},sep:"/",delimiter:":",win32:null,posix:null};ue.win32=ae.win32=ae;ue.posix=ae.posix=ue;var Vh=ye?ae.normalize:ue.normalize,jh=ye?ae.isAbsolute:ue.isAbsolute,Gh=ye?ae.join:ue.join,$h=ye?ae.resolve:ue.resolve,Qh=ye?ae.relative:ue.relative,Jh=ye?ae.dirname:ue.dirname,Xh=ye?ae.basename:ue.basename,Yh=ye?ae.extname:ue.extname,Zh=ye?ae.parse:ue.parse,Kh=ye?ae.sep:ue.sep,ed=ye?ae.delimiter:ue.delimiter;var Rl=/^\w[\w\d+.-]*$/,Dl=/^\//,Nl=/^\/\//;function Il(e,t){if(!e.scheme&&t)throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${e.authority}", path: "${e.path}", query: "${e.query}", fragment: "${e.fragment}"}`);if(e.scheme&&!Rl.test(e.scheme))throw new Error("[UriError]: Scheme contains illegal characters.");if(e.path){if(e.authority){if(!Dl.test(e.path))throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')}else if(Nl.test(e.path))throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')}}function zl(e,t){return!e&&!t?"file":e}function Ul(e,t){switch(e){case"https":case"http":case"file":t?t[0]!==ke&&(t=ke+t):t=ke;break}return t}var te="",ke="/",Fl=/^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/,$e=class e{static isUri(t){return t instanceof e?!0:t?typeof t.authority=="string"&&typeof t.fragment=="string"&&typeof t.path=="string"&&typeof t.query=="string"&&typeof t.scheme=="string"&&typeof t.fsPath=="string"&&typeof t.with=="function"&&typeof t.toString=="function":!1}constructor(t,n,i,r,s,a=!1){typeof t=="object"?(this.scheme=t.scheme||te,this.authority=t.authority||te,this.path=t.path||te,this.query=t.query||te,this.fragment=t.fragment||te):(this.scheme=zl(t,a),this.authority=n||te,this.path=Ul(this.scheme,i||te),this.query=r||te,this.fragment=s||te,Il(this,a))}get fsPath(){return Ui(this,!1)}with(t){if(!t)return this;let{scheme:n,authority:i,path:r,query:s,fragment:a}=t;return n===void 0?n=this.scheme:n===null&&(n=te),i===void 0?i=this.authority:i===null&&(i=te),r===void 0?r=this.path:r===null&&(r=te),s===void 0?s=this.query:s===null&&(s=te),a===void 0?a=this.fragment:a===null&&(a=te),n===this.scheme&&i===this.authority&&r===this.path&&s===this.query&&a===this.fragment?this:new Ge(n,i,r,s,a)}static parse(t,n=!1){let i=Fl.exec(t);return i?new Ge(i[2]||te,An(i[4]||te),An(i[5]||te),An(i[7]||te),An(i[9]||te),n):new Ge(te,te,te,te,te)}static file(t){let n=te;if(at&&(t=t.replace(/\\/g,ke)),t[0]===ke&&t[1]===ke){let i=t.indexOf(ke,2);i===-1?(n=t.substring(2),t=ke):(n=t.substring(2,i),t=t.substring(i)||ke)}return new Ge("file",n,t,te,te)}static from(t,n){return new Ge(t.scheme,t.authority,t.path,t.query,t.fragment,n)}static joinPath(t,...n){if(!t.path)throw new Error("[UriError]: cannot call joinPath on URI without path");let i;return at&&t.scheme==="file"?i=e.file(ae.join(Ui(t,!0),...n)).path:i=ue.join(t.path,...n),t.with({path:i})}toString(t=!1){return Fi(this,t)}toJSON(){return this}static revive(t){if(t){if(t instanceof e)return t;{let n=new Ge(t);return n._formatted=t.external??null,n._fsPath=t._sep===bs?t.fsPath??null:null,n}}else return t}};var bs=at?1:void 0,Ge=class extends $e{constructor(){super(...arguments),this._formatted=null,this._fsPath=null}get fsPath(){return this._fsPath||(this._fsPath=Ui(this,!1)),this._fsPath}toString(t=!1){return t?Fi(this,!0):(this._formatted||(this._formatted=Fi(this,!1)),this._formatted)}toJSON(){let t={$mid:1};return this._fsPath&&(t.fsPath=this._fsPath,t._sep=bs),this._formatted&&(t.external=this._formatted),this.path&&(t.path=this.path),this.scheme&&(t.scheme=this.scheme),this.authority&&(t.authority=this.authority),this.query&&(t.query=this.query),this.fragment&&(t.fragment=this.fragment),t}},vs={58:"%3A",47:"%2F",63:"%3F",35:"%23",91:"%5B",93:"%5D",64:"%40",33:"%21",36:"%24",38:"%26",39:"%27",40:"%28",41:"%29",42:"%2A",43:"%2B",44:"%2C",59:"%3B",61:"%3D",32:"%20"};function ps(e,t,n){let i,r=-1;for(let s=0;s<e.length;s++){let a=e.charCodeAt(s);if(a>=97&&a<=122||a>=65&&a<=90||a>=48&&a<=57||a===45||a===46||a===95||a===126||t&&a===47||n&&a===91||n&&a===93||n&&a===58)r!==-1&&(i+=encodeURIComponent(e.substring(r,s)),r=-1),i!==void 0&&(i+=e.charAt(s));else{i===void 0&&(i=e.substr(0,s));let l=vs[a];l!==void 0?(r!==-1&&(i+=encodeURIComponent(e.substring(r,s)),r=-1),i+=l):r===-1&&(r=s)}}return r!==-1&&(i+=encodeURIComponent(e.substring(r))),i!==void 0?i:e}function Hl(e){let t;for(let n=0;n<e.length;n++){let i=e.charCodeAt(n);i===35||i===63?(t===void 0&&(t=e.substr(0,n)),t+=vs[i]):t!==void 0&&(t+=e[n])}return t!==void 0?t:e}function Ui(e,t){let n;return e.authority&&e.path.length>1&&e.scheme==="file"?n=`//${e.authority}${e.path}`:e.path.charCodeAt(0)===47&&(e.path.charCodeAt(1)>=65&&e.path.charCodeAt(1)<=90||e.path.charCodeAt(1)>=97&&e.path.charCodeAt(1)<=122)&&e.path.charCodeAt(2)===58?t?n=e.path.substr(1):n=e.path[1].toLowerCase()+e.path.substr(2):n=e.path,at&&(n=n.replace(/\//g,"\\")),n}function Fi(e,t){let n=t?Hl:ps,i="",{scheme:r,authority:s,path:a,query:l,fragment:o}=e;if(r&&(i+=r,i+=":"),(s||r==="file")&&(i+=ke,i+=ke),s){let u=s.indexOf("@");if(u!==-1){let c=s.substr(0,u);s=s.substr(u+1),u=c.lastIndexOf(":"),u===-1?i+=n(c,!1,!1):(i+=n(c.substr(0,u),!1,!1),i+=":",i+=n(c.substr(u+1),!1,!0)),i+="@"}s=s.toLowerCase(),u=s.lastIndexOf(":"),u===-1?i+=n(s,!1,!0):(i+=n(s.substr(0,u),!1,!0),i+=s.substr(u))}if(a){if(a.length>=3&&a.charCodeAt(0)===47&&a.charCodeAt(2)===58){let u=a.charCodeAt(1);u>=65&&u<=90&&(a=`/${String.fromCharCode(u+32)}:${a.substr(3)}`)}else if(a.length>=2&&a.charCodeAt(1)===58){let u=a.charCodeAt(0);u>=65&&u<=90&&(a=`${String.fromCharCode(u+32)}:${a.substr(2)}`)}i+=n(a,!0,!1)}return l&&(i+="?",i+=n(l,!1,!1)),o&&(i+="#",i+=t?o:ps(o,!1,!1)),i}function _s(e){try{return decodeURIComponent(e)}catch{return e.length>3?e.substr(0,3)+_s(e.substr(3)):e}}var gs=/(%[0-9A-Za-z][0-9A-Za-z])+/g;function An(e){return e.match(gs)?e.replace(gs,t=>_s(t)):e}var oe=class e{constructor(t,n){this.lineNumber=t,this.column=n}with(t=this.lineNumber,n=this.column){return t===this.lineNumber&&n===this.column?this:new e(t,n)}delta(t=0,n=0){return this.with(this.lineNumber+t,this.column+n)}equals(t){return e.equals(this,t)}static equals(t,n){return!t&&!n?!0:!!t&&!!n&&t.lineNumber===n.lineNumber&&t.column===n.column}isBefore(t){return e.isBefore(this,t)}static isBefore(t,n){return t.lineNumber<n.lineNumber?!0:n.lineNumber<t.lineNumber?!1:t.column<n.column}isBeforeOrEqual(t){return e.isBeforeOrEqual(this,t)}static isBeforeOrEqual(t,n){return t.lineNumber<n.lineNumber?!0:n.lineNumber<t.lineNumber?!1:t.column<=n.column}static compare(t,n){let i=t.lineNumber|0,r=n.lineNumber|0;if(i===r){let s=t.column|0,a=n.column|0;return s-a}return i-r}clone(){return new e(this.lineNumber,this.column)}toString(){return"("+this.lineNumber+","+this.column+")"}static lift(t){return new e(t.lineNumber,t.column)}static isIPosition(t){return t&&typeof t.lineNumber=="number"&&typeof t.column=="number"}toJSON(){return{lineNumber:this.lineNumber,column:this.column}}};var J=class e{constructor(t,n,i,r){t>i||t===i&&n>r?(this.startLineNumber=i,this.startColumn=r,this.endLineNumber=t,this.endColumn=n):(this.startLineNumber=t,this.startColumn=n,this.endLineNumber=i,this.endColumn=r)}isEmpty(){return e.isEmpty(this)}static isEmpty(t){return t.startLineNumber===t.endLineNumber&&t.startColumn===t.endColumn}containsPosition(t){return e.containsPosition(this,t)}static containsPosition(t,n){return!(n.lineNumber<t.startLineNumber||n.lineNumber>t.endLineNumber||n.lineNumber===t.startLineNumber&&n.column<t.startColumn||n.lineNumber===t.endLineNumber&&n.column>t.endColumn)}static strictContainsPosition(t,n){return!(n.lineNumber<t.startLineNumber||n.lineNumber>t.endLineNumber||n.lineNumber===t.startLineNumber&&n.column<=t.startColumn||n.lineNumber===t.endLineNumber&&n.column>=t.endColumn)}containsRange(t){return e.containsRange(this,t)}static containsRange(t,n){return!(n.startLineNumber<t.startLineNumber||n.endLineNumber<t.startLineNumber||n.startLineNumber>t.endLineNumber||n.endLineNumber>t.endLineNumber||n.startLineNumber===t.startLineNumber&&n.startColumn<t.startColumn||n.endLineNumber===t.endLineNumber&&n.endColumn>t.endColumn)}strictContainsRange(t){return e.strictContainsRange(this,t)}static strictContainsRange(t,n){return!(n.startLineNumber<t.startLineNumber||n.endLineNumber<t.startLineNumber||n.startLineNumber>t.endLineNumber||n.endLineNumber>t.endLineNumber||n.startLineNumber===t.startLineNumber&&n.startColumn<=t.startColumn||n.endLineNumber===t.endLineNumber&&n.endColumn>=t.endColumn)}plusRange(t){return e.plusRange(this,t)}static plusRange(t,n){let i,r,s,a;return n.startLineNumber<t.startLineNumber?(i=n.startLineNumber,r=n.startColumn):n.startLineNumber===t.startLineNumber?(i=n.startLineNumber,r=Math.min(n.startColumn,t.startColumn)):(i=t.startLineNumber,r=t.startColumn),n.endLineNumber>t.endLineNumber?(s=n.endLineNumber,a=n.endColumn):n.endLineNumber===t.endLineNumber?(s=n.endLineNumber,a=Math.max(n.endColumn,t.endColumn)):(s=t.endLineNumber,a=t.endColumn),new e(i,r,s,a)}intersectRanges(t){return e.intersectRanges(this,t)}static intersectRanges(t,n){let i=t.startLineNumber,r=t.startColumn,s=t.endLineNumber,a=t.endColumn,l=n.startLineNumber,o=n.startColumn,u=n.endLineNumber,c=n.endColumn;return i<l?(i=l,r=o):i===l&&(r=Math.max(r,o)),s>u?(s=u,a=c):s===u&&(a=Math.min(a,c)),i>s||i===s&&r>a?null:new e(i,r,s,a)}equalsRange(t){return e.equalsRange(this,t)}static equalsRange(t,n){return!t&&!n?!0:!!t&&!!n&&t.startLineNumber===n.startLineNumber&&t.startColumn===n.startColumn&&t.endLineNumber===n.endLineNumber&&t.endColumn===n.endColumn}getEndPosition(){return e.getEndPosition(this)}static getEndPosition(t){return new oe(t.endLineNumber,t.endColumn)}getStartPosition(){return e.getStartPosition(this)}static getStartPosition(t){return new oe(t.startLineNumber,t.startColumn)}toString(){return"["+this.startLineNumber+","+this.startColumn+" -> "+this.endLineNumber+","+this.endColumn+"]"}setEndPosition(t,n){return new e(this.startLineNumber,this.startColumn,t,n)}setStartPosition(t,n){return new e(t,n,this.endLineNumber,this.endColumn)}collapseToStart(){return e.collapseToStart(this)}static collapseToStart(t){return new e(t.startLineNumber,t.startColumn,t.startLineNumber,t.startColumn)}collapseToEnd(){return e.collapseToEnd(this)}static collapseToEnd(t){return new e(t.endLineNumber,t.endColumn,t.endLineNumber,t.endColumn)}delta(t){return new e(this.startLineNumber+t,this.startColumn,this.endLineNumber+t,this.endColumn)}static fromPositions(t,n=t){return new e(t.lineNumber,t.column,n.lineNumber,n.column)}static lift(t){return t?new e(t.startLineNumber,t.startColumn,t.endLineNumber,t.endColumn):null}static isIRange(t){return t&&typeof t.startLineNumber=="number"&&typeof t.startColumn=="number"&&typeof t.endLineNumber=="number"&&typeof t.endColumn=="number"}static areIntersectingOrTouching(t,n){return!(t.endLineNumber<n.startLineNumber||t.endLineNumber===n.startLineNumber&&t.endColumn<n.startColumn||n.endLineNumber<t.startLineNumber||n.endLineNumber===t.startLineNumber&&n.endColumn<t.startColumn)}static areIntersecting(t,n){return!(t.endLineNumber<n.startLineNumber||t.endLineNumber===n.startLineNumber&&t.endColumn<=n.startColumn||n.endLineNumber<t.startLineNumber||n.endLineNumber===t.startLineNumber&&n.endColumn<=t.startColumn)}static compareRangesUsingStarts(t,n){if(t&&n){let s=t.startLineNumber|0,a=n.startLineNumber|0;if(s===a){let l=t.startColumn|0,o=n.startColumn|0;if(l===o){let u=t.endLineNumber|0,c=n.endLineNumber|0;if(u===c){let h=t.endColumn|0,f=n.endColumn|0;return h-f}return u-c}return l-o}return s-a}return(t?1:0)-(n?1:0)}static compareRangesUsingEnds(t,n){return t.endLineNumber===n.endLineNumber?t.endColumn===n.endColumn?t.startLineNumber===n.startLineNumber?t.startColumn-n.startColumn:t.startLineNumber-n.startLineNumber:t.endColumn-n.endColumn:t.endLineNumber-n.endLineNumber}static spansMultipleLines(t){return t.endLineNumber>t.startLineNumber}toJSON(){return this}};function Hi(e){return e<0?0:e>255?255:e|0}function lt(e){return e<0?0:e>4294967295?4294967295:e|0}var kn=class{constructor(t){this.values=t,this.prefixSum=new Uint32Array(t.length),this.prefixSumValidIndex=new Int32Array(1),this.prefixSumValidIndex[0]=-1}getCount(){return this.values.length}insertValues(t,n){t=lt(t);let i=this.values,r=this.prefixSum,s=n.length;return s===0?!1:(this.values=new Uint32Array(i.length+s),this.values.set(i.subarray(0,t),0),this.values.set(i.subarray(t),t+s),this.values.set(n,t),t-1<this.prefixSumValidIndex[0]&&(this.prefixSumValidIndex[0]=t-1),this.prefixSum=new Uint32Array(this.values.length),this.prefixSumValidIndex[0]>=0&&this.prefixSum.set(r.subarray(0,this.prefixSumValidIndex[0]+1)),!0)}setValue(t,n){return t=lt(t),n=lt(n),this.values[t]===n?!1:(this.values[t]=n,t-1<this.prefixSumValidIndex[0]&&(this.prefixSumValidIndex[0]=t-1),!0)}removeValues(t,n){t=lt(t),n=lt(n);let i=this.values,r=this.prefixSum;if(t>=i.length)return!1;let s=i.length-t;return n>=s&&(n=s),n===0?!1:(this.values=new Uint32Array(i.length-n),this.values.set(i.subarray(0,t),0),this.values.set(i.subarray(t+n),t),this.prefixSum=new Uint32Array(this.values.length),t-1<this.prefixSumValidIndex[0]&&(this.prefixSumValidIndex[0]=t-1),this.prefixSumValidIndex[0]>=0&&this.prefixSum.set(r.subarray(0,this.prefixSumValidIndex[0]+1)),!0)}getTotalSum(){return this.values.length===0?0:this._getPrefixSum(this.values.length-1)}getPrefixSum(t){return t<0?0:(t=lt(t),this._getPrefixSum(t))}_getPrefixSum(t){if(t<=this.prefixSumValidIndex[0])return this.prefixSum[t];let n=this.prefixSumValidIndex[0]+1;n===0&&(this.prefixSum[0]=this.values[0],n++),t>=this.values.length&&(t=this.values.length-1);for(let i=n;i<=t;i++)this.prefixSum[i]=this.prefixSum[i-1]+this.values[i];return this.prefixSumValidIndex[0]=Math.max(this.prefixSumValidIndex[0],t),this.prefixSum[t]}getIndexOf(t){t=Math.floor(t),this.getTotalSum();let n=0,i=this.values.length-1,r=0,s=0,a=0;for(;n<=i;)if(r=n+(i-n)/2|0,s=this.prefixSum[r],a=s-this.values[r],t<a)i=r-1;else if(t>=s)n=r+1;else break;return new Wi(r,t-a)}};var Wi=class{constructor(t,n){this.index=t,this.remainder=n,this._prefixSumIndexOfResultBrand=void 0,this.index=t,this.remainder=n}};var Sn=class{constructor(t,n,i,r){this._uri=t,this._lines=n,this._eol=i,this._versionId=r,this._lineStarts=null,this._cachedTextValue=null}dispose(){this._lines.length=0}get version(){return this._versionId}getText(){return this._cachedTextValue===null&&(this._cachedTextValue=this._lines.join(this._eol)),this._cachedTextValue}onEvents(t){t.eol&&t.eol!==this._eol&&(this._eol=t.eol,this._lineStarts=null);let n=t.changes;for(let i of n)this._acceptDeleteRange(i.range),this._acceptInsertText(new oe(i.range.startLineNumber,i.range.startColumn),i.text);this._versionId=t.versionId,this._cachedTextValue=null}_ensureLineStarts(){if(!this._lineStarts){let t=this._eol.length,n=this._lines.length,i=new Uint32Array(n);for(let r=0;r<n;r++)i[r]=this._lines[r].length+t;this._lineStarts=new kn(i)}}_setLineText(t,n){this._lines[t]=n,this._lineStarts&&this._lineStarts.setValue(t,this._lines[t].length+this._eol.length)}_acceptDeleteRange(t){if(t.startLineNumber===t.endLineNumber){if(t.startColumn===t.endColumn)return;this._setLineText(t.startLineNumber-1,this._lines[t.startLineNumber-1].substring(0,t.startColumn-1)+this._lines[t.startLineNumber-1].substring(t.endColumn-1));return}this._setLineText(t.startLineNumber-1,this._lines[t.startLineNumber-1].substring(0,t.startColumn-1)+this._lines[t.endLineNumber-1].substring(t.endColumn-1)),this._lines.splice(t.startLineNumber,t.endLineNumber-t.startLineNumber),this._lineStarts&&this._lineStarts.removeValues(t.startLineNumber,t.endLineNumber-t.startLineNumber)}_acceptInsertText(t,n){if(n.length===0)return;let i=es(n);if(i.length===1){this._setLineText(t.lineNumber-1,this._lines[t.lineNumber-1].substring(0,t.column-1)+i[0]+this._lines[t.lineNumber-1].substring(t.column-1));return}i[i.length-1]+=this._lines[t.lineNumber-1].substring(t.column-1),this._setLineText(t.lineNumber-1,this._lines[t.lineNumber-1].substring(0,t.column-1)+i[0]);let r=new Uint32Array(i.length-1);for(let s=1;s<i.length;s++)this._lines.splice(t.lineNumber+s-1,0,i[s]),r[s-1]=i[s].length+this._eol.length;this._lineStarts&&this._lineStarts.insertValues(t.lineNumber,r)}};var Wl="`~!@#$%^&*()-=+[{]}\\|;:'\",.<>/?";function Bl(e=""){let t="(-?\\d*\\.\\d\\w*)|([^";for(let n of Wl)e.indexOf(n)>=0||(t+="\\"+n);return t+="\\s]+)",new RegExp(t,"g")}var Bi=Bl();function Pi(e){let t=Bi;if(e&&e instanceof RegExp)if(e.global)t=e;else{let n="g";e.ignoreCase&&(n+="i"),e.multiline&&(n+="m"),e.unicode&&(n+="u"),t=new RegExp(e.source,n)}return t.lastIndex=0,t}var ws=new zt;ws.unshift({maxLen:1e3,windowSize:15,timeBudget:150});function Ot(e,t,n,i,r){if(t=Pi(t),r||(r=mt.first(ws)),n.length>r.maxLen){let u=e-r.maxLen/2;return u<0?u=0:i+=u,n=n.substring(u,e+r.maxLen/2),Ot(e,t,n,i,r)}let s=Date.now(),a=e-1-i,l=-1,o=null;for(let u=1;!(Date.now()-s>=r.timeBudget);u++){let c=a-r.windowSize*u;t.lastIndex=Math.max(0,c);let h=Pl(t,n,a,l);if(!h&&o||(o=h,c<=0))break;l=c}if(o){let u={word:o[0],startColumn:i+1+o.index,endColumn:i+1+o.index+o[0].length};return t.lastIndex=0,u}return null}function Pl(e,t,n,i){let r;for(;r=e.exec(t);){let s=r.index||0;if(s<=n&&e.lastIndex>=n)return r;if(i>0&&s>i)return null}return null}var Tt=class e{constructor(t){let n=Hi(t);this._defaultValue=n,this._asciiMap=e._createAsciiMap(n),this._map=new Map}static _createAsciiMap(t){let n=new Uint8Array(256);return n.fill(t),n}set(t,n){let i=Hi(n);t>=0&&t<256?this._asciiMap[t]=i:this._map.set(t,i)}get(t){return t>=0&&t<256?this._asciiMap[t]:this._map.get(t)||this._defaultValue}clear(){this._asciiMap.fill(this._defaultValue),this._map.clear()}};var Oi=class{constructor(t,n,i){let r=new Uint8Array(t*n);for(let s=0,a=t*n;s<a;s++)r[s]=i;this._data=r,this.rows=t,this.cols=n}get(t,n){return this._data[t*this.cols+n]}set(t,n,i){this._data[t*this.cols+n]=i}},Vi=class{constructor(t){let n=0,i=0;for(let s=0,a=t.length;s<a;s++){let[l,o,u]=t[s];o>n&&(n=o),l>i&&(i=l),u>i&&(i=u)}n++,i++;let r=new Oi(i,n,0);for(let s=0,a=t.length;s<a;s++){let[l,o,u]=t[s];r.set(l,o,u)}this._states=r,this._maxCharCode=n}nextState(t,n){return n<0||n>=this._maxCharCode?0:this._states.get(t,n)}},qi=null;function ql(){return qi===null&&(qi=new Vi([[1,104,2],[1,72,2],[1,102,6],[1,70,6],[2,116,3],[2,84,3],[3,116,4],[3,84,4],[4,112,5],[4,80,5],[5,115,9],[5,83,9],[5,58,10],[6,105,7],[6,73,7],[7,108,8],[7,76,8],[8,101,9],[8,69,9],[9,58,10],[10,47,11],[11,47,12]])),qi}var Vt=null;function Ol(){if(Vt===null){Vt=new Tt(0);let e=` 	<>'"\u3001\u3002\uFF61\uFF64\uFF0C\uFF0E\uFF1A\uFF1B\u2018\u3008\u300C\u300E\u3014\uFF08\uFF3B\uFF5B\uFF62\uFF63\uFF5D\uFF3D\uFF09\u3015\u300F\u300D\u3009\u2019\uFF40\uFF5E\u2026`;for(let n=0;n<e.length;n++)Vt.set(e.charCodeAt(n),1);let t=".,;:";for(let n=0;n<t.length;n++)Vt.set(t.charCodeAt(n),2)}return Vt}var ji=class e{static _createLink(t,n,i,r,s){let a=s-1;do{let l=n.charCodeAt(a);if(t.get(l)!==2)break;a--}while(a>r);if(r>0){let l=n.charCodeAt(r-1),o=n.charCodeAt(a);(l===40&&o===41||l===91&&o===93||l===123&&o===125)&&a--}return{range:{startLineNumber:i,startColumn:r+1,endLineNumber:i,endColumn:a+2},url:n.substring(r,a+1)}}static computeLinks(t,n=ql()){let i=Ol(),r=[];for(let s=1,a=t.getLineCount();s<=a;s++){let l=t.getLineContent(s),o=l.length,u=0,c=0,h=0,f=1,m=!1,b=!1,p=!1,w=!1;for(;u<o;){let x=!1,_=l.charCodeAt(u);if(f===13){let y;switch(_){case 40:m=!0,y=0;break;case 41:y=m?0:1;break;case 91:p=!0,b=!0,y=0;break;case 93:p=!1,y=b?0:1;break;case 123:w=!0,y=0;break;case 125:y=w?0:1;break;case 39:case 34:case 96:h===_?y=1:h===39||h===34||h===96?y=0:y=1;break;case 42:y=h===42?1:0;break;case 124:y=h===124?1:0;break;case 32:y=p?0:1;break;default:y=i.get(_)}y===1&&(r.push(e._createLink(i,l,s,c,u)),x=!0)}else if(f===12){let y;_===91?(b=!0,y=0):y=i.get(_),y===1?x=!0:f=13}else f=n.nextState(f,_),f===0&&(x=!0);x&&(f=1,m=!1,b=!1,w=!1,c=u+1,h=_),u++}f===13&&r.push(e._createLink(i,l,s,c,o))}return r}};function ys(e){return!e||typeof e.getLineCount!="function"||typeof e.getLineContent!="function"?[]:ji.computeLinks(e)}var Ln=class e{constructor(){this._defaultValueSet=[["true","false"],["True","False"],["Private","Public","Friend","ReadOnly","Partial","Protected","WriteOnly"],["public","protected","private"]]}static{this.INSTANCE=new e}navigateValueSet(t,n,i,r,s){if(t&&n){let a=this.doNavigateValueSet(n,s);if(a)return{range:t,value:a}}if(i&&r){let a=this.doNavigateValueSet(r,s);if(a)return{range:i,value:a}}return null}doNavigateValueSet(t,n){let i=this.numberReplace(t,n);return i!==null?i:this.textReplace(t,n)}numberReplace(t,n){let i=Math.pow(10,t.length-(t.lastIndexOf(".")+1)),r=Number(t),s=parseFloat(t);return!isNaN(r)&&!isNaN(s)&&r===s?r===0&&!n?null:(r=Math.floor(r*i),r+=n?i:-i,String(r/i)):null}textReplace(t,n){return this.valueSetsReplace(this._defaultValueSet,t,n)}valueSetsReplace(t,n,i){let r=null;for(let s=0,a=t.length;r===null&&s<a;s++)r=this.valueSetReplace(t[s],n,i);return r}valueSetReplace(t,n,i){let r=t.indexOf(n);return r>=0?(r+=i?1:-1,r<0?r=t.length-1:r%=t.length,t[r]):null}};var jt=class{constructor(){this._keyCodeToStr=[],this._strToKeyCode=Object.create(null)}define(t,n){this._keyCodeToStr[t]=n,this._strToKeyCode[n.toLowerCase()]=t}keyCodeToStr(t){return this._keyCodeToStr[t]}strToKeyCode(t){return this._strToKeyCode[t.toLowerCase()]||0}},Cn=new jt,Gi=new jt,$i=new jt,Vl=new Array(230),jl={},Gl=[],$l=Object.create(null),Ql=Object.create(null);var Ts=[],Qi=[];for(let e=0;e<=193;e++)Ts[e]=-1;for(let e=0;e<=132;e++)Qi[e]=-1;(function(){let e="",t=[[1,0,"None",0,"unknown",0,"VK_UNKNOWN",e,e],[1,1,"Hyper",0,e,0,e,e,e],[1,2,"Super",0,e,0,e,e,e],[1,3,"Fn",0,e,0,e,e,e],[1,4,"FnLock",0,e,0,e,e,e],[1,5,"Suspend",0,e,0,e,e,e],[1,6,"Resume",0,e,0,e,e,e],[1,7,"Turbo",0,e,0,e,e,e],[1,8,"Sleep",0,e,0,"VK_SLEEP",e,e],[1,9,"WakeUp",0,e,0,e,e,e],[0,10,"KeyA",31,"A",65,"VK_A",e,e],[0,11,"KeyB",32,"B",66,"VK_B",e,e],[0,12,"KeyC",33,"C",67,"VK_C",e,e],[0,13,"KeyD",34,"D",68,"VK_D",e,e],[0,14,"KeyE",35,"E",69,"VK_E",e,e],[0,15,"KeyF",36,"F",70,"VK_F",e,e],[0,16,"KeyG",37,"G",71,"VK_G",e,e],[0,17,"KeyH",38,"H",72,"VK_H",e,e],[0,18,"KeyI",39,"I",73,"VK_I",e,e],[0,19,"KeyJ",40,"J",74,"VK_J",e,e],[0,20,"KeyK",41,"K",75,"VK_K",e,e],[0,21,"KeyL",42,"L",76,"VK_L",e,e],[0,22,"KeyM",43,"M",77,"VK_M",e,e],[0,23,"KeyN",44,"N",78,"VK_N",e,e],[0,24,"KeyO",45,"O",79,"VK_O",e,e],[0,25,"KeyP",46,"P",80,"VK_P",e,e],[0,26,"KeyQ",47,"Q",81,"VK_Q",e,e],[0,27,"KeyR",48,"R",82,"VK_R",e,e],[0,28,"KeyS",49,"S",83,"VK_S",e,e],[0,29,"KeyT",50,"T",84,"VK_T",e,e],[0,30,"KeyU",51,"U",85,"VK_U",e,e],[0,31,"KeyV",52,"V",86,"VK_V",e,e],[0,32,"KeyW",53,"W",87,"VK_W",e,e],[0,33,"KeyX",54,"X",88,"VK_X",e,e],[0,34,"KeyY",55,"Y",89,"VK_Y",e,e],[0,35,"KeyZ",56,"Z",90,"VK_Z",e,e],[0,36,"Digit1",22,"1",49,"VK_1",e,e],[0,37,"Digit2",23,"2",50,"VK_2",e,e],[0,38,"Digit3",24,"3",51,"VK_3",e,e],[0,39,"Digit4",25,"4",52,"VK_4",e,e],[0,40,"Digit5",26,"5",53,"VK_5",e,e],[0,41,"Digit6",27,"6",54,"VK_6",e,e],[0,42,"Digit7",28,"7",55,"VK_7",e,e],[0,43,"Digit8",29,"8",56,"VK_8",e,e],[0,44,"Digit9",30,"9",57,"VK_9",e,e],[0,45,"Digit0",21,"0",48,"VK_0",e,e],[1,46,"Enter",3,"Enter",13,"VK_RETURN",e,e],[1,47,"Escape",9,"Escape",27,"VK_ESCAPE",e,e],[1,48,"Backspace",1,"Backspace",8,"VK_BACK",e,e],[1,49,"Tab",2,"Tab",9,"VK_TAB",e,e],[1,50,"Space",10,"Space",32,"VK_SPACE",e,e],[0,51,"Minus",88,"-",189,"VK_OEM_MINUS","-","OEM_MINUS"],[0,52,"Equal",86,"=",187,"VK_OEM_PLUS","=","OEM_PLUS"],[0,53,"BracketLeft",92,"[",219,"VK_OEM_4","[","OEM_4"],[0,54,"BracketRight",94,"]",221,"VK_OEM_6","]","OEM_6"],[0,55,"Backslash",93,"\\",220,"VK_OEM_5","\\","OEM_5"],[0,56,"IntlHash",0,e,0,e,e,e],[0,57,"Semicolon",85,";",186,"VK_OEM_1",";","OEM_1"],[0,58,"Quote",95,"'",222,"VK_OEM_7","'","OEM_7"],[0,59,"Backquote",91,"`",192,"VK_OEM_3","`","OEM_3"],[0,60,"Comma",87,",",188,"VK_OEM_COMMA",",","OEM_COMMA"],[0,61,"Period",89,".",190,"VK_OEM_PERIOD",".","OEM_PERIOD"],[0,62,"Slash",90,"/",191,"VK_OEM_2","/","OEM_2"],[1,63,"CapsLock",8,"CapsLock",20,"VK_CAPITAL",e,e],[1,64,"F1",59,"F1",112,"VK_F1",e,e],[1,65,"F2",60,"F2",113,"VK_F2",e,e],[1,66,"F3",61,"F3",114,"VK_F3",e,e],[1,67,"F4",62,"F4",115,"VK_F4",e,e],[1,68,"F5",63,"F5",116,"VK_F5",e,e],[1,69,"F6",64,"F6",117,"VK_F6",e,e],[1,70,"F7",65,"F7",118,"VK_F7",e,e],[1,71,"F8",66,"F8",119,"VK_F8",e,e],[1,72,"F9",67,"F9",120,"VK_F9",e,e],[1,73,"F10",68,"F10",121,"VK_F10",e,e],[1,74,"F11",69,"F11",122,"VK_F11",e,e],[1,75,"F12",70,"F12",123,"VK_F12",e,e],[1,76,"PrintScreen",0,e,0,e,e,e],[1,77,"ScrollLock",84,"ScrollLock",145,"VK_SCROLL",e,e],[1,78,"Pause",7,"PauseBreak",19,"VK_PAUSE",e,e],[1,79,"Insert",19,"Insert",45,"VK_INSERT",e,e],[1,80,"Home",14,"Home",36,"VK_HOME",e,e],[1,81,"PageUp",11,"PageUp",33,"VK_PRIOR",e,e],[1,82,"Delete",20,"Delete",46,"VK_DELETE",e,e],[1,83,"End",13,"End",35,"VK_END",e,e],[1,84,"PageDown",12,"PageDown",34,"VK_NEXT",e,e],[1,85,"ArrowRight",17,"RightArrow",39,"VK_RIGHT","Right",e],[1,86,"ArrowLeft",15,"LeftArrow",37,"VK_LEFT","Left",e],[1,87,"ArrowDown",18,"DownArrow",40,"VK_DOWN","Down",e],[1,88,"ArrowUp",16,"UpArrow",38,"VK_UP","Up",e],[1,89,"NumLock",83,"NumLock",144,"VK_NUMLOCK",e,e],[1,90,"NumpadDivide",113,"NumPad_Divide",111,"VK_DIVIDE",e,e],[1,91,"NumpadMultiply",108,"NumPad_Multiply",106,"VK_MULTIPLY",e,e],[1,92,"NumpadSubtract",111,"NumPad_Subtract",109,"VK_SUBTRACT",e,e],[1,93,"NumpadAdd",109,"NumPad_Add",107,"VK_ADD",e,e],[1,94,"NumpadEnter",3,e,0,e,e,e],[1,95,"Numpad1",99,"NumPad1",97,"VK_NUMPAD1",e,e],[1,96,"Numpad2",100,"NumPad2",98,"VK_NUMPAD2",e,e],[1,97,"Numpad3",101,"NumPad3",99,"VK_NUMPAD3",e,e],[1,98,"Numpad4",102,"NumPad4",100,"VK_NUMPAD4",e,e],[1,99,"Numpad5",103,"NumPad5",101,"VK_NUMPAD5",e,e],[1,100,"Numpad6",104,"NumPad6",102,"VK_NUMPAD6",e,e],[1,101,"Numpad7",105,"NumPad7",103,"VK_NUMPAD7",e,e],[1,102,"Numpad8",106,"NumPad8",104,"VK_NUMPAD8",e,e],[1,103,"Numpad9",107,"NumPad9",105,"VK_NUMPAD9",e,e],[1,104,"Numpad0",98,"NumPad0",96,"VK_NUMPAD0",e,e],[1,105,"NumpadDecimal",112,"NumPad_Decimal",110,"VK_DECIMAL",e,e],[0,106,"IntlBackslash",97,"OEM_102",226,"VK_OEM_102",e,e],[1,107,"ContextMenu",58,"ContextMenu",93,e,e,e],[1,108,"Power",0,e,0,e,e,e],[1,109,"NumpadEqual",0,e,0,e,e,e],[1,110,"F13",71,"F13",124,"VK_F13",e,e],[1,111,"F14",72,"F14",125,"VK_F14",e,e],[1,112,"F15",73,"F15",126,"VK_F15",e,e],[1,113,"F16",74,"F16",127,"VK_F16",e,e],[1,114,"F17",75,"F17",128,"VK_F17",e,e],[1,115,"F18",76,"F18",129,"VK_F18",e,e],[1,116,"F19",77,"F19",130,"VK_F19",e,e],[1,117,"F20",78,"F20",131,"VK_F20",e,e],[1,118,"F21",79,"F21",132,"VK_F21",e,e],[1,119,"F22",80,"F22",133,"VK_F22",e,e],[1,120,"F23",81,"F23",134,"VK_F23",e,e],[1,121,"F24",82,"F24",135,"VK_F24",e,e],[1,122,"Open",0,e,0,e,e,e],[1,123,"Help",0,e,0,e,e,e],[1,124,"Select",0,e,0,e,e,e],[1,125,"Again",0,e,0,e,e,e],[1,126,"Undo",0,e,0,e,e,e],[1,127,"Cut",0,e,0,e,e,e],[1,128,"Copy",0,e,0,e,e,e],[1,129,"Paste",0,e,0,e,e,e],[1,130,"Find",0,e,0,e,e,e],[1,131,"AudioVolumeMute",117,"AudioVolumeMute",173,"VK_VOLUME_MUTE",e,e],[1,132,"AudioVolumeUp",118,"AudioVolumeUp",175,"VK_VOLUME_UP",e,e],[1,133,"AudioVolumeDown",119,"AudioVolumeDown",174,"VK_VOLUME_DOWN",e,e],[1,134,"NumpadComma",110,"NumPad_Separator",108,"VK_SEPARATOR",e,e],[0,135,"IntlRo",115,"ABNT_C1",193,"VK_ABNT_C1",e,e],[1,136,"KanaMode",0,e,0,e,e,e],[0,137,"IntlYen",0,e,0,e,e,e],[1,138,"Convert",0,e,0,e,e,e],[1,139,"NonConvert",0,e,0,e,e,e],[1,140,"Lang1",0,e,0,e,e,e],[1,141,"Lang2",0,e,0,e,e,e],[1,142,"Lang3",0,e,0,e,e,e],[1,143,"Lang4",0,e,0,e,e,e],[1,144,"Lang5",0,e,0,e,e,e],[1,145,"Abort",0,e,0,e,e,e],[1,146,"Props",0,e,0,e,e,e],[1,147,"NumpadParenLeft",0,e,0,e,e,e],[1,148,"NumpadParenRight",0,e,0,e,e,e],[1,149,"NumpadBackspace",0,e,0,e,e,e],[1,150,"NumpadMemoryStore",0,e,0,e,e,e],[1,151,"NumpadMemoryRecall",0,e,0,e,e,e],[1,152,"NumpadMemoryClear",0,e,0,e,e,e],[1,153,"NumpadMemoryAdd",0,e,0,e,e,e],[1,154,"NumpadMemorySubtract",0,e,0,e,e,e],[1,155,"NumpadClear",131,"Clear",12,"VK_CLEAR",e,e],[1,156,"NumpadClearEntry",0,e,0,e,e,e],[1,0,e,5,"Ctrl",17,"VK_CONTROL",e,e],[1,0,e,4,"Shift",16,"VK_SHIFT",e,e],[1,0,e,6,"Alt",18,"VK_MENU",e,e],[1,0,e,57,"Meta",91,"VK_COMMAND",e,e],[1,157,"ControlLeft",5,e,0,"VK_LCONTROL",e,e],[1,158,"ShiftLeft",4,e,0,"VK_LSHIFT",e,e],[1,159,"AltLeft",6,e,0,"VK_LMENU",e,e],[1,160,"MetaLeft",57,e,0,"VK_LWIN",e,e],[1,161,"ControlRight",5,e,0,"VK_RCONTROL",e,e],[1,162,"ShiftRight",4,e,0,"VK_RSHIFT",e,e],[1,163,"AltRight",6,e,0,"VK_RMENU",e,e],[1,164,"MetaRight",57,e,0,"VK_RWIN",e,e],[1,165,"BrightnessUp",0,e,0,e,e,e],[1,166,"BrightnessDown",0,e,0,e,e,e],[1,167,"MediaPlay",0,e,0,e,e,e],[1,168,"MediaRecord",0,e,0,e,e,e],[1,169,"MediaFastForward",0,e,0,e,e,e],[1,170,"MediaRewind",0,e,0,e,e,e],[1,171,"MediaTrackNext",124,"MediaTrackNext",176,"VK_MEDIA_NEXT_TRACK",e,e],[1,172,"MediaTrackPrevious",125,"MediaTrackPrevious",177,"VK_MEDIA_PREV_TRACK",e,e],[1,173,"MediaStop",126,"MediaStop",178,"VK_MEDIA_STOP",e,e],[1,174,"Eject",0,e,0,e,e,e],[1,175,"MediaPlayPause",127,"MediaPlayPause",179,"VK_MEDIA_PLAY_PAUSE",e,e],[1,176,"MediaSelect",128,"LaunchMediaPlayer",181,"VK_MEDIA_LAUNCH_MEDIA_SELECT",e,e],[1,177,"LaunchMail",129,"LaunchMail",180,"VK_MEDIA_LAUNCH_MAIL",e,e],[1,178,"LaunchApp2",130,"LaunchApp2",183,"VK_MEDIA_LAUNCH_APP2",e,e],[1,179,"LaunchApp1",0,e,0,"VK_MEDIA_LAUNCH_APP1",e,e],[1,180,"SelectTask",0,e,0,e,e,e],[1,181,"LaunchScreenSaver",0,e,0,e,e,e],[1,182,"BrowserSearch",120,"BrowserSearch",170,"VK_BROWSER_SEARCH",e,e],[1,183,"BrowserHome",121,"BrowserHome",172,"VK_BROWSER_HOME",e,e],[1,184,"BrowserBack",122,"BrowserBack",166,"VK_BROWSER_BACK",e,e],[1,185,"BrowserForward",123,"BrowserForward",167,"VK_BROWSER_FORWARD",e,e],[1,186,"BrowserStop",0,e,0,"VK_BROWSER_STOP",e,e],[1,187,"BrowserRefresh",0,e,0,"VK_BROWSER_REFRESH",e,e],[1,188,"BrowserFavorites",0,e,0,"VK_BROWSER_FAVORITES",e,e],[1,189,"ZoomToggle",0,e,0,e,e,e],[1,190,"MailReply",0,e,0,e,e,e],[1,191,"MailForward",0,e,0,e,e,e],[1,192,"MailSend",0,e,0,e,e,e],[1,0,e,114,"KeyInComposition",229,e,e,e],[1,0,e,116,"ABNT_C2",194,"VK_ABNT_C2",e,e],[1,0,e,96,"OEM_8",223,"VK_OEM_8",e,e],[1,0,e,0,e,0,"VK_KANA",e,e],[1,0,e,0,e,0,"VK_HANGUL",e,e],[1,0,e,0,e,0,"VK_JUNJA",e,e],[1,0,e,0,e,0,"VK_FINAL",e,e],[1,0,e,0,e,0,"VK_HANJA",e,e],[1,0,e,0,e,0,"VK_KANJI",e,e],[1,0,e,0,e,0,"VK_CONVERT",e,e],[1,0,e,0,e,0,"VK_NONCONVERT",e,e],[1,0,e,0,e,0,"VK_ACCEPT",e,e],[1,0,e,0,e,0,"VK_MODECHANGE",e,e],[1,0,e,0,e,0,"VK_SELECT",e,e],[1,0,e,0,e,0,"VK_PRINT",e,e],[1,0,e,0,e,0,"VK_EXECUTE",e,e],[1,0,e,0,e,0,"VK_SNAPSHOT",e,e],[1,0,e,0,e,0,"VK_HELP",e,e],[1,0,e,0,e,0,"VK_APPS",e,e],[1,0,e,0,e,0,"VK_PROCESSKEY",e,e],[1,0,e,0,e,0,"VK_PACKET",e,e],[1,0,e,0,e,0,"VK_DBE_SBCSCHAR",e,e],[1,0,e,0,e,0,"VK_DBE_DBCSCHAR",e,e],[1,0,e,0,e,0,"VK_ATTN",e,e],[1,0,e,0,e,0,"VK_CRSEL",e,e],[1,0,e,0,e,0,"VK_EXSEL",e,e],[1,0,e,0,e,0,"VK_EREOF",e,e],[1,0,e,0,e,0,"VK_PLAY",e,e],[1,0,e,0,e,0,"VK_ZOOM",e,e],[1,0,e,0,e,0,"VK_NONAME",e,e],[1,0,e,0,e,0,"VK_PA1",e,e],[1,0,e,0,e,0,"VK_OEM_CLEAR",e,e]],n=[],i=[];for(let r of t){let[s,a,l,o,u,c,h,f,m]=r;if(i[a]||(i[a]=!0,Gl[a]=l,$l[l]=a,Ql[l.toLowerCase()]=a,s&&(Ts[a]=o,o!==0&&o!==3&&o!==5&&o!==4&&o!==6&&o!==57&&(Qi[o]=a))),!n[o]){if(n[o]=!0,!u)throw new Error(`String representation missing for key code ${o} around scan code ${l}`);Cn.define(o,u),Gi.define(o,f||u),$i.define(o,m||f||u)}c&&(Vl[c]=o),h&&(jl[h]=o)}Qi[3]=46})();var xs;(function(e){function t(l){return Cn.keyCodeToStr(l)}e.toString=t;function n(l){return Cn.strToKeyCode(l)}e.fromString=n;function i(l){return Gi.keyCodeToStr(l)}e.toUserSettingsUS=i;function r(l){return $i.keyCodeToStr(l)}e.toUserSettingsGeneral=r;function s(l){return Gi.strToKeyCode(l)||$i.strToKeyCode(l)}e.fromUserSettings=s;function a(l){if(l>=98&&l<=113)return null;switch(l){case 16:return"Up";case 18:return"Down";case 15:return"Left";case 17:return"Right"}return Cn.keyCodeToStr(l)}e.toElectronAccelerator=a})(xs||(xs={}));function As(e,t){let n=(t&65535)<<16>>>0;return(e|n)>>>0}var En=class e extends J{constructor(t,n,i,r){super(t,n,i,r),this.selectionStartLineNumber=t,this.selectionStartColumn=n,this.positionLineNumber=i,this.positionColumn=r}toString(){return"["+this.selectionStartLineNumber+","+this.selectionStartColumn+" -> "+this.positionLineNumber+","+this.positionColumn+"]"}equalsSelection(t){return e.selectionsEqual(this,t)}static selectionsEqual(t,n){return t.selectionStartLineNumber===n.selectionStartLineNumber&&t.selectionStartColumn===n.selectionStartColumn&&t.positionLineNumber===n.positionLineNumber&&t.positionColumn===n.positionColumn}getDirection(){return this.selectionStartLineNumber===this.startLineNumber&&this.selectionStartColumn===this.startColumn?0:1}setEndPosition(t,n){return this.getDirection()===0?new e(this.startLineNumber,this.startColumn,t,n):new e(t,n,this.startLineNumber,this.startColumn)}getPosition(){return new oe(this.positionLineNumber,this.positionColumn)}getSelectionStart(){return new oe(this.selectionStartLineNumber,this.selectionStartColumn)}setStartPosition(t,n){return this.getDirection()===0?new e(t,n,this.endLineNumber,this.endColumn):new e(this.endLineNumber,this.endColumn,t,n)}static fromPositions(t,n=t){return new e(t.lineNumber,t.column,n.lineNumber,n.column)}static fromRange(t,n){return n===0?new e(t.startLineNumber,t.startColumn,t.endLineNumber,t.endColumn):new e(t.endLineNumber,t.endColumn,t.startLineNumber,t.startColumn)}static liftSelection(t){return new e(t.selectionStartLineNumber,t.selectionStartColumn,t.positionLineNumber,t.positionColumn)}static selectionsArrEqual(t,n){if(t&&!n||!t&&n)return!1;if(!t&&!n)return!0;if(t.length!==n.length)return!1;for(let i=0,r=t.length;i<r;i++)if(!this.selectionsEqual(t[i],n[i]))return!1;return!0}static isISelection(t){return t&&typeof t.selectionStartLineNumber=="number"&&typeof t.selectionStartColumn=="number"&&typeof t.positionLineNumber=="number"&&typeof t.positionColumn=="number"}static createWithDirection(t,n,i,r,s){return s===0?new e(t,n,i,r):new e(i,r,t,n)}};var ks=Object.create(null);function d(e,t){if(qr(t)){let n=ks[t];if(n===void 0)throw new Error(`${e} references an unknown codicon: ${t}`);t=n}return ks[e]=t,{id:e}}var O={add:d("add",6e4),plus:d("plus",6e4),gistNew:d("gist-new",6e4),repoCreate:d("repo-create",6e4),lightbulb:d("lightbulb",60001),lightBulb:d("light-bulb",60001),repo:d("repo",60002),repoDelete:d("repo-delete",60002),gistFork:d("gist-fork",60003),repoForked:d("repo-forked",60003),gitPullRequest:d("git-pull-request",60004),gitPullRequestAbandoned:d("git-pull-request-abandoned",60004),recordKeys:d("record-keys",60005),keyboard:d("keyboard",60005),tag:d("tag",60006),tagAdd:d("tag-add",60006),tagRemove:d("tag-remove",60006),gitPullRequestLabel:d("git-pull-request-label",60006),person:d("person",60007),personFollow:d("person-follow",60007),personOutline:d("person-outline",60007),personFilled:d("person-filled",60007),gitBranch:d("git-branch",60008),gitBranchCreate:d("git-branch-create",60008),gitBranchDelete:d("git-branch-delete",60008),sourceControl:d("source-control",60008),mirror:d("mirror",60009),mirrorPublic:d("mirror-public",60009),star:d("star",60010),starAdd:d("star-add",60010),starDelete:d("star-delete",60010),starEmpty:d("star-empty",60010),comment:d("comment",60011),commentAdd:d("comment-add",60011),alert:d("alert",60012),warning:d("warning",60012),search:d("search",60013),searchSave:d("search-save",60013),logOut:d("log-out",60014),signOut:d("sign-out",60014),logIn:d("log-in",60015),signIn:d("sign-in",60015),eye:d("eye",60016),eyeUnwatch:d("eye-unwatch",60016),eyeWatch:d("eye-watch",60016),circleFilled:d("circle-filled",60017),primitiveDot:d("primitive-dot",60017),closeDirty:d("close-dirty",60017),debugBreakpoint:d("debug-breakpoint",60017),debugBreakpointDisabled:d("debug-breakpoint-disabled",60017),debugBreakpointPending:d("debug-breakpoint-pending",60377),debugHint:d("debug-hint",60017),primitiveSquare:d("primitive-square",60018),edit:d("edit",60019),pencil:d("pencil",60019),info:d("info",60020),issueOpened:d("issue-opened",60020),gistPrivate:d("gist-private",60021),gitForkPrivate:d("git-fork-private",60021),lock:d("lock",60021),mirrorPrivate:d("mirror-private",60021),close:d("close",60022),removeClose:d("remove-close",60022),x:d("x",60022),repoSync:d("repo-sync",60023),sync:d("sync",60023),clone:d("clone",60024),desktopDownload:d("desktop-download",60024),beaker:d("beaker",60025),microscope:d("microscope",60025),vm:d("vm",60026),deviceDesktop:d("device-desktop",60026),file:d("file",60027),fileText:d("file-text",60027),more:d("more",60028),ellipsis:d("ellipsis",60028),kebabHorizontal:d("kebab-horizontal",60028),mailReply:d("mail-reply",60029),reply:d("reply",60029),organization:d("organization",60030),organizationFilled:d("organization-filled",60030),organizationOutline:d("organization-outline",60030),newFile:d("new-file",60031),fileAdd:d("file-add",60031),newFolder:d("new-folder",60032),fileDirectoryCreate:d("file-directory-create",60032),trash:d("trash",60033),trashcan:d("trashcan",60033),history:d("history",60034),clock:d("clock",60034),folder:d("folder",60035),fileDirectory:d("file-directory",60035),symbolFolder:d("symbol-folder",60035),logoGithub:d("logo-github",60036),markGithub:d("mark-github",60036),github:d("github",60036),terminal:d("terminal",60037),console:d("console",60037),repl:d("repl",60037),zap:d("zap",60038),symbolEvent:d("symbol-event",60038),error:d("error",60039),stop:d("stop",60039),variable:d("variable",60040),symbolVariable:d("symbol-variable",60040),array:d("array",60042),symbolArray:d("symbol-array",60042),symbolModule:d("symbol-module",60043),symbolPackage:d("symbol-package",60043),symbolNamespace:d("symbol-namespace",60043),symbolObject:d("symbol-object",60043),symbolMethod:d("symbol-method",60044),symbolFunction:d("symbol-function",60044),symbolConstructor:d("symbol-constructor",60044),symbolBoolean:d("symbol-boolean",60047),symbolNull:d("symbol-null",60047),symbolNumeric:d("symbol-numeric",60048),symbolNumber:d("symbol-number",60048),symbolStructure:d("symbol-structure",60049),symbolStruct:d("symbol-struct",60049),symbolParameter:d("symbol-parameter",60050),symbolTypeParameter:d("symbol-type-parameter",60050),symbolKey:d("symbol-key",60051),symbolText:d("symbol-text",60051),symbolReference:d("symbol-reference",60052),goToFile:d("go-to-file",60052),symbolEnum:d("symbol-enum",60053),symbolValue:d("symbol-value",60053),symbolRuler:d("symbol-ruler",60054),symbolUnit:d("symbol-unit",60054),activateBreakpoints:d("activate-breakpoints",60055),archive:d("archive",60056),arrowBoth:d("arrow-both",60057),arrowDown:d("arrow-down",60058),arrowLeft:d("arrow-left",60059),arrowRight:d("arrow-right",60060),arrowSmallDown:d("arrow-small-down",60061),arrowSmallLeft:d("arrow-small-left",60062),arrowSmallRight:d("arrow-small-right",60063),arrowSmallUp:d("arrow-small-up",60064),arrowUp:d("arrow-up",60065),bell:d("bell",60066),bold:d("bold",60067),book:d("book",60068),bookmark:d("bookmark",60069),debugBreakpointConditionalUnverified:d("debug-breakpoint-conditional-unverified",60070),debugBreakpointConditional:d("debug-breakpoint-conditional",60071),debugBreakpointConditionalDisabled:d("debug-breakpoint-conditional-disabled",60071),debugBreakpointDataUnverified:d("debug-breakpoint-data-unverified",60072),debugBreakpointData:d("debug-breakpoint-data",60073),debugBreakpointDataDisabled:d("debug-breakpoint-data-disabled",60073),debugBreakpointLogUnverified:d("debug-breakpoint-log-unverified",60074),debugBreakpointLog:d("debug-breakpoint-log",60075),debugBreakpointLogDisabled:d("debug-breakpoint-log-disabled",60075),briefcase:d("briefcase",60076),broadcast:d("broadcast",60077),browser:d("browser",60078),bug:d("bug",60079),calendar:d("calendar",60080),caseSensitive:d("case-sensitive",60081),check:d("check",60082),checklist:d("checklist",60083),chevronDown:d("chevron-down",60084),dropDownButton:d("drop-down-button",60084),chevronLeft:d("chevron-left",60085),chevronRight:d("chevron-right",60086),chevronUp:d("chevron-up",60087),chromeClose:d("chrome-close",60088),chromeMaximize:d("chrome-maximize",60089),chromeMinimize:d("chrome-minimize",60090),chromeRestore:d("chrome-restore",60091),circle:d("circle",60092),circleOutline:d("circle-outline",60092),debugBreakpointUnverified:d("debug-breakpoint-unverified",60092),circleSlash:d("circle-slash",60093),circuitBoard:d("circuit-board",60094),clearAll:d("clear-all",60095),clippy:d("clippy",60096),closeAll:d("close-all",60097),cloudDownload:d("cloud-download",60098),cloudUpload:d("cloud-upload",60099),code:d("code",60100),collapseAll:d("collapse-all",60101),colorMode:d("color-mode",60102),commentDiscussion:d("comment-discussion",60103),compareChanges:d("compare-changes",60157),creditCard:d("credit-card",60105),dash:d("dash",60108),dashboard:d("dashboard",60109),database:d("database",60110),debugContinue:d("debug-continue",60111),debugDisconnect:d("debug-disconnect",60112),debugPause:d("debug-pause",60113),debugRestart:d("debug-restart",60114),debugStart:d("debug-start",60115),debugStepInto:d("debug-step-into",60116),debugStepOut:d("debug-step-out",60117),debugStepOver:d("debug-step-over",60118),debugStop:d("debug-stop",60119),debug:d("debug",60120),deviceCameraVideo:d("device-camera-video",60121),deviceCamera:d("device-camera",60122),deviceMobile:d("device-mobile",60123),diffAdded:d("diff-added",60124),diffIgnored:d("diff-ignored",60125),diffModified:d("diff-modified",60126),diffRemoved:d("diff-removed",60127),diffRenamed:d("diff-renamed",60128),diff:d("diff",60129),discard:d("discard",60130),editorLayout:d("editor-layout",60131),emptyWindow:d("empty-window",60132),exclude:d("exclude",60133),extensions:d("extensions",60134),eyeClosed:d("eye-closed",60135),fileBinary:d("file-binary",60136),fileCode:d("file-code",60137),fileMedia:d("file-media",60138),filePdf:d("file-pdf",60139),fileSubmodule:d("file-submodule",60140),fileSymlinkDirectory:d("file-symlink-directory",60141),fileSymlinkFile:d("file-symlink-file",60142),fileZip:d("file-zip",60143),files:d("files",60144),filter:d("filter",60145),flame:d("flame",60146),foldDown:d("fold-down",60147),foldUp:d("fold-up",60148),fold:d("fold",60149),folderActive:d("folder-active",60150),folderOpened:d("folder-opened",60151),gear:d("gear",60152),gift:d("gift",60153),gistSecret:d("gist-secret",60154),gist:d("gist",60155),gitCommit:d("git-commit",60156),gitCompare:d("git-compare",60157),gitMerge:d("git-merge",60158),githubAction:d("github-action",60159),githubAlt:d("github-alt",60160),globe:d("globe",60161),grabber:d("grabber",60162),graph:d("graph",60163),gripper:d("gripper",60164),heart:d("heart",60165),home:d("home",60166),horizontalRule:d("horizontal-rule",60167),hubot:d("hubot",60168),inbox:d("inbox",60169),issueClosed:d("issue-closed",60324),issueReopened:d("issue-reopened",60171),issues:d("issues",60172),italic:d("italic",60173),jersey:d("jersey",60174),json:d("json",60175),bracket:d("bracket",60175),kebabVertical:d("kebab-vertical",60176),key:d("key",60177),law:d("law",60178),lightbulbAutofix:d("lightbulb-autofix",60179),linkExternal:d("link-external",60180),link:d("link",60181),listOrdered:d("list-ordered",60182),listUnordered:d("list-unordered",60183),liveShare:d("live-share",60184),loading:d("loading",60185),location:d("location",60186),mailRead:d("mail-read",60187),mail:d("mail",60188),markdown:d("markdown",60189),megaphone:d("megaphone",60190),mention:d("mention",60191),milestone:d("milestone",60192),gitPullRequestMilestone:d("git-pull-request-milestone",60192),mortarBoard:d("mortar-board",60193),move:d("move",60194),multipleWindows:d("multiple-windows",60195),mute:d("mute",60196),noNewline:d("no-newline",60197),note:d("note",60198),octoface:d("octoface",60199),openPreview:d("open-preview",60200),package:d("package",60201),paintcan:d("paintcan",60202),pin:d("pin",60203),play:d("play",60204),run:d("run",60204),plug:d("plug",60205),preserveCase:d("preserve-case",60206),preview:d("preview",60207),project:d("project",60208),pulse:d("pulse",60209),question:d("question",60210),quote:d("quote",60211),radioTower:d("radio-tower",60212),reactions:d("reactions",60213),references:d("references",60214),refresh:d("refresh",60215),regex:d("regex",60216),remoteExplorer:d("remote-explorer",60217),remote:d("remote",60218),remove:d("remove",60219),replaceAll:d("replace-all",60220),replace:d("replace",60221),repoClone:d("repo-clone",60222),repoForcePush:d("repo-force-push",60223),repoPull:d("repo-pull",60224),repoPush:d("repo-push",60225),report:d("report",60226),requestChanges:d("request-changes",60227),rocket:d("rocket",60228),rootFolderOpened:d("root-folder-opened",60229),rootFolder:d("root-folder",60230),rss:d("rss",60231),ruby:d("ruby",60232),saveAll:d("save-all",60233),saveAs:d("save-as",60234),save:d("save",60235),screenFull:d("screen-full",60236),screenNormal:d("screen-normal",60237),searchStop:d("search-stop",60238),server:d("server",60240),settingsGear:d("settings-gear",60241),settings:d("settings",60242),shield:d("shield",60243),smiley:d("smiley",60244),sortPrecedence:d("sort-precedence",60245),splitHorizontal:d("split-horizontal",60246),splitVertical:d("split-vertical",60247),squirrel:d("squirrel",60248),starFull:d("star-full",60249),starHalf:d("star-half",60250),symbolClass:d("symbol-class",60251),symbolColor:d("symbol-color",60252),symbolCustomColor:d("symbol-customcolor",60252),symbolConstant:d("symbol-constant",60253),symbolEnumMember:d("symbol-enum-member",60254),symbolField:d("symbol-field",60255),symbolFile:d("symbol-file",60256),symbolInterface:d("symbol-interface",60257),symbolKeyword:d("symbol-keyword",60258),symbolMisc:d("symbol-misc",60259),symbolOperator:d("symbol-operator",60260),symbolProperty:d("symbol-property",60261),wrench:d("wrench",60261),wrenchSubaction:d("wrench-subaction",60261),symbolSnippet:d("symbol-snippet",60262),tasklist:d("tasklist",60263),telescope:d("telescope",60264),textSize:d("text-size",60265),threeBars:d("three-bars",60266),thumbsdown:d("thumbsdown",60267),thumbsup:d("thumbsup",60268),tools:d("tools",60269),triangleDown:d("triangle-down",60270),triangleLeft:d("triangle-left",60271),triangleRight:d("triangle-right",60272),triangleUp:d("triangle-up",60273),twitter:d("twitter",60274),unfold:d("unfold",60275),unlock:d("unlock",60276),unmute:d("unmute",60277),unverified:d("unverified",60278),verified:d("verified",60279),versions:d("versions",60280),vmActive:d("vm-active",60281),vmOutline:d("vm-outline",60282),vmRunning:d("vm-running",60283),watch:d("watch",60284),whitespace:d("whitespace",60285),wholeWord:d("whole-word",60286),window:d("window",60287),wordWrap:d("word-wrap",60288),zoomIn:d("zoom-in",60289),zoomOut:d("zoom-out",60290),listFilter:d("list-filter",60291),listFlat:d("list-flat",60292),listSelection:d("list-selection",60293),selection:d("selection",60293),listTree:d("list-tree",60294),debugBreakpointFunctionUnverified:d("debug-breakpoint-function-unverified",60295),debugBreakpointFunction:d("debug-breakpoint-function",60296),debugBreakpointFunctionDisabled:d("debug-breakpoint-function-disabled",60296),debugStackframeActive:d("debug-stackframe-active",60297),circleSmallFilled:d("circle-small-filled",60298),debugStackframeDot:d("debug-stackframe-dot",60298),debugStackframe:d("debug-stackframe",60299),debugStackframeFocused:d("debug-stackframe-focused",60299),debugBreakpointUnsupported:d("debug-breakpoint-unsupported",60300),symbolString:d("symbol-string",60301),debugReverseContinue:d("debug-reverse-continue",60302),debugStepBack:d("debug-step-back",60303),debugRestartFrame:d("debug-restart-frame",60304),callIncoming:d("call-incoming",60306),callOutgoing:d("call-outgoing",60307),menu:d("menu",60308),expandAll:d("expand-all",60309),feedback:d("feedback",60310),gitPullRequestReviewer:d("git-pull-request-reviewer",60310),groupByRefType:d("group-by-ref-type",60311),ungroupByRefType:d("ungroup-by-ref-type",60312),account:d("account",60313),gitPullRequestAssignee:d("git-pull-request-assignee",60313),bellDot:d("bell-dot",60314),debugConsole:d("debug-console",60315),library:d("library",60316),output:d("output",60317),runAll:d("run-all",60318),syncIgnored:d("sync-ignored",60319),pinned:d("pinned",60320),githubInverted:d("github-inverted",60321),debugAlt:d("debug-alt",60305),serverProcess:d("server-process",60322),serverEnvironment:d("server-environment",60323),pass:d("pass",60324),stopCircle:d("stop-circle",60325),playCircle:d("play-circle",60326),record:d("record",60327),debugAltSmall:d("debug-alt-small",60328),vmConnect:d("vm-connect",60329),cloud:d("cloud",60330),merge:d("merge",60331),exportIcon:d("export",60332),graphLeft:d("graph-left",60333),magnet:d("magnet",60334),notebook:d("notebook",60335),redo:d("redo",60336),checkAll:d("check-all",60337),pinnedDirty:d("pinned-dirty",60338),passFilled:d("pass-filled",60339),circleLargeFilled:d("circle-large-filled",60340),circleLarge:d("circle-large",60341),circleLargeOutline:d("circle-large-outline",60341),combine:d("combine",60342),gather:d("gather",60342),table:d("table",60343),variableGroup:d("variable-group",60344),typeHierarchy:d("type-hierarchy",60345),typeHierarchySub:d("type-hierarchy-sub",60346),typeHierarchySuper:d("type-hierarchy-super",60347),gitPullRequestCreate:d("git-pull-request-create",60348),runAbove:d("run-above",60349),runBelow:d("run-below",60350),notebookTemplate:d("notebook-template",60351),debugRerun:d("debug-rerun",60352),workspaceTrusted:d("workspace-trusted",60353),workspaceUntrusted:d("workspace-untrusted",60354),workspaceUnspecified:d("workspace-unspecified",60355),terminalCmd:d("terminal-cmd",60356),terminalDebian:d("terminal-debian",60357),terminalLinux:d("terminal-linux",60358),terminalPowershell:d("terminal-powershell",60359),terminalTmux:d("terminal-tmux",60360),terminalUbuntu:d("terminal-ubuntu",60361),terminalBash:d("terminal-bash",60362),arrowSwap:d("arrow-swap",60363),copy:d("copy",60364),personAdd:d("person-add",60365),filterFilled:d("filter-filled",60366),wand:d("wand",60367),debugLineByLine:d("debug-line-by-line",60368),inspect:d("inspect",60369),layers:d("layers",60370),layersDot:d("layers-dot",60371),layersActive:d("layers-active",60372),compass:d("compass",60373),compassDot:d("compass-dot",60374),compassActive:d("compass-active",60375),azure:d("azure",60376),issueDraft:d("issue-draft",60377),gitPullRequestClosed:d("git-pull-request-closed",60378),gitPullRequestDraft:d("git-pull-request-draft",60379),debugAll:d("debug-all",60380),debugCoverage:d("debug-coverage",60381),runErrors:d("run-errors",60382),folderLibrary:d("folder-library",60383),debugContinueSmall:d("debug-continue-small",60384),beakerStop:d("beaker-stop",60385),graphLine:d("graph-line",60386),graphScatter:d("graph-scatter",60387),pieChart:d("pie-chart",60388),bracketDot:d("bracket-dot",60389),bracketError:d("bracket-error",60390),lockSmall:d("lock-small",60391),azureDevops:d("azure-devops",60392),verifiedFilled:d("verified-filled",60393),newLine:d("newline",60394),layout:d("layout",60395),layoutActivitybarLeft:d("layout-activitybar-left",60396),layoutActivitybarRight:d("layout-activitybar-right",60397),layoutPanelLeft:d("layout-panel-left",60398),layoutPanelCenter:d("layout-panel-center",60399),layoutPanelJustify:d("layout-panel-justify",60400),layoutPanelRight:d("layout-panel-right",60401),layoutPanel:d("layout-panel",60402),layoutSidebarLeft:d("layout-sidebar-left",60403),layoutSidebarRight:d("layout-sidebar-right",60404),layoutStatusbar:d("layout-statusbar",60405),layoutMenubar:d("layout-menubar",60406),layoutCentered:d("layout-centered",60407),layoutSidebarRightOff:d("layout-sidebar-right-off",60416),layoutPanelOff:d("layout-panel-off",60417),layoutSidebarLeftOff:d("layout-sidebar-left-off",60418),target:d("target",60408),indent:d("indent",60409),recordSmall:d("record-small",60410),errorSmall:d("error-small",60411),arrowCircleDown:d("arrow-circle-down",60412),arrowCircleLeft:d("arrow-circle-left",60413),arrowCircleRight:d("arrow-circle-right",60414),arrowCircleUp:d("arrow-circle-up",60415),heartFilled:d("heart-filled",60420),map:d("map",60421),mapFilled:d("map-filled",60422),circleSmall:d("circle-small",60423),bellSlash:d("bell-slash",60424),bellSlashDot:d("bell-slash-dot",60425),commentUnresolved:d("comment-unresolved",60426),gitPullRequestGoToChanges:d("git-pull-request-go-to-changes",60427),gitPullRequestNewChanges:d("git-pull-request-new-changes",60428),searchFuzzy:d("search-fuzzy",60429),commentDraft:d("comment-draft",60430),send:d("send",60431),sparkle:d("sparkle",60432),insert:d("insert",60433),mic:d("mic",60434),thumbsDownFilled:d("thumbsdown-filled",60435),thumbsUpFilled:d("thumbsup-filled",60436),coffee:d("coffee",60437),snake:d("snake",60438),game:d("game",60439),vr:d("vr",60440),chip:d("chip",60441),piano:d("piano",60442),music:d("music",60443),micFilled:d("mic-filled",60444),gitFetch:d("git-fetch",60445),copilot:d("copilot",60446),lightbulbSparkle:d("lightbulb-sparkle",60447),lightbulbSparkleAutofix:d("lightbulb-sparkle-autofix",60447),robot:d("robot",60448),sparkleFilled:d("sparkle-filled",60449),diffSingle:d("diff-single",60450),diffMultiple:d("diff-multiple",60451),surroundWith:d("surround-with",60452),gitStash:d("git-stash",60454),gitStashApply:d("git-stash-apply",60455),gitStashPop:d("git-stash-pop",60456),runAllCoverage:d("run-all-coverage",60461),runCoverage:d("run-all-coverage",60460),coverage:d("coverage",60462),githubProject:d("github-project",60463),dialogError:d("dialog-error","error"),dialogWarning:d("dialog-warning","warning"),dialogInfo:d("dialog-info","info"),dialogClose:d("dialog-close","close"),treeItemExpanded:d("tree-item-expanded","chevron-down"),treeFilterOnTypeOn:d("tree-filter-on-type-on","list-filter"),treeFilterOnTypeOff:d("tree-filter-on-type-off","list-selection"),treeFilterClear:d("tree-filter-clear","close"),treeItemLoading:d("tree-item-loading","loading"),menuSelection:d("menu-selection","check"),menuSubmenu:d("menu-submenu","chevron-right"),menuBarMore:d("menubar-more","more"),scrollbarButtonLeft:d("scrollbar-button-left","triangle-left"),scrollbarButtonRight:d("scrollbar-button-right","triangle-right"),scrollbarButtonUp:d("scrollbar-button-up","triangle-up"),scrollbarButtonDown:d("scrollbar-button-down","triangle-down"),toolBarMore:d("toolbar-more","more"),quickInputBack:d("quick-input-back","arrow-left")};var Mn=class{constructor(){this._tokenizationSupports=new Map,this._factories=new Map,this._onDidChange=new de,this.onDidChange=this._onDidChange.event,this._colorMap=null}handleChange(t){this._onDidChange.fire({changedLanguages:t,changedColorMap:!1})}register(t,n){return this._tokenizationSupports.set(t,n),this.handleChange([t]),gt(()=>{this._tokenizationSupports.get(t)===n&&(this._tokenizationSupports.delete(t),this.handleChange([t]))})}get(t){return this._tokenizationSupports.get(t)||null}registerFactory(t,n){this._factories.get(t)?.dispose();let i=new Ji(this,t,n);return this._factories.set(t,i),gt(()=>{let r=this._factories.get(t);!r||r!==i||(this._factories.delete(t),r.dispose())})}async getOrCreate(t){let n=this.get(t);if(n)return n;let i=this._factories.get(t);return!i||i.isResolved?null:(await i.resolve(),this.get(t))}isResolved(t){if(this.get(t))return!0;let i=this._factories.get(t);return!!(!i||i.isResolved)}setColorMap(t){this._colorMap=t,this._onDidChange.fire({changedLanguages:Array.from(this._tokenizationSupports.keys()),changedColorMap:!0})}getColorMap(){return this._colorMap}getDefaultBackground(){return this._colorMap&&this._colorMap.length>2?this._colorMap[2]:null}},Ji=class extends ze{get isResolved(){return this._isResolved}constructor(t,n,i){super(),this._registry=t,this._languageId=n,this._factory=i,this._isDisposed=!1,this._resolvePromise=null,this._isResolved=!1}dispose(){this._isDisposed=!0,super.dispose()}async resolve(){return this._resolvePromise||(this._resolvePromise=this._create()),this._resolvePromise}async _create(){let t=await this._factory.tokenizationSupport;this._isResolved=!0,t&&!this._isDisposed&&this._register(this._registry.register(this._languageId,t))}};var Rn=class{constructor(t,n,i){this.offset=t,this.type=n,this.language=i,this._tokenBrand=void 0}toString(){return"("+this.offset+", "+this.type+")"}};var Ss;(function(e){let t=new Map;t.set(0,O.symbolMethod),t.set(1,O.symbolFunction),t.set(2,O.symbolConstructor),t.set(3,O.symbolField),t.set(4,O.symbolVariable),t.set(5,O.symbolClass),t.set(6,O.symbolStruct),t.set(7,O.symbolInterface),t.set(8,O.symbolModule),t.set(9,O.symbolProperty),t.set(10,O.symbolEvent),t.set(11,O.symbolOperator),t.set(12,O.symbolUnit),t.set(13,O.symbolValue),t.set(15,O.symbolEnum),t.set(14,O.symbolConstant),t.set(15,O.symbolEnum),t.set(16,O.symbolEnumMember),t.set(17,O.symbolKeyword),t.set(27,O.symbolSnippet),t.set(18,O.symbolText),t.set(19,O.symbolColor),t.set(20,O.symbolFile),t.set(21,O.symbolReference),t.set(22,O.symbolCustomColor),t.set(23,O.symbolFolder),t.set(24,O.symbolTypeParameter),t.set(25,O.account),t.set(26,O.issues);function n(s){let a=t.get(s);return a||(console.info("No codicon found for CompletionItemKind "+s),a=O.symbolProperty),a}e.toIcon=n;let i=new Map;i.set("method",0),i.set("function",1),i.set("constructor",2),i.set("field",3),i.set("variable",4),i.set("class",5),i.set("struct",6),i.set("interface",7),i.set("module",8),i.set("property",9),i.set("event",10),i.set("operator",11),i.set("unit",12),i.set("value",13),i.set("constant",14),i.set("enum",15),i.set("enum-member",16),i.set("enumMember",16),i.set("keyword",17),i.set("snippet",27),i.set("text",18),i.set("color",19),i.set("file",20),i.set("reference",21),i.set("customcolor",22),i.set("folder",23),i.set("type-parameter",24),i.set("typeParameter",24),i.set("account",25),i.set("issue",26);function r(s,a){let l=i.get(s);return typeof l>"u"&&!a&&(l=9),l}e.fromString=r})(Ss||(Ss={}));var Ls;(function(e){e[e.Automatic=0]="Automatic",e[e.Explicit=1]="Explicit"})(Ls||(Ls={}));var Cs;(function(e){e[e.Invoke=1]="Invoke",e[e.TriggerCharacter=2]="TriggerCharacter",e[e.ContentChange=3]="ContentChange"})(Cs||(Cs={}));var Es;(function(e){e[e.Text=0]="Text",e[e.Read=1]="Read",e[e.Write=2]="Write"})(Es||(Es={}));var Od={17:ee("vs/editor/common/languages","Array","array"),16:ee("vs/editor/common/languages","Boolean","boolean"),4:ee("vs/editor/common/languages","Class","class"),13:ee("vs/editor/common/languages","Constant","constant"),8:ee("vs/editor/common/languages","Constructor","constructor"),9:ee("vs/editor/common/languages","Enum","enumeration"),21:ee("vs/editor/common/languages","EnumMember","enumeration member"),23:ee("vs/editor/common/languages","Event","event"),7:ee("vs/editor/common/languages","Field","field"),0:ee("vs/editor/common/languages","File","file"),11:ee("vs/editor/common/languages","Function","function"),10:ee("vs/editor/common/languages","Interface","interface"),19:ee("vs/editor/common/languages","Key","key"),5:ee("vs/editor/common/languages","Method","method"),1:ee("vs/editor/common/languages","Module","module"),2:ee("vs/editor/common/languages","Namespace","namespace"),20:ee("vs/editor/common/languages","Null","null"),15:ee("vs/editor/common/languages","Number","number"),18:ee("vs/editor/common/languages","Object","object"),24:ee("vs/editor/common/languages","Operator","operator"),3:ee("vs/editor/common/languages","Package","package"),6:ee("vs/editor/common/languages","Property","property"),14:ee("vs/editor/common/languages","String","string"),22:ee("vs/editor/common/languages","Struct","struct"),25:ee("vs/editor/common/languages","TypeParameter","type parameter"),12:ee("vs/editor/common/languages","Variable","variable")};var Ms;(function(e){let t=new Map;t.set(0,O.symbolFile),t.set(1,O.symbolModule),t.set(2,O.symbolNamespace),t.set(3,O.symbolPackage),t.set(4,O.symbolClass),t.set(5,O.symbolMethod),t.set(6,O.symbolProperty),t.set(7,O.symbolField),t.set(8,O.symbolConstructor),t.set(9,O.symbolEnum),t.set(10,O.symbolInterface),t.set(11,O.symbolFunction),t.set(12,O.symbolVariable),t.set(13,O.symbolConstant),t.set(14,O.symbolString),t.set(15,O.symbolNumber),t.set(16,O.symbolBoolean),t.set(17,O.symbolArray),t.set(18,O.symbolObject),t.set(19,O.symbolKey),t.set(20,O.symbolNull),t.set(21,O.symbolEnumMember),t.set(22,O.symbolStruct),t.set(23,O.symbolEvent),t.set(24,O.symbolOperator),t.set(25,O.symbolTypeParameter);function n(i){let r=t.get(i);return r||(console.info("No codicon found for SymbolKind "+i),r=O.symbolProperty),r}e.toIcon=n})(Ms||(Ms={}));var Rs=class e{static{this.Comment=new e("comment")}static{this.Imports=new e("imports")}static{this.Region=new e("region")}static fromValue(t){switch(t){case"comment":return e.Comment;case"imports":return e.Imports;case"region":return e.Region}return new e(t)}constructor(t){this.value=t}},Ds;(function(e){function t(n){return!n||typeof n!="object"?!1:typeof n.id=="string"&&typeof n.title=="string"}e.is=t})(Ds||(Ds={}));var Ns;(function(e){e[e.Collapsed=0]="Collapsed",e[e.Expanded=1]="Expanded"})(Ns||(Ns={}));var Is;(function(e){e[e.Unresolved=0]="Unresolved",e[e.Resolved=1]="Resolved"})(Is||(Is={}));var zs;(function(e){e[e.Editing=0]="Editing",e[e.Preview=1]="Preview"})(zs||(zs={}));var Us;(function(e){e[e.Type=1]="Type",e[e.Parameter=2]="Parameter"})(Us||(Us={}));var Vd=new Mn,Fs;(function(e){e[e.None=0]="None",e[e.Option=1]="Option",e[e.Default=2]="Default",e[e.Preferred=3]="Preferred"})(Fs||(Fs={}));var Hs;(function(e){e[e.Invoke=0]="Invoke",e[e.Automatic=1]="Automatic"})(Hs||(Hs={}));var Ws;(function(e){e[e.Unknown=0]="Unknown",e[e.Disabled=1]="Disabled",e[e.Enabled=2]="Enabled"})(Ws||(Ws={}));var Bs;(function(e){e[e.Invoke=1]="Invoke",e[e.Auto=2]="Auto"})(Bs||(Bs={}));var Ps;(function(e){e[e.None=0]="None",e[e.KeepWhitespace=1]="KeepWhitespace",e[e.InsertAsSnippet=4]="InsertAsSnippet"})(Ps||(Ps={}));var qs;(function(e){e[e.Method=0]="Method",e[e.Function=1]="Function",e[e.Constructor=2]="Constructor",e[e.Field=3]="Field",e[e.Variable=4]="Variable",e[e.Class=5]="Class",e[e.Struct=6]="Struct",e[e.Interface=7]="Interface",e[e.Module=8]="Module",e[e.Property=9]="Property",e[e.Event=10]="Event",e[e.Operator=11]="Operator",e[e.Unit=12]="Unit",e[e.Value=13]="Value",e[e.Constant=14]="Constant",e[e.Enum=15]="Enum",e[e.EnumMember=16]="EnumMember",e[e.Keyword=17]="Keyword",e[e.Text=18]="Text",e[e.Color=19]="Color",e[e.File=20]="File",e[e.Reference=21]="Reference",e[e.Customcolor=22]="Customcolor",e[e.Folder=23]="Folder",e[e.TypeParameter=24]="TypeParameter",e[e.User=25]="User",e[e.Issue=26]="Issue",e[e.Snippet=27]="Snippet"})(qs||(qs={}));var Os;(function(e){e[e.Deprecated=1]="Deprecated"})(Os||(Os={}));var Vs;(function(e){e[e.Invoke=0]="Invoke",e[e.TriggerCharacter=1]="TriggerCharacter",e[e.TriggerForIncompleteCompletions=2]="TriggerForIncompleteCompletions"})(Vs||(Vs={}));var js;(function(e){e[e.EXACT=0]="EXACT",e[e.ABOVE=1]="ABOVE",e[e.BELOW=2]="BELOW"})(js||(js={}));var Gs;(function(e){e[e.NotSet=0]="NotSet",e[e.ContentFlush=1]="ContentFlush",e[e.RecoverFromMarkers=2]="RecoverFromMarkers",e[e.Explicit=3]="Explicit",e[e.Paste=4]="Paste",e[e.Undo=5]="Undo",e[e.Redo=6]="Redo"})(Gs||(Gs={}));var $s;(function(e){e[e.LF=1]="LF",e[e.CRLF=2]="CRLF"})($s||($s={}));var Qs;(function(e){e[e.Text=0]="Text",e[e.Read=1]="Read",e[e.Write=2]="Write"})(Qs||(Qs={}));var Js;(function(e){e[e.None=0]="None",e[e.Keep=1]="Keep",e[e.Brackets=2]="Brackets",e[e.Advanced=3]="Advanced",e[e.Full=4]="Full"})(Js||(Js={}));var Xs;(function(e){e[e.acceptSuggestionOnCommitCharacter=0]="acceptSuggestionOnCommitCharacter",e[e.acceptSuggestionOnEnter=1]="acceptSuggestionOnEnter",e[e.accessibilitySupport=2]="accessibilitySupport",e[e.accessibilityPageSize=3]="accessibilityPageSize",e[e.ariaLabel=4]="ariaLabel",e[e.ariaRequired=5]="ariaRequired",e[e.autoClosingBrackets=6]="autoClosingBrackets",e[e.autoClosingComments=7]="autoClosingComments",e[e.screenReaderAnnounceInlineSuggestion=8]="screenReaderAnnounceInlineSuggestion",e[e.autoClosingDelete=9]="autoClosingDelete",e[e.autoClosingOvertype=10]="autoClosingOvertype",e[e.autoClosingQuotes=11]="autoClosingQuotes",e[e.autoIndent=12]="autoIndent",e[e.automaticLayout=13]="automaticLayout",e[e.autoSurround=14]="autoSurround",e[e.bracketPairColorization=15]="bracketPairColorization",e[e.guides=16]="guides",e[e.codeLens=17]="codeLens",e[e.codeLensFontFamily=18]="codeLensFontFamily",e[e.codeLensFontSize=19]="codeLensFontSize",e[e.colorDecorators=20]="colorDecorators",e[e.colorDecoratorsLimit=21]="colorDecoratorsLimit",e[e.columnSelection=22]="columnSelection",e[e.comments=23]="comments",e[e.contextmenu=24]="contextmenu",e[e.copyWithSyntaxHighlighting=25]="copyWithSyntaxHighlighting",e[e.cursorBlinking=26]="cursorBlinking",e[e.cursorSmoothCaretAnimation=27]="cursorSmoothCaretAnimation",e[e.cursorStyle=28]="cursorStyle",e[e.cursorSurroundingLines=29]="cursorSurroundingLines",e[e.cursorSurroundingLinesStyle=30]="cursorSurroundingLinesStyle",e[e.cursorWidth=31]="cursorWidth",e[e.disableLayerHinting=32]="disableLayerHinting",e[e.disableMonospaceOptimizations=33]="disableMonospaceOptimizations",e[e.domReadOnly=34]="domReadOnly",e[e.dragAndDrop=35]="dragAndDrop",e[e.dropIntoEditor=36]="dropIntoEditor",e[e.emptySelectionClipboard=37]="emptySelectionClipboard",e[e.experimentalWhitespaceRendering=38]="experimentalWhitespaceRendering",e[e.extraEditorClassName=39]="extraEditorClassName",e[e.fastScrollSensitivity=40]="fastScrollSensitivity",e[e.find=41]="find",e[e.fixedOverflowWidgets=42]="fixedOverflowWidgets",e[e.folding=43]="folding",e[e.foldingStrategy=44]="foldingStrategy",e[e.foldingHighlight=45]="foldingHighlight",e[e.foldingImportsByDefault=46]="foldingImportsByDefault",e[e.foldingMaximumRegions=47]="foldingMaximumRegions",e[e.unfoldOnClickAfterEndOfLine=48]="unfoldOnClickAfterEndOfLine",e[e.fontFamily=49]="fontFamily",e[e.fontInfo=50]="fontInfo",e[e.fontLigatures=51]="fontLigatures",e[e.fontSize=52]="fontSize",e[e.fontWeight=53]="fontWeight",e[e.fontVariations=54]="fontVariations",e[e.formatOnPaste=55]="formatOnPaste",e[e.formatOnType=56]="formatOnType",e[e.glyphMargin=57]="glyphMargin",e[e.gotoLocation=58]="gotoLocation",e[e.hideCursorInOverviewRuler=59]="hideCursorInOverviewRuler",e[e.hover=60]="hover",e[e.inDiffEditor=61]="inDiffEditor",e[e.inlineSuggest=62]="inlineSuggest",e[e.inlineEdit=63]="inlineEdit",e[e.letterSpacing=64]="letterSpacing",e[e.lightbulb=65]="lightbulb",e[e.lineDecorationsWidth=66]="lineDecorationsWidth",e[e.lineHeight=67]="lineHeight",e[e.lineNumbers=68]="lineNumbers",e[e.lineNumbersMinChars=69]="lineNumbersMinChars",e[e.linkedEditing=70]="linkedEditing",e[e.links=71]="links",e[e.matchBrackets=72]="matchBrackets",e[e.minimap=73]="minimap",e[e.mouseStyle=74]="mouseStyle",e[e.mouseWheelScrollSensitivity=75]="mouseWheelScrollSensitivity",e[e.mouseWheelZoom=76]="mouseWheelZoom",e[e.multiCursorMergeOverlapping=77]="multiCursorMergeOverlapping",e[e.multiCursorModifier=78]="multiCursorModifier",e[e.multiCursorPaste=79]="multiCursorPaste",e[e.multiCursorLimit=80]="multiCursorLimit",e[e.occurrencesHighlight=81]="occurrencesHighlight",e[e.overviewRulerBorder=82]="overviewRulerBorder",e[e.overviewRulerLanes=83]="overviewRulerLanes",e[e.padding=84]="padding",e[e.pasteAs=85]="pasteAs",e[e.parameterHints=86]="parameterHints",e[e.peekWidgetDefaultFocus=87]="peekWidgetDefaultFocus",e[e.definitionLinkOpensInPeek=88]="definitionLinkOpensInPeek",e[e.quickSuggestions=89]="quickSuggestions",e[e.quickSuggestionsDelay=90]="quickSuggestionsDelay",e[e.readOnly=91]="readOnly",e[e.readOnlyMessage=92]="readOnlyMessage",e[e.renameOnType=93]="renameOnType",e[e.renderControlCharacters=94]="renderControlCharacters",e[e.renderFinalNewline=95]="renderFinalNewline",e[e.renderLineHighlight=96]="renderLineHighlight",e[e.renderLineHighlightOnlyWhenFocus=97]="renderLineHighlightOnlyWhenFocus",e[e.renderValidationDecorations=98]="renderValidationDecorations",e[e.renderWhitespace=99]="renderWhitespace",e[e.revealHorizontalRightPadding=100]="revealHorizontalRightPadding",e[e.roundedSelection=101]="roundedSelection",e[e.rulers=102]="rulers",e[e.scrollbar=103]="scrollbar",e[e.scrollBeyondLastColumn=104]="scrollBeyondLastColumn",e[e.scrollBeyondLastLine=105]="scrollBeyondLastLine",e[e.scrollPredominantAxis=106]="scrollPredominantAxis",e[e.selectionClipboard=107]="selectionClipboard",e[e.selectionHighlight=108]="selectionHighlight",e[e.selectOnLineNumbers=109]="selectOnLineNumbers",e[e.showFoldingControls=110]="showFoldingControls",e[e.showUnused=111]="showUnused",e[e.snippetSuggestions=112]="snippetSuggestions",e[e.smartSelect=113]="smartSelect",e[e.smoothScrolling=114]="smoothScrolling",e[e.stickyScroll=115]="stickyScroll",e[e.stickyTabStops=116]="stickyTabStops",e[e.stopRenderingLineAfter=117]="stopRenderingLineAfter",e[e.suggest=118]="suggest",e[e.suggestFontSize=119]="suggestFontSize",e[e.suggestLineHeight=120]="suggestLineHeight",e[e.suggestOnTriggerCharacters=121]="suggestOnTriggerCharacters",e[e.suggestSelection=122]="suggestSelection",e[e.tabCompletion=123]="tabCompletion",e[e.tabIndex=124]="tabIndex",e[e.unicodeHighlighting=125]="unicodeHighlighting",e[e.unusualLineTerminators=126]="unusualLineTerminators",e[e.useShadowDOM=127]="useShadowDOM",e[e.useTabStops=128]="useTabStops",e[e.wordBreak=129]="wordBreak",e[e.wordSeparators=130]="wordSeparators",e[e.wordWrap=131]="wordWrap",e[e.wordWrapBreakAfterCharacters=132]="wordWrapBreakAfterCharacters",e[e.wordWrapBreakBeforeCharacters=133]="wordWrapBreakBeforeCharacters",e[e.wordWrapColumn=134]="wordWrapColumn",e[e.wordWrapOverride1=135]="wordWrapOverride1",e[e.wordWrapOverride2=136]="wordWrapOverride2",e[e.wrappingIndent=137]="wrappingIndent",e[e.wrappingStrategy=138]="wrappingStrategy",e[e.showDeprecated=139]="showDeprecated",e[e.inlayHints=140]="inlayHints",e[e.editorClassName=141]="editorClassName",e[e.pixelRatio=142]="pixelRatio",e[e.tabFocusMode=143]="tabFocusMode",e[e.layoutInfo=144]="layoutInfo",e[e.wrappingInfo=145]="wrappingInfo",e[e.defaultColorDecorators=146]="defaultColorDecorators",e[e.colorDecoratorsActivatedOn=147]="colorDecoratorsActivatedOn",e[e.inlineCompletionsAccessibilityVerbose=148]="inlineCompletionsAccessibilityVerbose"})(Xs||(Xs={}));var Ys;(function(e){e[e.TextDefined=0]="TextDefined",e[e.LF=1]="LF",e[e.CRLF=2]="CRLF"})(Ys||(Ys={}));var Zs;(function(e){e[e.LF=0]="LF",e[e.CRLF=1]="CRLF"})(Zs||(Zs={}));var Ks;(function(e){e[e.Left=1]="Left",e[e.Center=2]="Center",e[e.Right=3]="Right"})(Ks||(Ks={}));var ea;(function(e){e[e.None=0]="None",e[e.Indent=1]="Indent",e[e.IndentOutdent=2]="IndentOutdent",e[e.Outdent=3]="Outdent"})(ea||(ea={}));var ta;(function(e){e[e.Both=0]="Both",e[e.Right=1]="Right",e[e.Left=2]="Left",e[e.None=3]="None"})(ta||(ta={}));var na;(function(e){e[e.Type=1]="Type",e[e.Parameter=2]="Parameter"})(na||(na={}));var ia;(function(e){e[e.Automatic=0]="Automatic",e[e.Explicit=1]="Explicit"})(ia||(ia={}));var ra;(function(e){e[e.Invoke=0]="Invoke",e[e.Automatic=1]="Automatic"})(ra||(ra={}));var Dn;(function(e){e[e.DependsOnKbLayout=-1]="DependsOnKbLayout",e[e.Unknown=0]="Unknown",e[e.Backspace=1]="Backspace",e[e.Tab=2]="Tab",e[e.Enter=3]="Enter",e[e.Shift=4]="Shift",e[e.Ctrl=5]="Ctrl",e[e.Alt=6]="Alt",e[e.PauseBreak=7]="PauseBreak",e[e.CapsLock=8]="CapsLock",e[e.Escape=9]="Escape",e[e.Space=10]="Space",e[e.PageUp=11]="PageUp",e[e.PageDown=12]="PageDown",e[e.End=13]="End",e[e.Home=14]="Home",e[e.LeftArrow=15]="LeftArrow",e[e.UpArrow=16]="UpArrow",e[e.RightArrow=17]="RightArrow",e[e.DownArrow=18]="DownArrow",e[e.Insert=19]="Insert",e[e.Delete=20]="Delete",e[e.Digit0=21]="Digit0",e[e.Digit1=22]="Digit1",e[e.Digit2=23]="Digit2",e[e.Digit3=24]="Digit3",e[e.Digit4=25]="Digit4",e[e.Digit5=26]="Digit5",e[e.Digit6=27]="Digit6",e[e.Digit7=28]="Digit7",e[e.Digit8=29]="Digit8",e[e.Digit9=30]="Digit9",e[e.KeyA=31]="KeyA",e[e.KeyB=32]="KeyB",e[e.KeyC=33]="KeyC",e[e.KeyD=34]="KeyD",e[e.KeyE=35]="KeyE",e[e.KeyF=36]="KeyF",e[e.KeyG=37]="KeyG",e[e.KeyH=38]="KeyH",e[e.KeyI=39]="KeyI",e[e.KeyJ=40]="KeyJ",e[e.KeyK=41]="KeyK",e[e.KeyL=42]="KeyL",e[e.KeyM=43]="KeyM",e[e.KeyN=44]="KeyN",e[e.KeyO=45]="KeyO",e[e.KeyP=46]="KeyP",e[e.KeyQ=47]="KeyQ",e[e.KeyR=48]="KeyR",e[e.KeyS=49]="KeyS",e[e.KeyT=50]="KeyT",e[e.KeyU=51]="KeyU",e[e.KeyV=52]="KeyV",e[e.KeyW=53]="KeyW",e[e.KeyX=54]="KeyX",e[e.KeyY=55]="KeyY",e[e.KeyZ=56]="KeyZ",e[e.Meta=57]="Meta",e[e.ContextMenu=58]="ContextMenu",e[e.F1=59]="F1",e[e.F2=60]="F2",e[e.F3=61]="F3",e[e.F4=62]="F4",e[e.F5=63]="F5",e[e.F6=64]="F6",e[e.F7=65]="F7",e[e.F8=66]="F8",e[e.F9=67]="F9",e[e.F10=68]="F10",e[e.F11=69]="F11",e[e.F12=70]="F12",e[e.F13=71]="F13",e[e.F14=72]="F14",e[e.F15=73]="F15",e[e.F16=74]="F16",e[e.F17=75]="F17",e[e.F18=76]="F18",e[e.F19=77]="F19",e[e.F20=78]="F20",e[e.F21=79]="F21",e[e.F22=80]="F22",e[e.F23=81]="F23",e[e.F24=82]="F24",e[e.NumLock=83]="NumLock",e[e.ScrollLock=84]="ScrollLock",e[e.Semicolon=85]="Semicolon",e[e.Equal=86]="Equal",e[e.Comma=87]="Comma",e[e.Minus=88]="Minus",e[e.Period=89]="Period",e[e.Slash=90]="Slash",e[e.Backquote=91]="Backquote",e[e.BracketLeft=92]="BracketLeft",e[e.Backslash=93]="Backslash",e[e.BracketRight=94]="BracketRight",e[e.Quote=95]="Quote",e[e.OEM_8=96]="OEM_8",e[e.IntlBackslash=97]="IntlBackslash",e[e.Numpad0=98]="Numpad0",e[e.Numpad1=99]="Numpad1",e[e.Numpad2=100]="Numpad2",e[e.Numpad3=101]="Numpad3",e[e.Numpad4=102]="Numpad4",e[e.Numpad5=103]="Numpad5",e[e.Numpad6=104]="Numpad6",e[e.Numpad7=105]="Numpad7",e[e.Numpad8=106]="Numpad8",e[e.Numpad9=107]="Numpad9",e[e.NumpadMultiply=108]="NumpadMultiply",e[e.NumpadAdd=109]="NumpadAdd",e[e.NUMPAD_SEPARATOR=110]="NUMPAD_SEPARATOR",e[e.NumpadSubtract=111]="NumpadSubtract",e[e.NumpadDecimal=112]="NumpadDecimal",e[e.NumpadDivide=113]="NumpadDivide",e[e.KEY_IN_COMPOSITION=114]="KEY_IN_COMPOSITION",e[e.ABNT_C1=115]="ABNT_C1",e[e.ABNT_C2=116]="ABNT_C2",e[e.AudioVolumeMute=117]="AudioVolumeMute",e[e.AudioVolumeUp=118]="AudioVolumeUp",e[e.AudioVolumeDown=119]="AudioVolumeDown",e[e.BrowserSearch=120]="BrowserSearch",e[e.BrowserHome=121]="BrowserHome",e[e.BrowserBack=122]="BrowserBack",e[e.BrowserForward=123]="BrowserForward",e[e.MediaTrackNext=124]="MediaTrackNext",e[e.MediaTrackPrevious=125]="MediaTrackPrevious",e[e.MediaStop=126]="MediaStop",e[e.MediaPlayPause=127]="MediaPlayPause",e[e.LaunchMediaPlayer=128]="LaunchMediaPlayer",e[e.LaunchMail=129]="LaunchMail",e[e.LaunchApp2=130]="LaunchApp2",e[e.Clear=131]="Clear",e[e.MAX_VALUE=132]="MAX_VALUE"})(Dn||(Dn={}));var Nn;(function(e){e[e.Hint=1]="Hint",e[e.Info=2]="Info",e[e.Warning=4]="Warning",e[e.Error=8]="Error"})(Nn||(Nn={}));var In;(function(e){e[e.Unnecessary=1]="Unnecessary",e[e.Deprecated=2]="Deprecated"})(In||(In={}));var sa;(function(e){e[e.Inline=1]="Inline",e[e.Gutter=2]="Gutter"})(sa||(sa={}));var aa;(function(e){e[e.UNKNOWN=0]="UNKNOWN",e[e.TEXTAREA=1]="TEXTAREA",e[e.GUTTER_GLYPH_MARGIN=2]="GUTTER_GLYPH_MARGIN",e[e.GUTTER_LINE_NUMBERS=3]="GUTTER_LINE_NUMBERS",e[e.GUTTER_LINE_DECORATIONS=4]="GUTTER_LINE_DECORATIONS",e[e.GUTTER_VIEW_ZONE=5]="GUTTER_VIEW_ZONE",e[e.CONTENT_TEXT=6]="CONTENT_TEXT",e[e.CONTENT_EMPTY=7]="CONTENT_EMPTY",e[e.CONTENT_VIEW_ZONE=8]="CONTENT_VIEW_ZONE",e[e.CONTENT_WIDGET=9]="CONTENT_WIDGET",e[e.OVERVIEW_RULER=10]="OVERVIEW_RULER",e[e.SCROLLBAR=11]="SCROLLBAR",e[e.OVERLAY_WIDGET=12]="OVERLAY_WIDGET",e[e.OUTSIDE_EDITOR=13]="OUTSIDE_EDITOR"})(aa||(aa={}));var oa;(function(e){e[e.AIGenerated=1]="AIGenerated"})(oa||(oa={}));var la;(function(e){e[e.TOP_RIGHT_CORNER=0]="TOP_RIGHT_CORNER",e[e.BOTTOM_RIGHT_CORNER=1]="BOTTOM_RIGHT_CORNER",e[e.TOP_CENTER=2]="TOP_CENTER"})(la||(la={}));var ua;(function(e){e[e.Left=1]="Left",e[e.Center=2]="Center",e[e.Right=4]="Right",e[e.Full=7]="Full"})(ua||(ua={}));var ca;(function(e){e[e.Left=0]="Left",e[e.Right=1]="Right",e[e.None=2]="None",e[e.LeftOfInjectedText=3]="LeftOfInjectedText",e[e.RightOfInjectedText=4]="RightOfInjectedText"})(ca||(ca={}));var ha;(function(e){e[e.Off=0]="Off",e[e.On=1]="On",e[e.Relative=2]="Relative",e[e.Interval=3]="Interval",e[e.Custom=4]="Custom"})(ha||(ha={}));var da;(function(e){e[e.None=0]="None",e[e.Text=1]="Text",e[e.Blocks=2]="Blocks"})(da||(da={}));var fa;(function(e){e[e.Smooth=0]="Smooth",e[e.Immediate=1]="Immediate"})(fa||(fa={}));var ma;(function(e){e[e.Auto=1]="Auto",e[e.Hidden=2]="Hidden",e[e.Visible=3]="Visible"})(ma||(ma={}));var zn;(function(e){e[e.LTR=0]="LTR",e[e.RTL=1]="RTL"})(zn||(zn={}));var pa;(function(e){e.Off="off",e.OnCode="onCode",e.On="on"})(pa||(pa={}));var ga;(function(e){e[e.Invoke=1]="Invoke",e[e.TriggerCharacter=2]="TriggerCharacter",e[e.ContentChange=3]="ContentChange"})(ga||(ga={}));var ba;(function(e){e[e.File=0]="File",e[e.Module=1]="Module",e[e.Namespace=2]="Namespace",e[e.Package=3]="Package",e[e.Class=4]="Class",e[e.Method=5]="Method",e[e.Property=6]="Property",e[e.Field=7]="Field",e[e.Constructor=8]="Constructor",e[e.Enum=9]="Enum",e[e.Interface=10]="Interface",e[e.Function=11]="Function",e[e.Variable=12]="Variable",e[e.Constant=13]="Constant",e[e.String=14]="String",e[e.Number=15]="Number",e[e.Boolean=16]="Boolean",e[e.Array=17]="Array",e[e.Object=18]="Object",e[e.Key=19]="Key",e[e.Null=20]="Null",e[e.EnumMember=21]="EnumMember",e[e.Struct=22]="Struct",e[e.Event=23]="Event",e[e.Operator=24]="Operator",e[e.TypeParameter=25]="TypeParameter"})(ba||(ba={}));var va;(function(e){e[e.Deprecated=1]="Deprecated"})(va||(va={}));var _a;(function(e){e[e.Hidden=0]="Hidden",e[e.Blink=1]="Blink",e[e.Smooth=2]="Smooth",e[e.Phase=3]="Phase",e[e.Expand=4]="Expand",e[e.Solid=5]="Solid"})(_a||(_a={}));var wa;(function(e){e[e.Line=1]="Line",e[e.Block=2]="Block",e[e.Underline=3]="Underline",e[e.LineThin=4]="LineThin",e[e.BlockOutline=5]="BlockOutline",e[e.UnderlineThin=6]="UnderlineThin"})(wa||(wa={}));var ya;(function(e){e[e.AlwaysGrowsWhenTypingAtEdges=0]="AlwaysGrowsWhenTypingAtEdges",e[e.NeverGrowsWhenTypingAtEdges=1]="NeverGrowsWhenTypingAtEdges",e[e.GrowsOnlyWhenTypingBefore=2]="GrowsOnlyWhenTypingBefore",e[e.GrowsOnlyWhenTypingAfter=3]="GrowsOnlyWhenTypingAfter"})(ya||(ya={}));var xa;(function(e){e[e.None=0]="None",e[e.Same=1]="Same",e[e.Indent=2]="Indent",e[e.DeepIndent=3]="DeepIndent"})(xa||(xa={}));var Xi=class{static{this.CtrlCmd=2048}static{this.Shift=1024}static{this.Alt=512}static{this.WinCtrl=256}static chord(t,n){return As(t,n)}};function Ta(){return{editor:void 0,languages:void 0,CancellationTokenSource:Ht,Emitter:de,KeyCode:Dn,KeyMod:Xi,Position:oe,Range:J,Selection:En,SelectionDirection:zn,MarkerSeverity:Nn,MarkerTag:In,Uri:$e,Token:Rn}}var Yi=class extends Tt{constructor(t){super(0);for(let n=0,i=t.length;n<i;n++)this.set(t.charCodeAt(n),2);this.set(32,1),this.set(9,1)}};function Jl(e){let t={};return n=>(t.hasOwnProperty(n)||(t[n]=e(n)),t[n])}var Xl=Jl(e=>new Yi(e));var Aa;(function(e){e[e.Left=1]="Left",e[e.Center=2]="Center",e[e.Right=4]="Right",e[e.Full=7]="Full"})(Aa||(Aa={}));var ka;(function(e){e[e.Left=1]="Left",e[e.Center=2]="Center",e[e.Right=3]="Right"})(ka||(ka={}));var Sa;(function(e){e[e.Inline=1]="Inline",e[e.Gutter=2]="Gutter"})(Sa||(Sa={}));var La;(function(e){e[e.Both=0]="Both",e[e.Right=1]="Right",e[e.Left=2]="Left",e[e.None=3]="None"})(La||(La={}));function Yl(e,t,n,i,r){if(i===0)return!0;let s=t.charCodeAt(i-1);if(e.get(s)!==0||s===13||s===10)return!0;if(r>0){let a=t.charCodeAt(i);if(e.get(a)!==0)return!0}return!1}function Zl(e,t,n,i,r){if(i+r===n)return!0;let s=t.charCodeAt(i+r);if(e.get(s)!==0||s===13||s===10)return!0;if(r>0){let a=t.charCodeAt(i+r-1);if(e.get(a)!==0)return!0}return!1}function Kl(e,t,n,i,r){return Yl(e,t,n,i,r)&&Zl(e,t,n,i,r)}var Un=class{constructor(t,n){this._wordSeparators=t,this._searchRegex=n,this._prevMatchStartIndex=-1,this._prevMatchLength=0}reset(t){this._searchRegex.lastIndex=t,this._prevMatchStartIndex=-1,this._prevMatchLength=0}next(t){let n=t.length,i;do{if(this._prevMatchStartIndex+this._prevMatchLength===n||(i=this._searchRegex.exec(t),!i))return null;let r=i.index,s=i[0].length;if(r===this._prevMatchStartIndex&&s===this._prevMatchLength){if(s===0){is(t,n,this._searchRegex.lastIndex)>65535?this._searchRegex.lastIndex+=2:this._searchRegex.lastIndex+=1;continue}return null}if(this._prevMatchStartIndex=r,this._prevMatchLength=s,!this._wordSeparators||Kl(this._wordSeparators,t,n,r,s))return i}while(i);return null}};function Ca(e,t="Unreachable"){throw new Error(t)}function At(e){if(!e()){debugger;e(),ln(new pe("Assertion Failed"))}}function Fn(e,t){let n=0;for(;n<e.length-1;){let i=e[n],r=e[n+1];if(!t(i,r))return!1;n++}return!0}var Hn=class{static computeUnicodeHighlights(t,n,i){let r=i?i.startLineNumber:1,s=i?i.endLineNumber:t.getLineCount(),a=new Wn(n),l=a.getCandidateCodePoints(),o;l==="allNonBasicAscii"?o=new RegExp("[^\\t\\n\\r\\x20-\\x7E]","g"):o=new RegExp(`${eu(Array.from(l))}`,"g");let u=new Un(null,o),c=[],h=!1,f,m=0,b=0,p=0;e:for(let w=r,x=s;w<=x;w++){let _=t.getLineContent(w),y=_.length;u.reset(0);do if(f=u.next(_),f){let C=f.index,E=f.index+f[0].length;if(C>0){let T=_.charCodeAt(C-1);xt(T)&&C--}if(E+1<y){let T=_.charCodeAt(E-1);xt(T)&&E++}let B=_.substring(C,E),v=Ot(C+1,Bi,_,0);v&&v.endColumn<=C+1&&(v=null);let g=a.shouldHighlightNonBasicASCII(B,v?v.word:null);if(g!==0){if(g===3?m++:g===2?b++:g===1?p++:Ca(),c.length>=1e3){h=!0;break e}c.push(new J(w,C+1,w,E+1))}}while(f)}return{ranges:c,hasMore:h,ambiguousCharacterCount:m,invisibleCharacterCount:b,nonBasicAsciiCharacterCount:p}}static computeUnicodeHighlightReason(t,n){let i=new Wn(n);switch(i.shouldHighlightNonBasicASCII(t,null)){case 0:return null;case 2:return{kind:1};case 3:{let s=t.codePointAt(0),a=i.ambiguousCharacters.getPrimaryConfusable(s),l=wt.getLocales().filter(o=>!wt.getInstance(new Set([...n.allowedLocales,o])).isAmbiguous(s));return{kind:0,confusableWith:String.fromCodePoint(a),notAmbiguousInLocales:l}}case 1:return{kind:2}}}};function eu(e,t){return`[${Kr(e.map(i=>String.fromCodePoint(i)).join(""))}]`}var Wn=class{constructor(t){this.options=t,this.allowedCodePoints=new Set(t.allowedCodePoints),this.ambiguousCharacters=wt.getInstance(new Set(t.allowedLocales))}getCandidateCodePoints(){if(this.options.nonBasicASCII)return"allNonBasicAscii";let t=new Set;if(this.options.invisibleCharacters)for(let n of yt.codePoints)Ea(String.fromCodePoint(n))||t.add(n);if(this.options.ambiguousCharacters)for(let n of this.ambiguousCharacters.getConfusableCodePoints())t.add(n);for(let n of this.allowedCodePoints)t.delete(n);return t}shouldHighlightNonBasicASCII(t,n){let i=t.codePointAt(0);if(this.allowedCodePoints.has(i))return 0;if(this.options.nonBasicASCII)return 1;let r=!1,s=!1;if(n)for(let a of n){let l=a.codePointAt(0),o=rs(a);r=r||o,!o&&!this.ambiguousCharacters.isAmbiguous(l)&&!yt.isInvisibleCharacter(l)&&(s=!0)}return!r&&s?0:this.options.invisibleCharacters&&!Ea(t)&&yt.isInvisibleCharacter(i)?2:this.options.ambiguousCharacters&&this.ambiguousCharacters.isAmbiguous(i)?3:0}};function Ea(e){return e===" "||e===`
`||e==="	"}var Qe=class{constructor(t,n,i){this.changes=t,this.moves=n,this.hitTimeout=i}},Bn=class e{constructor(t,n){this.lineRangeMapping=t,this.changes=n}flip(){return new e(this.lineRangeMapping.flip(),this.changes.map(t=>t.flip()))}};var $=class e{static addRange(t,n){let i=0;for(;i<n.length&&n[i].endExclusive<t.start;)i++;let r=i;for(;r<n.length&&n[r].start<=t.endExclusive;)r++;if(i===r)n.splice(i,0,t);else{let s=Math.min(t.start,n[i].start),a=Math.max(t.endExclusive,n[r-1].endExclusive);n.splice(i,r-i,new e(s,a))}}static tryCreate(t,n){if(!(t>n))return new e(t,n)}static ofLength(t){return new e(0,t)}static ofStartAndLength(t,n){return new e(t,t+n)}constructor(t,n){if(this.start=t,this.endExclusive=n,t>n)throw new pe(`Invalid range: ${this.toString()}`)}get isEmpty(){return this.start===this.endExclusive}delta(t){return new e(this.start+t,this.endExclusive+t)}deltaStart(t){return new e(this.start+t,this.endExclusive)}deltaEnd(t){return new e(this.start,this.endExclusive+t)}get length(){return this.endExclusive-this.start}toString(){return`[${this.start}, ${this.endExclusive})`}equals(t){return this.start===t.start&&this.endExclusive===t.endExclusive}containsRange(t){return this.start<=t.start&&t.endExclusive<=this.endExclusive}contains(t){return this.start<=t&&t<this.endExclusive}join(t){return new e(Math.min(this.start,t.start),Math.max(this.endExclusive,t.endExclusive))}intersect(t){let n=Math.max(this.start,t.start),i=Math.min(this.endExclusive,t.endExclusive);if(n<=i)return new e(n,i)}intersects(t){let n=Math.max(this.start,t.start),i=Math.min(this.endExclusive,t.endExclusive);return n<i}intersectsOrTouches(t){let n=Math.max(this.start,t.start),i=Math.min(this.endExclusive,t.endExclusive);return n<=i}isBefore(t){return this.endExclusive<=t.start}isAfter(t){return this.start>=t.endExclusive}slice(t){return t.slice(this.start,this.endExclusive)}substring(t){return t.substring(this.start,this.endExclusive)}clip(t){if(this.isEmpty)throw new pe(`Invalid clipping range: ${this.toString()}`);return Math.max(this.start,Math.min(this.endExclusive-1,t))}clipCyclic(t){if(this.isEmpty)throw new pe(`Invalid clipping range: ${this.toString()}`);return t<this.start?this.endExclusive-(this.start-t)%this.length:t>=this.endExclusive?this.start+(t-this.start)%this.length:t}map(t){let n=[];for(let i=this.start;i<this.endExclusive;i++)n.push(t(i));return n}forEach(t){for(let n=this.start;n<this.endExclusive;n++)t(n)}};var Y=class e{static fromRange(t){return new e(t.startLineNumber,t.endLineNumber)}static fromRangeInclusive(t){return new e(t.startLineNumber,t.endLineNumber+1)}static subtract(t,n){return n?t.startLineNumber<n.startLineNumber&&n.endLineNumberExclusive<t.endLineNumberExclusive?[new e(t.startLineNumber,n.startLineNumber),new e(n.endLineNumberExclusive,t.endLineNumberExclusive)]:n.startLineNumber<=t.startLineNumber&&t.endLineNumberExclusive<=n.endLineNumberExclusive?[]:n.endLineNumberExclusive<t.endLineNumberExclusive?[new e(Math.max(n.endLineNumberExclusive,t.startLineNumber),t.endLineNumberExclusive)]:[new e(t.startLineNumber,Math.min(n.startLineNumber,t.endLineNumberExclusive))]:[t]}static joinMany(t){if(t.length===0)return[];let n=new ut(t[0].slice());for(let i=1;i<t.length;i++)n=n.getUnion(new ut(t[i].slice()));return n.ranges}static ofLength(t,n){return new e(t,t+n)}static deserialize(t){return new e(t[0],t[1])}constructor(t,n){if(t>n)throw new pe(`startLineNumber ${t} cannot be after endLineNumberExclusive ${n}`);this.startLineNumber=t,this.endLineNumberExclusive=n}contains(t){return this.startLineNumber<=t&&t<this.endLineNumberExclusive}get isEmpty(){return this.startLineNumber===this.endLineNumberExclusive}delta(t){return new e(this.startLineNumber+t,this.endLineNumberExclusive+t)}deltaLength(t){return new e(this.startLineNumber,this.endLineNumberExclusive+t)}get length(){return this.endLineNumberExclusive-this.startLineNumber}join(t){return new e(Math.min(this.startLineNumber,t.startLineNumber),Math.max(this.endLineNumberExclusive,t.endLineNumberExclusive))}toString(){return`[${this.startLineNumber},${this.endLineNumberExclusive})`}intersect(t){let n=Math.max(this.startLineNumber,t.startLineNumber),i=Math.min(this.endLineNumberExclusive,t.endLineNumberExclusive);if(n<=i)return new e(n,i)}intersectsStrict(t){return this.startLineNumber<t.endLineNumberExclusive&&t.startLineNumber<this.endLineNumberExclusive}overlapOrTouch(t){return this.startLineNumber<=t.endLineNumberExclusive&&t.startLineNumber<=this.endLineNumberExclusive}equals(t){return this.startLineNumber===t.startLineNumber&&this.endLineNumberExclusive===t.endLineNumberExclusive}toInclusiveRange(){return this.isEmpty?null:new J(this.startLineNumber,1,this.endLineNumberExclusive-1,Number.MAX_SAFE_INTEGER)}toExclusiveRange(){return new J(this.startLineNumber,1,this.endLineNumberExclusive,1)}mapToLineArray(t){let n=[];for(let i=this.startLineNumber;i<this.endLineNumberExclusive;i++)n.push(t(i));return n}forEach(t){for(let n=this.startLineNumber;n<this.endLineNumberExclusive;n++)t(n)}serialize(){return[this.startLineNumber,this.endLineNumberExclusive]}includes(t){return this.startLineNumber<=t&&t<this.endLineNumberExclusive}toOffsetRange(){return new $(this.startLineNumber-1,this.endLineNumberExclusive-1)}},ut=class e{constructor(t=[]){this._normalizedRanges=t}get ranges(){return this._normalizedRanges}addRange(t){if(t.length===0)return;let n=Nt(this._normalizedRanges,r=>r.endLineNumberExclusive>=t.startLineNumber),i=it(this._normalizedRanges,r=>r.startLineNumber<=t.endLineNumberExclusive)+1;if(n===i)this._normalizedRanges.splice(n,0,t);else if(n===i-1){let r=this._normalizedRanges[n];this._normalizedRanges[n]=r.join(t)}else{let r=this._normalizedRanges[n].join(this._normalizedRanges[i-1]).join(t);this._normalizedRanges.splice(n,i-n,r)}}contains(t){let n=Ie(this._normalizedRanges,i=>i.startLineNumber<=t);return!!n&&n.endLineNumberExclusive>t}intersects(t){let n=Ie(this._normalizedRanges,i=>i.startLineNumber<t.endLineNumberExclusive);return!!n&&n.endLineNumberExclusive>t.startLineNumber}getUnion(t){if(this._normalizedRanges.length===0)return t;if(t._normalizedRanges.length===0)return this;let n=[],i=0,r=0,s=null;for(;i<this._normalizedRanges.length||r<t._normalizedRanges.length;){let a=null;if(i<this._normalizedRanges.length&&r<t._normalizedRanges.length){let l=this._normalizedRanges[i],o=t._normalizedRanges[r];l.startLineNumber<o.startLineNumber?(a=l,i++):(a=o,r++)}else i<this._normalizedRanges.length?(a=this._normalizedRanges[i],i++):(a=t._normalizedRanges[r],r++);s===null?s=a:s.endLineNumberExclusive>=a.startLineNumber?s=new Y(s.startLineNumber,Math.max(s.endLineNumberExclusive,a.endLineNumberExclusive)):(n.push(s),s=a)}return s!==null&&n.push(s),new e(n)}subtractFrom(t){let n=Nt(this._normalizedRanges,a=>a.endLineNumberExclusive>=t.startLineNumber),i=it(this._normalizedRanges,a=>a.startLineNumber<=t.endLineNumberExclusive)+1;if(n===i)return new e([t]);let r=[],s=t.startLineNumber;for(let a=n;a<i;a++){let l=this._normalizedRanges[a];l.startLineNumber>s&&r.push(new Y(s,l.startLineNumber)),s=l.endLineNumberExclusive}return s<t.endLineNumberExclusive&&r.push(new Y(s,t.endLineNumberExclusive)),new e(r)}toString(){return this._normalizedRanges.map(t=>t.toString()).join(", ")}getIntersection(t){let n=[],i=0,r=0;for(;i<this._normalizedRanges.length&&r<t._normalizedRanges.length;){let s=this._normalizedRanges[i],a=t._normalizedRanges[r],l=s.intersect(a);l&&!l.isEmpty&&n.push(l),s.endLineNumberExclusive<a.endLineNumberExclusive?i++:r++}return new e(n)}getWithDelta(t){return new e(this._normalizedRanges.map(n=>n.delta(t)))}};var Je=class e{static inverse(t,n,i){let r=[],s=1,a=1;for(let o of t){let u=new e(new Y(s,o.original.startLineNumber),new Y(a,o.modified.startLineNumber));u.modified.isEmpty||r.push(u),s=o.original.endLineNumberExclusive,a=o.modified.endLineNumberExclusive}let l=new e(new Y(s,n+1),new Y(a,i+1));return l.modified.isEmpty||r.push(l),r}static clip(t,n,i){let r=[];for(let s of t){let a=s.original.intersect(n),l=s.modified.intersect(i);a&&!a.isEmpty&&l&&!l.isEmpty&&r.push(new e(a,l))}return r}constructor(t,n){this.original=t,this.modified=n}toString(){return`{${this.original.toString()}->${this.modified.toString()}}`}flip(){return new e(this.modified,this.original)}join(t){return new e(this.original.join(t.original),this.modified.join(t.modified))}get changedLineCount(){return Math.max(this.original.length,this.modified.length)}},He=class e extends Je{constructor(t,n,i){super(t,n),this.innerChanges=i}flip(){return new e(this.modified,this.original,this.innerChanges?.map(t=>t.flip()))}},ct=class e{constructor(t,n){this.originalRange=t,this.modifiedRange=n}toString(){return`{${this.originalRange.toString()}->${this.modifiedRange.toString()}}`}flip(){return new e(this.modifiedRange,this.originalRange)}};var tu=3,Pn=class{computeDiff(t,n,i){let s=new $t(t,n,{maxComputationTime:i.maxComputationTimeMs,shouldIgnoreTrimWhitespace:i.ignoreTrimWhitespace,shouldComputeCharChanges:!0,shouldMakePrettyDiff:!0,shouldPostProcessCharChanges:!0}).computeDiff(),a=[],l=null;for(let o of s.changes){let u;o.originalEndLineNumber===0?u=new Y(o.originalStartLineNumber+1,o.originalStartLineNumber+1):u=new Y(o.originalStartLineNumber,o.originalEndLineNumber+1);let c;o.modifiedEndLineNumber===0?c=new Y(o.modifiedStartLineNumber+1,o.modifiedStartLineNumber+1):c=new Y(o.modifiedStartLineNumber,o.modifiedEndLineNumber+1);let h=new He(u,c,o.charChanges?.map(f=>new ct(new J(f.originalStartLineNumber,f.originalStartColumn,f.originalEndLineNumber,f.originalEndColumn),new J(f.modifiedStartLineNumber,f.modifiedStartColumn,f.modifiedEndLineNumber,f.modifiedEndColumn))));l&&(l.modified.endLineNumberExclusive===h.modified.startLineNumber||l.original.endLineNumberExclusive===h.original.startLineNumber)&&(h=new He(l.original.join(h.original),l.modified.join(h.modified),l.innerChanges&&h.innerChanges?l.innerChanges.concat(h.innerChanges):void 0),a.pop()),a.push(h),l=h}return At(()=>Fn(a,(o,u)=>u.original.startLineNumber-o.original.endLineNumberExclusive===u.modified.startLineNumber-o.modified.endLineNumberExclusive&&o.original.endLineNumberExclusive<u.original.startLineNumber&&o.modified.endLineNumberExclusive<u.modified.startLineNumber)),new Qe(a,[],s.quitEarly)}};function Ra(e,t,n,i){return new Pt(e,t,n).ComputeDiff(i)}var qn=class{constructor(t){let n=[],i=[];for(let r=0,s=t.length;r<s;r++)n[r]=Ki(t[r],1),i[r]=er(t[r],1);this.lines=t,this._startColumns=n,this._endColumns=i}getElements(){let t=[];for(let n=0,i=this.lines.length;n<i;n++)t[n]=this.lines[n].substring(this._startColumns[n]-1,this._endColumns[n]-1);return t}getStrictElement(t){return this.lines[t]}getStartLineNumber(t){return t+1}getEndLineNumber(t){return t+1}createCharSequence(t,n,i){let r=[],s=[],a=[],l=0;for(let o=n;o<=i;o++){let u=this.lines[o],c=t?this._startColumns[o]:1,h=t?this._endColumns[o]:u.length+1;for(let f=c;f<h;f++)r[l]=u.charCodeAt(f-1),s[l]=o+1,a[l]=f,l++;!t&&o<i&&(r[l]=10,s[l]=o+1,a[l]=u.length+1,l++)}return new Zi(r,s,a)}},Zi=class{constructor(t,n,i){this._charCodes=t,this._lineNumbers=n,this._columns=i}toString(){return"["+this._charCodes.map((t,n)=>(t===10?"\\n":String.fromCharCode(t))+`-(${this._lineNumbers[n]},${this._columns[n]})`).join(", ")+"]"}_assertIndex(t,n){if(t<0||t>=n.length)throw new Error("Illegal index")}getElements(){return this._charCodes}getStartLineNumber(t){return t>0&&t===this._lineNumbers.length?this.getEndLineNumber(t-1):(this._assertIndex(t,this._lineNumbers),this._lineNumbers[t])}getEndLineNumber(t){return t===-1?this.getStartLineNumber(t+1):(this._assertIndex(t,this._lineNumbers),this._charCodes[t]===10?this._lineNumbers[t]+1:this._lineNumbers[t])}getStartColumn(t){return t>0&&t===this._columns.length?this.getEndColumn(t-1):(this._assertIndex(t,this._columns),this._columns[t])}getEndColumn(t){return t===-1?this.getStartColumn(t+1):(this._assertIndex(t,this._columns),this._charCodes[t]===10?1:this._columns[t]+1)}},kt=class e{constructor(t,n,i,r,s,a,l,o){this.originalStartLineNumber=t,this.originalStartColumn=n,this.originalEndLineNumber=i,this.originalEndColumn=r,this.modifiedStartLineNumber=s,this.modifiedStartColumn=a,this.modifiedEndLineNumber=l,this.modifiedEndColumn=o}static createFromDiffChange(t,n,i){let r=n.getStartLineNumber(t.originalStart),s=n.getStartColumn(t.originalStart),a=n.getEndLineNumber(t.originalStart+t.originalLength-1),l=n.getEndColumn(t.originalStart+t.originalLength-1),o=i.getStartLineNumber(t.modifiedStart),u=i.getStartColumn(t.modifiedStart),c=i.getEndLineNumber(t.modifiedStart+t.modifiedLength-1),h=i.getEndColumn(t.modifiedStart+t.modifiedLength-1);return new e(r,s,a,l,o,u,c,h)}};function nu(e){if(e.length<=1)return e;let t=[e[0]],n=t[0];for(let i=1,r=e.length;i<r;i++){let s=e[i],a=s.originalStart-(n.originalStart+n.originalLength),l=s.modifiedStart-(n.modifiedStart+n.modifiedLength);Math.min(a,l)<tu?(n.originalLength=s.originalStart+s.originalLength-n.originalStart,n.modifiedLength=s.modifiedStart+s.modifiedLength-n.modifiedStart):(t.push(s),n=s)}return t}var Gt=class e{constructor(t,n,i,r,s){this.originalStartLineNumber=t,this.originalEndLineNumber=n,this.modifiedStartLineNumber=i,this.modifiedEndLineNumber=r,this.charChanges=s}static createFromDiffResult(t,n,i,r,s,a,l){let o,u,c,h,f;if(n.originalLength===0?(o=i.getStartLineNumber(n.originalStart)-1,u=0):(o=i.getStartLineNumber(n.originalStart),u=i.getEndLineNumber(n.originalStart+n.originalLength-1)),n.modifiedLength===0?(c=r.getStartLineNumber(n.modifiedStart)-1,h=0):(c=r.getStartLineNumber(n.modifiedStart),h=r.getEndLineNumber(n.modifiedStart+n.modifiedLength-1)),a&&n.originalLength>0&&n.originalLength<20&&n.modifiedLength>0&&n.modifiedLength<20&&s()){let m=i.createCharSequence(t,n.originalStart,n.originalStart+n.originalLength-1),b=r.createCharSequence(t,n.modifiedStart,n.modifiedStart+n.modifiedLength-1);if(m.getElements().length>0&&b.getElements().length>0){let p=Ra(m,b,s,!0).changes;l&&(p=nu(p)),f=[];for(let w=0,x=p.length;w<x;w++)f.push(kt.createFromDiffChange(p[w],m,b))}}return new e(o,u,c,h,f)}},$t=class{constructor(t,n,i){this.shouldComputeCharChanges=i.shouldComputeCharChanges,this.shouldPostProcessCharChanges=i.shouldPostProcessCharChanges,this.shouldIgnoreTrimWhitespace=i.shouldIgnoreTrimWhitespace,this.shouldMakePrettyDiff=i.shouldMakePrettyDiff,this.originalLines=t,this.modifiedLines=n,this.original=new qn(t),this.modified=new qn(n),this.continueLineDiff=Ma(i.maxComputationTime),this.continueCharDiff=Ma(i.maxComputationTime===0?0:Math.min(i.maxComputationTime,5e3))}computeDiff(){if(this.original.lines.length===1&&this.original.lines[0].length===0)return this.modified.lines.length===1&&this.modified.lines[0].length===0?{quitEarly:!1,changes:[]}:{quitEarly:!1,changes:[{originalStartLineNumber:1,originalEndLineNumber:1,modifiedStartLineNumber:1,modifiedEndLineNumber:this.modified.lines.length,charChanges:void 0}]};if(this.modified.lines.length===1&&this.modified.lines[0].length===0)return{quitEarly:!1,changes:[{originalStartLineNumber:1,originalEndLineNumber:this.original.lines.length,modifiedStartLineNumber:1,modifiedEndLineNumber:1,charChanges:void 0}]};let t=Ra(this.original,this.modified,this.continueLineDiff,this.shouldMakePrettyDiff),n=t.changes,i=t.quitEarly;if(this.shouldIgnoreTrimWhitespace){let l=[];for(let o=0,u=n.length;o<u;o++)l.push(Gt.createFromDiffResult(this.shouldIgnoreTrimWhitespace,n[o],this.original,this.modified,this.continueCharDiff,this.shouldComputeCharChanges,this.shouldPostProcessCharChanges));return{quitEarly:i,changes:l}}let r=[],s=0,a=0;for(let l=-1,o=n.length;l<o;l++){let u=l+1<o?n[l+1]:null,c=u?u.originalStart:this.originalLines.length,h=u?u.modifiedStart:this.modifiedLines.length;for(;s<c&&a<h;){let f=this.originalLines[s],m=this.modifiedLines[a];if(f!==m){{let b=Ki(f,1),p=Ki(m,1);for(;b>1&&p>1;){let w=f.charCodeAt(b-2),x=m.charCodeAt(p-2);if(w!==x)break;b--,p--}(b>1||p>1)&&this._pushTrimWhitespaceCharChange(r,s+1,1,b,a+1,1,p)}{let b=er(f,1),p=er(m,1),w=f.length+1,x=m.length+1;for(;b<w&&p<x;){let _=f.charCodeAt(b-1),y=f.charCodeAt(p-1);if(_!==y)break;b++,p++}(b<w||p<x)&&this._pushTrimWhitespaceCharChange(r,s+1,b,w,a+1,p,x)}}s++,a++}u&&(r.push(Gt.createFromDiffResult(this.shouldIgnoreTrimWhitespace,u,this.original,this.modified,this.continueCharDiff,this.shouldComputeCharChanges,this.shouldPostProcessCharChanges)),s+=u.originalLength,a+=u.modifiedLength)}return{quitEarly:i,changes:r}}_pushTrimWhitespaceCharChange(t,n,i,r,s,a,l){if(this._mergeTrimWhitespaceCharChange(t,n,i,r,s,a,l))return;let o;this.shouldComputeCharChanges&&(o=[new kt(n,i,n,r,s,a,s,l)]),t.push(new Gt(n,n,s,s,o))}_mergeTrimWhitespaceCharChange(t,n,i,r,s,a,l){let o=t.length;if(o===0)return!1;let u=t[o-1];return u.originalEndLineNumber===0||u.modifiedEndLineNumber===0?!1:u.originalEndLineNumber===n&&u.modifiedEndLineNumber===s?(this.shouldComputeCharChanges&&u.charChanges&&u.charChanges.push(new kt(n,i,n,r,s,a,s,l)),!0):u.originalEndLineNumber+1===n&&u.modifiedEndLineNumber+1===s?(u.originalEndLineNumber=n,u.modifiedEndLineNumber=s,this.shouldComputeCharChanges&&u.charChanges&&u.charChanges.push(new kt(n,i,n,r,s,a,s,l)),!0):!1}};function Ki(e,t){let n=ts(e);return n===-1?t:n+1}function er(e,t){let n=ns(e);return n===-1?t:n+2}function Ma(e){if(e===0)return()=>!0;let t=Date.now();return()=>Date.now()-t<e}var Re=class e{static trivial(t,n){return new e([new se($.ofLength(t.length),$.ofLength(n.length))],!1)}static trivialTimedOut(t,n){return new e([new se($.ofLength(t.length),$.ofLength(n.length))],!0)}constructor(t,n){this.diffs=t,this.hitTimeout=n}},se=class e{static invert(t,n){let i=[];return Cr(t,(r,s)=>{i.push(e.fromOffsetPairs(r?r.getEndExclusives():Me.zero,s?s.getStarts():new Me(n,(r?r.seq2Range.endExclusive-r.seq1Range.endExclusive:0)+n)))}),i}static fromOffsetPairs(t,n){return new e(new $(t.offset1,n.offset1),new $(t.offset2,n.offset2))}constructor(t,n){this.seq1Range=t,this.seq2Range=n}swap(){return new e(this.seq2Range,this.seq1Range)}toString(){return`${this.seq1Range} <-> ${this.seq2Range}`}join(t){return new e(this.seq1Range.join(t.seq1Range),this.seq2Range.join(t.seq2Range))}delta(t){return t===0?this:new e(this.seq1Range.delta(t),this.seq2Range.delta(t))}deltaStart(t){return t===0?this:new e(this.seq1Range.deltaStart(t),this.seq2Range.deltaStart(t))}deltaEnd(t){return t===0?this:new e(this.seq1Range.deltaEnd(t),this.seq2Range.deltaEnd(t))}intersectsOrTouches(t){return this.seq1Range.intersectsOrTouches(t.seq1Range)||this.seq2Range.intersectsOrTouches(t.seq2Range)}intersect(t){let n=this.seq1Range.intersect(t.seq1Range),i=this.seq2Range.intersect(t.seq2Range);if(!(!n||!i))return new e(n,i)}getStarts(){return new Me(this.seq1Range.start,this.seq2Range.start)}getEndExclusives(){return new Me(this.seq1Range.endExclusive,this.seq2Range.endExclusive)}},Me=class e{static{this.zero=new e(0,0)}static{this.max=new e(Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER)}constructor(t,n){this.offset1=t,this.offset2=n}toString(){return`${this.offset1} <-> ${this.offset2}`}delta(t){return t===0?this:new e(this.offset1+t,this.offset2+t)}equals(t){return this.offset1===t.offset1&&this.offset2===t.offset2}},Xe=class e{static{this.instance=new e}isValid(){return!0}},On=class{constructor(t){if(this.timeout=t,this.startTime=Date.now(),this.valid=!0,t<=0)throw new pe("timeout must be positive")}isValid(){if(!(Date.now()-this.startTime<this.timeout)&&this.valid){this.valid=!1;debugger}return this.valid}disable(){this.timeout=Number.MAX_SAFE_INTEGER,this.isValid=()=>!0,this.valid=!0}};var St=class{constructor(t,n){this.width=t,this.height=n,this.array=[],this.array=new Array(t*n)}get(t,n){return this.array[t+n*this.width]}set(t,n,i){this.array[t+n*this.width]=i}};function Jt(e){return e===32||e===9}var Qt=class e{static{this.chrKeys=new Map}static getKey(t){let n=this.chrKeys.get(t);return n===void 0&&(n=this.chrKeys.size,this.chrKeys.set(t,n)),n}constructor(t,n,i){this.range=t,this.lines=n,this.source=i,this.histogram=[];let r=0;for(let s=t.startLineNumber-1;s<t.endLineNumberExclusive-1;s++){let a=n[s];for(let o=0;o<a.length;o++){r++;let u=a[o],c=e.getKey(u);this.histogram[c]=(this.histogram[c]||0)+1}r++;let l=e.getKey(`
`);this.histogram[l]=(this.histogram[l]||0)+1}this.totalCount=r}computeSimilarity(t){let n=0,i=Math.max(this.histogram.length,t.histogram.length);for(let r=0;r<i;r++)n+=Math.abs((this.histogram[r]??0)-(t.histogram[r]??0));return 1-n/(this.totalCount+t.totalCount)}};var Vn=class{compute(t,n,i=Xe.instance,r){if(t.length===0||n.length===0)return Re.trivial(t,n);let s=new St(t.length,n.length),a=new St(t.length,n.length),l=new St(t.length,n.length);for(let b=0;b<t.length;b++)for(let p=0;p<n.length;p++){if(!i.isValid())return Re.trivialTimedOut(t,n);let w=b===0?0:s.get(b-1,p),x=p===0?0:s.get(b,p-1),_;t.getElement(b)===n.getElement(p)?(b===0||p===0?_=0:_=s.get(b-1,p-1),b>0&&p>0&&a.get(b-1,p-1)===3&&(_+=l.get(b-1,p-1)),_+=r?r(b,p):1):_=-1;let y=Math.max(w,x,_);if(y===_){let C=b>0&&p>0?l.get(b-1,p-1):0;l.set(b,p,C+1),a.set(b,p,3)}else y===w?(l.set(b,p,0),a.set(b,p,1)):y===x&&(l.set(b,p,0),a.set(b,p,2));s.set(b,p,y)}let o=[],u=t.length,c=n.length;function h(b,p){(b+1!==u||p+1!==c)&&o.push(new se(new $(b+1,u),new $(p+1,c))),u=b,c=p}let f=t.length-1,m=n.length-1;for(;f>=0&&m>=0;)a.get(f,m)===3?(h(f,m),f--,m--):a.get(f,m)===1?f--:m--;return h(-1,-1),o.reverse(),new Re(o,!1)}};var Lt=class{compute(t,n,i=Xe.instance){if(t.length===0||n.length===0)return Re.trivial(t,n);let r=t,s=n;function a(p,w){for(;p<r.length&&w<s.length&&r.getElement(p)===s.getElement(w);)p++,w++;return p}let l=0,o=new tr;o.set(0,a(0,0));let u=new nr;u.set(0,o.get(0)===0?null:new jn(null,0,0,o.get(0)));let c=0;e:for(;;){if(l++,!i.isValid())return Re.trivialTimedOut(r,s);let p=-Math.min(l,s.length+l%2),w=Math.min(l,r.length+l%2);for(c=p;c<=w;c+=2){let x=c===w?-1:o.get(c+1),_=c===p?-1:o.get(c-1)+1,y=Math.min(Math.max(x,_),r.length),C=y-c;if(y>r.length||C>s.length)continue;let E=a(y,C);o.set(c,E);let B=y===x?u.get(c+1):u.get(c-1);if(u.set(c,E!==y?new jn(B,y,C,E-y):B),o.get(c)===r.length&&o.get(c)-c===s.length)break e}}let h=u.get(c),f=[],m=r.length,b=s.length;for(;;){let p=h?h.x+h.length:0,w=h?h.y+h.length:0;if((p!==m||w!==b)&&f.push(new se(new $(p,m),new $(w,b))),!h)break;m=h.x,b=h.y,h=h.prev}return f.reverse(),new Re(f,!1)}},jn=class{constructor(t,n,i,r){this.prev=t,this.x=n,this.y=i,this.length=r}},tr=class{constructor(){this.positiveArr=new Int32Array(10),this.negativeArr=new Int32Array(10)}get(t){return t<0?(t=-t-1,this.negativeArr[t]):this.positiveArr[t]}set(t,n){if(t<0){if(t=-t-1,t>=this.negativeArr.length){let i=this.negativeArr;this.negativeArr=new Int32Array(i.length*2),this.negativeArr.set(i)}this.negativeArr[t]=n}else{if(t>=this.positiveArr.length){let i=this.positiveArr;this.positiveArr=new Int32Array(i.length*2),this.positiveArr.set(i)}this.positiveArr[t]=n}}},nr=class{constructor(){this.positiveArr=[],this.negativeArr=[]}get(t){return t<0?(t=-t-1,this.negativeArr[t]):this.positiveArr[t]}set(t,n){t<0?(t=-t-1,this.negativeArr[t]=n):this.positiveArr[t]=n}};var Ye=class{constructor(t,n,i){this.lines=t,this.considerWhitespaceChanges=i,this.elements=[],this.firstCharOffsetByLine=[],this.additionalOffsetByLine=[];let r=!1;n.start>0&&n.endExclusive>=t.length&&(n=new $(n.start-1,n.endExclusive),r=!0),this.lineRange=n,this.firstCharOffsetByLine[0]=0;for(let s=this.lineRange.start;s<this.lineRange.endExclusive;s++){let a=t[s],l=0;if(r)l=a.length,a="",r=!1;else if(!i){let o=a.trimStart();l=a.length-o.length,a=o.trimEnd()}this.additionalOffsetByLine.push(l);for(let o=0;o<a.length;o++)this.elements.push(a.charCodeAt(o));s<t.length-1&&(this.elements.push(10),this.firstCharOffsetByLine[s-this.lineRange.start+1]=this.elements.length)}this.additionalOffsetByLine.push(0)}toString(){return`Slice: "${this.text}"`}get text(){return this.getText(new $(0,this.length))}getText(t){return this.elements.slice(t.start,t.endExclusive).map(n=>String.fromCharCode(n)).join("")}getElement(t){return this.elements[t]}get length(){return this.elements.length}getBoundaryScore(t){let n=Na(t>0?this.elements[t-1]:-1),i=Na(t<this.elements.length?this.elements[t]:-1);if(n===7&&i===8)return 0;if(n===8)return 150;let r=0;return n!==i&&(r+=10,n===0&&i===1&&(r+=1)),r+=Da(n),r+=Da(i),r}translateOffset(t){if(this.lineRange.isEmpty)return new oe(this.lineRange.start+1,1);let n=it(this.firstCharOffsetByLine,i=>i<=t);return new oe(this.lineRange.start+n+1,t-this.firstCharOffsetByLine[n]+this.additionalOffsetByLine[n]+1)}translateRange(t){return J.fromPositions(this.translateOffset(t.start),this.translateOffset(t.endExclusive))}findWordContaining(t){if(t<0||t>=this.elements.length||!ir(this.elements[t]))return;let n=t;for(;n>0&&ir(this.elements[n-1]);)n--;let i=t;for(;i<this.elements.length&&ir(this.elements[i]);)i++;return new $(n,i)}countLinesIn(t){return this.translateOffset(t.endExclusive).lineNumber-this.translateOffset(t.start).lineNumber}isStronglyEqual(t,n){return this.elements[t]===this.elements[n]}extendToFullLines(t){let n=Ie(this.firstCharOffsetByLine,r=>r<=t.start)??0,i=Ar(this.firstCharOffsetByLine,r=>t.endExclusive<=r)??this.elements.length;return new $(n,i)}};function ir(e){return e>=97&&e<=122||e>=65&&e<=90||e>=48&&e<=57}var iu={0:0,1:0,2:0,3:10,4:2,5:30,6:3,7:10,8:10};function Da(e){return iu[e]}function Na(e){return e===10?8:e===13?7:Jt(e)?6:e>=97&&e<=122?0:e>=65&&e<=90?1:e>=48&&e<=57?2:e===-1?3:e===44||e===59?5:4}function za(e,t,n,i,r,s){let{moves:a,excludedChanges:l}=su(e,t,n,s);if(!s.isValid())return[];let o=e.filter(c=>!l.has(c)),u=au(o,i,r,t,n,s);return Mr(a,u),a=ou(a),a=a.filter(c=>{let h=c.original.toOffsetRange().slice(t).map(m=>m.trim());return h.join(`
`).length>=15&&ru(h,m=>m.length>=2)>=2}),a=lu(e,a),a}function ru(e,t){let n=0;for(let i of e)t(i)&&n++;return n}function su(e,t,n,i){let r=[],s=e.filter(o=>o.modified.isEmpty&&o.original.length>=3).map(o=>new Qt(o.original,t,o)),a=new Set(e.filter(o=>o.original.isEmpty&&o.modified.length>=3).map(o=>new Qt(o.modified,n,o))),l=new Set;for(let o of s){let u=-1,c;for(let h of a){let f=o.computeSimilarity(h);f>u&&(u=f,c=h)}if(u>.9&&c&&(a.delete(c),r.push(new Je(o.range,c.range)),l.add(o.source),l.add(c.source)),!i.isValid())return{moves:r,excludedChanges:l}}return{moves:r,excludedChanges:l}}function au(e,t,n,i,r,s){let a=[],l=new ft;for(let f of e)for(let m=f.original.startLineNumber;m<f.original.endLineNumberExclusive-2;m++){let b=`${t[m-1]}:${t[m+1-1]}:${t[m+2-1]}`;l.add(b,{range:new Y(m,m+3)})}let o=[];e.sort(rt(f=>f.modified.startLineNumber,st));for(let f of e){let m=[];for(let b=f.modified.startLineNumber;b<f.modified.endLineNumberExclusive-2;b++){let p=`${n[b-1]}:${n[b+1-1]}:${n[b+2-1]}`,w=new Y(b,b+3),x=[];l.forEach(p,({range:_})=>{for(let C of m)if(C.originalLineRange.endLineNumberExclusive+1===_.endLineNumberExclusive&&C.modifiedLineRange.endLineNumberExclusive+1===w.endLineNumberExclusive){C.originalLineRange=new Y(C.originalLineRange.startLineNumber,_.endLineNumberExclusive),C.modifiedLineRange=new Y(C.modifiedLineRange.startLineNumber,w.endLineNumberExclusive),x.push(C);return}let y={modifiedLineRange:w,originalLineRange:_};o.push(y),x.push(y)}),m=x}if(!s.isValid())return[]}o.sort(Rr(rt(f=>f.modifiedLineRange.length,st)));let u=new ut,c=new ut;for(let f of o){let m=f.modifiedLineRange.startLineNumber-f.originalLineRange.startLineNumber,b=u.subtractFrom(f.modifiedLineRange),p=c.subtractFrom(f.originalLineRange).getWithDelta(m),w=b.getIntersection(p);for(let x of w.ranges){if(x.length<3)continue;let _=x,y=x.delta(-m);a.push(new Je(y,_)),u.addRange(_),c.addRange(y)}}a.sort(rt(f=>f.original.startLineNumber,st));let h=new Dt(e);for(let f=0;f<a.length;f++){let m=a[f],b=h.findLastMonotonous(B=>B.original.startLineNumber<=m.original.startLineNumber),p=Ie(e,B=>B.modified.startLineNumber<=m.modified.startLineNumber),w=Math.max(m.original.startLineNumber-b.original.startLineNumber,m.modified.startLineNumber-p.modified.startLineNumber),x=h.findLastMonotonous(B=>B.original.startLineNumber<m.original.endLineNumberExclusive),_=Ie(e,B=>B.modified.startLineNumber<m.modified.endLineNumberExclusive),y=Math.max(x.original.endLineNumberExclusive-m.original.endLineNumberExclusive,_.modified.endLineNumberExclusive-m.modified.endLineNumberExclusive),C;for(C=0;C<w;C++){let B=m.original.startLineNumber-C-1,v=m.modified.startLineNumber-C-1;if(B>i.length||v>r.length||u.contains(v)||c.contains(B)||!Ia(i[B-1],r[v-1],s))break}C>0&&(c.addRange(new Y(m.original.startLineNumber-C,m.original.startLineNumber)),u.addRange(new Y(m.modified.startLineNumber-C,m.modified.startLineNumber)));let E;for(E=0;E<y;E++){let B=m.original.endLineNumberExclusive+E,v=m.modified.endLineNumberExclusive+E;if(B>i.length||v>r.length||u.contains(v)||c.contains(B)||!Ia(i[B-1],r[v-1],s))break}E>0&&(c.addRange(new Y(m.original.endLineNumberExclusive,m.original.endLineNumberExclusive+E)),u.addRange(new Y(m.modified.endLineNumberExclusive,m.modified.endLineNumberExclusive+E))),(C>0||E>0)&&(a[f]=new Je(new Y(m.original.startLineNumber-C,m.original.endLineNumberExclusive+E),new Y(m.modified.startLineNumber-C,m.modified.endLineNumberExclusive+E)))}return a}function Ia(e,t,n){if(e.trim()===t.trim())return!0;if(e.length>300&&t.length>300)return!1;let r=new Lt().compute(new Ye([e],new $(0,1),!1),new Ye([t],new $(0,1),!1),n),s=0,a=se.invert(r.diffs,e.length);for(let c of a)c.seq1Range.forEach(h=>{Jt(e.charCodeAt(h))||s++});function l(c){let h=0;for(let f=0;f<e.length;f++)Jt(c.charCodeAt(f))||h++;return h}let o=l(e.length>t.length?e:t);return s/o>.6&&o>10}function ou(e){if(e.length===0)return e;e.sort(rt(n=>n.original.startLineNumber,st));let t=[e[0]];for(let n=1;n<e.length;n++){let i=t[t.length-1],r=e[n],s=r.original.startLineNumber-i.original.endLineNumberExclusive,a=r.modified.startLineNumber-i.modified.endLineNumberExclusive;if(s>=0&&a>=0&&s+a<=2){t[t.length-1]=i.join(r);continue}t.push(r)}return t}function lu(e,t){let n=new Dt(e);return t=t.filter(i=>{let r=n.findLastMonotonous(l=>l.original.startLineNumber<i.original.endLineNumberExclusive)||new Je(new Y(1,1),new Y(1,1)),s=Ie(e,l=>l.modified.startLineNumber<i.modified.endLineNumberExclusive);return r!==s}),t}function rr(e,t,n){let i=n;return i=Ua(e,t,i),i=Ua(e,t,i),i=uu(e,t,i),i}function Ua(e,t,n){if(n.length===0)return n;let i=[];i.push(n[0]);for(let s=1;s<n.length;s++){let a=i[i.length-1],l=n[s];if(l.seq1Range.isEmpty||l.seq2Range.isEmpty){let o=l.seq1Range.start-a.seq1Range.endExclusive,u;for(u=1;u<=o&&!(e.getElement(l.seq1Range.start-u)!==e.getElement(l.seq1Range.endExclusive-u)||t.getElement(l.seq2Range.start-u)!==t.getElement(l.seq2Range.endExclusive-u));u++);if(u--,u===o){i[i.length-1]=new se(new $(a.seq1Range.start,l.seq1Range.endExclusive-o),new $(a.seq2Range.start,l.seq2Range.endExclusive-o));continue}l=l.delta(-u)}i.push(l)}let r=[];for(let s=0;s<i.length-1;s++){let a=i[s+1],l=i[s];if(l.seq1Range.isEmpty||l.seq2Range.isEmpty){let o=a.seq1Range.start-l.seq1Range.endExclusive,u;for(u=0;u<o&&!(!e.isStronglyEqual(l.seq1Range.start+u,l.seq1Range.endExclusive+u)||!t.isStronglyEqual(l.seq2Range.start+u,l.seq2Range.endExclusive+u));u++);if(u===o){i[s+1]=new se(new $(l.seq1Range.start+o,a.seq1Range.endExclusive),new $(l.seq2Range.start+o,a.seq2Range.endExclusive));continue}u>0&&(l=l.delta(u))}r.push(l)}return i.length>0&&r.push(i[i.length-1]),r}function uu(e,t,n){if(!e.getBoundaryScore||!t.getBoundaryScore)return n;for(let i=0;i<n.length;i++){let r=i>0?n[i-1]:void 0,s=n[i],a=i+1<n.length?n[i+1]:void 0,l=new $(r?r.seq1Range.endExclusive+1:0,a?a.seq1Range.start-1:e.length),o=new $(r?r.seq2Range.endExclusive+1:0,a?a.seq2Range.start-1:t.length);s.seq1Range.isEmpty?n[i]=Fa(s,e,t,l,o):s.seq2Range.isEmpty&&(n[i]=Fa(s.swap(),t,e,o,l).swap())}return n}function Fa(e,t,n,i,r){let a=1;for(;e.seq1Range.start-a>=i.start&&e.seq2Range.start-a>=r.start&&n.isStronglyEqual(e.seq2Range.start-a,e.seq2Range.endExclusive-a)&&a<100;)a++;a--;let l=0;for(;e.seq1Range.start+l<i.endExclusive&&e.seq2Range.endExclusive+l<r.endExclusive&&n.isStronglyEqual(e.seq2Range.start+l,e.seq2Range.endExclusive+l)&&l<100;)l++;if(a===0&&l===0)return e;let o=0,u=-1;for(let c=-a;c<=l;c++){let h=e.seq2Range.start+c,f=e.seq2Range.endExclusive+c,m=e.seq1Range.start+c,b=t.getBoundaryScore(m)+n.getBoundaryScore(h)+n.getBoundaryScore(f);b>u&&(u=b,o=c)}return e.delta(o)}function Ha(e,t,n){let i=[];for(let r of n){let s=i[i.length-1];if(!s){i.push(r);continue}r.seq1Range.start-s.seq1Range.endExclusive<=2||r.seq2Range.start-s.seq2Range.endExclusive<=2?i[i.length-1]=new se(s.seq1Range.join(r.seq1Range),s.seq2Range.join(r.seq2Range)):i.push(r)}return i}function Wa(e,t,n){let i=se.invert(n,e.length),r=[],s=new Me(0,0);function a(o,u){if(o.offset1<s.offset1||o.offset2<s.offset2)return;let c=e.findWordContaining(o.offset1),h=t.findWordContaining(o.offset2);if(!c||!h)return;let f=new se(c,h),m=f.intersect(u),b=m.seq1Range.length,p=m.seq2Range.length;for(;i.length>0;){let w=i[0];if(!(w.seq1Range.intersects(c)||w.seq2Range.intersects(h)))break;let _=e.findWordContaining(w.seq1Range.start),y=t.findWordContaining(w.seq2Range.start),C=new se(_,y),E=C.intersect(w);if(b+=E.seq1Range.length,p+=E.seq2Range.length,f=f.join(C),f.seq1Range.endExclusive>=w.seq1Range.endExclusive)i.shift();else break}b+p<(f.seq1Range.length+f.seq2Range.length)*2/3&&r.push(f),s=f.getEndExclusives()}for(;i.length>0;){let o=i.shift();o.seq1Range.isEmpty||(a(o.getStarts(),o),a(o.getEndExclusives().delta(-1),o))}return cu(n,r)}function cu(e,t){let n=[];for(;e.length>0||t.length>0;){let i=e[0],r=t[0],s;i&&(!r||i.seq1Range.start<r.seq1Range.start)?s=e.shift():s=t.shift(),n.length>0&&n[n.length-1].seq1Range.endExclusive>=s.seq1Range.start?n[n.length-1]=n[n.length-1].join(s):n.push(s)}return n}function Ba(e,t,n){let i=n;if(i.length===0)return i;let r=0,s;do{s=!1;let a=[i[0]];for(let l=1;l<i.length;l++){let c=function(f,m){let b=new $(u.seq1Range.endExclusive,o.seq1Range.start);return e.getText(b).replace(/\s/g,"").length<=4&&(f.seq1Range.length+f.seq2Range.length>5||m.seq1Range.length+m.seq2Range.length>5)},o=i[l],u=a[a.length-1];c(u,o)?(s=!0,a[a.length-1]=a[a.length-1].join(o)):a.push(o)}i=a}while(r++<10&&s);return i}function Pa(e,t,n){let i=n;if(i.length===0)return i;let r=0,s;do{s=!1;let l=[i[0]];for(let o=1;o<i.length;o++){let h=function(m,b){let p=new $(c.seq1Range.endExclusive,u.seq1Range.start);if(e.countLinesIn(p)>5||p.length>500)return!1;let x=e.getText(p).trim();if(x.length>20||x.split(/\r\n|\r|\n/).length>1)return!1;let _=e.countLinesIn(m.seq1Range),y=m.seq1Range.length,C=t.countLinesIn(m.seq2Range),E=m.seq2Range.length,B=e.countLinesIn(b.seq1Range),v=b.seq1Range.length,g=t.countLinesIn(b.seq2Range),T=b.seq2Range.length,q=2*40+50;function S(A){return Math.min(A,q)}return Math.pow(Math.pow(S(_*40+y),1.5)+Math.pow(S(C*40+E),1.5),1.5)+Math.pow(Math.pow(S(B*40+v),1.5)+Math.pow(S(g*40+T),1.5),1.5)>(q**1.5)**1.5*1.3},u=i[o],c=l[l.length-1];h(c,u)?(s=!0,l[l.length-1]=l[l.length-1].join(u)):l.push(u)}i=l}while(r++<10&&s);let a=[];return Er(i,(l,o,u)=>{let c=o;function h(x){return x.length>0&&x.trim().length<=3&&o.seq1Range.length+o.seq2Range.length>100}let f=e.extendToFullLines(o.seq1Range),m=e.getText(new $(f.start,o.seq1Range.start));h(m)&&(c=c.deltaStart(-m.length));let b=e.getText(new $(o.seq1Range.endExclusive,f.endExclusive));h(b)&&(c=c.deltaEnd(b.length));let p=se.fromOffsetPairs(l?l.getEndExclusives():Me.zero,u?u.getStarts():Me.max),w=c.intersect(p);a.length>0&&w.getStarts().equals(a[a.length-1].getEndExclusives())?a[a.length-1]=a[a.length-1].join(w):a.push(w)}),a}var Xt=class{constructor(t,n){this.trimmedHash=t,this.lines=n}getElement(t){return this.trimmedHash[t]}get length(){return this.trimmedHash.length}getBoundaryScore(t){let n=t===0?0:qa(this.lines[t-1]),i=t===this.lines.length?0:qa(this.lines[t]);return 1e3-(n+i)}getText(t){return this.lines.slice(t.start,t.endExclusive).join(`
`)}isStronglyEqual(t,n){return this.lines[t]===this.lines[n]}};function qa(e){let t=0;for(;t<e.length&&(e.charCodeAt(t)===32||e.charCodeAt(t)===9);)t++;return t}var Gn=class{constructor(){this.dynamicProgrammingDiffing=new Vn,this.myersDiffingAlgorithm=new Lt}computeDiff(t,n,i){if(t.length<=1&&Sr(t,n,(E,B)=>E===B))return new Qe([],[],!1);if(t.length===1&&t[0].length===0||n.length===1&&n[0].length===0)return new Qe([new He(new Y(1,t.length+1),new Y(1,n.length+1),[new ct(new J(1,1,t.length,t[0].length+1),new J(1,1,n.length,n[0].length+1))])],[],!1);let r=i.maxComputationTimeMs===0?Xe.instance:new On(i.maxComputationTimeMs),s=!i.ignoreTrimWhitespace,a=new Map;function l(E){let B=a.get(E);return B===void 0&&(B=a.size,a.set(E,B)),B}let o=t.map(E=>l(E.trim())),u=n.map(E=>l(E.trim())),c=new Xt(o,t),h=new Xt(u,n),f=c.length+h.length<1700?this.dynamicProgrammingDiffing.compute(c,h,r,(E,B)=>t[E]===n[B]?n[B].length===0?.1:1+Math.log(1+n[B].length):.99):this.myersDiffingAlgorithm.compute(c,h),m=f.diffs,b=f.hitTimeout;m=rr(c,h,m),m=Ba(c,h,m);let p=[],w=E=>{if(s)for(let B=0;B<E;B++){let v=x+B,g=_+B;if(t[v]!==n[g]){let T=this.refineDiff(t,n,new se(new $(v,v+1),new $(g,g+1)),r,s);for(let q of T.mappings)p.push(q);T.hitTimeout&&(b=!0)}}},x=0,_=0;for(let E of m){At(()=>E.seq1Range.start-x===E.seq2Range.start-_);let B=E.seq1Range.start-x;w(B),x=E.seq1Range.endExclusive,_=E.seq2Range.endExclusive;let v=this.refineDiff(t,n,E,r,s);v.hitTimeout&&(b=!0);for(let g of v.mappings)p.push(g)}w(t.length-x);let y=Oa(p,t,n),C=[];return i.computeMoves&&(C=this.computeMoves(y,t,n,o,u,r,s)),At(()=>{function E(v,g){if(v.lineNumber<1||v.lineNumber>g.length)return!1;let T=g[v.lineNumber-1];return!(v.column<1||v.column>T.length+1)}function B(v,g){return!(v.startLineNumber<1||v.startLineNumber>g.length+1||v.endLineNumberExclusive<1||v.endLineNumberExclusive>g.length+1)}for(let v of y){if(!v.innerChanges)return!1;for(let g of v.innerChanges)if(!(E(g.modifiedRange.getStartPosition(),n)&&E(g.modifiedRange.getEndPosition(),n)&&E(g.originalRange.getStartPosition(),t)&&E(g.originalRange.getEndPosition(),t)))return!1;if(!B(v.modified,n)||!B(v.original,t))return!1}return!0}),new Qe(y,C,b)}computeMoves(t,n,i,r,s,a,l){return za(t,n,i,r,s,a).map(c=>{let h=this.refineDiff(n,i,new se(c.original.toOffsetRange(),c.modified.toOffsetRange()),a,l),f=Oa(h.mappings,n,i,!0);return new Bn(c,f)})}refineDiff(t,n,i,r,s){let a=new Ye(t,i.seq1Range,s),l=new Ye(n,i.seq2Range,s),o=a.length+l.length<500?this.dynamicProgrammingDiffing.compute(a,l,r):this.myersDiffingAlgorithm.compute(a,l,r),u=o.diffs;return u=rr(a,l,u),u=Wa(a,l,u),u=Ha(a,l,u),u=Pa(a,l,u),{mappings:u.map(h=>new ct(a.translateRange(h.seq1Range),l.translateRange(h.seq2Range))),hitTimeout:o.hitTimeout}}};function Oa(e,t,n,i=!1){let r=[];for(let s of Lr(e.map(a=>hu(a,t,n)),(a,l)=>a.original.overlapOrTouch(l.original)||a.modified.overlapOrTouch(l.modified))){let a=s[0],l=s[s.length-1];r.push(new He(a.original.join(l.original),a.modified.join(l.modified),s.map(o=>o.innerChanges[0])))}return At(()=>!i&&r.length>0&&r[0].original.startLineNumber!==r[0].modified.startLineNumber?!1:Fn(r,(s,a)=>a.original.startLineNumber-s.original.endLineNumberExclusive===a.modified.startLineNumber-s.modified.endLineNumberExclusive&&s.original.endLineNumberExclusive<a.original.startLineNumber&&s.modified.endLineNumberExclusive<a.modified.startLineNumber)),r}function hu(e,t,n){let i=0,r=0;e.modifiedRange.endColumn===1&&e.originalRange.endColumn===1&&e.originalRange.startLineNumber+i<=e.originalRange.endLineNumber&&e.modifiedRange.startLineNumber+i<=e.modifiedRange.endLineNumber&&(r=-1),e.modifiedRange.startColumn-1>=n[e.modifiedRange.startLineNumber-1].length&&e.originalRange.startColumn-1>=t[e.originalRange.startLineNumber-1].length&&e.originalRange.startLineNumber<=e.originalRange.endLineNumber+r&&e.modifiedRange.startLineNumber<=e.modifiedRange.endLineNumber+r&&(i=1);let s=new Y(e.originalRange.startLineNumber+i,e.originalRange.endLineNumber+1+r),a=new Y(e.modifiedRange.startLineNumber+i,e.modifiedRange.endLineNumber+1+r);return new He(s,a,[e])}var $n={getLegacy:()=>new Pn,getDefault:()=>new Gn};function Ze(e,t){let n=Math.pow(10,t);return Math.round(e*n)/n}var ie=class{constructor(t,n,i,r=1){this._rgbaBrand=void 0,this.r=Math.min(255,Math.max(0,t))|0,this.g=Math.min(255,Math.max(0,n))|0,this.b=Math.min(255,Math.max(0,i))|0,this.a=Ze(Math.max(Math.min(1,r),0),3)}static equals(t,n){return t.r===n.r&&t.g===n.g&&t.b===n.b&&t.a===n.a}},De=class e{constructor(t,n,i,r){this._hslaBrand=void 0,this.h=Math.max(Math.min(360,t),0)|0,this.s=Ze(Math.max(Math.min(1,n),0),3),this.l=Ze(Math.max(Math.min(1,i),0),3),this.a=Ze(Math.max(Math.min(1,r),0),3)}static equals(t,n){return t.h===n.h&&t.s===n.s&&t.l===n.l&&t.a===n.a}static fromRGBA(t){let n=t.r/255,i=t.g/255,r=t.b/255,s=t.a,a=Math.max(n,i,r),l=Math.min(n,i,r),o=0,u=0,c=(l+a)/2,h=a-l;if(h>0){switch(u=Math.min(c<=.5?h/(2*c):h/(2-2*c),1),a){case n:o=(i-r)/h+(i<r?6:0);break;case i:o=(r-n)/h+2;break;case r:o=(n-i)/h+4;break}o*=60,o=Math.round(o)}return new e(o,u,c,s)}static _hue2rgb(t,n,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?t+(n-t)*6*i:i<1/2?n:i<2/3?t+(n-t)*(2/3-i)*6:t}static toRGBA(t){let n=t.h/360,{s:i,l:r,a:s}=t,a,l,o;if(i===0)a=l=o=r;else{let u=r<.5?r*(1+i):r+i-r*i,c=2*r-u;a=e._hue2rgb(c,u,n+1/3),l=e._hue2rgb(c,u,n),o=e._hue2rgb(c,u,n-1/3)}return new ie(Math.round(a*255),Math.round(l*255),Math.round(o*255),s)}},Ct=class e{constructor(t,n,i,r){this._hsvaBrand=void 0,this.h=Math.max(Math.min(360,t),0)|0,this.s=Ze(Math.max(Math.min(1,n),0),3),this.v=Ze(Math.max(Math.min(1,i),0),3),this.a=Ze(Math.max(Math.min(1,r),0),3)}static equals(t,n){return t.h===n.h&&t.s===n.s&&t.v===n.v&&t.a===n.a}static fromRGBA(t){let n=t.r/255,i=t.g/255,r=t.b/255,s=Math.max(n,i,r),a=Math.min(n,i,r),l=s-a,o=s===0?0:l/s,u;return l===0?u=0:s===n?u=((i-r)/l%6+6)%6:s===i?u=(r-n)/l+2:u=(n-i)/l+4,new e(Math.round(u*60),o,s,t.a)}static toRGBA(t){let{h:n,s:i,v:r,a:s}=t,a=r*i,l=a*(1-Math.abs(n/60%2-1)),o=r-a,[u,c,h]=[0,0,0];return n<60?(u=a,c=l):n<120?(u=l,c=a):n<180?(c=a,h=l):n<240?(c=l,h=a):n<300?(u=l,h=a):n<=360&&(u=a,h=l),u=Math.round((u+o)*255),c=Math.round((c+o)*255),h=Math.round((h+o)*255),new ie(u,c,h,s)}},ht=class e{static fromHex(t){return e.Format.CSS.parseHex(t)||e.red}static equals(t,n){return!t&&!n?!0:!t||!n?!1:t.equals(n)}get hsla(){return this._hsla?this._hsla:De.fromRGBA(this.rgba)}get hsva(){return this._hsva?this._hsva:Ct.fromRGBA(this.rgba)}constructor(t){if(t)if(t instanceof ie)this.rgba=t;else if(t instanceof De)this._hsla=t,this.rgba=De.toRGBA(t);else if(t instanceof Ct)this._hsva=t,this.rgba=Ct.toRGBA(t);else throw new Error("Invalid color ctor argument");else throw new Error("Color needs a value")}equals(t){return!!t&&ie.equals(this.rgba,t.rgba)&&De.equals(this.hsla,t.hsla)&&Ct.equals(this.hsva,t.hsva)}getRelativeLuminance(){let t=e._relativeLuminanceForComponent(this.rgba.r),n=e._relativeLuminanceForComponent(this.rgba.g),i=e._relativeLuminanceForComponent(this.rgba.b),r=.2126*t+.7152*n+.0722*i;return Ze(r,4)}static _relativeLuminanceForComponent(t){let n=t/255;return n<=.03928?n/12.92:Math.pow((n+.055)/1.055,2.4)}getContrastRatio(t){let n=this.getRelativeLuminance(),i=t.getRelativeLuminance();return n>i?(n+.05)/(i+.05):(i+.05)/(n+.05)}isDarker(){return(this.rgba.r*299+this.rgba.g*587+this.rgba.b*114)/1e3<128}isLighter(){return(this.rgba.r*299+this.rgba.g*587+this.rgba.b*114)/1e3>=128}isLighterThan(t){let n=this.getRelativeLuminance(),i=t.getRelativeLuminance();return n>i}isDarkerThan(t){let n=this.getRelativeLuminance(),i=t.getRelativeLuminance();return n<i}lighten(t){return new e(new De(this.hsla.h,this.hsla.s,this.hsla.l+this.hsla.l*t,this.hsla.a))}darken(t){return new e(new De(this.hsla.h,this.hsla.s,this.hsla.l-this.hsla.l*t,this.hsla.a))}transparent(t){let{r:n,g:i,b:r,a:s}=this.rgba;return new e(new ie(n,i,r,s*t))}isTransparent(){return this.rgba.a===0}isOpaque(){return this.rgba.a===1}opposite(){return new e(new ie(255-this.rgba.r,255-this.rgba.g,255-this.rgba.b,this.rgba.a))}blend(t){let n=t.rgba,i=this.rgba.a,r=n.a,s=i+r*(1-i);if(s<1e-6)return e.transparent;let a=this.rgba.r*i/s+n.r*r*(1-i)/s,l=this.rgba.g*i/s+n.g*r*(1-i)/s,o=this.rgba.b*i/s+n.b*r*(1-i)/s;return new e(new ie(a,l,o,s))}makeOpaque(t){if(this.isOpaque()||t.rgba.a!==1)return this;let{r:n,g:i,b:r,a:s}=this.rgba;return new e(new ie(t.rgba.r-s*(t.rgba.r-n),t.rgba.g-s*(t.rgba.g-i),t.rgba.b-s*(t.rgba.b-r),1))}flatten(...t){let n=t.reduceRight((i,r)=>e._flatten(r,i));return e._flatten(this,n)}static _flatten(t,n){let i=1-t.rgba.a;return new e(new ie(i*n.rgba.r+t.rgba.a*t.rgba.r,i*n.rgba.g+t.rgba.a*t.rgba.g,i*n.rgba.b+t.rgba.a*t.rgba.b))}toString(){return this._toString||(this._toString=e.Format.CSS.format(this)),this._toString}static getLighterColor(t,n,i){if(t.isLighterThan(n))return t;i=i||.5;let r=t.getRelativeLuminance(),s=n.getRelativeLuminance();return i=i*(s-r)/s,t.lighten(i)}static getDarkerColor(t,n,i){if(t.isDarkerThan(n))return t;i=i||.5;let r=t.getRelativeLuminance(),s=n.getRelativeLuminance();return i=i*(r-s)/r,t.darken(i)}static{this.white=new e(new ie(255,255,255,1))}static{this.black=new e(new ie(0,0,0,1))}static{this.red=new e(new ie(255,0,0,1))}static{this.blue=new e(new ie(0,0,255,1))}static{this.green=new e(new ie(0,255,0,1))}static{this.cyan=new e(new ie(0,255,255,1))}static{this.lightgrey=new e(new ie(211,211,211,1))}static{this.transparent=new e(new ie(0,0,0,0))}};(function(e){(function(t){(function(n){function i(m){return m.rgba.a===1?`rgb(${m.rgba.r}, ${m.rgba.g}, ${m.rgba.b})`:e.Format.CSS.formatRGBA(m)}n.formatRGB=i;function r(m){return`rgba(${m.rgba.r}, ${m.rgba.g}, ${m.rgba.b}, ${+m.rgba.a.toFixed(2)})`}n.formatRGBA=r;function s(m){return m.hsla.a===1?`hsl(${m.hsla.h}, ${(m.hsla.s*100).toFixed(2)}%, ${(m.hsla.l*100).toFixed(2)}%)`:e.Format.CSS.formatHSLA(m)}n.formatHSL=s;function a(m){return`hsla(${m.hsla.h}, ${(m.hsla.s*100).toFixed(2)}%, ${(m.hsla.l*100).toFixed(2)}%, ${m.hsla.a.toFixed(2)})`}n.formatHSLA=a;function l(m){let b=m.toString(16);return b.length!==2?"0"+b:b}function o(m){return`#${l(m.rgba.r)}${l(m.rgba.g)}${l(m.rgba.b)}`}n.formatHex=o;function u(m,b=!1){return b&&m.rgba.a===1?e.Format.CSS.formatHex(m):`#${l(m.rgba.r)}${l(m.rgba.g)}${l(m.rgba.b)}${l(Math.round(m.rgba.a*255))}`}n.formatHexA=u;function c(m){return m.isOpaque()?e.Format.CSS.formatHex(m):e.Format.CSS.formatRGBA(m)}n.format=c;function h(m){let b=m.length;if(b===0||m.charCodeAt(0)!==35)return null;if(b===7){let p=16*f(m.charCodeAt(1))+f(m.charCodeAt(2)),w=16*f(m.charCodeAt(3))+f(m.charCodeAt(4)),x=16*f(m.charCodeAt(5))+f(m.charCodeAt(6));return new e(new ie(p,w,x,1))}if(b===9){let p=16*f(m.charCodeAt(1))+f(m.charCodeAt(2)),w=16*f(m.charCodeAt(3))+f(m.charCodeAt(4)),x=16*f(m.charCodeAt(5))+f(m.charCodeAt(6)),_=16*f(m.charCodeAt(7))+f(m.charCodeAt(8));return new e(new ie(p,w,x,_/255))}if(b===4){let p=f(m.charCodeAt(1)),w=f(m.charCodeAt(2)),x=f(m.charCodeAt(3));return new e(new ie(16*p+p,16*w+w,16*x+x))}if(b===5){let p=f(m.charCodeAt(1)),w=f(m.charCodeAt(2)),x=f(m.charCodeAt(3)),_=f(m.charCodeAt(4));return new e(new ie(16*p+p,16*w+w,16*x+x,(16*_+_)/255))}return null}n.parseHex=h;function f(m){switch(m){case 48:return 0;case 49:return 1;case 50:return 2;case 51:return 3;case 52:return 4;case 53:return 5;case 54:return 6;case 55:return 7;case 56:return 8;case 57:return 9;case 97:return 10;case 65:return 10;case 98:return 11;case 66:return 11;case 99:return 12;case 67:return 12;case 100:return 13;case 68:return 13;case 101:return 14;case 69:return 14;case 102:return 15;case 70:return 15}return 0}})(t.CSS||(t.CSS={}))})(e.Format||(e.Format={}))})(ht||(ht={}));function Ga(e){let t=[];for(let n of e){let i=Number(n);(i||i===0&&n.replace(/\s/g,"")!=="")&&t.push(i)}return t}function sr(e,t,n,i){return{red:e/255,blue:n/255,green:t/255,alpha:i}}function Yt(e,t){let n=t.index,i=t[0].length;if(!n)return;let r=e.positionAt(n);return{startLineNumber:r.lineNumber,startColumn:r.column,endLineNumber:r.lineNumber,endColumn:r.column+i}}function du(e,t){if(!e)return;let n=ht.Format.CSS.parseHex(t);if(n)return{range:e,color:sr(n.rgba.r,n.rgba.g,n.rgba.b,n.rgba.a)}}function Va(e,t,n){if(!e||t.length!==1)return;let r=t[0].values(),s=Ga(r);return{range:e,color:sr(s[0],s[1],s[2],n?s[3]:1)}}function ja(e,t,n){if(!e||t.length!==1)return;let r=t[0].values(),s=Ga(r),a=new ht(new De(s[0],s[1]/100,s[2]/100,n?s[3]:1));return{range:e,color:sr(a.rgba.r,a.rgba.g,a.rgba.b,a.rgba.a)}}function Zt(e,t){return typeof e=="string"?[...e.matchAll(t)]:e.findMatches(t)}function fu(e){let t=[],i=Zt(e,/\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|(#)([A-Fa-f0-9]{3})\b|(#)([A-Fa-f0-9]{4})\b|(#)([A-Fa-f0-9]{6})\b|(#)([A-Fa-f0-9]{8})\b/gm);if(i.length>0)for(let r of i){let s=r.filter(u=>u!==void 0),a=s[1],l=s[2];if(!l)continue;let o;if(a==="rgb"){let u=/^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm;o=Va(Yt(e,r),Zt(l,u),!1)}else if(a==="rgba"){let u=/^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm;o=Va(Yt(e,r),Zt(l,u),!0)}else if(a==="hsl"){let u=/^\(\s*(36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm;o=ja(Yt(e,r),Zt(l,u),!1)}else if(a==="hsla"){let u=/^\(\s*(36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm;o=ja(Yt(e,r),Zt(l,u),!0)}else a==="#"&&(o=du(Yt(e,r),a+l));o&&t.push(o)}return t}function $a(e){return!e||typeof e.getValue!="function"||typeof e.positionAt!="function"?[]:fu(e)}var ar=class extends Sn{get uri(){return this._uri}get eol(){return this._eol}getValue(){return this.getText()}findMatches(t){let n=[];for(let i=0;i<this._lines.length;i++){let r=this._lines[i],s=this.offsetAt(new oe(i+1,1)),a=r.matchAll(t);for(let l of a)(l.index||l.index===0)&&(l.index=l.index+s),n.push(l)}return n}getLinesContent(){return this._lines.slice(0)}getLineCount(){return this._lines.length}getLineContent(t){return this._lines[t-1]}getWordAtPosition(t,n){let i=Ot(t.column,Pi(n),this._lines[t.lineNumber-1],0);return i?new J(t.lineNumber,i.startColumn,t.lineNumber,i.endColumn):null}getWordUntilPosition(t,n){let i=this.getWordAtPosition(t,n);return i?{word:this._lines[t.lineNumber-1].substring(i.startColumn-1,t.column-1),startColumn:i.startColumn,endColumn:t.column}:{word:"",startColumn:t.column,endColumn:t.column}}words(t){let n=this._lines,i=this._wordenize.bind(this),r=0,s="",a=0,l=[];return{*[Symbol.iterator](){for(;;)if(a<l.length){let o=s.substring(l[a].start,l[a].end);a+=1,yield o}else if(r<n.length)s=n[r],l=i(s,t),a=0,r+=1;else break}}}getLineWords(t,n){let i=this._lines[t-1],r=this._wordenize(i,n),s=[];for(let a of r)s.push({word:i.substring(a.start,a.end),startColumn:a.start+1,endColumn:a.end+1});return s}_wordenize(t,n){let i=[],r;for(n.lastIndex=0;(r=n.exec(t))&&r[0].length!==0;)i.push({start:r.index,end:r.index+r[0].length});return i}getValueInRange(t){if(t=this._validateRange(t),t.startLineNumber===t.endLineNumber)return this._lines[t.startLineNumber-1].substring(t.startColumn-1,t.endColumn-1);let n=this._eol,i=t.startLineNumber-1,r=t.endLineNumber-1,s=[];s.push(this._lines[i].substring(t.startColumn-1));for(let a=i+1;a<r;a++)s.push(this._lines[a]);return s.push(this._lines[r].substring(0,t.endColumn-1)),s.join(n)}offsetAt(t){return t=this._validatePosition(t),this._ensureLineStarts(),this._lineStarts.getPrefixSum(t.lineNumber-2)+(t.column-1)}positionAt(t){t=Math.floor(t),t=Math.max(0,t),this._ensureLineStarts();let n=this._lineStarts.getIndexOf(t),i=this._lines[n.index].length;return{lineNumber:1+n.index,column:1+Math.min(n.remainder,i)}}_validateRange(t){let n=this._validatePosition({lineNumber:t.startLineNumber,column:t.startColumn}),i=this._validatePosition({lineNumber:t.endLineNumber,column:t.endColumn});return n.lineNumber!==t.startLineNumber||n.column!==t.startColumn||i.lineNumber!==t.endLineNumber||i.column!==t.endColumn?{startLineNumber:n.lineNumber,startColumn:n.column,endLineNumber:i.lineNumber,endColumn:i.column}:t}_validatePosition(t){if(!oe.isIPosition(t))throw new Error("bad position");let{lineNumber:n,column:i}=t,r=!1;if(n<1)n=1,i=1,r=!0;else if(n>this._lines.length)n=this._lines.length,i=this._lines[n-1].length+1,r=!0;else{let s=this._lines[n-1].length+1;i<1?(i=1,r=!0):i>s&&(i=s,r=!0)}return r?{lineNumber:n,column:i}:t}},Qn=class e{constructor(t,n){this._host=t,this._models=Object.create(null),this._foreignModuleFactory=n,this._foreignModule=null}dispose(){this._models=Object.create(null)}_getModel(t){return this._models[t]}_getModels(){let t=[];return Object.keys(this._models).forEach(n=>t.push(this._models[n])),t}acceptNewModel(t){this._models[t.url]=new ar($e.parse(t.url),t.lines,t.EOL,t.versionId)}acceptModelChanged(t,n){if(!this._models[t])return;this._models[t].onEvents(n)}acceptRemovedModel(t){this._models[t]&&delete this._models[t]}async computeUnicodeHighlights(t,n,i){let r=this._getModel(t);return r?Hn.computeUnicodeHighlights(r,n,i):{ranges:[],hasMore:!1,ambiguousCharacterCount:0,invisibleCharacterCount:0,nonBasicAsciiCharacterCount:0}}async computeDiff(t,n,i,r){let s=this._getModel(t),a=this._getModel(n);return!s||!a?null:e.computeDiff(s,a,i,r)}static computeDiff(t,n,i,r){let s=r==="advanced"?$n.getDefault():$n.getLegacy(),a=t.getLinesContent(),l=n.getLinesContent(),o=s.computeDiff(a,l,i),u=o.changes.length>0?!1:this._modelsAreIdentical(t,n);function c(h){return h.map(f=>[f.original.startLineNumber,f.original.endLineNumberExclusive,f.modified.startLineNumber,f.modified.endLineNumberExclusive,f.innerChanges?.map(m=>[m.originalRange.startLineNumber,m.originalRange.startColumn,m.originalRange.endLineNumber,m.originalRange.endColumn,m.modifiedRange.startLineNumber,m.modifiedRange.startColumn,m.modifiedRange.endLineNumber,m.modifiedRange.endColumn])])}return{identical:u,quitEarly:o.hitTimeout,changes:c(o.changes),moves:o.moves.map(h=>[h.lineRangeMapping.original.startLineNumber,h.lineRangeMapping.original.endLineNumberExclusive,h.lineRangeMapping.modified.startLineNumber,h.lineRangeMapping.modified.endLineNumberExclusive,c(h.changes)])}}static _modelsAreIdentical(t,n){let i=t.getLineCount(),r=n.getLineCount();if(i!==r)return!1;for(let s=1;s<=i;s++){let a=t.getLineContent(s),l=n.getLineContent(s);if(a!==l)return!1}return!0}async computeDirtyDiff(t,n,i){let r=this._getModel(t),s=this._getModel(n);if(!r||!s)return null;let a=r.getLinesContent(),l=s.getLinesContent();return new $t(a,l,{shouldComputeCharChanges:!1,shouldPostProcessCharChanges:!1,shouldIgnoreTrimWhitespace:i,shouldMakePrettyDiff:!0,maxComputationTime:1e3}).computeDiff().changes}static{this._diffLimit=1e5}async computeMoreMinimalEdits(t,n,i){let r=this._getModel(t);if(!r)return n;let s=[],a;n=n.slice(0).sort((o,u)=>{if(o.range&&u.range)return J.compareRangesUsingStarts(o.range,u.range);let c=o.range?0:1,h=u.range?0:1;return c-h});let l=0;for(let o=1;o<n.length;o++)J.getEndPosition(n[l].range).equals(J.getStartPosition(n[o].range))?(n[l].range=J.fromPositions(J.getStartPosition(n[l].range),J.getEndPosition(n[o].range)),n[l].text+=n[o].text):(l++,n[l]=n[o]);n.length=l+1;for(let{range:o,text:u,eol:c}of n){if(typeof c=="number"&&(a=c),J.isEmpty(o)&&!u)continue;let h=r.getValueInRange(o);if(u=u.replace(/\r\n|\n|\r/g,r.eol),h===u)continue;if(Math.max(u.length,h.length)>e._diffLimit){s.push({range:o,text:u});continue}let f=hs(h,u,i),m=r.offsetAt(J.lift(o).getStartPosition());for(let b of f){let p=r.positionAt(m+b.originalStart),w=r.positionAt(m+b.originalStart+b.originalLength),x={text:u.substr(b.modifiedStart,b.modifiedLength),range:{startLineNumber:p.lineNumber,startColumn:p.column,endLineNumber:w.lineNumber,endColumn:w.column}};r.getValueInRange(x.range)!==x.text&&s.push(x)}}return typeof a=="number"&&s.push({eol:a,text:"",range:{startLineNumber:0,startColumn:0,endLineNumber:0,endColumn:0}}),s}computeHumanReadableDiff(t,n,i){let r=this._getModel(t);if(!r)return n;let s=[],a;n=n.slice(0).sort((l,o)=>{if(l.range&&o.range)return J.compareRangesUsingStarts(l.range,o.range);let u=l.range?0:1,c=o.range?0:1;return u-c});for(let{range:l,text:o,eol:u}of n){let p=function(x,_){return new oe(x.lineNumber+_.lineNumber-1,_.lineNumber===1?x.column+_.column-1:_.column)},w=function(x,_){let y=[];for(let C=_.startLineNumber;C<=_.endLineNumber;C++){let E=x[C-1];C===_.startLineNumber&&C===_.endLineNumber?y.push(E.substring(_.startColumn-1,_.endColumn-1)):C===_.startLineNumber?y.push(E.substring(_.startColumn-1)):C===_.endLineNumber?y.push(E.substring(0,_.endColumn-1)):y.push(E)}return y};if(typeof u=="number"&&(a=u),J.isEmpty(l)&&!o)continue;let c=r.getValueInRange(l);if(o=o.replace(/\r\n|\n|\r/g,r.eol),c===o)continue;if(Math.max(o.length,c.length)>e._diffLimit){s.push({range:l,text:o});continue}let h=c.split(/\r\n|\n|\r/),f=o.split(/\r\n|\n|\r/),m=$n.getDefault().computeDiff(h,f,i),b=J.lift(l).getStartPosition();for(let x of m.changes)if(x.innerChanges)for(let _ of x.innerChanges)s.push({range:J.fromPositions(p(b,_.originalRange.getStartPosition()),p(b,_.originalRange.getEndPosition())),text:w(f,_.modifiedRange).join(r.eol)});else throw new pe("The experimental diff algorithm always produces inner changes")}return typeof a=="number"&&s.push({eol:a,text:"",range:{startLineNumber:0,startColumn:0,endLineNumber:0,endColumn:0}}),s}async computeLinks(t){let n=this._getModel(t);return n?ys(n):null}async computeDefaultDocumentColors(t){let n=this._getModel(t);return n?$a(n):null}static{this._suggestionsLimit=1e4}async textualSuggest(t,n,i,r){let s=new bt,a=new RegExp(i,r),l=new Set;e:for(let o of t){let u=this._getModel(o);if(u){for(let c of u.words(a))if(!(c===n||!isNaN(Number(c)))&&(l.add(c),l.size>e._suggestionsLimit))break e}}return{words:Array.from(l),duration:s.elapsed()}}async computeWordRanges(t,n,i,r){let s=this._getModel(t);if(!s)return Object.create(null);let a=new RegExp(i,r),l=Object.create(null);for(let o=n.startLineNumber;o<n.endLineNumber;o++){let u=s.getLineWords(o,a);for(let c of u){if(!isNaN(Number(c.word)))continue;let h=l[c.word];h||(h=[],l[c.word]=h),h.push({startLineNumber:o,startColumn:c.startColumn,endLineNumber:o,endColumn:c.endColumn})}}return l}async navigateValueSet(t,n,i,r,s){let a=this._getModel(t);if(!a)return null;let l=new RegExp(r,s);n.startColumn===n.endColumn&&(n={startLineNumber:n.startLineNumber,startColumn:n.startColumn,endLineNumber:n.endLineNumber,endColumn:n.endColumn+1});let o=a.getValueInRange(n),u=a.getWordAtPosition({lineNumber:n.startLineNumber,column:n.startColumn},l);if(!u)return null;let c=a.getValueInRange(u);return Ln.INSTANCE.navigateValueSet(n,o,u,c,i)}loadForeignModule(t,n,i){let a={host:Or(i,(l,o)=>this._host.fhr(l,o)),getMirrorModels:()=>this._getModels()};return this._foreignModuleFactory?(this._foreignModule=this._foreignModuleFactory(a,n),Promise.resolve(Ft(this._foreignModule))):Promise.reject(new Error("Unexpected usage"))}fmr(t,n){if(!this._foreignModule||typeof this._foreignModule[t]!="function")return Promise.reject(new Error("Missing requestHandler or method: "+t));try{return Promise.resolve(this._foreignModule[t].apply(this._foreignModule,n))}catch(i){return Promise.reject(i)}}};typeof importScripts=="function"&&(globalThis.monaco=Ta());var or=!1;function Jn(e){if(or)return;or=!0;let t=new _n(n=>{globalThis.postMessage(n)},n=>new Qn(n,e));globalThis.onmessage=n=>{t.onmessage(n.data)}}globalThis.onmessage=e=>{or||Jn(null)};function pu(e,t){let n;return t.length===0?n=e:n=e.replace(/\{(\d+)\}/g,(i,r)=>{let s=r[0];return typeof t[s]<"u"?t[s]:i}),n}function gu(e,t,...n){return pu(t,n)}function wr(e){return gu}var Qa;(function(e){e.MIN_VALUE=-2147483648,e.MAX_VALUE=2147483647})(Qa||(Qa={}));var Zn;(function(e){e.MIN_VALUE=0,e.MAX_VALUE=2147483647})(Zn||(Zn={}));var he;(function(e){function t(i,r){return i===Number.MAX_VALUE&&(i=Zn.MAX_VALUE),r===Number.MAX_VALUE&&(r=Zn.MAX_VALUE),{line:i,character:r}}e.create=t;function n(i){var r=i;return M.objectLiteral(r)&&M.uinteger(r.line)&&M.uinteger(r.character)}e.is=n})(he||(he={}));var Z;(function(e){function t(i,r,s,a){if(M.uinteger(i)&&M.uinteger(r)&&M.uinteger(s)&&M.uinteger(a))return{start:he.create(i,r),end:he.create(s,a)};if(he.is(i)&&he.is(r))return{start:i,end:r};throw new Error("Range#create called with invalid arguments["+i+", "+r+", "+s+", "+a+"]")}e.create=t;function n(i){var r=i;return M.objectLiteral(r)&&he.is(r.start)&&he.is(r.end)}e.is=n})(Z||(Z={}));var Kn;(function(e){function t(i,r){return{uri:i,range:r}}e.create=t;function n(i){var r=i;return M.defined(r)&&Z.is(r.range)&&(M.string(r.uri)||M.undefined(r.uri))}e.is=n})(Kn||(Kn={}));var Ja;(function(e){function t(i,r,s,a){return{targetUri:i,targetRange:r,targetSelectionRange:s,originSelectionRange:a}}e.create=t;function n(i){var r=i;return M.defined(r)&&Z.is(r.targetRange)&&M.string(r.targetUri)&&(Z.is(r.targetSelectionRange)||M.undefined(r.targetSelectionRange))&&(Z.is(r.originSelectionRange)||M.undefined(r.originSelectionRange))}e.is=n})(Ja||(Ja={}));var cr;(function(e){function t(i,r,s,a){return{red:i,green:r,blue:s,alpha:a}}e.create=t;function n(i){var r=i;return M.numberRange(r.red,0,1)&&M.numberRange(r.green,0,1)&&M.numberRange(r.blue,0,1)&&M.numberRange(r.alpha,0,1)}e.is=n})(cr||(cr={}));var Xa;(function(e){function t(i,r){return{range:i,color:r}}e.create=t;function n(i){var r=i;return Z.is(r.range)&&cr.is(r.color)}e.is=n})(Xa||(Xa={}));var Ya;(function(e){function t(i,r,s){return{label:i,textEdit:r,additionalTextEdits:s}}e.create=t;function n(i){var r=i;return M.string(r.label)&&(M.undefined(r.textEdit)||le.is(r))&&(M.undefined(r.additionalTextEdits)||M.typedArray(r.additionalTextEdits,le.is))}e.is=n})(Ya||(Ya={}));var ei;(function(e){e.Comment="comment",e.Imports="imports",e.Region="region"})(ei||(ei={}));var Za;(function(e){function t(i,r,s,a,l){var o={startLine:i,endLine:r};return M.defined(s)&&(o.startCharacter=s),M.defined(a)&&(o.endCharacter=a),M.defined(l)&&(o.kind=l),o}e.create=t;function n(i){var r=i;return M.uinteger(r.startLine)&&M.uinteger(r.startLine)&&(M.undefined(r.startCharacter)||M.uinteger(r.startCharacter))&&(M.undefined(r.endCharacter)||M.uinteger(r.endCharacter))&&(M.undefined(r.kind)||M.string(r.kind))}e.is=n})(Za||(Za={}));var hr;(function(e){function t(i,r){return{location:i,message:r}}e.create=t;function n(i){var r=i;return M.defined(r)&&Kn.is(r.location)&&M.string(r.message)}e.is=n})(hr||(hr={}));var Ka;(function(e){e.Error=1,e.Warning=2,e.Information=3,e.Hint=4})(Ka||(Ka={}));var eo;(function(e){e.Unnecessary=1,e.Deprecated=2})(eo||(eo={}));var to;(function(e){function t(n){var i=n;return i!=null&&M.string(i.href)}e.is=t})(to||(to={}));var ti;(function(e){function t(i,r,s,a,l,o){var u={range:i,message:r};return M.defined(s)&&(u.severity=s),M.defined(a)&&(u.code=a),M.defined(l)&&(u.source=l),M.defined(o)&&(u.relatedInformation=o),u}e.create=t;function n(i){var r,s=i;return M.defined(s)&&Z.is(s.range)&&M.string(s.message)&&(M.number(s.severity)||M.undefined(s.severity))&&(M.integer(s.code)||M.string(s.code)||M.undefined(s.code))&&(M.undefined(s.codeDescription)||M.string((r=s.codeDescription)===null||r===void 0?void 0:r.href))&&(M.string(s.source)||M.undefined(s.source))&&(M.undefined(s.relatedInformation)||M.typedArray(s.relatedInformation,hr.is))}e.is=n})(ti||(ti={}));var nn;(function(e){function t(i,r){for(var s=[],a=2;a<arguments.length;a++)s[a-2]=arguments[a];var l={title:i,command:r};return M.defined(s)&&s.length>0&&(l.arguments=s),l}e.create=t;function n(i){var r=i;return M.defined(r)&&M.string(r.title)&&M.string(r.command)}e.is=n})(nn||(nn={}));var le;(function(e){function t(s,a){return{range:s,newText:a}}e.replace=t;function n(s,a){return{range:{start:s,end:s},newText:a}}e.insert=n;function i(s){return{range:s,newText:""}}e.del=i;function r(s){var a=s;return M.objectLiteral(a)&&M.string(a.newText)&&Z.is(a.range)}e.is=r})(le||(le={}));var Mt;(function(e){function t(i,r,s){var a={label:i};return r!==void 0&&(a.needsConfirmation=r),s!==void 0&&(a.description=s),a}e.create=t;function n(i){var r=i;return r!==void 0&&M.objectLiteral(r)&&M.string(r.label)&&(M.boolean(r.needsConfirmation)||r.needsConfirmation===void 0)&&(M.string(r.description)||r.description===void 0)}e.is=n})(Mt||(Mt={}));var fe;(function(e){function t(n){var i=n;return typeof i=="string"}e.is=t})(fe||(fe={}));var et;(function(e){function t(s,a,l){return{range:s,newText:a,annotationId:l}}e.replace=t;function n(s,a,l){return{range:{start:s,end:s},newText:a,annotationId:l}}e.insert=n;function i(s,a){return{range:s,newText:"",annotationId:a}}e.del=i;function r(s){var a=s;return le.is(a)&&(Mt.is(a.annotationId)||fe.is(a.annotationId))}e.is=r})(et||(et={}));var ni;(function(e){function t(i,r){return{textDocument:i,edits:r}}e.create=t;function n(i){var r=i;return M.defined(r)&&ii.is(r.textDocument)&&Array.isArray(r.edits)}e.is=n})(ni||(ni={}));var rn;(function(e){function t(i,r,s){var a={kind:"create",uri:i};return r!==void 0&&(r.overwrite!==void 0||r.ignoreIfExists!==void 0)&&(a.options=r),s!==void 0&&(a.annotationId=s),a}e.create=t;function n(i){var r=i;return r&&r.kind==="create"&&M.string(r.uri)&&(r.options===void 0||(r.options.overwrite===void 0||M.boolean(r.options.overwrite))&&(r.options.ignoreIfExists===void 0||M.boolean(r.options.ignoreIfExists)))&&(r.annotationId===void 0||fe.is(r.annotationId))}e.is=n})(rn||(rn={}));var sn;(function(e){function t(i,r,s,a){var l={kind:"rename",oldUri:i,newUri:r};return s!==void 0&&(s.overwrite!==void 0||s.ignoreIfExists!==void 0)&&(l.options=s),a!==void 0&&(l.annotationId=a),l}e.create=t;function n(i){var r=i;return r&&r.kind==="rename"&&M.string(r.oldUri)&&M.string(r.newUri)&&(r.options===void 0||(r.options.overwrite===void 0||M.boolean(r.options.overwrite))&&(r.options.ignoreIfExists===void 0||M.boolean(r.options.ignoreIfExists)))&&(r.annotationId===void 0||fe.is(r.annotationId))}e.is=n})(sn||(sn={}));var an;(function(e){function t(i,r,s){var a={kind:"delete",uri:i};return r!==void 0&&(r.recursive!==void 0||r.ignoreIfNotExists!==void 0)&&(a.options=r),s!==void 0&&(a.annotationId=s),a}e.create=t;function n(i){var r=i;return r&&r.kind==="delete"&&M.string(r.uri)&&(r.options===void 0||(r.options.recursive===void 0||M.boolean(r.options.recursive))&&(r.options.ignoreIfNotExists===void 0||M.boolean(r.options.ignoreIfNotExists)))&&(r.annotationId===void 0||fe.is(r.annotationId))}e.is=n})(an||(an={}));var dr;(function(e){function t(n){var i=n;return i&&(i.changes!==void 0||i.documentChanges!==void 0)&&(i.documentChanges===void 0||i.documentChanges.every(function(r){return M.string(r.kind)?rn.is(r)||sn.is(r)||an.is(r):ni.is(r)}))}e.is=t})(dr||(dr={}));var Xn=function(){function e(t,n){this.edits=t,this.changeAnnotations=n}return e.prototype.insert=function(t,n,i){var r,s;if(i===void 0?r=le.insert(t,n):fe.is(i)?(s=i,r=et.insert(t,n,i)):(this.assertChangeAnnotations(this.changeAnnotations),s=this.changeAnnotations.manage(i),r=et.insert(t,n,s)),this.edits.push(r),s!==void 0)return s},e.prototype.replace=function(t,n,i){var r,s;if(i===void 0?r=le.replace(t,n):fe.is(i)?(s=i,r=et.replace(t,n,i)):(this.assertChangeAnnotations(this.changeAnnotations),s=this.changeAnnotations.manage(i),r=et.replace(t,n,s)),this.edits.push(r),s!==void 0)return s},e.prototype.delete=function(t,n){var i,r;if(n===void 0?i=le.del(t):fe.is(n)?(r=n,i=et.del(t,n)):(this.assertChangeAnnotations(this.changeAnnotations),r=this.changeAnnotations.manage(n),i=et.del(t,r)),this.edits.push(i),r!==void 0)return r},e.prototype.add=function(t){this.edits.push(t)},e.prototype.all=function(){return this.edits},e.prototype.clear=function(){this.edits.splice(0,this.edits.length)},e.prototype.assertChangeAnnotations=function(t){if(t===void 0)throw new Error("Text edit change is not configured to manage change annotations.")},e}(),no=function(){function e(t){this._annotations=t===void 0?Object.create(null):t,this._counter=0,this._size=0}return e.prototype.all=function(){return this._annotations},Object.defineProperty(e.prototype,"size",{get:function(){return this._size},enumerable:!1,configurable:!0}),e.prototype.manage=function(t,n){var i;if(fe.is(t)?i=t:(i=this.nextId(),n=t),this._annotations[i]!==void 0)throw new Error("Id "+i+" is already in use.");if(n===void 0)throw new Error("No annotation provided for id "+i);return this._annotations[i]=n,this._size++,i},e.prototype.nextId=function(){return this._counter++,this._counter.toString()},e}();(function(){function e(t){var n=this;this._textEditChanges=Object.create(null),t!==void 0?(this._workspaceEdit=t,t.documentChanges?(this._changeAnnotations=new no(t.changeAnnotations),t.changeAnnotations=this._changeAnnotations.all(),t.documentChanges.forEach(function(i){if(ni.is(i)){var r=new Xn(i.edits,n._changeAnnotations);n._textEditChanges[i.textDocument.uri]=r}})):t.changes&&Object.keys(t.changes).forEach(function(i){var r=new Xn(t.changes[i]);n._textEditChanges[i]=r})):this._workspaceEdit={}}return Object.defineProperty(e.prototype,"edit",{get:function(){return this.initDocumentChanges(),this._changeAnnotations!==void 0&&(this._changeAnnotations.size===0?this._workspaceEdit.changeAnnotations=void 0:this._workspaceEdit.changeAnnotations=this._changeAnnotations.all()),this._workspaceEdit},enumerable:!1,configurable:!0}),e.prototype.getTextEditChange=function(t){if(ii.is(t)){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var n={uri:t.uri,version:t.version},i=this._textEditChanges[n.uri];if(!i){var r=[],s={textDocument:n,edits:r};this._workspaceEdit.documentChanges.push(s),i=new Xn(r,this._changeAnnotations),this._textEditChanges[n.uri]=i}return i}else{if(this.initChanges(),this._workspaceEdit.changes===void 0)throw new Error("Workspace edit is not configured for normal text edit changes.");var i=this._textEditChanges[t];if(!i){var r=[];this._workspaceEdit.changes[t]=r,i=new Xn(r),this._textEditChanges[t]=i}return i}},e.prototype.initDocumentChanges=function(){this._workspaceEdit.documentChanges===void 0&&this._workspaceEdit.changes===void 0&&(this._changeAnnotations=new no,this._workspaceEdit.documentChanges=[],this._workspaceEdit.changeAnnotations=this._changeAnnotations.all())},e.prototype.initChanges=function(){this._workspaceEdit.documentChanges===void 0&&this._workspaceEdit.changes===void 0&&(this._workspaceEdit.changes=Object.create(null))},e.prototype.createFile=function(t,n,i){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var r;Mt.is(n)||fe.is(n)?r=n:i=n;var s,a;if(r===void 0?s=rn.create(t,i):(a=fe.is(r)?r:this._changeAnnotations.manage(r),s=rn.create(t,i,a)),this._workspaceEdit.documentChanges.push(s),a!==void 0)return a},e.prototype.renameFile=function(t,n,i,r){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var s;Mt.is(i)||fe.is(i)?s=i:r=i;var a,l;if(s===void 0?a=sn.create(t,n,r):(l=fe.is(s)?s:this._changeAnnotations.manage(s),a=sn.create(t,n,r,l)),this._workspaceEdit.documentChanges.push(a),l!==void 0)return l},e.prototype.deleteFile=function(t,n,i){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var r;Mt.is(n)||fe.is(n)?r=n:i=n;var s,a;if(r===void 0?s=an.create(t,i):(a=fe.is(r)?r:this._changeAnnotations.manage(r),s=an.create(t,i,a)),this._workspaceEdit.documentChanges.push(s),a!==void 0)return a},e})();var io;(function(e){function t(i){return{uri:i}}e.create=t;function n(i){var r=i;return M.defined(r)&&M.string(r.uri)}e.is=n})(io||(io={}));var ro;(function(e){function t(i,r){return{uri:i,version:r}}e.create=t;function n(i){var r=i;return M.defined(r)&&M.string(r.uri)&&M.integer(r.version)}e.is=n})(ro||(ro={}));var ii;(function(e){function t(i,r){return{uri:i,version:r}}e.create=t;function n(i){var r=i;return M.defined(r)&&M.string(r.uri)&&(r.version===null||M.integer(r.version))}e.is=n})(ii||(ii={}));var so;(function(e){function t(i,r,s,a){return{uri:i,languageId:r,version:s,text:a}}e.create=t;function n(i){var r=i;return M.defined(r)&&M.string(r.uri)&&M.string(r.languageId)&&M.integer(r.version)&&M.string(r.text)}e.is=n})(so||(so={}));var Le;(function(e){e.PlainText="plaintext",e.Markdown="markdown"})(Le||(Le={}));(function(e){function t(n){var i=n;return i===e.PlainText||i===e.Markdown}e.is=t})(Le||(Le={}));var fr;(function(e){function t(n){var i=n;return M.objectLiteral(n)&&Le.is(i.kind)&&M.string(i.value)}e.is=t})(fr||(fr={}));var be;(function(e){e.Text=1,e.Method=2,e.Function=3,e.Constructor=4,e.Field=5,e.Variable=6,e.Class=7,e.Interface=8,e.Module=9,e.Property=10,e.Unit=11,e.Value=12,e.Enum=13,e.Keyword=14,e.Snippet=15,e.Color=16,e.File=17,e.Reference=18,e.Folder=19,e.EnumMember=20,e.Constant=21,e.Struct=22,e.Event=23,e.Operator=24,e.TypeParameter=25})(be||(be={}));var Se;(function(e){e.PlainText=1,e.Snippet=2})(Se||(Se={}));var ao;(function(e){e.Deprecated=1})(ao||(ao={}));var oo;(function(e){function t(i,r,s){return{newText:i,insert:r,replace:s}}e.create=t;function n(i){var r=i;return r&&M.string(r.newText)&&Z.is(r.insert)&&Z.is(r.replace)}e.is=n})(oo||(oo={}));var lo;(function(e){e.asIs=1,e.adjustIndentation=2})(lo||(lo={}));var uo;(function(e){function t(n){return{label:n}}e.create=t})(uo||(uo={}));var co;(function(e){function t(n,i){return{items:n||[],isIncomplete:!!i}}e.create=t})(co||(co={}));var ri;(function(e){function t(i){return i.replace(/[\\`*_{}[\]()#+\-.!]/g,"\\$&")}e.fromPlainText=t;function n(i){var r=i;return M.string(r)||M.objectLiteral(r)&&M.string(r.language)&&M.string(r.value)}e.is=n})(ri||(ri={}));var ho;(function(e){function t(n){var i=n;return!!i&&M.objectLiteral(i)&&(fr.is(i.contents)||ri.is(i.contents)||M.typedArray(i.contents,ri.is))&&(n.range===void 0||Z.is(n.range))}e.is=t})(ho||(ho={}));var fo;(function(e){function t(n,i){return i?{label:n,documentation:i}:{label:n}}e.create=t})(fo||(fo={}));var mo;(function(e){function t(n,i){for(var r=[],s=2;s<arguments.length;s++)r[s-2]=arguments[s];var a={label:n};return M.defined(i)&&(a.documentation=i),M.defined(r)?a.parameters=r:a.parameters=[],a}e.create=t})(mo||(mo={}));var si;(function(e){e.Text=1,e.Read=2,e.Write=3})(si||(si={}));var po;(function(e){function t(n,i){var r={range:n};return M.number(i)&&(r.kind=i),r}e.create=t})(po||(po={}));var mr;(function(e){e.File=1,e.Module=2,e.Namespace=3,e.Package=4,e.Class=5,e.Method=6,e.Property=7,e.Field=8,e.Constructor=9,e.Enum=10,e.Interface=11,e.Function=12,e.Variable=13,e.Constant=14,e.String=15,e.Number=16,e.Boolean=17,e.Array=18,e.Object=19,e.Key=20,e.Null=21,e.EnumMember=22,e.Struct=23,e.Event=24,e.Operator=25,e.TypeParameter=26})(mr||(mr={}));var go;(function(e){e.Deprecated=1})(go||(go={}));var bo;(function(e){function t(n,i,r,s,a){var l={name:n,kind:i,location:{uri:s,range:r}};return a&&(l.containerName=a),l}e.create=t})(bo||(bo={}));var vo;(function(e){function t(i,r,s,a,l,o){var u={name:i,detail:r,kind:s,range:a,selectionRange:l};return o!==void 0&&(u.children=o),u}e.create=t;function n(i){var r=i;return r&&M.string(r.name)&&M.number(r.kind)&&Z.is(r.range)&&Z.is(r.selectionRange)&&(r.detail===void 0||M.string(r.detail))&&(r.deprecated===void 0||M.boolean(r.deprecated))&&(r.children===void 0||Array.isArray(r.children))&&(r.tags===void 0||Array.isArray(r.tags))}e.is=n})(vo||(vo={}));var _o;(function(e){e.Empty="",e.QuickFix="quickfix",e.Refactor="refactor",e.RefactorExtract="refactor.extract",e.RefactorInline="refactor.inline",e.RefactorRewrite="refactor.rewrite",e.Source="source",e.SourceOrganizeImports="source.organizeImports",e.SourceFixAll="source.fixAll"})(_o||(_o={}));var wo;(function(e){function t(i,r){var s={diagnostics:i};return r!=null&&(s.only=r),s}e.create=t;function n(i){var r=i;return M.defined(r)&&M.typedArray(r.diagnostics,ti.is)&&(r.only===void 0||M.typedArray(r.only,M.string))}e.is=n})(wo||(wo={}));var yo;(function(e){function t(i,r,s){var a={title:i},l=!0;return typeof r=="string"?(l=!1,a.kind=r):nn.is(r)?a.command=r:a.edit=r,l&&s!==void 0&&(a.kind=s),a}e.create=t;function n(i){var r=i;return r&&M.string(r.title)&&(r.diagnostics===void 0||M.typedArray(r.diagnostics,ti.is))&&(r.kind===void 0||M.string(r.kind))&&(r.edit!==void 0||r.command!==void 0)&&(r.command===void 0||nn.is(r.command))&&(r.isPreferred===void 0||M.boolean(r.isPreferred))&&(r.edit===void 0||dr.is(r.edit))}e.is=n})(yo||(yo={}));var xo;(function(e){function t(i,r){var s={range:i};return M.defined(r)&&(s.data=r),s}e.create=t;function n(i){var r=i;return M.defined(r)&&Z.is(r.range)&&(M.undefined(r.command)||nn.is(r.command))}e.is=n})(xo||(xo={}));var To;(function(e){function t(i,r){return{tabSize:i,insertSpaces:r}}e.create=t;function n(i){var r=i;return M.defined(r)&&M.uinteger(r.tabSize)&&M.boolean(r.insertSpaces)}e.is=n})(To||(To={}));var Ao;(function(e){function t(i,r,s){return{range:i,target:r,data:s}}e.create=t;function n(i){var r=i;return M.defined(r)&&Z.is(r.range)&&(M.undefined(r.target)||M.string(r.target))}e.is=n})(Ao||(Ao={}));var ai;(function(e){function t(i,r){return{range:i,parent:r}}e.create=t;function n(i){var r=i;return r!==void 0&&Z.is(r.range)&&(r.parent===void 0||e.is(r.parent))}e.is=n})(ai||(ai={}));var ko;(function(e){function t(s,a,l,o){return new bu(s,a,l,o)}e.create=t;function n(s){var a=s;return!!(M.defined(a)&&M.string(a.uri)&&(M.undefined(a.languageId)||M.string(a.languageId))&&M.uinteger(a.lineCount)&&M.func(a.getText)&&M.func(a.positionAt)&&M.func(a.offsetAt))}e.is=n;function i(s,a){for(var l=s.getText(),o=r(a,function(b,p){var w=b.range.start.line-p.range.start.line;return w===0?b.range.start.character-p.range.start.character:w}),u=l.length,c=o.length-1;c>=0;c--){var h=o[c],f=s.offsetAt(h.range.start),m=s.offsetAt(h.range.end);if(m<=u)l=l.substring(0,f)+h.newText+l.substring(m,l.length);else throw new Error("Overlapping edit");u=f}return l}e.applyEdits=i;function r(s,a){if(s.length<=1)return s;var l=s.length/2|0,o=s.slice(0,l),u=s.slice(l);r(o,a),r(u,a);for(var c=0,h=0,f=0;c<o.length&&h<u.length;){var m=a(o[c],u[h]);m<=0?s[f++]=o[c++]:s[f++]=u[h++]}for(;c<o.length;)s[f++]=o[c++];for(;h<u.length;)s[f++]=u[h++];return s}})(ko||(ko={}));var bu=function(){function e(t,n,i,r){this._uri=t,this._languageId=n,this._version=i,this._content=r,this._lineOffsets=void 0}return Object.defineProperty(e.prototype,"uri",{get:function(){return this._uri},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"languageId",{get:function(){return this._languageId},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"version",{get:function(){return this._version},enumerable:!1,configurable:!0}),e.prototype.getText=function(t){if(t){var n=this.offsetAt(t.start),i=this.offsetAt(t.end);return this._content.substring(n,i)}return this._content},e.prototype.update=function(t,n){this._content=t.text,this._version=n,this._lineOffsets=void 0},e.prototype.getLineOffsets=function(){if(this._lineOffsets===void 0){for(var t=[],n=this._content,i=!0,r=0;r<n.length;r++){i&&(t.push(r),i=!1);var s=n.charAt(r);i=s==="\r"||s===`
`,s==="\r"&&r+1<n.length&&n.charAt(r+1)===`
`&&r++}i&&n.length>0&&t.push(n.length),this._lineOffsets=t}return this._lineOffsets},e.prototype.positionAt=function(t){t=Math.max(Math.min(t,this._content.length),0);var n=this.getLineOffsets(),i=0,r=n.length;if(r===0)return he.create(0,t);for(;i<r;){var s=Math.floor((i+r)/2);n[s]>t?r=s:i=s+1}var a=i-1;return he.create(a,t-n[a])},e.prototype.offsetAt=function(t){var n=this.getLineOffsets();if(t.line>=n.length)return this._content.length;if(t.line<0)return 0;var i=n[t.line],r=t.line+1<n.length?n[t.line+1]:this._content.length;return Math.max(Math.min(i+t.character,r),i)},Object.defineProperty(e.prototype,"lineCount",{get:function(){return this.getLineOffsets().length},enumerable:!1,configurable:!0}),e}(),M;(function(e){var t=Object.prototype.toString;function n(m){return typeof m<"u"}e.defined=n;function i(m){return typeof m>"u"}e.undefined=i;function r(m){return m===!0||m===!1}e.boolean=r;function s(m){return t.call(m)==="[object String]"}e.string=s;function a(m){return t.call(m)==="[object Number]"}e.number=a;function l(m,b,p){return t.call(m)==="[object Number]"&&b<=m&&m<=p}e.numberRange=l;function o(m){return t.call(m)==="[object Number]"&&-2147483648<=m&&m<=2147483647}e.integer=o;function u(m){return t.call(m)==="[object Number]"&&0<=m&&m<=2147483647}e.uinteger=u;function c(m){return t.call(m)==="[object Function]"}e.func=c;function h(m){return m!==null&&typeof m=="object"}e.objectLiteral=h;function f(m,b){return Array.isArray(m)&&m.every(b)}e.typedArray=f})(M||(M={}));var So=class pr{constructor(t,n,i,r){this._uri=t,this._languageId=n,this._version=i,this._content=r,this._lineOffsets=void 0}get uri(){return this._uri}get languageId(){return this._languageId}get version(){return this._version}getText(t){if(t){let n=this.offsetAt(t.start),i=this.offsetAt(t.end);return this._content.substring(n,i)}return this._content}update(t,n){for(let i of t)if(pr.isIncremental(i)){let r=Oo(i.range),s=this.offsetAt(r.start),a=this.offsetAt(r.end);this._content=this._content.substring(0,s)+i.text+this._content.substring(a,this._content.length);let l=Math.max(r.start.line,0),o=Math.max(r.end.line,0),u=this._lineOffsets,c=Lo(i.text,!1,s);if(o-l===c.length)for(let f=0,m=c.length;f<m;f++)u[f+l+1]=c[f];else c.length<1e4?u.splice(l+1,o-l,...c):this._lineOffsets=u=u.slice(0,l+1).concat(c,u.slice(o+1));let h=i.text.length-(a-s);if(h!==0)for(let f=l+1+c.length,m=u.length;f<m;f++)u[f]=u[f]+h}else if(pr.isFull(i))this._content=i.text,this._lineOffsets=void 0;else throw new Error("Unknown change event received");this._version=n}getLineOffsets(){return this._lineOffsets===void 0&&(this._lineOffsets=Lo(this._content,!0)),this._lineOffsets}positionAt(t){t=Math.max(Math.min(t,this._content.length),0);let n=this.getLineOffsets(),i=0,r=n.length;if(r===0)return{line:0,character:t};for(;i<r;){let a=Math.floor((i+r)/2);n[a]>t?r=a:i=a+1}let s=i-1;return{line:s,character:t-n[s]}}offsetAt(t){let n=this.getLineOffsets();if(t.line>=n.length)return this._content.length;if(t.line<0)return 0;let i=n[t.line],r=t.line+1<n.length?n[t.line+1]:this._content.length;return Math.max(Math.min(i+t.character,r),i)}get lineCount(){return this.getLineOffsets().length}static isIncremental(t){let n=t;return n!=null&&typeof n.text=="string"&&n.range!==void 0&&(n.rangeLength===void 0||typeof n.rangeLength=="number")}static isFull(t){let n=t;return n!=null&&typeof n.text=="string"&&n.range===void 0&&n.rangeLength===void 0}},gr;(function(e){function t(r,s,a,l){return new So(r,s,a,l)}e.create=t;function n(r,s,a){if(r instanceof So)return r.update(s,a),r;throw new Error("TextDocument.update: document must be created by TextDocument.create")}e.update=n;function i(r,s){let a=r.getText(),l=br(s.map(vu),(c,h)=>{let f=c.range.start.line-h.range.start.line;return f===0?c.range.start.character-h.range.start.character:f}),o=0,u=[];for(let c of l){let h=r.offsetAt(c.range.start);if(h<o)throw new Error("Overlapping edit");h>o&&u.push(a.substring(o,h)),c.newText.length&&u.push(c.newText),o=r.offsetAt(c.range.end)}return u.push(a.substr(o)),u.join("")}e.applyEdits=i})(gr||(gr={}));function br(e,t){if(e.length<=1)return e;let n=e.length/2|0,i=e.slice(0,n),r=e.slice(n);br(i,t),br(r,t);let s=0,a=0,l=0;for(;s<i.length&&a<r.length;)t(i[s],r[a])<=0?e[l++]=i[s++]:e[l++]=r[a++];for(;s<i.length;)e[l++]=i[s++];for(;a<r.length;)e[l++]=r[a++];return e}function Lo(e,t,n=0){let i=t?[n]:[];for(let r=0;r<e.length;r++){let s=e.charCodeAt(r);(s===13||s===10)&&(s===13&&r+1<e.length&&e.charCodeAt(r+1)===10&&r++,i.push(n+r+1))}return i}function Oo(e){let t=e.start,n=e.end;return t.line>n.line||t.line===n.line&&t.character>n.character?{start:n,end:t}:e}function vu(e){let t=Oo(e.range);return t!==e.range?{newText:e.newText,range:t}:e}var F;(function(e){e[e.StartCommentTag=0]="StartCommentTag",e[e.Comment=1]="Comment",e[e.EndCommentTag=2]="EndCommentTag",e[e.StartTagOpen=3]="StartTagOpen",e[e.StartTagClose=4]="StartTagClose",e[e.StartTagSelfClose=5]="StartTagSelfClose",e[e.StartTag=6]="StartTag",e[e.EndTagOpen=7]="EndTagOpen",e[e.EndTagClose=8]="EndTagClose",e[e.EndTag=9]="EndTag",e[e.DelimiterAssign=10]="DelimiterAssign",e[e.AttributeName=11]="AttributeName",e[e.AttributeValue=12]="AttributeValue",e[e.StartDoctypeTag=13]="StartDoctypeTag",e[e.Doctype=14]="Doctype",e[e.EndDoctypeTag=15]="EndDoctypeTag",e[e.Content=16]="Content",e[e.Whitespace=17]="Whitespace",e[e.Unknown=18]="Unknown",e[e.Script=19]="Script",e[e.Styles=20]="Styles",e[e.EOS=21]="EOS"})(F||(F={}));var V;(function(e){e[e.WithinContent=0]="WithinContent",e[e.AfterOpeningStartTag=1]="AfterOpeningStartTag",e[e.AfterOpeningEndTag=2]="AfterOpeningEndTag",e[e.WithinDoctype=3]="WithinDoctype",e[e.WithinTag=4]="WithinTag",e[e.WithinEndTag=5]="WithinEndTag",e[e.WithinComment=6]="WithinComment",e[e.WithinScriptContent=7]="WithinScriptContent",e[e.WithinStyleContent=8]="WithinStyleContent",e[e.AfterAttributeName=9]="AfterAttributeName",e[e.BeforeAttributeValue=10]="BeforeAttributeValue"})(V||(V={}));var Co;(function(e){e.LATEST={textDocument:{completion:{completionItem:{documentationFormat:[Le.Markdown,Le.PlainText]}},hover:{contentFormat:[Le.Markdown,Le.PlainText]}}}})(Co||(Co={}));var vr;(function(e){e[e.Unknown=0]="Unknown",e[e.File=1]="File",e[e.Directory=2]="Directory",e[e.SymbolicLink=64]="SymbolicLink"})(vr||(vr={}));var Ke=wr(),_u=function(){function e(t,n){this.source=t,this.len=t.length,this.position=n}return e.prototype.eos=function(){return this.len<=this.position},e.prototype.getSource=function(){return this.source},e.prototype.pos=function(){return this.position},e.prototype.goBackTo=function(t){this.position=t},e.prototype.goBack=function(t){this.position-=t},e.prototype.advance=function(t){this.position+=t},e.prototype.goToEnd=function(){this.position=this.source.length},e.prototype.nextChar=function(){return this.source.charCodeAt(this.position++)||0},e.prototype.peekChar=function(t){return t===void 0&&(t=0),this.source.charCodeAt(this.position+t)||0},e.prototype.advanceIfChar=function(t){return t===this.source.charCodeAt(this.position)?(this.position++,!0):!1},e.prototype.advanceIfChars=function(t){var n;if(this.position+t.length>this.source.length)return!1;for(n=0;n<t.length;n++)if(this.source.charCodeAt(this.position+n)!==t[n])return!1;return this.advance(n),!0},e.prototype.advanceIfRegExp=function(t){var n=this.source.substr(this.position),i=n.match(t);return i?(this.position=this.position+i.index+i[0].length,i[0]):""},e.prototype.advanceUntilRegExp=function(t){var n=this.source.substr(this.position),i=n.match(t);return i?(this.position=this.position+i.index,i[0]):(this.goToEnd(),"")},e.prototype.advanceUntilChar=function(t){for(;this.position<this.source.length;){if(this.source.charCodeAt(this.position)===t)return!0;this.advance(1)}return!1},e.prototype.advanceUntilChars=function(t){for(;this.position+t.length<=this.source.length;){for(var n=0;n<t.length&&this.source.charCodeAt(this.position+n)===t[n];n++);if(n===t.length)return!0;this.advance(1)}return this.goToEnd(),!1},e.prototype.skipWhitespace=function(){var t=this.advanceWhileChar(function(n){return n===Su||n===Lu||n===Tu||n===ku||n===Au});return t>0},e.prototype.advanceWhileChar=function(t){for(var n=this.position;this.position<this.len&&t(this.source.charCodeAt(this.position));)this.position++;return this.position-n},e}(),Eo=33,Et=45,Yn=60,Ne=62,lr=47,wu=61,yu=34,xu=39,Tu=10,Au=13,ku=12,Su=32,Lu=9,Cu={"text/x-handlebars-template":!0,"text/html":!0};function we(e,t,n,i){t===void 0&&(t=0),n===void 0&&(n=V.WithinContent),i===void 0&&(i=!1);var r=new _u(e,t),s=n,a=0,l=F.Unknown,o,u,c,h,f;function m(){return r.advanceIfRegExp(/^[_:\w][_:\w-.\d]*/).toLowerCase()}function b(){return r.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()}function p(_,y,C){return l=y,a=_,o=C,y}function w(){var _=r.pos(),y=s,C=x();return C!==F.EOS&&_===r.pos()&&!(i&&(C===F.StartTagClose||C===F.EndTagClose))?(console.log("Scanner.scan has not advanced at offset "+_+", state before: "+y+" after: "+s),r.advance(1),p(_,F.Unknown)):C}function x(){var _=r.pos();if(r.eos())return p(_,F.EOS);var y;switch(s){case V.WithinComment:return r.advanceIfChars([Et,Et,Ne])?(s=V.WithinContent,p(_,F.EndCommentTag)):(r.advanceUntilChars([Et,Et,Ne]),p(_,F.Comment));case V.WithinDoctype:return r.advanceIfChar(Ne)?(s=V.WithinContent,p(_,F.EndDoctypeTag)):(r.advanceUntilChar(Ne),p(_,F.Doctype));case V.WithinContent:if(r.advanceIfChar(Yn)){if(!r.eos()&&r.peekChar()===Eo){if(r.advanceIfChars([Eo,Et,Et]))return s=V.WithinComment,p(_,F.StartCommentTag);if(r.advanceIfRegExp(/^!doctype/i))return s=V.WithinDoctype,p(_,F.StartDoctypeTag)}return r.advanceIfChar(lr)?(s=V.AfterOpeningEndTag,p(_,F.EndTagOpen)):(s=V.AfterOpeningStartTag,p(_,F.StartTagOpen))}return r.advanceUntilChar(Yn),p(_,F.Content);case V.AfterOpeningEndTag:var C=m();return C.length>0?(s=V.WithinEndTag,p(_,F.EndTag)):r.skipWhitespace()?p(_,F.Whitespace,Ke("error.unexpectedWhitespace","Tag name must directly follow the open bracket.")):(s=V.WithinEndTag,r.advanceUntilChar(Ne),_<r.pos()?p(_,F.Unknown,Ke("error.endTagNameExpected","End tag name expected.")):x());case V.WithinEndTag:if(r.skipWhitespace())return p(_,F.Whitespace);if(r.advanceIfChar(Ne))return s=V.WithinContent,p(_,F.EndTagClose);if(i&&r.peekChar()===Yn)return s=V.WithinContent,p(_,F.EndTagClose,Ke("error.closingBracketMissing","Closing bracket missing."));y=Ke("error.closingBracketExpected","Closing bracket expected.");break;case V.AfterOpeningStartTag:return c=m(),f=void 0,h=void 0,c.length>0?(u=!1,s=V.WithinTag,p(_,F.StartTag)):r.skipWhitespace()?p(_,F.Whitespace,Ke("error.unexpectedWhitespace","Tag name must directly follow the open bracket.")):(s=V.WithinTag,r.advanceUntilChar(Ne),_<r.pos()?p(_,F.Unknown,Ke("error.startTagNameExpected","Start tag name expected.")):x());case V.WithinTag:return r.skipWhitespace()?(u=!0,p(_,F.Whitespace)):u&&(h=b(),h.length>0)?(s=V.AfterAttributeName,u=!1,p(_,F.AttributeName)):r.advanceIfChars([lr,Ne])?(s=V.WithinContent,p(_,F.StartTagSelfClose)):r.advanceIfChar(Ne)?(c==="script"?f&&Cu[f]?s=V.WithinContent:s=V.WithinScriptContent:c==="style"?s=V.WithinStyleContent:s=V.WithinContent,p(_,F.StartTagClose)):i&&r.peekChar()===Yn?(s=V.WithinContent,p(_,F.StartTagClose,Ke("error.closingBracketMissing","Closing bracket missing."))):(r.advance(1),p(_,F.Unknown,Ke("error.unexpectedCharacterInTag","Unexpected character in tag.")));case V.AfterAttributeName:return r.skipWhitespace()?(u=!0,p(_,F.Whitespace)):r.advanceIfChar(wu)?(s=V.BeforeAttributeValue,p(_,F.DelimiterAssign)):(s=V.WithinTag,x());case V.BeforeAttributeValue:if(r.skipWhitespace())return p(_,F.Whitespace);var E=r.advanceIfRegExp(/^[^\s"'`=<>]+/);if(E.length>0)return r.peekChar()===Ne&&r.peekChar(-1)===lr&&(r.goBack(1),E=E.substr(0,E.length-1)),h==="type"&&(f=E),s=V.WithinTag,u=!1,p(_,F.AttributeValue);var B=r.peekChar();return B===xu||B===yu?(r.advance(1),r.advanceUntilChar(B)&&r.advance(1),h==="type"&&(f=r.getSource().substring(_+1,r.pos()-1)),s=V.WithinTag,u=!1,p(_,F.AttributeValue)):(s=V.WithinTag,u=!1,x());case V.WithinScriptContent:for(var v=1;!r.eos();){var g=r.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);if(g.length===0)return r.goToEnd(),p(_,F.Script);if(g==="<!--")v===1&&(v=2);else if(g==="-->")v=1;else if(g[1]!=="/")v===2&&(v=3);else if(v===3)v=2;else{r.goBack(g.length);break}}return s=V.WithinContent,_<r.pos()?p(_,F.Script):x();case V.WithinStyleContent:return r.advanceUntilRegExp(/<\/style/i),s=V.WithinContent,_<r.pos()?p(_,F.Styles):x()}return r.advance(1),s=V.WithinContent,p(_,F.Unknown,y)}return{scan:w,getTokenType:function(){return l},getTokenOffset:function(){return a},getTokenLength:function(){return r.pos()-a},getTokenEnd:function(){return r.pos()},getTokenText:function(){return r.getSource().substring(a,r.pos())},getScannerState:function(){return s},getTokenError:function(){return o}}}function Mo(e,t){var n=0,i=e.length;if(i===0)return 0;for(;n<i;){var r=Math.floor((n+i)/2);t(e[r])?i=r:n=r+1}return n}function Eu(e,t,n){for(var i=0,r=e.length-1;i<=r;){var s=(i+r)/2|0,a=n(e[s],t);if(a<0)i=s+1;else if(a>0)r=s-1;else return s}return-(i+1)}var Mu=["area","base","br","col","embed","hr","img","input","keygen","link","menuitem","meta","param","source","track","wbr"];function oi(e){return!!e&&Eu(Mu,e.toLowerCase(),function(t,n){return t.localeCompare(n)})>=0}var Ro=function(){function e(t,n,i,r){this.start=t,this.end=n,this.children=i,this.parent=r,this.closed=!1}return Object.defineProperty(e.prototype,"attributeNames",{get:function(){return this.attributes?Object.keys(this.attributes):[]},enumerable:!1,configurable:!0}),e.prototype.isSameTag=function(t){return this.tag===void 0?t===void 0:t!==void 0&&this.tag.length===t.length&&this.tag.toLowerCase()===t},Object.defineProperty(e.prototype,"firstChild",{get:function(){return this.children[0]},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"lastChild",{get:function(){return this.children.length?this.children[this.children.length-1]:void 0},enumerable:!1,configurable:!0}),e.prototype.findNodeBefore=function(t){var n=Mo(this.children,function(s){return t<=s.start})-1;if(n>=0){var i=this.children[n];if(t>i.start){if(t<i.end)return i.findNodeBefore(t);var r=i.lastChild;return r&&r.end===i.end?i.findNodeBefore(t):i}}return this},e.prototype.findNodeAt=function(t){var n=Mo(this.children,function(r){return t<=r.start})-1;if(n>=0){var i=this.children[n];if(t>i.start&&t<=i.end)return i.findNodeAt(t)}return this},e}();function Vo(e){for(var t=we(e,void 0,void 0,!0),n=new Ro(0,e.length,[],void 0),i=n,r=-1,s=void 0,a=null,l=t.scan();l!==F.EOS;){switch(l){case F.StartTagOpen:var o=new Ro(t.getTokenOffset(),e.length,[],i);i.children.push(o),i=o;break;case F.StartTag:i.tag=t.getTokenText();break;case F.StartTagClose:i.parent&&(i.end=t.getTokenEnd(),t.getTokenLength()?(i.startTagEnd=t.getTokenEnd(),i.tag&&oi(i.tag)&&(i.closed=!0,i=i.parent)):i=i.parent);break;case F.StartTagSelfClose:i.parent&&(i.closed=!0,i.end=t.getTokenEnd(),i.startTagEnd=t.getTokenEnd(),i=i.parent);break;case F.EndTagOpen:r=t.getTokenOffset(),s=void 0;break;case F.EndTag:s=t.getTokenText().toLowerCase();break;case F.EndTagClose:for(var u=i;!u.isSameTag(s)&&u.parent;)u=u.parent;if(u.parent){for(;i!==u;)i.end=r,i.closed=!1,i=i.parent;i.closed=!0,i.endTagStart=r,i.end=t.getTokenEnd(),i=i.parent}break;case F.AttributeName:{a=t.getTokenText();var c=i.attributes;c||(i.attributes=c={}),c[a]=null;break}case F.AttributeValue:{var h=t.getTokenText(),c=i.attributes;c&&a&&(c[a]=h,a=null);break}}l=t.scan()}for(;i.parent;)i.end=e.length,i.closed=!1,i=i.parent;return{roots:n.children,findNodeBefore:n.findNodeBefore.bind(n),findNodeAt:n.findNodeAt.bind(n)}}var en={"Aacute;":"\xC1",Aacute:"\xC1","aacute;":"\xE1",aacute:"\xE1","Abreve;":"\u0102","abreve;":"\u0103","ac;":"\u223E","acd;":"\u223F","acE;":"\u223E\u0333","Acirc;":"\xC2",Acirc:"\xC2","acirc;":"\xE2",acirc:"\xE2","acute;":"\xB4",acute:"\xB4","Acy;":"\u0410","acy;":"\u0430","AElig;":"\xC6",AElig:"\xC6","aelig;":"\xE6",aelig:"\xE6","af;":"\u2061","Afr;":"\u{1D504}","afr;":"\u{1D51E}","Agrave;":"\xC0",Agrave:"\xC0","agrave;":"\xE0",agrave:"\xE0","alefsym;":"\u2135","aleph;":"\u2135","Alpha;":"\u0391","alpha;":"\u03B1","Amacr;":"\u0100","amacr;":"\u0101","amalg;":"\u2A3F","AMP;":"&",AMP:"&","amp;":"&",amp:"&","And;":"\u2A53","and;":"\u2227","andand;":"\u2A55","andd;":"\u2A5C","andslope;":"\u2A58","andv;":"\u2A5A","ang;":"\u2220","ange;":"\u29A4","angle;":"\u2220","angmsd;":"\u2221","angmsdaa;":"\u29A8","angmsdab;":"\u29A9","angmsdac;":"\u29AA","angmsdad;":"\u29AB","angmsdae;":"\u29AC","angmsdaf;":"\u29AD","angmsdag;":"\u29AE","angmsdah;":"\u29AF","angrt;":"\u221F","angrtvb;":"\u22BE","angrtvbd;":"\u299D","angsph;":"\u2222","angst;":"\xC5","angzarr;":"\u237C","Aogon;":"\u0104","aogon;":"\u0105","Aopf;":"\u{1D538}","aopf;":"\u{1D552}","ap;":"\u2248","apacir;":"\u2A6F","apE;":"\u2A70","ape;":"\u224A","apid;":"\u224B","apos;":"'","ApplyFunction;":"\u2061","approx;":"\u2248","approxeq;":"\u224A","Aring;":"\xC5",Aring:"\xC5","aring;":"\xE5",aring:"\xE5","Ascr;":"\u{1D49C}","ascr;":"\u{1D4B6}","Assign;":"\u2254","ast;":"*","asymp;":"\u2248","asympeq;":"\u224D","Atilde;":"\xC3",Atilde:"\xC3","atilde;":"\xE3",atilde:"\xE3","Auml;":"\xC4",Auml:"\xC4","auml;":"\xE4",auml:"\xE4","awconint;":"\u2233","awint;":"\u2A11","backcong;":"\u224C","backepsilon;":"\u03F6","backprime;":"\u2035","backsim;":"\u223D","backsimeq;":"\u22CD","Backslash;":"\u2216","Barv;":"\u2AE7","barvee;":"\u22BD","Barwed;":"\u2306","barwed;":"\u2305","barwedge;":"\u2305","bbrk;":"\u23B5","bbrktbrk;":"\u23B6","bcong;":"\u224C","Bcy;":"\u0411","bcy;":"\u0431","bdquo;":"\u201E","becaus;":"\u2235","Because;":"\u2235","because;":"\u2235","bemptyv;":"\u29B0","bepsi;":"\u03F6","bernou;":"\u212C","Bernoullis;":"\u212C","Beta;":"\u0392","beta;":"\u03B2","beth;":"\u2136","between;":"\u226C","Bfr;":"\u{1D505}","bfr;":"\u{1D51F}","bigcap;":"\u22C2","bigcirc;":"\u25EF","bigcup;":"\u22C3","bigodot;":"\u2A00","bigoplus;":"\u2A01","bigotimes;":"\u2A02","bigsqcup;":"\u2A06","bigstar;":"\u2605","bigtriangledown;":"\u25BD","bigtriangleup;":"\u25B3","biguplus;":"\u2A04","bigvee;":"\u22C1","bigwedge;":"\u22C0","bkarow;":"\u290D","blacklozenge;":"\u29EB","blacksquare;":"\u25AA","blacktriangle;":"\u25B4","blacktriangledown;":"\u25BE","blacktriangleleft;":"\u25C2","blacktriangleright;":"\u25B8","blank;":"\u2423","blk12;":"\u2592","blk14;":"\u2591","blk34;":"\u2593","block;":"\u2588","bne;":"=\u20E5","bnequiv;":"\u2261\u20E5","bNot;":"\u2AED","bnot;":"\u2310","Bopf;":"\u{1D539}","bopf;":"\u{1D553}","bot;":"\u22A5","bottom;":"\u22A5","bowtie;":"\u22C8","boxbox;":"\u29C9","boxDL;":"\u2557","boxDl;":"\u2556","boxdL;":"\u2555","boxdl;":"\u2510","boxDR;":"\u2554","boxDr;":"\u2553","boxdR;":"\u2552","boxdr;":"\u250C","boxH;":"\u2550","boxh;":"\u2500","boxHD;":"\u2566","boxHd;":"\u2564","boxhD;":"\u2565","boxhd;":"\u252C","boxHU;":"\u2569","boxHu;":"\u2567","boxhU;":"\u2568","boxhu;":"\u2534","boxminus;":"\u229F","boxplus;":"\u229E","boxtimes;":"\u22A0","boxUL;":"\u255D","boxUl;":"\u255C","boxuL;":"\u255B","boxul;":"\u2518","boxUR;":"\u255A","boxUr;":"\u2559","boxuR;":"\u2558","boxur;":"\u2514","boxV;":"\u2551","boxv;":"\u2502","boxVH;":"\u256C","boxVh;":"\u256B","boxvH;":"\u256A","boxvh;":"\u253C","boxVL;":"\u2563","boxVl;":"\u2562","boxvL;":"\u2561","boxvl;":"\u2524","boxVR;":"\u2560","boxVr;":"\u255F","boxvR;":"\u255E","boxvr;":"\u251C","bprime;":"\u2035","Breve;":"\u02D8","breve;":"\u02D8","brvbar;":"\xA6",brvbar:"\xA6","Bscr;":"\u212C","bscr;":"\u{1D4B7}","bsemi;":"\u204F","bsim;":"\u223D","bsime;":"\u22CD","bsol;":"\\","bsolb;":"\u29C5","bsolhsub;":"\u27C8","bull;":"\u2022","bullet;":"\u2022","bump;":"\u224E","bumpE;":"\u2AAE","bumpe;":"\u224F","Bumpeq;":"\u224E","bumpeq;":"\u224F","Cacute;":"\u0106","cacute;":"\u0107","Cap;":"\u22D2","cap;":"\u2229","capand;":"\u2A44","capbrcup;":"\u2A49","capcap;":"\u2A4B","capcup;":"\u2A47","capdot;":"\u2A40","CapitalDifferentialD;":"\u2145","caps;":"\u2229\uFE00","caret;":"\u2041","caron;":"\u02C7","Cayleys;":"\u212D","ccaps;":"\u2A4D","Ccaron;":"\u010C","ccaron;":"\u010D","Ccedil;":"\xC7",Ccedil:"\xC7","ccedil;":"\xE7",ccedil:"\xE7","Ccirc;":"\u0108","ccirc;":"\u0109","Cconint;":"\u2230","ccups;":"\u2A4C","ccupssm;":"\u2A50","Cdot;":"\u010A","cdot;":"\u010B","cedil;":"\xB8",cedil:"\xB8","Cedilla;":"\xB8","cemptyv;":"\u29B2","cent;":"\xA2",cent:"\xA2","CenterDot;":"\xB7","centerdot;":"\xB7","Cfr;":"\u212D","cfr;":"\u{1D520}","CHcy;":"\u0427","chcy;":"\u0447","check;":"\u2713","checkmark;":"\u2713","Chi;":"\u03A7","chi;":"\u03C7","cir;":"\u25CB","circ;":"\u02C6","circeq;":"\u2257","circlearrowleft;":"\u21BA","circlearrowright;":"\u21BB","circledast;":"\u229B","circledcirc;":"\u229A","circleddash;":"\u229D","CircleDot;":"\u2299","circledR;":"\xAE","circledS;":"\u24C8","CircleMinus;":"\u2296","CirclePlus;":"\u2295","CircleTimes;":"\u2297","cirE;":"\u29C3","cire;":"\u2257","cirfnint;":"\u2A10","cirmid;":"\u2AEF","cirscir;":"\u29C2","ClockwiseContourIntegral;":"\u2232","CloseCurlyDoubleQuote;":"\u201D","CloseCurlyQuote;":"\u2019","clubs;":"\u2663","clubsuit;":"\u2663","Colon;":"\u2237","colon;":":","Colone;":"\u2A74","colone;":"\u2254","coloneq;":"\u2254","comma;":",","commat;":"@","comp;":"\u2201","compfn;":"\u2218","complement;":"\u2201","complexes;":"\u2102","cong;":"\u2245","congdot;":"\u2A6D","Congruent;":"\u2261","Conint;":"\u222F","conint;":"\u222E","ContourIntegral;":"\u222E","Copf;":"\u2102","copf;":"\u{1D554}","coprod;":"\u2210","Coproduct;":"\u2210","COPY;":"\xA9",COPY:"\xA9","copy;":"\xA9",copy:"\xA9","copysr;":"\u2117","CounterClockwiseContourIntegral;":"\u2233","crarr;":"\u21B5","Cross;":"\u2A2F","cross;":"\u2717","Cscr;":"\u{1D49E}","cscr;":"\u{1D4B8}","csub;":"\u2ACF","csube;":"\u2AD1","csup;":"\u2AD0","csupe;":"\u2AD2","ctdot;":"\u22EF","cudarrl;":"\u2938","cudarrr;":"\u2935","cuepr;":"\u22DE","cuesc;":"\u22DF","cularr;":"\u21B6","cularrp;":"\u293D","Cup;":"\u22D3","cup;":"\u222A","cupbrcap;":"\u2A48","CupCap;":"\u224D","cupcap;":"\u2A46","cupcup;":"\u2A4A","cupdot;":"\u228D","cupor;":"\u2A45","cups;":"\u222A\uFE00","curarr;":"\u21B7","curarrm;":"\u293C","curlyeqprec;":"\u22DE","curlyeqsucc;":"\u22DF","curlyvee;":"\u22CE","curlywedge;":"\u22CF","curren;":"\xA4",curren:"\xA4","curvearrowleft;":"\u21B6","curvearrowright;":"\u21B7","cuvee;":"\u22CE","cuwed;":"\u22CF","cwconint;":"\u2232","cwint;":"\u2231","cylcty;":"\u232D","Dagger;":"\u2021","dagger;":"\u2020","daleth;":"\u2138","Darr;":"\u21A1","dArr;":"\u21D3","darr;":"\u2193","dash;":"\u2010","Dashv;":"\u2AE4","dashv;":"\u22A3","dbkarow;":"\u290F","dblac;":"\u02DD","Dcaron;":"\u010E","dcaron;":"\u010F","Dcy;":"\u0414","dcy;":"\u0434","DD;":"\u2145","dd;":"\u2146","ddagger;":"\u2021","ddarr;":"\u21CA","DDotrahd;":"\u2911","ddotseq;":"\u2A77","deg;":"\xB0",deg:"\xB0","Del;":"\u2207","Delta;":"\u0394","delta;":"\u03B4","demptyv;":"\u29B1","dfisht;":"\u297F","Dfr;":"\u{1D507}","dfr;":"\u{1D521}","dHar;":"\u2965","dharl;":"\u21C3","dharr;":"\u21C2","DiacriticalAcute;":"\xB4","DiacriticalDot;":"\u02D9","DiacriticalDoubleAcute;":"\u02DD","DiacriticalGrave;":"`","DiacriticalTilde;":"\u02DC","diam;":"\u22C4","Diamond;":"\u22C4","diamond;":"\u22C4","diamondsuit;":"\u2666","diams;":"\u2666","die;":"\xA8","DifferentialD;":"\u2146","digamma;":"\u03DD","disin;":"\u22F2","div;":"\xF7","divide;":"\xF7",divide:"\xF7","divideontimes;":"\u22C7","divonx;":"\u22C7","DJcy;":"\u0402","djcy;":"\u0452","dlcorn;":"\u231E","dlcrop;":"\u230D","dollar;":"$","Dopf;":"\u{1D53B}","dopf;":"\u{1D555}","Dot;":"\xA8","dot;":"\u02D9","DotDot;":"\u20DC","doteq;":"\u2250","doteqdot;":"\u2251","DotEqual;":"\u2250","dotminus;":"\u2238","dotplus;":"\u2214","dotsquare;":"\u22A1","doublebarwedge;":"\u2306","DoubleContourIntegral;":"\u222F","DoubleDot;":"\xA8","DoubleDownArrow;":"\u21D3","DoubleLeftArrow;":"\u21D0","DoubleLeftRightArrow;":"\u21D4","DoubleLeftTee;":"\u2AE4","DoubleLongLeftArrow;":"\u27F8","DoubleLongLeftRightArrow;":"\u27FA","DoubleLongRightArrow;":"\u27F9","DoubleRightArrow;":"\u21D2","DoubleRightTee;":"\u22A8","DoubleUpArrow;":"\u21D1","DoubleUpDownArrow;":"\u21D5","DoubleVerticalBar;":"\u2225","DownArrow;":"\u2193","Downarrow;":"\u21D3","downarrow;":"\u2193","DownArrowBar;":"\u2913","DownArrowUpArrow;":"\u21F5","DownBreve;":"\u0311","downdownarrows;":"\u21CA","downharpoonleft;":"\u21C3","downharpoonright;":"\u21C2","DownLeftRightVector;":"\u2950","DownLeftTeeVector;":"\u295E","DownLeftVector;":"\u21BD","DownLeftVectorBar;":"\u2956","DownRightTeeVector;":"\u295F","DownRightVector;":"\u21C1","DownRightVectorBar;":"\u2957","DownTee;":"\u22A4","DownTeeArrow;":"\u21A7","drbkarow;":"\u2910","drcorn;":"\u231F","drcrop;":"\u230C","Dscr;":"\u{1D49F}","dscr;":"\u{1D4B9}","DScy;":"\u0405","dscy;":"\u0455","dsol;":"\u29F6","Dstrok;":"\u0110","dstrok;":"\u0111","dtdot;":"\u22F1","dtri;":"\u25BF","dtrif;":"\u25BE","duarr;":"\u21F5","duhar;":"\u296F","dwangle;":"\u29A6","DZcy;":"\u040F","dzcy;":"\u045F","dzigrarr;":"\u27FF","Eacute;":"\xC9",Eacute:"\xC9","eacute;":"\xE9",eacute:"\xE9","easter;":"\u2A6E","Ecaron;":"\u011A","ecaron;":"\u011B","ecir;":"\u2256","Ecirc;":"\xCA",Ecirc:"\xCA","ecirc;":"\xEA",ecirc:"\xEA","ecolon;":"\u2255","Ecy;":"\u042D","ecy;":"\u044D","eDDot;":"\u2A77","Edot;":"\u0116","eDot;":"\u2251","edot;":"\u0117","ee;":"\u2147","efDot;":"\u2252","Efr;":"\u{1D508}","efr;":"\u{1D522}","eg;":"\u2A9A","Egrave;":"\xC8",Egrave:"\xC8","egrave;":"\xE8",egrave:"\xE8","egs;":"\u2A96","egsdot;":"\u2A98","el;":"\u2A99","Element;":"\u2208","elinters;":"\u23E7","ell;":"\u2113","els;":"\u2A95","elsdot;":"\u2A97","Emacr;":"\u0112","emacr;":"\u0113","empty;":"\u2205","emptyset;":"\u2205","EmptySmallSquare;":"\u25FB","emptyv;":"\u2205","EmptyVerySmallSquare;":"\u25AB","emsp;":"\u2003","emsp13;":"\u2004","emsp14;":"\u2005","ENG;":"\u014A","eng;":"\u014B","ensp;":"\u2002","Eogon;":"\u0118","eogon;":"\u0119","Eopf;":"\u{1D53C}","eopf;":"\u{1D556}","epar;":"\u22D5","eparsl;":"\u29E3","eplus;":"\u2A71","epsi;":"\u03B5","Epsilon;":"\u0395","epsilon;":"\u03B5","epsiv;":"\u03F5","eqcirc;":"\u2256","eqcolon;":"\u2255","eqsim;":"\u2242","eqslantgtr;":"\u2A96","eqslantless;":"\u2A95","Equal;":"\u2A75","equals;":"=","EqualTilde;":"\u2242","equest;":"\u225F","Equilibrium;":"\u21CC","equiv;":"\u2261","equivDD;":"\u2A78","eqvparsl;":"\u29E5","erarr;":"\u2971","erDot;":"\u2253","Escr;":"\u2130","escr;":"\u212F","esdot;":"\u2250","Esim;":"\u2A73","esim;":"\u2242","Eta;":"\u0397","eta;":"\u03B7","ETH;":"\xD0",ETH:"\xD0","eth;":"\xF0",eth:"\xF0","Euml;":"\xCB",Euml:"\xCB","euml;":"\xEB",euml:"\xEB","euro;":"\u20AC","excl;":"!","exist;":"\u2203","Exists;":"\u2203","expectation;":"\u2130","ExponentialE;":"\u2147","exponentiale;":"\u2147","fallingdotseq;":"\u2252","Fcy;":"\u0424","fcy;":"\u0444","female;":"\u2640","ffilig;":"\uFB03","fflig;":"\uFB00","ffllig;":"\uFB04","Ffr;":"\u{1D509}","ffr;":"\u{1D523}","filig;":"\uFB01","FilledSmallSquare;":"\u25FC","FilledVerySmallSquare;":"\u25AA","fjlig;":"fj","flat;":"\u266D","fllig;":"\uFB02","fltns;":"\u25B1","fnof;":"\u0192","Fopf;":"\u{1D53D}","fopf;":"\u{1D557}","ForAll;":"\u2200","forall;":"\u2200","fork;":"\u22D4","forkv;":"\u2AD9","Fouriertrf;":"\u2131","fpartint;":"\u2A0D","frac12;":"\xBD",frac12:"\xBD","frac13;":"\u2153","frac14;":"\xBC",frac14:"\xBC","frac15;":"\u2155","frac16;":"\u2159","frac18;":"\u215B","frac23;":"\u2154","frac25;":"\u2156","frac34;":"\xBE",frac34:"\xBE","frac35;":"\u2157","frac38;":"\u215C","frac45;":"\u2158","frac56;":"\u215A","frac58;":"\u215D","frac78;":"\u215E","frasl;":"\u2044","frown;":"\u2322","Fscr;":"\u2131","fscr;":"\u{1D4BB}","gacute;":"\u01F5","Gamma;":"\u0393","gamma;":"\u03B3","Gammad;":"\u03DC","gammad;":"\u03DD","gap;":"\u2A86","Gbreve;":"\u011E","gbreve;":"\u011F","Gcedil;":"\u0122","Gcirc;":"\u011C","gcirc;":"\u011D","Gcy;":"\u0413","gcy;":"\u0433","Gdot;":"\u0120","gdot;":"\u0121","gE;":"\u2267","ge;":"\u2265","gEl;":"\u2A8C","gel;":"\u22DB","geq;":"\u2265","geqq;":"\u2267","geqslant;":"\u2A7E","ges;":"\u2A7E","gescc;":"\u2AA9","gesdot;":"\u2A80","gesdoto;":"\u2A82","gesdotol;":"\u2A84","gesl;":"\u22DB\uFE00","gesles;":"\u2A94","Gfr;":"\u{1D50A}","gfr;":"\u{1D524}","Gg;":"\u22D9","gg;":"\u226B","ggg;":"\u22D9","gimel;":"\u2137","GJcy;":"\u0403","gjcy;":"\u0453","gl;":"\u2277","gla;":"\u2AA5","glE;":"\u2A92","glj;":"\u2AA4","gnap;":"\u2A8A","gnapprox;":"\u2A8A","gnE;":"\u2269","gne;":"\u2A88","gneq;":"\u2A88","gneqq;":"\u2269","gnsim;":"\u22E7","Gopf;":"\u{1D53E}","gopf;":"\u{1D558}","grave;":"`","GreaterEqual;":"\u2265","GreaterEqualLess;":"\u22DB","GreaterFullEqual;":"\u2267","GreaterGreater;":"\u2AA2","GreaterLess;":"\u2277","GreaterSlantEqual;":"\u2A7E","GreaterTilde;":"\u2273","Gscr;":"\u{1D4A2}","gscr;":"\u210A","gsim;":"\u2273","gsime;":"\u2A8E","gsiml;":"\u2A90","GT;":">",GT:">","Gt;":"\u226B","gt;":">",gt:">","gtcc;":"\u2AA7","gtcir;":"\u2A7A","gtdot;":"\u22D7","gtlPar;":"\u2995","gtquest;":"\u2A7C","gtrapprox;":"\u2A86","gtrarr;":"\u2978","gtrdot;":"\u22D7","gtreqless;":"\u22DB","gtreqqless;":"\u2A8C","gtrless;":"\u2277","gtrsim;":"\u2273","gvertneqq;":"\u2269\uFE00","gvnE;":"\u2269\uFE00","Hacek;":"\u02C7","hairsp;":"\u200A","half;":"\xBD","hamilt;":"\u210B","HARDcy;":"\u042A","hardcy;":"\u044A","hArr;":"\u21D4","harr;":"\u2194","harrcir;":"\u2948","harrw;":"\u21AD","Hat;":"^","hbar;":"\u210F","Hcirc;":"\u0124","hcirc;":"\u0125","hearts;":"\u2665","heartsuit;":"\u2665","hellip;":"\u2026","hercon;":"\u22B9","Hfr;":"\u210C","hfr;":"\u{1D525}","HilbertSpace;":"\u210B","hksearow;":"\u2925","hkswarow;":"\u2926","hoarr;":"\u21FF","homtht;":"\u223B","hookleftarrow;":"\u21A9","hookrightarrow;":"\u21AA","Hopf;":"\u210D","hopf;":"\u{1D559}","horbar;":"\u2015","HorizontalLine;":"\u2500","Hscr;":"\u210B","hscr;":"\u{1D4BD}","hslash;":"\u210F","Hstrok;":"\u0126","hstrok;":"\u0127","HumpDownHump;":"\u224E","HumpEqual;":"\u224F","hybull;":"\u2043","hyphen;":"\u2010","Iacute;":"\xCD",Iacute:"\xCD","iacute;":"\xED",iacute:"\xED","ic;":"\u2063","Icirc;":"\xCE",Icirc:"\xCE","icirc;":"\xEE",icirc:"\xEE","Icy;":"\u0418","icy;":"\u0438","Idot;":"\u0130","IEcy;":"\u0415","iecy;":"\u0435","iexcl;":"\xA1",iexcl:"\xA1","iff;":"\u21D4","Ifr;":"\u2111","ifr;":"\u{1D526}","Igrave;":"\xCC",Igrave:"\xCC","igrave;":"\xEC",igrave:"\xEC","ii;":"\u2148","iiiint;":"\u2A0C","iiint;":"\u222D","iinfin;":"\u29DC","iiota;":"\u2129","IJlig;":"\u0132","ijlig;":"\u0133","Im;":"\u2111","Imacr;":"\u012A","imacr;":"\u012B","image;":"\u2111","ImaginaryI;":"\u2148","imagline;":"\u2110","imagpart;":"\u2111","imath;":"\u0131","imof;":"\u22B7","imped;":"\u01B5","Implies;":"\u21D2","in;":"\u2208","incare;":"\u2105","infin;":"\u221E","infintie;":"\u29DD","inodot;":"\u0131","Int;":"\u222C","int;":"\u222B","intcal;":"\u22BA","integers;":"\u2124","Integral;":"\u222B","intercal;":"\u22BA","Intersection;":"\u22C2","intlarhk;":"\u2A17","intprod;":"\u2A3C","InvisibleComma;":"\u2063","InvisibleTimes;":"\u2062","IOcy;":"\u0401","iocy;":"\u0451","Iogon;":"\u012E","iogon;":"\u012F","Iopf;":"\u{1D540}","iopf;":"\u{1D55A}","Iota;":"\u0399","iota;":"\u03B9","iprod;":"\u2A3C","iquest;":"\xBF",iquest:"\xBF","Iscr;":"\u2110","iscr;":"\u{1D4BE}","isin;":"\u2208","isindot;":"\u22F5","isinE;":"\u22F9","isins;":"\u22F4","isinsv;":"\u22F3","isinv;":"\u2208","it;":"\u2062","Itilde;":"\u0128","itilde;":"\u0129","Iukcy;":"\u0406","iukcy;":"\u0456","Iuml;":"\xCF",Iuml:"\xCF","iuml;":"\xEF",iuml:"\xEF","Jcirc;":"\u0134","jcirc;":"\u0135","Jcy;":"\u0419","jcy;":"\u0439","Jfr;":"\u{1D50D}","jfr;":"\u{1D527}","jmath;":"\u0237","Jopf;":"\u{1D541}","jopf;":"\u{1D55B}","Jscr;":"\u{1D4A5}","jscr;":"\u{1D4BF}","Jsercy;":"\u0408","jsercy;":"\u0458","Jukcy;":"\u0404","jukcy;":"\u0454","Kappa;":"\u039A","kappa;":"\u03BA","kappav;":"\u03F0","Kcedil;":"\u0136","kcedil;":"\u0137","Kcy;":"\u041A","kcy;":"\u043A","Kfr;":"\u{1D50E}","kfr;":"\u{1D528}","kgreen;":"\u0138","KHcy;":"\u0425","khcy;":"\u0445","KJcy;":"\u040C","kjcy;":"\u045C","Kopf;":"\u{1D542}","kopf;":"\u{1D55C}","Kscr;":"\u{1D4A6}","kscr;":"\u{1D4C0}","lAarr;":"\u21DA","Lacute;":"\u0139","lacute;":"\u013A","laemptyv;":"\u29B4","lagran;":"\u2112","Lambda;":"\u039B","lambda;":"\u03BB","Lang;":"\u27EA","lang;":"\u27E8","langd;":"\u2991","langle;":"\u27E8","lap;":"\u2A85","Laplacetrf;":"\u2112","laquo;":"\xAB",laquo:"\xAB","Larr;":"\u219E","lArr;":"\u21D0","larr;":"\u2190","larrb;":"\u21E4","larrbfs;":"\u291F","larrfs;":"\u291D","larrhk;":"\u21A9","larrlp;":"\u21AB","larrpl;":"\u2939","larrsim;":"\u2973","larrtl;":"\u21A2","lat;":"\u2AAB","lAtail;":"\u291B","latail;":"\u2919","late;":"\u2AAD","lates;":"\u2AAD\uFE00","lBarr;":"\u290E","lbarr;":"\u290C","lbbrk;":"\u2772","lbrace;":"{","lbrack;":"[","lbrke;":"\u298B","lbrksld;":"\u298F","lbrkslu;":"\u298D","Lcaron;":"\u013D","lcaron;":"\u013E","Lcedil;":"\u013B","lcedil;":"\u013C","lceil;":"\u2308","lcub;":"{","Lcy;":"\u041B","lcy;":"\u043B","ldca;":"\u2936","ldquo;":"\u201C","ldquor;":"\u201E","ldrdhar;":"\u2967","ldrushar;":"\u294B","ldsh;":"\u21B2","lE;":"\u2266","le;":"\u2264","LeftAngleBracket;":"\u27E8","LeftArrow;":"\u2190","Leftarrow;":"\u21D0","leftarrow;":"\u2190","LeftArrowBar;":"\u21E4","LeftArrowRightArrow;":"\u21C6","leftarrowtail;":"\u21A2","LeftCeiling;":"\u2308","LeftDoubleBracket;":"\u27E6","LeftDownTeeVector;":"\u2961","LeftDownVector;":"\u21C3","LeftDownVectorBar;":"\u2959","LeftFloor;":"\u230A","leftharpoondown;":"\u21BD","leftharpoonup;":"\u21BC","leftleftarrows;":"\u21C7","LeftRightArrow;":"\u2194","Leftrightarrow;":"\u21D4","leftrightarrow;":"\u2194","leftrightarrows;":"\u21C6","leftrightharpoons;":"\u21CB","leftrightsquigarrow;":"\u21AD","LeftRightVector;":"\u294E","LeftTee;":"\u22A3","LeftTeeArrow;":"\u21A4","LeftTeeVector;":"\u295A","leftthreetimes;":"\u22CB","LeftTriangle;":"\u22B2","LeftTriangleBar;":"\u29CF","LeftTriangleEqual;":"\u22B4","LeftUpDownVector;":"\u2951","LeftUpTeeVector;":"\u2960","LeftUpVector;":"\u21BF","LeftUpVectorBar;":"\u2958","LeftVector;":"\u21BC","LeftVectorBar;":"\u2952","lEg;":"\u2A8B","leg;":"\u22DA","leq;":"\u2264","leqq;":"\u2266","leqslant;":"\u2A7D","les;":"\u2A7D","lescc;":"\u2AA8","lesdot;":"\u2A7F","lesdoto;":"\u2A81","lesdotor;":"\u2A83","lesg;":"\u22DA\uFE00","lesges;":"\u2A93","lessapprox;":"\u2A85","lessdot;":"\u22D6","lesseqgtr;":"\u22DA","lesseqqgtr;":"\u2A8B","LessEqualGreater;":"\u22DA","LessFullEqual;":"\u2266","LessGreater;":"\u2276","lessgtr;":"\u2276","LessLess;":"\u2AA1","lesssim;":"\u2272","LessSlantEqual;":"\u2A7D","LessTilde;":"\u2272","lfisht;":"\u297C","lfloor;":"\u230A","Lfr;":"\u{1D50F}","lfr;":"\u{1D529}","lg;":"\u2276","lgE;":"\u2A91","lHar;":"\u2962","lhard;":"\u21BD","lharu;":"\u21BC","lharul;":"\u296A","lhblk;":"\u2584","LJcy;":"\u0409","ljcy;":"\u0459","Ll;":"\u22D8","ll;":"\u226A","llarr;":"\u21C7","llcorner;":"\u231E","Lleftarrow;":"\u21DA","llhard;":"\u296B","lltri;":"\u25FA","Lmidot;":"\u013F","lmidot;":"\u0140","lmoust;":"\u23B0","lmoustache;":"\u23B0","lnap;":"\u2A89","lnapprox;":"\u2A89","lnE;":"\u2268","lne;":"\u2A87","lneq;":"\u2A87","lneqq;":"\u2268","lnsim;":"\u22E6","loang;":"\u27EC","loarr;":"\u21FD","lobrk;":"\u27E6","LongLeftArrow;":"\u27F5","Longleftarrow;":"\u27F8","longleftarrow;":"\u27F5","LongLeftRightArrow;":"\u27F7","Longleftrightarrow;":"\u27FA","longleftrightarrow;":"\u27F7","longmapsto;":"\u27FC","LongRightArrow;":"\u27F6","Longrightarrow;":"\u27F9","longrightarrow;":"\u27F6","looparrowleft;":"\u21AB","looparrowright;":"\u21AC","lopar;":"\u2985","Lopf;":"\u{1D543}","lopf;":"\u{1D55D}","loplus;":"\u2A2D","lotimes;":"\u2A34","lowast;":"\u2217","lowbar;":"_","LowerLeftArrow;":"\u2199","LowerRightArrow;":"\u2198","loz;":"\u25CA","lozenge;":"\u25CA","lozf;":"\u29EB","lpar;":"(","lparlt;":"\u2993","lrarr;":"\u21C6","lrcorner;":"\u231F","lrhar;":"\u21CB","lrhard;":"\u296D","lrm;":"\u200E","lrtri;":"\u22BF","lsaquo;":"\u2039","Lscr;":"\u2112","lscr;":"\u{1D4C1}","Lsh;":"\u21B0","lsh;":"\u21B0","lsim;":"\u2272","lsime;":"\u2A8D","lsimg;":"\u2A8F","lsqb;":"[","lsquo;":"\u2018","lsquor;":"\u201A","Lstrok;":"\u0141","lstrok;":"\u0142","LT;":"<",LT:"<","Lt;":"\u226A","lt;":"<",lt:"<","ltcc;":"\u2AA6","ltcir;":"\u2A79","ltdot;":"\u22D6","lthree;":"\u22CB","ltimes;":"\u22C9","ltlarr;":"\u2976","ltquest;":"\u2A7B","ltri;":"\u25C3","ltrie;":"\u22B4","ltrif;":"\u25C2","ltrPar;":"\u2996","lurdshar;":"\u294A","luruhar;":"\u2966","lvertneqq;":"\u2268\uFE00","lvnE;":"\u2268\uFE00","macr;":"\xAF",macr:"\xAF","male;":"\u2642","malt;":"\u2720","maltese;":"\u2720","Map;":"\u2905","map;":"\u21A6","mapsto;":"\u21A6","mapstodown;":"\u21A7","mapstoleft;":"\u21A4","mapstoup;":"\u21A5","marker;":"\u25AE","mcomma;":"\u2A29","Mcy;":"\u041C","mcy;":"\u043C","mdash;":"\u2014","mDDot;":"\u223A","measuredangle;":"\u2221","MediumSpace;":"\u205F","Mellintrf;":"\u2133","Mfr;":"\u{1D510}","mfr;":"\u{1D52A}","mho;":"\u2127","micro;":"\xB5",micro:"\xB5","mid;":"\u2223","midast;":"*","midcir;":"\u2AF0","middot;":"\xB7",middot:"\xB7","minus;":"\u2212","minusb;":"\u229F","minusd;":"\u2238","minusdu;":"\u2A2A","MinusPlus;":"\u2213","mlcp;":"\u2ADB","mldr;":"\u2026","mnplus;":"\u2213","models;":"\u22A7","Mopf;":"\u{1D544}","mopf;":"\u{1D55E}","mp;":"\u2213","Mscr;":"\u2133","mscr;":"\u{1D4C2}","mstpos;":"\u223E","Mu;":"\u039C","mu;":"\u03BC","multimap;":"\u22B8","mumap;":"\u22B8","nabla;":"\u2207","Nacute;":"\u0143","nacute;":"\u0144","nang;":"\u2220\u20D2","nap;":"\u2249","napE;":"\u2A70\u0338","napid;":"\u224B\u0338","napos;":"\u0149","napprox;":"\u2249","natur;":"\u266E","natural;":"\u266E","naturals;":"\u2115","nbsp;":"\xA0",nbsp:"\xA0","nbump;":"\u224E\u0338","nbumpe;":"\u224F\u0338","ncap;":"\u2A43","Ncaron;":"\u0147","ncaron;":"\u0148","Ncedil;":"\u0145","ncedil;":"\u0146","ncong;":"\u2247","ncongdot;":"\u2A6D\u0338","ncup;":"\u2A42","Ncy;":"\u041D","ncy;":"\u043D","ndash;":"\u2013","ne;":"\u2260","nearhk;":"\u2924","neArr;":"\u21D7","nearr;":"\u2197","nearrow;":"\u2197","nedot;":"\u2250\u0338","NegativeMediumSpace;":"\u200B","NegativeThickSpace;":"\u200B","NegativeThinSpace;":"\u200B","NegativeVeryThinSpace;":"\u200B","nequiv;":"\u2262","nesear;":"\u2928","nesim;":"\u2242\u0338","NestedGreaterGreater;":"\u226B","NestedLessLess;":"\u226A","NewLine;":`
`,"nexist;":"\u2204","nexists;":"\u2204","Nfr;":"\u{1D511}","nfr;":"\u{1D52B}","ngE;":"\u2267\u0338","nge;":"\u2271","ngeq;":"\u2271","ngeqq;":"\u2267\u0338","ngeqslant;":"\u2A7E\u0338","nges;":"\u2A7E\u0338","nGg;":"\u22D9\u0338","ngsim;":"\u2275","nGt;":"\u226B\u20D2","ngt;":"\u226F","ngtr;":"\u226F","nGtv;":"\u226B\u0338","nhArr;":"\u21CE","nharr;":"\u21AE","nhpar;":"\u2AF2","ni;":"\u220B","nis;":"\u22FC","nisd;":"\u22FA","niv;":"\u220B","NJcy;":"\u040A","njcy;":"\u045A","nlArr;":"\u21CD","nlarr;":"\u219A","nldr;":"\u2025","nlE;":"\u2266\u0338","nle;":"\u2270","nLeftarrow;":"\u21CD","nleftarrow;":"\u219A","nLeftrightarrow;":"\u21CE","nleftrightarrow;":"\u21AE","nleq;":"\u2270","nleqq;":"\u2266\u0338","nleqslant;":"\u2A7D\u0338","nles;":"\u2A7D\u0338","nless;":"\u226E","nLl;":"\u22D8\u0338","nlsim;":"\u2274","nLt;":"\u226A\u20D2","nlt;":"\u226E","nltri;":"\u22EA","nltrie;":"\u22EC","nLtv;":"\u226A\u0338","nmid;":"\u2224","NoBreak;":"\u2060","NonBreakingSpace;":"\xA0","Nopf;":"\u2115","nopf;":"\u{1D55F}","Not;":"\u2AEC","not;":"\xAC",not:"\xAC","NotCongruent;":"\u2262","NotCupCap;":"\u226D","NotDoubleVerticalBar;":"\u2226","NotElement;":"\u2209","NotEqual;":"\u2260","NotEqualTilde;":"\u2242\u0338","NotExists;":"\u2204","NotGreater;":"\u226F","NotGreaterEqual;":"\u2271","NotGreaterFullEqual;":"\u2267\u0338","NotGreaterGreater;":"\u226B\u0338","NotGreaterLess;":"\u2279","NotGreaterSlantEqual;":"\u2A7E\u0338","NotGreaterTilde;":"\u2275","NotHumpDownHump;":"\u224E\u0338","NotHumpEqual;":"\u224F\u0338","notin;":"\u2209","notindot;":"\u22F5\u0338","notinE;":"\u22F9\u0338","notinva;":"\u2209","notinvb;":"\u22F7","notinvc;":"\u22F6","NotLeftTriangle;":"\u22EA","NotLeftTriangleBar;":"\u29CF\u0338","NotLeftTriangleEqual;":"\u22EC","NotLess;":"\u226E","NotLessEqual;":"\u2270","NotLessGreater;":"\u2278","NotLessLess;":"\u226A\u0338","NotLessSlantEqual;":"\u2A7D\u0338","NotLessTilde;":"\u2274","NotNestedGreaterGreater;":"\u2AA2\u0338","NotNestedLessLess;":"\u2AA1\u0338","notni;":"\u220C","notniva;":"\u220C","notnivb;":"\u22FE","notnivc;":"\u22FD","NotPrecedes;":"\u2280","NotPrecedesEqual;":"\u2AAF\u0338","NotPrecedesSlantEqual;":"\u22E0","NotReverseElement;":"\u220C","NotRightTriangle;":"\u22EB","NotRightTriangleBar;":"\u29D0\u0338","NotRightTriangleEqual;":"\u22ED","NotSquareSubset;":"\u228F\u0338","NotSquareSubsetEqual;":"\u22E2","NotSquareSuperset;":"\u2290\u0338","NotSquareSupersetEqual;":"\u22E3","NotSubset;":"\u2282\u20D2","NotSubsetEqual;":"\u2288","NotSucceeds;":"\u2281","NotSucceedsEqual;":"\u2AB0\u0338","NotSucceedsSlantEqual;":"\u22E1","NotSucceedsTilde;":"\u227F\u0338","NotSuperset;":"\u2283\u20D2","NotSupersetEqual;":"\u2289","NotTilde;":"\u2241","NotTildeEqual;":"\u2244","NotTildeFullEqual;":"\u2247","NotTildeTilde;":"\u2249","NotVerticalBar;":"\u2224","npar;":"\u2226","nparallel;":"\u2226","nparsl;":"\u2AFD\u20E5","npart;":"\u2202\u0338","npolint;":"\u2A14","npr;":"\u2280","nprcue;":"\u22E0","npre;":"\u2AAF\u0338","nprec;":"\u2280","npreceq;":"\u2AAF\u0338","nrArr;":"\u21CF","nrarr;":"\u219B","nrarrc;":"\u2933\u0338","nrarrw;":"\u219D\u0338","nRightarrow;":"\u21CF","nrightarrow;":"\u219B","nrtri;":"\u22EB","nrtrie;":"\u22ED","nsc;":"\u2281","nsccue;":"\u22E1","nsce;":"\u2AB0\u0338","Nscr;":"\u{1D4A9}","nscr;":"\u{1D4C3}","nshortmid;":"\u2224","nshortparallel;":"\u2226","nsim;":"\u2241","nsime;":"\u2244","nsimeq;":"\u2244","nsmid;":"\u2224","nspar;":"\u2226","nsqsube;":"\u22E2","nsqsupe;":"\u22E3","nsub;":"\u2284","nsubE;":"\u2AC5\u0338","nsube;":"\u2288","nsubset;":"\u2282\u20D2","nsubseteq;":"\u2288","nsubseteqq;":"\u2AC5\u0338","nsucc;":"\u2281","nsucceq;":"\u2AB0\u0338","nsup;":"\u2285","nsupE;":"\u2AC6\u0338","nsupe;":"\u2289","nsupset;":"\u2283\u20D2","nsupseteq;":"\u2289","nsupseteqq;":"\u2AC6\u0338","ntgl;":"\u2279","Ntilde;":"\xD1",Ntilde:"\xD1","ntilde;":"\xF1",ntilde:"\xF1","ntlg;":"\u2278","ntriangleleft;":"\u22EA","ntrianglelefteq;":"\u22EC","ntriangleright;":"\u22EB","ntrianglerighteq;":"\u22ED","Nu;":"\u039D","nu;":"\u03BD","num;":"#","numero;":"\u2116","numsp;":"\u2007","nvap;":"\u224D\u20D2","nVDash;":"\u22AF","nVdash;":"\u22AE","nvDash;":"\u22AD","nvdash;":"\u22AC","nvge;":"\u2265\u20D2","nvgt;":">\u20D2","nvHarr;":"\u2904","nvinfin;":"\u29DE","nvlArr;":"\u2902","nvle;":"\u2264\u20D2","nvlt;":"<\u20D2","nvltrie;":"\u22B4\u20D2","nvrArr;":"\u2903","nvrtrie;":"\u22B5\u20D2","nvsim;":"\u223C\u20D2","nwarhk;":"\u2923","nwArr;":"\u21D6","nwarr;":"\u2196","nwarrow;":"\u2196","nwnear;":"\u2927","Oacute;":"\xD3",Oacute:"\xD3","oacute;":"\xF3",oacute:"\xF3","oast;":"\u229B","ocir;":"\u229A","Ocirc;":"\xD4",Ocirc:"\xD4","ocirc;":"\xF4",ocirc:"\xF4","Ocy;":"\u041E","ocy;":"\u043E","odash;":"\u229D","Odblac;":"\u0150","odblac;":"\u0151","odiv;":"\u2A38","odot;":"\u2299","odsold;":"\u29BC","OElig;":"\u0152","oelig;":"\u0153","ofcir;":"\u29BF","Ofr;":"\u{1D512}","ofr;":"\u{1D52C}","ogon;":"\u02DB","Ograve;":"\xD2",Ograve:"\xD2","ograve;":"\xF2",ograve:"\xF2","ogt;":"\u29C1","ohbar;":"\u29B5","ohm;":"\u03A9","oint;":"\u222E","olarr;":"\u21BA","olcir;":"\u29BE","olcross;":"\u29BB","oline;":"\u203E","olt;":"\u29C0","Omacr;":"\u014C","omacr;":"\u014D","Omega;":"\u03A9","omega;":"\u03C9","Omicron;":"\u039F","omicron;":"\u03BF","omid;":"\u29B6","ominus;":"\u2296","Oopf;":"\u{1D546}","oopf;":"\u{1D560}","opar;":"\u29B7","OpenCurlyDoubleQuote;":"\u201C","OpenCurlyQuote;":"\u2018","operp;":"\u29B9","oplus;":"\u2295","Or;":"\u2A54","or;":"\u2228","orarr;":"\u21BB","ord;":"\u2A5D","order;":"\u2134","orderof;":"\u2134","ordf;":"\xAA",ordf:"\xAA","ordm;":"\xBA",ordm:"\xBA","origof;":"\u22B6","oror;":"\u2A56","orslope;":"\u2A57","orv;":"\u2A5B","oS;":"\u24C8","Oscr;":"\u{1D4AA}","oscr;":"\u2134","Oslash;":"\xD8",Oslash:"\xD8","oslash;":"\xF8",oslash:"\xF8","osol;":"\u2298","Otilde;":"\xD5",Otilde:"\xD5","otilde;":"\xF5",otilde:"\xF5","Otimes;":"\u2A37","otimes;":"\u2297","otimesas;":"\u2A36","Ouml;":"\xD6",Ouml:"\xD6","ouml;":"\xF6",ouml:"\xF6","ovbar;":"\u233D","OverBar;":"\u203E","OverBrace;":"\u23DE","OverBracket;":"\u23B4","OverParenthesis;":"\u23DC","par;":"\u2225","para;":"\xB6",para:"\xB6","parallel;":"\u2225","parsim;":"\u2AF3","parsl;":"\u2AFD","part;":"\u2202","PartialD;":"\u2202","Pcy;":"\u041F","pcy;":"\u043F","percnt;":"%","period;":".","permil;":"\u2030","perp;":"\u22A5","pertenk;":"\u2031","Pfr;":"\u{1D513}","pfr;":"\u{1D52D}","Phi;":"\u03A6","phi;":"\u03C6","phiv;":"\u03D5","phmmat;":"\u2133","phone;":"\u260E","Pi;":"\u03A0","pi;":"\u03C0","pitchfork;":"\u22D4","piv;":"\u03D6","planck;":"\u210F","planckh;":"\u210E","plankv;":"\u210F","plus;":"+","plusacir;":"\u2A23","plusb;":"\u229E","pluscir;":"\u2A22","plusdo;":"\u2214","plusdu;":"\u2A25","pluse;":"\u2A72","PlusMinus;":"\xB1","plusmn;":"\xB1",plusmn:"\xB1","plussim;":"\u2A26","plustwo;":"\u2A27","pm;":"\xB1","Poincareplane;":"\u210C","pointint;":"\u2A15","Popf;":"\u2119","popf;":"\u{1D561}","pound;":"\xA3",pound:"\xA3","Pr;":"\u2ABB","pr;":"\u227A","prap;":"\u2AB7","prcue;":"\u227C","prE;":"\u2AB3","pre;":"\u2AAF","prec;":"\u227A","precapprox;":"\u2AB7","preccurlyeq;":"\u227C","Precedes;":"\u227A","PrecedesEqual;":"\u2AAF","PrecedesSlantEqual;":"\u227C","PrecedesTilde;":"\u227E","preceq;":"\u2AAF","precnapprox;":"\u2AB9","precneqq;":"\u2AB5","precnsim;":"\u22E8","precsim;":"\u227E","Prime;":"\u2033","prime;":"\u2032","primes;":"\u2119","prnap;":"\u2AB9","prnE;":"\u2AB5","prnsim;":"\u22E8","prod;":"\u220F","Product;":"\u220F","profalar;":"\u232E","profline;":"\u2312","profsurf;":"\u2313","prop;":"\u221D","Proportion;":"\u2237","Proportional;":"\u221D","propto;":"\u221D","prsim;":"\u227E","prurel;":"\u22B0","Pscr;":"\u{1D4AB}","pscr;":"\u{1D4C5}","Psi;":"\u03A8","psi;":"\u03C8","puncsp;":"\u2008","Qfr;":"\u{1D514}","qfr;":"\u{1D52E}","qint;":"\u2A0C","Qopf;":"\u211A","qopf;":"\u{1D562}","qprime;":"\u2057","Qscr;":"\u{1D4AC}","qscr;":"\u{1D4C6}","quaternions;":"\u210D","quatint;":"\u2A16","quest;":"?","questeq;":"\u225F","QUOT;":'"',QUOT:'"',"quot;":'"',quot:'"',"rAarr;":"\u21DB","race;":"\u223D\u0331","Racute;":"\u0154","racute;":"\u0155","radic;":"\u221A","raemptyv;":"\u29B3","Rang;":"\u27EB","rang;":"\u27E9","rangd;":"\u2992","range;":"\u29A5","rangle;":"\u27E9","raquo;":"\xBB",raquo:"\xBB","Rarr;":"\u21A0","rArr;":"\u21D2","rarr;":"\u2192","rarrap;":"\u2975","rarrb;":"\u21E5","rarrbfs;":"\u2920","rarrc;":"\u2933","rarrfs;":"\u291E","rarrhk;":"\u21AA","rarrlp;":"\u21AC","rarrpl;":"\u2945","rarrsim;":"\u2974","Rarrtl;":"\u2916","rarrtl;":"\u21A3","rarrw;":"\u219D","rAtail;":"\u291C","ratail;":"\u291A","ratio;":"\u2236","rationals;":"\u211A","RBarr;":"\u2910","rBarr;":"\u290F","rbarr;":"\u290D","rbbrk;":"\u2773","rbrace;":"}","rbrack;":"]","rbrke;":"\u298C","rbrksld;":"\u298E","rbrkslu;":"\u2990","Rcaron;":"\u0158","rcaron;":"\u0159","Rcedil;":"\u0156","rcedil;":"\u0157","rceil;":"\u2309","rcub;":"}","Rcy;":"\u0420","rcy;":"\u0440","rdca;":"\u2937","rdldhar;":"\u2969","rdquo;":"\u201D","rdquor;":"\u201D","rdsh;":"\u21B3","Re;":"\u211C","real;":"\u211C","realine;":"\u211B","realpart;":"\u211C","reals;":"\u211D","rect;":"\u25AD","REG;":"\xAE",REG:"\xAE","reg;":"\xAE",reg:"\xAE","ReverseElement;":"\u220B","ReverseEquilibrium;":"\u21CB","ReverseUpEquilibrium;":"\u296F","rfisht;":"\u297D","rfloor;":"\u230B","Rfr;":"\u211C","rfr;":"\u{1D52F}","rHar;":"\u2964","rhard;":"\u21C1","rharu;":"\u21C0","rharul;":"\u296C","Rho;":"\u03A1","rho;":"\u03C1","rhov;":"\u03F1","RightAngleBracket;":"\u27E9","RightArrow;":"\u2192","Rightarrow;":"\u21D2","rightarrow;":"\u2192","RightArrowBar;":"\u21E5","RightArrowLeftArrow;":"\u21C4","rightarrowtail;":"\u21A3","RightCeiling;":"\u2309","RightDoubleBracket;":"\u27E7","RightDownTeeVector;":"\u295D","RightDownVector;":"\u21C2","RightDownVectorBar;":"\u2955","RightFloor;":"\u230B","rightharpoondown;":"\u21C1","rightharpoonup;":"\u21C0","rightleftarrows;":"\u21C4","rightleftharpoons;":"\u21CC","rightrightarrows;":"\u21C9","rightsquigarrow;":"\u219D","RightTee;":"\u22A2","RightTeeArrow;":"\u21A6","RightTeeVector;":"\u295B","rightthreetimes;":"\u22CC","RightTriangle;":"\u22B3","RightTriangleBar;":"\u29D0","RightTriangleEqual;":"\u22B5","RightUpDownVector;":"\u294F","RightUpTeeVector;":"\u295C","RightUpVector;":"\u21BE","RightUpVectorBar;":"\u2954","RightVector;":"\u21C0","RightVectorBar;":"\u2953","ring;":"\u02DA","risingdotseq;":"\u2253","rlarr;":"\u21C4","rlhar;":"\u21CC","rlm;":"\u200F","rmoust;":"\u23B1","rmoustache;":"\u23B1","rnmid;":"\u2AEE","roang;":"\u27ED","roarr;":"\u21FE","robrk;":"\u27E7","ropar;":"\u2986","Ropf;":"\u211D","ropf;":"\u{1D563}","roplus;":"\u2A2E","rotimes;":"\u2A35","RoundImplies;":"\u2970","rpar;":")","rpargt;":"\u2994","rppolint;":"\u2A12","rrarr;":"\u21C9","Rrightarrow;":"\u21DB","rsaquo;":"\u203A","Rscr;":"\u211B","rscr;":"\u{1D4C7}","Rsh;":"\u21B1","rsh;":"\u21B1","rsqb;":"]","rsquo;":"\u2019","rsquor;":"\u2019","rthree;":"\u22CC","rtimes;":"\u22CA","rtri;":"\u25B9","rtrie;":"\u22B5","rtrif;":"\u25B8","rtriltri;":"\u29CE","RuleDelayed;":"\u29F4","ruluhar;":"\u2968","rx;":"\u211E","Sacute;":"\u015A","sacute;":"\u015B","sbquo;":"\u201A","Sc;":"\u2ABC","sc;":"\u227B","scap;":"\u2AB8","Scaron;":"\u0160","scaron;":"\u0161","sccue;":"\u227D","scE;":"\u2AB4","sce;":"\u2AB0","Scedil;":"\u015E","scedil;":"\u015F","Scirc;":"\u015C","scirc;":"\u015D","scnap;":"\u2ABA","scnE;":"\u2AB6","scnsim;":"\u22E9","scpolint;":"\u2A13","scsim;":"\u227F","Scy;":"\u0421","scy;":"\u0441","sdot;":"\u22C5","sdotb;":"\u22A1","sdote;":"\u2A66","searhk;":"\u2925","seArr;":"\u21D8","searr;":"\u2198","searrow;":"\u2198","sect;":"\xA7",sect:"\xA7","semi;":";","seswar;":"\u2929","setminus;":"\u2216","setmn;":"\u2216","sext;":"\u2736","Sfr;":"\u{1D516}","sfr;":"\u{1D530}","sfrown;":"\u2322","sharp;":"\u266F","SHCHcy;":"\u0429","shchcy;":"\u0449","SHcy;":"\u0428","shcy;":"\u0448","ShortDownArrow;":"\u2193","ShortLeftArrow;":"\u2190","shortmid;":"\u2223","shortparallel;":"\u2225","ShortRightArrow;":"\u2192","ShortUpArrow;":"\u2191","shy;":"\xAD",shy:"\xAD","Sigma;":"\u03A3","sigma;":"\u03C3","sigmaf;":"\u03C2","sigmav;":"\u03C2","sim;":"\u223C","simdot;":"\u2A6A","sime;":"\u2243","simeq;":"\u2243","simg;":"\u2A9E","simgE;":"\u2AA0","siml;":"\u2A9D","simlE;":"\u2A9F","simne;":"\u2246","simplus;":"\u2A24","simrarr;":"\u2972","slarr;":"\u2190","SmallCircle;":"\u2218","smallsetminus;":"\u2216","smashp;":"\u2A33","smeparsl;":"\u29E4","smid;":"\u2223","smile;":"\u2323","smt;":"\u2AAA","smte;":"\u2AAC","smtes;":"\u2AAC\uFE00","SOFTcy;":"\u042C","softcy;":"\u044C","sol;":"/","solb;":"\u29C4","solbar;":"\u233F","Sopf;":"\u{1D54A}","sopf;":"\u{1D564}","spades;":"\u2660","spadesuit;":"\u2660","spar;":"\u2225","sqcap;":"\u2293","sqcaps;":"\u2293\uFE00","sqcup;":"\u2294","sqcups;":"\u2294\uFE00","Sqrt;":"\u221A","sqsub;":"\u228F","sqsube;":"\u2291","sqsubset;":"\u228F","sqsubseteq;":"\u2291","sqsup;":"\u2290","sqsupe;":"\u2292","sqsupset;":"\u2290","sqsupseteq;":"\u2292","squ;":"\u25A1","Square;":"\u25A1","square;":"\u25A1","SquareIntersection;":"\u2293","SquareSubset;":"\u228F","SquareSubsetEqual;":"\u2291","SquareSuperset;":"\u2290","SquareSupersetEqual;":"\u2292","SquareUnion;":"\u2294","squarf;":"\u25AA","squf;":"\u25AA","srarr;":"\u2192","Sscr;":"\u{1D4AE}","sscr;":"\u{1D4C8}","ssetmn;":"\u2216","ssmile;":"\u2323","sstarf;":"\u22C6","Star;":"\u22C6","star;":"\u2606","starf;":"\u2605","straightepsilon;":"\u03F5","straightphi;":"\u03D5","strns;":"\xAF","Sub;":"\u22D0","sub;":"\u2282","subdot;":"\u2ABD","subE;":"\u2AC5","sube;":"\u2286","subedot;":"\u2AC3","submult;":"\u2AC1","subnE;":"\u2ACB","subne;":"\u228A","subplus;":"\u2ABF","subrarr;":"\u2979","Subset;":"\u22D0","subset;":"\u2282","subseteq;":"\u2286","subseteqq;":"\u2AC5","SubsetEqual;":"\u2286","subsetneq;":"\u228A","subsetneqq;":"\u2ACB","subsim;":"\u2AC7","subsub;":"\u2AD5","subsup;":"\u2AD3","succ;":"\u227B","succapprox;":"\u2AB8","succcurlyeq;":"\u227D","Succeeds;":"\u227B","SucceedsEqual;":"\u2AB0","SucceedsSlantEqual;":"\u227D","SucceedsTilde;":"\u227F","succeq;":"\u2AB0","succnapprox;":"\u2ABA","succneqq;":"\u2AB6","succnsim;":"\u22E9","succsim;":"\u227F","SuchThat;":"\u220B","Sum;":"\u2211","sum;":"\u2211","sung;":"\u266A","Sup;":"\u22D1","sup;":"\u2283","sup1;":"\xB9",sup1:"\xB9","sup2;":"\xB2",sup2:"\xB2","sup3;":"\xB3",sup3:"\xB3","supdot;":"\u2ABE","supdsub;":"\u2AD8","supE;":"\u2AC6","supe;":"\u2287","supedot;":"\u2AC4","Superset;":"\u2283","SupersetEqual;":"\u2287","suphsol;":"\u27C9","suphsub;":"\u2AD7","suplarr;":"\u297B","supmult;":"\u2AC2","supnE;":"\u2ACC","supne;":"\u228B","supplus;":"\u2AC0","Supset;":"\u22D1","supset;":"\u2283","supseteq;":"\u2287","supseteqq;":"\u2AC6","supsetneq;":"\u228B","supsetneqq;":"\u2ACC","supsim;":"\u2AC8","supsub;":"\u2AD4","supsup;":"\u2AD6","swarhk;":"\u2926","swArr;":"\u21D9","swarr;":"\u2199","swarrow;":"\u2199","swnwar;":"\u292A","szlig;":"\xDF",szlig:"\xDF","Tab;":"	","target;":"\u2316","Tau;":"\u03A4","tau;":"\u03C4","tbrk;":"\u23B4","Tcaron;":"\u0164","tcaron;":"\u0165","Tcedil;":"\u0162","tcedil;":"\u0163","Tcy;":"\u0422","tcy;":"\u0442","tdot;":"\u20DB","telrec;":"\u2315","Tfr;":"\u{1D517}","tfr;":"\u{1D531}","there4;":"\u2234","Therefore;":"\u2234","therefore;":"\u2234","Theta;":"\u0398","theta;":"\u03B8","thetasym;":"\u03D1","thetav;":"\u03D1","thickapprox;":"\u2248","thicksim;":"\u223C","ThickSpace;":"\u205F\u200A","thinsp;":"\u2009","ThinSpace;":"\u2009","thkap;":"\u2248","thksim;":"\u223C","THORN;":"\xDE",THORN:"\xDE","thorn;":"\xFE",thorn:"\xFE","Tilde;":"\u223C","tilde;":"\u02DC","TildeEqual;":"\u2243","TildeFullEqual;":"\u2245","TildeTilde;":"\u2248","times;":"\xD7",times:"\xD7","timesb;":"\u22A0","timesbar;":"\u2A31","timesd;":"\u2A30","tint;":"\u222D","toea;":"\u2928","top;":"\u22A4","topbot;":"\u2336","topcir;":"\u2AF1","Topf;":"\u{1D54B}","topf;":"\u{1D565}","topfork;":"\u2ADA","tosa;":"\u2929","tprime;":"\u2034","TRADE;":"\u2122","trade;":"\u2122","triangle;":"\u25B5","triangledown;":"\u25BF","triangleleft;":"\u25C3","trianglelefteq;":"\u22B4","triangleq;":"\u225C","triangleright;":"\u25B9","trianglerighteq;":"\u22B5","tridot;":"\u25EC","trie;":"\u225C","triminus;":"\u2A3A","TripleDot;":"\u20DB","triplus;":"\u2A39","trisb;":"\u29CD","tritime;":"\u2A3B","trpezium;":"\u23E2","Tscr;":"\u{1D4AF}","tscr;":"\u{1D4C9}","TScy;":"\u0426","tscy;":"\u0446","TSHcy;":"\u040B","tshcy;":"\u045B","Tstrok;":"\u0166","tstrok;":"\u0167","twixt;":"\u226C","twoheadleftarrow;":"\u219E","twoheadrightarrow;":"\u21A0","Uacute;":"\xDA",Uacute:"\xDA","uacute;":"\xFA",uacute:"\xFA","Uarr;":"\u219F","uArr;":"\u21D1","uarr;":"\u2191","Uarrocir;":"\u2949","Ubrcy;":"\u040E","ubrcy;":"\u045E","Ubreve;":"\u016C","ubreve;":"\u016D","Ucirc;":"\xDB",Ucirc:"\xDB","ucirc;":"\xFB",ucirc:"\xFB","Ucy;":"\u0423","ucy;":"\u0443","udarr;":"\u21C5","Udblac;":"\u0170","udblac;":"\u0171","udhar;":"\u296E","ufisht;":"\u297E","Ufr;":"\u{1D518}","ufr;":"\u{1D532}","Ugrave;":"\xD9",Ugrave:"\xD9","ugrave;":"\xF9",ugrave:"\xF9","uHar;":"\u2963","uharl;":"\u21BF","uharr;":"\u21BE","uhblk;":"\u2580","ulcorn;":"\u231C","ulcorner;":"\u231C","ulcrop;":"\u230F","ultri;":"\u25F8","Umacr;":"\u016A","umacr;":"\u016B","uml;":"\xA8",uml:"\xA8","UnderBar;":"_","UnderBrace;":"\u23DF","UnderBracket;":"\u23B5","UnderParenthesis;":"\u23DD","Union;":"\u22C3","UnionPlus;":"\u228E","Uogon;":"\u0172","uogon;":"\u0173","Uopf;":"\u{1D54C}","uopf;":"\u{1D566}","UpArrow;":"\u2191","Uparrow;":"\u21D1","uparrow;":"\u2191","UpArrowBar;":"\u2912","UpArrowDownArrow;":"\u21C5","UpDownArrow;":"\u2195","Updownarrow;":"\u21D5","updownarrow;":"\u2195","UpEquilibrium;":"\u296E","upharpoonleft;":"\u21BF","upharpoonright;":"\u21BE","uplus;":"\u228E","UpperLeftArrow;":"\u2196","UpperRightArrow;":"\u2197","Upsi;":"\u03D2","upsi;":"\u03C5","upsih;":"\u03D2","Upsilon;":"\u03A5","upsilon;":"\u03C5","UpTee;":"\u22A5","UpTeeArrow;":"\u21A5","upuparrows;":"\u21C8","urcorn;":"\u231D","urcorner;":"\u231D","urcrop;":"\u230E","Uring;":"\u016E","uring;":"\u016F","urtri;":"\u25F9","Uscr;":"\u{1D4B0}","uscr;":"\u{1D4CA}","utdot;":"\u22F0","Utilde;":"\u0168","utilde;":"\u0169","utri;":"\u25B5","utrif;":"\u25B4","uuarr;":"\u21C8","Uuml;":"\xDC",Uuml:"\xDC","uuml;":"\xFC",uuml:"\xFC","uwangle;":"\u29A7","vangrt;":"\u299C","varepsilon;":"\u03F5","varkappa;":"\u03F0","varnothing;":"\u2205","varphi;":"\u03D5","varpi;":"\u03D6","varpropto;":"\u221D","vArr;":"\u21D5","varr;":"\u2195","varrho;":"\u03F1","varsigma;":"\u03C2","varsubsetneq;":"\u228A\uFE00","varsubsetneqq;":"\u2ACB\uFE00","varsupsetneq;":"\u228B\uFE00","varsupsetneqq;":"\u2ACC\uFE00","vartheta;":"\u03D1","vartriangleleft;":"\u22B2","vartriangleright;":"\u22B3","Vbar;":"\u2AEB","vBar;":"\u2AE8","vBarv;":"\u2AE9","Vcy;":"\u0412","vcy;":"\u0432","VDash;":"\u22AB","Vdash;":"\u22A9","vDash;":"\u22A8","vdash;":"\u22A2","Vdashl;":"\u2AE6","Vee;":"\u22C1","vee;":"\u2228","veebar;":"\u22BB","veeeq;":"\u225A","vellip;":"\u22EE","Verbar;":"\u2016","verbar;":"|","Vert;":"\u2016","vert;":"|","VerticalBar;":"\u2223","VerticalLine;":"|","VerticalSeparator;":"\u2758","VerticalTilde;":"\u2240","VeryThinSpace;":"\u200A","Vfr;":"\u{1D519}","vfr;":"\u{1D533}","vltri;":"\u22B2","vnsub;":"\u2282\u20D2","vnsup;":"\u2283\u20D2","Vopf;":"\u{1D54D}","vopf;":"\u{1D567}","vprop;":"\u221D","vrtri;":"\u22B3","Vscr;":"\u{1D4B1}","vscr;":"\u{1D4CB}","vsubnE;":"\u2ACB\uFE00","vsubne;":"\u228A\uFE00","vsupnE;":"\u2ACC\uFE00","vsupne;":"\u228B\uFE00","Vvdash;":"\u22AA","vzigzag;":"\u299A","Wcirc;":"\u0174","wcirc;":"\u0175","wedbar;":"\u2A5F","Wedge;":"\u22C0","wedge;":"\u2227","wedgeq;":"\u2259","weierp;":"\u2118","Wfr;":"\u{1D51A}","wfr;":"\u{1D534}","Wopf;":"\u{1D54E}","wopf;":"\u{1D568}","wp;":"\u2118","wr;":"\u2240","wreath;":"\u2240","Wscr;":"\u{1D4B2}","wscr;":"\u{1D4CC}","xcap;":"\u22C2","xcirc;":"\u25EF","xcup;":"\u22C3","xdtri;":"\u25BD","Xfr;":"\u{1D51B}","xfr;":"\u{1D535}","xhArr;":"\u27FA","xharr;":"\u27F7","Xi;":"\u039E","xi;":"\u03BE","xlArr;":"\u27F8","xlarr;":"\u27F5","xmap;":"\u27FC","xnis;":"\u22FB","xodot;":"\u2A00","Xopf;":"\u{1D54F}","xopf;":"\u{1D569}","xoplus;":"\u2A01","xotime;":"\u2A02","xrArr;":"\u27F9","xrarr;":"\u27F6","Xscr;":"\u{1D4B3}","xscr;":"\u{1D4CD}","xsqcup;":"\u2A06","xuplus;":"\u2A04","xutri;":"\u25B3","xvee;":"\u22C1","xwedge;":"\u22C0","Yacute;":"\xDD",Yacute:"\xDD","yacute;":"\xFD",yacute:"\xFD","YAcy;":"\u042F","yacy;":"\u044F","Ycirc;":"\u0176","ycirc;":"\u0177","Ycy;":"\u042B","ycy;":"\u044B","yen;":"\xA5",yen:"\xA5","Yfr;":"\u{1D51C}","yfr;":"\u{1D536}","YIcy;":"\u0407","yicy;":"\u0457","Yopf;":"\u{1D550}","yopf;":"\u{1D56A}","Yscr;":"\u{1D4B4}","yscr;":"\u{1D4CE}","YUcy;":"\u042E","yucy;":"\u044E","Yuml;":"\u0178","yuml;":"\xFF",yuml:"\xFF","Zacute;":"\u0179","zacute;":"\u017A","Zcaron;":"\u017D","zcaron;":"\u017E","Zcy;":"\u0417","zcy;":"\u0437","Zdot;":"\u017B","zdot;":"\u017C","zeetrf;":"\u2128","ZeroWidthSpace;":"\u200B","Zeta;":"\u0396","zeta;":"\u03B6","Zfr;":"\u2128","zfr;":"\u{1D537}","ZHcy;":"\u0416","zhcy;":"\u0436","zigrarr;":"\u21DD","Zopf;":"\u2124","zopf;":"\u{1D56B}","Zscr;":"\u{1D4B5}","zscr;":"\u{1D4CF}","zwj;":"\u200D","zwnj;":"\u200C"};function tt(e,t){if(e.length<t.length)return!1;for(var n=0;n<t.length;n++)if(e[n]!==t[n])return!1;return!0}function Ru(e,t){var n=e.length-t.length;return n>0?e.lastIndexOf(t)===n:n===0?e===t:!1}function Do(e,t){for(var n="";t>0;)(t&1)===1&&(n+=e),e+=e,t=t>>>1;return n}var Du=97,Nu=122,Iu=65,zu=90,Uu=48,Fu=57;function Kt(e,t){var n=e.charCodeAt(t);return Du<=n&&n<=Nu||Iu<=n&&n<=zu||Uu<=n&&n<=Fu}function li(e){return typeof e<"u"}function Hu(e){if(e)return typeof e=="string"?{kind:"markdown",value:e}:{kind:"markdown",value:e.value}}var jo=function(){function e(t,n){var i=this;this.id=t,this._tags=[],this._tagMap={},this._valueSetMap={},this._tags=n.tags||[],this._globalAttributes=n.globalAttributes||[],this._tags.forEach(function(r){i._tagMap[r.name.toLowerCase()]=r}),n.valueSets&&n.valueSets.forEach(function(r){i._valueSetMap[r.name]=r.values})}return e.prototype.isApplicable=function(){return!0},e.prototype.getId=function(){return this.id},e.prototype.provideTags=function(){return this._tags},e.prototype.provideAttributes=function(t){var n=[],i=function(s){n.push(s)},r=this._tagMap[t.toLowerCase()];return r&&r.attributes.forEach(i),this._globalAttributes.forEach(i),n},e.prototype.provideValues=function(t,n){var i=this,r=[];n=n.toLowerCase();var s=function(l){l.forEach(function(o){o.name.toLowerCase()===n&&(o.values&&o.values.forEach(function(u){r.push(u)}),o.valueSet&&i._valueSetMap[o.valueSet]&&i._valueSetMap[o.valueSet].forEach(function(u){r.push(u)}))})},a=this._tagMap[t.toLowerCase()];return a&&s(a.attributes),s(this._globalAttributes),r},e}();function dt(e,t,n){t===void 0&&(t={});var i={kind:n?"markdown":"plaintext",value:""};if(e.description&&t.documentation!==!1){var r=Hu(e.description);r&&(i.value+=r.value)}if(e.references&&e.references.length>0&&t.references!==!1&&(i.value.length&&(i.value+=`
...
`)),i.value!=="")return i}var No=function(e,t,n,i){function r(s){return s instanceof n?s:new n(function(a){a(s)})}return new(n||(n=Promise))(function(s,a){function l(c){try{u(i.next(c))}catch(h){a(h)}}function o(c){try{u(i.throw(c))}catch(h){a(h)}}function u(c){c.done?s(c.value):r(c.value).then(l,o)}u((i=i.apply(e,t||[])).next())})},Io=function(e,t){var n={label:0,sent:function(){if(s[0]&1)throw s[1];return s[1]},trys:[],ops:[]},i,r,s,a;return a={next:l(0),throw:l(1),return:l(2)},typeof Symbol=="function"&&(a[Symbol.iterator]=function(){return this}),a;function l(u){return function(c){return o([u,c])}}function o(u){if(i)throw new TypeError("Generator is already executing.");for(;n;)try{if(i=1,r&&(s=u[0]&2?r.return:u[0]?r.throw||((s=r.return)&&s.call(r),0):r.next)&&!(s=s.call(r,u[1])).done)return s;switch(r=0,s&&(u=[u[0]&2,s.value]),u[0]){case 0:case 1:s=u;break;case 4:return n.label++,{value:u[1],done:!1};case 5:n.label++,r=u[1],u=[0];continue;case 7:u=n.ops.pop(),n.trys.pop();continue;default:if(s=n.trys,!(s=s.length>0&&s[s.length-1])&&(u[0]===6||u[0]===2)){n=0;continue}if(u[0]===3&&(!s||u[1]>s[0]&&u[1]<s[3])){n.label=u[1];break}if(u[0]===6&&n.label<s[1]){n.label=s[1],s=u;break}if(s&&n.label<s[2]){n.label=s[2],n.ops.push(u);break}s[2]&&n.ops.pop(),n.trys.pop();continue}u=t.call(e,n)}catch(c){u=[6,c],r=0}finally{i=s=0}if(u[0]&5)throw u[1];return{value:u[0]?u[1]:void 0,done:!0}}},Wu=function(){function e(t){this.readDirectory=t,this.atributeCompletions=[]}return e.prototype.onHtmlAttributeValue=function(t){Ou(t.tag,t.attribute)&&this.atributeCompletions.push(t)},e.prototype.computeCompletions=function(t,n){return No(this,void 0,void 0,function(){var i,r,s,a,l,o,u,c,h,f;return Io(this,function(m){switch(m.label){case 0:i={items:[],isIncomplete:!1},r=0,s=this.atributeCompletions,m.label=1;case 1:return r<s.length?(a=s[r],l=Pu(t.getText(a.range)),qu(l)?l==="."||l===".."?(i.isIncomplete=!0,[3,4]):[3,2]:[3,4]):[3,5];case 2:return o=Vu(a.value,l,a.range),[4,this.providePathSuggestions(a.value,o,t,n)];case 3:for(u=m.sent(),c=0,h=u;c<h.length;c++)f=h[c],i.items.push(f);m.label=4;case 4:return r++,[3,1];case 5:return[2,i]}})})},e.prototype.providePathSuggestions=function(t,n,i,r){return No(this,void 0,void 0,function(){var s,a,l,o,u,c,h,f,m;return Io(this,function(b){switch(b.label){case 0:if(s=t.substring(0,t.lastIndexOf("/")+1),a=r.resolveReference(s||".",i.uri),!a)return[3,4];b.label=1;case 1:return b.trys.push([1,3,,4]),l=[],[4,this.readDirectory(a)];case 2:for(o=b.sent(),u=0,c=o;u<c.length;u++)h=c[u],f=h[0],m=h[1],f.charCodeAt(0)!==Bu&&l.push(ju(f,m===vr.Directory,n));return[2,l];case 3:return b.sent(),[3,4];case 4:return[2,[]]}})})},e}(),Bu=46;function Pu(e){return tt(e,"'")||tt(e,'"')?e.slice(1,-1):e}function qu(e){return!(tt(e,"http")||tt(e,"https")||tt(e,"//"))}function Ou(e,t){if(t==="src"||t==="href")return!0;var n=$u[e];return n?typeof n=="string"?n===t:n.indexOf(t)!==-1:!1}function Vu(e,t,n){var i,r=e.lastIndexOf("/");if(r===-1)i=Gu(n,1,-1);else{var s=t.slice(r+1),a=tn(n.end,-1-s.length),l=s.indexOf(" "),o=void 0;l!==-1?o=tn(a,l):o=tn(n.end,-1),i=Z.create(a,o)}return i}function ju(e,t,n){return t?(e=e+"/",{label:e,kind:be.Folder,textEdit:le.replace(n,e),command:{title:"Suggest",command:"editor.action.triggerSuggest"}}):{label:e,kind:be.File,textEdit:le.replace(n,e)}}function tn(e,t){return he.create(e.line,e.character+t)}function Gu(e,t,n){var i=tn(e.start,t),r=tn(e.end,n);return Z.create(i,r)}var $u={a:"href",area:"href",body:"background",del:"cite",form:"action",frame:["src","longdesc"],img:["src","longdesc"],ins:"cite",link:"href",object:"data",q:"cite",script:"src",audio:"src",button:"formaction",command:"icon",embed:"src",html:"manifest",input:["src","formaction"],source:"src",track:"src",video:["src","poster"]},Qu=function(e,t,n,i){function r(s){return s instanceof n?s:new n(function(a){a(s)})}return new(n||(n=Promise))(function(s,a){function l(c){try{u(i.next(c))}catch(h){a(h)}}function o(c){try{u(i.throw(c))}catch(h){a(h)}}function u(c){c.done?s(c.value):r(c.value).then(l,o)}u((i=i.apply(e,t||[])).next())})},Ju=function(e,t){var n={label:0,sent:function(){if(s[0]&1)throw s[1];return s[1]},trys:[],ops:[]},i,r,s,a;return a={next:l(0),throw:l(1),return:l(2)},typeof Symbol=="function"&&(a[Symbol.iterator]=function(){return this}),a;function l(u){return function(c){return o([u,c])}}function o(u){if(i)throw new TypeError("Generator is already executing.");for(;n;)try{if(i=1,r&&(s=u[0]&2?r.return:u[0]?r.throw||((s=r.return)&&s.call(r),0):r.next)&&!(s=s.call(r,u[1])).done)return s;switch(r=0,s&&(u=[u[0]&2,s.value]),u[0]){case 0:case 1:s=u;break;case 4:return n.label++,{value:u[1],done:!1};case 5:n.label++,r=u[1],u=[0];continue;case 7:u=n.ops.pop(),n.trys.pop();continue;default:if(s=n.trys,!(s=s.length>0&&s[s.length-1])&&(u[0]===6||u[0]===2)){n=0;continue}if(u[0]===3&&(!s||u[1]>s[0]&&u[1]<s[3])){n.label=u[1];break}if(u[0]===6&&n.label<s[1]){n.label=s[1],s=u;break}if(s&&n.label<s[2]){n.label=s[2],n.ops.push(u);break}s[2]&&n.ops.pop(),n.trys.pop();continue}u=t.call(e,n)}catch(c){u=[6,c],r=0}finally{i=s=0}if(u[0]&5)throw u[1];return{value:u[0]?u[1]:void 0,done:!0}}},Xu=wr(),Yu=function(){function e(t,n){this.lsOptions=t,this.dataManager=n,this.completionParticipants=[]}return e.prototype.setCompletionParticipants=function(t){this.completionParticipants=t||[]},e.prototype.doComplete2=function(t,n,i,r,s){return Qu(this,void 0,void 0,function(){var a,l,o,u;return Ju(this,function(c){switch(c.label){case 0:if(!this.lsOptions.fileSystemProvider||!this.lsOptions.fileSystemProvider.readDirectory)return[2,this.doComplete(t,n,i,s)];a=new Wu(this.lsOptions.fileSystemProvider.readDirectory),l=this.completionParticipants,this.completionParticipants=[a].concat(l),o=this.doComplete(t,n,i,s),c.label=1;case 1:return c.trys.push([1,,3,4]),[4,a.computeCompletions(t,r)];case 2:return u=c.sent(),[2,{isIncomplete:o.isIncomplete||u.isIncomplete,items:u.items.concat(o.items)}];case 3:return this.completionParticipants=l,[7];case 4:return[2]}})})},e.prototype.doComplete=function(t,n,i,r){var s=this._doComplete(t,n,i,r);return this.convertCompletionList(s)},e.prototype._doComplete=function(t,n,i,r){var s={isIncomplete:!1,items:[]},a=this.completionParticipants,l=this.dataManager.getDataProviders().filter(function(I){return I.isApplicable(t.languageId)&&(!r||r[I.getId()]!==!1)}),o=this.doesSupportMarkdown(),u=t.getText(),c=t.offsetAt(n),h=i.findNodeBefore(c);if(!h)return s;var f=we(u,h.start),m="",b;function p(I,z){return z===void 0&&(z=c),I>c&&(I=c),{start:t.positionAt(I),end:t.positionAt(z)}}function w(I,z){var P=p(I,z);return l.forEach(function(G){G.provideTags().forEach(function(X){s.items.push({label:X.name,kind:be.Property,documentation:dt(X,void 0,o),textEdit:le.replace(P,X.name),insertTextFormat:Se.PlainText})})}),s}function x(I){for(var z=I;z>0;){var P=u.charAt(z-1);if(`
\r`.indexOf(P)>=0)return u.substring(z,I);if(!ui(P))return null;z--}return u.substring(0,I)}function _(I,z,P){P===void 0&&(P=c);var G=p(I,P),X=zo(u,P,V.WithinEndTag,F.EndTagClose)?"":">",Q=h;for(z&&(Q=Q.parent);Q;){var K=Q.tag;if(K&&(!Q.closed||Q.endTagStart&&Q.endTagStart>c)){var me={label:"/"+K,kind:be.Property,filterText:"/"+K,textEdit:le.replace(G,"/"+K+X),insertTextFormat:Se.PlainText},Ce=x(Q.start),We=x(I-1);if(Ce!==null&&We!==null&&Ce!==We){var ve=Ce+"</"+K+X;me.textEdit=le.replace(p(I-1-We.length),ve),me.filterText=We+"</"+K}return s.items.push(me),s}Q=Q.parent}return z||l.forEach(function(nt){nt.provideTags().forEach(function(xe){s.items.push({label:"/"+xe.name,kind:be.Property,documentation:dt(xe,void 0,o),filterText:"/"+xe.name+X,textEdit:le.replace(G,"/"+xe.name+X),insertTextFormat:Se.PlainText})})}),s}function y(I,z){if(r&&r.hideAutoCompleteProposals)return s;if(!oi(z)){var P=t.positionAt(I);s.items.push({label:"</"+z+">",kind:be.Property,filterText:"</"+z+">",textEdit:le.insert(P,"$0</"+z+">"),insertTextFormat:Se.Snippet})}return s}function C(I,z){return w(I,z),_(I,!0,z),s}function E(){var I=Object.create(null);return h.attributeNames.forEach(function(z){I[z]=!0}),I}function B(I,z){var P;z===void 0&&(z=c);for(var G=c;G<z&&u[G]!=="<";)G++;var X=u.substring(I,z),Q=p(I,G),K="";if(!zo(u,z,V.AfterAttributeName,F.DelimiterAssign)){var me=(P=r?.attributeDefaultValue)!==null&&P!==void 0?P:"doublequotes";me==="empty"?K="=$1":me==="singlequotes"?K="='$1'":K='="$1"'}var Ce=E();return Ce[X]=!1,l.forEach(function(We){We.provideAttributes(m).forEach(function(ve){if(!Ce[ve.name]){Ce[ve.name]=!0;var nt=ve.name,xe;ve.valueSet!=="v"&&K.length&&(nt=nt+K,(ve.valueSet||ve.name==="style")&&(xe={title:"Suggest",command:"editor.action.triggerSuggest"})),s.items.push({label:ve.name,kind:ve.valueSet==="handler"?be.Function:be.Value,documentation:dt(ve,void 0,o),textEdit:le.replace(Q,nt),insertTextFormat:Se.Snippet,command:xe})}})}),v(Q,Ce),s}function v(I,z){var P="data-",G={};G[P]="".concat(P,'$1="$2"');function X(Q){Q.attributeNames.forEach(function(K){tt(K,P)&&!G[K]&&!z[K]&&(G[K]=K+'="$1"')}),Q.children.forEach(function(K){return X(K)})}i&&i.roots.forEach(function(Q){return X(Q)}),Object.keys(G).forEach(function(Q){return s.items.push({label:Q,kind:be.Value,textEdit:le.replace(I,G[Q]),insertTextFormat:Se.Snippet})})}function g(I,z){z===void 0&&(z=c);var P,G,X;if(c>I&&c<=z&&Zu(u[I])){var Q=I+1,K=z;z>I&&u[z-1]===u[I]&&K--;var me=Ku(u,c,Q),Ce=ec(u,c,K);P=p(me,Ce),X=c>=Q&&c<=K?u.substring(Q,c):"",G=!1}else P=p(I,z),X=u.substring(I,c),G=!0;if(a.length>0)for(var We=m.toLowerCase(),ve=b.toLowerCase(),nt=p(I,z),xe=0,yr=a;xe<yr.length;xe++){var xr=yr[xe];xr.onHtmlAttributeValue&&xr.onHtmlAttributeValue({document:t,position:n,tag:We,attribute:ve,value:X,range:nt})}return l.forEach(function(Xo){Xo.provideValues(m,b).forEach(function(on){var Tr=G?'"'+on.name+'"':on.name;s.items.push({label:on.name,filterText:Tr,kind:be.Unit,documentation:dt(on,void 0,o),textEdit:le.replace(P,Tr),insertTextFormat:Se.PlainText})})}),S(),s}function T(I){return c===f.getTokenEnd()&&(N=f.scan(),N===I&&f.getTokenOffset()===c)?f.getTokenEnd():c}function q(){for(var I=0,z=a;I<z.length;I++){var P=z[I];P.onHtmlContent&&P.onHtmlContent({document:t,position:n})}return S()}function S(){for(var I=c-1,z=n.character;I>=0&&Kt(u,I);)I--,z--;if(I>=0&&u[I]==="&"){var P=Z.create(he.create(n.line,z-1),n);for(var G in en)if(Ru(G,";")){var X="&"+G;s.items.push({label:X,kind:be.Keyword,documentation:Xu("entity.propose","Character entity representing '".concat(en[G],"'")),textEdit:le.replace(P,X),insertTextFormat:Se.PlainText})}}return s}function A(I,z){var P=p(I,z);s.items.push({label:"!DOCTYPE",kind:be.Property,documentation:"A preamble for an HTML document.",textEdit:le.replace(P,"!DOCTYPE html>"),insertTextFormat:Se.PlainText})}for(var N=f.scan();N!==F.EOS&&f.getTokenOffset()<=c;){switch(N){case F.StartTagOpen:if(f.getTokenEnd()===c){var D=T(F.StartTag);return n.line===0&&A(c,D),C(c,D)}break;case F.StartTag:if(f.getTokenOffset()<=c&&c<=f.getTokenEnd())return w(f.getTokenOffset(),f.getTokenEnd());m=f.getTokenText();break;case F.AttributeName:if(f.getTokenOffset()<=c&&c<=f.getTokenEnd())return B(f.getTokenOffset(),f.getTokenEnd());b=f.getTokenText();break;case F.DelimiterAssign:if(f.getTokenEnd()===c){var D=T(F.AttributeValue);return g(c,D)}break;case F.AttributeValue:if(f.getTokenOffset()<=c&&c<=f.getTokenEnd())return g(f.getTokenOffset(),f.getTokenEnd());break;case F.Whitespace:if(c<=f.getTokenEnd())switch(f.getScannerState()){case V.AfterOpeningStartTag:var U=f.getTokenOffset(),W=T(F.StartTag);return C(U,W);case V.WithinTag:case V.AfterAttributeName:return B(f.getTokenEnd());case V.BeforeAttributeValue:return g(f.getTokenEnd());case V.AfterOpeningEndTag:return _(f.getTokenOffset()-1,!1);case V.WithinContent:return q()}break;case F.EndTagOpen:if(c<=f.getTokenEnd()){var L=f.getTokenOffset()+1,k=T(F.EndTag);return _(L,!1,k)}break;case F.EndTag:if(c<=f.getTokenEnd())for(var R=f.getTokenOffset()-1;R>=0;){var H=u.charAt(R);if(H==="/")return _(R,!1,f.getTokenEnd());if(!ui(H))break;R--}break;case F.StartTagClose:if(c<=f.getTokenEnd()&&m)return y(f.getTokenEnd(),m);break;case F.Content:if(c<=f.getTokenEnd())return q();break;default:if(c<=f.getTokenEnd())return s;break}N=f.scan()}return s},e.prototype.doQuoteComplete=function(t,n,i,r){var s,a=t.offsetAt(n);if(a<=0)return null;var l=(s=r?.attributeDefaultValue)!==null&&s!==void 0?s:"doublequotes";if(l==="empty")return null;var o=t.getText().charAt(a-1);if(o!=="=")return null;var u=l==="doublequotes"?'"$1"':"'$1'",c=i.findNodeBefore(a);if(c&&c.attributes&&c.start<a&&(!c.endTagStart||c.endTagStart>a))for(var h=we(t.getText(),c.start),f=h.scan();f!==F.EOS&&h.getTokenEnd()<=a;){if(f===F.AttributeName&&h.getTokenEnd()===a-1)return f=h.scan(),f!==F.DelimiterAssign||(f=h.scan(),f===F.Unknown||f===F.AttributeValue)?null:u;f=h.scan()}return null},e.prototype.doTagComplete=function(t,n,i){var r=t.offsetAt(n);if(r<=0)return null;var s=t.getText().charAt(r-1);if(s===">"){var a=i.findNodeBefore(r);if(a&&a.tag&&!oi(a.tag)&&a.start<r&&(!a.endTagStart||a.endTagStart>r))for(var l=we(t.getText(),a.start),o=l.scan();o!==F.EOS&&l.getTokenEnd()<=r;){if(o===F.StartTagClose&&l.getTokenEnd()===r)return"$0</".concat(a.tag,">");o=l.scan()}}else if(s==="/"){for(var a=i.findNodeBefore(r);a&&a.closed&&!(a.endTagStart&&a.endTagStart>r);)a=a.parent;if(a&&a.tag)for(var l=we(t.getText(),a.start),o=l.scan();o!==F.EOS&&l.getTokenEnd()<=r;){if(o===F.EndTagOpen&&l.getTokenEnd()===r)return"".concat(a.tag,">");o=l.scan()}}return null},e.prototype.convertCompletionList=function(t){return this.doesSupportMarkdown()||t.items.forEach(function(n){n.documentation&&typeof n.documentation!="string"&&(n.documentation={kind:"plaintext",value:n.documentation.value})}),t},e.prototype.doesSupportMarkdown=function(){var t,n,i;if(!li(this.supportsMarkdown)){if(!li(this.lsOptions.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;var r=(i=(n=(t=this.lsOptions.clientCapabilities.textDocument)===null||t===void 0?void 0:t.completion)===null||n===void 0?void 0:n.completionItem)===null||i===void 0?void 0:i.documentationFormat;this.supportsMarkdown=Array.isArray(r)&&r.indexOf(Le.Markdown)!==-1}return this.supportsMarkdown},e}();function Zu(e){return/^["']*$/.test(e)}function ui(e){return/^\s*$/.test(e)}function zo(e,t,n,i){for(var r=we(e,t,n),s=r.scan();s===F.Whitespace;)s=r.scan();return s===i}function Ku(e,t,n){for(;t>n&&!ui(e[t-1]);)t--;return t}function ec(e,t,n){for(;t<n&&!ui(e[t]);)t++;return t}var tc=wr(),nc=function(){function e(t,n){this.lsOptions=t,this.dataManager=n}return e.prototype.doHover=function(t,n,i,r){var s=this.convertContents.bind(this),a=this.doesSupportMarkdown(),l=t.offsetAt(n),o=i.findNodeAt(l),u=t.getText();if(!o||!o.tag)return null;var c=this.dataManager.getDataProviders().filter(function(A){return A.isApplicable(t.languageId)});function h(A,N,D){for(var U=function(H){var I=null;if(H.provideTags().forEach(function(z){if(z.name.toLowerCase()===A.toLowerCase()){var P=dt(z,r,a);P||(P={kind:a?"markdown":"plaintext",value:""}),I={contents:P,range:N}}}),I)return I.contents=s(I.contents),{value:I}},W=0,L=c;W<L.length;W++){var k=L[W],R=U(k);if(typeof R=="object")return R.value}return null}function f(A,N,D){for(var U=function(H){var I=null;if(H.provideAttributes(A).forEach(function(z){if(N===z.name&&z.description){var P=dt(z,r,a);P?I={contents:P,range:D}:I=null}}),I)return I.contents=s(I.contents),{value:I}},W=0,L=c;W<L.length;W++){var k=L[W],R=U(k);if(typeof R=="object")return R.value}return null}function m(A,N,D,U){for(var W=function(I){var z=null;if(I.provideValues(A,N).forEach(function(P){if(D===P.name&&P.description){var G=dt(P,r,a);G?z={contents:G,range:U}:z=null}}),z)return z.contents=s(z.contents),{value:z}},L=0,k=c;L<k.length;L++){var R=k[L],H=W(R);if(typeof H=="object")return H.value}return null}function b(A,N){var D=x(A);for(var U in en){var W=null,L="&"+U;if(D===L){var k=en[U].charCodeAt(0).toString(16).toUpperCase(),R="U+";if(k.length<4)for(var H=4-k.length,I=0;I<H;)R+="0",I+=1;R+=k;var z=tc("entity.propose","Character entity representing '".concat(en[U],"', unicode equivalent '").concat(R,"'"));z?W={contents:z,range:N}:W=null}if(W)return W.contents=s(W.contents),W}return null}function p(A,N){for(var D=we(t.getText(),N),U=D.scan();U!==F.EOS&&(D.getTokenEnd()<l||D.getTokenEnd()===l&&U!==A);)U=D.scan();return U===A&&l<=D.getTokenEnd()?{start:t.positionAt(D.getTokenOffset()),end:t.positionAt(D.getTokenEnd())}:null}function w(){for(var A=l-1,N=n.character;A>=0&&Kt(u,A);)A--,N--;for(var D=A+1,U=N;Kt(u,D);)D++,U++;if(A>=0&&u[A]==="&"){var W=null;return u[D]===";"?W=Z.create(he.create(n.line,N),he.create(n.line,U+1)):W=Z.create(he.create(n.line,N),he.create(n.line,U)),W}return null}function x(A){for(var N=l-1,D="&";N>=0&&Kt(A,N);)N--;for(N=N+1;Kt(A,N);)D+=A[N],N+=1;return D+=";",D}if(o.endTagStart&&l>=o.endTagStart){var _=p(F.EndTag,o.endTagStart);return _?h(o.tag,_):null}var y=p(F.StartTag,o.start);if(y)return h(o.tag,y);var C=p(F.AttributeName,o.start);if(C){var E=o.tag,B=t.getText(C);return f(E,B,C)}var v=w();if(v)return b(u,v);function g(A,N){for(var D=we(t.getText(),A),U=D.scan(),W=void 0;U!==F.EOS&&D.getTokenEnd()<=N;)U=D.scan(),U===F.AttributeName&&(W=D.getTokenText());return W}var T=p(F.AttributeValue,o.start);if(T){var E=o.tag,q=ic(t.getText(T)),S=g(o.start,t.offsetAt(T.start));if(S)return m(E,S,q,T)}return null},e.prototype.convertContents=function(t){if(!this.doesSupportMarkdown()){if(typeof t=="string")return t;if("kind"in t)return{kind:"plaintext",value:t.value};if(Array.isArray(t))t.map(function(n){return typeof n=="string"?n:n.value});else return t.value}return t},e.prototype.doesSupportMarkdown=function(){var t,n,i;if(!li(this.supportsMarkdown)){if(!li(this.lsOptions.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;var r=(i=(n=(t=this.lsOptions.clientCapabilities)===null||t===void 0?void 0:t.textDocument)===null||n===void 0?void 0:n.hover)===null||i===void 0?void 0:i.contentFormat;this.supportsMarkdown=Array.isArray(r)&&r.indexOf(Le.Markdown)!==-1}return this.supportsMarkdown},e}();function ic(e){return e.length<=1?e.replace(/['"]/,""):((e[0]==="'"||e[0]==='"')&&(e=e.slice(1)),(e[e.length-1]==="'"||e[e.length-1]==='"')&&(e=e.slice(0,-1)),e)}function rc(e,t){return e}var Go;(function(){var e=[,,function(r){function s(o){this.__parent=o,this.__character_count=0,this.__indent_count=-1,this.__alignment_count=0,this.__wrap_point_index=0,this.__wrap_point_character_count=0,this.__wrap_point_indent_count=-1,this.__wrap_point_alignment_count=0,this.__items=[]}s.prototype.clone_empty=function(){var o=new s(this.__parent);return o.set_indent(this.__indent_count,this.__alignment_count),o},s.prototype.item=function(o){return o<0?this.__items[this.__items.length+o]:this.__items[o]},s.prototype.has_match=function(o){for(var u=this.__items.length-1;u>=0;u--)if(this.__items[u].match(o))return!0;return!1},s.prototype.set_indent=function(o,u){this.is_empty()&&(this.__indent_count=o||0,this.__alignment_count=u||0,this.__character_count=this.__parent.get_indent_size(this.__indent_count,this.__alignment_count))},s.prototype._set_wrap_point=function(){this.__parent.wrap_line_length&&(this.__wrap_point_index=this.__items.length,this.__wrap_point_character_count=this.__character_count,this.__wrap_point_indent_count=this.__parent.next_line.__indent_count,this.__wrap_point_alignment_count=this.__parent.next_line.__alignment_count)},s.prototype._should_wrap=function(){return this.__wrap_point_index&&this.__character_count>this.__parent.wrap_line_length&&this.__wrap_point_character_count>this.__parent.next_line.__character_count},s.prototype._allow_wrap=function(){if(this._should_wrap()){this.__parent.add_new_line();var o=this.__parent.current_line;return o.set_indent(this.__wrap_point_indent_count,this.__wrap_point_alignment_count),o.__items=this.__items.slice(this.__wrap_point_index),this.__items=this.__items.slice(0,this.__wrap_point_index),o.__character_count+=this.__character_count-this.__wrap_point_character_count,this.__character_count=this.__wrap_point_character_count,o.__items[0]===" "&&(o.__items.splice(0,1),o.__character_count-=1),!0}return!1},s.prototype.is_empty=function(){return this.__items.length===0},s.prototype.last=function(){return this.is_empty()?null:this.__items[this.__items.length-1]},s.prototype.push=function(o){this.__items.push(o);var u=o.lastIndexOf(`
...
`+u+`
You passed in: '`+this.raw_options[o]+"'");return h},s.prototype._is_valid_selection=function(o,u){return o.length&&u.length&&!o.some(function(c){return u.indexOf(c)===-1})};function a(o,u){var c={};o=l(o);var h;for(h in o)h!==u&&(c[h]=o[h]);if(u&&o[u])for(h in o[u])c[h]=o[u][h];return c}function l(o){var u={},c;for(c in o){var h=c.replace(/-/g,"_");u[h]=o[c]}return u}r.exports.Options=s,r.exports.normalizeOpts=l,r.exports.mergeOpts=a},,function(r){var s=RegExp.prototype.hasOwnProperty("sticky");function a(l){this.__input=l||"",this.__input_length=this.__input.length,this.__position=0}a.prototype.restart=function(){this.__position=0},a.prototype.back=function(){this.__position>0&&(this.__position-=1)},a.prototype.hasNext=function(){return this.__position<this.__input_length},a.prototype.next=function(){var l=null;return this.hasNext()&&(l=this.__input.charAt(this.__position),this.__position+=1),l},a.prototype.peek=function(l){var o=null;return l=l||0,l+=this.__position,l>=0&&l<this.__input_length&&(o=this.__input.charAt(l)),o},a.prototype.__match=function(l,o){l.lastIndex=o;var u=l.exec(this.__input);return u&&!(s&&l.sticky)&&u.index!==o&&(u=null),u},a.prototype.test=function(l,o){return o=o||0,o+=this.__position,o>=0&&o<this.__input_length?!!this.__match(l,o):!1},a.prototype.testChar=function(l,o){var u=this.peek(o);return l.lastIndex=0,u!==null&&l.test(u)},a.prototype.match=function(l){var o=this.__match(l,this.__position);return o?this.__position+=o[0].length:o=null,o},a.prototype.read=function(l,o,u){var c="",h;return l&&(h=this.match(l),h&&(c+=h[0])),o&&(h||!l)&&(c+=this.readUntil(o,u)),c},a.prototype.readUntil=function(l,o){var u="",c=this.__position;l.lastIndex=this.__position;var h=l.exec(this.__input);return h?(c=h.index,o&&(c+=h[0].length)):c=this.__input_length,u=this.__input.substring(this.__position,c),this.__position=c,u},a.prototype.readUntilAfter=function(l){return this.readUntil(l,!0)},a.prototype.get_regexp=function(l,o){var u=null,c="g";return o&&s&&(c="y"),typeof l=="string"&&l!==""?u=new RegExp(l,c):l&&(u=new RegExp(l.source,c)),u},a.prototype.get_literal_regexp=function(l){return RegExp(l.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"))},a.prototype.peekUntilAfter=function(l){var o=this.__position,u=this.readUntilAfter(l);return this.__position=o,u},a.prototype.lookBack=function(l){var o=this.__position-1;return o>=l.length&&this.__input.substring(o-l.length,o).toLowerCase()===l},r.exports.InputScanner=a},,,,,function(r){function s(a,l){a=typeof a=="string"?a:a.source,l=typeof l=="string"?l:l.source,this.__directives_block_pattern=new RegExp(a+/ beautify( \w+[:]\w+)+ /.source+l,"g"),this.__directive_pattern=/ (\w+)[:](\w+)/g,this.__directives_end_ignore_pattern=new RegExp(a+/\sbeautify\signore:end\s/.source+l,"g")}s.prototype.get_directives=function(a){if(!a.match(this.__directives_block_pattern))return null;var l={};this.__directive_pattern.lastIndex=0;for(var o=this.__directive_pattern.exec(a);o;)l[o[1]]=o[2],o=this.__directive_pattern.exec(a);return l},s.prototype.readIgnored=function(a){return a.readUntilAfter(this.__directives_end_ignore_pattern)},r.exports.Directives=s},,function(r,s,a){var l=a(16).Beautifier,o=a(17).Options;function u(c,h){var f=new l(c,h);return f.beautify()}r.exports=u,r.exports.defaultOptions=function(){return new o}},function(r,s,a){var l=a(17).Options,o=a(2).Output,u=a(8).InputScanner,c=a(13).Directives,h=new c(/\/\*/,/\*\//),f=/\r\n|[\r\n]/,m=/\r\n|[\r\n]/g,b=/\s/,p=/(?:\s|\n)+/g,w=/\/\*(?:[\s\S]*?)((?:\*\/)|$)/g,x=/\/\/(?:[^\n\r\u2028\u2029]*)/g;function _(y,C){this._source_text=y||"",this._options=new l(C),this._ch=null,this._input=null,this.NESTED_AT_RULE={"@page":!0,"@font-face":!0,"@keyframes":!0,"@media":!0,"@supports":!0,"@document":!0},this.CONDITIONAL_GROUP_RULE={"@media":!0,"@supports":!0,"@document":!0}}_.prototype.eatString=function(y){var C="";for(this._ch=this._input.next();this._ch;){if(C+=this._ch,this._ch==="\\")C+=this._input.next();else if(y.indexOf(this._ch)!==-1||this._ch===`
`)break;this._ch=this._input.next()}return C},_.prototype.eatWhitespace=function(y){for(var C=b.test(this._input.peek()),E=0;b.test(this._input.peek());)this._ch=this._input.next(),y&&this._ch===`
`&&(E===0||E<this._options.max_preserve_newlines)&&(E++,this._output.add_new_line(!0));return C},_.prototype.foundNestedPseudoClass=function(){for(var y=0,C=1,E=this._input.peek(C);E;){if(E==="{")return!0;if(E==="(")y+=1;else if(E===")"){if(y===0)return!1;y-=1}else if(E===";"||E==="}")return!1;C++,E=this._input.peek(C)}return!1},_.prototype.print_string=function(y){this._output.set_indent(this._indentLevel),this._output.non_breaking_space=!0,this._output.add_token(y)},_.prototype.preserveSingleSpace=function(y){y&&(this._output.space_before_token=!0)},_.prototype.indent=function(){this._indentLevel++},_.prototype.outdent=function(){this._indentLevel>0&&this._indentLevel--},_.prototype.beautify=function(){if(this._options.disabled)return this._source_text;var y=this._source_text,C=this._options.eol;C==="auto"&&(C=`
`,y&&f.test(y||"")&&(C=y.match(f)[0])),y=y.replace(m,`
`);var E=y.match(/^[\t ]*/)[0];this._output=new o(this._options,E),this._input=new u(y),this._indentLevel=0,this._nestedLevel=0,this._ch=null;for(var B=0,v=!1,g=!1,T=!1,q=!1,S=!1,A=this._ch,N,D,U;N=this._input.read(p),D=N!=="",U=A,this._ch=this._input.next(),this._ch==="\\"&&this._input.hasNext()&&(this._ch+=this._input.next()),A=this._ch,this._ch;)if(this._ch==="/"&&this._input.peek()==="*"){this._output.add_new_line(),this._input.back();var W=this._input.read(w),L=h.get_directives(W);L&&L.ignore==="start"&&(W+=h.readIgnored(this._input)),this.print_string(W),this.eatWhitespace(!0),this._output.add_new_line()}else if(this._ch==="/"&&this._input.peek()==="/")this._output.space_before_token=!0,this._input.back(),this.print_string(this._input.read(x)),this.eatWhitespace(!0);else if(this._ch==="@")if(this.preserveSingleSpace(D),this._input.peek()==="{")this.print_string(this._ch+this.eatString("}"));else{this.print_string(this._ch);var k=this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);k.match(/[ :]$/)&&(k=this.eatString(": ").replace(/\s$/,""),this.print_string(k),this._output.space_before_token=!0),k=k.replace(/\s$/,""),k==="extend"?q=!0:k==="import"&&(S=!0),k in this.NESTED_AT_RULE?(this._nestedLevel+=1,k in this.CONDITIONAL_GROUP_RULE&&(T=!0)):!v&&B===0&&k.indexOf(":")!==-1&&(g=!0,this.indent())}else this._ch==="#"&&this._input.peek()==="{"?(this.preserveSingleSpace(D),this.print_string(this._ch+this.eatString("}"))):this._ch==="{"?(g&&(g=!1,this.outdent()),T?(T=!1,v=this._indentLevel>=this._nestedLevel):v=this._indentLevel>=this._nestedLevel-1,this._options.newline_between_rules&&v&&this._output.previous_line&&this._output.previous_line.item(-1)!=="{"&&this._output.ensure_empty_line_above("/",","),this._output.space_before_token=!0,this._options.brace_style==="expand"?(this._output.add_new_line(),this.print_string(this._ch),this.indent(),this._output.set_indent(this._indentLevel)):(this.indent(),this.print_string(this._ch)),this.eatWhitespace(!0),this._output.add_new_line()):this._ch==="}"?(this.outdent(),this._output.add_new_line(),U==="{"&&this._output.trim(!0),S=!1,q=!1,g&&(this.outdent(),g=!1),this.print_string(this._ch),v=!1,this._nestedLevel&&this._nestedLevel--,this.eatWhitespace(!0),this._output.add_new_line(),this._options.newline_between_rules&&!this._output.just_added_blankline()&&this._input.peek()!=="}"&&this._output.add_new_line(!0)):this._ch===":"?(v||T)&&!(this._input.lookBack("&")||this.foundNestedPseudoClass())&&!this._input.lookBack("(")&&!q&&B===0?(this.print_string(":"),g||(g=!0,this._output.space_before_token=!0,this.eatWhitespace(!0),this.indent())):(this._input.lookBack(" ")&&(this._output.space_before_token=!0),this._input.peek()===":"?(this._ch=this._input.next(),this.print_string("::")):this.print_string(":")):this._ch==='"'||this._ch==="'"?(this.preserveSingleSpace(D),this.print_string(this._ch+this.eatString(this._ch)),this.eatWhitespace(!0)):this._ch===";"?B===0?(g&&(this.outdent(),g=!1),q=!1,S=!1,this.print_string(this._ch),this.eatWhitespace(!0),this._input.peek()!=="/"&&this._output.add_new_line()):(this.print_string(this._ch),this.eatWhitespace(!0),this._output.space_before_token=!0):this._ch==="("?this._input.lookBack("url")?(this.print_string(this._ch),this.eatWhitespace(),B++,this.indent(),this._ch=this._input.next(),this._ch===")"||this._ch==='"'||this._ch==="'"?this._input.back():this._ch&&(this.print_string(this._ch+this.eatString(")")),B&&(B--,this.outdent()))):(this.preserveSingleSpace(D),this.print_string(this._ch),this.eatWhitespace(),B++,this.indent()):this._ch===")"?(B&&(B--,this.outdent()),this.print_string(this._ch)):this._ch===","?(this.print_string(this._ch),this.eatWhitespace(!0),this._options.selector_separator_newline&&!g&&B===0&&!S&&!q?this._output.add_new_line():this._output.space_before_token=!0):(this._ch===">"||this._ch==="+"||this._ch==="~")&&!g&&B===0?this._options.space_around_combinator?(this._output.space_before_token=!0,this.print_string(this._ch),this._output.space_before_token=!0):(this.print_string(this._ch),this.eatWhitespace(),this._ch&&b.test(this._ch)&&(this._ch="")):this._ch==="]"?this.print_string(this._ch):this._ch==="["?(this.preserveSingleSpace(D),this.print_string(this._ch)):this._ch==="="?(this.eatWhitespace(),this.print_string("="),b.test(this._ch)&&(this._ch="")):this._ch==="!"&&!this._input.lookBack("\\")?(this.print_string(" "),this.print_string(this._ch)):(this.preserveSingleSpace(D),this.print_string(this._ch));var R=this._output.get_code(C);return R},r.exports.Beautifier=_},function(r,s,a){var l=a(6).Options;function o(u){l.call(this,u,"css"),this.selector_separator_newline=this._get_boolean("selector_separator_newline",!0),this.newline_between_rules=this._get_boolean("newline_between_rules",!0);var c=this._get_boolean("space_around_selector_separator");this.space_around_combinator=this._get_boolean("space_around_combinator")||c;var h=this._get_selection_list("brace_style",["collapse","expand","end-expand","none","preserve-inline"]);this.brace_style="collapse";for(var f=0;f<h.length;f++)h[f]!=="expand"?this.brace_style="collapse":this.brace_style=h[f]}o.prototype=new l,r.exports.Options=o}],t={};function n(r){var s=t[r];if(s!==void 0)return s.exports;var a=t[r]={exports:{}};return e[r](a,a.exports,n),a.exports}var i=n(15);Go=i})();var sc=Go,$o;(function(){var e=[,,function(r){function s(o){this.__parent=o,this.__character_count=0,this.__indent_count=-1,this.__alignment_count=0,this.__wrap_point_index=0,this.__wrap_point_character_count=0,this.__wrap_point_indent_count=-1,this.__wrap_point_alignment_count=0,this.__items=[]}s.prototype.clone_empty=function(){var o=new s(this.__parent);return o.set_indent(this.__indent_count,this.__alignment_count),o},s.prototype.item=function(o){return o<0?this.__items[this.__items.length+o]:this.__items[o]},s.prototype.has_match=function(o){for(var u=this.__items.length-1;u>=0;u--)if(this.__items[u].match(o))return!0;return!1},s.prototype.set_indent=function(o,u){this.is_empty()&&(this.__indent_count=o||0,this.__alignment_count=u||0,this.__character_count=this.__parent.get_indent_size(this.__indent_count,this.__alignment_count))},s.prototype._set_wrap_point=function(){this.__parent.wrap_line_length&&(this.__wrap_point_index=this.__items.length,this.__wrap_point_character_count=this.__character_count,this.__wrap_point_indent_count=this.__parent.next_line.__indent_count,this.__wrap_point_alignment_count=this.__parent.next_line.__alignment_count)},s.prototype._should_wrap=function(){return this.__wrap_point_index&&this.__character_count>this.__parent.wrap_line_length&&this.__wrap_point_character_count>this.__parent.next_line.__character_count},s.prototype._allow_wrap=function(){if(this._should_wrap()){this.__parent.add_new_line();var o=this.__parent.current_line;return o.set_indent(this.__wrap_point_indent_count,this.__wrap_point_alignment_count),o.__items=this.__items.slice(this.__wrap_point_index),this.__items=this.__items.slice(0,this.__wrap_point_index),o.__character_count+=this.__character_count-this.__wrap_point_character_count,this.__character_count=this.__wrap_point_character_count,o.__items[0]===" "&&(o.__items.splice(0,1),o.__character_count-=1),!0}return!1},s.prototype.is_empty=function(){return this.__items.length===0},s.prototype.last=function(){return this.is_empty()?null:this.__items[this.__items.length-1]},s.prototype.push=function(o){this.__items.push(o);var u=o.lastIndexOf(`
`);u!==-1?this.__character_count=o.length-u:this.__character_count+=o.length},s.prototype.pop=function(){var o=null;return this.is_empty()||(o=this.__items.pop(),this.__character_count-=o.length),o},s.prototype._remove_indent=function(){this.__indent_count>0&&(this.__indent_count-=1,this.__character_count-=this.__parent.indent_size)},s.prototype._remove_wrap_indent=function(){this.__wrap_point_indent_count>0&&(this.__wrap_point_indent_count-=1)},s.prototype.trim=function(){for(;this.last()===" ";)this.__items.pop(),this.__character_count-=1},s.prototype.toString=function(){var o="";return this.is_empty()?this.__parent.indent_empty_lines&&(o=this.__parent.get_indent_string(this.__indent_count)):(o=this.__parent.get_indent_string(this.__indent_count,this.__alignment_count),o+=this.__items.join("")),o};function a(o,u){this.__cache=[""],this.__indent_size=o.indent_size,this.__indent_string=o.indent_char,o.indent_with_tabs||(this.__indent_string=new Array(o.indent_size+1).join(o.indent_char)),u=u||"",o.indent_level>0&&(u=new Array(o.indent_level+1).join(this.__indent_string)),this.__base_string=u,this.__base_string_length=u.length}a.prototype.get_indent_size=function(o,u){var c=this.__base_string_length;return u=u||0,o<0&&(c=0),c+=o*this.__indent_size,c+=u,c},a.prototype.get_indent_string=function(o,u){var c=this.__base_string;return u=u||0,o<0&&(o=0,c=""),u+=o*this.__indent_size,this.__ensure_cache(u),c+=this.__cache[u],c},a.prototype.__ensure_cache=function(o){for(;o>=this.__cache.length;)this.__add_column()},a.prototype.__add_column=function(){var o=this.__cache.length,u=0,c="";this.__indent_size&&o>=this.__indent_size&&(u=Math.floor(o/this.__indent_size),o-=u*this.__indent_size,c=new Array(u+1).join(this.__indent_string)),o&&(c+=new Array(o+1).join(" ")),this.__cache.push(c)};function l(o,u){this.__indent_cache=new a(o,u),this.raw=!1,this._end_with_newline=o.end_with_newline,this.indent_size=o.indent_size,this.wrap_line_length=o.wrap_line_length,this.indent_empty_lines=o.indent_empty_lines,this.__lines=[],this.previous_line=null,this.current_line=null,this.next_line=new s(this),this.space_before_token=!1,this.non_breaking_space=!1,this.previous_token_wrapped=!1,this.__add_outputline()}l.prototype.__add_outputline=function(){this.previous_line=this.current_line,this.current_line=this.next_line.clone_empty(),this.__lines.push(this.current_line)},l.prototype.get_line_number=function(){return this.__lines.length},l.prototype.get_indent_string=function(o,u){return this.__indent_cache.get_indent_string(o,u)},l.prototype.get_indent_size=function(o,u){return this.__indent_cache.get_indent_size(o,u)},l.prototype.is_empty=function(){return!this.previous_line&&this.current_line.is_empty()},l.prototype.add_new_line=function(o){return this.is_empty()||!o&&this.just_added_newline()?!1:(this.raw||this.__add_outputline(),!0)},l.prototype.get_code=function(o){this.trim(!0);var u=this.current_line.pop();u&&(u[u.length-1]===`
`&&(u=u.replace(/\n+$/g,"")),this.current_line.push(u)),this._end_with_newline&&this.__add_outputline();var c=this.__lines.join(`
`);return o!==`
...
You passed in: '`+this.raw_options[o]+"'");return h[0]},s.prototype._get_selection_list=function(o,u,c){if(!u||u.length===0)throw new Error("Selection list cannot be empty.");if(c=c||[u[0]],!this._is_valid_selection(c,u))throw new Error("Invalid Default Value!");var h=this._get_array(o,c);if(!this._is_valid_selection(h,u))throw new Error("Invalid Option Value: The option '"+o+`' can contain only the following values:
`+u+`
You passed in: '`+this.raw_options[o]+"'");return h},s.prototype._is_valid_selection=function(o,u){return o.length&&u.length&&!o.some(function(c){return u.indexOf(c)===-1})};function a(o,u){var c={};o=l(o);var h;for(h in o)h!==u&&(c[h]=o[h]);if(u&&o[u])for(h in o[u])c[h]=o[u][h];return c}function l(o){var u={},c;for(c in o){var h=c.replace(/-/g,"_");u[h]=o[c]}return u}r.exports.Options=s,r.exports.normalizeOpts=l,r.exports.mergeOpts=a},,function(r){var s=RegExp.prototype.hasOwnProperty("sticky");function a(l){this.__input=l||"",this.__input_length=this.__input.length,this.__position=0}a.prototype.restart=function(){this.__position=0},a.prototype.back=function(){this.__position>0&&(this.__position-=1)},a.prototype.hasNext=function(){return this.__position<this.__input_length},a.prototype.next=function(){var l=null;return this.hasNext()&&(l=this.__input.charAt(this.__position),this.__position+=1),l},a.prototype.peek=function(l){var o=null;return l=l||0,l+=this.__position,l>=0&&l<this.__input_length&&(o=this.__input.charAt(l)),o},a.prototype.__match=function(l,o){l.lastIndex=o;var u=l.exec(this.__input);return u&&!(s&&l.sticky)&&u.index!==o&&(u=null),u},a.prototype.test=function(l,o){return o=o||0,o+=this.__position,o>=0&&o<this.__input_length?!!this.__match(l,o):!1},a.prototype.testChar=function(l,o){var u=this.peek(o);return l.lastIndex=0,u!==null&&l.test(u)},a.prototype.match=function(l){var o=this.__match(l,this.__position);return o?this.__position+=o[0].length:o=null,o},a.prototype.read=function(l,o,u){var c="",h;return l&&(h=this.match(l),h&&(c+=h[0])),o&&(h||!l)&&(c+=this.readUntil(o,u)),c},a.prototype.readUntil=function(l,o){var u="",c=this.__position;l.lastIndex=this.__position;var h=l.exec(this.__input);return h?(c=h.index,o&&(c+=h[0].length)):c=this.__input_length,u=this.__input.substring(this.__position,c),this.__position=c,u},a.prototype.readUntilAfter=function(l){return this.readUntil(l,!0)},a.prototype.get_regexp=function(l,o){var u=null,c="g";return o&&s&&(c="y"),typeof l=="string"&&l!==""?u=new RegExp(l,c):l&&(u=new RegExp(l.source,c)),u},a.prototype.get_literal_regexp=function(l){return RegExp(l.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"))},a.prototype.peekUntilAfter=function(l){var o=this.__position,u=this.readUntilAfter(l);return this.__position=o,u},a.prototype.lookBack=function(l){var o=this.__position-1;return o>=l.length&&this.__input.substring(o-l.length,o).toLowerCase()===l},r.exports.InputScanner=a},function(r,s,a){var l=a(8).InputScanner,o=a(3).Token,u=a(10).TokenStream,c=a(11).WhitespacePattern,h={START:"TK_START",RAW:"TK_RAW",EOF:"TK_EOF"},f=function(m,b){this._input=new l(m),this._options=b||{},this.__tokens=null,this._patterns={},this._patterns.whitespace=new c(this._input)};f.prototype.tokenize=function(){this._input.restart(),this.__tokens=new u,this._reset();for(var m,b=new o(h.START,""),p=null,w=[],x=new u;b.type!==h.EOF;){for(m=this._get_next_token(b,p);this._is_comment(m);)x.add(m),m=this._get_next_token(b,p);x.isEmpty()||(m.comments_before=x,x=new u),m.parent=p,this._is_opening(m)?(w.push(p),p=m):p&&this._is_closing(m,p)&&(m.opened=p,p.closed=m,p=w.pop(),m.parent=p),m.previous=b,b.next=m,this.__tokens.add(m),b=m}return this.__tokens},f.prototype._is_first_token=function(){return this.__tokens.isEmpty()},f.prototype._reset=function(){},f.prototype._get_next_token=function(m,b){this._readWhitespace();var p=this._input.read(/.+/g);return p?this._create_token(h.RAW,p):this._create_token(h.EOF,"")},f.prototype._is_comment=function(m){return!1},f.prototype._is_opening=function(m){return!1},f.prototype._is_closing=function(m,b){return!1},f.prototype._create_token=function(m,b){var p=new o(m,b,this._patterns.whitespace.newline_count,this._patterns.whitespace.whitespace_before_token);return p},f.prototype._readWhitespace=function(){return this._patterns.whitespace.read()},r.exports.Tokenizer=f,r.exports.TOKEN=h},function(r){function s(a){this.__tokens=[],this.__tokens_length=this.__tokens.length,this.__position=0,this.__parent_token=a}s.prototype.restart=function(){this.__position=0},s.prototype.isEmpty=function(){return this.__tokens_length===0},s.prototype.hasNext=function(){return this.__position<this.__tokens_length},s.prototype.next=function(){var a=null;return this.hasNext()&&(a=this.__tokens[this.__position],this.__position+=1),a},s.prototype.peek=function(a){var l=null;return a=a||0,a+=this.__position,a>=0&&a<this.__tokens_length&&(l=this.__tokens[a]),l},s.prototype.add=function(a){this.__parent_token&&(a.parent=this.__parent_token),this.__tokens.push(a),this.__tokens_length+=1},r.exports.TokenStream=s},function(r,s,a){var l=a(12).Pattern;function o(u,c){l.call(this,u,c),c?this._line_regexp=this._input.get_regexp(c._line_regexp):this.__set_whitespace_patterns("",""),this.newline_count=0,this.whitespace_before_token=""}o.prototype=new l,o.prototype.__set_whitespace_patterns=function(u,c){u+="\\t ",c+="\\n\\r",this._match_pattern=this._input.get_regexp("["+u+c+"]+",!0),this._newline_regexp=this._input.get_regexp("\\r\\n|["+c+"]")},o.prototype.read=function(){this.newline_count=0,this.whitespace_before_token="";var u=this._input.read(this._match_pattern);if(u===" ")this.whitespace_before_token=" ";else if(u){var c=this.__split(this._newline_regexp,u);this.newline_count=c.length-1,this.whitespace_before_token=c[this.newline_count]}return u},o.prototype.matching=function(u,c){var h=this._create();return h.__set_whitespace_patterns(u,c),h._update(),h},o.prototype._create=function(){return new o(this._input,this)},o.prototype.__split=function(u,c){u.lastIndex=0;for(var h=0,f=[],m=u.exec(c);m;)f.push(c.substring(h,m.index)),h=m.index+m[0].length,m=u.exec(c);return h<c.length?f.push(c.substring(h,c.length)):f.push(""),f},r.exports.WhitespacePattern=o},function(r){function s(a,l){this._input=a,this._starting_pattern=null,this._match_pattern=null,this._until_pattern=null,this._until_after=!1,l&&(this._starting_pattern=this._input.get_regexp(l._starting_pattern,!0),this._match_pattern=this._input.get_regexp(l._match_pattern,!0),this._until_pattern=this._input.get_regexp(l._until_pattern),this._until_after=l._until_after)}s.prototype.read=function(){var a=this._input.read(this._starting_pattern);return(!this._starting_pattern||a)&&(a+=this._input.read(this._match_pattern,this._until_pattern,this._until_after)),a},s.prototype.read_match=function(){return this._input.match(this._match_pattern)},s.prototype.until_after=function(a){var l=this._create();return l._until_after=!0,l._until_pattern=this._input.get_regexp(a),l._update(),l},s.prototype.until=function(a){var l=this._create();return l._until_after=!1,l._until_pattern=this._input.get_regexp(a),l._update(),l},s.prototype.starting_with=function(a){var l=this._create();return l._starting_pattern=this._input.get_regexp(a,!0),l._update(),l},s.prototype.matching=function(a){var l=this._create();return l._match_pattern=this._input.get_regexp(a,!0),l._update(),l},s.prototype._create=function(){return new s(this._input,this)},s.prototype._update=function(){},r.exports.Pattern=s},function(r){function s(a,l){a=typeof a=="string"?a:a.source,l=typeof l=="string"?l:l.source,this.__directives_block_pattern=new RegExp(a+/ beautify( \w+[:]\w+)+ /.source+l,"g"),this.__directive_pattern=/ (\w+)[:](\w+)/g,this.__directives_end_ignore_pattern=new RegExp(a+/\sbeautify\signore:end\s/.source+l,"g")}s.prototype.get_directives=function(a){if(!a.match(this.__directives_block_pattern))return null;var l={};this.__directive_pattern.lastIndex=0;for(var o=this.__directive_pattern.exec(a);o;)l[o[1]]=o[2],o=this.__directive_pattern.exec(a);return l},s.prototype.readIgnored=function(a){return a.readUntilAfter(this.__directives_end_ignore_pattern)},r.exports.Directives=s},function(r,s,a){var l=a(12).Pattern,o={django:!1,erb:!1,handlebars:!1,php:!1,smarty:!1};function u(c,h){l.call(this,c,h),this.__template_pattern=null,this._disabled=Object.assign({},o),this._excluded=Object.assign({},o),h&&(this.__template_pattern=this._input.get_regexp(h.__template_pattern),this._excluded=Object.assign(this._excluded,h._excluded),this._disabled=Object.assign(this._disabled,h._disabled));var f=new l(c);this.__patterns={handlebars_comment:f.starting_with(/{{!--/).until_after(/--}}/),handlebars_unescaped:f.starting_with(/{{{/).until_after(/}}}/),handlebars:f.starting_with(/{{/).until_after(/}}/),php:f.starting_with(/<\?(?:[= ]|php)/).until_after(/\?>/),erb:f.starting_with(/<%[^%]/).until_after(/[^%]%>/),django:f.starting_with(/{%/).until_after(/%}/),django_value:f.starting_with(/{{/).until_after(/}}/),django_comment:f.starting_with(/{#/).until_after(/#}/),smarty:f.starting_with(/{(?=[^}{\s\n])/).until_after(/[^\s\n]}/),smarty_comment:f.starting_with(/{\*/).until_after(/\*}/),smarty_literal:f.starting_with(/{literal}/).until_after(/{\/literal}/)}}u.prototype=new l,u.prototype._create=function(){return new u(this._input,this)},u.prototype._update=function(){this.__set_templated_pattern()},u.prototype.disable=function(c){var h=this._create();return h._disabled[c]=!0,h._update(),h},u.prototype.read_options=function(c){var h=this._create();for(var f in o)h._disabled[f]=c.templating.indexOf(f)===-1;return h._update(),h},u.prototype.exclude=function(c){var h=this._create();return h._excluded[c]=!0,h._update(),h},u.prototype.read=function(){var c="";this._match_pattern?c=this._input.read(this._starting_pattern):c=this._input.read(this._starting_pattern,this.__template_pattern);for(var h=this._read_template();h;)this._match_pattern?h+=this._input.read(this._match_pattern):h+=this._input.readUntil(this.__template_pattern),c+=h,h=this._read_template();return this._until_after&&(c+=this._input.readUntilAfter(this._until_pattern)),c},u.prototype.__set_templated_pattern=function(){var c=[];this._disabled.php||c.push(this.__patterns.php._starting_pattern.source),this._disabled.handlebars||c.push(this.__patterns.handlebars._starting_pattern.source),this._disabled.erb||c.push(this.__patterns.erb._starting_pattern.source),this._disabled.django||(c.push(this.__patterns.django._starting_pattern.source),c.push(this.__patterns.django_value._starting_pattern.source),c.push(this.__patterns.django_comment._starting_pattern.source)),this._disabled.smarty||c.push(this.__patterns.smarty._starting_pattern.source),this._until_pattern&&c.push(this._until_pattern.source),this.__template_pattern=this._input.get_regexp("(?:"+c.join("|")+")")},u.prototype._read_template=function(){var c="",h=this._input.peek();if(h==="<"){var f=this._input.peek(1);!this._disabled.php&&!this._excluded.php&&f==="?"&&(c=c||this.__patterns.php.read()),!this._disabled.erb&&!this._excluded.erb&&f==="%"&&(c=c||this.__patterns.erb.read())}else h==="{"&&(!this._disabled.handlebars&&!this._excluded.handlebars&&(c=c||this.__patterns.handlebars_comment.read(),c=c||this.__patterns.handlebars_unescaped.read(),c=c||this.__patterns.handlebars.read()),this._disabled.django||(!this._excluded.django&&!this._excluded.handlebars&&(c=c||this.__patterns.django_value.read()),this._excluded.django||(c=c||this.__patterns.django_comment.read(),c=c||this.__patterns.django.read())),this._disabled.smarty||this._disabled.django&&this._disabled.handlebars&&(c=c||this.__patterns.smarty_comment.read(),c=c||this.__patterns.smarty_literal.read(),c=c||this.__patterns.smarty.read()));return c},r.exports.TemplatablePattern=u},,,,function(r,s,a){var l=a(19).Beautifier,o=a(20).Options;function u(c,h,f,m){var b=new l(c,h,f,m);return b.beautify()}r.exports=u,r.exports.defaultOptions=function(){return new o}},function(r,s,a){var l=a(20).Options,o=a(2).Output,u=a(21).Tokenizer,c=a(21).TOKEN,h=/\r\n|[\r\n]/,f=/\r\n|[\r\n]/g,m=function(v,g){this.indent_level=0,this.alignment_size=0,this.max_preserve_newlines=v.max_preserve_newlines,this.preserve_newlines=v.preserve_newlines,this._output=new o(v,g)};m.prototype.current_line_has_match=function(v){return this._output.current_line.has_match(v)},m.prototype.set_space_before_token=function(v,g){this._output.space_before_token=v,this._output.non_breaking_space=g},m.prototype.set_wrap_point=function(){this._output.set_indent(this.indent_level,this.alignment_size),this._output.set_wrap_point()},m.prototype.add_raw_token=function(v){this._output.add_raw_token(v)},m.prototype.print_preserved_newlines=function(v){var g=0;v.type!==c.TEXT&&v.previous.type!==c.TEXT&&(g=v.newlines?1:0),this.preserve_newlines&&(g=v.newlines<this.max_preserve_newlines+1?v.newlines:this.max_preserve_newlines+1);for(var T=0;T<g;T++)this.print_newline(T>0);return g!==0},m.prototype.traverse_whitespace=function(v){return v.whitespace_before||v.newlines?(this.print_preserved_newlines(v)||(this._output.space_before_token=!0),!0):!1},m.prototype.previous_token_wrapped=function(){return this._output.previous_token_wrapped},m.prototype.print_newline=function(v){this._output.add_new_line(v)},m.prototype.print_token=function(v){v.text&&(this._output.set_indent(this.indent_level,this.alignment_size),this._output.add_token(v.text))},m.prototype.indent=function(){this.indent_level++},m.prototype.get_full_indent=function(v){return v=this.indent_level+(v||0),v<1?"":this._output.get_indent_string(v)};var b=function(v){for(var g=null,T=v.next;T.type!==c.EOF&&v.closed!==T;){if(T.type===c.ATTRIBUTE&&T.text==="type"){T.next&&T.next.type===c.EQUALS&&T.next.next&&T.next.next.type===c.VALUE&&(g=T.next.next.text);break}T=T.next}return g},p=function(v,g){var T=null,q=null;return g.closed?(v==="script"?T="text/javascript":v==="style"&&(T="text/css"),T=b(g)||T,T.search("text/css")>-1?q="css":T.search(/module|((text|application|dojo)\/(x-)?(javascript|ecmascript|jscript|livescript|(ld\+)?json|method|aspect))/)>-1?q="javascript":T.search(/(text|application|dojo)\/(x-)?(html)/)>-1?q="html":T.search(/test\/null/)>-1&&(q="null"),q):null};function w(v,g){return g.indexOf(v)!==-1}function x(v,g,T){this.parent=v||null,this.tag=g?g.tag_name:"",this.indent_level=T||0,this.parser_token=g||null}function _(v){this._printer=v,this._current_frame=null}_.prototype.get_parser_token=function(){return this._current_frame?this._current_frame.parser_token:null},_.prototype.record_tag=function(v){var g=new x(this._current_frame,v,this._printer.indent_level);this._current_frame=g},_.prototype._try_pop_frame=function(v){var g=null;return v&&(g=v.parser_token,this._printer.indent_level=v.indent_level,this._current_frame=v.parent),g},_.prototype._get_frame=function(v,g){for(var T=this._current_frame;T&&v.indexOf(T.tag)===-1;){if(g&&g.indexOf(T.tag)!==-1){T=null;break}T=T.parent}return T},_.prototype.try_pop=function(v,g){var T=this._get_frame([v],g);return this._try_pop_frame(T)},_.prototype.indent_to_tag=function(v){var g=this._get_frame(v);g&&(this._printer.indent_level=g.indent_level)};function y(v,g,T,q){this._source_text=v||"",g=g||{},this._js_beautify=T,this._css_beautify=q,this._tag_stack=null;var S=new l(g,"html");this._options=S,this._is_wrap_attributes_force=this._options.wrap_attributes.substr(0,5)==="force",this._is_wrap_attributes_force_expand_multiline=this._options.wrap_attributes==="force-expand-multiline",this._is_wrap_attributes_force_aligned=this._options.wrap_attributes==="force-aligned",this._is_wrap_attributes_aligned_multiple=this._options.wrap_attributes==="aligned-multiple",this._is_wrap_attributes_preserve=this._options.wrap_attributes.substr(0,8)==="preserve",this._is_wrap_attributes_preserve_aligned=this._options.wrap_attributes==="preserve-aligned"}y.prototype.beautify=function(){if(this._options.disabled)return this._source_text;var v=this._source_text,g=this._options.eol;this._options.eol==="auto"&&(g=`
`,v&&h.test(v)&&(g=v.match(h)[0])),v=v.replace(f,`
`);var T=v.match(/^[\t ]*/)[0],q={text:"",type:""},S=new C,A=new m(this._options,T),N=new u(v,this._options).tokenize();this._tag_stack=new _(A);for(var D=null,U=N.next();U.type!==c.EOF;)U.type===c.TAG_OPEN||U.type===c.COMMENT?(D=this._handle_tag_open(A,U,S,q),S=D):U.type===c.ATTRIBUTE||U.type===c.EQUALS||U.type===c.VALUE||U.type===c.TEXT&&!S.tag_complete?D=this._handle_inside_tag(A,U,S,N):U.type===c.TAG_CLOSE?D=this._handle_tag_close(A,U,S):U.type===c.TEXT?D=this._handle_text(A,U,S):A.add_raw_token(U),q=D,U=N.next();var W=A._output.get_code(g);return W},y.prototype._handle_tag_close=function(v,g,T){var q={text:g.text,type:g.type};return v.alignment_size=0,T.tag_complete=!0,v.set_space_before_token(g.newlines||g.whitespace_before!=="",!0),T.is_unformatted?v.add_raw_token(g):(T.tag_start_char==="<"&&(v.set_space_before_token(g.text[0]==="/",!0),this._is_wrap_attributes_force_expand_multiline&&T.has_wrapped_attrs&&v.print_newline(!1)),v.print_token(g)),T.indent_content&&!(T.is_unformatted||T.is_content_unformatted)&&(v.indent(),T.indent_content=!1),!T.is_inline_element&&!(T.is_unformatted||T.is_content_unformatted)&&v.set_wrap_point(),q},y.prototype._handle_inside_tag=function(v,g,T,q){var S=T.has_wrapped_attrs,A={text:g.text,type:g.type};if(v.set_space_before_token(g.newlines||g.whitespace_before!=="",!0),T.is_unformatted)v.add_raw_token(g);else if(T.tag_start_char==="{"&&g.type===c.TEXT)v.print_preserved_newlines(g)?(g.newlines=0,v.add_raw_token(g)):v.print_token(g);else{if(g.type===c.ATTRIBUTE?(v.set_space_before_token(!0),T.attr_count+=1):(g.type===c.EQUALS||g.type===c.VALUE&&g.previous.type===c.EQUALS)&&v.set_space_before_token(!1),g.type===c.ATTRIBUTE&&T.tag_start_char==="<"&&((this._is_wrap_attributes_preserve||this._is_wrap_attributes_preserve_aligned)&&(v.traverse_whitespace(g),S=S||g.newlines!==0),this._is_wrap_attributes_force)){var N=T.attr_count>1;if(this._is_wrap_attributes_force_expand_multiline&&T.attr_count===1){var D=!0,U=0,W;do{if(W=q.peek(U),W.type===c.ATTRIBUTE){D=!1;break}U+=1}while(U<4&&W.type!==c.EOF&&W.type!==c.TAG_CLOSE);N=!D}N&&(v.print_newline(!1),S=!0)}v.print_token(g),S=S||v.previous_token_wrapped(),T.has_wrapped_attrs=S}return A},y.prototype._handle_text=function(v,g,T){var q={text:g.text,type:"TK_CONTENT"};return T.custom_beautifier_name?this._print_custom_beatifier_text(v,g,T):T.is_unformatted||T.is_content_unformatted?v.add_raw_token(g):(v.traverse_whitespace(g),v.print_token(g)),q},y.prototype._print_custom_beatifier_text=function(v,g,T){var q=this;if(g.text!==""){var S=g.text,A,N=1,D="",U="";T.custom_beautifier_name==="javascript"&&typeof this._js_beautify=="function"?A=this._js_beautify:T.custom_beautifier_name==="css"&&typeof this._css_beautify=="function"?A=this._css_beautify:T.custom_beautifier_name==="html"&&(A=function(I,z){var P=new y(I,z,q._js_beautify,q._css_beautify);return P.beautify()}),this._options.indent_scripts==="keep"?N=0:this._options.indent_scripts==="separate"&&(N=-v.indent_level);var W=v.get_full_indent(N);if(S=S.replace(/\n[ \t]*$/,""),T.custom_beautifier_name!=="html"&&S[0]==="<"&&S.match(/^(<!--|<!\[CDATA\[)/)){var L=/^(<!--[^\n]*|<!\[CDATA\[)(\n?)([ \t\n]*)([\s\S]*)(-->|]]>)$/.exec(S);if(!L){v.add_raw_token(g);return}D=W+L[1]+`
`,S=L[4],L[5]&&(U=W+L[5]),S=S.replace(/\n[ \t]*$/,""),(L[2]||L[3].indexOf(`
`)!==-1)&&(L=L[3].match(/[ \t]+$/),L&&(g.whitespace_before=L[0]))}if(S)if(A){var k=function(){this.eol=`
`};k.prototype=this._options.raw_options;var R=new k;S=A(W+S,R)}else{var H=g.whitespace_before;H&&(S=S.replace(new RegExp(`
(`+H+")?","g"),`
`)),S=W+S.replace(/\n/g,`
`+W)}D&&(S?S=D+S+`
`+U:S=D+U),v.print_newline(!1),S&&(g.text=S,g.whitespace_before="",g.newlines=0,v.add_raw_token(g),v.print_newline(!0))}},y.prototype._handle_tag_open=function(v,g,T,q){var S=this._get_tag_open_token(g);return(T.is_unformatted||T.is_content_unformatted)&&!T.is_empty_element&&g.type===c.TAG_OPEN&&g.text.indexOf("</")===0?(v.add_raw_token(g),S.start_tag_token=this._tag_stack.try_pop(S.tag_name)):(v.traverse_whitespace(g),this._set_tag_position(v,g,S,T,q),S.is_inline_element||v.set_wrap_point(),v.print_token(g)),(this._is_wrap_attributes_force_aligned||this._is_wrap_attributes_aligned_multiple||this._is_wrap_attributes_preserve_aligned)&&(S.alignment_size=g.text.length+1),!S.tag_complete&&!S.is_unformatted&&(v.alignment_size=S.alignment_size),S};var C=function(v,g){if(this.parent=v||null,this.text="",this.type="TK_TAG_OPEN",this.tag_name="",this.is_inline_element=!1,this.is_unformatted=!1,this.is_content_unformatted=!1,this.is_empty_element=!1,this.is_start_tag=!1,this.is_end_tag=!1,this.indent_content=!1,this.multiline_content=!1,this.custom_beautifier_name=null,this.start_tag_token=null,this.attr_count=0,this.has_wrapped_attrs=!1,this.alignment_size=0,this.tag_complete=!1,this.tag_start_char="",this.tag_check="",!g)this.tag_complete=!0;else{var T;this.tag_start_char=g.text[0],this.text=g.text,this.tag_start_char==="<"?(T=g.text.match(/^<([^\s>]*)/),this.tag_check=T?T[1]:""):(T=g.text.match(/^{{(?:[\^]|#\*?)?([^\s}]+)/),this.tag_check=T?T[1]:"",g.text==="{{#>"&&this.tag_check===">"&&g.next!==null&&(this.tag_check=g.next.text)),this.tag_check=this.tag_check.toLowerCase(),g.type===c.COMMENT&&(this.tag_complete=!0),this.is_start_tag=this.tag_check.charAt(0)!=="/",this.tag_name=this.is_start_tag?this.tag_check:this.tag_check.substr(1),this.is_end_tag=!this.is_start_tag||g.closed&&g.closed.text==="/>",this.is_end_tag=this.is_end_tag||this.tag_start_char==="{"&&(this.text.length<3||/[^#\^]/.test(this.text.charAt(2)))}};y.prototype._get_tag_open_token=function(v){var g=new C(this._tag_stack.get_parser_token(),v);return g.alignment_size=this._options.wrap_attributes_indent_size,g.is_end_tag=g.is_end_tag||w(g.tag_check,this._options.void_elements),g.is_empty_element=g.tag_complete||g.is_start_tag&&g.is_end_tag,g.is_unformatted=!g.tag_complete&&w(g.tag_check,this._options.unformatted),g.is_content_unformatted=!g.is_empty_element&&w(g.tag_check,this._options.content_unformatted),g.is_inline_element=w(g.tag_name,this._options.inline)||g.tag_start_char==="{",g},y.prototype._set_tag_position=function(v,g,T,q,S){if(T.is_empty_element||(T.is_end_tag?T.start_tag_token=this._tag_stack.try_pop(T.tag_name):(this._do_optional_end_element(T)&&(T.is_inline_element||v.print_newline(!1)),this._tag_stack.record_tag(T),(T.tag_name==="script"||T.tag_name==="style")&&!(T.is_unformatted||T.is_content_unformatted)&&(T.custom_beautifier_name=p(T.tag_check,g)))),w(T.tag_check,this._options.extra_liners)&&(v.print_newline(!1),v._output.just_added_blankline()||v.print_newline(!0)),T.is_empty_element){if(T.tag_start_char==="{"&&T.tag_check==="else"){this._tag_stack.indent_to_tag(["if","unless","each"]),T.indent_content=!0;var A=v.current_line_has_match(/{{#if/);A||v.print_newline(!1)}T.tag_name==="!--"&&S.type===c.TAG_CLOSE&&q.is_end_tag&&T.text.indexOf(`
`)===-1||(T.is_inline_element||T.is_unformatted||v.print_newline(!1),this._calcluate_parent_multiline(v,T))}else if(T.is_end_tag){var N=!1;N=T.start_tag_token&&T.start_tag_token.multiline_content,N=N||!T.is_inline_element&&!(q.is_inline_element||q.is_unformatted)&&!(S.type===c.TAG_CLOSE&&T.start_tag_token===q)&&S.type!=="TK_CONTENT",(T.is_content_unformatted||T.is_unformatted)&&(N=!1),N&&v.print_newline(!1)}else T.indent_content=!T.custom_beautifier_name,T.tag_start_char==="<"&&(T.tag_name==="html"?T.indent_content=this._options.indent_inner_html:T.tag_name==="head"?T.indent_content=this._options.indent_head_inner_html:T.tag_name==="body"&&(T.indent_content=this._options.indent_body_inner_html)),!(T.is_inline_element||T.is_unformatted)&&(S.type!=="TK_CONTENT"||T.is_content_unformatted)&&v.print_newline(!1),this._calcluate_parent_multiline(v,T)},y.prototype._calcluate_parent_multiline=function(v,g){g.parent&&v._output.just_added_newline()&&!((g.is_inline_element||g.is_unformatted)&&g.parent.is_inline_element)&&(g.parent.multiline_content=!0)};var E=["address","article","aside","blockquote","details","div","dl","fieldset","figcaption","figure","footer","form","h1","h2","h3","h4","h5","h6","header","hr","main","nav","ol","p","pre","section","table","ul"],B=["a","audio","del","ins","map","noscript","video"];y.prototype._do_optional_end_element=function(v){var g=null;if(!(v.is_empty_element||!v.is_start_tag||!v.parent)){if(v.tag_name==="body")g=g||this._tag_stack.try_pop("head");else if(v.tag_name==="li")g=g||this._tag_stack.try_pop("li",["ol","ul"]);else if(v.tag_name==="dd"||v.tag_name==="dt")g=g||this._tag_stack.try_pop("dt",["dl"]),g=g||this._tag_stack.try_pop("dd",["dl"]);else if(v.parent.tag_name==="p"&&E.indexOf(v.tag_name)!==-1){var T=v.parent.parent;(!T||B.indexOf(T.tag_name)===-1)&&(g=g||this._tag_stack.try_pop("p"))}else v.tag_name==="rp"||v.tag_name==="rt"?(g=g||this._tag_stack.try_pop("rt",["ruby","rtc"]),g=g||this._tag_stack.try_pop("rp",["ruby","rtc"])):v.tag_name==="optgroup"?g=g||this._tag_stack.try_pop("optgroup",["select"]):v.tag_name==="option"?g=g||this._tag_stack.try_pop("option",["select","datalist","optgroup"]):v.tag_name==="colgroup"?g=g||this._tag_stack.try_pop("caption",["table"]):v.tag_name==="thead"?(g=g||this._tag_stack.try_pop("caption",["table"]),g=g||this._tag_stack.try_pop("colgroup",["table"])):v.tag_name==="tbody"||v.tag_name==="tfoot"?(g=g||this._tag_stack.try_pop("caption",["table"]),g=g||this._tag_stack.try_pop("colgroup",["table"]),g=g||this._tag_stack.try_pop("thead",["table"]),g=g||this._tag_stack.try_pop("tbody",["table"])):v.tag_name==="tr"?(g=g||this._tag_stack.try_pop("caption",["table"]),g=g||this._tag_stack.try_pop("colgroup",["table"]),g=g||this._tag_stack.try_pop("tr",["table","thead","tbody","tfoot"])):(v.tag_name==="th"||v.tag_name==="td")&&(g=g||this._tag_stack.try_pop("td",["table","thead","tbody","tfoot","tr"]),g=g||this._tag_stack.try_pop("th",["table","thead","tbody","tfoot","tr"]));return v.parent=this._tag_stack.get_parser_token(),g}},r.exports.Beautifier=y},function(r,s,a){var l=a(6).Options;function o(u){l.call(this,u,"html"),this.templating.length===1&&this.templating[0]==="auto"&&(this.templating=["django","erb","handlebars","php"]),this.indent_inner_html=this._get_boolean("indent_inner_html"),this.indent_body_inner_html=this._get_boolean("indent_body_inner_html",!0),this.indent_head_inner_html=this._get_boolean("indent_head_inner_html",!0),this.indent_handlebars=this._get_boolean("indent_handlebars",!0),this.wrap_attributes=this._get_selection("wrap_attributes",["auto","force","force-aligned","force-expand-multiline","aligned-multiple","preserve","preserve-aligned"]),this.wrap_attributes_indent_size=this._get_number("wrap_attributes_indent_size",this.indent_size),this.extra_liners=this._get_array("extra_liners",["head","body","/html"]),this.inline=this._get_array("inline",["a","abbr","area","audio","b","bdi","bdo","br","button","canvas","cite","code","data","datalist","del","dfn","em","embed","i","iframe","img","input","ins","kbd","keygen","label","map","mark","math","meter","noscript","object","output","progress","q","ruby","s","samp","select","small","span","strong","sub","sup","svg","template","textarea","time","u","var","video","wbr","text","acronym","big","strike","tt"]),this.void_elements=this._get_array("void_elements",["area","base","br","col","embed","hr","img","input","keygen","link","menuitem","meta","param","source","track","wbr","!doctype","?xml","basefont","isindex"]),this.unformatted=this._get_array("unformatted",[]),this.content_unformatted=this._get_array("content_unformatted",["pre","textarea"]),this.unformatted_content_delimiter=this._get_characters("unformatted_content_delimiter"),this.indent_scripts=this._get_selection("indent_scripts",["normal","keep","separate"])}o.prototype=new l,r.exports.Options=o},function(r,s,a){var l=a(9).Tokenizer,o=a(9).TOKEN,u=a(13).Directives,c=a(14).TemplatablePattern,h=a(12).Pattern,f={TAG_OPEN:"TK_TAG_OPEN",TAG_CLOSE:"TK_TAG_CLOSE",ATTRIBUTE:"TK_ATTRIBUTE",EQUALS:"TK_EQUALS",VALUE:"TK_VALUE",COMMENT:"TK_COMMENT",TEXT:"TK_TEXT",UNKNOWN:"TK_UNKNOWN",START:o.START,RAW:o.RAW,EOF:o.EOF},m=new u(/<\!--/,/-->/),b=function(p,w){l.call(this,p,w),this._current_tag_name="";var x=new c(this._input).read_options(this._options),_=new h(this._input);if(this.__patterns={word:x.until(/[\n\r\t <]/),single_quote:x.until_after(/'/),double_quote:x.until_after(/"/),attribute:x.until(/[\n\r\t =>]|\/>/),element_name:x.until(/[\n\r\t >\/]/),handlebars_comment:_.starting_with(/{{!--/).until_after(/--}}/),handlebars:_.starting_with(/{{/).until_after(/}}/),handlebars_open:_.until(/[\n\r\t }]/),handlebars_raw_close:_.until(/}}/),comment:_.starting_with(/<!--/).until_after(/-->/),cdata:_.starting_with(/<!\[CDATA\[/).until_after(/]]>/),conditional_comment:_.starting_with(/<!\[/).until_after(/]>/),processing:_.starting_with(/<\?/).until_after(/\?>/)},this._options.indent_handlebars&&(this.__patterns.word=this.__patterns.word.exclude("handlebars")),this._unformatted_content_delimiter=null,this._options.unformatted_content_delimiter){var y=this._input.get_literal_regexp(this._options.unformatted_content_delimiter);this.__patterns.unformatted_content_delimiter=_.matching(y).until_after(y)}};b.prototype=new l,b.prototype._is_comment=function(p){return!1},b.prototype._is_opening=function(p){return p.type===f.TAG_OPEN},b.prototype._is_closing=function(p,w){return p.type===f.TAG_CLOSE&&w&&((p.text===">"||p.text==="/>")&&w.text[0]==="<"||p.text==="}}"&&w.text[0]==="{"&&w.text[1]==="{")},b.prototype._reset=function(){this._current_tag_name=""},b.prototype._get_next_token=function(p,w){var x=null;this._readWhitespace();var _=this._input.peek();return _===null?this._create_token(f.EOF,""):(x=x||this._read_open_handlebars(_,w),x=x||this._read_attribute(_,p,w),x=x||this._read_close(_,w),x=x||this._read_raw_content(_,p,w),x=x||this._read_content_word(_),x=x||this._read_comment_or_cdata(_),x=x||this._read_processing(_),x=x||this._read_open(_,w),x=x||this._create_token(f.UNKNOWN,this._input.next()),x)},b.prototype._read_comment_or_cdata=function(p){var w=null,x=null,_=null;if(p==="<"){var y=this._input.peek(1);y==="!"&&(x=this.__patterns.comment.read(),x?(_=m.get_directives(x),_&&_.ignore==="start"&&(x+=m.readIgnored(this._input))):x=this.__patterns.cdata.read()),x&&(w=this._create_token(f.COMMENT,x),w.directives=_)}return w},b.prototype._read_processing=function(p){var w=null,x=null,_=null;if(p==="<"){var y=this._input.peek(1);(y==="!"||y==="?")&&(x=this.__patterns.conditional_comment.read(),x=x||this.__patterns.processing.read()),x&&(w=this._create_token(f.COMMENT,x),w.directives=_)}return w},b.prototype._read_open=function(p,w){var x=null,_=null;return w||p==="<"&&(x=this._input.next(),this._input.peek()==="/"&&(x+=this._input.next()),x+=this.__patterns.element_name.read(),_=this._create_token(f.TAG_OPEN,x)),_},b.prototype._read_open_handlebars=function(p,w){var x=null,_=null;return w||this._options.indent_handlebars&&p==="{"&&this._input.peek(1)==="{"&&(this._input.peek(2)==="!"?(x=this.__patterns.handlebars_comment.read(),x=x||this.__patterns.handlebars.read(),_=this._create_token(f.COMMENT,x)):(x=this.__patterns.handlebars_open.read(),_=this._create_token(f.TAG_OPEN,x))),_},b.prototype._read_close=function(p,w){var x=null,_=null;return w&&(w.text[0]==="<"&&(p===">"||p==="/"&&this._input.peek(1)===">")?(x=this._input.next(),p==="/"&&(x+=this._input.next()),_=this._create_token(f.TAG_CLOSE,x)):w.text[0]==="{"&&p==="}"&&this._input.peek(1)==="}"&&(this._input.next(),this._input.next(),_=this._create_token(f.TAG_CLOSE,"}}"))),_},b.prototype._read_attribute=function(p,w,x){var _=null,y="";if(x&&x.text[0]==="<")if(p==="=")_=this._create_token(f.EQUALS,this._input.next());else if(p==='"'||p==="'"){var C=this._input.next();p==='"'?C+=this.__patterns.double_quote.read():C+=this.__patterns.single_quote.read(),_=this._create_token(f.VALUE,C)}else y=this.__patterns.attribute.read(),y&&(w.type===f.EQUALS?_=this._create_token(f.VALUE,y):_=this._create_token(f.ATTRIBUTE,y));return _},b.prototype._is_content_unformatted=function(p){return this._options.void_elements.indexOf(p)===-1&&(this._options.content_unformatted.indexOf(p)!==-1||this._options.unformatted.indexOf(p)!==-1)},b.prototype._read_raw_content=function(p,w,x){var _="";if(x&&x.text[0]==="{")_=this.__patterns.handlebars_raw_close.read();else if(w.type===f.TAG_CLOSE&&w.opened.text[0]==="<"&&w.text[0]!=="/"){var y=w.opened.text.substr(1).toLowerCase();if(y==="script"||y==="style"){var C=this._read_comment_or_cdata(p);if(C)return C.type=f.TEXT,C;_=this._input.readUntil(new RegExp("</"+y+"[\\n\\r\\t ]*?>","ig"))}else this._is_content_unformatted(y)&&(_=this._input.readUntil(new RegExp("</"+y+"[\\n\\r\\t ]*?>","ig")))}return _?this._create_token(f.TEXT,_):null},b.prototype._read_content_word=function(p){var w="";if(this._options.unformatted_content_delimiter&&p===this._options.unformatted_content_delimiter[0]&&(w=this.__patterns.unformatted_content_delimiter.read()),w||(w=this.__patterns.word.read()),w)return this._create_token(f.TEXT,w)},r.exports.Tokenizer=b,r.exports.TOKEN=f}],t={};function n(r){var s=t[r];if(s!==void 0)return s.exports;var a=t[r]={exports:{}};return e[r](a,a.exports,n),a.exports}var i=n(18);$o=i})();function ac(e,t){return $o(e,t,rc,sc)}function oc(e,t,n){var i=e.getText(),r=!0,s=0,a=n.tabSize||4;if(t){for(var l=e.offsetAt(t.start),o=l;o>0&&Fo(i,o-1);)o--;o===0||Uo(i,o-1)?l=o:o<l&&(l=o+1);for(var u=e.offsetAt(t.end),c=u;c<i.length&&Fo(i,c);)c++;(c===i.length||Uo(i,c))&&(u=c),t=Z.create(e.positionAt(l),e.positionAt(u));var h=i.substring(0,l);if(new RegExp(/.*[<][^>]*$/).test(h))return i=i.substring(l,u),[{range:t,newText:i}];if(r=u===i.length,i=i.substring(l,u),l!==0){var f=e.offsetAt(he.create(t.start.line,0));s=cc(e.getText(),f,n)}}else t=Z.create(he.create(0,0),e.positionAt(i.length));var m={indent_size:a,indent_char:n.insertSpaces?" ":"	",indent_empty_lines:_e(n,"indentEmptyLines",!1),wrap_line_length:_e(n,"wrapLineLength",120),unformatted:ur(n,"unformatted",void 0),content_unformatted:ur(n,"contentUnformatted",void 0),indent_inner_html:_e(n,"indentInnerHtml",!1),preserve_newlines:_e(n,"preserveNewLines",!0),max_preserve_newlines:_e(n,"maxPreserveNewLines",32786),indent_handlebars:_e(n,"indentHandlebars",!1),end_with_newline:r&&_e(n,"endWithNewline",!1),extra_liners:ur(n,"extraLiners",void 0),wrap_attributes:_e(n,"wrapAttributes","auto"),wrap_attributes_indent_size:_e(n,"wrapAttributesIndentSize",void 0),eol:`
`,indent_scripts:_e(n,"indentScripts","normal"),templating:uc(n,"all"),unformatted_content_delimiter:_e(n,"unformattedContentDelimiter","")},b=ac(lc(i),m);if(s>0){var p=n.insertSpaces?Do(" ",a*s):Do("	",s);b=b.split(`
`).join(`
`+p),t.start.character===0&&(b=p+b)}return[{range:t,newText:b}]}function lc(e){return e.replace(/^\s+/,"")}function _e(e,t,n){if(e&&e.hasOwnProperty(t)){var i=e[t];if(i!==null)return i}return n}function ur(e,t,n){var i=_e(e,t,null);return typeof i=="string"?i.length>0?i.split(",").map(function(r){return r.trim().toLowerCase()}):[]:n}function uc(e,t){var n=_e(e,"templating",t);return n===!0?["auto"]:["none"]}function cc(e,t,n){for(var i=t,r=0,s=n.tabSize||4;i<e.length;){var a=e.charAt(i);if(a===" ")r++;else if(a==="	")r+=s;else break;i++}return Math.floor(r/s)}function Uo(e,t){return`\r
`.indexOf(e.charAt(t))!==-1}function Fo(e,t){return" 	".indexOf(e.charAt(t))!==-1}var Qo;Qo=(()=>{var e={470:i=>{function r(l){if(typeof l!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(l))}function s(l,o){for(var u,c="",h=0,f=-1,m=0,b=0;b<=l.length;++b){if(b<l.length)u=l.charCodeAt(b);else{if(u===47)break;u=47}if(u===47){if(!(f===b-1||m===1))if(f!==b-1&&m===2){if(c.length<2||h!==2||c.charCodeAt(c.length-1)!==46||c.charCodeAt(c.length-2)!==46){if(c.length>2){var p=c.lastIndexOf("/");if(p!==c.length-1){p===-1?(c="",h=0):h=(c=c.slice(0,p)).length-1-c.lastIndexOf("/"),f=b,m=0;continue}}else if(c.length===2||c.length===1){c="",h=0,f=b,m=0;continue}}o&&(c.length>0?c+="/..":c="..",h=2)}else c.length>0?c+="/"+l.slice(f+1,b):c=l.slice(f+1,b),h=b-f-1;f=b,m=0}else u===46&&m!==-1?++m:m=-1}return c}var a={resolve:function(){for(var l,o="",u=!1,c=arguments.length-1;c>=-1&&!u;c--){var h;c>=0?h=arguments[c]:(l===void 0&&(l=process.cwd()),h=l),r(h),h.length!==0&&(o=h+"/"+o,u=h.charCodeAt(0)===47)}return o=s(o,!u),u?o.length>0?"/"+o:"/":o.length>0?o:"."},normalize:function(l){if(r(l),l.length===0)return".";var o=l.charCodeAt(0)===47,u=l.charCodeAt(l.length-1)===47;return(l=s(l,!o)).length!==0||o||(l="."),l.length>0&&u&&(l+="/"),o?"/"+l:l},isAbsolute:function(l){return r(l),l.length>0&&l.charCodeAt(0)===47},join:function(){if(arguments.length===0)return".";for(var l,o=0;o<arguments.length;++o){var u=arguments[o];r(u),u.length>0&&(l===void 0?l=u:l+="/"+u)}return l===void 0?".":a.normalize(l)},relative:function(l,o){if(r(l),r(o),l===o||(l=a.resolve(l))===(o=a.resolve(o)))return"";for(var u=1;u<l.length&&l.charCodeAt(u)===47;++u);for(var c=l.length,h=c-u,f=1;f<o.length&&o.charCodeAt(f)===47;++f);for(var m=o.length-f,b=h<m?h:m,p=-1,w=0;w<=b;++w){if(w===b){if(m>b){if(o.charCodeAt(f+w)===47)return o.slice(f+w+1);if(w===0)return o.slice(f+w)}else h>b&&(l.charCodeAt(u+w)===47?p=w:w===0&&(p=0));break}var x=l.charCodeAt(u+w);if(x!==o.charCodeAt(f+w))break;x===47&&(p=w)}var _="";for(w=u+p+1;w<=c;++w)w!==c&&l.charCodeAt(w)!==47||(_.length===0?_+="..":_+="/..");return _.length>0?_+o.slice(f+p):(f+=p,o.charCodeAt(f)===47&&++f,o.slice(f))},_makeLong:function(l){return l},dirname:function(l){if(r(l),l.length===0)return".";for(var o=l.charCodeAt(0),u=o===47,c=-1,h=!0,f=l.length-1;f>=1;--f)if((o=l.charCodeAt(f))===47){if(!h){c=f;break}}else h=!1;return c===-1?u?"/":".":u&&c===1?"//":l.slice(0,c)},basename:function(l,o){if(o!==void 0&&typeof o!="string")throw new TypeError('"ext" argument must be a string');r(l);var u,c=0,h=-1,f=!0;if(o!==void 0&&o.length>0&&o.length<=l.length){if(o.length===l.length&&o===l)return"";var m=o.length-1,b=-1;for(u=l.length-1;u>=0;--u){var p=l.charCodeAt(u);if(p===47){if(!f){c=u+1;break}}else b===-1&&(f=!1,b=u+1),m>=0&&(p===o.charCodeAt(m)?--m==-1&&(h=u):(m=-1,h=b))}return c===h?h=b:h===-1&&(h=l.length),l.slice(c,h)}for(u=l.length-1;u>=0;--u)if(l.charCodeAt(u)===47){if(!f){c=u+1;break}}else h===-1&&(f=!1,h=u+1);return h===-1?"":l.slice(c,h)},extname:function(l){r(l);for(var o=-1,u=0,c=-1,h=!0,f=0,m=l.length-1;m>=0;--m){var b=l.charCodeAt(m);if(b!==47)c===-1&&(h=!1,c=m+1),b===46?o===-1?o=m:f!==1&&(f=1):o!==-1&&(f=-1);else if(!h){u=m+1;break}}return o===-1||c===-1||f===0||f===1&&o===c-1&&o===u+1?"":l.slice(o,c)},format:function(l){if(l===null||typeof l!="object")throw new TypeError('The "pathObject" argument must be of type Object. Received type '+typeof l);return function(o,u){var c=u.dir||u.root,h=u.base||(u.name||"")+(u.ext||"");return c?c===u.root?c+h:c+"/"+h:h}(0,l)},parse:function(l){r(l);var o={root:"",dir:"",base:"",ext:"",name:""};if(l.length===0)return o;var u,c=l.charCodeAt(0),h=c===47;h?(o.root="/",u=1):u=0;for(var f=-1,m=0,b=-1,p=!0,w=l.length-1,x=0;w>=u;--w)if((c=l.charCodeAt(w))!==47)b===-1&&(p=!1,b=w+1),c===46?f===-1?f=w:x!==1&&(x=1):f!==-1&&(x=-1);else if(!p){m=w+1;break}return f===-1||b===-1||x===0||x===1&&f===b-1&&f===m+1?b!==-1&&(o.base=o.name=m===0&&h?l.slice(1,b):l.slice(m,b)):(m===0&&h?(o.name=l.slice(1,f),o.base=l.slice(1,b)):(o.name=l.slice(m,f),o.base=l.slice(m,b)),o.ext=l.slice(f,b)),m>0?o.dir=l.slice(0,m-1):h&&(o.dir="/"),o},sep:"/",delimiter:":",win32:null,posix:null};a.posix=a,i.exports=a},447:(i,r,s)=>{var a;if(s.r(r),s.d(r,{URI:()=>_,Utils:()=>N}),typeof process=="object")a=process.platform==="win32";else if(typeof navigator=="object"){var l=navigator.userAgent;a=l.indexOf("Windows")>=0}var o,u,c=(o=function(L,k){return(o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(R,H){R.__proto__=H}||function(R,H){for(var I in H)Object.prototype.hasOwnProperty.call(H,I)&&(R[I]=H[I])})(L,k)},function(L,k){if(typeof k!="function"&&k!==null)throw new TypeError("Class extends value "+String(k)+" is not a constructor or null");function R(){this.constructor=L}o(L,k),L.prototype=k===null?Object.create(k):(R.prototype=k.prototype,new R)}),h=/^\w[\w\d+.-]*$/,f=/^\//,m=/^\/\//;function b(L,k){if(!L.scheme&&k)throw new Error('[UriError]: Scheme is missing: {scheme: "", authority: "'.concat(L.authority,'", path: "').concat(L.path,'", query: "').concat(L.query,'", fragment: "').concat(L.fragment,'"}'));if(L.scheme&&!h.test(L.scheme))throw new Error("[UriError]: Scheme contains illegal characters.");if(L.path){if(L.authority){if(!f.test(L.path))throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')}else if(m.test(L.path))throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')}}var p="",w="/",x=/^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/,_=function(){function L(k,R,H,I,z,P){P===void 0&&(P=!1),typeof k=="object"?(this.scheme=k.scheme||p,this.authority=k.authority||p,this.path=k.path||p,this.query=k.query||p,this.fragment=k.fragment||p):(this.scheme=function(G,X){return G||X?G:"file"}(k,P),this.authority=R||p,this.path=function(G,X){switch(G){case"https":case"http":case"file":X?X[0]!==w&&(X=w+X):X=w}return X}(this.scheme,H||p),this.query=I||p,this.fragment=z||p,b(this,P))}return L.isUri=function(k){return k instanceof L||!!k&&typeof k.authority=="string"&&typeof k.fragment=="string"&&typeof k.path=="string"&&typeof k.query=="string"&&typeof k.scheme=="string"&&typeof k.fsPath=="string"&&typeof k.with=="function"&&typeof k.toString=="function"},Object.defineProperty(L.prototype,"fsPath",{get:function(){return g(this,!1)},enumerable:!1,configurable:!0}),L.prototype.with=function(k){if(!k)return this;var R=k.scheme,H=k.authority,I=k.path,z=k.query,P=k.fragment;return R===void 0?R=this.scheme:R===null&&(R=p),H===void 0?H=this.authority:H===null&&(H=p),I===void 0?I=this.path:I===null&&(I=p),z===void 0?z=this.query:z===null&&(z=p),P===void 0?P=this.fragment:P===null&&(P=p),R===this.scheme&&H===this.authority&&I===this.path&&z===this.query&&P===this.fragment?this:new C(R,H,I,z,P)},L.parse=function(k,R){R===void 0&&(R=!1);var H=x.exec(k);return H?new C(H[2]||p,A(H[4]||p),A(H[5]||p),A(H[7]||p),A(H[9]||p),R):new C(p,p,p,p,p)},L.file=function(k){var R=p;if(a&&(k=k.replace(/\\/g,w)),k[0]===w&&k[1]===w){var H=k.indexOf(w,2);H===-1?(R=k.substring(2),k=w):(R=k.substring(2,H),k=k.substring(H)||w)}return new C("file",R,k,p,p)},L.from=function(k){var R=new C(k.scheme,k.authority,k.path,k.query,k.fragment);return b(R,!0),R},L.prototype.toString=function(k){return k===void 0&&(k=!1),T(this,k)},L.prototype.toJSON=function(){return this},L.revive=function(k){if(k){if(k instanceof L)return k;var R=new C(k);return R._formatted=k.external,R._fsPath=k._sep===y?k.fsPath:null,R}return k},L}(),y=a?1:void 0,C=function(L){function k(){var R=L!==null&&L.apply(this,arguments)||this;return R._formatted=null,R._fsPath=null,R}return c(k,L),Object.defineProperty(k.prototype,"fsPath",{get:function(){return this._fsPath||(this._fsPath=g(this,!1)),this._fsPath},enumerable:!1,configurable:!0}),k.prototype.toString=function(R){return R===void 0&&(R=!1),R?T(this,!0):(this._formatted||(this._formatted=T(this,!1)),this._formatted)},k.prototype.toJSON=function(){var R={$mid:1};return this._fsPath&&(R.fsPath=this._fsPath,R._sep=y),this._formatted&&(R.external=this._formatted),this.path&&(R.path=this.path),this.scheme&&(R.scheme=this.scheme),this.authority&&(R.authority=this.authority),this.query&&(R.query=this.query),this.fragment&&(R.fragment=this.fragment),R},k}(_),E=((u={})[58]="%3A",u[47]="%2F",u[63]="%3F",u[35]="%23",u[91]="%5B",u[93]="%5D",u[64]="%40",u[33]="%21",u[36]="%24",u[38]="%26",u[39]="%27",u[40]="%28",u[41]="%29",u[42]="%2A",u[43]="%2B",u[44]="%2C",u[59]="%3B",u[61]="%3D",u[32]="%20",u);function B(L,k){for(var R=void 0,H=-1,I=0;I<L.length;I++){var z=L.charCodeAt(I);if(z>=97&&z<=122||z>=65&&z<=90||z>=48&&z<=57||z===45||z===46||z===95||z===126||k&&z===47)H!==-1&&(R+=encodeURIComponent(L.substring(H,I)),H=-1),R!==void 0&&(R+=L.charAt(I));else{R===void 0&&(R=L.substr(0,I));var P=E[z];P!==void 0?(H!==-1&&(R+=encodeURIComponent(L.substring(H,I)),H=-1),R+=P):H===-1&&(H=I)}}return H!==-1&&(R+=encodeURIComponent(L.substring(H))),R!==void 0?R:L}function v(L){for(var k=void 0,R=0;R<L.length;R++){var H=L.charCodeAt(R);H===35||H===63?(k===void 0&&(k=L.substr(0,R)),k+=E[H]):k!==void 0&&(k+=L[R])}return k!==void 0?k:L}function g(L,k){var R;return R=L.authority&&L.path.length>1&&L.scheme==="file"?"//".concat(L.authority).concat(L.path):L.path.charCodeAt(0)===47&&(L.path.charCodeAt(1)>=65&&L.path.charCodeAt(1)<=90||L.path.charCodeAt(1)>=97&&L.path.charCodeAt(1)<=122)&&L.path.charCodeAt(2)===58?k?L.path.substr(1):L.path[1].toLowerCase()+L.path.substr(2):L.path,a&&(R=R.replace(/\//g,"\\")),R}function T(L,k){var R=k?v:B,H="",I=L.scheme,z=L.authority,P=L.path,G=L.query,X=L.fragment;if(I&&(H+=I,H+=":"),(z||I==="file")&&(H+=w,H+=w),z){var Q=z.indexOf("@");if(Q!==-1){var K=z.substr(0,Q);z=z.substr(Q+1),(Q=K.indexOf(":"))===-1?H+=R(K,!1):(H+=R(K.substr(0,Q),!1),H+=":",H+=R(K.substr(Q+1),!1)),H+="@"}(Q=(z=z.toLowerCase()).indexOf(":"))===-1?H+=R(z,!1):(H+=R(z.substr(0,Q),!1),H+=z.substr(Q))}if(P){if(P.length>=3&&P.charCodeAt(0)===47&&P.charCodeAt(2)===58)(me=P.charCodeAt(1))>=65&&me<=90&&(P="/".concat(String.fromCharCode(me+32),":").concat(P.substr(3)));else if(P.length>=2&&P.charCodeAt(1)===58){var me;(me=P.charCodeAt(0))>=65&&me<=90&&(P="".concat(String.fromCharCode(me+32),":").concat(P.substr(2)))}H+=R(P,!0)}return G&&(H+="?",H+=R(G,!1)),X&&(H+="#",H+=k?X:B(X,!1)),H}function q(L){try{return decodeURIComponent(L)}catch{return L.length>3?L.substr(0,3)+q(L.substr(3)):L}}var S=/(%[0-9A-Za-z][0-9A-Za-z])+/g;function A(L){return L.match(S)?L.replace(S,function(k){return q(k)}):L}var N,D=s(470),U=function(L,k,R){if(R||arguments.length===2)for(var H,I=0,z=k.length;I<z;I++)!H&&I in k||(H||(H=Array.prototype.slice.call(k,0,I)),H[I]=k[I]);return L.concat(H||Array.prototype.slice.call(k))},W=D.posix||D;(function(L){L.joinPath=function(k){for(var R=[],H=1;H<arguments.length;H++)R[H-1]=arguments[H];return k.with({path:W.join.apply(W,U([k.path],R,!1))})},L.resolvePath=function(k){for(var R=[],H=1;H<arguments.length;H++)R[H-1]=arguments[H];var I=k.path||"/";return k.with({path:W.resolve.apply(W,U([I],R,!1))})},L.dirname=function(k){var R=W.dirname(k.path);return R.length===1&&R.charCodeAt(0)===46?k:k.with({path:R})},L.basename=function(k){return W.basename(k.path)},L.extname=function(k){return W.extname(k.path)}})(N||(N={}))}},t={};function n(i){if(t[i])return t[i].exports;var r=t[i]={exports:{}};return e[i](r,r.exports,n),r.exports}return n.d=(i,r)=>{for(var s in r)n.o(r,s)&&!n.o(i,s)&&Object.defineProperty(i,s,{enumerable:!0,get:r[s]})},n.o=(i,r)=>Object.prototype.hasOwnProperty.call(i,r),n.r=i=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(i,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(i,"__esModule",{value:!0})},n(447)})();var{URI:hc,Utils:mm}=Qo;function _r(e){var t=e[0],n=e[e.length-1];return t===n&&(t==="'"||t==='"')&&(e=e.substr(1,e.length-2)),e}function dc(e,t){return!e.length||t==="handlebars"&&/{{|}}/.test(e)?!1:/\b(w[\w\d+.-]*:\/\/)?[^\s()<>]+(?:\([\w\d]+\)|([^[:punct:]\s]|\/?))/.test(e)}function fc(e,t,n,i){if(!(/^\s*javascript\:/i.test(t)||/[\n\r]/.test(t))){if(t=t.replace(/^\s*/g,""),/^https?:\/\//i.test(t)||/^file:\/\//i.test(t))return t;if(/^\#/i.test(t))return e+t;if(/^\/\//i.test(t)){var r=tt(e,"https://")?"https":"http";return r+":"+t.replace(/^\s*/g,"")}return n?n.resolveReference(t,i||e):t}}function mc(e,t,n,i,r,s){var a=_r(n);if(dc(a,e.languageId)){a.length<n.length&&(i++,r--);var l=fc(e.uri,a,t,s);if(!(!l||!pc(l)))return{range:Z.create(e.positionAt(i),e.positionAt(r)),target:l}}}function pc(e){try{return hc.parse(e),!0}catch{return!1}}function gc(e,t){for(var n=[],i=we(e.getText(),0),r=i.scan(),s=void 0,a=!1,l=void 0,o={};r!==F.EOS;){switch(r){case F.StartTag:if(!l){var u=i.getTokenText().toLowerCase();a=u==="base"}break;case F.AttributeName:s=i.getTokenText().toLowerCase();break;case F.AttributeValue:if(s==="src"||s==="href"){var c=i.getTokenText();if(!a){var h=mc(e,t,c,i.getTokenOffset(),i.getTokenEnd(),l);h&&n.push(h)}a&&typeof l>"u"&&(l=_r(c),l&&t&&(l=t.resolveReference(l,e.uri))),a=!1,s=void 0}else if(s==="id"){var f=_r(i.getTokenText());o[f]=i.getTokenOffset()}break}r=i.scan()}for(var m=0,b=n;m<b.length;m++){var h=b[m],p=e.uri+"#";if(h.target&&tt(h.target,p)){var w=h.target.substr(p.length),x=o[w];if(x!==void 0){var _=e.positionAt(x);h.target="".concat(p).concat(_.line+1,",").concat(_.character+1)}}}return n}function bc(e,t,n){var i=e.offsetAt(t),r=n.findNodeAt(i);if(!r.tag)return[];var s=[],a=Bo(F.StartTag,e,r.start),l=typeof r.endTagStart=="number"&&Bo(F.EndTag,e,r.endTagStart);return(a&&Wo(a,t)||l&&Wo(l,t))&&(a&&s.push({kind:si.Read,range:a}),l&&s.push({kind:si.Read,range:l})),s}function Ho(e,t){return e.line<t.line||e.line===t.line&&e.character<=t.character}function Wo(e,t){return Ho(e.start,t)&&Ho(t,e.end)}function Bo(e,t,n){for(var i=we(t.getText(),n),r=i.scan();r!==F.EOS&&r!==e;)r=i.scan();return r!==F.EOS?{start:t.positionAt(i.getTokenOffset()),end:t.positionAt(i.getTokenEnd())}:null}function vc(e,t){var n=[];return t.roots.forEach(function(i){Jo(e,i,"",n)}),n}function Jo(e,t,n,i){var r=_c(t),s=Kn.create(e.uri,Z.create(e.positionAt(t.start),e.positionAt(t.end))),a={name:r,location:s,containerName:n,kind:mr.Field};i.push(a),t.children.forEach(function(l){Jo(e,l,r,i)})}function _c(e){var t=e.tag;if(e.attributes){var n=e.attributes.id,i=e.attributes.class;n&&(t+="#".concat(n.replace(/[\"\']/g,""))),i&&(t+=i.replace(/[\"\']/g,"").split(/\s+/).map(function(r){return".".concat(r)}).join(""))}return t||"?"}function wc(e,t,n,i){var r,s=e.offsetAt(t),a=i.findNodeAt(s);if(!a.tag||!yc(a,s,a.tag))return null;var l=[],o={start:e.positionAt(a.start+1),end:e.positionAt(a.start+1+a.tag.length)};if(l.push({range:o,newText:n}),a.endTagStart){var u={start:e.positionAt(a.endTagStart+2),end:e.positionAt(a.endTagStart+2+a.tag.length)};l.push({range:u,newText:n})}var c=(r={},r[e.uri.toString()]=l,r);return{changes:c}}function yc(e,t,n){return e.endTagStart&&e.endTagStart+2<=t&&t<=e.endTagStart+2+n.length?!0:e.start+1<=t&&t<=e.start+1+n.length}function xc(e,t,n){var i=e.offsetAt(t),r=n.findNodeAt(i);if(!r.tag||!r.endTagStart)return null;if(r.start+1<=i&&i<=r.start+1+r.tag.length){var s=i-1-r.start+r.endTagStart+2;return e.positionAt(s)}if(r.endTagStart+2<=i&&i<=r.endTagStart+2+r.tag.length){var s=i-2-r.endTagStart+r.start+1;return e.positionAt(s)}return null}function Po(e,t,n){var i=e.offsetAt(t),r=n.findNodeAt(i),s=r.tag?r.tag.length:0;return r.endTagStart&&(r.start+1<=i&&i<=r.start+1+s||r.endTagStart+2<=i&&i<=r.endTagStart+2+s)?[Z.create(e.positionAt(r.start+1),e.positionAt(r.start+1+s)),Z.create(e.positionAt(r.endTagStart+2),e.positionAt(r.endTagStart+2+s))]:null}function Tc(e,t){e=e.sort(function(b,p){var w=b.startLine-p.startLine;return w===0&&(w=b.endLine-p.endLine),w});for(var n=void 0,i=[],r=[],s=[],a=function(b,p){r[b]=p,p<30&&(s[p]=(s[p]||0)+1)},l=0;l<e.length;l++){var o=e[l];if(!n)n=o,a(l,0);else if(o.startLine>n.startLine){if(o.endLine<=n.endLine)i.push(n),n=o,a(l,i.length);else if(o.startLine>n.endLine){do n=i.pop();while(n&&o.startLine>n.endLine);n&&i.push(n),n=o,a(l,i.length)}}}for(var u=0,c=0,l=0;l<s.length;l++){var h=s[l];if(h){if(h+u>t){c=l;break}u+=h}}for(var f=[],l=0;l<e.length;l++){var m=r[l];typeof m=="number"&&(m<c||m===c&&u++<t)&&f.push(e[l])}return f}function Ac(e,t){var n=we(e.getText()),i=n.scan(),r=[],s=[],a=null,l=-1;function o(_){r.push(_),l=_.startLine}for(;i!==F.EOS;){switch(i){case F.StartTag:{var u=n.getTokenText(),c=e.positionAt(n.getTokenOffset()).line;s.push({startLine:c,tagName:u}),a=u;break}case F.EndTag:{a=n.getTokenText();break}case F.StartTagClose:if(!a||!oi(a))break;case F.EndTagClose:case F.StartTagSelfClose:{for(var h=s.length-1;h>=0&&s[h].tagName!==a;)h--;if(h>=0){var f=s[h];s.length=h;var m=e.positionAt(n.getTokenOffset()).line,c=f.startLine,b=m-1;b>c&&l!==c&&o({startLine:c,endLine:b})}break}case F.Comment:{var c=e.positionAt(n.getTokenOffset()).line,p=n.getTokenText(),w=p.match(/^\s*#(region\b)|(endregion\b)/);if(w)if(w[1])s.push({startLine:c,tagName:""});else{for(var h=s.length-1;h>=0&&s[h].tagName.length;)h--;if(h>=0){var f=s[h];s.length=h;var b=c;c=f.startLine,b>c&&l!==c&&o({startLine:c,endLine:b,kind:ei.Region})}}else{var b=e.positionAt(n.getTokenOffset()+n.getTokenLength()).line;c<b&&o({startLine:c,endLine:b,kind:ei.Comment})}break}}i=n.scan()}var x=t&&t.rangeLimit||Number.MAX_VALUE;return r.length>x?Tc(r,x):r}function kc(e,t){function n(i){for(var r=Sc(e,i),s=void 0,a=void 0,l=r.length-1;l>=0;l--){var o=r[l];(!s||o[0]!==s[0]||o[1]!==s[1])&&(a=ai.create(Z.create(e.positionAt(r[l][0]),e.positionAt(r[l][1])),a)),s=o}return a||(a=ai.create(Z.create(i,i))),a}return t.map(n)}function Sc(e,t){var n=Vo(e.getText()),i=e.offsetAt(t),r=n.findNodeAt(i),s=Lc(r);if(r.startTagEnd&&!r.endTagStart){if(r.startTagEnd!==r.end)return[[r.start,r.end]];var a=Z.create(e.positionAt(r.startTagEnd-2),e.positionAt(r.startTagEnd)),l=e.getText(a);l==="/>"?s.unshift([r.start+1,r.startTagEnd-2]):s.unshift([r.start+1,r.startTagEnd-1]);var o=qo(e,r,i);return s=o.concat(s),s}if(!r.startTagEnd||!r.endTagStart)return s;if(s.unshift([r.start,r.end]),r.start<i&&i<r.startTagEnd){s.unshift([r.start+1,r.startTagEnd-1]);var o=qo(e,r,i);return s=o.concat(s),s}else return r.startTagEnd<=i&&i<=r.endTagStart?(s.unshift([r.startTagEnd,r.endTagStart]),s):(i>=r.endTagStart+2&&s.unshift([r.endTagStart+2,r.end-1]),s)}function Lc(e){for(var t=e,n=function(r){return r.startTagEnd&&r.endTagStart&&r.startTagEnd<r.endTagStart?[[r.startTagEnd,r.endTagStart],[r.start,r.end]]:[[r.start,r.end]]},i=[];t.parent;)t=t.parent,n(t).forEach(function(r){return i.push(r)});return i}function qo(e,t,n){for(var i=Z.create(e.positionAt(t.start),e.positionAt(t.end)),r=e.getText(i),s=n-t.start,a=we(r),l=a.scan(),o=t.start,u=[],c=!1,h=-1;l!==F.EOS;){switch(l){case F.AttributeName:{if(s<a.getTokenOffset()){c=!1;break}s<=a.getTokenEnd()&&u.unshift([a.getTokenOffset(),a.getTokenEnd()]),c=!0,h=a.getTokenOffset();break}case F.AttributeValue:{if(!c)break;var f=a.getTokenText();if(s<a.getTokenOffset()){u.push([h,a.getTokenEnd()]);break}s>=a.getTokenOffset()&&s<=a.getTokenEnd()&&(u.unshift([a.getTokenOffset(),a.getTokenEnd()]),(f[0]==='"'&&f[f.length-1]==='"'||f[0]==="'"&&f[f.length-1]==="'")&&s>=a.getTokenOffset()+1&&s<=a.getTokenEnd()-1&&u.unshift([a.getTokenOffset()+1,a.getTokenEnd()-1]),u.push([h,a.getTokenEnd()]));break}}l=a.scan()}return u.map(function(m){return[m[0]+o,m[1]+o]})}var Cc={version:1.1,tags:[{name:"html",description:{kind:"markdown",value:"The html element represents the root of an HTML document."},attributes:[{name:"manifest",description:{kind:"markdown",value:"Specifies the URI of a resource manifest indicating resources that should be cached locally. See [Using the application cache](https://developer.mozilla.org/en-US/docs/Web/HTML/Using_the_application_cache) for details."}},{name:"version",description:'Specifies the version of the HTML [Document Type Definition](https://developer.mozilla.org/en-US/docs/Glossary/DTD "Document Type Definition: In HTML, the doctype is the required "<!DOCTYPE html>" preamble found at the top of all documents. Its sole purpose is to prevent a browser from switching into so-called \u201Cquirks mode\u201D when rendering a document; that is, the "<!DOCTYPE html>" doctype ensures that the browser makes a best-effort attempt at following the relevant specifications, rather than using a different rendering mode that is incompatible with some specifications.") that governs the current document. This attribute is not needed, because it is redundant with the version information in the document type declaration.'},{name:"xmlns",description:'Specifies the XML Namespace of the document. Default value is `"http://www.w3.org/1999/xhtml"`. This is required in documents parsed with XML parsers, and optional in text/html documents.'}],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/HTML/Element/html"}]},{name:"head",description:{kind:"markdown",value:"The head element represents a collection of metadata for the Document."},attributes:[{name:"profile",description:"The URIs of one or more metadata profiles, separated by white space."}],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/HTML/Element/head"}]},{name:"title",description:{kind:"markdown",value:"The title element represents the document's title or name. Authors should use titles that identify their documents even when they are used out of context, for example in a user's history or bookmarks, or in search results. The document's title is often different from its first heading, since the first heading does not have to stand alone when taken out of context."},attributes:[],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/HTML/Element/title"}]},{name:"base",description:{kind:"markdown",value:"The base element allows authors to specify the document base URL for the purposes of resolving relative URLs, and the name of the default browsing context for the purposes of following hyperlinks. The element does not represent any content beyond this information."},attributes:[{name:"href",description:{kind:"markdown",value:"The base URL to be used throughout the document for relative URL addresses. If this attribute is specified, this element must come before any other elements with attributes whose values are URLs. Absolute and relative URLs are allowed."}},{name:"target",description:{kind:"markdown",value:"A name or keyword indicating the default location to display the result when hyperlinks or forms cause navigation, for elements that do not have an explicit target reference. It is a name of, or keyword for, a _browsing context_ (for example: tab, window, or inline frame). The following keywords have special meanings:\n\n*   `_self`: Load the result into the same browsing context as the current one. This value is the default if the attribute is not specified.\n*   `_blank`: Load the result into a new unnamed browsing context.\n*   `_parent`: Load the result into the parent browsing context of the current one. If there is no parent, this option behaves the same way as `_self`.\n*   `_top`: Load the result into the top-level browsing context (that is, the browsing context that is an ancestor of the current one, and has no parent). If there is no parent, this option behaves the same way as `_self`.\n\nIf this attribute is specified, this element must come before any other elements with attributes whose values are URLs."}}],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/HTML/Element/base"}]},{name:"link",description:{kind:"markdown",value:"The link element allows authors to link their document to other resources."},attributes:[{name:"href",description:{kind:"markdown",value:'This attribute specifies the [URL](https://developer.mozilla.org/en-US/docs/Glossary/URL "URL: Uniform Resource Locator (URL) is a text string specifying where a resource can be found on the Internet.") of the linked resource. A URL can be absolute or relative.'}},{name:"crossorigin",valueSet:"xo",description:{kind:"markdown",value:'This enumerated attribute indicates whether [CORS](https://developer.mozilla.org/en-US/docs/Glossary/CORS "CORS: CORS (Cross-Origin Resource Sharing) is a system, consisting of transmitting HTTP headers, that determines whether browsers block frontend JavaScript code from accessing responses for cross-origin requests.") must be used when fetching the resource. [CORS-enabled images](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_Enabled_Image) can be reused in the [`<canvas>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/canvas "Use the HTML <canvas> element with either the canvas scripting API or the WebGL API to draw graphics and animations.") element without being _tainted_. The allowed values are:\n\n`anonymous`\n\nA cross-origin request (i.e. with an [`Origin`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Origin "The Origin request header indicates where a fetch originates from. It doesn\'t include any path information, but only the server name. It is sent with CORS requests, as well as with POST requests. It is similar to the Referer header, but, unlike this header, it doesn\'t disclose the whole path.") HTTP header) is performed, but no credential is sent (i.e. no cookie, X.509 certificate, or HTTP Basic authentication). If the server does not give credentials to the origin site (by not setting the [`Access-Control-Allow-Origin`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Origin "The Access-Control-Allow-Origin response header indicates whether the response can be shared with requesting code from the given origin.") HTTP header) the image will be tainted and its usage restricted.\n\n`use-credentials`\n\nA cross-origin request (i.e. with an `Origin` HTTP header) is performed along with a credential sent (i.e. a cookie, certificate, and/or HTTP Basic authentication is performed). If the server does not give credentials to the origin site (through [`Access-Control-Allow-Credentials`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Credentials "The Access-Control-Allow-Credentials response header tells browsers whether to expose the response to frontend JavaScript code when the request\'s credentials mode (Request.credentials) is "include".") HTTP header), the resource will be _tainted_ and its usage restricted.\n\nIf the attribute is not present, the resource is fetched without a [CORS](https://developer.mozilla.org/en-US/docs/Glossary/CORS "CORS: CORS (Cross-Origin Resource Sharing) is a system, consisting of transmitting HTTP headers, that determines whether browsers block frontend JavaScript code from accessing responses for cross-origin requests.") request (i.e. without sending the `Origin` HTTP header), preventing its non-tainted usage. If invalid, it is handled as if the enumerated keyword **anonymous** was used. See [CORS settings attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_settings_attributes) for additional information.'}},{name:"rel",description:{kind:"markdown",value:"This attribute names a relationship of the linked document to the current document. The attribute must be a space-separated list of the [link types values](https://developer.mozilla.org/en-US/docs/Web/HTML/Link_types)."}},{name:"media",description:{kind:"markdown",value:"This attribute specifies the media that the linked resource applies to. Its value must be a media type / [media query](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_queries). This attribute is mainly useful when linking to external stylesheets \u2014 it allows the user agent to pick the best adapted one for the device it runs on.\n\n**Notes:**\n\n*   In HTML 4, this can only be a simple white-space-separated list of media description literals, i.e., [media types and groups](https://developer.mozilla.org/en-US/docs/Web/CSS/@media), where defined and allowed as values for this attribute, such as `print`, `screen`, `aural`, `braille`. HTML5 extended this to any kind of [media queries](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_queries), which are a superset of the allowed values of HTML 4.\n*   Browsers not supporting [CSS3 Media Queries](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_queries) won't necessarily recognize the adequate link; do not forget to set fallback links, the restricted set of media queries defined in HTML 4."}},{name:"hreflang",description:{kind:"markdown",value:"This attribute indicates the language of the linked resource. It is purely advisory. Allowed values are determined by [BCP47](https://www.ietf.org/rfc/bcp/bcp47.txt). Use this attribute only if the [`href`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#attr-href) attribute is present."}},{name:"type",description:{kind:"markdown",value:'This attribute is used to define the type of the content linked to. The value of the attribute should be a MIME type such as **text/html**, **text/css**, and so on. The common use of this attribute is to define the type of stylesheet being referenced (such as **text/css**), but given that CSS is the only stylesheet language used on the web, not only is it possible to omit the `type` attribute, but is actually now recommended practice. It is also used on `rel="preload"` link types, to make sure the browser only downloads file types that it supports.'}},{name:"sizes",description:{kind:"markdown",value:"This attribute defines the sizes of the icons for visual media contained in the resource. It must be present only if the [`rel`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/link#attr-rel) contains a value of `icon` or a non-standard type such as Apple's `apple-touch-icon`. It may have the following values:\n\n*   `any`, meaning that the icon can be scaled to any size as it is in a vector format, like `image/svg+xml`.\n*   a white-space separated list of sizes, each in the format `_<width in pixels>_x_<height in pixels>_` or `_<width in pixels>_X_<height in pixels>_`. Each of these sizes must be contained in the resource.\n\n**Note:** Most icon formats are only able to store one single icon; therefore most of the time the [`sizes`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-sizes) contains only one entry. MS's ICO format does, as well as Apple's ICNS. ICO is more ubiquitous; you should definitely use it."}},{name:"as",description:'This attribute is only used when `rel="preload"` or `rel="prefetch"` has been set on the `<link>` element. It specifies the type of content being loaded by the `<link>`, which is necessary for content prioritization, request matching, application of correct [content security policy](https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP), and setting of correct [`Accept`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Accept "The Accept request HTTP header advertises which content types, expressed as MIME types, the client is able to understand. Using content negotiation, the server then selects one of the proposals, uses it and informs the client of its choice with the Content-Type response header. Browsers set adequate values for this header depending on\xA0the context where the request is done: when fetching a CSS stylesheet a different value is set for the request than when fetching an image,\xA0video or a script.") request header.'},{name:"importance",description:"Indicates the relative importance of the resource. Priority hints are delegated using the values:"},{name:"importance",description:'**`auto`**: Indicates\xA0**no\xA0preference**. The browser may use its own heuristics to decide the priority of the resource.\n\n**`high`**: Indicates to the\xA0browser\xA0that the resource is of\xA0**high** priority.\n\n**`low`**:\xA0Indicates to the\xA0browser\xA0that the resource is of\xA0**low** priority.\n\n**Note:** The `importance` attribute may only be used for the `<link>` element if `rel="preload"` or `rel="prefetch"` is present.'},{name:"integrity",description:"Contains inline metadata \u2014 a base64-encoded cryptographic hash of the resource (file) you\u2019re telling the browser to fetch. The browser can use this to verify that the fetched resource has been delivered free of unexpected manipulation. See [Subresource Integrity](https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity)."},{name:"referrerpolicy",description:'A string indicating which referrer to use when fetching the resource:\n\n*   `no-referrer` means that the [`Referer`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Referer "The Referer request header contains the address of the previous web page from which a link to the currently requested page was followed. The Referer header allows servers to identify where people are visiting them from and may use that data for analytics, logging, or optimized caching, for example.") header will not be sent.\n*   `no-referrer-when-downgrade` means that no [`Referer`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Referer "The Referer request header contains the address of the previous web page from which a link to the currently requested page was followed. The Referer header allows servers to identify where people are visiting them from and may use that data for analytics, logging, or optimized caching, for example.") header will be sent when navigating to an origin without TLS (HTTPS). This is a user agent\u2019s default behavior, if no policy is otherwise specified.\n*   `origin` means that the referrer will be the origin of the page, which is roughly the scheme, the host, and the port.\n*   `origin-when-cross-origin` means that navigating to other origins will be limited to the scheme, the host, and the port, while navigating on the same origin will include the referrer\'s path.\n*   `unsafe-url` means that the referrer will include the origin and the path (but not the fragment, password, or username). This case is unsafe because it can leak origins and paths from TLS-protected resources to insecure origins.'},{name:"title",description:'The `title` attribute has special semantics on the `<link>` element. When used on a `<link rel="stylesheet">` it defines a [preferred or an alternate stylesheet](https://developer.mozilla.org/en-US/docs/Web/CSS/Alternative_style_sheets). Incorrectly using it may [cause the stylesheet to be ignored](https://developer.mozilla.org/en-US/docs/Correctly_Using_Titles_With_External_Stylesheets).'}],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/HTML/Element/link"}]},{name:"meta",description:{kind:"markdown",value:"The meta element represents various kinds of metadata that cannot be expressed using the title, base, link, style, and script elements."},attributes:[{name:"name",description:{kind:"markdown",value:`This attribute defines the name of a piece of document-level metadata. It should not be set if one of the attributes [\`itemprop\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-itemprop), [\`http-equiv\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta#attr-http-equiv) or [\`charset\`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta#attr-charset) is also set.
