...
import { IUriIdentityService } from './vscode/src/vs/platform/uriIdentity/common/uriIdentity.js';
...
import { IWorkingCopyFileService } from './vscode/src/vs/workbench/services/workingCopy/common/workingCopyFileService.js';
...
import { NullExtensionService, IExtensionService } from './vscode/src/vs/workbench/services/extensions/common/extensions.js';
...
import { IEnvironmentService } from './vscode/src/vs/platform/environment/common/environment.js';
...
import { IContextKeyService } from './vscode/src/vs/platform/contextkey/common/contextkey.js';
...
import { IUserDataProfilesService, toUserDataProfile } from './vscode/src/vs/platform/userDataProfile/common/userDataProfile.js';
import { NullPolicyService, IPolicyService } from './vscode/src/vs/platform/policy/common/policy.js';
import { IUserDataProfileService, IUserDataProfileImportExportService, IUserDataProfileManagementService } from './vscode/src/vs/workbench/services/userDataProfile/common/userDataProfile.js';
...
import { AbstractLoggerService, LogLevel, NullLogger, ILoggerService } from './vscode/src/vs/platform/log/common/log.js';
...
import { IWorkspaceTrustRequestService, IWorkspaceTrustEnablementService } from './vscode/src/vs/platform/workspace/common/workspaceTrust.js';
...
import { ICustomEndpointTelemetryService } from './vscode/src/vs/platform/telemetry/common/telemetry.js';
...
import { IExtensionManagementServerService, IWebExtensionsScannerService, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService } from './vscode/src/vs/workbench/services/extensionManagement/common/extensionManagement.js';
...
import { IWorkingCopyService } from './vscode/src/vs/workbench/services/workingCopy/common/workingCopyService.js';
import { IFilesConfigurationService } from './vscode/src/vs/workbench/services/filesConfiguration/common/filesConfigurationService.js';
...
import { IOutputChannelModelService } from './vscode/src/vs/workbench/contrib/output/common/outputChannelModelService.js';
import { IExtensionResourceLoaderService } from './vscode/src/vs/platform/extensionResourceLoader/common/extensionResourceLoader.js';
import { IExplorerService } from './vscode/src/vs/workbench/contrib/files/browser/files.js';
import { IExtensionStorageService } from './vscode/src/vs/platform/extensionManagement/common/extensionStorage.js';
...
import { State, IUpdateService } from './vscode/src/vs/platform/update/common/update.js';
import { IStatusbarService } from './vscode/src/vs/workbench/services/statusbar/browser/statusbar.js';
import { IExtensionTipsService, IGlobalExtensionEnablementService, IExtensionGalleryService, IExtensionManagementService } from './vscode/src/vs/platform/extensionManagement/common/extensionManagement.js';
...
import { IWorkingCopyEditorService } from './vscode/src/vs/workbench/services/workingCopy/common/workingCopyEditorService.js';
import { IUserActivityService } from './vscode/src/vs/workbench/services/userActivity/common/userActivityService.js';
import { ICanonicalUriService } from './vscode/src/vs/platform/workspace/common/canonicalUri.js';
import { IExtensionStatusBarItemService } from './vscode/src/vs/workbench/api/browser/statusBarExtensionPoint.js';
...
import { IExternalUriOpenerService } from './vscode/src/vs/workbench/contrib/externalUriOpener/common/externalUriOpenerService.js';
import { IAccessibleViewService } from './vscode/src/vs/workbench/contrib/accessibility/browser/accessibleView.js';
import { IBuiltinExtensionsScannerService } from './vscode/src/vs/platform/extensions/common/extensions.js';
...
import { INotebookKernelService, INotebookKernelHistoryService } from './vscode/src/vs/workbench/contrib/notebook/common/notebookKernelService.js';
...
import { IQuickChatService, IChatWidgetService, IChatAccessibilityService } from './vscode/src/vs/workbench/contrib/chat/browser/chat.js';
...
import { NullDiagnosticsService, IDiagnosticsService } from './vscode/src/vs/platform/diagnostics/common/diagnostics.js';
...
import { ILocaleService, IActiveLanguagePackService } from './vscode/src/vs/workbench/services/localization/common/locale.js';
import { joinPath } from './vscode/src/vs/base/common/resources.js';
import { IExtensionRecommendationsService, IExtensionIgnoredRecommendationsService } from './vscode/src/vs/workbench/services/extensionRecommendations/common/extensionRecommendations.js';
import { IIgnoredExtensionsManagementService } from './vscode/src/vs/platform/userDataSync/common/ignoredExtensions.js';
import { IExtensionRecommendationNotificationService } from './vscode/src/vs/platform/extensionRecommendations/common/extensionRecommendations.js';
import { IWorkspaceExtensionsConfigService } from './vscode/src/vs/workbench/services/extensionRecommendations/common/workspaceExtensionsConfig.js';
import { IRemoteUserDataProfilesService } from './vscode/src/vs/workbench/services/userDataProfile/common/remoteUserDataProfiles.js';
import { IExtensionBisectService } from './vscode/src/vs/workbench/services/extensionManagement/browser/extensionBisect.js';
import { IUserDataSyncAccountService } from './vscode/src/vs/platform/userDataSync/common/userDataSyncAccount.js';
import { ITestResultStorage } from './vscode/src/vs/workbench/contrib/testing/common/testResultStorage.js';
import { ITestingDecorationsService } from './vscode/src/vs/workbench/contrib/testing/common/testingDecorations.js';
import { ITestingContinuousRunService } from './vscode/src/vs/workbench/contrib/testing/common/testingContinuousRunService.js';
import { ITestExplorerFilterState } from './vscode/src/vs/workbench/contrib/testing/common/testExplorerFilterState.js';
import { ITestingPeekOpener } from './vscode/src/vs/workbench/contrib/testing/common/testingPeekOpener.js';
import { IAuxiliaryWindowService } from './vscode/src/vs/workbench/services/auxiliaryWindow/browser/auxiliaryWindowService.js';
import { ISpeechService } from './vscode/src/vs/workbench/contrib/speech/common/speechService.js';
import { ITitleService } from './vscode/src/vs/workbench/services/title/browser/titleService.js';
import { ITestCoverageService } from './vscode/src/vs/workbench/contrib/testing/common/testCoverageService.js';
import { IChatWidgetHistoryService } from './vscode/src/vs/workbench/contrib/chat/common/chatWidgetHistoryService.js';
import { INotebookEditorWorkerService } from './vscode/src/vs/workbench/contrib/notebook/common/services/notebookWorkerService.js';
import { INotebookExecutionService } from './vscode/src/vs/workbench/contrib/notebook/common/notebookExecutionService.js';
import { INotebookKeymapService } from './vscode/src/vs/workbench/contrib/notebook/common/notebookKeymapService.js';
import { INotebookLoggingService } from './vscode/src/vs/workbench/contrib/notebook/common/notebookLoggingService.js';
import { IWalkthroughsService } from './vscode/src/vs/workbench/contrib/welcomeGettingStarted/browser/gettingStartedService.js';
import { IUserDataSyncMachinesService } from './vscode/src/vs/platform/userDataSync/common/userDataSyncMachines.js';
import { IWorkingCopyHistoryService } from './vscode/src/vs/workbench/services/workingCopy/common/workingCopyHistory.js';
import { mainWindow } from './vscode/src/vs/base/browser/window.js';
import { IViewsService } from './vscode/src/vs/workbench/services/views/common/viewsService.js';
import { IHoverService } from './vscode/src/vs/platform/hover/browser/hover.js';
import { IInlineChatSessionService } from './vscode/src/vs/workbench/contrib/inlineChat/browser/inlineChatSessionService.js';
import { IInlineChatSavingService } from './vscode/src/vs/workbench/contrib/inlineChat/browser/inlineChatSavingService.js';
import { INotebookDocumentService } from './vscode/src/vs/workbench/services/notebook/common/notebookDocumentService.js';
import { IDebugVisualizerService } from './vscode/src/vs/workbench/contrib/debug/common/debugVisualizers.js';
import { IEditSessionsLogService, IEditSessionsStorageService } from './vscode/src/vs/workbench/contrib/editSessions/common/editSessions.js';
import { IMultiDiffSourceResolverService } from './vscode/src/vs/workbench/contrib/multiDiffEditor/browser/multiDiffSourceResolverService.js';
import { IInteractiveHistoryService } from './vscode/src/vs/workbench/contrib/interactive/browser/interactiveHistoryService.js';
import { IWorkspaceTagsService } from './vscode/src/vs/workbench/contrib/tags/common/workspaceTags.js';
import { NoOpWorkspaceTagsService } from './vscode/src/vs/workbench/contrib/tags/browser/workspaceTagsService.js';
import { IExtensionFeaturesManagementService } from './vscode/src/vs/workbench/services/extensionManagement/common/extensionFeatures.js';
import { IEditorPaneService } from './vscode/src/vs/workbench/services/editor/common/editorPaneService.js';
import { IWorkspaceIdentityService } from './vscode/src/vs/workbench/services/workspaces/common/workspaceIdentityService.js';
import { IDefaultLogLevelsService } from './vscode/src/vs/workbench/contrib/logs/common/defaultLogLevels.js';
...
registerSingleton(IProductService, class ProductService {
    constructor() {
        this._serviceBrand = undefined;
        this.version = "1.87.2";
        this.commit = "863d2581ecda6849923a2118d93a088b0745d9d6";
        this.quality = 'oss';
...
registerSingleton(ITreeViewsService, class TreeviewsService {
    constructor() {
        this.getRenderedTreeElement = unsupported;
        this.addRenderedTreeItemElement = unsupported;
        this.removeRenderedTreeItemElement = unsupported;
    }
}, 1 );
...
registerSingleton(ITerminalService, class TerminalService {
    constructor() {
        ...
        this.createOnInstanceEvent = unsupported;
        this.createOnInstanceCapabilityEvent = unsupported;
...
registerSingleton(IChatProviderService, class ChatProviderService {
    constructor() {
        this.onDidChangeProviders = Event.None;
        this.getProviders = () => [];
        this.lookupChatResponseProvider = unsupported;
...
registerSingleton(IMultiDiffSourceResolverService, class MultiDiffSourceResolverService {
    constructor() {
        this.registerResolver = unsupported;
        this.resolve = unsupported;
    }
}, 1 );
