...
import { isMacintosh, isWeb, isWindows, isLinux } from '../../base/common/platform.js';
import { ConfigurationMigrationWorkbenchContribution, DynamicWorkbenchSecurityConfiguration, workbenchConfigurationNodeBase, problemsConfigurationNodeBase, Extensions } from '../common/configuration.js';
...
(function registerConfiguration() {
    registerWorkbenchContribution2(ConfigurationMigrationWorkbenchContribution.ID, ConfigurationMigrationWorkbenchContribution, 4 );
    registerWorkbenchContribution2(DynamicWorkbenchSecurityConfiguration.ID, DynamicWorkbenchSecurityConfiguration, 3 );
        ...
        'properties': {
            ...
            ["workbench.editor.editorActionsLocation" ]: {
                ...
                'markdownEnumDescriptions': [
                    ( localizeWithPath(
                        'vs/workbench/browser/workbench.contribution',
                        { comment: ['{0} will be a setting name rendered as a link'], key: 'workbench.editor.editorActionsLocation.default' },
                    ...
                    ( localizeWithPath(
                        'vs/workbench/browser/workbench.contribution',
                        { comment: ['{0} will be a setting name rendered as a link'], key: 'workbench.editor.editorActionsLocation.titleBar' },
            ...
            'workbench.editor.wrapTabs': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'wrapTabs' },
            ...
            'workbench.editor.scrollToSwitchTabs': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'scrollToSwitchTabs' },
            ...
            'workbench.editor.highlightModifiedTabs': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'highlightModifiedTabs' },
            ...
            'workbench.editor.tabActionLocation': {
                ...
                markdownDescription: ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0} will be a setting name rendered as a link'], key: 'tabActionLocation' },
            ...
            'workbench.editor.tabSizing': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'tabSizing' },
            ...
            'workbench.editor.tabSizingFixedMinWidth': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'workbench.editor.tabSizingFixedMinWidth' },
            ...
            'workbench.editor.tabSizingFixedMaxWidth': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'workbench.editor.tabSizingFixedMaxWidth' },
            ...
            'window.density.editorTabHeight': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'workbench.editor.tabHeight' },
            ...
            'workbench.editor.pinnedTabSizing': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'pinnedTabSizing' },
            ...
            'workbench.editor.pinnedTabsOnSeparateRow': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'workbench.editor.pinnedTabsOnSeparateRow' },
            ...
            'workbench.editor.enablePreviewFromQuickOpen': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'enablePreviewFromQuickOpen' },
            ...
            'workbench.editor.enablePreviewFromCodeNavigation': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'enablePreviewFromCodeNavigation' },
            ...
            'workbench.editor.openPositioning': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1}, {2}, {3} will be a setting name rendered as a link'], key: 'editorOpenPositioning' },
            ...
            'workbench.editor.doubleClickTabToToggleEditorGroupSizes': {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['{0}, {1} will be a setting name rendered as a link'], key: 'doubleClickTabToToggleEditorGroupSizes' },
            ...
            ["workbench.activityBar.location" ]: {
                ...
                'markdownDescription': ( localizeWithPath(
                    'vs/workbench/browser/workbench.contribution',
                    { comment: ['This is the description for a setting'], key: 'activityBarLocation' },
                ...
                'enumDescriptions': [
                    ( localizeWithPath(
                        ...
                        "Show the Activity Bar to the side of the Primary Side Bar."
                    )),
                    ( localizeWithPath(
                        'vs/workbench/browser/workbench.contribution',
                        'workbench.activityBar.location.top',
                        "Show the Activity Bar on top of the Primary Side Bar."
                    )),
                    ( localizeWithPath(
                        'vs/workbench/browser/workbench.contribution',
            ...
            ["workbench.layoutControl.enabled" ]: {
                ...
                'markdownDescription': isWeb ?
                    ...
                    ( localizeWithPath(
                        'vs/workbench/browser/workbench.contribution',
                        { key: 'layoutControlEnabled', comment: ['{0}, {1} is a placeholder for a setting identifier.'] },
    ...
    let windowTitleDescription = ( localizeWithPath(
        'vs/workbench/browser/workbench.contribution',
        'windowTitle',
        ...
        'properties': {
            ...
            ["window.commandCenter" ]: {
                ...
                markdownDescription: isWeb ?
                    ...
                    ( localizeWithPath(
                        'vs/workbench/browser/workbench.contribution',
                        { key: 'window.commandCenter', comment: ['{0}, {1} is a placeholder for a setting identifier.'] },
            ...
            'window.menuBarVisibility': {
                ...
                'markdownEnumDescriptions': [
                    ...
                    isWeb ?
                        ...
                        ( localizeWithPath(
                            'vs/workbench/browser/workbench.contribution',
                            { key: 'window.menuBarVisibility.compact', comment: ['{0}, {1} is a placeholder for a setting identifier.'] },
...
( Registry.as(Extensions.ConfigurationMigration))
    .registerConfigurationMigrations([{
        key: 'workbench.activityBar.visible', migrateFn: (value) => {
            ...
            if (value === false) {
                result.push(["workbench.activityBar.location" , { value: "hidden"  }]);
            }
            return result;
        }
    }]);
( Registry.as(Extensions.ConfigurationMigration))
    .registerConfigurationMigrations([{
        ...
        key: "workbench.editor.showTabs" , migrateFn: (value) => {
            const results = [];
            if (typeof value === 'boolean') {
                value = value ? "multiple"  : "single" ;
                results.push(["workbench.editor.showTabs" , { value }]);
            }
            return results;
        }
    }, {
