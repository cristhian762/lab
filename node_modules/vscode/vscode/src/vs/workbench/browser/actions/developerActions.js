    ...
    run(accessor) {
        ...
        disposables.add(onKeyDown.event(e => {
            ...
            if (event.ctrlKey || event.altKey || event.metaKey || event.shiftKey
                ...
                || event.keyCode === 15  || event.keyCode === 17 ) {
                keyboardMarker.innerText = '';
                length = 0;
            }
...
class LogStorageAction extends Action2 {
    ...
    run(accessor) {
        ...
        storageService.log();
        dialogService.info(( localizeWithPath(
            'vs/workbench/browser/actions/developerActions',
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    async run(accessor) {
                    ...
                    if (value && (!environmentService.isBuilt  || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: ( localizeWithPath(
                                ...
                                "Scope: {0}, Target: {1}",
                                scope === -1  ? ( localizeWithPath('vs/workbench/browser/actions/developerActions', 'global', "Global")) : scope === 0  ? ( localizeWithPath('vs/workbench/browser/actions/developerActions', 'profile', "Profile")) : ( localizeWithPath('vs/workbench/browser/actions/developerActions', 'workspace', "Workspace")),
                                target === 1  ? ( localizeWithPath('vs/workbench/browser/actions/developerActions', 'machine', "Machine")) : ( localizeWithPath('vs/workbench/browser/actions/developerActions', 'user', "User"))
                            )),
                        });
                    }
                }
        ...
        const selectedItems = await ( new Promise(resolve => {
            ...
            picker.customLabel = ( localizeWithPath(
                'vs/workbench/browser/actions/developerActions',
            ...
            if (items.length === 0) {
                picker.description = ( localizeWithPath(
                    'vs/workbench/browser/actions/developerActions',
