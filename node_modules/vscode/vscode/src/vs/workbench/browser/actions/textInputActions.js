...
let TextInputActionsProvider = class TextInputActionsProvider extends Disposable {
    ...
    createActions() {
        return [
            (
            new Action('undo', ( localizeWithPath('vs/workbench/browser/actions/textInputActions', 'undo', "Undo")), undefined, true, async () => getActiveDocument().execCommand('undo'))),
            ( new Action('redo', ( localizeWithPath('vs/workbench/browser/actions/textInputActions', 'redo', "Redo")), undefined, true, async () => getActiveDocument().execCommand('redo'))),
            ( new Separator()),
            (
            new Action('editor.action.clipboardCutAction', ( localizeWithPath('vs/workbench/browser/actions/textInputActions', 'cut', "Cut")), undefined, true, async () => getActiveDocument().execCommand('cut'))),
            ( new Action('editor.action.clipboardCopyAction', ( localizeWithPath('vs/workbench/browser/actions/textInputActions', 'copy', "Copy")), undefined, true, async () => getActiveDocument().execCommand('copy'))),
            ( new Action('editor.action.clipboardPasteAction', ( localizeWithPath('vs/workbench/browser/actions/textInputActions', 'paste', "Paste")), undefined, true, async (element) => {
                if (isNative) {
            ...
            ( new Separator()),
            (
            new Action('editor.action.selectAll', ( localizeWithPath('vs/workbench/browser/actions/textInputActions', 'selectAll', "Select All")), undefined, true, async () => getActiveDocument().execCommand('selectAll')))
        ];
    }
    registerListeners() {
