...
const panelLeftOffIcon = registerIcon('panel-left-off', Codicon.layoutSidebarLeftOff, ( localizeWithPath(
    'vs/workbench/browser/actions/layoutActions',
    'panelLeftOff',
...
const panelRightOffIcon = registerIcon('panel-right-off', Codicon.layoutSidebarRightOff, ( localizeWithPath(
    'vs/workbench/browser/actions/layoutActions',
    'panelRightOff',
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, ( localize2WithPath(
            'vs/workbench/browser/actions/layoutActions',
            'moveSidebarRight',
...
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarLeftAction.ID, ( localize2WithPath(
            'vs/workbench/browser/actions/layoutActions',
            'moveSidebarLeft',
...
class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        super("workbench.editor.showTabs" , "none" , title, HideEditorTabsAction.ID, precondition);
    }
}
class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        super("zenMode.showTabs" , "none" , title, ZenHideEditorTabsAction.ID, precondition);
    }
}
class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        super("workbench.editor.showTabs" , "multiple" , title, ShowMultipleEditorTabsAction.ID, precondition);
    }
}
class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        super("zenMode.showTabs" , "multiple" , title, ZenShowMultipleEditorTabsAction.ID, precondition);
    }
}
class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        super("workbench.editor.showTabs" , "single" , title, ShowSingleEditorTabAction.ID, precondition);
    }
}
class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        super("zenMode.showTabs" , "single" , title, ZenShowSingleEditorTabAction.ID, precondition);
    }
}
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localizeWithPath('vs/workbench/browser/actions/layoutActions', 'tabBar', "Tab Bar")),
    group: '3_workbench_layout_move',
    order: 10,
...
if (isWindows || isLinux || isWeb) {
    ...
    for (const menuId of [MenuId.TitleBarContext, MenuId.TitleBarTitleContext]) {
        MenuRegistry.appendMenuItem(menuId, {
            ...
            when: ( ContextKeyExpr.and(( IsAuxiliaryWindowFocusedContext.toNegated()), ( ContextKeyExpr.notEquals(TitleBarStyleContext.key, "native" )), ( IsMainWindowFullscreenContext.negate()))),
            group: '2_config',
            order: 0
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2WithPath('vs/workbench/browser/actions/layoutActions', 'moveView', "Move View")),
            category: Categories.View,
            f1: true
        });
    }
...
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( ContextKeyExpr.notEquals('config.workbench.activityBar.location', 'hidden')), ( localizeWithPath(
        'vs/workbench/browser/actions/layoutActions',
        'activityBar',
        "Activity Bar"
...
const MiscLayoutOptions = [
    CreateOptionLayoutItem('workbench.action.toggleFullScreen', IsMainWindowFullscreenContext, ( localizeWithPath('vs/workbench/browser/actions/layoutActions', 'fullscreen', "Full Screen")), fullscreenIcon),
    ...
    CreateOptionLayoutItem('workbench.action.toggleCenteredLayout', IsMainEditorCenteredLayoutContext, ( localizeWithPath(
        'vs/workbench/browser/actions/layoutActions',
        'centeredLayout',
        "Centered Layout"
    )), centerLayoutIcon),
