...
import { IsWebContext, IsDevelopmentContext, IsIOSContext, IsMacNativeContext } from '../../../platform/contextkey/common/contextkeys.js';
...
import { getActiveWindow, getActiveElement } from '../../../base/browser/dom.js';
...
class BaseOpenRecentAction extends Action2 {
    ...
    async run(accessor) {
        ...
        let keyMods;
        const workspaceSeparator = { type: 'separator', label: hasWorkspaces ? ( localizeWithPath(
            'vs/workbench/browser/actions/windowActions',
            'workspacesAndFolders',
            "folders & workspaces"
        )) : ( localizeWithPath('vs/workbench/browser/actions/windowActions', 'folders', "folders")) };
        const fileSeparator = { type: 'separator', label: ( localizeWithPath('vs/workbench/browser/actions/windowActions', 'files', "files")) };
        const picks = [workspaceSeparator, ...workspacePicks, fileSeparator, ...filePicks];
        const pick = await quickInputService.pick(picks, {
            contextKey: inRecentFilesPickerContextKey,
            activeItem: [...workspacePicks, ...filePicks][autoFocusSecondEntry ? 1 : 0],
            placeHolder: isMacintosh ? ( localizeWithPath(
                'vs/workbench/browser/actions/windowActions',
            ...
            onDidTriggerItemButton: async (context) => {
                if (context.button === this.removeFromRecentlyOpened) {
                    ...
                    const { confirmed } = await dialogService.confirm({
                        title: isDirtyWorkspace ? ( localizeWithPath(
                            'vs/workbench/browser/actions/windowActions',
                            'dirtyWorkspace',
                            "Workspace with Unsaved Files"
                        )) : ( localizeWithPath(
                        ...
                        message: isDirtyWorkspace ? ( localizeWithPath(
                            'vs/workbench/browser/actions/windowActions',
                        ...
                        detail: isDirtyWorkspace ? ( localizeWithPath(
                            'vs/workbench/browser/actions/windowActions',
    ...
    toQuickPick(modelService, languageService, labelService, recent, isDirty) {
        ...
        return {
            iconClasses,
            label: name,
            ariaLabel: isDirty ? isWorkspace ? ( localizeWithPath(
                'vs/workbench/browser/actions/windowActions',
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2WithPath('vs/workbench/browser/actions/windowActions', 'about', "About")),
                mnemonicTitle: ( localizeWithPath(
                    'vs/workbench/browser/actions/windowActions',
...
class NewWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2WithPath('vs/workbench/browser/actions/windowActions', 'newWindow', "New Window")),
                mnemonicTitle: ( localizeWithPath(
                    'vs/workbench/browser/actions/windowActions',
            ...
            keybinding: {
                weight: 200 ,
                primary: isWeb ? ((isWindows ? KeyChord(2048  | 41 , 1024  | 44 ) : 2048  | 512  | 1024  | 44) ) : 2048  | 1024  | 44 ,
                secondary: isWeb ? [2048  | 1024  | 44 ] : undefined
            },
            menu: {
