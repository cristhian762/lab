...
import { breadcrumbsPickerBackground, widgetShadow, widgetBorder } from '../../../../platform/theme/common/colorRegistry.js';
import { isWorkspaceFolder, isWorkspace, IWorkspaceContextService } from '../../../../platform/workspace/common/workspace.js';
...
let FileRenderer = class FileRenderer {
    constructor(_labels, _hoverDelegate, _configService) {
...
let BreadcrumbsFilePicker = class BreadcrumbsFilePicker extends BreadcrumbsPicker {
    ...
    _createTree(container) {
        ...
        return this._instantiationService.createInstance(WorkbenchAsyncDataTree, 'BreadcrumbsFilePicker', container, ( new FileVirtualDelegate()), [this._instantiationService.createInstance(FileRenderer, labels, nativeHoverDelegate)], this._instantiationService.createInstance(FileDataSource), {
