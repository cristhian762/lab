...
let AbstractTextEditor = class AbstractTextEditor extends AbstractEditorWithViewState {
    ...
    computeAriaLabel() {
        return this._input ? computeEditorAriaLabel(this._input, undefined, this.group, this.editorGroupService.count) : ( localizeWithPath('vs/workbench/browser/parts/editor/textEditor', 'editor', "Editor"));
    }
