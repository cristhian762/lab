...
const auxiliaryBarRightIcon = registerIcon('auxiliarybar-right-layout-icon', Codicon.layoutSidebarRight, ( localizeWithPath(
...
const auxiliaryBarRightOffIcon = registerIcon('auxiliarybar-right-off-layout-icon', Codicon.layoutSidebarRightOff, ( localizeWithPath(
    'vs/workbench/browser/parts/auxiliarybar/auxiliaryBarActions',
    'toggleAuxiliaryIconRightOn',
    'Icon to toggle the auxiliary bar on in its right position.'
)));
const auxiliaryBarLeftIcon = registerIcon('auxiliarybar-left-layout-icon', Codicon.layoutSidebarLeft, ( localizeWithPath(
    'vs/workbench/browser/parts/auxiliarybar/auxiliaryBarActions',
    'toggleAuxiliaryIconLeft',
    'Icon to toggle the auxiliary bar in its left position.'
)));
const auxiliaryBarLeftOffIcon = registerIcon('auxiliarybar-left-off-layout-icon', Codicon.layoutSidebarLeftOff, ( localizeWithPath(
    'vs/workbench/browser/parts/auxiliarybar/auxiliaryBarActions',
