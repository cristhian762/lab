...
import { MenuRegistry, MenuId, SubmenuItemAction, registerAction2, MenuItemAction, Action2, IMenuService } from '../../../../platform/actions/common/actions.js';
...
import { Direction } from '../../../../base/browser/ui/menu/menu.js';
...
let CustomMenubarControl = class CustomMenubarControl extends MenubarControl {
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case "idle" :
                return ( new Action('update.check', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
                    { key: 'checkForUpdates', comment: ['&& denotes a mnemonic'] },
                    "Check for &&Updates..."
                )), undefined, true, () => this.updateService.checkForUpdates(true)));
            case "checking for updates" :
                return ( new Action('update.checking', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
                    'checkingForUpdates',
                    "Checking for Updates..."
                )), undefined, false));
            case "available for download" :
                return ( new Action('update.downloadNow', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
                    { key: 'download now', comment: ['&& denotes a mnemonic'] },
                    "D&&ownload Update"
                )), undefined, true, () => this.updateService.downloadUpdate()));
            case "downloading" :
                return ( new Action('update.downloading', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
                    'DownloadingUpdate',
                    "Downloading Update..."
                )), undefined, false));
            case "downloaded" :
                return ( new Action('update.install', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
                    { key: 'installUpdate...', comment: ['&& denotes a mnemonic'] },
                    "Install &&Update..."
                )), undefined, true, () => this.updateService.applyUpdate()));
            case "updating" :
                return ( new Action('update.updating', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
                    'installingUpdate',
                    "Installing Update..."
                )), undefined, false));
            case "ready" :
                return ( new Action('update.restart', ( localizeWithPath(
                    'vs/workbench/browser/parts/titlebar/menubarControl',
