        ...
        for (const resource of resources) {
            ...
            if (workingCopyResult?.condition === condition) {
                if (workingCopyResult.workingCopy.isDirty() &&
                    this.filesConfigurationService.getAutoSaveMode(workingCopyResult.workingCopy.resource).mode !== 0 ) {
                ...
                if (editorResult?.condition === condition &&
                    ...
                    this.filesConfigurationService.getAutoSaveMode(editorResult.editor.editor).mode !== 0 ) {
        ...
        const handle = setTimeout(() => {
            ...
            if (workingCopy.isDirty()) {
                ...
                if (autoSaveMode.mode !== 0 ) {
                    ...
                    this.waitingOnConditionAutoSaveWorkingCopies.set(workingCopy.resource, { workingCopy, reason: 2 , condition: autoSaveMode.reason });
                }
            }
        }, autoSaveAfterDelay);
