...
import { MenuRegistry, MenuId, registerAction2, IMenuService, Action2 } from '../../../../platform/actions/common/actions.js';
...
import { ViewContainerLocationToString, IViewDescriptorService, ViewVisibilityState } from '../../../common/views.js';
...
MenuRegistry.appendMenuItem(MenuId.ViewContainerTitle, {
    ...
    title: ( localizeWithPath('vs/workbench/browser/parts/views/viewPaneContainer', 'views', "Views")),
    order: 1,
...
let ViewPaneContainer = class ViewPaneContainer extends Component {
    ...
    isViewMergedWithContainer() {
        ...
        if (location === 0  && !this.layoutService.isVisible("workbench.parts.activitybar" ) && this.configurationService.getValue("workbench.activityBar.location" ) === "top" ) {
            return false;
        }
