...
let WindowTitle = class WindowTitle extends Disposable {
    ...
    get fileName() {
        ...
        const fileName = activeEditor.getTitle(0 );
    ...
    getWindowTitle() {
        ...
        let titleTemplate = this.configurationService.getValue("window.title" );
        if (typeof titleTemplate !== 'string') {
            titleTemplate = defaultWindowTitle;
        }
        let separator = this.configurationService.getValue("window.titleSeparator" );
