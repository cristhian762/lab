...
import { append, $, prepend, asCSSUrl, show, hide, trackFocus, clearNode, getTotalHeight, getLargestChildWidth, getActiveElement } from '../../../../base/browser/dom.js';
...
import { MenuId, MenuRegistry, registerAction2, Action2, IMenuService } from '../../../../platform/actions/common/actions.js';
...
import { FolderThemeIcon, FileThemeIcon, IThemeService } from '../../../../platform/theme/common/themeService.js';
...
let TreeRenderer = class TreeRenderer extends Disposable {
    ...
    constructor(treeViewId, menus, labels, actionViewItemProvider, aligner, checkboxStateHandler, manuallyManageCheckboxes, themeService, configurationService, labelService, treeViewsService, contextKeyService, instantiationService) {
        ...
        this._hoverDelegate = this._register(instantiationService.createInstance(WorkbenchHoverDelegate, 'mouse', false, { persistence: undefined  }));
