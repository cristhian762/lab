...
import { badgeForeground, badgeBackground, contrastBorder } from '../../../platform/theme/common/colorRegistry.js';
...
let ManageExtensionAction = class ManageExtensionAction extends Action {
    constructor(commandService) {
        super('activitybar.manage.extension', ( localizeWithPath(
            'vs/workbench/browser/parts/compositeBarActions',
            'manageExtension',
            "Manage Extension"
        )));
...
let CompositeActionViewItem = class CompositeActionViewItem extends CompositeBarActionViewItem {
    ...
    showContextMenu(container) {
        ...
        if (isPinned) {
            this.toggleCompositePinnedAction.label = ( localizeWithPath(
                'vs/workbench/browser/parts/compositeBarActions',
                'hide',
                "Hide '{0}'",
                this.compositeBarActionItem.name
        ...
        if (isBadgeEnabled) {
            this.toggleCompositeBadgeAction.label = ( localizeWithPath(
                'vs/workbench/browser/parts/compositeBarActions',
                'hideBadge',
                "Hide Badge"
            ));
...
class ToggleCompositePinnedAction extends Action {
    constructor(activity, compositeBar) {
        super('show.toggleCompositePinned', activity ? activity.name : ( localizeWithPath(
            'vs/workbench/browser/parts/compositeBarActions',
            'toggle',
            "Toggle View Pinned"
        )));
...
class ToggleCompositeBadgeAction extends Action {
    constructor(compositeBarActionItem, compositeBar) {
        super('show.toggleCompositeBadge', compositeBarActionItem ? compositeBarActionItem.name : ( localizeWithPath(
            'vs/workbench/browser/parts/compositeBarActions',
            'toggleBadge',
            "Toggle View Badge"
        )));
