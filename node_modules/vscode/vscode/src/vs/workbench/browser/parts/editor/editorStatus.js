...
import { IMarkerData, MarkerSeverity, IMarkerService } from '../../../../platform/markers/common/markers.js';
...
const nlsSingleSelectionRange = ( localizeWithPath(
    'vs/workbench/browser/parts/editor/editorStatus',
    'singleSelectionRange',
    "Ln {0}, Col {1} ({2} selected)"
));
const nlsSingleSelection = ( localizeWithPath(
    'vs/workbench/browser/parts/editor/editorStatus',
    'singleSelection',
    "Ln {0}, Col {1}"
));
const nlsMultiSelectionRange = ( localizeWithPath(
    'vs/workbench/browser/parts/editor/editorStatus',
    'multiSelectionRange',
    "{0} selections ({1} characters selected)"
));
const nlsMultiSelection = ( localizeWithPath(
    'vs/workbench/browser/parts/editor/editorStatus',
    'multiSelection',
    "{0} selections"
));
const nlsEOLLF = ( localizeWithPath(
    'vs/workbench/browser/parts/editor/editorStatus',
    'endOfLineLineFeed',
    "LF"
));
const nlsEOLCRLF = ( localizeWithPath(
    'vs/workbench/browser/parts/editor/editorStatus',
...
let EditorStatus = class EditorStatus extends Disposable {
    ...
    async showIndentationPicker() {
        ...
        if (!activeTextEditorControl) {
            return this.quickInputService.pick([{ label: ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
                'noEditor',
        ...
        picks.splice(3, 0, { type: 'separator', label: ( localizeWithPath(
            'vs/workbench/browser/parts/editor/editorStatus',
            'indentConvert',
            "convert file"
        )) });
        ...
        const action = await this.quickInputService.pick(picks, { placeHolder: ( localizeWithPath(
            'vs/workbench/browser/parts/editor/editorStatus',
            'pickAction',
            "Select Action"
        )), matchOnDetail: true });
    ...
    onEOLChange(editorWidget) {
        ...
        if (editorWidget && !editorWidget.getOption(91 )) {
        ...
        if (this.hasToUpdateStatus(previousMarker, this.currentMarker)) {
            if (this.currentMarker) {
                ...
                if (!this.statusBarEntryAccessor.value) {
                    this.statusBarEntryAccessor.value = this.statusbarService.addEntry({ name: ( localizeWithPath(
                        'vs/workbench/browser/parts/editor/editorStatus',
                        'currentProblem',
                        "Current Problem"
                    )), text: '', ariaLabel: '' }, 'statusbar.currentProblem', 0 );
                }
                this.statusBarEntryAccessor.value.update({ name: ( localizeWithPath(
                    'vs/workbench/browser/parts/editor/editorStatus',
                    'currentProblem',
                    "Current Problem"
                )), text, ariaLabel: text });
...
let ShowLanguageExtensionsAction = class ShowLanguageExtensionsAction extends Action {
    ...
    constructor(fileExtension, commandService, galleryService) {
        super(ShowLanguageExtensionsAction_1.ID, ( localizeWithPath(
            'vs/workbench/browser/parts/editor/editorStatus',
...
class ChangeLanguageAction extends Action2 {
    ...
    async run(accessor) {
        ...
        if (hasLanguageSupport && resource) {
            ...
            configureLanguageSettings = { label: ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
            ...
            configureLanguageAssociations = { label: ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
    ...
    configureFileAssociation(resource, languageService, quickInputService, configurationService) {
        ...
        const picks = ( languages.map(({ languageName, languageId }) => {
            return {
                ...
                label: languageName,
                iconClasses: getIconClassesForLanguageId(languageId),
                description: (languageId === currentAssociation) ? ( localizeWithPath(
                    'vs/workbench/browser/parts/editor/editorStatus',
                    'currentAssociation',
                    "Current Association"
                )) : undefined
        ...
        setTimeout(async () => {
            const language = await quickInputService.pick(picks, { placeHolder: ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
...
class ChangeEOLAction extends Action2 {
    ...
    async run(accessor) {
        ...
        const eol = await quickInputService.pick(EOLOptions, { placeHolder: ( localizeWithPath(
            'vs/workbench/browser/parts/editor/editorStatus',
            'pickEndOfLine',
            "Select End of Line Sequence"
...
class ChangeEncodingAction extends Action2 {
    ...
    async run(accessor) {
        ...
        const saveWithEncodingPick = { label: ( localizeWithPath(
            'vs/workbench/browser/parts/editor/editorStatus',
            'saveWithEncoding',
            "Save with Encoding"
        )) };
        const reopenWithEncodingPick = { label: ( localizeWithPath(
            'vs/workbench/browser/parts/editor/editorStatus',
            'reopenWithEncoding',
        ...
        if (encodingSupport instanceof UntitledTextEditorInput) {
            ...
            action = await quickInputService.pick([reopenWithEncodingPick, saveWithEncodingPick], { placeHolder: ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
                'pickAction',
                "Select Action"
            )), matchOnDetail: true });
        ...
        if (guessedEncoding && configuredEncoding !== guessedEncoding && SUPPORTED_ENCODINGS[guessedEncoding]) {
            ...
            picks.unshift({ id: guessedEncoding, label: SUPPORTED_ENCODINGS[guessedEncoding].labelLong, description: ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
                'guessedEncoding',
        ...
        const encoding = await quickInputService.pick(picks, {
            placeHolder: isReopenWithEncoding ? ( localizeWithPath(
                'vs/workbench/browser/parts/editor/editorStatus',
