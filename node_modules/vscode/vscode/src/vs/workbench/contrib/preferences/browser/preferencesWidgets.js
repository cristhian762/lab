...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'userSettings',
            "User"
        ));
        this.userRemoteSettings.label = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'userSettingsRemote',
            "Remote"
        )) + (hostLabel ? ` [${hostLabel}]` : '');
        this.workspaceSettings.label = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'workspaceSettings',
            "Workspace"
        ));
        this.folderSettingsAction.label = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'folderSettings',
            "Folder"
        ));
    ...
    create(parent) {
        ...
        this.userLocalSettings.tooltip = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'userSettings',
            "User"
        ));
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'userSettingsRemote',
            "Remote"
        )) + (hostLabel ? ` [${hostLabel}]` : '');
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = ( localizeWithPath(
            'vs/workbench/contrib/preferences/browser/preferencesWidgets',
            'workspaceSettings',
            "Workspace"
        ));
