...
import { MenuId, MenuRegistry, IMenuService } from '../../../../platform/actions/common/actions.js';
import { createAndFillInActionBarActions, createActionViewItem } from '../../../../platform/actions/browser/menuEntryActionViewItem.js';
import { TUNNEL_VIEW_ID, TunnelType, IRemoteExplorerService, TunnelEditId } from '../../../services/remote/common/remoteExplorerService.js';
...
import { getDefaultHoverDelegate } from '../../../../base/browser/ui/hover/hoverDelegate.js';
var TunnelPanel_1;
...
class TunnelItem {
    ...
    get iconTooltip() {
        ...
        if (!isAdd) {
            return `${this.processDescription ? ( localizeWithPath(
                'vs/workbench/contrib/remote/browser/tunnelView',
    ...
    get portTooltip() {
        const isAdd = this.tunnelType === TunnelType.Add;
        if (!isAdd) {
            return `${this.name ? ( localizeWithPath(
                'vs/workbench/contrib/remote/browser/tunnelView',
...
const TunnelViewFocusContextKey = ( new RawContextKey('tunnelViewFocus', false, ( localizeWithPath(
    'vs/workbench/contrib/remote/browser/tunnelView',
    'tunnel.focusContext',
...
let TunnelPanel = class TunnelPanel extends ViewPane {
    ...
    static { this.TITLE = ( localize2WithPath('vs/workbench/contrib/remote/browser/tunnelView', 'remote.tunnel', "Ports")); }
...
( (function(LabelTunnelAction) {
    ...
    LabelTunnelAction.LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.label',
        "Set Port Label"
    ));
...
( (function(ForwardPortAction) {
    ...
    ForwardPortAction.LABEL = ( localize2WithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.forward',
        "Forward a Port"
    ));
    ForwardPortAction.TREEITEM_LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.forwardItem',
        "Forward Port"
    ));
    const forwardPrompt = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
...
( (function(ClosePortAction) {
    ...
    ClosePortAction.LABEL = ( localize2WithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.close',
    ...
    function commandPaletteHandler() {
        return async (accessor) => {
            ...
            const result = await quickInputService.pick(picks, { placeHolder: ( localizeWithPath(
                'vs/workbench/contrib/remote/browser/tunnelView',
...
( (function(OpenPortInBrowserAction) {
    ...
    OpenPortInBrowserAction.LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.open',
        "Open in Browser"
    ));
...
( (function(OpenPortInPreviewAction) {
    ...
    OpenPortInPreviewAction.LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
...
( (function(OpenPortInBrowserCommandPaletteAction) {
    ...
    OpenPortInBrowserCommandPaletteAction.LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
    ...
    function handler() {
        return async (accessor, arg) => {
            ...
            const picked = await quickPickService.pick(options, { placeHolder: ( localizeWithPath(
                'vs/workbench/contrib/remote/browser/tunnelView',
...
( (function(CopyAddressAction) {
    ...
    CopyAddressAction.INLINE_LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.copyAddressInline',
        "Copy Local Address"
    ));
    CopyAddressAction.COMMANDPALETTE_LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
    ...
    function commandPaletteHandler() {
        return async (accessor, arg) => {
            ...
            const result = await quickInputService.pick(makeTunnelPicks(tunnels, remoteExplorerService, tunnelService), { placeHolder: ( localizeWithPath(
                'vs/workbench/contrib/remote/browser/tunnelView',
...
( (function(ChangeLocalPortAction) {
    ...
    ChangeLocalPortAction.LABEL = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
    ...
    function validateInput(tunnelService, value, canElevate) {
        if (!value.match(/^[0-9]+$/)) {
            return { content: ( localizeWithPath(
                'vs/workbench/contrib/remote/browser/tunnelView',
...
( (function(SetTunnelProtocolAction) {
    ...
    SetTunnelProtocolAction.LABEL_HTTP = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
        'remote.tunnel.protocolHttp',
        "HTTP"
    ));
    SetTunnelProtocolAction.LABEL_HTTPS = ( localizeWithPath(
        'vs/workbench/contrib/remote/browser/tunnelView',
