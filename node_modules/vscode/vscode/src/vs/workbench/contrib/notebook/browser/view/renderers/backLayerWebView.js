...
import { WebviewOriginStore, IWebviewService } from '../../../../webview/browser/webview.js';
...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': ( localizeWithPath(
            ...
            'notebook-cell-renderer-not-found-error': ( localizeWithPath('vs/workbench/contrib/notebook/browser/view/renderers/backLayerWebView', {
                key: 'notebook.error.rendererNotFound',
                comment: ['$0 is a placeholder for the mime type']
            }, "No renderer found for '$0'")),
            'notebook-cell-renderer-fallbacks-exhausted': ( localizeWithPath('vs/workbench/contrib/notebook/browser/view/renderers/backLayerWebView', {
    ...
    getRendererData() {
        return ( this.notebookService.getRenderers().map((renderer) => {
            ...
            return {
                ...
                messaging: renderer.messaging !== "never" ,
