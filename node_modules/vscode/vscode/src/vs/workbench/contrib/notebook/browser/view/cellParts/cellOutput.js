...
let CellOutputElement = class CellOutputElement extends Disposable {
    ...
    async _attachToolbar(outputItemDiv, notebookTextModel, kernel, index, mimeTypes) {
        ...
        const pickAction = ( new Action('notebook.output.pickMimetype', ( localizeWithPath(
            'vs/workbench/contrib/notebook/browser/view/cellParts/cellOutput',
            'pickMimeType',
            "Change Presentation"
        )), ThemeIcon.asClassName(mimetypeIcon), undefined, async (_context) => this._pickActiveMimeTypeRenderer(outputItemDiv, notebookTextModel, kernel, this.output)));
