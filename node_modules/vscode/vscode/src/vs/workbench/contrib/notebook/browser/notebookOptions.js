...
class NotebookOptions extends Disposable {
    ...
    _migrateDeprecatedSetting(deprecatedKey, key) {
        ...
        if (deprecatedSetting.application !== undefined) {
            this.configurationService.updateValue(deprecatedKey, undefined, 1 );
            this.configurationService.updateValue(key, deprecatedSetting.application.value, 1 );
        }
        if (deprecatedSetting.user !== undefined) {
            this.configurationService.updateValue(deprecatedKey, undefined, 2 );
            this.configurationService.updateValue(key, deprecatedSetting.user.value, 2 );
        }
        if (deprecatedSetting.userLocal !== undefined) {
            this.configurationService.updateValue(deprecatedKey, undefined, 3 );
            this.configurationService.updateValue(key, deprecatedSetting.userLocal.value, 3 );
        }
        if (deprecatedSetting.userRemote !== undefined) {
            this.configurationService.updateValue(deprecatedKey, undefined, 4 );
            this.configurationService.updateValue(key, deprecatedSetting.userRemote.value, 4 );
        }
        if (deprecatedSetting.workspace !== undefined) {
            this.configurationService.updateValue(deprecatedKey, undefined, 5 );
            this.configurationService.updateValue(key, deprecatedSetting.workspace.value, 5 );
        }
        if (deprecatedSetting.workspaceFolder !== undefined) {
            this.configurationService.updateValue(deprecatedKey, undefined, 6 );
            this.configurationService.updateValue(key, deprecatedSetting.workspaceFolder.value, 6 );
        }
    }
