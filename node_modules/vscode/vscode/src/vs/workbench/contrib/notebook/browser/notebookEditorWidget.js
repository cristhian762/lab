...
import { registerColor, transparent, listInactiveSelectionBackground, focusBorder, errorForeground, foreground, contrastBorder, scrollbarSliderBackground, scrollbarSliderHoverBackground, scrollbarSliderActiveBackground } from '../../../../platform/theme/common/colorRegistry.js';
...
import { SelectionStateType, CellKind, RENDERER_NOT_AVAILABLE } from '../common/notebookCommon.js';
import { NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_OUPTUT_INPUT_FOCUSED, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_CURSOR_NAVIGATION_MODE } from '../common/notebookContextKeys.js';
...
import { NotebookCellOutlineProvider } from './viewModel/notebookOutlineProvider.js';
...
let NotebookEditorWidget = class NotebookEditorWidget extends Disposable {
    ...
    constructor(creationOptions, dimension, instantiationService, editorGroupsService, notebookRendererMessaging, notebookEditorService, notebookKernelService, _notebookService, configurationService, contextKeyService, layoutService, contextMenuService, telemetryService, notebookExecutionService, notebookExecutionStateService, editorProgressService, logService, keybindingService, codeEditorService) {
        ...
        this._notebookOutline = this._register(this.instantiationService.createInstance(NotebookCellOutlineProvider, this, 4 ));
    ...
    _createCellList() {
        ...
        this._register(this.configurationService.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration("accessibility.verbosity.notebook" )) {
        ...
        if (cellOptions) {
            ...
            if (cell) {
                ...
                if (selection) {
                    ...
                    this._list.revealCell(cell, options?.cellRevealType ?? 4 );
                }
    ...
    revealInView(cell) {
        return this._list.revealCell(cell, 1 );
    }
    revealInViewAtTop(cell) {
        this._list.revealCell(cell, 2 );
    }
    revealInCenter(cell) {
        this._list.revealCell(cell, 3 );
    }
    async revealInCenterIfOutsideViewport(cell) {
        await this._list.revealCell(cell, 4 );
    }
    revealFirstLineIfOutsideViewport(cell) {
        this._list.revealCell(cell, 6 );
    }
    ...
    async createOutput(cell, output, offset, createWhenIdle) {
        this._insetModifyQueueByOutputId.queue(output.source.model.outputId, async () => {
            ...
            if (!existingOutput
                || ((!existingOutput.renderer && output.type === 1) )) {
                if (createWhenIdle) {
...
registerColor('notebook.focusedEditorBorder', {
    light: focusBorder,
    dark: focusBorder,
    hcDark: focusBorder,
    hcLight: focusBorder
...
const cellStatusIconSuccess = registerColor('notebookStatusSuccessIcon.foreground', {
...
const runningCellRulerDecorationColor = registerColor('notebookEditorOverviewRuler.runningCellForeground', {
    light: debugIconStartForeground,
    dark: debugIconStartForeground,
    hcDark: debugIconStartForeground,
    hcLight: debugIconStartForeground
...
const cellStatusIconError = registerColor('notebookStatusErrorIcon.foreground', {
...
registerColor('notebookStatusRunningIcon.foreground', {
    light: foreground,
    dark: foreground,
    hcDark: foreground,
    hcLight: foreground
...
registerColor('notebook.outputContainerBorderColor', {
    dark: null,
    light: null,
    hcDark: null,
    hcLight: null
...
registerColor('notebook.outputContainerBackgroundColor', {
    dark: null,
    light: null,
    hcDark: null,
    hcLight: null
...
const focusedCellBackground = registerColor('notebook.focusedCellBackground', {
    dark: null,
    light: null,
    hcDark: null,
    hcLight: null
...
registerColor('notebook.focusedCellBorder', {
    dark: focusBorder,
    light: focusBorder,
    hcDark: focusBorder,
    hcLight: focusBorder
...
registerColor('notebook.inactiveFocusedCellBorder', {
    dark: notebookCellBorder,
    light: notebookCellBorder,
...
registerColor('notebookScrollbarSlider.background', {
...
registerColor('notebookScrollbarSlider.hoverBackground', {
...
registerColor('notebookScrollbarSlider.activeBackground', {
