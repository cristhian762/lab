...
import { WorkbenchList, IListService } from '../../../../../platform/list/browser/listService.js';
import { CellEditState, CellFocusMode, CellRevealRangeType, CursorAtBoundary, CursorAtLineBoundary } from '../notebookBrowser.js';
...
let NotebookCellList = class NotebookCellList extends WorkbenchList {
    ...
    setHiddenAreas(_ranges, triggerViewUpdate) {
        ...
        const hiddenAreaIds = ( newRanges.map(
            range => this._viewModel.setTrackedRange(null, range, 3 )
        )).filter(id => id !== null);
