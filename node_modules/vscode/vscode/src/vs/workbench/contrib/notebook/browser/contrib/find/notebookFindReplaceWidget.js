...
const NLS_FIND_INPUT_LABEL = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'label.find',
    "Find"
));
const NLS_FIND_INPUT_PLACEHOLDER = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'placeholder.find',
    "Find"
));
...
const NLS_CLOSE_BTN_LABEL = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'label.closeButton',
    "Close"
));
...
const NLS_REPLACE_INPUT_LABEL = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'label.replace',
    "Replace"
));
...
registerIcon('find-filter', Codicon.filter, ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'findFilterIcon',
    'Icon for Find Filter in find widget.'
)));
const NOTEBOOK_FIND_FILTERS = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'notebook.find.filter.filterAction',
    "Find Filters"
));
const NOTEBOOK_FIND_IN_MARKUP_INPUT = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'notebook.find.filter.findInMarkupInput',
    "Markdown Source"
));
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'notebook.find.filter.findInMarkupPreview',
    "Rendered Markdown"
));
const NOTEBOOK_FIND_IN_CODE_INPUT = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
    'notebook.find.filter.findInCodeInput',
    "Code Cell Source"
));
const NOTEBOOK_FIND_IN_CODE_OUTPUT = ( localizeWithPath(
    'vs/workbench/contrib/notebook/browser/contrib/find/notebookFindReplaceWidget',
...
let SimpleFindReplaceWidget = class SimpleFindReplaceWidget extends Widget {
    constructor(_contextViewService, contextKeyService, _configurationService, contextMenuService, instantiationService, _state = ( new FindReplaceState()), _notebookEditor) {
        super();
