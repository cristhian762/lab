...
import { NOTEBOOK_CELL_LIST_FOCUSED, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_CELL_TYPE, NOTEBOOK_CELL_MARKDOWN_EDIT_MODE, NOTEBOOK_CELL_EDITABLE, NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_USE_CONSOLIDATED_OUTPUT_BUTTON, NOTEBOOK_HAS_OUTPUTS, NOTEBOOK_IS_ACTIVE_EDITOR } from '../../common/notebookContextKeys.js';
...
registerAction2(class DeleteCellAction extends NotebookCellAction {
    ...
    async runWithContext(accessor, context) {
        ...
        if (runState === NotebookCellExecutionState.Executing && configService.getValue(NotebookSetting.confirmDeleteRunningCell)) {
            ...
            const primaryButton = ( localizeWithPath(
                'vs/workbench/contrib/notebook/browser/controller/editActions',
                'confirmDeleteButton',
                "Delete"
            ));
...
registerAction2(class ChangeCellLanguageAction extends NotebookCellAction {
    ...
    async showLanguagePicker(accessor, context) {
        ...
        const selection = await quickInputService.pick(picks, { placeHolder: ( localizeWithPath(
            'vs/workbench/contrib/notebook/browser/controller/editActions',
...
registerAction2(class SelectNotebookIndentation extends NotebookAction {
    ...
    async showNotebookIndentationPicker(accessor, context) {
        ...
        if (!activeNotebook || activeNotebook.isDisposed) {
            return quickInputService.pick([{ label: ( localizeWithPath(
                'vs/workbench/contrib/notebook/browser/controller/editActions',
                'noNotebookEditor',
        ...
        const action = await quickInputService.pick(picks, { placeHolder: ( localizeWithPath(
            'vs/workbench/contrib/notebook/browser/controller/editActions',
            'pickAction',
            "Select Action"
        )), matchOnDetail: true });
