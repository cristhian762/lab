...
const CONTEXT_IN_DEBUG_MODE = ( new RawContextKey('inDebugMode', false, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/debug/common/debug',
    'inDebugMode',
    "True when debugging, false otherwise."
)) }));
const CONTEXT_IN_DEBUG_REPL = ( new RawContextKey('inDebugRepl', false, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/debug/common/debug',
    'inDebugRepl',
...
const CONTEXT_VARIABLES_FOCUSED = ( new RawContextKey('variablesFocused', true, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/debug/common/debug',
    'variablesFocused',
...
const CONTEXT_BREAKPOINTS_EXIST = ( new RawContextKey('breakpointsExist', false, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/debug/common/debug',
    'breakpointsExist',
...
const CONTEXT_MULTI_SESSION_REPL = ( new RawContextKey('multiSessionRepl', false, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/debug/common/debug',
    'multiSessionRepl',
    "True when there is more than 1 debug console."
)) }));
const CONTEXT_MULTI_SESSION_DEBUG = ( new RawContextKey('multiSessionDebug', false, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/debug/common/debug',
    'multiSessionDebug',
