...
let BreakpointWidget = class BreakpointWidget extends ZoneWidget {
    ...
    _fillContainer(container) {
        ...
        ], this.context, this.contextViewService, defaultSelectBoxStyles, { ariaLabel: ( (localizeWithPath(
            'vs/workbench/contrib/debug/browser/breakpointWidget',
            'breakpointType',
            'Breakpoint Type'
        ))) })));
    ...
    createModesInput(container) {
        ...
        const sb = this.selectModeBox = ( (new SelectBox([
            { text: ( (localizeWithPath('vs/workbench/contrib/debug/browser/breakpointWidget', 'bpMode', 'Mode'))), isDisabled: true },
    ...
    createTriggerBreakpointInput(container) {
        ...
        const selectBreakpointBox = this.selectBreakpointBox = ( (new SelectBox([{ text: ( (localizeWithPath(
            'vs/workbench/contrib/debug/browser/breakpointWidget',
            'triggerByLoading',
            'Loading...'
        ))), isDisabled: true }], 0, this.contextViewService, defaultSelectBoxStyles, { ariaLabel: ( (localizeWithPath(
            'vs/workbench/contrib/debug/browser/breakpointWidget',
            'selectBreakpoint',
            'Select breakpoint'
        ))) })));
        ...
        closeButton.label = ( (localizeWithPath('vs/workbench/contrib/debug/browser/breakpointWidget', 'ok', "Ok")));
    ...
    centerInputVertically() {
        if (this.container && typeof this.heightInPx === 'number') {
            const lineHeight = this.input.getOption(67 );
            const lineNum = this.input.getModel().getLineCount();
