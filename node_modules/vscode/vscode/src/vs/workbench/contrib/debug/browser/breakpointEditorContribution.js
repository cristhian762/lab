...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: ( new MarkdownString()).appendText(( localizeWithPath(
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isShiftPressed) {
                        ...
                        const breakpointType = logPoint ? ( localizeWithPath(
                            'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                            'logPoint',
                            "Logpoint"
                        )) : ( localizeWithPath(
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'logPoint',
                "Logpoint"
            )) : ( localizeWithPath(
            ...
            actions.push(( new Action('debug.removeBreakpoint', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'removeBreakpoint',
                "Remove {0}",
                breakpointType
            ...
            actions.push(( new Action('workbench.debug.action.editBreakpointAction', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'editBreakpoint',
                "Edit {0}...",
                breakpointType
            ...
            actions.push(( new Action(
                ...
                breakpoints[0].enabled ? ( localizeWithPath(
                    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                    'disableBreakpoint',
                    "Disable {0}",
                    breakpointType
            ...
            actions.push(( new SubmenuAction('debug.removeBreakpoints', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'removeBreakpoints',
                "Remove Breakpoints"
            )), ( sorted.map(bp => ( new Action('removeInlineBreakpoint', bp.column ? ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
            ...
            actions.push(( new SubmenuAction('debug.editBreakpoints', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'editBreakpoints',
                "Edit Breakpoints"
            )), ( sorted.map(bp => ( new Action('editBreakpoint', bp.column ? ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
            ...
            actions.push(( new SubmenuAction('debug.enableDisableBreakpoints', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'enableDisableBreakpoints',
                "Enable/Disable Breakpoints"
            )), ( sorted.map(bp => ( new Action(
                bp.enabled ? 'disableColumnBreakpoint' : 'enableColumnBreakpoint',
                bp.enabled ? (bp.column ? ( localizeWithPath(
                    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
            ...
            actions.push(( new Action('addBreakpoint', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'addBreakpoint',
                "Add Breakpoint"
            )), undefined, true, () => this.debugService.addBreakpoints(uri, [{ lineNumber, column }]))));
            actions.push(( new Action('addConditionalBreakpoint', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'addConditionalBreakpoint',
                "Add Conditional Breakpoint..."
            )), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, 0 )))));
            actions.push(( new Action('addLogPoint', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'addLogPoint',
                "Add Logpoint..."
            )), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, 2 )))));
            actions.push(( new Action('addTriggeredBreakpoint', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'addTriggeredBreakpoint',
                "Add Triggered Breakpoint..."
            )), undefined, true, () => Promise.resolve(this.showBreakpointWidget(lineNumber, column, 3 )))));
        }
        if (this.debugService.state === 2 ) {
            actions.push(( new Separator()));
            actions.push(( new Action('runToLine', ( localizeWithPath(
                'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
                'runToLine',
                "Run to Line"
...
const debugIconBreakpointForeground = registerColor('debugIcon.breakpointForeground', { dark: '#E51400', light: '#E51400', hcDark: '#E51400', hcLight: '#E51400' }, ( localizeWithPath(
    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
    'debugIcon.breakpointForeground',
    'Icon color for breakpoints.'
)));
const debugIconBreakpointDisabledForeground = registerColor('debugIcon.breakpointDisabledForeground', { dark: '#848484', light: '#848484', hcDark: '#848484', hcLight: '#848484' }, ( localizeWithPath(
    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
    'debugIcon.breakpointDisabledForeground',
    'Icon color for disabled breakpoints.'
)));
const debugIconBreakpointUnverifiedForeground = registerColor('debugIcon.breakpointUnverifiedForeground', { dark: '#848484', light: '#848484', hcDark: '#848484', hcLight: '#848484' }, ( localizeWithPath(
    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
    'debugIcon.breakpointUnverifiedForeground',
    'Icon color for unverified breakpoints.'
)));
const debugIconBreakpointCurrentStackframeForeground = registerColor('debugIcon.breakpointCurrentStackframeForeground', { dark: '#FFCC00', light: '#BE8700', hcDark: '#FFCC00', hcLight: '#BE8700' }, ( localizeWithPath(
    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
    'debugIcon.breakpointCurrentStackframeForeground',
    'Icon color for the current breakpoint stack frame.'
)));
const debugIconBreakpointStackframeForeground = registerColor('debugIcon.breakpointStackframeForeground', { dark: '#89D185', light: '#89D185', hcDark: '#89D185', hcLight: '#89D185' }, ( localizeWithPath(
    'vs/workbench/contrib/debug/browser/breakpointEditorContribution',
