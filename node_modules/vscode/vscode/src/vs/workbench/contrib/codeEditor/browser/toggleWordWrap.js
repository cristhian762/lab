...
const EDITOR_WORD_WRAP = ( new RawContextKey('editorWordWrap', false, ( localizeWithPath(
...
class ToggleWordWrapAction extends EditorAction {
    ...
    run(accessor, editor) {
        ...
        if (transientState) {
            ...
            const actualWrappingInfo = editor.getOption(145 );
...
let EditorWordWrapContextKeyTracker = class EditorWordWrapContextKeyTracker extends Disposable {
    ...
    _updateFromCodeEditor() {
        if (!canToggleWordWrap(this._codeEditorService, this._activeEditor)) {
            ...
            const wrappingInfo = this._activeEditor.getOption(145 );
