...
import { asCssVariable, inputBackground, inputForeground, inputPlaceholderForeground, asCssVariableWithDefault, inputBorder, selectionBackground, editorSelectionBackground } from '../../../../../platform/theme/common/colorRegistry.js';
...
let SuggestEnabledInput = class SuggestEnabledInput extends Widget {
    constructor(id, parent, suggestionProvider, ariaLabel, resourceHandle, options, defaultInstantiationService, modelService, contextKeyService, languageFeaturesService, configurationService) {
        ...
        this._register(Event.chain(this.inputWidget.onKeyDown, $ => $.filter(e => e.keyCode === 3 ))(e => { e.preventDefault();  }, this));
        this._register(Event.chain(this.inputWidget.onKeyDown, $ => $.filter(e => e.keyCode === 18  && (isMacintosh ? e.metaKey : e.ctrlKey)))(() => this._onShouldFocusResults.fire(), this));
