...
const TASK_RUNNING_STATE = ( new RawContextKey('taskRunning', false, ( localizeWithPath(
    'vs/workbench/contrib/tasks/common/tasks',
    'tasks.taskRunningContext',
    "Whether a task is currently running."
))));
const TASKS_CATEGORY = ( localize2WithPath('vs/workbench/contrib/tasks/common/tasks', 'tasksCategory', "Tasks"));
var ShellQuoting;
                ...
                if (schema.default !== undefined) {
                    ...
                    switch (schema.type) {
                        ...
                        case 'string':
                            ...
                            break;
                        default:
                            reporter.error(( localizeWithPath(
                                'vs/workbench/contrib/tasks/common/tasks',
