...
let WebviewEditor = class WebviewEditor extends EditorPane {
    ...
    constructor(telemetryService, themeService, storageService, _editorGroupsService, _editorService, _workbenchLayoutService, _hostService, _contextKeyService) {
        ...
        this._register(Event.any(_editorGroupsService.activePart.onDidScroll, _editorGroupsService.activePart.onDidAddGroup, _editorGroupsService.activePart.onDidRemoveGroup, _editorGroupsService.activePart.onDidMoveGroup)(() => {
    ...
    synchronizeWebviewContainerDimensions(webview, dimension) {
        ...
        const rootContainer = this._workbenchLayoutService.getContainer($window, "workbench.parts.editor" );
