...
import { terminalDecorationMark, terminalDecorationIncomplete, terminalDecorationError, terminalDecorationSuccess } from '../terminalIcons.js';
import { TerminalDecorationHoverManager, updateLayout } from './decorationStyles.js';
...
let DecorationAddon = class DecorationAddon extends Disposable {
    ...
    _updateDecorationVisibility() {
        ...
        const currentCommand = this._capabilities.get(2 )?.executingCommandObject;
        if (currentCommand) {
    ...
    _updateGutterDecorationVisibility() {
        const commandDecorationElements = this._terminal?.element?.querySelectorAll("terminal-command-decoration" );
    ...
    registerCommandDecoration(command, beforeCommandExecution, markProperties) {
        ...
        decoration.onRender(element => {
            ...
            if (!element.classList.contains("codicon" ) || command?.marker?.line === 0) {
    ...
    async _getCommandActions(command) {
        const actions = [];
        if (command.command !== '') {
            const labelRun = ( localizeWithPath(
                'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
                        ...
                        const shouldRun = await ( new Promise(r => {
                            this._notificationService.prompt(Severity.Info, ( localizeWithPath(
                                ...
                                command.command
                                    ...
                                    label: ( localizeWithPath('vs/workbench/contrib/terminal/browser/xterm/decorationAddon', 'no', 'No')),
                                    run: () => r(false)
                                }]);
                        }));
                        if (!shouldRun) {
            ...
            const labelCopy = ( localizeWithPath(
                'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
        ...
        if (command.hasOutput()) {
            const labelCopyCommandAndOutput = ( localizeWithPath(
                'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
            ...
            const labelText = ( localizeWithPath(
                'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
                "terminal.copyOutput",
                'Copy Output'
            ));
            ...
            const labelHtml = ( localizeWithPath(
                'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
        ...
        const labelRunRecent = ( localizeWithPath(
            'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
        ...
        const labelGoToRecent = ( localizeWithPath(
            'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
        ...
        actions.push(( new Separator()));
        const labelAbout = ( localizeWithPath(
            'vs/workbench/contrib/terminal/browser/xterm/decorationAddon',
