...
import { AutoUpdateConfigurationKey, INSTALL_ACTIONS_GROUP, UPDATE_ACTIONS_GROUP, THEME_ACTIONS_GROUP, VIEWLET_ID, IExtensionsWorkbenchService, TOGGLE_IGNORE_EXTENSION_ACTION_ID, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID } from '../common/extensions.js';
import { ExtensionsConfigurationInitialContent } from '../common/extensionsFileTemplate.js';
import { ExtensionManagementErrorCode, TargetPlatformToString, IExtensionGalleryService } from '../../../../platform/extensionManagement/common/extensionManagement.js';
...
import { isLanguagePackExtension, ExtensionIdentifier, getWorkspaceSupportTypeMessage, isApplicationScopedExtension } from '../../../../platform/extensions/common/extensions.js';
...
import { registerColor, buttonBackground, buttonForeground, buttonHoverBackground, buttonSeparator, editorErrorForeground, editorWarningForeground, editorInfoForeground } from '../../../../platform/theme/common/colorRegistry.js';
...
let PromptExtensionInstallFailureAction = class PromptExtensionInstallFailureAction extends Action {
    ...
    async run() {
        ...
        if (this.error.name === ExtensionManagementErrorCode.Unsupported) {
            const productName = isWeb ? ( localizeWithPath(
        ...
        if ([ExtensionManagementErrorCode.Incompatible, ExtensionManagementErrorCode.IncompatibleTargetPlatform, ExtensionManagementErrorCode.Malicious, ExtensionManagementErrorCode.Deprecated].includes(this.error.name)) {
        ...
        const operationMessage = this.installOperation === 3  ? ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'update operation',
        ...
        if (downloadUrl) {
            additionalMessage = ( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'check logs',
...
let InstallAction = class InstallAction extends ExtensionAction {
    ...
    constructor(options, extensionsWorkbenchService, instantiationService, runtimeExtensionService, workbenchThemeService, labelService, dialogService, preferencesService, telemetryService) {
        super('extensions.install', ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'install',
            "Install"
        )), InstallAction_1.Class, false);
    ...
    getLabel(primary) {
        if (this.options.installPreReleaseVersion && this.extension?.hasPreReleaseVersion) {
            return primary ? ( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'install pre-release',
                "Install Pre-Release"
            )) : ( localizeWithPath(
...
let InstallInOtherServerAction = class InstallInOtherServerAction extends ExtensionAction {
    ...
    static { this.INSTALL_LABEL = ( localizeWithPath(
        'vs/workbench/contrib/extensions/browser/extensionsActions',
        'install',
        "Install"
    )); }
    static { this.INSTALLING_LABEL = ( localizeWithPath(
        'vs/workbench/contrib/extensions/browser/extensionsActions',
        'installing',
        "Installing"
    )); }
...
let UninstallAction = class UninstallAction extends ExtensionAction {
    ...
    static { this.UninstallLabel = ( localizeWithPath(
        'vs/workbench/contrib/extensions/browser/extensionsActions',
        'uninstallAction',
        "Uninstall"
    )); }
    static { this.UninstallingLabel = ( localizeWithPath(
        'vs/workbench/contrib/extensions/browser/extensionsActions',
        'Uninstalling',
        "Uninstalling"
    )); }
...
let UpdateAction = class UpdateAction extends AbstractUpdateAction {
    constructor(verbose, extensionsWorkbenchService, instantiationService) {
        super(`extensions.update`, ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'update',
            "Update"
    ...
    update() {
        super.update();
        if (this.extension) {
            this.label = this.verbose ? ( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'update to',
                "Update to v{0}",
...
let ToggleAutoUpdateForExtensionAction = class ToggleAutoUpdateForExtensionAction extends ExtensionAction {
    ...
    update() {
        ...
        if (this.enableWhenOutdated && (this.extension.state !== 1  || !this.extension.outdated)) {
            return;
        }
...
let MigrateDeprecatedExtensionAction = class MigrateDeprecatedExtensionAction extends ExtensionAction {
    ...
    constructor(small, extensionsWorkbenchService) {
        super('extensionsAction.migrateDeprecatedExtension', ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'migrateExtension',
            "Migrate"
        )), MigrateDeprecatedExtensionAction_1.DisabledClass, false);
        this.small = small;
        this.extensionsWorkbenchService = extensionsWorkbenchService;
        this.update();
    }
    update() {
        ...
        this.tooltip = ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'migrate to',
            "Migrate to {0}",
            this.extension.deprecationInfo.extension.displayName
        ));
        this.label = this.small ? ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'migrate',
            "Migrate"
        )) : this.tooltip;
...
class ExtensionActionWithDropdownActionViewItem extends ActionWithDropdownActionViewItem {
...
let InstallAnotherVersionAction = class InstallAnotherVersionAction extends ExtensionAction {
    ...
    async run() {
        ...
        if (!allVersions.length) {
            await this.dialogService.info(( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'no versions',
        ...
        const picks = ( allVersions.map((v, i) => {
            return {
                id: v.version,
                label: v.version,
                description: `${fromNow(( new Date(Date.parse(v.date))), true)}${v.isPreReleaseVersion ? ` (${( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'pre-release',
                    "pre-release"
                ))})` : ''}${v.version === this.extension.version ? ` (${( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'current',
                    "current"
                ))})` : ''}`,
...
let EnableDropDownAction = class EnableDropDownAction extends ActionWithDropDownAction {
    constructor(instantiationService) {
        super('extensions.enable', ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'enableAction',
            "Enable"
        )), [
...
let DisableDropDownAction = class DisableDropDownAction extends ActionWithDropDownAction {
    constructor(instantiationService) {
        super('extensions.disable', ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'disableAction',
            "Disable"
        )), [[
...
let ReloadAction = class ReloadAction extends ExtensionAction {
    ...
    constructor(hostService, extensionService) {
        super('extensions.reload', ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'reloadAction',
            "Reload"
        )), ReloadAction_1.DisabledClass, false);
    ...
    update() {
        ...
        this.label = reloadTooltip !== undefined ? ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'reload required',
            'Reload Required'
        )) : '';
...
ReloadAction = ReloadAction_1 = ( __decorate([
...
let SearchExtensionsAction = class SearchExtensionsAction extends Action {
    constructor(searchValue, paneCompositeService) {
        super('extensions.searchExtensions', ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
...
let AbstractConfigureRecommendedExtensionsAction = class AbstractConfigureRecommendedExtensionsAction extends Action {
    ...
    openExtensionsFile(extensionsFileResource) {
        ...
        })), error => Promise.reject(( new Error(( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
    ...
    computeLabel() {
        ...
        if (currentStatus !== null) {
            if (currentStatus === 0  && this.status === 1 ) {
                return canAddExtension() ? this.initialStatus === 1  && this.version !== currentVersion ? ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'updated',
                    "Updated"
                )) : ( localizeWithPath(
            ...
            if (currentStatus === 2  && this.status === 3 ) {
                this.initialStatus = this.status;
                return canRemoveExtension() ? ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'uninstalled',
                    "Uninstalled"
                )) : null;
        ...
        if (currentEnablementState !== null) {
            ...
            if (!currentlyEnabled && enabled) {
                return canAddExtension() ? ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'enabled',
                    "Enabled"
                )) : null;
...
let ToggleSyncExtensionAction = class ToggleSyncExtensionAction extends ExtensionDropDownAction {
    ...
    static { this.SYNC_CLASS = `${ToggleSyncExtensionAction_1.ICON_ACTION_CLASS} extension-sync ${ThemeIcon.asClassName(syncEnabledIcon)}`; }
    ...
    update() {
        ...
        if (this.extension) {
            ...
            this.tooltip = isIgnored ? ( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'ignored',
            ...
            actionGroups: [
                [
                    ( new Action(
                        ...
                        this.extensionsWorkbenchService.isExtensionIgnoredToSync(this.extension) ? ( localizeWithPath(
                            'vs/workbench/contrib/extensions/browser/extensionsActions',
                            'sync',
                            "Sync this extension"
                        )) : ( localizeWithPath(
...
let ExtensionStatusAction = class ExtensionStatusAction extends ExtensionAction {
    ...
    async computeAndUpdateStatus() {
        ...
        if (this.extension.isMalicious) {
            this.updateStatus({ icon: warningIcon, message: ( new MarkdownString(( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'malicious tooltip',
        ...
        if (this.extension.deprecationInfo) {
            if (this.extension.deprecationInfo.extension) {
                ...
                const message = ( new MarkdownString(( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'deprecated tooltip',
                    "This extension is deprecated as it is no longer being maintained."
                ))));
        ...
        if (this.extension.gallery && this.extension.state === 3  && !(await this.extensionsWorkbenchService.canInstall(this.extension))) {
            ...
            if (this.extensionManagementServerService.webExtensionManagementServer) {
                const productName = ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    'VS Code for Web',
                    "{0} for the Web",
                    this.productService.nameLong
        ...
        if (this.extension.enablementState === 2 ) {
            this.updateStatus({ message: ( new MarkdownString(( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
        ...
        if (this.extension.enablementState === 4 ) {
            ...
            this.updateStatus({ icon: infoIcon, message: ( new MarkdownString(details ? escapeMarkdownSyntaxTokens(details) : ( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
        ...
        if (isVirtualWorkspace(this.contextService.getWorkspace())) {
            ...
            if (virtualSupportType === 'limited' || details) {
                this.updateStatus({ icon: warningIcon, message: ( new MarkdownString(details ? escapeMarkdownSyntaxTokens(details) : ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
        ...
        if (this.extension.enablementState === 0  ||
            ...
            this.updateStatus({ icon: trustIcon, message: ( new MarkdownString(
                untrustedDetails ? escapeMarkdownSyntaxTokens(untrustedDetails) : ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
                    ...
                    if (this.extensionManifestPropertiesService.prefersExecuteOnWorkspace(this.extension.local.manifest)) {
                        if (this.extensionManagementServerService.remoteExtensionManagementServer) {
                            message = ( new MarkdownString(`${( localizeWithPath(
                                ...
                                'learn more',
                                "Learn More"
                            ))}](https://aka.ms/vscode-remote/developing-extensions/architecture)`));
                        }
                    }
                }
        ...
        for (const feature of features) {
            ...
            const manageAccessLink = `[${( localizeWithPath(
                'vs/workbench/contrib/extensions/browser/extensionsActions',
                'manage access',
                'Manage Access'
            ))}](${( URI.parse(
                `command:extension.open?${encodeURIComponent(JSON.stringify([this.extension.identifier.id, "features" , false, feature.id]))}`
            ))})`;
        ...
        if (this.extensionManagementServerService.remoteExtensionManagementServer) {
            if (isLanguagePackExtension(this.extension.local.manifest)) {
                if (!( this.extensionsWorkbenchService.installed.some(
                    ...
                    const message = this.extension.server === this.extensionManagementServerService.localExtensionManagementServer
                        ? ( new MarkdownString(( localizeWithPath(
                        'vs/workbench/contrib/extensions/browser/extensionsActions',
            ...
            if (this.extension.server === this.extensionManagementServerService.localExtensionManagementServer && runningExtensionServer === this.extensionManagementServerService.remoteExtensionManagementServer) {
                if (this.extensionManifestPropertiesService.prefersExecuteOnWorkspace(this.extension.local.manifest)) {
                    this.updateStatus({ icon: infoIcon, message: ( new MarkdownString(`${( localizeWithPath(
                        'vs/workbench/contrib/extensions/browser/extensionsActions',
                        'enabled remotely',
                        ...
                        'learn more',
                        "Learn More"
                    ))}](https://aka.ms/vscode-remote/developing-extensions/architecture)`)) }, true);
                }
                return;
            }
...
let ReinstallAction = class ReinstallAction extends Action {
    ...
    run() {
        return this.quickInputService.pick(this.getEntries(), { placeHolder: ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
    ...
    reinstallExtension(extension) {
        return this.instantiationService.createInstance(SearchExtensionsAction, '@installed ').run()
            ...
            return this.extensionsWorkbenchService.reinstall(extension)
                ...
                const message = requireReload ? ( localizeWithPath(
                    'vs/workbench/contrib/extensions/browser/extensionsActions',
...
let InstallSpecificVersionOfExtensionAction = class InstallSpecificVersionOfExtensionAction extends Action {
    ...
    async run() {
        const extensionPick = await this.quickInputService.pick(this.getExtensionEntries(), { placeHolder: ( localizeWithPath(
            'vs/workbench/contrib/extensions/browser/extensionsActions',
            'selectExtension',
            "Select Extension"
        )), matchOnDetail: true });
...
export { AbstractConfigureRecommendedExtensionsAction, AbstractInstallExtensionsInServerAction, ActionWithDropDownAction, ClearLanguageAction, ConfigureWorkspaceFolderRecommendedExtensionsAction, ConfigureWorkspaceRecommendedExtensionsAction, DisableDropDownAction, DisableForWorkspaceAction, DisableGloballyAction, DropDownMenuActionViewItem, EnableDropDownAction, EnableForWorkspaceAction, EnableGloballyAction, ExtensionAction, ExtensionActionWithDropdownActionViewItem, ExtensionDropDownAction, ExtensionEditorManageExtensionAction, ExtensionStatusAction, ExtensionStatusLabelAction, IgnoreExtensionRecommendationAction, InstallAction, InstallAnotherVersionAction, InstallDropdownAction, InstallInOtherServerAction, InstallLocalExtensionsInRemoteAction, InstallRecommendedExtensionAction, InstallRemoteExtensionsInLocalAction, InstallSpecificVersionOfExtensionAction, InstallingLabelAction, LocalInstallAction, ManageExtensionAction, MenuItemExtensionAction, MigrateDeprecatedExtensionAction, PromptExtensionInstallFailureAction, ReinstallAction, ReloadAction, RemoteInstallAction, SearchExtensionsAction, SetColorThemeAction, SetFileIconThemeAction, SetLanguageAction, SetProductIconThemeAction, ShowRecommendedExtensionAction, ToggleAutoUpdateForExtensionAction, ToggleAutoUpdatesForPublisherAction, TogglePreReleaseExtensionAction, ToggleSyncExtensionAction, UndoIgnoreExtensionRecommendationAction, UninstallAction, UpdateAction, WebInstallAction, extensionButtonProminentBackground, getContextMenuActions };
