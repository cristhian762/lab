...
let ReviewZoneWidget = class ReviewZoneWidget extends ZoneWidget {
    ...
    constructor(editor, _owner, _commentThread, _pendingComment, _pendingEdits, instantiationService, themeService, commentService, contextKeyService, configurationService) {
        ...
        this._isExpanded = this._initialCollapsibleState === CommentThreadCollapsibleState.Expanded;
        this._commentThreadDisposables = [];
        this.create();
    ...
    _fillContainer(container) {
        ...
        this._commentThreadWidget = this._scopedInstantiationService.createInstance(CommentThreadWidget, container, this.editor, this._owner, this.editor.getModel().uri, this._contextKeyService, this._scopedInstantiationService, this._commentThread, this._pendingComment, this._pendingEdits, { editor: this.editor, codeBlockFontSize: '', codeBlockFontFamily: this.configurationService.getValue('editor').fontFamily || EDITOR_FONT_DEFAULTS.fontFamily }, this._commentOptions, {
            actionRunner: async () => {
    ...
    display(range) {
        ...
        this._commentThreadWidget.display(this.editor.getOption(67 ));
...
export { ReviewZoneWidget, isMouseUpEventDragFromMouseDown, parseMouseDownInfoFromEvent };
