...
import { registerWorkbenchContribution2, Extensions } from '../../../common/contributions.js';
...
import './files.fileEditorFactory.contribution.js';
...
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(EditorPaneDescriptor.create(TextFileEditor, TextFileEditor.ID, ( localizeWithPath(
    'vs/workbench/contrib/files/browser/files.editorPane.contribution',
    'textFileEditor',
    "Text File Editor"
))), [
