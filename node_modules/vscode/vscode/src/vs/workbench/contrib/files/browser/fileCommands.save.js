...
import { EmbeddedCodeEditorWidget } from '../../../../editor/browser/widget/embeddedCodeEditorWidget.js';
...
import { SAVE_FILE_COMMAND_ID, SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID, SAVE_FILE_AS_COMMAND_ID, SAVE_ALL_COMMAND_ID, SAVE_ALL_IN_GROUP_COMMAND_ID, SAVE_FILES_COMMAND_ID } from './fileConstants.js';
    ...
    try {
        ...
        if (!isCancellationError(error)) {
            notificationService.notify({
                ...
                actions: {
                    primary: [
                        toAction({ id: 'workbench.action.files.saveEditors', label: ( localizeWithPath('vs/workbench/contrib/files/browser/fileCommands.save', 'retry', "Retry")), run: () => instantiationService.invokeFunction(accessor => doSaveEditors(accessor, editors, options)) }),
                        toAction({ id: 'workbench.action.files.revertEditors', label: ( localizeWithPath(
                            'vs/workbench/contrib/files/browser/fileCommands.save',
                            'discard',
                            "Discard"
