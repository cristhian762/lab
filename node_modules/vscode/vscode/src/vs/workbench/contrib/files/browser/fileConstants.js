...
const SAVE_FILE_AS_LABEL = ( localize2WithPath('vs/workbench/contrib/files/browser/fileConstants', 'saveAs', "Save As..."));
const SAVE_FILE_COMMAND_ID = 'workbench.action.files.save';
const SAVE_FILE_LABEL = ( localize2WithPath('vs/workbench/contrib/files/browser/fileConstants', 'save', "Save"));
const SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID = 'workbench.action.files.saveWithoutFormatting';
const SAVE_FILE_WITHOUT_FORMATTING_LABEL = ( localize2WithPath(
 'vs/workbench/contrib/files/browser/fileConstants',
 'saveWithoutFormatting',
 "Save without Formatting"
));
const SAVE_ALL_COMMAND_ID = 'saveAll';
const SAVE_ALL_LABEL = ( localize2WithPath('vs/workbench/contrib/files/browser/fileConstants', 'saveAll', "Save All"));
...
const REMOVE_ROOT_FOLDER_LABEL = ( localizeWithPath(
 'vs/workbench/contrib/files/browser/fileConstants',
...
const NEW_UNTITLED_FILE_LABEL = ( localize2WithPath(
 'vs/workbench/contrib/files/browser/fileConstants',
 'newUntitledFile',
