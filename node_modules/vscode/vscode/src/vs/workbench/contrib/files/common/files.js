...
const FoldersViewVisibleContext = ( new RawContextKey('foldersViewVisible', true, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/files/common/files',
    'foldersViewVisible',
...
const FilesExplorerFocusedContext = ( new RawContextKey('filesExplorerFocus', true, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/files/common/files',
    'filesExplorerFocus',
    "True when the focus is inside the EXPLORER view."
)) }));
const OpenEditorsFocusedContext = ( new RawContextKey('openEditorsFocus', true, { type: 'boolean', description: ( localizeWithPath(
    'vs/workbench/contrib/files/common/files',
    'openEditorsFocus',
