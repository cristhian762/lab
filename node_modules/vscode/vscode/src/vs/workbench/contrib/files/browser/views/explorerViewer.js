...
import { addDisposableListener, addStandardDisposableListener, getWindow, EventType, isActiveElement, hasParentWithClass } from '../../../../../base/browser/dom.js';
...
import { ExternalElementsDragAndDropData, NativeDragAndDropData } from '../../../../../base/browser/ui/list/listView.js';
...
import { isStringArray, isNumber } from '../../../../../base/common/types.js';
        ...
        const toDispose = [
            ...
            addDisposableListener(inputBox.inputElement, EventType.BLUR, async () => {
                while (true) {
                    ...
                    else if (ownerDocument.activeElement instanceof HTMLElement && hasParentWithClass(ownerDocument.activeElement, 'context-view')) {
...
let FileDragAndDrop = class FileDragAndDrop {
    ...
    async handleExplorerDrop(data, target, targetIndex, targetSector, originalEvent) {
        ...
        if (confirmDragAndDrop) {
            const message = items.length > 1 && items.every(s => s.isRoot) ? ( localizeWithPath(
                'vs/workbench/contrib/files/browser/views/explorerViewer',
                'confirmRootsMove',
                "Are you sure you want to change the order of multiple root folders in your workspace?"
            ))
                : items.length > 1 ? ( localizeWithPath(
                'vs/workbench/contrib/files/browser/views/explorerViewer',
                'confirmMultiMove',
                ...
                target.name
                    ...
                    : items[0].isRoot ? ( localizeWithPath(
                'vs/workbench/contrib/files/browser/views/explorerViewer',
                'confirmRootMove',
