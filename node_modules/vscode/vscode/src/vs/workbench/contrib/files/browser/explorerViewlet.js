...
import { Extensions, ViewContentGroups, IViewDescriptorService } from '../../../common/views.js';
...
const explorerViewIcon = registerIcon('explorer-view-icon', Codicon.files, ( localizeWithPath(
    'vs/workbench/contrib/files/browser/explorerViewlet',
    'explorerViewIcon',
    'View icon of the explorer view.'
)));
const openEditorsViewIcon = registerIcon('open-editors-view-icon', Codicon.book, ( localizeWithPath(
    'vs/workbench/contrib/files/browser/explorerViewlet',
    'openEditorsIcon',
...
let ExplorerViewletViewsContribution = class ExplorerViewletViewsContribution extends Disposable {
    ...
    createExplorerViewDescriptor() {
        return {
            id: VIEW_ID,
            name: ( localize2WithPath('vs/workbench/contrib/files/browser/explorerViewlet', 'folders', "Folders")),
            containerIcon: explorerViewIcon,
...
const openFolder = ( localizeWithPath(
    'vs/workbench/contrib/files/browser/explorerViewlet',
    'openFolder',
    "Open Folder"
));
const addAFolder = ( localizeWithPath(
    'vs/workbench/contrib/files/browser/explorerViewlet',
    'addAFolder',
    "add a folder"
));
const openRecent = ( localizeWithPath(
    'vs/workbench/contrib/files/browser/explorerViewlet',
    'openRecent',
    "Open Recent"
));
