...
import { registerColor, editorErrorForeground, transparent } from '../../../../platform/theme/common/colorRegistry.js';
...
import { EmbeddedDiffEditorWidget } from '../../../../editor/browser/widget/embeddedCodeEditorWidget.js';
import { Action, ActionRunner } from '../../../../base/common/actions.js';
import { IKeybindingService } from '../../../../platform/keybinding/common/keybinding.js';
import { basename } from '../../../../base/common/resources.js';
import { MenuRegistry, MenuId, IMenuService, MenuItemAction } from '../../../../platform/actions/common/actions.js';
...
let DirtyDiffWidget = class DirtyDiffWidget extends PeekViewWidget {
    ...
    updateActions() {
        ...
        this._actionbarWidget.push(( new Action('peekview.close', ( localizeWithPath(
            'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
            'label.close',
            "Close"
        )), ThemeIcon.asClassName(Codicon.close), true, () => this.dispose())), { label: false, icon: true });
    }
    _fillHead(container) {
...
const overviewRulerModifiedForeground = registerColor('editorOverviewRuler.modifiedForeground', { dark: ( transparent(editorGutterModifiedBackground, 0.6)), light: ( transparent(editorGutterModifiedBackground, 0.6)), hcDark: ( transparent(editorGutterModifiedBackground, 0.6)), hcLight: ( transparent(editorGutterModifiedBackground, 0.6)) }, ( localizeWithPath(
    'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
    'overviewRulerModifiedForeground',
    'Overview ruler marker color for modified content.'
)));
const overviewRulerAddedForeground = registerColor('editorOverviewRuler.addedForeground', { dark: ( transparent(editorGutterAddedBackground, 0.6)), light: ( transparent(editorGutterAddedBackground, 0.6)), hcDark: ( transparent(editorGutterAddedBackground, 0.6)), hcLight: ( transparent(editorGutterAddedBackground, 0.6)) }, ( localizeWithPath(
    'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
    'overviewRulerAddedForeground',
    'Overview ruler marker color for added content.'
)));
const overviewRulerDeletedForeground = registerColor('editorOverviewRuler.deletedForeground', { dark: ( transparent(editorGutterDeletedBackground, 0.6)), light: ( transparent(editorGutterDeletedBackground, 0.6)), hcDark: ( transparent(editorGutterDeletedBackground, 0.6)), hcLight: ( transparent(editorGutterDeletedBackground, 0.6)) }, ( localizeWithPath(
    'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
...
let DirtyDiffDecorator = DirtyDiffDecorator_1 = class DirtyDiffDecorator extends Disposable {
    ...
    constructor(editorModel, codeEditor, model, configurationService) {
        ...
        const diffAdded = ( localizeWithPath(
            'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
            'diffAdded',
            'Added lines'
        ));
        ...
        const diffModified = ( localizeWithPath(
            'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
            'diffModified',
            'Changed lines'
        ));
        ...
        this.deletedOptions = DirtyDiffDecorator_1.createDecoration('dirty-diff-deleted', ( localizeWithPath(
            'vs/workbench/contrib/scm/browser/dirtydiffDecorator',
            'diffDeleted',
            'Removed lines'
        )), {
            ...
            return (await Promise.all(( quickDiffs.map(async (quickDiff) => {
                try {
                    ...
                    if (isTextFileEditorModel(ref.object)) {
                        ...
                        if (encoding) {
                            ref.object.setEncoding(encoding, 1 );
                        }
                    }
