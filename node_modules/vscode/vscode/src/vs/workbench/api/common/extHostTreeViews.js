...
class ExtHostTreeView extends Disposable {
    ...
    createAndRegisterTreeNode(element, extTreeItem, parentNode) {
        ...
        if (extTreeItem.id && ( this.elements.has(node.item.handle))) {
            throw new Error(localizeWithPath('vs/workbench/api/common/extHostTreeViews', 'treeView.duplicateElement', 'Element with id {0} is already registered', extTreeItem.id));
        }
