...
import { TestMessage, TestResults, TestTag, location, TestItem, TestCoverage, Range } from './extHostTypeConverters.js';
...
import { TestsDiffOp, isStartControllerTests, KEEP_N_LAST_COVERAGE_REPORTS, AbstractIncrementalTestCollection } from '../../contrib/testing/common/testTypes.js';
...
class TestRunTracker extends Disposable {
    ...
    constructor(dto, proxy, extension, logService, parentToken) {
        ...
        this.coverageEmitter = this._register(( new Emitter()));
