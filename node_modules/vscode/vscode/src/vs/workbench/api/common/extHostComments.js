...
import { CommentThreadCollapsibleState, CommentThreadState as CommentThreadState$1 } from '../../../editor/common/languages.js';
import { ExtensionIdentifierMap } from '../../../platform/extensions/common/extensions.js';
import { Range, MarkdownString as MarkdownString$1, pathOrURIToURI } from './extHostTypeConverters.js';
import { MarkdownString, CommentThreadCollapsibleState as CommentThreadCollapsibleState$1, CommentThreadState } from './extHostTypes.js';
...
function createExtHostComments(mainContext, commands, documents) {
    ...
    class ExtHostCommentThread {
        ...
        constructor(commentControllerId, _commentControllerHandle, _id, _uri, _range, _comments, extensionDescription, _isTemplate) {
            ...
            proxy.$createCommentThread(_commentControllerHandle, this.handle, this._id, this._uri, Range.from(this._range), extensionDescription.identifier, this._isTemplate);
