...
import { isString, isNumber, isUndefinedOrNull, isEmptyObject } from '../../../base/common/types.js';
...
import { Position as Position$1, Selection as Selection$1, Range as Range$1, Diagnostic as Diagnostic$1, ViewColumn as ViewColumn$1, MarkdownString as MarkdownString$1, WorkspaceEdit as WorkspaceEdit$1, SnippetTextEdit, SnippetString, TextEdit as TextEdit$1, SymbolKind as SymbolKind$1, SymbolInformation, CallHierarchyItem as CallHierarchyItem$1, CallHierarchyIncomingCall as CallHierarchyIncomingCall$1, CallHierarchyOutgoingCall as CallHierarchyOutgoingCall$1, Location as Location$1, InlineValueText, InlineValueVariableLookup, InlineValueEvaluatableExpression, InlineValueContext as InlineValueContext$1, CompletionItem as CompletionItem$1, InlayHint as InlayHint$1, DocumentLink as DocumentLink$1, ColorPresentation as ColorPresentation$1, Color as Color$1, NotebookCellOutputItem as NotebookCellOutputItem$1, NotebookCellOutput as NotebookCellOutput$1, TestTag as TestTag$1, TypeHierarchyItem as TypeHierarchyItem$1, DiagnosticRelatedInformation as DiagnosticRelatedInformation$1, DiagnosticSeverity as DiagnosticSeverity$1, Hover as Hover$1, DocumentHighlight as DocumentHighlight$1, InlayHintLabelPart as InlayHintLabelPart$1, FoldingRangeKind as FoldingRangeKind$1, NotebookCellData as NotebookCellData$1, DiagnosticTag as DiagnosticTag$1, SymbolTag as SymbolTag$1, CompletionItemTag as CompletionItemTag$1, CompletionItemKind as CompletionItemKind$1, EndOfLine as EndOfLine$1, RelativePattern, NotebookRange as NotebookRange$1, NotebookCellKind as NotebookCellKind$1, DataTransfer as DataTransfer$1, StandardTokenType, TextDocumentSaveReason as TextDocumentSaveReason$1, TextEditorLineNumbersStyle as TextEditorLineNumbersStyle$1, ProgressLocation as ProgressLocation$1, NotebookCellExecutionState as NotebookCellExecutionState$2, TestMessage as TestMessage$1, InternalFileDataTransferItem, DataTransferFile, InternalDataTransferItem, LanguageModelAssistantMessage, LanguageModelUserMessage, LanguageModelSystemMessage, InteractiveEditorResponseFeedbackKind as InteractiveEditorResponseFeedbackKind$1, ChatResponseMarkdownPart as ChatResponseMarkdownPart$1, ChatResponseAnchorPart as ChatResponseAnchorPart$1, ChatResponseReferencePart as ChatResponseReferencePart$1, ChatResponseProgressPart as ChatResponseProgressPart$1, ChatResponseFileTreePart, DocumentSymbol as DocumentSymbol$1, EvaluatableExpression as EvaluatableExpression$1, MultiDocumentHighlight as MultiDocumentHighlight$1, SelectionRange as SelectionRange$1, NotebookData as NotebookData$1, NotebookCellStatusBarAlignment, NotebookRendererScript as NotebookRendererScript$1, CodeActionTriggerKind as CodeActionTriggerKind$1, ChatVariableLevel as ChatVariableLevel$1, ChatResponseCommandButtonPart as ChatResponseCommandButtonPart$1, DecorationRangeBehavior as DecorationRangeBehavior$1, CompletionTriggerKind as CompletionTriggerKind$1 } from './extHostTypes.js';
var Selection;
( (function(Selection) {
        ...
        return (!!v && typeof v === 'object' &&
            ...
            v.documents.every(subArr => Array.isArray(subArr) &&
                subArr.every(docRef => docRef && typeof docRef === 'object' &&
                    ...
                    'ranges' in docRef && Array.isArray(docRef.ranges) && docRef.ranges.every((r) => r instanceof Range$1))));
    }
...
})(ChatInlineFollowup || (ChatInlineFollowup = {})));
var LanguageModelMessage;
( (function(LanguageModelMessage) {
    function to(message) {
        switch (message.role) {
            case 0 : return new LanguageModelSystemMessage(message.content);
            case 1 : return new LanguageModelUserMessage(message.content);
            case 2 : return new LanguageModelAssistantMessage(message.content);
        }
    }
    LanguageModelMessage.to = to;
    function from(message) {
        if (message instanceof LanguageModelSystemMessage) {
            return { role: 0 , content: message.content };
        }
        else if (message instanceof LanguageModelUserMessage) {
            return { role: 1 , content: message.content };
        }
        else if (message instanceof LanguageModelAssistantMessage) {
            return { role: 2 , content: message.content };
        }
        else {
...
( (function(ChatVariableLevel) {
    function to(level) {
        switch (level) {
            case 'short': return ChatVariableLevel$1.Short;
            case 'medium': return ChatVariableLevel$1.Medium;
            case 'full':
            default:
                return ChatVariableLevel$1.Full;
        }
    }
    ChatVariableLevel.to = to;
    function from(level) {
        switch (level) {
            case ChatVariableLevel$1.Short: return 'short';
            case ChatVariableLevel$1.Medium: return 'medium';
            case ChatVariableLevel$1.Full:
            default:
                return 'full';
        }
    }
...
( (function(InteractiveEditorResponseFeedbackKind) {
    function to(kind) {
        switch (kind) {
            case 1 :
                return InteractiveEditorResponseFeedbackKind$1.Helpful;
            case 0 :
                return InteractiveEditorResponseFeedbackKind$1.Unhelpful;
            case 2 :
                return InteractiveEditorResponseFeedbackKind$1.Undone;
            case 3 :
                return InteractiveEditorResponseFeedbackKind$1.Accepted;
            case 4 :
                return InteractiveEditorResponseFeedbackKind$1.Bug;
        }
    }
...
( (function(ChatResponseAnchorPart) {
    function to(part) {
        return {
            ...
            name: part.title,
            inlineReference: !URI.isUri(part.value) ? Location.from(part.value) : part.value
        };
    }
    ChatResponseAnchorPart.to = to;
    function from(part) {
        const value = revive(part);
        return new ChatResponseAnchorPart$1(URI.isUri(value.inlineReference) ? value.inlineReference : Location.to(value.inlineReference), part.name);
    }
...
( (function(ChatResponseReferencePart) {
    function to(part) {
        return {
            kind: 'reference',
            reference: !URI.isUri(part.value) ? Location.from(part.value) : part.value
        };
    }
    ChatResponseReferencePart.to = to;
    function from(part) {
        const value = revive(part);
        return new ChatResponseReferencePart$1(URI.isUri(value.reference) ? value.reference : Location.to(value.reference));
    }
...
( (function(ChatResponseProgress) {
    ...
    function to(progress) {
        switch (progress.kind) {
            ...
            case 'reference':
                return {
                    reference: isUriComponents(progress.reference) ?
    ...
    function toProgressContent(progress, commandsConverter) {
        switch (progress.kind) {
            ...
            case 'inlineReference':
                return {
                    inlineReference: isUriComponents(progress.inlineReference) ?
...
})(ChatResponseProgress || (ChatResponseProgress = {})));
...
})(ChatAgentResolvedVariable || (ChatAgentResolvedVariable = {})));
...
export { CallHierarchyIncomingCall, CallHierarchyItem, CallHierarchyOutgoingCall, ChatAgentCompletionItem, ChatAgentRequest, ChatAgentResolvedVariable, ChatAgentResult, ChatAgentUserActionEvent, ChatFollowup, ChatInlineFollowup, ChatResponseAnchorPart, ChatResponseCommandButtonPart, ChatResponseFilesPart, ChatResponseMarkdownPart, ChatResponsePart, ChatResponseProgress, ChatResponseProgressPart, ChatResponseReferencePart, ChatVariable, ChatVariableLevel, CodeActionTriggerKind, Color, ColorPresentation, CompletionContext, CompletionItem, CompletionItemKind, CompletionItemTag, CompletionTriggerKind, DataTransfer, DataTransferItem, DebugTreeItem, DecorationRangeBehavior, DecorationRenderOptions, DefinitionLink, Diagnostic, DiagnosticRelatedInformation, DiagnosticSeverity, DiagnosticTag, DocumentHighlight, DocumentLink, DocumentSelector, DocumentSymbol, EndOfLine, EvaluatableExpression, FoldingRange, FoldingRangeKind, GlobPattern, Hover, InlayHint, InlayHintKind, InlayHintLabelPart, InlineValue, InlineValueContext, InteractiveEditorResponseFeedbackKind, LanguageModelMessage, LanguageSelector, Location, MappedEditsContext, MarkdownString, MultiDocumentHighlight, NotebookCellData, NotebookCellExecutionState, NotebookCellExecutionSummary, NotebookCellKind, NotebookCellOutput, NotebookCellOutputItem, NotebookData, NotebookDocumentContentOptions, NotebookExclusiveDocumentPattern, NotebookKernelSourceAction, NotebookRange, NotebookRendererScript, NotebookStatusBarItem, ParameterInformation, Position, ProgressLocation, Range, Selection, SelectionRange, SignatureHelp, SignatureInformation, SymbolKind, SymbolTag, TerminalQuickFix, TestCoverage, TestItem, TestMessage, TestResults, TestTag, TextDocumentSaveReason, TextEdit, TextEditorLineNumbersStyle, TextEditorOpenOptions, ThemableDecorationAttachmentRenderOptions, ThemableDecorationRenderOptions, TokenType, TypeHierarchyItem, ViewBadge, ViewColumn, WorkspaceEdit, WorkspaceSymbol, fromRangeOrRangeWithMessage, isDecorationOptionsArr, location, pathOrURIToURI };
