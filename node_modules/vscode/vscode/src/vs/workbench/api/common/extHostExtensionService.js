...
let AbstractExtHostExtensionService = AbstractExtHostExtensionService_1 = class AbstractExtHostExtensionService extends Disposable {
    ...
    async _doHandleExtensionTests() {
        ...
        if (!extensionDevelopmentLocationURI || !extensionTestsLocationURI) {
            throw new Error(localizeWithPath('vs/workbench/api/common/extHostExtensionService', 'extensionTestError1', "Cannot load test runner."));
        }
        ...
        if (!testRunner || typeof testRunner.run !== 'function') {
            throw new Error(localizeWithPath('vs/workbench/api/common/extHostExtensionService', 'extensionTestError', "Path {0} does not point to a valid extension test runner.", extensionTestsLocationURI.toString()));
        }
