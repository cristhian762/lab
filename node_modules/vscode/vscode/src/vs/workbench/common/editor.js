...
const DEFAULT_EDITOR_ASSOCIATION = {
    id: 'default',
    displayName: ( localizeWithPath(
        'vs/workbench/common/editor',
        'promptOpenWith.defaultEditor.displayName',
        "Text Editor"
    )),
    providerDisplayName: ( localizeWithPath('vs/workbench/common/editor', 'builtinProviderDisplayName', "Built-in"))
};
...
function createTooLargeFileError(group, input, options, message, preferencesService) {
    return createEditorOpenError(message, [
        toAction({
            id: 'workbench.action.openLargeFile', label: ( localizeWithPath('vs/workbench/common/editor', 'openLargeFile', "Open Anyway")), run: () => {
        ...
        toAction({
            id: 'workbench.action.configureEditorLargeFileConfirmation', label: ( localizeWithPath(
            'vs/workbench/common/editor',
