...
import { registerColor, editorBackground, transparent, contrastBorder, treeIndentGuidesStroke, activeContrastBorder, focusBorder, editorWidgetForeground, editorWidgetBackground, editorForeground, inputBorder, listActiveSelectionBackground, darken, listActiveSelectionForeground, editorInfoForeground, errorForeground, editorWarningForeground, toolbarHoverBackground, widgetBorder, textLinkForeground, lighten, editorErrorForeground } from '../../platform/theme/common/colorRegistry.js';
...
const TITLE_BAR_BORDER = registerColor('titleBar.border', {
    ...
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localizeWithPath('vs/workbench/common/theme', 'titleBarBorder', "Title bar border color.")));
...
registerColor('commandCenter.foreground', { dark: TITLE_BAR_ACTIVE_FOREGROUND, hcDark: TITLE_BAR_ACTIVE_FOREGROUND, light: TITLE_BAR_ACTIVE_FOREGROUND, hcLight: TITLE_BAR_ACTIVE_FOREGROUND }, ( localizeWithPath(
    'vs/workbench/common/theme',
    'commandCenter-foreground',
    "Foreground color of the command center"
)), false);
registerColor('commandCenter.activeForeground', { dark: MENUBAR_SELECTION_FOREGROUND, hcDark: MENUBAR_SELECTION_FOREGROUND, light: MENUBAR_SELECTION_FOREGROUND, hcLight: MENUBAR_SELECTION_FOREGROUND }, ( localizeWithPath(
    'vs/workbench/common/theme',
...
const COMMAND_CENTER_BACKGROUND = registerColor('commandCenter.background', { dark: ( Color.white.transparent(0.05)), hcDark: null, light: ( Color.black.transparent(0.05)), hcLight: null }, ( localizeWithPath(
    'vs/workbench/common/theme',
    'commandCenter-background',
    "Background color of the command center"
)), false);
registerColor('commandCenter.activeBackground', { dark: ( Color.white.transparent(0.08)), hcDark: MENUBAR_SELECTION_BACKGROUND, light: ( Color.black.transparent(0.08)), hcLight: MENUBAR_SELECTION_BACKGROUND }, ( localizeWithPath(
    'vs/workbench/common/theme',
    'commandCenter-activeBackground',
    "Active background color of the command center"
)), false);
registerColor('commandCenter.border', { dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .20)), hcDark: contrastBorder, light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .20)), hcLight: contrastBorder }, ( localizeWithPath(
    'vs/workbench/common/theme',
    'commandCenter-border',
    "Border color of the command center"
)), false);
registerColor('commandCenter.activeBorder', { dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .30)), hcDark: TITLE_BAR_ACTIVE_FOREGROUND, light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .30)), hcLight: TITLE_BAR_ACTIVE_FOREGROUND }, ( localizeWithPath(
    'vs/workbench/common/theme',
