...
const VIEWS_LOG_NAME = ( localizeWithPath('vs/workbench/common/views', 'views log', "Views"));
const defaultViewIcon = registerIcon('default-view-icon', Codicon.window, ( localizeWithPath('vs/workbench/common/views', 'defaultViewIcon', 'Default view icon.')));
var Extensions;
( (function(Extensions) {
    ...
    addViews(viewDescriptors, viewContainer) {
        ...
        for (const viewDescriptor of viewDescriptors) {
            if (this.getView(viewDescriptor.id) !== null) {
                throw new Error(localizeWithPath('vs/workbench/common/views', 'duplicateId', "A view with id '{0}' is already registered", viewDescriptor.id));
            }
...
export { Extensions, IViewDescriptorService, NoTreeViewError, ResolvableTreeItem, TreeItemCollapsibleState, VIEWS_LOG_ID, VIEWS_LOG_NAME, ViewContainerLocation, ViewContainerLocationToString, ViewContainerLocations, ViewContentGroups, ViewVisibilityState, defaultViewIcon };
