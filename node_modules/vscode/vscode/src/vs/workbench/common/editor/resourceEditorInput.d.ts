import { EditorInputWithPreferredResource, EditorInputCapabilities, Verbosity, IFileLimitedEditorInputOptions } from '../editor.js';
...
declare abstract class AbstractResourceEditorInput extends EditorInput implements EditorInputWithPreferredResource {
    ...
    constructor(resource: URI, preferredResource: URI | undefined, labelService: ILabelService, fileService: IFileService, filesConfigurationService: IFilesConfigurationService, textResourceConfigurationService: ITextResourceConfigurationService);
