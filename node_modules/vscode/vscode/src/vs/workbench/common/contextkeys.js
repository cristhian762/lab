...
const IsMainWindowFullscreenContext = ( new RawContextKey('isFullscreen', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
    'isFullscreen',
    "Whether the main window is in fullscreen mode"
))));
const IsAuxiliaryWindowFocusedContext = ( new RawContextKey('isAuxiliaryWindowFocusedContext', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
...
const ActiveCompareEditorOriginalWriteableContext = ( new RawContextKey('activeCompareEditorOriginalWritable', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
    'activeCompareEditorOriginalWritable',
    "Whether the active compare editor has a writable original side"
))));
...
const EditorPartMaximizedEditorGroupContext = ( new RawContextKey('editorPartMaximizedEditorGroup', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
    'editorPartEditorGroupMaximized',
    "Editor Part has a maximized group"
))));
const IsAuxiliaryEditorPartContext = ( new RawContextKey('isAuxiliaryEditorPart', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
    'isAuxiliaryEditorPart',
    "Editor Part is in an auxiliary window"
))));
...
const IsMainEditorCenteredLayoutContext = ( new RawContextKey('isCenteredLayout', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
...
const MainEditorAreaVisibleContext = ( new RawContextKey('mainEditorAreaVisible', true, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
...
const TitleBarStyleContext = ( new RawContextKey('titleBarStyle', isLinux ? 'native' : 'custom', ( localizeWithPath(
    'vs/workbench/common/contextkeys',
    'titleBarStyle',
    "Style of the window title bar"
))));
const TitleBarVisibleContext = ( new RawContextKey('titleBarVisible', false, ( localizeWithPath(
    'vs/workbench/common/contextkeys',
    'titleBarVisible',
