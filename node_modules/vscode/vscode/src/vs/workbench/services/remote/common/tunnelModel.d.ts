...
import { TunnelProtocol, ITunnelService, RemoteTunnel, PortAttributesProvider, TunnelPrivacyId, ProvidedOnAutoForward } from '../../../../platform/tunnel/common/tunnel.js';
...
declare enum TunnelCloseReason {
    Other = "Other",
    User = "User",
    AutoForwardEnd = "AutoForwardEnd"
}
declare enum TunnelSource {
    User = 0,
    Auto = 1,
    Extension = 2
}
...
declare class PortsAttributes extends Disposable {
...
declare class TunnelModel extends Disposable {
...
export { type Attributes, type CandidatePort, OnPortForward, PortsAttributes, type Tunnel, TunnelCloseReason, TunnelModel, type TunnelProperties, TunnelSource };
