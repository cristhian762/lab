...
import { Extensions as Extensions$1 } from '../../../../platform/theme/common/colorRegistry.js';
...
class ColorDataRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [
            ( localizeWithPath('vs/workbench/services/themes/common/colorExtensionPoint', 'id', "ID")),
            ( localizeWithPath(
                'vs/workbench/services/themes/common/colorExtensionPoint',
                'description',
                "Description"
