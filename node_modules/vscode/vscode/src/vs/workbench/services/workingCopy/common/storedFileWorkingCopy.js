            ...
            if (this.isResolved() && !options.skipSaveParticipants && this.workingCopyFileService.hasSaveParticipants) {
                try {
                    ...
                    if (!saveCancellation.token.isCancellationRequested) {
                        ...
                        try {
                            await this.workingCopyFileService.runSaveParticipants(this, { reason: options.reason ?? 1 , savedFrom: options.from }, saveCancellation.token);
                        }
                        finally {
                            this.ignoreSaveFromSaveParticipants = false;
                        }
...
export { StoredFileWorkingCopy, isStoredFileWorkingCopySaveEvent };
