...
import { ITitlebarPart, IAuxiliaryTitlebarPart } from '../../../browser/parts/titlebar/titlebarPart.js';
import { IEditorGroupsContainer } from '../../editor/common/editorGroupsService.js';

declare const ITitleService: ServiceIdentifier<ITitleService>;
interface ITitleService extends ITitlebarPart {
