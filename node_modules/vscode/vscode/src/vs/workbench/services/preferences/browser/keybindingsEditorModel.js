...
const SOURCE_SYSTEM = ( localizeWithPath(
    'vs/workbench/services/preferences/browser/keybindingsEditorModel',
    'default',
    "System"
));
const SOURCE_EXTENSION = ( localizeWithPath(
    'vs/workbench/services/preferences/browser/keybindingsEditorModel',
    'extension',
    "Extension"
));
const SOURCE_USER = ( localizeWithPath(
    'vs/workbench/services/preferences/browser/keybindingsEditorModel',
    'user',
    "User"
));
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? ( localizeWithPath(
                    'vs/workbench/services/preferences/browser/keybindingsEditorModel',
                    'cat.title',
                    "{0}: {1}",
                    category,
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (equalsIgnoreCase(( localizeWithPath(
            'vs/workbench/services/preferences/browser/keybindingsEditorModel',
            'option',
            "option"
        )), word)) {
