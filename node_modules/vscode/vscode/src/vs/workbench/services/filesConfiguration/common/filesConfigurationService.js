...
import { AutoSaveConfiguration, FILES_READONLY_INCLUDE_CONFIG, FILES_READONLY_EXCLUDE_CONFIG, HotExitConfiguration, hasReadonlyCapability, IFileService } from '../../../../platform/files/common/files.js';
...
let FilesConfigurationService = class FilesConfigurationService extends Disposable {
    ...
    getAutoSaveMode(resourceOrEditor) {
        const resource = this.toResource(resourceOrEditor);
