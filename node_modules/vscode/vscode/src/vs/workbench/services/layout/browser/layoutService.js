...
function isTitleBarEmpty(configurationService) {
    ...
    if (configurationService.getValue("workbench.activityBar.location" ) === "top" ) {
        return false;
    }
...
export { IWorkbenchLayoutService, Parts, Position, panelOpensMaximizedFromString, positionFromString, positionToString, shouldShowCustomTitleBar };
