...
import { ETAG_DISABLED, NotModifiedSinceFileOperationError, IFileService } from '../../../../platform/files/common/files.js';
...
let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel {
    ...
    static { this.TEXTFILE_SAVE_ENCODING_SOURCE = SaveSourceRegistry.registerSource('textFileEncoding.source', ( localizeWithPath(
            ...
            if (this.isResolved() && !options.skipSaveParticipants) {
                try {
                    ...
                    if (!saveCancellation.token.isCancellationRequested) {
                        ...
                        try {
                            await this.textFileService.files.runSaveParticipants(this, { reason: options.reason ?? 1 , savedFrom: options.from }, saveCancellation.token);
                        }
                        finally {
                            this.ignoreSaveFromSaveParticipants = false;
                        }
