...
import { MenuId, SubmenuItemAction, IMenuService } from '../../../../platform/actions/common/actions.js';
...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createEnumAction(( localizeWithPath(
            'vs/editor/contrib/contextmenu/browser/contextmenu',
            'context.minimap.size',
            "Vertical size"
        )), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: ( localizeWithPath(
                    'vs/editor/contrib/contextmenu/browser/contextmenu',
        ...
        actions.push(createEnumAction(( localizeWithPath(
            ...
            "Slider"
        )), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: ( localizeWithPath(
                    'vs/editor/contrib/contextmenu/browser/contextmenu',
