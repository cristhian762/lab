...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? ( localizeWithPath(
    ...
    constructor() {
        super({
            ...
            menuOpts: {
                ...
                title: ( localizeWithPath(
                    'vs/editor/contrib/multicursor/browser/multicursor',
                    { key: 'miInsertCursorAtEndOfEachLineSelected', comment: ['&& denotes a mnemonic'] },
...
class MultiCursorSession {
    ...
    _getNextMatch() {
        ...
        const nextMatch = this._editor.getModel().findNextMatch(this.searchText, lastAddedSelection.getEndPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(130 ) : null, false);
        if (!nextMatch) {
            return null;
        }
    ...
    _getPreviousMatch() {
        ...
        const allSelections = this._editor.getSelections();
        const lastAddedSelection = allSelections[allSelections.length - 1];
        const previousMatch = this._editor.getModel().findPreviousMatch(this.searchText, lastAddedSelection.getStartPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(130 ) : null, false);
        if (!previousMatch) {
            return null;
        }
        return ( new Selection(
    ...
    selectAll(searchScope) {
        ...
        if (searchScope) {
            return editorModel.findMatches(this.searchText, searchScope, false, this.matchCase, this.wholeWord ? this._editor.getOption(130 ) : null, false, 1073741824 );
        }
        return editorModel.findMatches(this.searchText, true, false, this.matchCase, this.wholeWord ? this._editor.getOption(130 ) : null, false, 1073741824 );
    }
}
    ...
    selectAll(findController) {
        ...
        if (findState.isRevealed && findState.searchString.length > 0 && findState.isRegex) {
            ...
            if (findState.searchScope) {
                matches = editorModel.findMatches(findState.searchString, findState.searchScope, findState.isRegex, findState.matchCase, findState.wholeWord ? this._editor.getOption(130 ) : null, false, 1073741824 );
            }
            else {
                matches = editorModel.findMatches(findState.searchString, true, findState.isRegex, findState.matchCase, findState.wholeWord ? this._editor.getOption(130 ) : null, false, 1073741824 );
            }
        }
        else {
            this._beginSessionIfNeeded(findController);
    ...
    constructor() {
        super({
            ...
            menuOpts: {
                ...
                title: ( localizeWithPath(
                    'vs/editor/contrib/multicursor/browser/multicursor',
                    { key: 'miAddSelectionToNextFindMatch', comment: ['&& denotes a mnemonic'] },
                    "Add &&Next Occurrence"
                )),
                order: 5
            }
    ...
    constructor() {
        super({
            ...
            menuOpts: {
                ...
                title: ( localizeWithPath(
                    'vs/editor/contrib/multicursor/browser/multicursor',
                    { key: 'miAddSelectionToPreviousFindMatch', comment: ['&& denotes a mnemonic'] },
...
let SelectionHighlighter = class SelectionHighlighter extends Disposable {
    ...
    static _createState(oldState, isEnabled, editor) {
        ...
        return ( new SelectionHighlighterState(
            ...
            r.searchText,
            r.matchCase,
            r.wholeWord ? editor.getOption(130 ) : null,
            oldState
        ));
    }
    _setState(newState) {
