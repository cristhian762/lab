import { getActiveElement, removeCSSRulesContainingSelector, createCSSRule } from '../../../../base/browser/dom.js';
...
class ZoneWidget {
    ...
    revealRange(range, isLastLine) {
        if (isLastLine) {
            this.editor.revealLineNearTop(range.endLineNumber, 0 );
        }
        else {
            this.editor.revealRange(range, 0 );
        }
    }
    ...
    _initSash() {
        ...
        this._disposables.add(this._resizeSash.onDidChange((evt) => {
            if (data) {
                const lineDelta = (evt.currentY - data.startY) / this.editor.getOption(67 );
