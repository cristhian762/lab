...
import { registerColor, editorForeground, editorInfoForeground, contrastBorder, activeContrastBorder } from '../../../../platform/theme/common/colorRegistry.js';
...
( (function(PeekContext) {
    PeekContext.inPeekEditor = ( new RawContextKey('inReferenceSearchEditor', true, ( localizeWithPath(
...
let PeekViewWidget = class PeekViewWidget extends ZoneWidget {
    ...
    _fillHead(container, noCloseAction) {
        ...
        if (!noCloseAction) {
            this._actionbarWidget.push(( new Action('peekview.close', ( localizeWithPath('vs/editor/contrib/peekView/browser/peekView', 'label.close', "Close")), ThemeIcon.asClassName(Codicon.close), true, () => {
                this.dispose();
...
const peekViewTitleBackground = registerColor('peekViewTitle.background', { dark: '#252526', light: '#F3F3F3', hcDark: Color.black, hcLight: Color.white }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewTitleBackground',
    'Background color of the peek view title area.'
)));
const peekViewTitleForeground = registerColor('peekViewTitleLabel.foreground', { dark: Color.white, light: Color.black, hcDark: Color.white, hcLight: editorForeground }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewTitleForeground',
    'Color of the peek view title.'
)));
const peekViewTitleInfoForeground = registerColor('peekViewTitleDescription.foreground', { dark: '#ccccccb3', light: '#616161', hcDark: '#FFFFFF99', hcLight: '#292929' }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewTitleInfoForeground',
    'Color of the peek view title info.'
)));
const peekViewBorder = registerColor('peekView.border', { dark: editorInfoForeground, light: editorInfoForeground, hcDark: contrastBorder, hcLight: contrastBorder }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewBorder',
    'Color of the peek view borders and arrow.'
)));
const peekViewResultsBackground = registerColor('peekViewResult.background', { dark: '#252526', light: '#F3F3F3', hcDark: Color.black, hcLight: Color.white }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
...
const peekViewEditorBackground = registerColor('peekViewEditor.background', { dark: '#001F33', light: '#F2F8FC', hcDark: Color.black, hcLight: Color.white }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewEditorBackground',
    'Background color of the peek view editor.'
)));
registerColor('peekViewEditorGutter.background', { dark: peekViewEditorBackground, light: peekViewEditorBackground, hcDark: peekViewEditorBackground, hcLight: peekViewEditorBackground }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
...
registerColor('peekViewResult.matchHighlightBackground', { dark: '#ea5c004d', light: '#ea5c004d', hcDark: null, hcLight: null }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewResultsMatchHighlight',
    'Match highlight color in the peek view result list.'
)));
const peekViewEditorMatchHighlight = registerColor('peekViewEditor.matchHighlightBackground', { dark: '#ff8f0099', light: '#f5d802de', hcDark: null, hcLight: null }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
    'peekViewEditorMatchHighlight',
    'Match highlight color in the peek view editor.'
)));
registerColor('peekViewEditor.matchHighlightBorder', { dark: null, light: null, hcDark: activeContrastBorder, hcLight: activeContrastBorder }, ( localizeWithPath(
    'vs/editor/contrib/peekView/browser/peekView',
