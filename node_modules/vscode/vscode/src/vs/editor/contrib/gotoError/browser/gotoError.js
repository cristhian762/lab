...
import { registerEditorContribution, registerEditorAction, registerEditorCommand, EditorAction, EditorCommand } from '../../../browser/editorExtensions.js';
    ...
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, ( localizeWithPath(
                    'vs/editor/contrib/gotoError/browser/gotoError',
                    'nextMarkerIcon',
    ...
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, ( localizeWithPath(
                    'vs/editor/contrib/gotoError/browser/gotoError',
                    'previousMarkerIcon',
        ...
        super(true, true, {
            ...
            menuOpts: {
                ...
                title: ( localizeWithPath(
                    'vs/editor/contrib/gotoError/browser/gotoError',
                    { key: 'miGotoNextProblem', comment: ['&& denotes a mnemonic'] },
                    "Next &&Problem"
                )),
                group: '6_problem_nav',
                order: 1
    ...
    constructor() {
        super(false, true, {
            ...
            menuOpts: {
                ...
                title: ( localizeWithPath(
                    'vs/editor/contrib/gotoError/browser/gotoError',
                    { key: 'miGotoPreviousProblem', comment: ['&& denotes a mnemonic'] },
                    "Previous &&Problem"
                )),
                group: '6_problem_nav',
                order: 2
