...
import { editorActiveLinkForeground, editorInlayHintParameterBackground, editorInlayHintParameterForeground, editorInlayHintTypeBackground, editorInlayHintTypeForeground, editorInlayHintBackground, editorInlayHintForeground } from '../../../../platform/theme/common/colorRegistry.js';
...
let InlayHintsController = class InlayHintsController {
    ...
    _update() {
        ...
        this._removeAllDecorations();
        const options = this._editor.getOption(140 );
