    ...
    computeAsync(anchor, _lineDecorations, token) {
        ...
        return ( new AsyncIterableObject(async (executor) => {
            ...
            if (isNonEmptyArray(part.item.hint.textEdits)) {
                executor.emitOne(( new MarkdownHover(this, anchor.range, [( new MarkdownString()).appendText(( localizeWithPath(
            ...
            if (part.part.location || part.part.command) {
                ...
                if (part.part.location && part.part.command) {
                    linkHint = ( new MarkdownString()).appendText(( localizeWithPath(
                        'vs/editor/contrib/inlayHints/browser/inlayHintsHover',
                        'hint.defAndCommand',
                    ...
                    linkHint = ( new MarkdownString(`[${( localizeWithPath(
                        'vs/editor/contrib/inlayHints/browser/inlayHintsHover',
                        'hint.cmd',
                        "Execute Command"
                    ))}](${asCommandLink(part.part.command)} "${part.part.command.title}") (${kb})`, { isTrusted: true }));
                }
                if (linkHint) {
