...
class GenericGoToLocationAction extends SymbolNavigationAction {
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return ( new ReferencesModel(this._references, ( localizeWithPath(
            'vs/editor/contrib/gotoSymbol/browser/goToCommands',
            'generic.title',
            'Locations'
        ))));
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), Position.lift(position), false, token).then(references => ( new ReferencesModel(references, ( localizeWithPath(
                'vs/editor/contrib/gotoSymbol/browser/goToCommands',
                'ref.title',
                'References'
            ))))));
