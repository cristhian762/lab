...
let GotoDefinitionAtPositionEditorContribution = class GotoDefinitionAtPositionEditorContribution {
    ...
    async startFindDefinition(position) {
        ...
        if (results.length > 1) {
            ...
            this.addDecoration(combinedRange, ( new MarkdownString()).appendText(( localizeWithPath(
    ...
    gotoDefinition(position, openToSide) {
        ...
        return this.editor.invokeWithinContext((accessor) => {
            const canPeek = !openToSide && this.editor.getOption(88 ) && !this.isInPeekEditor(accessor);
