...
let ReferenceWidget = class ReferenceWidget extends PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = ( new TextModel(( localizeWithPath(
            'vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget',
            'missingPreviewMessage',
            "no preview available"
        )), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null, this._undoRedoService, this._languageService, this._languageConfigurationService));
    ...
    _onNewModel() {
        ...
        if (this._model.isEmpty) {
            this.setTitle('');
            this._messageContainer.innerText = ( localizeWithPath(
                'vs/editor/contrib/gotoSymbol/browser/peek/referencesWidget',
                'noResults',
                "No results"
            ));
