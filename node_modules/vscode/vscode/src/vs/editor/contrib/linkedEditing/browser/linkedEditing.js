...
import { registerEditorCommand, registerModelAndPositionCommand, registerEditorContribution, registerEditorAction, EditorCommand, EditorAction } from '../../../browser/editorExtensions.js';
...
registerColor('editor.linkedEditingBackground', { dark: ( ( Color.fromHex('#f00')).transparent(0.3)), light: ( ( Color.fromHex('#f00')).transparent(0.3)), hcDark: ( ( Color.fromHex('#f00')).transparent(0.3)), hcLight: Color.white }, ( localizeWithPath(
    'vs/editor/contrib/linkedEditing/browser/linkedEditing',
