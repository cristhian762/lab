...
import { addPositions, lengthOfText, subtractPositions, Permutation, getNewRanges } from './utils.js';
        ...
        this.state = derivedOpts({
            ...
            if (suggestItem) {
                ...
                const ghostTexts = ( edits
                    .map(
                    (edit, idx) => edit.computeGhostText(model, mode, positions[idx], fullEditPreviewLength)
                ))
                    .filter(isDefined);
    ...
    async _acceptNext(editor, getAcceptUntilIndex) {
        ...
        try {
            ...
            if (completion.source.provider.handlePartialAccept) {
                ...
                const text = editor.getModel().getValueInRange(acceptedRange, 1 );
