...
let InlineCompletionsHintsWidget = class InlineCompletionsHintsWidget extends Disposable {
    constructor(editor, model, instantiationService) {
        ...
        this._register(autorunWithStore((reader, store) => {
            ...
            const contentWidget = store.add(this.instantiationService.createInstance(InlineSuggestionHintsContentWidget, this.editor, true, this.position, model.selectedInlineCompletionIndex, model.inlineCompletionsCount, ( model.selectedInlineCompletion.map(
                v =>  v?.inlineCompletion.source.inlineCompletions.commands ?? []
            ))));
...
const inlineSuggestionHintsNextIcon = registerIcon('inline-suggestion-hints-next', Codicon.chevronRight, ( localizeWithPath(
    'vs/editor/contrib/inlineCompletions/browser/inlineCompletionsHintsWidget',
    'parameterHintsNextIcon',
    'Icon for show next parameter hint.'
)));
const inlineSuggestionHintsPreviousIcon = registerIcon('inline-suggestion-hints-previous', Codicon.chevronLeft, ( localizeWithPath(
    'vs/editor/contrib/inlineCompletions/browser/inlineCompletionsHintsWidget',
...
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    constructor(editor, withBorder, _position, _currentSuggestionIdx, _suggestionCount, _extraCommands, _commandService, instantiationService, keybindingService, _contextKeyService, _menuService) {
        ...
        this.previousAction = this.createCommandAction(showPreviousInlineSuggestionActionId, ( localizeWithPath(
            'vs/editor/contrib/inlineCompletions/browser/inlineCompletionsHintsWidget',
            'previous',
            'Previous'
        ...
        this.nextAction = this.createCommandAction(showNextInlineSuggestionActionId, ( localizeWithPath(
            'vs/editor/contrib/inlineCompletions/browser/inlineCompletionsHintsWidget',
            'next',
            'Next'
