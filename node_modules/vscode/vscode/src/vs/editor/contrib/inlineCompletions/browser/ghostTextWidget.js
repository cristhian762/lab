...
import { observableSignalFromEvent, observableFromEvent } from '../../../../base/common/observableInternal/utils.js';
...
class AdditionalLinesWidget extends Disposable {
    ...
    constructor(editor, languageIdCodec, lines) {
        ...
        this.editorOptionsChanged = observableSignalFromEvent('editorOptionChanged', Event.filter(this.editor.onDidChangeConfiguration, e => e.hasChanged(33 )
            || e.hasChanged(117 )
            || e.hasChanged(99 )
            || e.hasChanged(94 )
            || e.hasChanged(51 )
...
function renderLines(domNode, tabSize, lines, opts, languageIdCodec) {
    const disableMonospaceOptimizations = opts.get(33 );
    const stopRenderingLineAfter = opts.get(117 );
    const renderWhitespace = 'none';
    const renderControlCharacters = opts.get(94 );
    const fontLigatures = opts.get(51 );
    const fontInfo = opts.get(50 );
    const lineHeight = opts.get(67 );
