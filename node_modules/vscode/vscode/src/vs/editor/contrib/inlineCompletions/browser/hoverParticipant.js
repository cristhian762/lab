...
let InlineCompletionsHoverParticipant = class InlineCompletionsHoverParticipant {
    ...
    renderHoverParts(context, hoverParts) {
        ...
        const w = this._instantiationService.createInstance(InlineSuggestionHintsContentWidget, this._editor, false, constObservable(null), model.selectedInlineCompletionIndex, model.inlineCompletionsCount, ( model.selectedInlineCompletion.map(
    ...
    renderScreenReaderText(context, part, disposableStore) {
        ...
        const render = (code) => {
            ...
            const inlineSuggestionAvailable = ( localizeWithPath(
