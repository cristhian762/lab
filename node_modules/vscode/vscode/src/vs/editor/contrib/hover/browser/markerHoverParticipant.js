...
let MarkerHoverParticipant = class MarkerHoverParticipant {
    ...
    renderMarkerStatusbar(context, markerHover, disposables) {
        ...
        if (!this._editor.getOption(91 )) {
            ...
            if (this.recentMarkerCodeActionsInfo) {
                if (IMarkerData.makeKey(this.recentMarkerCodeActionsInfo.marker) === IMarkerData.makeKey(markerHover.marker)) {
                    if (!this.recentMarkerCodeActionsInfo.hasCodeActions) {
                        quickfixPlaceholderElement.textContent = ( localizeWithPath(
                            'vs/editor/contrib/hover/browser/markerHoverParticipant',
                            'noQuickFixes',
            ...
            const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo && !this.recentMarkerCodeActionsInfo.hasCodeActions ? Disposable.None : disposableTimeout(() => quickfixPlaceholderElement.textContent = ( localizeWithPath(
                'vs/editor/contrib/hover/browser/markerHoverParticipant',
