...
let FoldingController = class FoldingController extends Disposable {
    ...
    constructor(editor, contextKeyService, languageConfigurationService, notificationService, languageFeatureDebounceService, languageFeaturesService) {
        ...
        this._isEnabled = options.get(43 );
        this._useFoldingProviders = options.get(44 ) !== 'indentation';
        this._unfoldOnClickAfterEndOfLine = options.get(48 );
        this._restoringViewState = false;
        this._currentModelHasFoldedImports = false;
        this._foldingImportsByDefault = options.get(46 );
        ...
        this.foldingDecorationProvider.showFoldingControls = options.get(110 );
        this.foldingDecorationProvider.showFoldingHighlights = options.get(45 );
        this.foldingEnabled = CONTEXT_FOLDING_ENABLED.bindTo(this.contextKeyService);
        this.foldingEnabled.set(this._isEnabled);
        this._register(this.editor.onDidChangeModel(() => this.onModelChanged()));
        this._register(this.editor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(43 )) {
                this._isEnabled = this.editor.getOptions().get(43 );
                this.foldingEnabled.set(this._isEnabled);
                this.onModelChanged();
            }
            if (e.hasChanged(47 )) {
            ...
            if (e.hasChanged(110 ) || e.hasChanged(45 )) {
                const options = this.editor.getOptions();
                this.foldingDecorationProvider.showFoldingControls = options.get(110 );
                this.foldingDecorationProvider.showFoldingHighlights = options.get(45 );
            ...
            if (e.hasChanged(44 )) {
                this._useFoldingProviders = this.editor.getOptions().get(44 ) !== 'indentation';
                this.onFoldingStrategyChanged();
            }
            if (e.hasChanged(48 )) {
                this._unfoldOnClickAfterEndOfLine = this.editor.getOptions().get(48 );
            }
            if (e.hasChanged(46 )) {
                this._foldingImportsByDefault = this.editor.getOptions().get(46 );
            }
        }));
        this.onModelChanged();
    }
...
class UnFoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(2048  | 41 , 2048  | 94 ),
                weight: 100
            }
        });
    }
...
class FoldAction extends FoldingAction {
    constructor() {
        super({
            id: 'editor.fold',
            label: ( localizeWithPath('vs/editor/contrib/folding/browser/folding', 'foldAction.label', "Fold")),
            alias: 'Fold',
            precondition: CONTEXT_FOLDING_ENABLED,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class FoldRecursivelyAction extends FoldingAction {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(2048  | 41 , 2048  | 92 ),
                weight: 100
            }
        });
    }
...
class FoldAllBlockCommentsAction extends FoldingAction {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(2048  | 41 , 2048  | 90 ),
                weight: 100
            }
        });
    }
...
class FoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(2048  | 41 , 2048  | 88 ),
                weight: 100
            }
        });
    }
...
class UnfoldAllExceptAction extends FoldingAction {
    constructor() {
        super({
            ...
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: KeyChord(2048  | 41 , 2048  | 86 ),
                weight: 100
            }
        });
    }
