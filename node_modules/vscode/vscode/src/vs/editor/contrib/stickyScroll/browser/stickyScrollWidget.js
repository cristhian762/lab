...
class StickyScrollWidget extends Disposable {
    constructor(_editor) {
        ...
        this._lineHeight = this._editor.getOption(67 );
        ...
        const updateScrollLeftPosition = () => {
            this._linesDomNode.style.left = this._editor.getOption(115 ).scrollWithEditor ? `-${this._editor.getScrollLeft()}px` : '0px';
        };
    ...
    _setFoldingHoverListeners() {
        const showFoldingControls = this._editor.getOption(110 );
