...
let StickyScrollController = class StickyScrollController extends Disposable {
    ...
    _revealLineInCenterIfOutsideViewport(position) {
        this._reveaInEditor(position, () => this._editor.revealLineInCenterIfOutsideViewport(position.lineNumber, 0 ));
    }
    ...
    _toggleFoldingRegionForLine(line) {
        ...
        const scrollTop = (foldingIcon.isCollapsed ?
            ...
            - this._editor.getOption(67 ) * stickyLine.index + 1;
        this._editor.setScrollTop(scrollTop);
        this._renderStickyScroll(line);
    }
    _readConfiguration() {
        const options = this._editor.getOption(115 );
        ...
        const lineNumberOption = this._editor.getOption(68 );
    ...
    _onDidResize() {
        ...
        const theoreticalLines = layoutInfo.height / this._editor.getOption(67 );
    ...
    findScrollWidgetState() {
        ...
        const maxNumberStickyLines = Math.min(this._maxStickyLines, this._editor.getOption(115 ).maxLineCount);
