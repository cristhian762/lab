...
import { getSnippetSuggestSupport, QuickSuggestionsOptions, provideSuggestionItems, CompletionOptions } from './suggest.js';
...
function canShowQuickSuggest(editor, contextKeyService, configurationService) {
    ...
    return !editor.getOption(62 ).suppressSuggestions;
}
...
let SuggestModel = SuggestModel_1 = class SuggestModel {
    ...
    _doTriggerQuickSuggest() {
        if (QuickSuggestionsOptions.isAllOff(this._editor.getOption(89 ))) {
            return;
        }
        if (this._editor.getOption(118 ).snippetsPreventQuickSuggestions && SnippetController2.get(this._editor)?.isInSnippet()) {
            return;
        }
        this.cancel();
        this._triggerQuickSuggest.cancelAndSet(() => {
            ...
            const config = this._editor.getOption(89 );
    ...
    trigger(options) {
        ...
        const snippetSuggestions = this._editor.getOption(112 );
        ...
        Promise.all([completions, wordDistance]).then(async ([completions, wordDistance]) => {
            ...
            const fuzzySearchOptions = {
                ...
                firstMatchCanBeWeak: !this._editor.getOption(118 ).matchOnWordStartOnly
            };
            this._completionModel = ( new CompletionModel(completions.items, this._context.column, {
                leadingLineContent: ctx.leadingLineContent,
                characterCountDelta: ctx.column - this._context.column
            }, wordDistance, this._editor.getOption(118 ), this._editor.getOption(112 ), fuzzySearchOptions, clipboardText));
    ...
    static createSuggestFilter(editor) {
        ...
        const snippetSuggestions = editor.getOption(112 );
        if (snippetSuggestions === 'none') {
            result.add(27 );
        }
        const suggestOptions = editor.getOption(118 );
