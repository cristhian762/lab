...
const Context = {
    ...
    HasFocusedSuggestion: ( new RawContextKey('suggestWidgetHasFocusedSuggestion', false, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
        'suggestWidgetHasSelection',
        "Whether any suggestion is focused"
    )))),
    DetailsVisible: ( new RawContextKey('suggestWidgetDetailsVisible', false, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
        'suggestWidgetDetailsVisible',
        "Whether suggestion details are visible"
    )))),
    MultipleSuggestions: ( new RawContextKey('suggestWidgetMultipleSuggestions', false, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
        'suggestWidgetMultipleSuggestions',
        "Whether there are multiple suggestions to pick from"
    )))),
    MakesTextEdit: ( new RawContextKey('suggestionMakesTextEdit', true, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
        'suggestionMakesTextEdit',
        "Whether inserting the current suggestion yields in a change or has everything already been typed"
    )))),
    AcceptSuggestionsOnEnter: ( new RawContextKey('acceptSuggestionOnEnter', true, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
        'acceptSuggestionOnEnter',
        "Whether suggestions are inserted when pressing Enter"
    )))),
    HasInsertAndReplaceRange: ( new RawContextKey('suggestionHasInsertAndReplaceRange', false, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
    ...
    CanResolve: ( new RawContextKey('suggestionCanResolve', false, ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggest',
...
async function provideSuggestionItems(registry, model, position, options = CompletionOptions.default, context = { triggerKind: 0  }, token = CancellationToken.None) {
...
export { CompletionItem, CompletionItemModel, CompletionOptions, Context, QuickSuggestionsOptions, getSnippetSuggestSupport, getSuggestionComparator, provideSuggestionItems, setSnippetSuggestSupport, showSimpleSuggestions, suggestWidgetStatusbarMenu };
