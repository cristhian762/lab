...
import { registerColor, editorWidgetBackground, editorWidgetBorder, editorForeground, quickInputListFocusForeground, quickInputListFocusIconForeground, quickInputListFocusBackground, listHighlightForeground, listFocusHighlightForeground, transparent, activeContrastBorder } from '../../../../platform/theme/common/colorRegistry.js';
...
var SuggestWidget_1;
registerColor('editorSuggestWidget.background', { dark: editorWidgetBackground, light: editorWidgetBackground, hcDark: editorWidgetBackground, hcLight: editorWidgetBackground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetBackground',
    'Background color of the suggest widget.'
)));
registerColor('editorSuggestWidget.border', { dark: editorWidgetBorder, light: editorWidgetBorder, hcDark: editorWidgetBorder, hcLight: editorWidgetBorder }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetBorder',
    'Border color of the suggest widget.'
)));
const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', { dark: editorForeground, light: editorForeground, hcDark: editorForeground, hcLight: editorForeground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetForeground',
    'Foreground color of the suggest widget.'
)));
registerColor('editorSuggestWidget.selectedForeground', { dark: quickInputListFocusForeground, light: quickInputListFocusForeground, hcDark: quickInputListFocusForeground, hcLight: quickInputListFocusForeground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetSelectedForeground',
    'Foreground color of the selected entry in the suggest widget.'
)));
registerColor('editorSuggestWidget.selectedIconForeground', { dark: quickInputListFocusIconForeground, light: quickInputListFocusIconForeground, hcDark: quickInputListFocusIconForeground, hcLight: quickInputListFocusIconForeground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetSelectedIconForeground',
    'Icon foreground color of the selected entry in the suggest widget.'
)));
const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', { dark: quickInputListFocusBackground, light: quickInputListFocusBackground, hcDark: quickInputListFocusBackground, hcLight: quickInputListFocusBackground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetSelectedBackground',
    'Background color of the selected entry in the suggest widget.'
)));
registerColor('editorSuggestWidget.highlightForeground', { dark: listHighlightForeground, light: listHighlightForeground, hcDark: listHighlightForeground, hcLight: listHighlightForeground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetHighlightForeground',
    'Color of the match highlights in the suggest widget.'
)));
registerColor('editorSuggestWidget.focusHighlightForeground', { dark: listFocusHighlightForeground, light: listFocusHighlightForeground, hcDark: listFocusHighlightForeground, hcLight: listFocusHighlightForeground }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
    'editorSuggestWidgetFocusHighlightForeground',
    'Color of the match highlights in the suggest widget when an item is focused.'
)));
registerColor('editorSuggestWidgetStatus.foreground', { dark: ( transparent(editorSuggestWidgetForeground, .5)), light: ( transparent(editorSuggestWidgetForeground, .5)), hcDark: ( transparent(editorSuggestWidgetForeground, .5)), hcLight: ( transparent(editorSuggestWidgetForeground, .5)) }, ( localizeWithPath(
    'vs/editor/contrib/suggest/browser/suggestWidget',
...
class PersistedWidgetSize {
    ...
    restore() {
        const raw = this._service.get(this._key, 0 ) ?? '';
        try {
    ...
    store(size) {
        this._service.store(this._key, JSON.stringify(size), 0 , 1 );
    }
    reset() {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggestWidget',
        'suggestWidget.loading',
        "Loading..."
    )); }
    static { this.NO_SUGGESTIONS_MESSAGE = ( localizeWithPath(
        'vs/editor/contrib/suggest/browser/suggestWidget',
    ...
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        const applyIconStyle = () => this.element.domNode.classList.toggle('no-icons', !this.editor.getOption(118 ).showIcons);
        applyIconStyle();
        ...
        this._list = ( new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                getRole: () => 'option',
                getWidgetAriaLabel: () => ( localizeWithPath('vs/editor/contrib/suggest/browser/suggestWidget', 'suggest', "Suggest")),
        ...
        const applyStatusBarStyle = () => this.element.domNode.classList.toggle('with-status-bar', this.editor.getOption(118 ).showStatusBar);
        applyStatusBarStyle();
        ...
        this._disposables.add(this.editor.onDidChangeConfiguration(e => {
            ...
            if (this._completionModel && (e.hasChanged(50 ) || e.hasChanged(119 ) || e.hasChanged(120 ))) {
    ...
    getLayoutInfo() {
        ...
        const itemHeight = clamp(this.editor.getOption(120 ) || fontInfo.lineHeight, 8, 1000);
        const statusBarHeight = !this.editor.getOption(118 ).showStatusBar || this._state === 2  || this._state === 1  ? 0 : itemHeight;
