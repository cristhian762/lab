...
let SuggestDetailsWidget = class SuggestDetailsWidget {
    constructor(_editor, instaService) {
        ...
        this._close.title = ( localizeWithPath(
    ...
    getLayoutInfo() {
        const lineHeight = this._editor.getOption(120 ) || this._editor.getOption(50 ).lineHeight;
    ...
    renderLoading() {
        this._type.textContent = ( localizeWithPath(
            'vs/editor/contrib/suggest/browser/suggestWidgetDetails',
            'loading',
            "Loading..."
        ));
