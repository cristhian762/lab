...
import { EditorAction, registerEditorContribution, registerEditorAction, registerEditorCommand, EditorCommand } from '../../../browser/editorExtensions.js';
...
let SuggestController = class SuggestController {
    ...
    constructor(editor, _memoryService, _commandService, _contextKeyService, _instantiationService, _logService, _telemetryService) {
        ...
        ctxInsertMode.set(editor.getOption(118 ).insertMode);
        this._toDispose.add(this.model.onDidTrigger(() => ctxInsertMode.set(editor.getOption(118 ).insertMode)));
        this.widget = this._toDispose.add(( new WindowIdleValue(getWindow(editor.getDomNode()), () => {
            ...
            const commitCharacterController = ( new CommitCharacterController(
                ...
                widget,
                this.model,
                item => this._insertSuggestion(item, 2 )
            ));
            ...
            this._toDispose.add(widget.onDetailsKeyDown(e => {
                if (e.toKeyCodeChord().equals(( new KeyCodeChord(true, false, false, false, 33 ))) ||
                    (isMacintosh && e.toKeyCodeChord().equals(( new KeyCodeChord(false, false, false, true, 33 ))))) {
                    e.stopPropagation();
                    return;
                }
        ...
        this._toDispose.add(this.model.onDidSuggest(e => {
            ...
            if (e.triggerOptions.auto) {
                const options = this.editor.getOption(118 );
    ...
    getOverwriteInfo(item, toggleMode) {
        ...
        let replace = this.editor.getOption(118 ).insertMode === 'replace';
        if (toggleMode) {
            replace = !replace;
        }
