...
class FindModelBoundToEditorModel {
    ...
    research(moveCursor, newFindScope) {
        ...
        if (moveCursor && this._editor.getOption(41 ).cursorMoveOnType) {
    ...
    _moveToPrevMatch(before, isRecursed = false) {
        ...
        let prevMatch = model.findPreviousMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(130 ) : null, false);
        if (prevMatch && prevMatch.range.isEmpty() && prevMatch.range.getStartPosition().equals(position)) {
            position = this._prevSearchPosition(position);
            prevMatch = model.findPreviousMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(130 ) : null, false);
        }
        if (!prevMatch) {
            return;
        }
    ...
    _getNextMatch(after, captureMatches, forceMove, isRecursed = false) {
        ...
        const model = this._editor.getModel();
        let position = ( new Position(lineNumber, column));
        let nextMatch = model.findNextMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(130 ) : null, captureMatches);
        if (forceMove && nextMatch && nextMatch.range.isEmpty() && nextMatch.range.getStartPosition().equals(position)) {
            position = this._nextSearchPosition(position);
            nextMatch = model.findNextMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(130 ) : null, captureMatches);
        }
        if (!nextMatch) {
            return null;
        }
    ...
    _findMatches(findScopes, captureMatches, limitResultCount) {
        ...
        return this._editor.getModel().findMatches(this._state.searchString, searchRanges, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(130 ) : null, captureMatches, limitResultCount);
    }
    replaceAll() {
        if (!this._hasMatches()) {
            return;
    ...
    _largeReplaceAll() {
        const searchParams = ( new SearchParams(
            ...
            this._state.wholeWord ? this._editor.getOption(130 ) : null
        ));
