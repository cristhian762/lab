...
import { registerMultiEditorAction, registerEditorContribution, registerEditorAction, registerEditorCommand, MultiEditorAction, EditorCommand, EditorAction } from '../../../browser/editorExtensions.js';
...
let CommonFindController = class CommonFindController extends Disposable {
    ...
    async getGlobalBufferTerm() {
        if (this._editor.getOption(41 ).globalFindClipboard
...
const StartFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localizeWithPath('vs/editor/contrib/find/browser/findController', 'startFindAction', "Find")),
    alias: 'Find',
...
StartFindAction.addImplementation(0, (accessor, editor, args) => {
    ...
    return controller.start({
        forceRevealReplace: false,
        seedSearchStringFromSelection: editor.getOption(41 ).seedSearchStringFromSelection !== 'never' ? 'single' : 'none',
        seedSearchStringFromNonEmptySelection: editor.getOption(41 ).seedSearchStringFromSelection === 'selection',
        seedSearchStringFromGlobalClipboard: editor.getOption(41 ).globalFindClipboard,
        shouldFocus: 1 ,
        shouldAnimate: true,
        updateSearchScope: false,
        loop: editor.getOption(41 ).loop
    });
});
    ...
    async run(accessor, editor, args) {
        ...
        if (controller) {
            ...
            await controller.start({
                forceRevealReplace: false,
                seedSearchStringFromSelection: (controller.getState().searchString.length === 0) && editor.getOption(41 ).seedSearchStringFromSelection !== 'never' ? 'single' : 'none',
                seedSearchStringFromNonEmptySelection: editor.getOption(41 ).seedSearchStringFromSelection === 'selection',
    ...
    run(accessor, editor, args) {
        ...
        const updatePickerAndEditor = (value) => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = ( localizeWithPath(
                    'vs/editor/contrib/find/browser/findController',
...
const StartFindReplaceAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localizeWithPath('vs/editor/contrib/find/browser/findController', 'startReplace', "Replace")),
    alias: 'Replace',
    precondition: ( ContextKeyExpr.or(EditorContextKeys.focus, ( ContextKeyExpr.has('editorIsOpen')))),
    kbOpts: {
        kbExpr: null,
...
StartFindReplaceAction.addImplementation(0, (accessor, editor, args) => {
    if (!editor.hasModel() || editor.getOption(91 )) {
        return false;
    }
    const controller = CommonFindController.get(editor);
    if (!controller) {
    ...
    const seedSearchStringFromSelection = !currentSelection.isEmpty()
        ...
        && (editor.getOption(41 ).seedSearchStringFromSelection !== 'never')
        && !findInputFocused;
    ...
    return controller.start({
        ...
        seedSearchStringFromNonEmptySelection: editor.getOption(41 ).seedSearchStringFromSelection === 'selection',
        seedSearchStringFromGlobalClipboard: editor.getOption(41 ).seedSearchStringFromSelection !== 'never',
...
export { CommonFindController, FindController, MatchFindAction, MoveToMatchFindAction, NextMatchFindAction, NextSelectionMatchFindAction, PreviousMatchFindAction, PreviousSelectionMatchFindAction, SelectionMatchFindAction, StartFindAction, StartFindReplaceAction, StartFindWithArgsAction, StartFindWithSelectionAction, getSelectionSearchString };
