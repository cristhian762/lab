...
import { asCssVariable, inputActiveOptionBackground, inputActiveOptionBorder, inputActiveOptionForeground, editorFindMatchHighlightBorder, editorFindRangeHighlightBorder, contrastBorder } from '../../../../platform/theme/common/colorRegistry.js';
...
const findSelectionIcon = registerIcon('find-selection', Codicon.selection, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findSelectionIcon',
    'Icon for \'Find in Selection\' in the editor find widget.'
)));
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findCollapsedIcon',
    'Icon to indicate that the editor find widget is collapsed.'
)));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findExpandedIcon',
    'Icon to indicate that the editor find widget is expanded.'
)));
const findReplaceIcon = registerIcon('find-replace', Codicon.replace, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findReplaceIcon',
    'Icon for \'Replace\' in the editor find widget.'
)));
const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findReplaceAllIcon',
    'Icon for \'Replace All\' in the editor find widget.'
)));
const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findPreviousMatchIcon',
    'Icon for \'Find Previous\' in the editor find widget.'
)));
const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'findNextMatchIcon',
    'Icon for \'Find Next\' in the editor find widget.'
)));
const NLS_FIND_DIALOG_LABEL = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.findDialog',
    "Find / Replace"
));
const NLS_FIND_INPUT_LABEL = ( localizeWithPath('vs/editor/contrib/find/browser/findWidget', 'label.find', "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localizeWithPath('vs/editor/contrib/find/browser/findWidget', 'placeholder.find', "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.previousMatchButton',
    "Previous Match"
));
const NLS_NEXT_MATCH_BTN_LABEL = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.nextMatchButton',
    "Next Match"
));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.toggleSelectionFind',
    "Find in Selection"
));
const NLS_CLOSE_BTN_LABEL = ( localizeWithPath('vs/editor/contrib/find/browser/findWidget', 'label.closeButton', "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localizeWithPath('vs/editor/contrib/find/browser/findWidget', 'label.replace', "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'placeholder.replace',
    "Replace"
));
const NLS_REPLACE_BTN_LABEL = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.replaceButton',
    "Replace"
));
const NLS_REPLACE_ALL_BTN_LABEL = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.replaceAllButton',
    "Replace All"
));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.toggleReplaceButton',
    "Toggle Replace"
));
const NLS_MATCHES_COUNT_LIMIT_TITLE = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'title.matchesCountLimit',
    "Only the first {0} results are highlighted, but all find operations work on the entire text.",
    MATCHES_LIMIT
));
const NLS_MATCHES_LOCATION = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.matchesLocation',
    "{0} of {1}"
));
const NLS_NO_RESULTS = ( localizeWithPath(
    'vs/editor/contrib/find/browser/findWidget',
    'label.noResults',
    "No results"
));
...
class FindWidget extends Widget {
    ...
    constructor(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService) {
        ...
        this._register(this._codeEditor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(91 )) {
                if (this._codeEditor.getOption(91 )) {
            ...
            if (e.hasChanged(41 )) {
                const supportLoop = this._codeEditor.getOption(41 ).loop;
                this._state.change({ loop: supportLoop }, false);
                const addExtraSpaceOnTop = this._codeEditor.getOption(41 ).addExtraSpaceOnTop;
        ...
        if (this._codeEditor.getOption(41 ).addExtraSpaceOnTop) {
            this._viewZone = ( new FindWidgetViewZone(0));
        }
    ...
    _onStateChanged(e) {
        ...
        if (e.isReplaceRevealed) {
            if (this._state.isReplaceRevealed) {
                if (!this._codeEditor.getOption(91 ) && !this._isReplaceVisible) {
    ...
    _updateButtons() {
        ...
        const canReplace = !this._codeEditor.getOption(91 );
    ...
    _reveal() {
        ...
        if (!this._isVisible) {
            ...
            if (this._codeEditor.getOption(41 ).seedSearchStringFromSelection && selection) {
    ...
    _showViewZone(adjustScroll = true) {
        ...
        this._codeEditor.changeViewZones((accessor) => {
            if (this._viewZoneId !== undefined) {
                ...
                scrollAdjustment -= this._codeEditor.getOption(84 ).top;
...
export { FindWidget, FindWidgetViewZone, NLS_MATCHES_LOCATION, NLS_NO_RESULTS, SimpleButton, findNextMatchIcon, findPreviousMatchIcon, findReplaceAllIcon, findReplaceIcon };
