...
import { registerColor, activeContrastBorder, overviewRulerSelectionHighlightForeground, minimapSelectionOccurrenceHighlight, editorSelectionHighlight } from '../../../../platform/theme/common/colorRegistry.js';
import { themeColorFromId, registerThemingParticipant } from '../../../../platform/theme/common/themeService.js';
const wordHighlightBackground = registerColor('editor.wordHighlightBackground', { dark: '#575757B8', light: '#57575740', hcDark: null, hcLight: null }, ( localizeWithPath(
...
registerColor('editor.wordHighlightStrongBackground', { dark: '#004972B8', light: '#0e639c40', hcDark: null, hcLight: null }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
    'wordHighlightStrong',
...
registerColor('editor.wordHighlightTextBackground', { light: wordHighlightBackground, dark: wordHighlightBackground, hcDark: wordHighlightBackground, hcLight: wordHighlightBackground }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
    'wordHighlightText',
...
const wordHighlightBorder = registerColor('editor.wordHighlightBorder', { light: null, dark: null, hcDark: activeContrastBorder, hcLight: activeContrastBorder }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
    'wordHighlightBorder',
    'Border color of a symbol during read-access, like reading a variable.'
)));
registerColor('editor.wordHighlightStrongBorder', { light: null, dark: null, hcDark: activeContrastBorder, hcLight: activeContrastBorder }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
    'wordHighlightStrongBorder',
    'Border color of a symbol during write-access, like writing to a variable.'
)));
registerColor('editor.wordHighlightTextBorder', { light: wordHighlightBorder, dark: wordHighlightBorder, hcDark: wordHighlightBorder, hcLight: wordHighlightBorder }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
    'wordHighlightTextBorder',
    "Border color of a textual occurrence for a symbol."
)));
const overviewRulerWordHighlightForeground = registerColor('editorOverviewRuler.wordHighlightForeground', { dark: '#A0A0A0CC', light: '#A0A0A0CC', hcDark: '#A0A0A0CC', hcLight: '#A0A0A0CC' }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
...
const overviewRulerWordHighlightStrongForeground = registerColor('editorOverviewRuler.wordHighlightStrongForeground', { dark: '#C0A0C0CC', light: '#C0A0C0CC', hcDark: '#C0A0C0CC', hcLight: '#C0A0C0CC' }, ( localizeWithPath(
    'vs/editor/contrib/wordHighlighter/browser/highlightDecorations',
