...
import { mayIncludeActionsOfKind, CodeActionKind, filtersAction, CodeActionItem, CodeActionTriggerSource } from '../common/types.js';
...
class ManagedCodeActionSet extends Disposable {
    ...
    get hasAutoFix() {
        return ( this.validActions.some(
            ({ action: fix }) => !!fix.kind && CodeActionKind.QuickFix.contains(( new CodeActionKind(fix.kind))) && !!fix.isPreferred
        ));
    }
    get hasAIFix() {
