...
import { RawContextKey, ContextKeyExpr, IContextKeyService } from '../../../../platform/contextkey/common/contextkey.js';
...
let SnippetController2 = class SnippetController2 {
    ...
    static { this.InSnippetMode = ( new RawContextKey('inSnippetMode', false, ( localizeWithPath(
        'vs/editor/contrib/snippet/browser/snippetController2',
        'inSnippetMode',
        "Whether the editor in current in snippet mode"
    )))); }
    static { this.HasNextTabstop = ( new RawContextKey('hasNextTabstop', false, ( localizeWithPath(
        'vs/editor/contrib/snippet/browser/snippetController2',
        'hasNextTabstop',
        "Whether there is a next tab stop when in snippet mode"
    )))); }
    static { this.HasPrevTabstop = ( new RawContextKey('hasPrevTabstop', false, ( localizeWithPath(
        'vs/editor/contrib/snippet/browser/snippetController2',
        'hasPrevTabstop',
                ...
                provideCompletionItems: (model, position) => {
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: { id: 'jumpToNextSnippetPlaceholder', title: ( localizeWithPath(
                                'vs/editor/contrib/snippet/browser/snippetController2',
                                'next',
