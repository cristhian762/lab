...
const UndoCommand = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '',
            title: ( localizeWithPath('vs/editor/browser/editorExtensions', 'undo', "Undo")),
            order: 1
        }]
})));
...
const RedoCommand = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            ...
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localizeWithPath('vs/editor/browser/editorExtensions', 'redo', "Redo")),
            order: 1
        }]
})));
...
const SelectAllCommand = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            ...
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localizeWithPath('vs/editor/browser/editorExtensions', 'selectAll', "Select All")),
            order: 1
        }]
})));
export { Command, EditorAction, EditorAction2, EditorCommand, EditorExtensionsRegistry, MultiCommand, MultiEditorAction, ProxyCommand, RedoCommand, SelectAllCommand, UndoCommand, registerDiffEditorContribution, registerEditorAction, registerEditorCommand, registerEditorContribution, registerInstantiatedEditorAction, registerModelAndPositionCommand, registerMultiEditorAction };
