...
const accessibleDiffViewerInsertIcon = registerIcon('diff-review-insert', Codicon.add, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
    'accessibleDiffViewerInsertIcon',
    'Icon for \'Insert\' in accessible diff viewer.'
)));
const accessibleDiffViewerRemoveIcon = registerIcon('diff-review-remove', Codicon.remove, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
    'accessibleDiffViewerRemoveIcon',
    'Icon for \'Remove\' in accessible diff viewer.'
)));
const accessibleDiffViewerCloseIcon = registerIcon('diff-review-close', Codicon.close, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
...
let View = class View extends Disposable {
    constructor(_element, _model, _width, _height, _models, _languageService) {
        ...
        this._register(autorun(reader => {
            ...
            if (this._model.canClose.read(reader)) {
                this._actionBar.push(( new Action('diffreview.close', ( localizeWithPath(
                    'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
                    'label.close',
                    "Close"
                )), 'close-diff-review ' + ThemeIcon.asClassName(accessibleDiffViewerCloseIcon), true, async () => _model.close())), { label: false, icon: true });
            }
        }));
    ...
    _render(store) {
        ...
        container.setAttribute('aria-label', ( localizeWithPath(
            'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
            'ariaLabel',
            'Accessible Diff Viewer. Use arrow up and down to navigate.'
        )));
        applyFontInfo(container, modifiedOptions.get(50 ));
        ...
        const lineHeight = modifiedOptions.get(67 );
        ...
        for (const viewItem of group?.lines || []) {
            ...
            if (viewItem.type === LineType.Header) {
                ...
                const getAriaLines = (lines) => lines === 0 ? ( localizeWithPath(
                    'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
                    'no_lines_changed',
                    "no lines changed"
                ))
                    : lines === 1 ? ( localizeWithPath(
                    'vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer',
                    'one_line_changed',
                    "1 line changed"
                ))
                ...
                header.setAttribute('aria-label', ( localizeWithPath('vs/editor/browser/widget/diffEditor/components/accessibleDiffViewer', {
                    key: 'header',
                    comment: [
    ...
    _createRow(item, lineHeight, width, originalOptions, originalModel, originalModelOpts, modifiedOptions, modifiedModel, modifiedModelOpts) {
        const originalLayoutInfo = originalOptions.get(144 );
        const originalLineNumbersWidth = originalLayoutInfo.glyphMarginWidth + originalLayoutInfo.lineNumbersWidth;
        const modifiedLayoutInfo = modifiedOptions.get(144 );
    ...
    _getLineHtml(model, options, tabSize, lineNumber, languageIdCodec) {
        ...
        const r = renderViewLine2(( new RenderLineInput(
            (fontInfo.isMonospace && !options.get(33 )),
            ...
            options.get(99 ),
            options.get(94 ),
            options.get(51 ) !== EditorFontLigatures.OFF,
            null
        )));
        return r.html;
    }
