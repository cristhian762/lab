...
class InlineDiffDeletedCodeMargin extends Disposable {
    ...
    constructor(_getViewZoneId, _marginDomNode, _modifiedEditor, _diff, _editor, _viewLineCounts, _originalTextModel, _contextMenuService, _clipboardService) {
        ...
        const lineHeight = this._modifiedEditor.getOption(67 );
        ...
        const useShadowDOM = _modifiedEditor.getOption(127 ) && !isIOS;
        const showContextMenu = (x, y) => {
            this._contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    ...
                    const readOnly = _modifiedEditor.getOption(91 );
                    if (!readOnly) {
                        actions.push(( new Action('diff.inline.revertChange', ( localizeWithPath(
                            'vs/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin',
