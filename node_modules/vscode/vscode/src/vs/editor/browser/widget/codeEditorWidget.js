...
import { editorErrorForeground, editorWarningForeground, editorInfoForeground, editorHintForeground } from '../../../platform/theme/common/colorRegistry.js';
...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        const isDropIntoEnabled = () => {
            return !this._configuration.options.get(91 )
                && this._configuration.options.get(36 ).enabled;
        };
    ...
    _createConfiguration(isSimpleWidget, isStandaloneEditor, options, accessibilityService) {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(130 ), position);
    }
    ...
    pushUndoStop() {
        ...
        if (this._configuration.options.get(91 )) {
            return false;
        }
    ...
    applyFontInfo(target) {
        applyFontInfo(target, this._configuration.options.get(50 ));
    }
            ...
            switch (e.kind) {
                ...
                case 6 : {
                    if (e.reachedMaxCursorCount) {
                        const multiCursorLimit = this.getOption(80 );
...
class EditorContextKeysManager extends Disposable {
    ...
    _updateFromConfig() {
        ...
        this._editorReadonly.set(options.get(91 ));
