...
registerColor('diffEditor.move.border', { dark: '#8b8b8b9c', light: '#8b8b8b9c', hcDark: '#8b8b8b9c', hcLight: '#8b8b8b9c', }, ( localizeWithPath(
...
registerColor('diffEditor.moveActive.border', { dark: '#FFA500', light: '#FFA500', hcDark: '#FFA500', hcLight: '#FFA500', }, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/registrations.contribution',
    'diffEditor.moveActive.border',
    'The active border color for text that got moved in the diff editor.'
)));
registerColor('diffEditor.unchangedRegionShadow', { dark: '#000000', light: '#737373BF', hcDark: '#000000', hcLight: '#737373BF', }, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/registrations.contribution',
    'diffEditor.unchangedRegionShadow',
    'The color of the shadow around unchanged region widgets.'
)));
const diffInsertIcon = registerIcon('diff-insert', Codicon.add, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/registrations.contribution',
    'diffInsertIcon',
    'Line decoration for inserts in the diff editor.'
)));
const diffRemoveIcon = registerIcon('diff-remove', Codicon.remove, ( localizeWithPath(
    'vs/editor/browser/widget/diffEditor/registrations.contribution',
    'diffRemoveIcon',
