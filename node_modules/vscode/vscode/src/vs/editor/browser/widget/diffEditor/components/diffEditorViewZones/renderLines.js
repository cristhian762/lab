...
class RenderOptions {
    static fromEditor(editor) {
        ...
        const fontInfo = modifiedEditorOptions.get(50 );
        const layoutInfo = modifiedEditorOptions.get(144 );
        return ( new RenderOptions(
            editor.getModel()?.getOptions().tabSize || 0,
            fontInfo,
            modifiedEditorOptions.get(33 ),
            fontInfo.typicalHalfwidthCharacterWidth,
            modifiedEditorOptions.get(104 ),
            modifiedEditorOptions.get(67 ),
            layoutInfo.decorationsWidth,
            modifiedEditorOptions.get(117 ),
            modifiedEditorOptions.get(99 ),
            modifiedEditorOptions.get(94 ),
            modifiedEditorOptions.get(51 )
        ));
    }
