...
let TextAreaHandler = class TextAreaHandler extends ViewPart {
    constructor(context, viewController, visibleRangeProvider, _keybindingService, _instantiationService) {
        ...
        const layoutInfo = options.get(144 );
        this._setAccessibilityOptions(options);
        this._contentLeft = layoutInfo.contentLeft;
        this._contentWidth = layoutInfo.contentWidth;
        this._contentHeight = layoutInfo.height;
        this._fontInfo = options.get(50 );
        this._lineHeight = options.get(67 );
        ...
        this.textArea.setAttribute('tabindex', String(options.get(124 )));
        this.textArea.setAttribute('role', 'textbox');
        this.textArea.setAttribute('aria-roledescription', ( localizeWithPath('vs/editor/browser/controller/textAreaHandler', 'editor', "editor")));
        this.textArea.setAttribute('aria-multiline', 'true');
        this.textArea.setAttribute('aria-autocomplete', options.get(91 ) ? 'none' : 'both');
        ...
        const textAreaInputHost = {
            ...
            getScreenReaderContent: () => {
                if (this._accessibilitySupport === 1 ) {
                    ...
                    if (isMacintosh && !selection.isEmpty() && simpleModel.getValueLengthInRange(selection, 0 ) < LIMIT_CHARS) {
                ...
                return PagedScreenReaderStrategy.fromEditorSelection(simpleModel, this._selections[0], this._accessibilityPageSize, this._accessibilitySupport === 0 );
            },
    ...
    _getWordBeforePosition(position) {
        const lineContent = this._context.viewModel.getLineContent(position.lineNumber);
        const wordSeparators = getMapForWordSeparators(this._context.configuration.options.get(130 ));
    ...
    _getAriaLabel(options) {
        ...
        if (accessibilitySupport === 1 ) {
            ...
            const editorNotAccessibleMessage = ( localizeWithPath(
    ...
    onConfigurationChanged(e) {
        ...
        this.textArea.setAttribute('aria-required', options.get(5 ) ? 'true' : 'false');
        this.textArea.setAttribute('tabindex', String(options.get(124 )));
        if (e.hasChanged(34 ) || e.hasChanged(91 )) {
            this._ensureReadOnlyAttribute();
        }
        if (e.hasChanged(2 )) {
    ...
    _ensureReadOnlyAttribute() {
        const options = this._context.configuration.options;
        const useReadOnly = !IME.enabled || (options.get(34 ) && options.get(91 ));
        if (useReadOnly) {
    ...
    _doRender(renderData) {
        ...
        if (options.get(57 )) {
            ...
            if (options.get(68 ).renderType !== 0 ) {
