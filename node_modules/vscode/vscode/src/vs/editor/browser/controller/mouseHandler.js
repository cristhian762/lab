...
class MouseHandler extends ViewEventHandler {
    constructor(context, viewController, viewHelper) {
        ...
        this._height = this._context.configuration.options.get(144 ).height;
    ...
    onConfigurationChanged(e) {
        if (e.hasChanged(144 )) {
            const height = this._context.configuration.options.get(144 ).height;
...
class TopBottomDragScrollingOperation extends Disposable {
    ...
    _getScrollSpeed() {
        ...
        const viewportInLines = this._context.configuration.options.get(144 ).height / lineHeight;
    ...
    _execute() {
        ...
        let mouseTarget;
        {
            ...
            const horizontalScrollbarHeight = this._context.configuration.options.get(144 ).horizontalScrollbarHeight;
