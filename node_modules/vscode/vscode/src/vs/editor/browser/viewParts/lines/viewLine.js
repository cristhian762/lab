...
import { LineRange, renderViewLine, DomPosition, RenderLineInput } from '../../../common/viewLayout/viewLineRenderer.js';
...
class ViewLineOptions {
    constructor(config, themeType) {
        ...
        const experimentalWhitespaceRendering = options.get(38 );
        if (experimentalWhitespaceRendering === 'off') {
            this.renderWhitespace = options.get(99 );
        }
        else {
            this.renderWhitespace = 'none';
        }
        this.renderControlCharacters = options.get(94 );
        ...
        this.lineHeight = options.get(67 );
        this.stopRenderingLineAfter = options.get(117 );
        this.fontLigatures = options.get(51 );
    }
    equals(other) {
...
class FastRenderedViewLine {
    constructor(domNode, renderLineInput, characterMapping) {
        ...
        const keyColumnCount = Math.floor(renderLineInput.lineContent.length / 300 );
        if (keyColumnCount > 0) {
    ...
    _getColumnPixelOffset(lineNumber, column, context) {
        ...
        const keyColumnOrdinal = Math.floor((column - 1) / 300 ) - 1;
