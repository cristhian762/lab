...
import { editorOverviewRulerBorder, editorCursorForeground, editorOverviewRulerBackground } from '../../../common/core/editorColorRegistry.js';
...
class Settings {
    constructor(config, theme) {
        ...
        this.pixelRatio = options.get(142 );
        this.overviewRulerLanes = options.get(83 );
        this.renderBorder = options.get(82 );
        const borderColor = theme.getColor(editorOverviewRulerBorder);
        this.borderColor = borderColor ? ( borderColor.toString()) : null;
        this.hideCursor = options.get(59 );
