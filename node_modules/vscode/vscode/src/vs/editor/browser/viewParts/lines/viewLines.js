...
class ViewLines extends ViewPart {
    ...
    constructor(context, linesContent) {
        ...
        this._revealHorizontalRightPadding = options.get(100 );
        ...
        PartFingerprints.write(this.domNode, 8 );
        ...
        this._stickyScrollEnabled = options.get(115 ).enabled;
        this._maxNumberStickyLines = options.get(115 ).maxLineCount;
    }
    dispose() {
    ...
    _computeScrollLeftToReveal(horizontalRevealRequest) {
        ...
        const layoutInfo = this._context.configuration.options.get(144 );
