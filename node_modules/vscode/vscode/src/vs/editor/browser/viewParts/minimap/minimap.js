...
class MinimapOptions {
    constructor(configuration, theme, tokensColorTracker) {
        ...
        const pixelRatio = options.get(142 );
        const layoutInfo = options.get(144 );
        const minimapLayout = layoutInfo.minimap;
        const fontInfo = options.get(50 );
        const minimapOpts = options.get(73 );
        this.renderMinimap = minimapLayout.renderMinimap;
        this.size = minimapOpts.size;
        this.minimapHeightIsEditorHeight = minimapLayout.minimapHeightIsEditorHeight;
        this.scrollBeyondLastLine = options.get(105 );
        this.paddingTop = options.get(84 ).top;
        this.paddingBottom = options.get(84 ).bottom;
...
class Minimap extends ViewPart {
    ...
    revealLineNumber(lineNumber) {
        ...
        this._context.viewModel.revealRange('mouse', false, ( new Range(lineNumber, 1, lineNumber, 1)), 1 , 0 );
    }
...
class InnerMinimap extends Disposable {
    constructor(theme, model) {
        ...
        PartFingerprints.write(this._domNode, 9 );
