...
function canBreak(prevCharCode, prevCharCodeClass, charCode, charCodeClass, isKeepAll) {
    return (charCode !== 32  && (((prevCharCodeClass === 2  && charCodeClass !== 2) )
            || ((prevCharCodeClass !== 1  && charCodeClass === 1) )
            || ((!isKeepAll && prevCharCodeClass === 3  && charCodeClass !== 2) ) || (!isKeepAll && charCodeClass === 3  && prevCharCodeClass !== 1) ));
}
