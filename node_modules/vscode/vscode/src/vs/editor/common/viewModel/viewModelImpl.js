...
import { filterValidationDecorations, EDITOR_FONT_DEFAULTS } from '../config/editorOptions.js';
import { CursorsController } from '../cursor/cursor.js';
import { CursorConfiguration } from '../cursorCommon.js';
import { Position } from '../core/position.js';
import { Range } from '../core/range.js';
import { InternalModelContentChangeEvent } from '../textModelEvents.js';
...
class ViewModel extends Disposable {
    constructor(editorId, configuration, model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, scheduleAtNextAnimationFrame, languageConfigurationService, _themeService, _attachedView) {
        ...
        if (this.model.isTooLargeForTokenization()) {
            ...
            const wrappingStrategy = options.get(138 );
            const wrappingInfo = options.get(145 );
            const wrappingIndent = options.get(137 );
            const wordBreak = options.get(129 );
    ...
    getVisibleRangesPlusViewportAboveBelow() {
        const layoutInfo = this._configuration.options.get(144 );
        const lineHeight = this._configuration.options.get(67 );
    ...
    revealTopMostCursor(source) {
        ...
        this._withViewEventsCollector(eventsCollector => eventsCollector.emitViewEvent(new ViewRevealRangeRequestEvent(source, false, viewRange, null, 0 , true, 0 )));
    }
...
class ViewportStart {
    static create(model) {
        const viewportStartLineTrackedRange = model._setTrackedRange(null, ( new Range(1, 1, 1, 1)), 1 );
    ...
    update(viewModel, startLineNumber) {
        ...
        const viewportStartLineTrackedRange = viewModel.model._setTrackedRange(this._modelTrackedRange, ( new Range(position.lineNumber, position.column, position.lineNumber, position.column)), 1 );
