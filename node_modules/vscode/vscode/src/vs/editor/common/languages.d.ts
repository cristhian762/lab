...
import { LanguageFilter } from './languageSelector.js';
...
interface DocumentPasteEditProvider {
    ...
    provideDocumentPasteEdits?(model: ITextModel, ranges: readonly IRange[], dataTransfer: IReadonlyVSDataTransfer, context: DocumentPasteContext, token: CancellationToken): Promise<DocumentPasteEdit | undefined>;
}
/**
...
interface NewSymbolNamesProvider {
    provideNewSymbolNames(model: ITextModel, range: IRange, token: CancellationToken): ProviderResult<NewSymbolName[]>;
}
interface Command {
    id: string;
    title: string;
