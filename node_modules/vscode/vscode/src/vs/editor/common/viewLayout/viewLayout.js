...
class ViewLayout extends Disposable {
    ...
    _configureSmoothScrollDuration() {
        this._scrollable.setSmoothScrollDuration(this._configuration.options.get(114 ) ? SMOOTH_SCROLLING_TIME : 0);
    }
    onConfigurationChanged(e) {
        const options = this._configuration.options;
        if (e.hasChanged(67 )) {
            this._linesLayout.setLineHeight(options.get(67 ));
        }
        if (e.hasChanged(84 )) {
            const padding = options.get(84 );
    ...
    _getHorizontalScrollbarHeight(width, scrollWidth) {
        const options = this._configuration.options;
        const scrollbar = options.get(103 );
    ...
    _getContentHeight(width, height, contentWidth) {
        ...
        if (options.get(105 )) {
            result += Math.max(0, height - options.get(67 ) - options.get(84 ).bottom);
        }
        else if (!options.get(103 ).ignoreHorizontalScrollbarInContentHeight) {
    ...
    _computeContentWidth() {
        ...
        if (wrappingInfo.isViewportWrapping) {
            ...
            const extraHorizontalSpace = options.get(104 ) * fontInfo.typicalHalfwidthCharacterWidth;
