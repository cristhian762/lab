...
class EditStack {
    ...
    _getOrCreateEditStackElement(beforeCursorState, group) {
        ...
        const newElement = ( new SingleModelEditStackElement(( localizeWithPath('vs/editor/common/model/editStack', 'edit', "Typing")), 'undoredo.textBufferEdit', this._model, beforeCursorState));
