...
class ActionWithDropdownActionViewItem extends ActionViewItem {
    ...
    render(container) {
        ...
        if (this.element) {
            ...
            this.dropdownMenuActionViewItem = this._register(( new DropdownMenuActionViewItem(this._register(( new Action('dropdownAction', ( localizeWithPath(
                'vs/base/browser/ui/dropdown/dropdownActionViewItem',
                'moreActions',
                "More Actions..."
            ))))), menuActionsProvider, this.contextMenuProvider, { classNames: ['dropdown', ...ThemeIcon.asClassNameArray(Codicon.dropDownButton), ...menuActionClassNames], hoverDelegate: this.options.hoverDelegate })));
            ...
            this._register(addDisposableListener(this.element, EventType.KEY_DOWN, e => {
                ...
                let handled = false;
                if (this.dropdownMenuActionViewItem?.isFocused() && event.equals(15 )) {
                    handled = true;
                    this.dropdownMenuActionViewItem?.blur();
                    this.focus();
                }
                else if (this.isFocused() && event.equals(17 )) {
                    handled = true;
                    this.blur();
