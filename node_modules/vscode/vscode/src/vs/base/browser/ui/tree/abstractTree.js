import { createStyleSheet, isActiveElement, asCssValueWithDefault, isKeyboardEvent, append, $, clearNode, hasParentWithClass, h, getWindow } from '../../dom.js';
...
import { TreeMouseEventTarget, TreeError } from './tree.js';
    ...
    render() {
        ...
        if (this.pattern && noMatches) {
            if (this.tree.options.showNotFoundMessage ?? true) {
                this.widget?.showMessage({ type: 2 , content: ( localizeWithPath('vs/base/browser/ui/tree/abstractTree', 'not found', "No elements found.")) });
            }
            else {
...
export { AbstractTree, AbstractTreeViewState, ComposedTreeDelegate, FuzzyToggle, ModeToggle, RenderIndentGuides, TreeFindMatchType, TreeFindMode, TreeRenderer };
