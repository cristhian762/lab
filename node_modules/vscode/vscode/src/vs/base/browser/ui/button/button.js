...
class ButtonWithDropdown extends Disposable {
    constructor(container, options) {
        ...
        this._register(setupCustomHover(getDefaultHoverDelegate('mouse'), this.dropdownButton.element, ( localizeWithPath(
...
export { Button, ButtonBar, ButtonWithDescription, ButtonWithDropdown };
