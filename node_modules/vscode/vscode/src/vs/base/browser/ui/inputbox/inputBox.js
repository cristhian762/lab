...
class InputBox extends Widget {
    ...
    stylesForType(type) {
        ...
        switch (type) {
            case 1 : return { border: styles.inputValidationInfoBorder, background: styles.inputValidationInfoBackground, foreground: styles.inputValidationInfoForeground };
            case 2 : return { border: styles.inputValidationWarningBorder, background: styles.inputValidationWarningBackground, foreground: styles.inputValidationWarningForeground };
...
class HistoryInputBox extends InputBox {
    constructor(container, contextViewProvider, options) {
        const NLS_PLACEHOLDER_HISTORY_HINT_SUFFIX_NO_PARENS = ( localizeWithPath('vs/base/browser/ui/inputbox/inputBox', {
        ...
        const NLS_PLACEHOLDER_HISTORY_HINT_SUFFIX_IN_PARENS = ( localizeWithPath('vs/base/browser/ui/inputbox/inputBox', {
    ...
    showNextValue() {
        ...
        this.value = next ?? '';
        status(this.value ? this.value : ( localizeWithPath('vs/base/browser/ui/inputbox/inputBox', 'clearedInput', "Cleared Input")));
    }
    showPreviousValue() {
        if (!( this.history.has(this.value))) {
            this.addToHistory();
...
export { HistoryInputBox, InputBox, unthemedInboxStyles };
