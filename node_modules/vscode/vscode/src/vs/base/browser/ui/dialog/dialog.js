...
class Dialog extends Disposable {
    constructor(container, message, buttons, options) {
        ...
        if (Array.isArray(buttons) && buttons.length > 0) {
            ...
            this.buttons = [( localizeWithPath('vs/base/browser/ui/dialog/dialog', 'ok', "OK"))];
        }
        else {
            this.buttons = [];
        }
    ...
    getIconAriaLabel() {
        let typeLabel = ( localizeWithPath('vs/base/browser/ui/dialog/dialog', 'dialogInfoMessage', 'Info'));
        switch (this.options.type) {
            case 'error':
                typeLabel = ( localizeWithPath('vs/base/browser/ui/dialog/dialog', 'dialogErrorMessage', 'Error'));
                break;
            case 'warning':
                typeLabel = ( localizeWithPath('vs/base/browser/ui/dialog/dialog', 'dialogWarningMessage', 'Warning'));
                break;
            case 'pending':
                typeLabel = ( localizeWithPath('vs/base/browser/ui/dialog/dialog', 'dialogPendingMessage', 'In Progress'));
                break;
        }
        return typeLabel;
    }
    ...
    async show() {
        ...
        return ( new Promise((resolve) => {
            ...
            if (!this.options.disableCloseAction) {
                ...
                const action = this._register(( new Action('dialog.close', ( localizeWithPath('vs/base/browser/ui/dialog/dialog', 'dialogClose', "Close Dialog")), ThemeIcon.asClassName(Codicon.dialogClose), true, async () => {
                    resolve({
                        button: this.options.cancelId || 0,
                        checkboxChecked: this.checkbox ? this.checkbox.checked : undefined
                    });
