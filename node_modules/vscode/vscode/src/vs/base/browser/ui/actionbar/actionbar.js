import { addDisposableListener, EventType, trackFocus, getActiveElement, isAncestor, EventHelper, clearNode } from '../../dom.js';
...
class ActionBar extends Disposable {
    constructor(container, options = {}) {
        ...
        this._register(addDisposableListener(this.domNode, EventType.KEY_DOWN, e => {
            ...
            else if (event.equals(9 ) && this.cancelHasListener) {
            ...
            else if (event.equals(2 ) && focusedItem instanceof BaseActionViewItem && focusedItem.trapsArrowNavigation) {
                eventHandled = this.focusNext();
            }
        ...
        this._register(addDisposableListener(this.domNode, EventType.KEY_UP, e => {
            ...
            else if (event.equals(2 ) || event.equals(1024  | 2 ) || event.equals(16 ) || event.equals(18 ) || event.equals(15 ) || event.equals(17 )) {
...
export { ActionBar, prepareActions };
