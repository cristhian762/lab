...
import { cleanMnemonic, MENU_ESCAPED_MNEMONIC_REGEX, Direction, Menu, MENU_MNEMONIC_REGEX } from './menu.js';
...
class MenuBar extends Disposable {
    ...
    createOverflowMenu() {
        const label = this.isCompact ? ( localizeWithPath('vs/base/browser/ui/menu/menubar', 'mAppMenu', 'Application Menu')) : ( localizeWithPath('vs/base/browser/ui/menu/menubar', 'mMore', 'More'));
