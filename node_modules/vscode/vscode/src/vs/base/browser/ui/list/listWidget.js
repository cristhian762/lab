...
import { EventHelper, getWindow, createStyleSheet, isActiveElement, getActiveElement, asCssValueWithDefault, isMouseEvent } from '../../dom.js';
...
const DefaultKeyboardNavigationDelegate = new class {
    mightProducePrintableCharacter(event) {
        ...
        return ((event.keyCode >= 31  && event.keyCode <= 56) )
            ...
            || ((event.keyCode >= 98  && event.keyCode <= 107) )
            || ((event.keyCode >= 85  && event.keyCode <= 95) );
    }
};
...
class DOMFocusController {
    constructor(list, view) {
        ...
        const onKeyDown = Event.chain(this.disposables.add(( new DomEmitter(view.domNode, 'keydown'))).event, $ => ( $
            ...
            .map(e => ( new StandardKeyboardEvent(e)))));
        const onTab = Event.chain(onKeyDown, $ => $.filter(e => e.keyCode === 2  && !e.ctrlKey && !e.metaKey && !e.shiftKey && !e.altKey));
