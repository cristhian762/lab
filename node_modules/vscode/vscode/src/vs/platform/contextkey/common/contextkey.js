...
const errorEmptyString = ( localizeWithPath(
...
const errorNoInAfterNot = ( localizeWithPath(
    'vs/platform/contextkey/common/contextkey',
    'contextkey.parser.error.noInAfterNot',
    "'in' after 'not'."
));
const errorClosingParenthesis = ( localizeWithPath(
    'vs/platform/contextkey/common/contextkey',
    'contextkey.parser.error.closingParenthesis',
    "closing parenthesis ')'"
));
const errorUnexpectedToken = ( localizeWithPath(
    'vs/platform/contextkey/common/contextkey',
    'contextkey.parser.error.unexpectedToken',
    "Unexpected token"
));
const hintUnexpectedToken = ( localizeWithPath(
    'vs/platform/contextkey/common/contextkey',
    'contextkey.parser.error.unexpectedToken.hint',
    "Did you forget to put && or || before the token?"
));
const errorUnexpectedEOF = ( localizeWithPath(
    'vs/platform/contextkey/common/contextkey',
    'contextkey.parser.error.unexpectedEOF',
    "Unexpected end of expression"
));
const hintUnexpectedEOF = ( localizeWithPath(
    'vs/platform/contextkey/common/contextkey',
