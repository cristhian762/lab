...
const widgetClose = registerIcon('widget-close', Codicon.close, ( (localizeWithPath(
    'vs/platform/theme/common/iconRegistry',
    'widgetClose',
    'Icon for the close action in widgets.'
))));
const gotoPreviousLocation = registerIcon('goto-previous-location', Codicon.arrowUp, ( (localizeWithPath(
    'vs/platform/theme/common/iconRegistry',
    'previousChangeIcon',
    'Icon for goto previous editor location.'
))));
const gotoNextLocation = registerIcon('goto-next-location', Codicon.arrowDown, ( (localizeWithPath(
    'vs/platform/theme/common/iconRegistry',
    'nextChangeIcon',
