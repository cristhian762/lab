...
import { IContextKeyServiceTarget, IContextKeyService } from '../../contextkey/common/contextkey.js';
...
export { IKeybindingService, type IKeyboardEvent, type IUserFriendlyKeybinding, type KeybindingsSchemaContribution };
