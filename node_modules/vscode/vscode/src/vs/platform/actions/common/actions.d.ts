...
import { IContextKeyService, ContextKeyExpression } from '../../contextkey/common/contextkey.js';
...
export { type IMenu, type IMenuActionOptions, type IMenuChangeEvent, type IMenuCreateOptions, type IMenuItem, type IMenuItemHide, type IMenuRegistry, type IMenuRegistryChangeEvent, IMenuService, type ISubmenuItem, MenuId, MenuItemAction, MenuRegistry, SubmenuItemAction };
