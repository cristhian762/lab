...
interface IResolvableEditorModel extends IDisposable {
    /**
     * Resolves the model.
     */
...
export { EditorActivation, EditorOpenSource, EditorResolution, type IBaseResourceEditorInput, type IBaseTextResourceEditorInput, type IBaseUntypedEditorInput, type IEditorOptions, type IResolvableEditorModel, type IResourceEditorInput, type IResourceEditorInputIdentifier, type ITextEditorOptions, type ITextEditorSelection, type ITextResourceEditorInput, TextEditorSelectionRevealType, TextEditorSelectionSource };
