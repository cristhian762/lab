...
import { ResourceEditStackSnapshot, IUndoRedoService, UndoRedoGroup, UndoRedoSource } from './undoRedo.js';
                ...
                buttons: [
                    {
                        label: ( localizeWithPath(
                            'vs/platform/undoRedo/common/undoRedoService',
                            { key: 'ok', comment: ['{0} denotes a number that is > 1, && denotes a mnemonic'] },
                            "&&Undo in {0} Files",
    ...
    async _confirmAndContinueUndo(strResource, sourceId, element) {
        const result = await this._dialogService.confirm({
            ...
            primaryButton: ( localizeWithPath(
                'vs/platform/undoRedo/common/undoRedoService',
                { key: 'confirmDifferentSource.yes', comment: ['&& denotes a mnemonic'] },
                "&&Yes"
            )),
