...
import { toFileOperationResult, IFileService } from '../../files/common/files.js';
...
let UserDataProfilesService = class UserDataProfilesService extends Disposable {
    ...
    createDefaultProfile() {
        const defaultProfile = toUserDataProfile('__default__profile__', ( localizeWithPath(
            'vs/platform/userDataProfile/common/userDataProfile',
            'defaultProfile',
            "Default"
        )), this.environmentService.userRoamingDataHome, this.profilesCacheHome);
...
export { IUserDataProfilesService, UserDataProfilesService, isUserDataProfile, reviveProfile, toUserDataProfile };
