...
import { isSafari, isChrome, isEdge, isFirefox, isAndroid, PlatformToString, isWeb, platform } from '../../../base/common/platform.js';
...
let UserDataSyncMachinesService = class UserDataSyncMachinesService extends Disposable {
    ...
    async readMachinesData(manifest) {
        ...
        if (machinesData.version !== UserDataSyncMachinesService_1.VERSION) {
            throw new Error(localizeWithPath('vs/platform/userDataSync/common/userDataSyncMachines', 'error incompatible', "Cannot read machines data as the current version is incompatible. Please update {0} and try again.", this.productService.nameLong));
        }
        return machinesData;
    }
...
export { IUserDataSyncMachinesService, UserDataSyncMachinesService, isWebPlatform };
