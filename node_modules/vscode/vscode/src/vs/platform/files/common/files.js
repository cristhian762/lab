...
function ensureFileSystemProviderError(error) {
    if (!error) {
        return createFileSystemProviderError(( localizeWithPath('vs/platform/files/common/files', 'unknownError', "Unknown Error")), FileSystemProviderErrorCode.Unknown);
    }
    return error;
}
