...
class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        checkAll.setAttribute('aria-label', ( localizeWithPath(
        ...
        const visibleCount = ( new CountBadge(visibleCountContainer, { countFormat: ( localizeWithPath(
            'vs/platform/quickinput/browser/quickInputController',
        ...
        const count = ( new CountBadge(countContainer, { countFormat: ( localizeWithPath(
            'vs/platform/quickinput/browser/quickInputController',
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? ( localizeWithPath(
            'vs/platform/quickinput/browser/quickInputController',
