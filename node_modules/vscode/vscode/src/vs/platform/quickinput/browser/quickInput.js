...
import { reset, EventHelper, isMouseEvent, addDisposableListener, EventType } from '../../../base/browser/dom.js';
...
import { QuickInputHideReason, ItemActivation, NO_KEY_MODS } from '../common/quickInput.js';
...
import { WorkbenchHoverDelegate, IHoverService } from '../../hover/browser/hover.js';
const backButton = {
...
class QuickInput extends Disposable {
    static { this.noPromptMessage = ( localizeWithPath(
...
class QuickPick extends QuickInput {
    ...
    static { this.DEFAULT_ARIA_LABEL = ( localizeWithPath(
        'vs/platform/quickinput/browser/quickInput',
...
export { InputBox, QuickInputHoverDelegate, QuickPick, QuickWidget, backButton };
