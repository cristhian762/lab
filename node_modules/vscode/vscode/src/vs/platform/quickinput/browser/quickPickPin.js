...
function _formatPinnedItems(storageKey, quickPick, storageService, changedItem, filterDuplicates) {
    ...
    if (pinnedItems.length) {
        formattedItems.push({ type: 'separator', label: ( localizeWithPath(
...
function updateButtons(item, removePin) {
    ...
    newButtons.unshift({
        ...
        tooltip: removePin ? ( localizeWithPath('vs/platform/quickinput/browser/quickPickPin', 'pinCommand', "Pin command")) : ( localizeWithPath(
            'vs/platform/quickinput/browser/quickPickPin',
            'pinnedCommand',
            "Pinned command"
        )),
